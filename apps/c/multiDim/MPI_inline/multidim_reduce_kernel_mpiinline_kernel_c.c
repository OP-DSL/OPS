...
#define OPS_ACC_MD0(d,x,y) (n_x*1 + n_y*xdim0_multidim_reduce_kernel*1 + (x)+(d)*xdim0_multidim_reduce_kernel*ydim0_multidim_reduce_kernel+(xdim0_multidim_reduce_kernel*(y)))
//user function
