...
#define OPS_ACC_MD0(d,x,y) (n_x*1 + x + (n_y*1+(y))*xdim1_multidim_copy_kernel + (d) * xdim1_multidim_copy_kernel*ydim1_multidim_copy_kernel)
#define OPS_ACC_MD1(d,x,y) (n_x*1 + x + (n_y*1+(y))*xdim1_multidim_copy_kernel + (d) * xdim1_multidim_copy_kernel*ydim1_multidim_copy_kernel)
//user function
