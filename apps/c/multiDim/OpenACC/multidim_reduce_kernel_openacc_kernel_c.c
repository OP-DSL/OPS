...
void multidim_reduce_kernel_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    ...
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ...
      #ifdef OPS_SOA
      const ptrm_double ptr0 = {  p_a0 + n_x*1 + n_y*xdim0_multidim_reduce_kernel*1, xdim0_multidim_reduce_kernel, ydim0_multidim_reduce_kernel};
      #else
      const ptrm_double ptr0 = {  p_a0 + n_x*1 + n_y*xdim0_multidim_reduce_kernel*1, xdim0_multidim_reduce_kernel, 2};
      #endif
