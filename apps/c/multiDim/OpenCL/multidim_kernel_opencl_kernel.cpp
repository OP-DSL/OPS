...
void buildOpenCLKernels_multidim_kernel(OPS_instance *instance, int xdim0,
                                        int ydim0) {
  ...
  if (!isbuilt_multidim_kernel) {
    ...
    instance->ostream() << "Compiling multidim_kernel " << OCL_FMA
                        << " source -- start \n";
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts,
                ...
                "-Dxdim0_multidim_kernel=%d  -Dydim0_multidim_kernel=%d ",
