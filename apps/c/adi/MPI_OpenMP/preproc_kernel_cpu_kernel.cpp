  ...
  for ( int n_z=start[2]; n_z<end[2]; n_z++ ){
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        ...
        const ACC<double> u(xdim0_preproc_kernel, ydim0_preproc_kernel, u_p + n_x*1 + n_y * xdim0_preproc_kernel*1 + n_z * xdim0_preproc_kernel * ydim0_preproc_kernel*1);
        ACC<double> du(xdim1_preproc_kernel, ydim1_preproc_kernel, du_p + n_x*1 + n_y * xdim1_preproc_kernel*1 + n_z * xdim1_preproc_kernel * ydim1_preproc_kernel*1);
        ACC<double> ax(xdim2_preproc_kernel, ydim2_preproc_kernel, ax_p + n_x*1 + n_y * xdim2_preproc_kernel*1 + n_z * xdim2_preproc_kernel * ydim2_preproc_kernel*1);
        ACC<double> bx(xdim3_preproc_kernel, ydim3_preproc_kernel, bx_p + n_x*1 + n_y * xdim3_preproc_kernel*1 + n_z * xdim3_preproc_kernel * ydim3_preproc_kernel*1);
        ACC<double> cx(xdim4_preproc_kernel, ydim4_preproc_kernel, cx_p + n_x*1 + n_y * xdim4_preproc_kernel*1 + n_z * xdim4_preproc_kernel * ydim4_preproc_kernel*1);
        ACC<double> ay(xdim5_preproc_kernel, ydim5_preproc_kernel, ay_p + n_x*1 + n_y * xdim5_preproc_kernel*1 + n_z * xdim5_preproc_kernel * ydim5_preproc_kernel*1);
        ACC<double> by(xdim6_preproc_kernel, ydim6_preproc_kernel, by_p + n_x*1 + n_y * xdim6_preproc_kernel*1 + n_z * xdim6_preproc_kernel * ydim6_preproc_kernel*1);
        ACC<double> cy(xdim7_preproc_kernel, ydim7_preproc_kernel, cy_p + n_x*1 + n_y * xdim7_preproc_kernel*1 + n_z * xdim7_preproc_kernel * ydim7_preproc_kernel*1);
        ACC<double> az(xdim8_preproc_kernel, ydim8_preproc_kernel, az_p + n_x*1 + n_y * xdim8_preproc_kernel*1 + n_z * xdim8_preproc_kernel * ydim8_preproc_kernel*1);
        ACC<double> bz(xdim9_preproc_kernel, ydim9_preproc_kernel, bz_p + n_x*1 + n_y * xdim9_preproc_kernel*1 + n_z * xdim9_preproc_kernel * ydim9_preproc_kernel*1);
        ACC<double> cz(xdim10_preproc_kernel, ydim10_preproc_kernel, cz_p + n_x*1 + n_y * xdim10_preproc_kernel*1 + n_z * xdim10_preproc_kernel * ydim10_preproc_kernel*1);
