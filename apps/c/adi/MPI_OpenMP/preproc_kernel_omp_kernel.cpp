...
// user function
inline void preproc_kernel(const double *u, double *du, double *ax, double *bx,
    ...
    for (int n_z = start_i; n_z < finish_i; n_z++) {
      for (int n_y = start[1]; n_y < end[1]; n_y++) {
        for (int n_x = start[0];
          ...
          for (int i = 0; i < SIMD_VEC; i++) {
            preproc_kernel(
                ...
                (double *)p_a[7] + i * 1 * 1, (double *)p_a[8] + i * 1 * 1,
                (double *)p_a[9] + i * 1 * 1, (double *)p_a[10] + i * 1 * 1,
                arg_idx);
        ...
        for (int n_x = start[0] + ((end[0] - start[0]) / SIMD_VEC) * SIMD_VEC;
          ...
          preproc_kernel((const double *)p_a[0], (double *)p_a[1],
                         (double *)p_a[2], (double *)p_a[3], (double *)p_a[4],
                         (double *)p_a[5], (double *)p_a[6], (double *)p_a[7],
