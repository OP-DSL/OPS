...
#define OPS_ACC0(x, y, z)                                                      \
  (x + xdim0_preproc_kernel * (y) +                                            \
   xdim0_preproc_kernel * ydim0_preproc_kernel * (z))
#define OPS_ACC1(x, y, z)                                                      \
  (x + xdim1_preproc_kernel * (y) +                                            \
   xdim1_preproc_kernel * ydim1_preproc_kernel * (z))
#define OPS_ACC2(x, y, z)                                                      \
  (x + xdim2_preproc_kernel * (y) +                                            \
   xdim2_preproc_kernel * ydim2_preproc_kernel * (z))
#define OPS_ACC3(x, y, z)                                                      \
  (x + xdim3_preproc_kernel * (y) +                                            \
   xdim3_preproc_kernel * ydim3_preproc_kernel * (z))
#define OPS_ACC4(x, y, z)                                                      \
  (x + xdim4_preproc_kernel * (y) +                                            \
   xdim4_preproc_kernel * ydim4_preproc_kernel * (z))
#define OPS_ACC5(x, y, z)                                                      \
  (x + xdim5_preproc_kernel * (y) +                                            \
   xdim5_preproc_kernel * ydim5_preproc_kernel * (z))
#define OPS_ACC6(x, y, z)                                                      \
  (x + xdim6_preproc_kernel * (y) +                                            \
   xdim6_preproc_kernel * ydim6_preproc_kernel * (z))
#define OPS_ACC7(x, y, z)                                                      \
  (x + xdim7_preproc_kernel * (y) +                                            \
   xdim7_preproc_kernel * ydim7_preproc_kernel * (z))
#define OPS_ACC8(x, y, z)                                                      \
  (x + xdim8_preproc_kernel * (y) +                                            \
   xdim8_preproc_kernel * ydim8_preproc_kernel * (z))
#define OPS_ACC9(x, y, z)                                                      \
  (x + xdim9_preproc_kernel * (y) +                                            \
   xdim9_preproc_kernel * ydim9_preproc_kernel * (z))
#define OPS_ACC10(x, y, z)                                                     \
  (x + xdim10_preproc_kernel * (y) +                                           \
   xdim10_preproc_kernel * ydim10_preproc_kernel * (z))

// user function
__device__

    void
    preproc_kernel(const double *u, double *du, double *ax, double *bx,
                   double *cx, double *ay, double *by, double *cy, double *az,
                   double *bz, double *cz, int *idx) {
  ...
  if (idx[0] == 0 || idx[0] == nx - 1 || idx[1] == 0 || idx[1] == ny - 1 ||
    ...
    d = lambda *
        (u[OPS_ACC0(-1, 0, 0)] + u[OPS_ACC0(1, 0, 0)] + u[OPS_ACC0(0, -1, 0)] +
         u[OPS_ACC0(0, 1, 0)] + u[OPS_ACC0(0, 0, -1)] + u[OPS_ACC0(0, 0, 1)] -
...
__global__ void ops_preproc_kernel(
    ...
    double *__restrict arg5, double *__restrict arg6, double *__restrict arg7,
    double *__restrict arg8, double *__restrict arg9, double *__restrict arg10,
    int arg_idx0, int arg_idx1, int arg_idx2, int size0, int size1, int size2) {
  ...
  arg0 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim0_preproc_kernel +
          idx_z * 1 * 1 * xdim0_preproc_kernel * ydim0_preproc_kernel;
  arg1 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim1_preproc_kernel +
          idx_z * 1 * 1 * xdim1_preproc_kernel * ydim1_preproc_kernel;
  arg2 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim2_preproc_kernel +
          idx_z * 1 * 1 * xdim2_preproc_kernel * ydim2_preproc_kernel;
  arg3 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim3_preproc_kernel +
          idx_z * 1 * 1 * xdim3_preproc_kernel * ydim3_preproc_kernel;
  arg4 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim4_preproc_kernel +
          idx_z * 1 * 1 * xdim4_preproc_kernel * ydim4_preproc_kernel;
  arg5 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim5_preproc_kernel +
          idx_z * 1 * 1 * xdim5_preproc_kernel * ydim5_preproc_kernel;
  arg6 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim6_preproc_kernel +
          idx_z * 1 * 1 * xdim6_preproc_kernel * ydim6_preproc_kernel;
  arg7 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim7_preproc_kernel +
          idx_z * 1 * 1 * xdim7_preproc_kernel * ydim7_preproc_kernel;
  arg8 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim8_preproc_kernel +
          idx_z * 1 * 1 * xdim8_preproc_kernel * ydim8_preproc_kernel;
  arg9 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim9_preproc_kernel +
          idx_z * 1 * 1 * xdim9_preproc_kernel * ydim9_preproc_kernel;
  arg10 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim10_preproc_kernel +
           idx_z * 1 * 1 * xdim10_preproc_kernel * ydim10_preproc_kernel;

  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    preproc_kernel(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9,
                   arg10, arg_idx);
  }
}
...
void ops_par_loop_preproc_kernel(char const *name, ops_block block, int dim,
  ...
  if (xdim0 != xdim0_preproc_kernel_h || ydim0 != ydim0_preproc_kernel_h ||
      xdim1 != xdim1_preproc_kernel_h || ydim1 != ydim1_preproc_kernel_h ||
      xdim2 != xdim2_preproc_kernel_h || ydim2 != ydim2_preproc_kernel_h ||
      xdim3 != xdim3_preproc_kernel_h || ydim3 != ydim3_preproc_kernel_h ||
      xdim4 != xdim4_preproc_kernel_h || ydim4 != ydim4_preproc_kernel_h ||
      xdim5 != xdim5_preproc_kernel_h || ydim5 != ydim5_preproc_kernel_h ||
      xdim6 != xdim6_preproc_kernel_h || ydim6 != ydim6_preproc_kernel_h ||
      xdim7 != xdim7_preproc_kernel_h || ydim7 != ydim7_preproc_kernel_h ||
      xdim8 != xdim8_preproc_kernel_h || ydim8 != ydim8_preproc_kernel_h ||
      xdim9 != xdim9_preproc_kernel_h || ydim9 != ydim9_preproc_kernel_h ||
      xdim10 != xdim10_preproc_kernel_h || ydim10 != ydim10_preproc_kernel_h) {
  ...
  ops_preproc_kernel<<<grid, tblock>>>(
      (double *)p_a[0], (double *)p_a[1], (double *)p_a[2], (double *)p_a[3],
      (double *)p_a[4], (double *)p_a[5], (double *)p_a[6], (double *)p_a[7],
      (double *)p_a[8], (double *)p_a[9], (double *)p_a[10], arg_idx[0],
      arg_idx[1], arg_idx[2], x_size, y_size, z_size);
