...
void ops_par_loop_write_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_write_kernel_h[0][0] || ydim0 != dims_write_kernel_h[0][1] || xdim1 != dims_write_kernel_h[1][0] || ydim1 != dims_write_kernel_h[1][1] || xdim2 != dims_write_kernel_h[2][0] || ydim2 != dims_write_kernel_h[2][1]) {
