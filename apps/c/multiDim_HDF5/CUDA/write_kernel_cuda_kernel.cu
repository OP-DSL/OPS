...
#define OPS_ACC1(x, y, z)                                                      \
  (x + dims_write_kernel[1][0] * (y) +                                         \
   dims_write_kernel[1][0] * dims_write_kernel[1][1] * (z))
#define OPS_ACC2(x, y, z)                                                      \
  (x + dims_write_kernel[2][0] * (y) +                                         \
   dims_write_kernel[2][0] * dims_write_kernel[2][1] * (z))

#define OPS_ACC_MD0(d, x, y, z)                                                \
  ((x)*2 + (d) + (dims_write_kernel[0][0] * (y)*2) +                           \
   (dims_write_kernel[0][0] * dims_write_kernel[0][1] * (z)*2))
// user function
__device__
