...
void buildOpenCLKernels_write_kernel(OPS_instance *instance, int xdim0,
                                     int ydim0, int xdim1, int ydim1, int xdim2,
                                     int ydim2, int xdim3, int ydim3, int xdim4,
                                     int ydim4, int xdim5, int ydim5, int xdim6,
                                     int ydim6) {
  ...
  if (!isbuilt_write_kernel) {
    ...
    instance->ostream() << "Compiling write_kernel " << OCL_FMA
                        << " source -- start \n";
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts,
                ...
                "-Dxdim3_write_kernel=%d  -Dydim3_write_kernel=%d  "
                "-Dxdim4_write_kernel=%d  -Dydim4_write_kernel=%d  "
                "-Dxdim5_write_kernel=%d  -Dydim5_write_kernel=%d  "
                "-Dxdim6_write_kernel=%d  -Dydim6_write_kernel=%d ",
    ...
    instance->opencl_instance->OPS_opencl_core.kernel[0] =
