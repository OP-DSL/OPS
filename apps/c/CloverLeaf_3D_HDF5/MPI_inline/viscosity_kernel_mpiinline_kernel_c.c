...
void viscosity_kernel_c_wrapper(
    ...
    double *restrict viscosity, const double *restrict zvel0,
    const double *restrict celldz, const double *restrict xarea,
    const double *restrict yarea, const double *restrict zarea, int x_size,
