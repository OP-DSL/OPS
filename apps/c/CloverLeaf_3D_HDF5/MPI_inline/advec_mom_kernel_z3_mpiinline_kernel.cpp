...
extern "C" {
#endif
void advec_mom_kernel_z3_c_wrapper(double *p_a0, double *p_a1, double *p_a2,
...
void ops_par_loop_advec_mom_kernel_z3(char const *name, ops_block block,
  ...
  advec_mom_kernel_z3_c_wrapper(p_a0, p_a1, p_a2, p_a3, x_size, y_size, z_size);
  ...
  if (block->instance->OPS_diags > 1) {
    block->instance->OPS_kernels[125].transfer +=
