...
void PdV_kernel_predict_c_wrapper(
    ...
    double *restrict yarea_p, double *restrict yvel0_p,
    ...
    double *restrict zarea_p, double *restrict zvel0_p, int x_size, int y_size,
    int z_size) {
    ...
    for (int n_y = 0; n_y < y_size; n_y++) {
      for (int n_x = 0; n_x < x_size; n_x++) {
        const ptr_double xarea = {
            xarea_p + n_x * 1 + n_y * xdim0_PdV_kernel_predict * 1 +
        ...
        const ptr_double xvel0 = {
            xvel0_p + n_x * 1 + n_y * xdim1_PdV_kernel_predict * 1 +
        ...
        const ptr_double yarea = {
            yarea_p + n_x * 1 + n_y * xdim2_PdV_kernel_predict * 1 +
        ...
        const ptr_double yvel0 = {
            yvel0_p + n_x * 1 + n_y * xdim3_PdV_kernel_predict * 1 +
        ...
        ptr_double volume_change = {
            volume_change_p + n_x * 1 + n_y * xdim4_PdV_kernel_predict * 1 +
        ...
        const ptr_double volume = {
            volume_p + n_x * 1 + n_y * xdim5_PdV_kernel_predict * 1 +
        ...
        const ptr_double pressure = {
            pressure_p + n_x * 1 + n_y * xdim6_PdV_kernel_predict * 1 +
        ...
        const ptr_double viscosity = {
            viscosity_p + n_x * 1 + n_y * xdim9_PdV_kernel_predict * 1 +
        ...
        const ptr_double zarea = {
            zarea_p + n_x * 1 + n_y * xdim12_PdV_kernel_predict * 1 +
        ...
        const ptr_double zvel0 = {
            zvel0_p + n_x * 1 + n_y * xdim13_PdV_kernel_predict * 1 +
