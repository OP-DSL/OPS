...
void initialise_chunk_kernel_cellx_c_wrapper(double *restrict vertexx_p,
    ...
    for (int n_y = 0; n_y < y_size; n_y++) {
      for (int n_x = 0; n_x < x_size; n_x++) {
        const ptr_double vertexx = {
            vertexx_p + n_x * 1 +
                n_y * xdim0_initialise_chunk_kernel_cellx * 0 +
        ...
        ptr_double cellx = {cellx_p + n_x * 1 +
        ...
        ptr_double celldx = {celldx_p + n_x * 1 +
