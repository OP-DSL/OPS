...
void advec_mom_kernel2_y_c_wrapper(double *restrict vel1_p,
  ...
  for (int n_z = 0; n_z < z_size; n_z++) {
    for (int n_y = 0; n_y < y_size; n_y++) {
      for (int n_x = 0; n_x < x_size; n_x++) {
        ptr_double vel1 = {
            vel1_p + n_x * 1 + n_y * xdim0_advec_mom_kernel2_y * 1 +
                n_z * xdim0_advec_mom_kernel2_y * ydim0_advec_mom_kernel2_y * 1,
            xdim0_advec_mom_kernel2_y, ydim0_advec_mom_kernel2_y};
        ...
        OPS_ACC(vel1, 0, 0, 0) =
            (OPS_ACC(vel1, 0, 0, 0) * OPS_ACC(node_mass_pre, 0, 0, 0) +
             OPS_ACC(mom_flux, 0, -1, 0) - OPS_ACC(mom_flux, 0, 0, 0)) /
