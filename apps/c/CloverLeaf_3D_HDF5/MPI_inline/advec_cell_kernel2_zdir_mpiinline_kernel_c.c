...
#define OPS_ACC0(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim0_advec_cell_kernel2_zdir * 1 +                         \
...
#define OPS_ACC1(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim1_advec_cell_kernel2_zdir * 1 +                         \
...
#define OPS_ACC2(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim2_advec_cell_kernel2_zdir * 1 +                         \
...
#define OPS_ACC3(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim3_advec_cell_kernel2_zdir * 1 +                         \
