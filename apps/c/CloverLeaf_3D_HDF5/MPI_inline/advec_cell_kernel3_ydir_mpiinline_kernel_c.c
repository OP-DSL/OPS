...
void advec_cell_kernel3_ydir_c_wrapper(
    double *restrict vol_flux_y_p, double *restrict pre_vol_p,
    int *restrict yy_p, double *restrict vertexdy_p,
    double *restrict density1_p, double *restrict energy1_p,
    double *restrict mass_flux_y_p, double *restrict ener_flux_p, int x_size,
  ...
  for (int n_z = 0; n_z < z_size; n_z++) {
    for (int n_y = 0; n_y < y_size; n_y++) {
      for (int n_x = 0; n_x < x_size; n_x++) {
        ...
        sigmat =
            fabs(OPS_ACC(vol_flux_y, 0, 0, 0)) / OPS_ACC(pre_vol, 0, donor, 0);
        sigma3 = (1.0 + sigmat) *
        ...
        diffuw =
            OPS_ACC(density1, 0, donor, 0) - OPS_ACC(density1, 0, upwind, 0);
        diffdw =
            OPS_ACC(density1, 0, downwind, 0) - OPS_ACC(density1, 0, donor, 0);
        ...
        OPS_ACC(ener_flux, 0, 0, 0) = OPS_ACC(mass_flux_y, 0, 0, 0) *
                                      (OPS_ACC(energy1, 0, donor, 0) + limiter);
      }
    }
  }
}
