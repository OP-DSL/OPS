...
void buildOpenCLKernels_update_halo_kernel2_yvel_plus_4_front(
  ...
  if (!isbuilt_update_halo_kernel2_yvel_plus_4_front) {
    ...
    instance->ostream() << "Compiling update_halo_kernel2_yvel_plus_4_front "
    ...
    instance->ostream()
        << "compiling update_halo_kernel2_yvel_plus_4_front -- done\n";
