...
void buildOpenCLKernels_advec_mom_kernel1_z_nonvector(
  ...
  if (!isbuilt_advec_mom_kernel1_z_nonvector) {
    ...
    instance->ostream() << "Compiling advec_mom_kernel1_z_nonvector " << OCL_FMA
                        << " source -- start \n";
    ...
    instance->opencl_instance->OPS_opencl_core.kernel[136] =
        clCreateKernel(instance->opencl_instance->OPS_opencl_core.program,
                       "ops_advec_mom_kernel1_z_nonvector", &ret);
    clSafeCall(ret);
