...
void buildOpenCLKernels_update_halo_kernel2_zvel_plus_2_right(int xdim0, int ydim0, int xdim1, int ydim1) {
  ...
  if(!isbuilt_update_halo_kernel2_zvel_plus_2_right) {
    ...
    OPS_opencl_core.kernel[99] = clCreateKernel(OPS_opencl_core.program, "ops_update_halo_kernel2_zvel_plus_2_right", &ret);
    clSafeCall( ret );
...
void ops_par_loop_update_halo_kernel2_zvel_plus_2_right(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  if (OPS_diags > 1) {
    ops_timing_realloc(99,"update_halo_kernel2_zvel_plus_2_right");
