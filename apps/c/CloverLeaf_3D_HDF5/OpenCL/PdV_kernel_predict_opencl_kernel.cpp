...
void buildOpenCLKernels_PdV_kernel_predict(int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3, int xdim4, int ydim4, int xdim5, int ydim5, int xdim6, int ydim6, int xdim7, int ydim7, int xdim8, int ydim8, int xdim9, int ydim9, int xdim10, int ydim10, int xdim11, int ydim11, int xdim12, int ydim12, int xdim13, int ydim13) {
  ...
  if(!isbuilt_PdV_kernel_predict) {
    ...
    OPS_opencl_core.kernel[101] = clCreateKernel(OPS_opencl_core.program, "ops_PdV_kernel_predict", &ret);
    clSafeCall( ret );
...
void ops_par_loop_PdV_kernel_predict(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg9, ops_arg arg10, ops_arg arg11, ops_arg arg12, ops_arg arg13) {
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[101], 0, sizeof(cl_mem), (void*) &arg0.data_d ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[101], 1, sizeof(cl_mem), (void*) &arg1.data_d ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[101], 2, sizeof(cl_mem), (void*) &arg2.data_d ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[101], 3, sizeof(cl_mem), (void*) &arg3.data_d ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[101], 4, sizeof(cl_mem), (void*) &arg4.data_d ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[101], 5, sizeof(cl_mem), (void*) &arg5.data_d ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[101], 6, sizeof(cl_mem), (void*) &arg6.data_d ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[101], 7, sizeof(cl_mem), (void*) &arg7.data_d ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[101], 8, sizeof(cl_mem), (void*) &arg8.data_d ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[101], 9, sizeof(cl_mem), (void*) &arg9.data_d ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[101], 10, sizeof(cl_mem), (void*) &arg10.data_d ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[101], 11, sizeof(cl_mem), (void*) &arg11.data_d ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[101], 12, sizeof(cl_mem), (void*) &arg12.data_d ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[101], 13, sizeof(cl_mem), (void*) &arg13.data_d ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[101], 14, sizeof(cl_double), (void*) &dt ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[101], 15, sizeof(cl_int), (void*) &base0 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[101], 16, sizeof(cl_int), (void*) &base1 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[101], 17, sizeof(cl_int), (void*) &base2 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[101], 18, sizeof(cl_int), (void*) &base3 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[101], 19, sizeof(cl_int), (void*) &base4 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[101], 20, sizeof(cl_int), (void*) &base5 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[101], 21, sizeof(cl_int), (void*) &base6 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[101], 22, sizeof(cl_int), (void*) &base7 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[101], 23, sizeof(cl_int), (void*) &base8 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[101], 24, sizeof(cl_int), (void*) &base9 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[101], 25, sizeof(cl_int), (void*) &base10 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[101], 26, sizeof(cl_int), (void*) &base11 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[101], 27, sizeof(cl_int), (void*) &base12 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[101], 28, sizeof(cl_int), (void*) &base13 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[101], 29, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[101], 30, sizeof(cl_int), (void*) &y_size ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[101], 31, sizeof(cl_int), (void*) &z_size ));

    //call/enque opencl kernel wrapper function
    clSafeCall( clEnqueueNDRangeKernel(OPS_opencl_core.command_queue, OPS_opencl_core.kernel[101], 3, NULL, globalWorkSize, localWorkSize, 0, NULL, NULL) );
  }
  if (OPS_diags>1) {
