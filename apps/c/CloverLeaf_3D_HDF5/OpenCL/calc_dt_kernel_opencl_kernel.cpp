...
void ops_par_loop_calc_dt_kernel(char const *name, ops_block block, int dim,
  ...
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[97], 11, sizeof(cl_mem),
                            (void *)&arg11.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[97], 12, sizeof(cl_mem),
                            (void *)&arg12.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[97], 13, sizeof(cl_mem),
                            (void *)&arg13.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[97], 14, sizeof(cl_double),
                            (void *)&g_small));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[97], 15, sizeof(cl_double),
                            (void *)&dtc_safe));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[97], 16, sizeof(cl_double),
                            (void *)&dtu_safe));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[97], 17, sizeof(cl_double),
                            (void *)&dtv_safe));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[97], 18, sizeof(cl_double),
                            (void *)&dtw_safe));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[97], 19, sizeof(cl_double),
                            (void *)&dtdiv_safe));
  ...
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[97], 26, sizeof(cl_int),
                            (void *)&base6));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[97], 27, sizeof(cl_int),
                            (void *)&base7));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[97], 28, sizeof(cl_int),
                            (void *)&base8));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[97], 29, sizeof(cl_int),
                            (void *)&base9));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[97], 30, sizeof(cl_int),
                            (void *)&base10));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[97], 31, sizeof(cl_int),
                            (void *)&base11));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[97], 32, sizeof(cl_int),
                            (void *)&base12));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[97], 33, sizeof(cl_int),
                            (void *)&base13));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[97], 34, sizeof(cl_int),
                            (void *)&x_size));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[97], 35, sizeof(cl_int),
                            (void *)&y_size));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[97], 36, sizeof(cl_int),
                            (void *)&z_size));
