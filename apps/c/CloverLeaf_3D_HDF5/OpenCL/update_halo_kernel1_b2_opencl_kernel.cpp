...
void buildOpenCLKernels_update_halo_kernel1_b2(int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3, int xdim4, int ydim4, int xdim5, int ydim5, int xdim6, int ydim6) {
  ...
  if(!isbuilt_update_halo_kernel1_b2) {
    ...
    OPS_opencl_core.kernel[56] = clCreateKernel(OPS_opencl_core.program, "ops_update_halo_kernel1_b2", &ret);
    clSafeCall( ret );
...
void ops_par_loop_update_halo_kernel1_b2(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6, ops_arg arg7) {
  ...
  #ifdef CHECKPOINTING
  if (!ops_checkpointing_before(args,8,range,56)) return;
  #endif
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[56], 8, sizeof(cl_int), (void*) &base0 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[56], 9, sizeof(cl_int), (void*) &base1 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[56], 10, sizeof(cl_int), (void*) &base2 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[56], 11, sizeof(cl_int), (void*) &base3 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[56], 12, sizeof(cl_int), (void*) &base4 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[56], 13, sizeof(cl_int), (void*) &base5 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[56], 14, sizeof(cl_int), (void*) &base6 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[56], 15, sizeof(cl_int), (void*) &x_size ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[56], 16, sizeof(cl_int), (void*) &y_size ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[56], 17, sizeof(cl_int), (void*) &z_size ));
