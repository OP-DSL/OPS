...
void buildOpenCLKernels_update_halo_kernel2_zvel_minus_2_front(int xdim0, int ydim0, int xdim1, int ydim1) {
  ...
  if(!isbuilt_update_halo_kernel2_zvel_minus_2_front) {
    ...
    printf("Compiling update_halo_kernel2_zvel_minus_2_front %d source -- start \n",OCL_FMA);
      ...
      if (pPath!=NULL)
        if(OCL_FMA)
          sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/c/include -DOPS_WARPSIZE=%d  -Dxdim0_update_halo_kernel2_zvel_minus_2_front=%d  -Dydim0_update_halo_kernel2_zvel_minus_2_front=%d  -Dxdim1_update_halo_kernel2_zvel_minus_2_front=%d  -Dydim1_update_halo_kernel2_zvel_minus_2_front=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1);
        else
    ...
    OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[58] = clCreateKernel(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.program, "ops_update_halo_kernel2_zvel_minus_2_front", &ret);
    clSafeCall( ret );
...
void ops_par_loop_update_halo_kernel2_zvel_minus_2_front(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  if (OPS_instance::getOPSInstance()->OPS_diags > 1) {
    ops_timing_realloc(58,"update_halo_kernel2_zvel_minus_2_front");
  ...
  buildOpenCLKernels_update_halo_kernel2_zvel_minus_2_front(
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[58], 3, sizeof(cl_int), (void*) &base0 ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[58], 4, sizeof(cl_int), (void*) &base1 ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[58], 5, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[58], 6, sizeof(cl_int), (void*) &y_size ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[58], 7, sizeof(cl_int), (void*) &z_size ));
