...
void buildOpenCLKernels_update_halo_kernel2_zvel_minus_2_front(
  ...
  if (!isbuilt_update_halo_kernel2_zvel_minus_2_front) {
    ...
    instance->ostream() << "Compiling update_halo_kernel2_zvel_minus_2_front "
    ...
    instance->ostream()
        << "compiling update_halo_kernel2_zvel_minus_2_front -- done\n";
