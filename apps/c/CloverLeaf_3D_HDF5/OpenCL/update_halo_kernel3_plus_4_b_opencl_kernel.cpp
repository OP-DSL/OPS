...
void buildOpenCLKernels_update_halo_kernel3_plus_4_b(int xdim0, int ydim0, int xdim1, int ydim1) {
  ...
  if(!isbuilt_update_halo_kernel3_plus_4_b) {
    ...
    OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[61] = clCreateKernel(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.program, "ops_update_halo_kernel3_plus_4_b", &ret);
    clSafeCall( ret );
...
void ops_par_loop_update_halo_kernel3_plus_4_b(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  if (OPS_instance::getOPSInstance()->OPS_diags > 1) {
    ops_timing_realloc(61,"update_halo_kernel3_plus_4_b");
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[61], 3, sizeof(cl_int), (void*) &base0 ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[61], 4, sizeof(cl_int), (void*) &base1 ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[61], 5, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[61], 6, sizeof(cl_int), (void*) &y_size ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[61], 7, sizeof(cl_int), (void*) &z_size ));
