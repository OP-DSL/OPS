...
void buildOpenCLKernels_update_halo_kernel2_yvel_plus_4_left(
  ...
  if (!isbuilt_update_halo_kernel2_yvel_plus_4_left) {
    ...
    instance->ostream() << "Compiling update_halo_kernel2_yvel_plus_4_left "
    ...
    instance->ostream()
        << "compiling update_halo_kernel2_yvel_plus_4_left -- done\n";
