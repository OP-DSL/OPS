...
void buildOpenCLKernels_update_halo_kernel4_plus_2_front(int xdim0, int ydim0, int xdim1, int ydim1) {
  ...
  if(!isbuilt_update_halo_kernel4_plus_2_front) {
    ...
    OPS_opencl_core.kernel[127] = clCreateKernel(OPS_opencl_core.program, "ops_update_halo_kernel4_plus_2_front", &ret);
    clSafeCall( ret );
...
void ops_par_loop_update_halo_kernel4_plus_2_front(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[127], 3, sizeof(cl_int), (void*) &base0 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[127], 4, sizeof(cl_int), (void*) &base1 ));
