...
void buildOpenCLKernels_flux_calc_kernelx(OPS_instance *instance, int xdim0,
  ...
  if (!isbuilt_flux_calc_kernelx) {
    ...
    instance->ostream() << "Compiling flux_calc_kernelx " << OCL_FMA
                        << " source -- start \n";
