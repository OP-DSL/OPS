...
void buildOpenCLKernels_calc_dt_kernel_get(OPS_instance *instance, int xdim0,
  ...
  if (!isbuilt_calc_dt_kernel_get) {
    ...
    instance->ostream() << "Compiling calc_dt_kernel_get " << OCL_FMA
                        << " source -- start \n";
    ...
    instance->opencl_instance->OPS_opencl_core.kernel[99] =
        clCreateKernel(instance->opencl_instance->OPS_opencl_core.program,
                       "ops_calc_dt_kernel_get", &ret);
    clSafeCall(ret);
