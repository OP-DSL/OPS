...
void buildOpenCLKernels_update_halo_kernel2_zvel_minus_2_back(int xdim0, int ydim0, int xdim1, int ydim1) {
  ...
  if(!isbuilt_update_halo_kernel2_zvel_minus_2_back) {
    ...
    printf("Compiling update_halo_kernel2_zvel_minus_2_back %d source -- start \n",OCL_FMA);
      ...
      if (pPath!=NULL)
        if(OCL_FMA)
          sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/c/include -DOPS_WARPSIZE=%d  -Dxdim0_update_halo_kernel2_zvel_minus_2_back=%d  -Dydim0_update_halo_kernel2_zvel_minus_2_back=%d  -Dxdim1_update_halo_kernel2_zvel_minus_2_back=%d  -Dydim1_update_halo_kernel2_zvel_minus_2_back=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1);
        else
    ...
    OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[56] = clCreateKernel(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.program, "ops_update_halo_kernel2_zvel_minus_2_back", &ret);
    clSafeCall( ret );
...
void ops_par_loop_update_halo_kernel2_zvel_minus_2_back(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  buildOpenCLKernels_update_halo_kernel2_zvel_minus_2_back(
