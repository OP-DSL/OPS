...
void buildOpenCLKernels_update_halo_kernel2_zvel_plus_4_top(
  ...
  if (!isbuilt_update_halo_kernel2_zvel_plus_4_top) {
    ...
    instance->ostream() << "Compiling update_halo_kernel2_zvel_plus_4_top "
    ...
    instance->ostream()
        << "compiling update_halo_kernel2_zvel_plus_4_top -- done\n";
