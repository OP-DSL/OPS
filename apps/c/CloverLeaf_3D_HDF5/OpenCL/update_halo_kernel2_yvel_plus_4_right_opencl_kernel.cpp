...
void buildOpenCLKernels_update_halo_kernel2_yvel_plus_4_right(
  ...
  if (!isbuilt_update_halo_kernel2_yvel_plus_4_right) {
    ...
    instance->ostream() << "Compiling update_halo_kernel2_yvel_plus_4_right "
    ...
    instance->ostream()
        << "compiling update_halo_kernel2_yvel_plus_4_right -- done\n";

    // Create the OpenCL kernel
    instance->opencl_instance->OPS_opencl_core.kernel[41] =
