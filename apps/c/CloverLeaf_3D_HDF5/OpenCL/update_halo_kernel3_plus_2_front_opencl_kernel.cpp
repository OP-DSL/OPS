...
void buildOpenCLKernels_update_halo_kernel3_plus_2_front(int xdim0, int ydim0, int xdim1, int ydim1) {
  ...
  if(!isbuilt_update_halo_kernel3_plus_2_front) {
    ...
    OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[70] = clCreateKernel(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.program, "ops_update_halo_kernel3_plus_2_front", &ret);
    clSafeCall( ret );
...
void ops_par_loop_update_halo_kernel3_plus_2_front(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  if (OPS_instance::getOPSInstance()->OPS_diags > 1) {
    ops_timing_realloc(70,"update_halo_kernel3_plus_2_front");
