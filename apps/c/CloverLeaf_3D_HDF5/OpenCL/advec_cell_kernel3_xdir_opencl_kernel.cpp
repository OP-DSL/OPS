...
void buildOpenCLKernels_advec_cell_kernel3_xdir(
  ...
  if (!isbuilt_advec_cell_kernel3_xdir) {
    ...
    instance->ostream() << "Compiling advec_cell_kernel3_xdir " << OCL_FMA
                        << " source -- start \n";
    ...
    instance->opencl_instance->OPS_opencl_core.kernel[110] =
        clCreateKernel(instance->opencl_instance->OPS_opencl_core.program,
                       "ops_advec_cell_kernel3_xdir", &ret);
    clSafeCall(ret);
