...
void ops_decl_const_char( int dim, char const * type, int typeSize, char * dat, char const * name ) {
  ...
  if (OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.constant == NULL) {
    OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.constant = (cl_mem*) malloc((15)*sizeof(cl_mem));
    for ( int i=0; i<15; i++ ){
...
void buildOpenCLKernels() {
  ...
  if(!isbuilt) {
    ...
    OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.n_kernels = 140;
    OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel = (cl_kernel*) malloc(140*sizeof(cl_kernel));
  }
  isbuilt = true;
}
