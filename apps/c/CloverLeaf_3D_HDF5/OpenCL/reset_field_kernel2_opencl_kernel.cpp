...
void buildOpenCLKernels_reset_field_kernel2(OPS_instance *instance, int xdim0,
  ...
  if (!isbuilt_reset_field_kernel2) {
    ...
    instance->ostream() << "Compiling reset_field_kernel2 " << OCL_FMA
                        << " source -- start \n";
    ...
    instance->opencl_instance->OPS_opencl_core.kernel[139] =
