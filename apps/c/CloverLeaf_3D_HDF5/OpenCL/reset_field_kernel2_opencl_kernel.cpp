...
void buildOpenCLKernels_reset_field_kernel2(int xdim0, int ydim0, int xdim1,
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(
            ...
            "-Dxdim0_reset_field_kernel2=%d  -Dydim0_reset_field_kernel2=%d  "
            "-Dxdim1_reset_field_kernel2=%d  -Dydim1_reset_field_kernel2=%d  "
            "-Dxdim2_reset_field_kernel2=%d  -Dydim2_reset_field_kernel2=%d  "
            "-Dxdim3_reset_field_kernel2=%d  -Dydim3_reset_field_kernel2=%d  "
            "-Dxdim4_reset_field_kernel2=%d  -Dydim4_reset_field_kernel2=%d  "
            "-Dxdim5_reset_field_kernel2=%d  -Dydim5_reset_field_kernel2=%d ",
...
void ops_par_loop_reset_field_kernel2(char const *name, ops_block block,
  ...
  buildOpenCLKernels_reset_field_kernel2(xdim0, ydim0, xdim1, ydim1, xdim2,
  ...
  if (globalWorkSize[0] > 0 && globalWorkSize[1] > 0 && globalWorkSize[2] > 0) {
    ...
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[139], 1, sizeof(cl_mem),
                              (void *)&arg1.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[139], 2, sizeof(cl_mem),
                              (void *)&arg2.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[139], 3, sizeof(cl_mem),
                              (void *)&arg3.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[139], 4, sizeof(cl_mem),
                              (void *)&arg4.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[139], 5, sizeof(cl_mem),
                              (void *)&arg5.data_d));
    ...
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[139], 7, sizeof(cl_int),
                              (void *)&base1));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[139], 8, sizeof(cl_int),
                              (void *)&base2));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[139], 9, sizeof(cl_int),
                              (void *)&base3));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[139], 10, sizeof(cl_int),
                              (void *)&base4));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[139], 11, sizeof(cl_int),
                              (void *)&base5));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[139], 12, sizeof(cl_int),
                              (void *)&x_size));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[139], 13, sizeof(cl_int),
                              (void *)&y_size));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[139], 14, sizeof(cl_int),
                              (void *)&z_size));
