...
void buildOpenCLKernels_field_summary_kernel(int xdim0, int ydim0, int xdim1,
  ...
  if (!isbuilt_field_summary_kernel) {
    ...
    OPS_opencl_core.kernel[95] = clCreateKernel(
...
void ops_par_loop_field_summary_kernel(char const *name, ops_block block,
  ...
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[95], 1, sizeof(cl_mem),
                            (void *)&arg1.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[95], 2, sizeof(cl_mem),
                            (void *)&arg2.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[95], 3, sizeof(cl_mem),
                            (void *)&arg3.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[95], 4, sizeof(cl_mem),
                            (void *)&arg4.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[95], 5, sizeof(cl_mem),
                            (void *)&arg5.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[95], 6, sizeof(cl_mem),
                            (void *)&arg6.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[95], 7, sizeof(cl_mem),
                            (void *)&arg7.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[95], 8,
                            nthread * sizeof(double), NULL));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[95], 9, sizeof(cl_int),
                            (void *)&r_bytes7));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[95], 10, sizeof(cl_mem),
                            (void *)&arg8.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[95], 11,
                            nthread * sizeof(double), NULL));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[95], 12, sizeof(cl_int),
                            (void *)&r_bytes8));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[95], 13, sizeof(cl_mem),
                            (void *)&arg9.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[95], 14,
                            nthread * sizeof(double), NULL));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[95], 15, sizeof(cl_int),
                            (void *)&r_bytes9));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[95], 16, sizeof(cl_mem),
                            (void *)&arg10.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[95], 17,
                            nthread * sizeof(double), NULL));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[95], 18, sizeof(cl_int),
                            (void *)&r_bytes10));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[95], 19, sizeof(cl_mem),
                            (void *)&arg11.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[95], 20,
                            nthread * sizeof(double), NULL));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[95], 21, sizeof(cl_int),
                            (void *)&r_bytes11));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[95], 22, sizeof(cl_int),
                            (void *)&base0));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[95], 23, sizeof(cl_int),
                            (void *)&base1));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[95], 24, sizeof(cl_int),
                            (void *)&base2));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[95], 25, sizeof(cl_int),
                            (void *)&base3));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[95], 26, sizeof(cl_int),
                            (void *)&base4));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[95], 27, sizeof(cl_int),
                            (void *)&base5));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[95], 28, sizeof(cl_int),
                            (void *)&base6));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[95], 29, sizeof(cl_int),
                            (void *)&x_size));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[95], 30, sizeof(cl_int),
                            (void *)&y_size));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[95], 31, sizeof(cl_int),
                            (void *)&z_size));
