...
void buildOpenCLKernels_field_summary_kernel(OPS_instance *instance, int xdim0,
  ...
  if (!isbuilt_field_summary_kernel) {
    ...
    instance->ostream() << "Compiling field_summary_kernel " << OCL_FMA
                        << " source -- start \n";
    ...
    instance->opencl_instance->OPS_opencl_core.kernel[95] =
        clCreateKernel(instance->opencl_instance->OPS_opencl_core.program,
                       "ops_field_summary_kernel", &ret);
    clSafeCall(ret);
