...
void buildOpenCLKernels_advec_cell_kernel4_zdir(
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts, "-cl-mad-enable -DOCL_FMA -I%s/c/include "
                           "-DOPS_WARPSIZE=%d  "
                           "-Dxdim0_advec_cell_kernel4_zdir=%d  "
                           "-Dydim0_advec_cell_kernel4_zdir=%d  "
                           "-Dxdim1_advec_cell_kernel4_zdir=%d  "
                           "-Dydim1_advec_cell_kernel4_zdir=%d  "
                           "-Dxdim2_advec_cell_kernel4_zdir=%d  "
                           "-Dydim2_advec_cell_kernel4_zdir=%d  "
                           "-Dxdim3_advec_cell_kernel4_zdir=%d  "
                           "-Dydim3_advec_cell_kernel4_zdir=%d  "
                           "-Dxdim4_advec_cell_kernel4_zdir=%d  "
                           "-Dydim4_advec_cell_kernel4_zdir=%d  "
                           "-Dxdim5_advec_cell_kernel4_zdir=%d  "
                           "-Dydim5_advec_cell_kernel4_zdir=%d  "
                           "-Dxdim6_advec_cell_kernel4_zdir=%d  "
                           "-Dydim6_advec_cell_kernel4_zdir=%d  "
                           "-Dxdim7_advec_cell_kernel4_zdir=%d  "
                           "-Dydim7_advec_cell_kernel4_zdir=%d  "
                           "-Dxdim8_advec_cell_kernel4_zdir=%d  "
                           "-Dydim8_advec_cell_kernel4_zdir=%d  "
                           "-Dxdim9_advec_cell_kernel4_zdir=%d  "
                           "-Dydim9_advec_cell_kernel4_zdir=%d  "
                           "-Dxdim10_advec_cell_kernel4_zdir=%d  "
                           "-Dydim10_advec_cell_kernel4_zdir=%d ",
...
void ops_par_loop_advec_cell_kernel4_zdir(
  ...
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[119], 8, sizeof(cl_mem),
                            (void *)&arg8.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[119], 9, sizeof(cl_mem),
                            (void *)&arg9.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[119], 10, sizeof(cl_mem),
                            (void *)&arg10.data_d));
  ...
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[119], 19, sizeof(cl_int),
                            (void *)&base8));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[119], 20, sizeof(cl_int),
                            (void *)&base9));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[119], 21, sizeof(cl_int),
                            (void *)&base10));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[119], 22, sizeof(cl_int),
                            (void *)&x_size));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[119], 23, sizeof(cl_int),
                            (void *)&y_size));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[119], 24, sizeof(cl_int),
                            (void *)&z_size));
