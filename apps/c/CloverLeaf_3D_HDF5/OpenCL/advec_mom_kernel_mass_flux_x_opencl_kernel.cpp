...
void buildOpenCLKernels_advec_mom_kernel_mass_flux_x(int xdim0, int ydim0, int xdim1, int ydim1) {
  ...
  if(!isbuilt_advec_mom_kernel_mass_flux_x) {
    ...
    OPS_opencl_core.kernel[126] = clCreateKernel(OPS_opencl_core.program, "ops_advec_mom_kernel_mass_flux_x", &ret);
    clSafeCall( ret );
...
void ops_par_loop_advec_mom_kernel_mass_flux_x(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[126], 2, sizeof(cl_int), (void*) &base0 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[126], 3, sizeof(cl_int), (void*) &base1 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[126], 4, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[126], 5, sizeof(cl_int), (void*) &y_size ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[126], 6, sizeof(cl_int), (void*) &z_size ));
