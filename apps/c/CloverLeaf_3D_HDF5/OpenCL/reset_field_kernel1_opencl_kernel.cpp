...
void buildOpenCLKernels_reset_field_kernel1(int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3) {
  ...
  if(!isbuilt_reset_field_kernel1) {
    ...
    OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[138] = clCreateKernel(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.program, "ops_reset_field_kernel1", &ret);
    clSafeCall( ret );
