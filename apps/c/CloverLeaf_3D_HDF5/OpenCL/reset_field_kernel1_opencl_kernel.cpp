...
void buildOpenCLKernels_reset_field_kernel1(OPS_instance *instance, int xdim0,
  ...
  if (!isbuilt_reset_field_kernel1) {
    ...
    instance->ostream() << "Compiling reset_field_kernel1 " << OCL_FMA
                        << " source -- start \n";
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(
            ...
            "-Dxdim0_reset_field_kernel1=%d  -Dydim0_reset_field_kernel1=%d  "
            "-Dxdim1_reset_field_kernel1=%d  -Dydim1_reset_field_kernel1=%d  "
            "-Dxdim2_reset_field_kernel1=%d  -Dydim2_reset_field_kernel1=%d  "
            "-Dxdim3_reset_field_kernel1=%d  -Dydim3_reset_field_kernel1=%d ",
