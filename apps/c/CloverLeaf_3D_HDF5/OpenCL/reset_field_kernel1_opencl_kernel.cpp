...
void buildOpenCLKernels_reset_field_kernel1(int xdim0, int ydim0, int xdim1,
  ...
  if (!isbuilt_reset_field_kernel1) {
    ...
    OPS_opencl_core.kernel[138] = clCreateKernel(
        OPS_opencl_core.program, "ops_reset_field_kernel1", &ret);
    clSafeCall(ret);
...
void ops_par_loop_reset_field_kernel1(char const *name, ops_block block,
  ...
  buildOpenCLKernels_reset_field_kernel1(xdim0, ydim0, xdim1, ydim1, xdim2,
                                         ydim2, xdim3, ydim3);
