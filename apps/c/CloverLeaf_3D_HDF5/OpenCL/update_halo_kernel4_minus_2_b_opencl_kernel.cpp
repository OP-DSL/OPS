...
void buildOpenCLKernels_update_halo_kernel4_minus_2_b(OPS_instance *instance,
                                                      int xdim0, int ydim0,
                                                      int xdim1, int ydim1) {
  ...
  if (!isbuilt_update_halo_kernel4_minus_2_b) {
    ...
    instance->ostream() << "Compiling update_halo_kernel4_minus_2_b " << OCL_FMA
                        << " source -- start \n";
    ...
    instance->opencl_instance->OPS_opencl_core.kernel[74] =
        clCreateKernel(instance->opencl_instance->OPS_opencl_core.program,
                       "ops_update_halo_kernel4_minus_2_b", &ret);
    clSafeCall(ret);
