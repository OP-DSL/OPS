...
void buildOpenCLKernels_advec_mom_kernel_y2(int xdim0, int ydim0, int xdim1,
  ...
  if (!isbuilt_advec_mom_kernel_y2) {
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(
            ...
            "-Dxdim0_advec_mom_kernel_y2=%d  -Dydim0_advec_mom_kernel_y2=%d  "
            "-Dxdim1_advec_mom_kernel_y2=%d  -Dydim1_advec_mom_kernel_y2=%d  "
            "-Dxdim2_advec_mom_kernel_y2=%d  -Dydim2_advec_mom_kernel_y2=%d  "
            "-Dxdim3_advec_mom_kernel_y2=%d  -Dydim3_advec_mom_kernel_y2=%d  "
            "-Dxdim4_advec_mom_kernel_y2=%d  -Dydim4_advec_mom_kernel_y2=%d ",
    ...
    OPS_opencl_core.kernel[123] = clCreateKernel(
        OPS_opencl_core.program, "ops_advec_mom_kernel_y2", &ret);
    clSafeCall(ret);
...
void ops_par_loop_advec_mom_kernel_y2(char const *name, ops_block block,
  ...
  buildOpenCLKernels_advec_mom_kernel_y2(xdim0, ydim0, xdim1, ydim1, xdim2,
