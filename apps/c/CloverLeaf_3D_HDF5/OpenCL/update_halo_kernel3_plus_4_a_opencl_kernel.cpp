...
void buildOpenCLKernels_update_halo_kernel3_plus_4_a(int xdim0, int ydim0, int xdim1, int ydim1) {
  ...
  if(!isbuilt_update_halo_kernel3_plus_4_a) {
    ...
    printf("Compiling update_halo_kernel3_plus_4_a %d source -- start \n",OCL_FMA);
      ...
      if (pPath!=NULL)
        if(OCL_FMA)
          sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/c/include -DOPS_WARPSIZE=%d  -Dxdim0_update_halo_kernel3_plus_4_a=%d  -Dydim0_update_halo_kernel3_plus_4_a=%d  -Dxdim1_update_halo_kernel3_plus_4_a=%d  -Dydim1_update_halo_kernel3_plus_4_a=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1);
        else
    ...
    OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[59] = clCreateKernel(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.program, "ops_update_halo_kernel3_plus_4_a", &ret);
    clSafeCall( ret );
...
void ops_par_loop_update_halo_kernel3_plus_4_a(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  if (OPS_instance::getOPSInstance()->OPS_diags > 1) {
    ops_timing_realloc(59,"update_halo_kernel3_plus_4_a");
