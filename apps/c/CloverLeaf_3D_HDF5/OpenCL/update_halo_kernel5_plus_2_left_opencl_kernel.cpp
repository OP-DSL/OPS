...
void buildOpenCLKernels_update_halo_kernel5_plus_2_left(OPS_instance *instance,
                                                        int xdim0, int ydim0,
                                                        int xdim1, int ydim1) {
  ...
  if (!isbuilt_update_halo_kernel5_plus_2_left) {
    ...
    instance->ostream() << "Compiling update_halo_kernel5_plus_2_left "
    ...
    instance->ostream()
        << "compiling update_halo_kernel5_plus_2_left -- done\n";

    // Create the OpenCL kernel
    instance->opencl_instance->OPS_opencl_core.kernel[88] =
        clCreateKernel(instance->opencl_instance->OPS_opencl_core.program,
                       "ops_update_halo_kernel5_plus_2_left", &ret);
    clSafeCall(ret);
