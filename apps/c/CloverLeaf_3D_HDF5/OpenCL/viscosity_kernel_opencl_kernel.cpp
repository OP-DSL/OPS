...
void ops_par_loop_viscosity_kernel(char const *name, ops_block block, int dim,
  ...
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[96], 7, sizeof(cl_mem),
                            (void *)&arg7.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[96], 8, sizeof(cl_mem),
                            (void *)&arg8.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[96], 9, sizeof(cl_mem),
                            (void *)&arg9.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[96], 10, sizeof(cl_mem),
                            (void *)&arg10.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[96], 11, sizeof(cl_mem),
                            (void *)&arg11.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[96], 12, sizeof(cl_int),
                            (void *)&base0));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[96], 13, sizeof(cl_int),
                            (void *)&base1));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[96], 14, sizeof(cl_int),
                            (void *)&base2));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[96], 15, sizeof(cl_int),
                            (void *)&base3));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[96], 16, sizeof(cl_int),
                            (void *)&base4));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[96], 17, sizeof(cl_int),
                            (void *)&base5));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[96], 18, sizeof(cl_int),
                            (void *)&base6));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[96], 19, sizeof(cl_int),
                            (void *)&base7));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[96], 20, sizeof(cl_int),
                            (void *)&base8));
