...
inline void update_halo_kernel5_plus_2_right(ptr_double vol_flux_z,
  ...
  if (fields[FIELD_VOL_FLUX_Z] == 1)
    OPS_ACC(vol_flux_z, 0, 0, 0) = (OPS_ACC(vol_flux_z, -2, 0, 0));
  if (fields[FIELD_MASS_FLUX_Z] == 1)
    OPS_ACC(mass_flux_z, 0, 0, 0) = (OPS_ACC(mass_flux_z, -2, 0, 0));
}
        ...
        ptr_double ptr0 = {
            p_a0 + n_x * 1 * 1 +
                ...
                n_z * xdim0_update_halo_kernel5_plus_2_right *
                    ydim0_update_halo_kernel5_plus_2_right * 1 * 1,
        ...
        ptr_double ptr1 = {
            p_a1 + n_x * 1 * 1 +
                ...
                n_z * xdim1_update_halo_kernel5_plus_2_right *
                    ydim1_update_halo_kernel5_plus_2_right * 1 * 1,
            xdim1_update_halo_kernel5_plus_2_right,
            ydim1_update_halo_kernel5_plus_2_right};
        update_halo_kernel5_plus_2_right(ptr0, ptr1, p_a2);
      }
    }
  }
}
