...
inline void advec_mom_kernel1_x_nonvector(const ptr_double node_flux,
  ...
  sigma =
      fabs(OPS_ACC(node_flux, 0, 0, 0)) / OPS_ACC(node_mass_pre, donor, 0, 0);
