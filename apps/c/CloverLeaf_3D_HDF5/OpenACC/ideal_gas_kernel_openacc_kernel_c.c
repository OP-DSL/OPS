  ...
  for ( int n_z=0; n_z<z_size; n_z++ ){
    ...
    for ( int n_y=0; n_y<y_size; n_y++ ){
      ...
      for ( int n_x=0; n_x<x_size; n_x++ ){
        ideal_gas_kernel(  p_a0 + n_x*1*1 + n_y*xdim0_ideal_gas_kernel*1*1 + n_z*xdim0_ideal_gas_kernel*ydim0_ideal_gas_kernel*1*1,
           p_a1 + n_x*1*1 + n_y*xdim1_ideal_gas_kernel*1*1 + n_z*xdim1_ideal_gas_kernel*ydim1_ideal_gas_kernel*1*1,
           p_a2 + n_x*1*1 + n_y*xdim2_ideal_gas_kernel*1*1 + n_z*xdim2_ideal_gas_kernel*ydim2_ideal_gas_kernel*1*1,
           p_a3 + n_x*1*1 + n_y*xdim3_ideal_gas_kernel*1*1 + n_z*xdim3_ideal_gas_kernel*ydim3_ideal_gas_kernel*1*1 );
