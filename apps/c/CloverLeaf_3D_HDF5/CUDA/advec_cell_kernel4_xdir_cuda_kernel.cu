...
#define OPS_ACC0(x,y,z) (x+dims_advec_cell_kernel4_xdir[0][0]*(y)+dims_advec_cell_kernel4_xdir[0][0]*dims_advec_cell_kernel4_xdir[0][1]*(z))
#define OPS_ACC1(x,y,z) (x+dims_advec_cell_kernel4_xdir[1][0]*(y)+dims_advec_cell_kernel4_xdir[1][0]*dims_advec_cell_kernel4_xdir[1][1]*(z))
#define OPS_ACC2(x,y,z) (x+dims_advec_cell_kernel4_xdir[2][0]*(y)+dims_advec_cell_kernel4_xdir[2][0]*dims_advec_cell_kernel4_xdir[2][1]*(z))
#define OPS_ACC3(x,y,z) (x+dims_advec_cell_kernel4_xdir[3][0]*(y)+dims_advec_cell_kernel4_xdir[3][0]*dims_advec_cell_kernel4_xdir[3][1]*(z))
#define OPS_ACC4(x,y,z) (x+dims_advec_cell_kernel4_xdir[4][0]*(y)+dims_advec_cell_kernel4_xdir[4][0]*dims_advec_cell_kernel4_xdir[4][1]*(z))
#define OPS_ACC5(x,y,z) (x+dims_advec_cell_kernel4_xdir[5][0]*(y)+dims_advec_cell_kernel4_xdir[5][0]*dims_advec_cell_kernel4_xdir[5][1]*(z))
#define OPS_ACC6(x,y,z) (x+dims_advec_cell_kernel4_xdir[6][0]*(y)+dims_advec_cell_kernel4_xdir[6][0]*dims_advec_cell_kernel4_xdir[6][1]*(z))
#define OPS_ACC7(x,y,z) (x+dims_advec_cell_kernel4_xdir[7][0]*(y)+dims_advec_cell_kernel4_xdir[7][0]*dims_advec_cell_kernel4_xdir[7][1]*(z))
#define OPS_ACC8(x,y,z) (x+dims_advec_cell_kernel4_xdir[8][0]*(y)+dims_advec_cell_kernel4_xdir[8][0]*dims_advec_cell_kernel4_xdir[8][1]*(z))
#define OPS_ACC9(x,y,z) (x+dims_advec_cell_kernel4_xdir[9][0]*(y)+dims_advec_cell_kernel4_xdir[9][0]*dims_advec_cell_kernel4_xdir[9][1]*(z))
#define OPS_ACC10(x,y,z) (x+dims_advec_cell_kernel4_xdir[10][0]*(y)+dims_advec_cell_kernel4_xdir[10][0]*dims_advec_cell_kernel4_xdir[10][1]*(z))
