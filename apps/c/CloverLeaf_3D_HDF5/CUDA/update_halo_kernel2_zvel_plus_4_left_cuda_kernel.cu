...
#define OPS_ACC0(x,y,z) (x+dims_update_halo_kernel2_zvel_plus_4_left[0][0]*(y)+dims_update_halo_kernel2_zvel_plus_4_left[0][0]*dims_update_halo_kernel2_zvel_plus_4_left[0][1]*(z))
#define OPS_ACC1(x,y,z) (x+dims_update_halo_kernel2_zvel_plus_4_left[1][0]*(y)+dims_update_halo_kernel2_zvel_plus_4_left[1][0]*dims_update_halo_kernel2_zvel_plus_4_left[1][1]*(z))
