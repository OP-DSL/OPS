...
#define OPS_ACC0(x, y, z)                                                      \
  (x + dims_field_summary_kernel[0][0] * (y) +                                 \
   dims_field_summary_kernel[0][0] * dims_field_summary_kernel[0][1] * (z))
#define OPS_ACC1(x, y, z)                                                      \
  (x + dims_field_summary_kernel[1][0] * (y) +                                 \
   dims_field_summary_kernel[1][0] * dims_field_summary_kernel[1][1] * (z))
#define OPS_ACC2(x, y, z)                                                      \
  (x + dims_field_summary_kernel[2][0] * (y) +                                 \
   dims_field_summary_kernel[2][0] * dims_field_summary_kernel[2][1] * (z))
#define OPS_ACC3(x, y, z)                                                      \
  (x + dims_field_summary_kernel[3][0] * (y) +                                 \
   dims_field_summary_kernel[3][0] * dims_field_summary_kernel[3][1] * (z))
#define OPS_ACC4(x, y, z)                                                      \
  (x + dims_field_summary_kernel[4][0] * (y) +                                 \
   dims_field_summary_kernel[4][0] * dims_field_summary_kernel[4][1] * (z))
#define OPS_ACC5(x, y, z)                                                      \
  (x + dims_field_summary_kernel[5][0] * (y) +                                 \
   dims_field_summary_kernel[5][0] * dims_field_summary_kernel[5][1] * (z))
#define OPS_ACC6(x, y, z)                                                      \
  (x + dims_field_summary_kernel[6][0] * (y) +                                 \
   dims_field_summary_kernel[6][0] * dims_field_summary_kernel[6][1] * (z))
...
__global__ void ops_field_summary_kernel(
  ...
  arg0 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_field_summary_kernel[0][0] +
          idx_z * 1 * 1 * dims_field_summary_kernel[0][0] *
              dims_field_summary_kernel[0][1];
  arg1 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_field_summary_kernel[1][0] +
          idx_z * 1 * 1 * dims_field_summary_kernel[1][0] *
              dims_field_summary_kernel[1][1];
  arg2 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_field_summary_kernel[2][0] +
          idx_z * 1 * 1 * dims_field_summary_kernel[2][0] *
              dims_field_summary_kernel[2][1];
  arg3 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_field_summary_kernel[3][0] +
          idx_z * 1 * 1 * dims_field_summary_kernel[3][0] *
              dims_field_summary_kernel[3][1];
  arg4 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_field_summary_kernel[4][0] +
          idx_z * 1 * 1 * dims_field_summary_kernel[4][0] *
              dims_field_summary_kernel[4][1];
  arg5 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_field_summary_kernel[5][0] +
          idx_z * 1 * 1 * dims_field_summary_kernel[5][0] *
              dims_field_summary_kernel[5][1];
  arg6 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_field_summary_kernel[6][0] +
          idx_z * 1 * 1 * dims_field_summary_kernel[6][0] *
              dims_field_summary_kernel[6][1];
...
void ops_par_loop_field_summary_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_field_summary_kernel_h[0][0] ||
      ydim0 != dims_field_summary_kernel_h[0][1] ||
      xdim1 != dims_field_summary_kernel_h[1][0] ||
      ydim1 != dims_field_summary_kernel_h[1][1] ||
      xdim2 != dims_field_summary_kernel_h[2][0] ||
      ydim2 != dims_field_summary_kernel_h[2][1] ||
      xdim3 != dims_field_summary_kernel_h[3][0] ||
      ydim3 != dims_field_summary_kernel_h[3][1] ||
      xdim4 != dims_field_summary_kernel_h[4][0] ||
      ydim4 != dims_field_summary_kernel_h[4][1] ||
      xdim5 != dims_field_summary_kernel_h[5][0] ||
      ydim5 != dims_field_summary_kernel_h[5][1] ||
      xdim6 != dims_field_summary_kernel_h[6][0] ||
      ydim6 != dims_field_summary_kernel_h[6][1]) {
    ...
    cutilSafeCall(cudaMemcpyToSymbol(dims_field_summary_kernel,
                                     dims_field_summary_kernel_h,
                                     sizeof(dims_field_summary_kernel)));
  }
