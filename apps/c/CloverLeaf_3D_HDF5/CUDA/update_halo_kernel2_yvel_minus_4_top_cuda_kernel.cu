...
#define OPS_ACC0(x, y, z)                                                      \
  (x + dims_update_halo_kernel2_yvel_minus_4_top[0][0] * (y) +                 \
   dims_update_halo_kernel2_yvel_minus_4_top[0][0] *                           \
       dims_update_halo_kernel2_yvel_minus_4_top[0][1] * (z))
#define OPS_ACC1(x, y, z)                                                      \
  (x + dims_update_halo_kernel2_yvel_minus_4_top[1][0] * (y) +                 \
   dims_update_halo_kernel2_yvel_minus_4_top[1][0] *                           \
       dims_update_halo_kernel2_yvel_minus_4_top[1][1] * (z))
...
__global__ void ops_update_halo_kernel2_yvel_minus_4_top(
  ...
  arg0 += idx_x * 1 * 1 +
          idx_y * 1 * 1 * dims_update_halo_kernel2_yvel_minus_4_top[0][0] +
          idx_z * 1 * 1 * dims_update_halo_kernel2_yvel_minus_4_top[0][0] *
              dims_update_halo_kernel2_yvel_minus_4_top[0][1];
  arg1 += idx_x * 1 * 1 +
          idx_y * 1 * 1 * dims_update_halo_kernel2_yvel_minus_4_top[1][0] +
          idx_z * 1 * 1 * dims_update_halo_kernel2_yvel_minus_4_top[1][0] *
              dims_update_halo_kernel2_yvel_minus_4_top[1][1];
...
void ops_par_loop_update_halo_kernel2_yvel_minus_4_top_execute(
  ...
  if (xdim0 != dims_update_halo_kernel2_yvel_minus_4_top_h[0][0] ||
      ydim0 != dims_update_halo_kernel2_yvel_minus_4_top_h[0][1] ||
      xdim1 != dims_update_halo_kernel2_yvel_minus_4_top_h[1][0] ||
      ydim1 != dims_update_halo_kernel2_yvel_minus_4_top_h[1][1]) {
    ...
    cutilSafeCall(
        cudaMemcpyToSymbol(dims_update_halo_kernel2_yvel_minus_4_top,
                           dims_update_halo_kernel2_yvel_minus_4_top_h,
                           sizeof(dims_update_halo_kernel2_yvel_minus_4_top)));
  }
