...
#define OPS_ACC0(x,y,z) (x+dims_update_halo_kernel2_zvel_plus_4_bot[0][0]*(y)+dims_update_halo_kernel2_zvel_plus_4_bot[0][0]*dims_update_halo_kernel2_zvel_plus_4_bot[0][1]*(z))
#define OPS_ACC1(x,y,z) (x+dims_update_halo_kernel2_zvel_plus_4_bot[1][0]*(y)+dims_update_halo_kernel2_zvel_plus_4_bot[1][0]*dims_update_halo_kernel2_zvel_plus_4_bot[1][1]*(z))
