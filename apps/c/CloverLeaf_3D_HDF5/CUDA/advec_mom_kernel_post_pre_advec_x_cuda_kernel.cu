...
#define OPS_ACC0(x,y,z) (x+dims_advec_mom_kernel_post_pre_advec_x[0][0]*(y)+dims_advec_mom_kernel_post_pre_advec_x[0][0]*dims_advec_mom_kernel_post_pre_advec_x[0][1]*(z))
#define OPS_ACC1(x,y,z) (x+dims_advec_mom_kernel_post_pre_advec_x[1][0]*(y)+dims_advec_mom_kernel_post_pre_advec_x[1][0]*dims_advec_mom_kernel_post_pre_advec_x[1][1]*(z))
#define OPS_ACC2(x,y,z) (x+dims_advec_mom_kernel_post_pre_advec_x[2][0]*(y)+dims_advec_mom_kernel_post_pre_advec_x[2][0]*dims_advec_mom_kernel_post_pre_advec_x[2][1]*(z))
#define OPS_ACC3(x,y,z) (x+dims_advec_mom_kernel_post_pre_advec_x[3][0]*(y)+dims_advec_mom_kernel_post_pre_advec_x[3][0]*dims_advec_mom_kernel_post_pre_advec_x[3][1]*(z))
#define OPS_ACC4(x,y,z) (x+dims_advec_mom_kernel_post_pre_advec_x[4][0]*(y)+dims_advec_mom_kernel_post_pre_advec_x[4][0]*dims_advec_mom_kernel_post_pre_advec_x[4][1]*(z))
