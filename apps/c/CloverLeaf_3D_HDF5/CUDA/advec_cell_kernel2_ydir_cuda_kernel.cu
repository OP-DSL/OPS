...
__global__ void ops_advec_cell_kernel2_ydir(double *__restrict arg0,
  ...
  arg0 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim0_advec_cell_kernel2_ydir +
          idx_z * 1 * 1 * xdim0_advec_cell_kernel2_ydir *
  ...
  arg2 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim2_advec_cell_kernel2_ydir +
          idx_z * 1 * 1 * xdim2_advec_cell_kernel2_ydir *
              ydim2_advec_cell_kernel2_ydir;
  arg3 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim3_advec_cell_kernel2_ydir +
          idx_z * 1 * 1 * xdim3_advec_cell_kernel2_ydir *
              ydim3_advec_cell_kernel2_ydir;
  arg4 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim4_advec_cell_kernel2_ydir +
          idx_z * 1 * 1 * xdim4_advec_cell_kernel2_ydir *
...
void ops_par_loop_advec_cell_kernel2_ydir_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_advec_cell_kernel2_ydir_h ||
      ydim0 != ydim0_advec_cell_kernel2_ydir_h ||
      xdim1 != xdim1_advec_cell_kernel2_ydir_h ||
      ydim1 != ydim1_advec_cell_kernel2_ydir_h ||
      xdim2 != xdim2_advec_cell_kernel2_ydir_h ||
      ydim2 != ydim2_advec_cell_kernel2_ydir_h ||
      xdim3 != xdim3_advec_cell_kernel2_ydir_h ||
      ydim3 != ydim3_advec_cell_kernel2_ydir_h ||
      xdim4 != xdim4_advec_cell_kernel2_ydir_h ||
      ydim4 != ydim4_advec_cell_kernel2_ydir_h) {
