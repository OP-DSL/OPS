...
__global__ void ops_initialise_chunk_kernel_z(double *__restrict arg0,
  ...
  arg0 += idx_x * 0 * 1 + idx_y * 0 * 1 * xdim0_initialise_chunk_kernel_z +
          idx_z * 1 * 1 * xdim0_initialise_chunk_kernel_z *
              ydim0_initialise_chunk_kernel_z;
  arg1 += idx_x * 0 * 1 + idx_y * 0 * 1 * xdim1_initialise_chunk_kernel_z +
          idx_z * 1 * 1 * xdim1_initialise_chunk_kernel_z *
              ydim1_initialise_chunk_kernel_z;
  arg2 += idx_x * 0 * 1 + idx_y * 0 * 1 * xdim2_initialise_chunk_kernel_z +
          idx_z * 1 * 1 * xdim2_initialise_chunk_kernel_z *
