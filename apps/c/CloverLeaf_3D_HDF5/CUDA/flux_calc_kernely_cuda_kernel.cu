...
#define OPS_ACC0(x,y,z) (x+dims_flux_calc_kernely[0][0]*(y)+dims_flux_calc_kernely[0][0]*dims_flux_calc_kernely[0][1]*(z))
#define OPS_ACC1(x,y,z) (x+dims_flux_calc_kernely[1][0]*(y)+dims_flux_calc_kernely[1][0]*dims_flux_calc_kernely[1][1]*(z))
#define OPS_ACC2(x,y,z) (x+dims_flux_calc_kernely[2][0]*(y)+dims_flux_calc_kernely[2][0]*dims_flux_calc_kernely[2][1]*(z))
#define OPS_ACC3(x,y,z) (x+dims_flux_calc_kernely[3][0]*(y)+dims_flux_calc_kernely[3][0]*dims_flux_calc_kernely[3][1]*(z))
