...
#define OPS_ACC0(x, y, z)                                                      \
  (x + dims_flux_calc_kernely[0][0] * (y) +                                    \
   dims_flux_calc_kernely[0][0] * dims_flux_calc_kernely[0][1] * (z))
#define OPS_ACC1(x, y, z)                                                      \
  (x + dims_flux_calc_kernely[1][0] * (y) +                                    \
   dims_flux_calc_kernely[1][0] * dims_flux_calc_kernely[1][1] * (z))
#define OPS_ACC2(x, y, z)                                                      \
  (x + dims_flux_calc_kernely[2][0] * (y) +                                    \
   dims_flux_calc_kernely[2][0] * dims_flux_calc_kernely[2][1] * (z))
#define OPS_ACC3(x, y, z)                                                      \
  (x + dims_flux_calc_kernely[3][0] * (y) +                                    \
   dims_flux_calc_kernely[3][0] * dims_flux_calc_kernely[3][1] * (z))

// user function
__device__

    void
    flux_calc_kernely_gpu(double *vol_flux_y, const double *yarea,
...
__global__ void ops_flux_calc_kernely(double *__restrict arg0,
  ...
  arg0 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_flux_calc_kernely[0][0] +
          idx_z * 1 * 1 * dims_flux_calc_kernely[0][0] *
              dims_flux_calc_kernely[0][1];
  arg1 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_flux_calc_kernely[1][0] +
          idx_z * 1 * 1 * dims_flux_calc_kernely[1][0] *
              dims_flux_calc_kernely[1][1];
  arg2 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_flux_calc_kernely[2][0] +
          idx_z * 1 * 1 * dims_flux_calc_kernely[2][0] *
              dims_flux_calc_kernely[2][1];
  arg3 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_flux_calc_kernely[3][0] +
          idx_z * 1 * 1 * dims_flux_calc_kernely[3][0] *
              dims_flux_calc_kernely[3][1];
...
void ops_par_loop_flux_calc_kernely_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_flux_calc_kernely_h[0][0] ||
      ydim0 != dims_flux_calc_kernely_h[0][1] ||
      xdim1 != dims_flux_calc_kernely_h[1][0] ||
      ydim1 != dims_flux_calc_kernely_h[1][1] ||
      xdim2 != dims_flux_calc_kernely_h[2][0] ||
      ydim2 != dims_flux_calc_kernely_h[2][1] ||
      xdim3 != dims_flux_calc_kernely_h[3][0] ||
      ydim3 != dims_flux_calc_kernely_h[3][1]) {
    ...
    cutilSafeCall(cudaMemcpyToSymbol(dims_flux_calc_kernely,
                                     dims_flux_calc_kernely_h,
                                     sizeof(dims_flux_calc_kernely)));
  }
