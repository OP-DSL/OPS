...
#define OPS_ACC0(x,y,z) (x+dims_update_halo_kernel1_l2[0][0]*(y)+dims_update_halo_kernel1_l2[0][0]*dims_update_halo_kernel1_l2[0][1]*(z))
#define OPS_ACC1(x,y,z) (x+dims_update_halo_kernel1_l2[1][0]*(y)+dims_update_halo_kernel1_l2[1][0]*dims_update_halo_kernel1_l2[1][1]*(z))
#define OPS_ACC2(x,y,z) (x+dims_update_halo_kernel1_l2[2][0]*(y)+dims_update_halo_kernel1_l2[2][0]*dims_update_halo_kernel1_l2[2][1]*(z))
#define OPS_ACC3(x,y,z) (x+dims_update_halo_kernel1_l2[3][0]*(y)+dims_update_halo_kernel1_l2[3][0]*dims_update_halo_kernel1_l2[3][1]*(z))
#define OPS_ACC4(x,y,z) (x+dims_update_halo_kernel1_l2[4][0]*(y)+dims_update_halo_kernel1_l2[4][0]*dims_update_halo_kernel1_l2[4][1]*(z))
#define OPS_ACC5(x,y,z) (x+dims_update_halo_kernel1_l2[5][0]*(y)+dims_update_halo_kernel1_l2[5][0]*dims_update_halo_kernel1_l2[5][1]*(z))
#define OPS_ACC6(x,y,z) (x+dims_update_halo_kernel1_l2[6][0]*(y)+dims_update_halo_kernel1_l2[6][0]*dims_update_halo_kernel1_l2[6][1]*(z))
