...
#define OPS_ACC0(x,y,z) (x+dims_advec_mom_kernel2_y[0][0]*(y)+dims_advec_mom_kernel2_y[0][0]*dims_advec_mom_kernel2_y[0][1]*(z))
#define OPS_ACC1(x,y,z) (x+dims_advec_mom_kernel2_y[1][0]*(y)+dims_advec_mom_kernel2_y[1][0]*dims_advec_mom_kernel2_y[1][1]*(z))
#define OPS_ACC2(x,y,z) (x+dims_advec_mom_kernel2_y[2][0]*(y)+dims_advec_mom_kernel2_y[2][0]*dims_advec_mom_kernel2_y[2][1]*(z))
#define OPS_ACC3(x,y,z) (x+dims_advec_mom_kernel2_y[3][0]*(y)+dims_advec_mom_kernel2_y[3][0]*dims_advec_mom_kernel2_y[3][1]*(z))
