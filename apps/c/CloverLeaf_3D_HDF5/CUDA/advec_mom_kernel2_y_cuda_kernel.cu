...
#define OPS_ACC0(x, y, z)                                                      \
  (x + dims_advec_mom_kernel2_y[0][0] * (y) +                                  \
   dims_advec_mom_kernel2_y[0][0] * dims_advec_mom_kernel2_y[0][1] * (z))
#define OPS_ACC1(x, y, z)                                                      \
  (x + dims_advec_mom_kernel2_y[1][0] * (y) +                                  \
   dims_advec_mom_kernel2_y[1][0] * dims_advec_mom_kernel2_y[1][1] * (z))
#define OPS_ACC2(x, y, z)                                                      \
  (x + dims_advec_mom_kernel2_y[2][0] * (y) +                                  \
   dims_advec_mom_kernel2_y[2][0] * dims_advec_mom_kernel2_y[2][1] * (z))
#define OPS_ACC3(x, y, z)                                                      \
  (x + dims_advec_mom_kernel2_y[3][0] * (y) +                                  \
   dims_advec_mom_kernel2_y[3][0] * dims_advec_mom_kernel2_y[3][1] * (z))

// user function
__device__

    inline void
    advec_mom_kernel2_y_gpu(double *vel1, const double *node_mass_post,
...
__global__ void ops_advec_mom_kernel2_y(double *__restrict arg0,
  ...
  arg0 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_advec_mom_kernel2_y[0][0] +
          idx_z * 1 * 1 * dims_advec_mom_kernel2_y[0][0] *
              dims_advec_mom_kernel2_y[0][1];
  arg1 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_advec_mom_kernel2_y[1][0] +
          idx_z * 1 * 1 * dims_advec_mom_kernel2_y[1][0] *
              dims_advec_mom_kernel2_y[1][1];
  arg2 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_advec_mom_kernel2_y[2][0] +
          idx_z * 1 * 1 * dims_advec_mom_kernel2_y[2][0] *
              dims_advec_mom_kernel2_y[2][1];
  arg3 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_advec_mom_kernel2_y[3][0] +
          idx_z * 1 * 1 * dims_advec_mom_kernel2_y[3][0] *
              dims_advec_mom_kernel2_y[3][1];
...
void ops_par_loop_advec_mom_kernel2_y_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_advec_mom_kernel2_y_h[0][0] ||
      ydim0 != dims_advec_mom_kernel2_y_h[0][1] ||
      xdim1 != dims_advec_mom_kernel2_y_h[1][0] ||
      ydim1 != dims_advec_mom_kernel2_y_h[1][1] ||
      xdim2 != dims_advec_mom_kernel2_y_h[2][0] ||
      ydim2 != dims_advec_mom_kernel2_y_h[2][1] ||
      xdim3 != dims_advec_mom_kernel2_y_h[3][0] ||
      ydim3 != dims_advec_mom_kernel2_y_h[3][1]) {
    ...
    cutilSafeCall(cudaMemcpyToSymbol(dims_advec_mom_kernel2_y,
                                     dims_advec_mom_kernel2_y_h,
                                     sizeof(dims_advec_mom_kernel2_y)));
  }
