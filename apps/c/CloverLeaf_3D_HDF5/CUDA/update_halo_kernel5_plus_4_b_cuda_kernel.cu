...
#define OPS_ACC0(x,y,z) (x+dims_update_halo_kernel5_plus_4_b[0][0]*(y)+dims_update_halo_kernel5_plus_4_b[0][0]*dims_update_halo_kernel5_plus_4_b[0][1]*(z))
#define OPS_ACC1(x,y,z) (x+dims_update_halo_kernel5_plus_4_b[1][0]*(y)+dims_update_halo_kernel5_plus_4_b[1][0]*dims_update_halo_kernel5_plus_4_b[1][1]*(z))
