...
#define OPS_ACC0(x, y, z)                                                      \
  (x + dims_initialise_chunk_kernel_yy[0][0] * (y) +                           \
   dims_initialise_chunk_kernel_yy[0][0] *                                     \
       dims_initialise_chunk_kernel_yy[0][1] * (z))
...
__global__ void ops_initialise_chunk_kernel_yy(int *__restrict arg0,
  ...
  arg0 += idx_x * 0 * 1 +
          idx_y * 1 * 1 * dims_initialise_chunk_kernel_yy[0][0] +
          idx_z * 0 * 1 * dims_initialise_chunk_kernel_yy[0][0] *
              dims_initialise_chunk_kernel_yy[0][1];
...
void ops_par_loop_initialise_chunk_kernel_yy_execute(
  ...
  if (xdim0 != dims_initialise_chunk_kernel_yy_h[0][0] ||
      ydim0 != dims_initialise_chunk_kernel_yy_h[0][1]) {
    dims_initialise_chunk_kernel_yy_h[0][0] = xdim0;
    dims_initialise_chunk_kernel_yy_h[0][1] = ydim0;
    cutilSafeCall(cudaMemcpyToSymbol(dims_initialise_chunk_kernel_yy,
                                     dims_initialise_chunk_kernel_yy_h,
                                     sizeof(dims_initialise_chunk_kernel_yy)));
  }
