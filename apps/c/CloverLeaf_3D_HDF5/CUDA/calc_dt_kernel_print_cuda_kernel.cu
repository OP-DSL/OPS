...
#define OPS_ACC0(x, y, z)                                                      \
  (x + dims_calc_dt_kernel_print[0][0] * (y) +                                 \
   dims_calc_dt_kernel_print[0][0] * dims_calc_dt_kernel_print[0][1] * (z))
#define OPS_ACC1(x, y, z)                                                      \
  (x + dims_calc_dt_kernel_print[1][0] * (y) +                                 \
   dims_calc_dt_kernel_print[1][0] * dims_calc_dt_kernel_print[1][1] * (z))
#define OPS_ACC2(x, y, z)                                                      \
  (x + dims_calc_dt_kernel_print[2][0] * (y) +                                 \
   dims_calc_dt_kernel_print[2][0] * dims_calc_dt_kernel_print[2][1] * (z))
#define OPS_ACC3(x, y, z)                                                      \
  (x + dims_calc_dt_kernel_print[3][0] * (y) +                                 \
   dims_calc_dt_kernel_print[3][0] * dims_calc_dt_kernel_print[3][1] * (z))
#define OPS_ACC4(x, y, z)                                                      \
  (x + dims_calc_dt_kernel_print[4][0] * (y) +                                 \
   dims_calc_dt_kernel_print[4][0] * dims_calc_dt_kernel_print[4][1] * (z))
#define OPS_ACC5(x, y, z)                                                      \
  (x + dims_calc_dt_kernel_print[5][0] * (y) +                                 \
   dims_calc_dt_kernel_print[5][0] * dims_calc_dt_kernel_print[5][1] * (z))
#define OPS_ACC6(x, y, z)                                                      \
  (x + dims_calc_dt_kernel_print[6][0] * (y) +                                 \
   dims_calc_dt_kernel_print[6][0] * dims_calc_dt_kernel_print[6][1] * (z))
...
__global__ void ops_calc_dt_kernel_print(
  ...
  arg0 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_calc_dt_kernel_print[0][0] +
          idx_z * 1 * 1 * dims_calc_dt_kernel_print[0][0] *
              dims_calc_dt_kernel_print[0][1];
  arg1 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_calc_dt_kernel_print[1][0] +
          idx_z * 1 * 1 * dims_calc_dt_kernel_print[1][0] *
              dims_calc_dt_kernel_print[1][1];
  arg2 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_calc_dt_kernel_print[2][0] +
          idx_z * 1 * 1 * dims_calc_dt_kernel_print[2][0] *
              dims_calc_dt_kernel_print[2][1];
  arg3 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_calc_dt_kernel_print[3][0] +
          idx_z * 1 * 1 * dims_calc_dt_kernel_print[3][0] *
              dims_calc_dt_kernel_print[3][1];
  arg4 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_calc_dt_kernel_print[4][0] +
          idx_z * 1 * 1 * dims_calc_dt_kernel_print[4][0] *
              dims_calc_dt_kernel_print[4][1];
  arg5 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_calc_dt_kernel_print[5][0] +
          idx_z * 1 * 1 * dims_calc_dt_kernel_print[5][0] *
              dims_calc_dt_kernel_print[5][1];
  arg6 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_calc_dt_kernel_print[6][0] +
          idx_z * 1 * 1 * dims_calc_dt_kernel_print[6][0] *
              dims_calc_dt_kernel_print[6][1];
...
void ops_par_loop_calc_dt_kernel_print_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_calc_dt_kernel_print_h[0][0] ||
      ydim0 != dims_calc_dt_kernel_print_h[0][1] ||
      xdim1 != dims_calc_dt_kernel_print_h[1][0] ||
      ydim1 != dims_calc_dt_kernel_print_h[1][1] ||
      xdim2 != dims_calc_dt_kernel_print_h[2][0] ||
      ydim2 != dims_calc_dt_kernel_print_h[2][1] ||
      xdim3 != dims_calc_dt_kernel_print_h[3][0] ||
      ydim3 != dims_calc_dt_kernel_print_h[3][1] ||
      xdim4 != dims_calc_dt_kernel_print_h[4][0] ||
      ydim4 != dims_calc_dt_kernel_print_h[4][1] ||
      xdim5 != dims_calc_dt_kernel_print_h[5][0] ||
      ydim5 != dims_calc_dt_kernel_print_h[5][1] ||
      xdim6 != dims_calc_dt_kernel_print_h[6][0] ||
      ydim6 != dims_calc_dt_kernel_print_h[6][1]) {
    ...
    cutilSafeCall(cudaMemcpyToSymbol(dims_calc_dt_kernel_print,
                                     dims_calc_dt_kernel_print_h,
                                     sizeof(dims_calc_dt_kernel_print)));
  }
