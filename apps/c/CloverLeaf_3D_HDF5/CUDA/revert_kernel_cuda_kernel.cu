...
__global__ void ops_revert_kernel(const double *__restrict arg0,
  ...
  arg0 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim0_revert_kernel +
          idx_z * 1 * 1 * xdim0_revert_kernel * ydim0_revert_kernel;
  arg1 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim1_revert_kernel +
          idx_z * 1 * 1 * xdim1_revert_kernel * ydim1_revert_kernel;
  arg2 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim2_revert_kernel +
          idx_z * 1 * 1 * xdim2_revert_kernel * ydim2_revert_kernel;
...
void ops_par_loop_revert_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (!ops_checkpointing_before(args, 4, range, 103))
    return;
#endif
  ...
  if (xdim0 != xdim0_revert_kernel_h || ydim0 != ydim0_revert_kernel_h ||
      xdim1 != xdim1_revert_kernel_h || ydim1 != ydim1_revert_kernel_h ||
      xdim2 != xdim2_revert_kernel_h || ydim2 != ydim2_revert_kernel_h ||
      xdim3 != xdim3_revert_kernel_h || ydim3 != ydim3_revert_kernel_h) {
