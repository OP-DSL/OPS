...
#define OPS_ACC0(x, y, z)                                                      \
  (x + dims_revert_kernel[0][0] * (y) +                                        \
   dims_revert_kernel[0][0] * dims_revert_kernel[0][1] * (z))
#define OPS_ACC1(x, y, z)                                                      \
  (x + dims_revert_kernel[1][0] * (y) +                                        \
   dims_revert_kernel[1][0] * dims_revert_kernel[1][1] * (z))
#define OPS_ACC2(x, y, z)                                                      \
  (x + dims_revert_kernel[2][0] * (y) +                                        \
   dims_revert_kernel[2][0] * dims_revert_kernel[2][1] * (z))
#define OPS_ACC3(x, y, z)                                                      \
  (x + dims_revert_kernel[3][0] * (y) +                                        \
   dims_revert_kernel[3][0] * dims_revert_kernel[3][1] * (z))
...
__global__ void ops_revert_kernel(const double *__restrict arg0,
  ...
  arg0 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_revert_kernel[0][0] +
          idx_z * 1 * 1 * dims_revert_kernel[0][0] * dims_revert_kernel[0][1];
  arg1 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_revert_kernel[1][0] +
          idx_z * 1 * 1 * dims_revert_kernel[1][0] * dims_revert_kernel[1][1];
  arg2 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_revert_kernel[2][0] +
          idx_z * 1 * 1 * dims_revert_kernel[2][0] * dims_revert_kernel[2][1];
  arg3 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_revert_kernel[3][0] +
          idx_z * 1 * 1 * dims_revert_kernel[3][0] * dims_revert_kernel[3][1];
...
// host stub function
#ifndef OPS_LAZY
void ops_par_loop_revert_kernel(char const *name, ops_block block, int dim,
...
void ops_par_loop_revert_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_revert_kernel_h[0][0] ||
      ydim0 != dims_revert_kernel_h[0][1] ||
      xdim1 != dims_revert_kernel_h[1][0] ||
      ydim1 != dims_revert_kernel_h[1][1] ||
      xdim2 != dims_revert_kernel_h[2][0] ||
      ydim2 != dims_revert_kernel_h[2][1] ||
      xdim3 != dims_revert_kernel_h[3][0] ||
      ydim3 != dims_revert_kernel_h[3][1]) {
    ...
    cutilSafeCall(cudaMemcpyToSymbol(dims_revert_kernel, dims_revert_kernel_h,
                                     sizeof(dims_revert_kernel)));
  }
