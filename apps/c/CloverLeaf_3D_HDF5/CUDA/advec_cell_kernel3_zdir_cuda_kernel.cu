...
#define OPS_ACC0(x, y, z)                                                      \
  (x + dims_advec_cell_kernel3_zdir[0][0] * (y) +                              \
   dims_advec_cell_kernel3_zdir[0][0] * dims_advec_cell_kernel3_zdir[0][1] *   \
       (z))
#define OPS_ACC1(x, y, z)                                                      \
  (x + dims_advec_cell_kernel3_zdir[1][0] * (y) +                              \
   dims_advec_cell_kernel3_zdir[1][0] * dims_advec_cell_kernel3_zdir[1][1] *   \
       (z))
#define OPS_ACC2(x, y, z)                                                      \
  (x + dims_advec_cell_kernel3_zdir[2][0] * (y) +                              \
   dims_advec_cell_kernel3_zdir[2][0] * dims_advec_cell_kernel3_zdir[2][1] *   \
       (z))
#define OPS_ACC3(x, y, z)                                                      \
  (x + dims_advec_cell_kernel3_zdir[3][0] * (y) +                              \
   dims_advec_cell_kernel3_zdir[3][0] * dims_advec_cell_kernel3_zdir[3][1] *   \
       (z))
#define OPS_ACC4(x, y, z)                                                      \
  (x + dims_advec_cell_kernel3_zdir[4][0] * (y) +                              \
   dims_advec_cell_kernel3_zdir[4][0] * dims_advec_cell_kernel3_zdir[4][1] *   \
       (z))
#define OPS_ACC5(x, y, z)                                                      \
  (x + dims_advec_cell_kernel3_zdir[5][0] * (y) +                              \
   dims_advec_cell_kernel3_zdir[5][0] * dims_advec_cell_kernel3_zdir[5][1] *   \
       (z))
#define OPS_ACC6(x, y, z)                                                      \
  (x + dims_advec_cell_kernel3_zdir[6][0] * (y) +                              \
   dims_advec_cell_kernel3_zdir[6][0] * dims_advec_cell_kernel3_zdir[6][1] *   \
       (z))
#define OPS_ACC7(x, y, z)                                                      \
  (x + dims_advec_cell_kernel3_zdir[7][0] * (y) +                              \
   dims_advec_cell_kernel3_zdir[7][0] * dims_advec_cell_kernel3_zdir[7][1] *   \
       (z))
...
__global__ void ops_advec_cell_kernel3_zdir(
  ...
  arg0 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_advec_cell_kernel3_zdir[0][0] +
          idx_z * 1 * 1 * dims_advec_cell_kernel3_zdir[0][0] *
              dims_advec_cell_kernel3_zdir[0][1];
  arg1 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_advec_cell_kernel3_zdir[1][0] +
          idx_z * 1 * 1 * dims_advec_cell_kernel3_zdir[1][0] *
              dims_advec_cell_kernel3_zdir[1][1];
  arg2 += idx_x * 0 * 1 + idx_y * 0 * 1 * dims_advec_cell_kernel3_zdir[2][0] +
          idx_z * 1 * 1 * dims_advec_cell_kernel3_zdir[2][0] *
              dims_advec_cell_kernel3_zdir[2][1];
  arg3 += idx_x * 0 * 1 + idx_y * 0 * 1 * dims_advec_cell_kernel3_zdir[3][0] +
          idx_z * 1 * 1 * dims_advec_cell_kernel3_zdir[3][0] *
              dims_advec_cell_kernel3_zdir[3][1];
  arg4 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_advec_cell_kernel3_zdir[4][0] +
          idx_z * 1 * 1 * dims_advec_cell_kernel3_zdir[4][0] *
              dims_advec_cell_kernel3_zdir[4][1];
  arg5 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_advec_cell_kernel3_zdir[5][0] +
          idx_z * 1 * 1 * dims_advec_cell_kernel3_zdir[5][0] *
              dims_advec_cell_kernel3_zdir[5][1];
  arg6 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_advec_cell_kernel3_zdir[6][0] +
          idx_z * 1 * 1 * dims_advec_cell_kernel3_zdir[6][0] *
              dims_advec_cell_kernel3_zdir[6][1];
  arg7 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_advec_cell_kernel3_zdir[7][0] +
          idx_z * 1 * 1 * dims_advec_cell_kernel3_zdir[7][0] *
              dims_advec_cell_kernel3_zdir[7][1];
...
void ops_par_loop_advec_cell_kernel3_zdir_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_advec_cell_kernel3_zdir_h[0][0] ||
      ydim0 != dims_advec_cell_kernel3_zdir_h[0][1] ||
      xdim1 != dims_advec_cell_kernel3_zdir_h[1][0] ||
      ydim1 != dims_advec_cell_kernel3_zdir_h[1][1] ||
      xdim2 != dims_advec_cell_kernel3_zdir_h[2][0] ||
      ydim2 != dims_advec_cell_kernel3_zdir_h[2][1] ||
      xdim3 != dims_advec_cell_kernel3_zdir_h[3][0] ||
      ydim3 != dims_advec_cell_kernel3_zdir_h[3][1] ||
      xdim4 != dims_advec_cell_kernel3_zdir_h[4][0] ||
      ydim4 != dims_advec_cell_kernel3_zdir_h[4][1] ||
      xdim5 != dims_advec_cell_kernel3_zdir_h[5][0] ||
      ydim5 != dims_advec_cell_kernel3_zdir_h[5][1] ||
      xdim6 != dims_advec_cell_kernel3_zdir_h[6][0] ||
      ydim6 != dims_advec_cell_kernel3_zdir_h[6][1] ||
      xdim7 != dims_advec_cell_kernel3_zdir_h[7][0] ||
      ydim7 != dims_advec_cell_kernel3_zdir_h[7][1]) {
    ...
    cutilSafeCall(cudaMemcpyToSymbol(dims_advec_cell_kernel3_zdir,
                                     dims_advec_cell_kernel3_zdir_h,
                                     sizeof(dims_advec_cell_kernel3_zdir)));
  }
