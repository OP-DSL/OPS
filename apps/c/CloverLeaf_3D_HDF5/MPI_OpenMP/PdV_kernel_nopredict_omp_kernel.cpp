...
void ops_par_loop_PdV_kernel_nopredict(
  ...
  offs[14][1] = off3D(1, &start[0], &end[0], args[14].dat->size,
                      args[14].stencil->stride) -
                offs[14][0];
  offs[14][2] = off3D(2, &start[0], &end[0], args[14].dat->size,
                      args[14].stencil->stride) -
                offs[14][1] - offs[14][0];

  offs[15][0] = args[15].stencil->stride[0] * 1; // unit step in x dimension
  offs[15][1] = off3D(1, &start[0], &end[0], args[15].dat->size,
                      args[15].stencil->stride) -
                offs[15][0];
  offs[15][2] = off3D(2, &start[0], &end[0], args[15].dat->size,
                      args[15].stencil->stride) -
                offs[15][1] - offs[15][0];

  offs[16][0] = args[16].stencil->stride[0] * 1; // unit step in x dimension
  offs[16][1] = off3D(1, &start[0], &end[0], args[16].dat->size,
                      args[16].stencil->stride) -
                offs[16][0];
  offs[16][2] = off3D(2, &start[0], &end[0], args[16].dat->size,
                      args[16].stencil->stride) -
                offs[16][1] - offs[16][0];
...
#endif
    int base14 = dat14 * 1 * (start0 * args[14].stencil->stride[0] -
                              args[14].dat->base[0] - d_m[0]);
    base14 =
        base14 +
        dat14 * args[14].dat->size[0] * (start1 * args[14].stencil->stride[1] -
                                         args[14].dat->base[1] - d_m[1]);
    base14 = base14 +
             dat14 * args[14].dat->size[0] * args[14].dat->size[1] *
                 (start2 * args[14].stencil->stride[2] - args[14].dat->base[2] -
                  d_m[2]);
...
#endif
    int base15 = dat15 * 1 * (start0 * args[15].stencil->stride[0] -
                              args[15].dat->base[0] - d_m[0]);
    base15 =
        base15 +
        dat15 * args[15].dat->size[0] * (start1 * args[15].stencil->stride[1] -
                                         args[15].dat->base[1] - d_m[1]);
    base15 = base15 +
             dat15 * args[15].dat->size[0] * args[15].dat->size[1] *
                 (start2 * args[15].stencil->stride[2] - args[15].dat->base[2] -
                  d_m[2]);
...
#endif
    int base16 = dat16 * 1 * (start0 * args[16].stencil->stride[0] -
                              args[16].dat->base[0] - d_m[0]);
    base16 =
        base16 +
        dat16 * args[16].dat->size[0] * (start1 * args[16].stencil->stride[1] -
                                         args[16].dat->base[1] - d_m[1]);
    base16 = base16 +
             dat16 * args[16].dat->size[0] * args[16].dat->size[1] *
                 (start2 * args[16].stencil->stride[2] - args[16].dat->base[2] -
                  d_m[2]);
...
#pragma simd
          for (int i = 0; i < SIMD_VEC; i++) {
            PdV_kernel_nopredict((const double *)p_a[0] + i * 1 * 1,
                                 ...
                                 (double *)p_a[13] + i * 1 * 1,
                                 (const double *)p_a[14] + i * 1 * 1,
                                 (const double *)p_a[15] + i * 1 * 1,
                                 (const double *)p_a[16] + i * 1 * 1);
          }
        ...
        for (int n_x = start[0] + ((end[0] - start[0]) / SIMD_VEC) * SIMD_VEC;
          ...
          PdV_kernel_nopredict((const double *)p_a[0], (const double *)p_a[1],
                               ...
                               (const double *)p_a[14], (const double *)p_a[15],
                               (const double *)p_a[16]);
