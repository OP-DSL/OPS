      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        ACC<double> node_mass_post(
            ...
            node_mass_post_p + n_x * 1 +
                n_y * xdim0_advec_mom_kernel_post_pre_advec_z * 1 +
        ...
        const ACC<double> post_vol(
            ...
            post_vol_p + n_x * 1 +
                n_y * xdim1_advec_mom_kernel_post_pre_advec_z * 1 +
        ...
        const ACC<double> density1(
            ...
            density1_p + n_x * 1 +
                n_y * xdim2_advec_mom_kernel_post_pre_advec_z * 1 +
        ...
        ACC<double> node_mass_pre(
            ...
            node_mass_pre_p + n_x * 1 +
                n_y * xdim3_advec_mom_kernel_post_pre_advec_z * 1 +
        ...
        const ACC<double> node_flux(
            ...
            node_flux_p + n_x * 1 +
                n_y * xdim4_advec_mom_kernel_post_pre_advec_z * 1 +
        ...
        node_mass_pre(0, 0, 0) =
            node_mass_post(0, 0, 0) - node_flux(0, 0, -1) + node_flux(0, 0, 0);
      }
    }
  }
  if (OPS_diags > 1) {
