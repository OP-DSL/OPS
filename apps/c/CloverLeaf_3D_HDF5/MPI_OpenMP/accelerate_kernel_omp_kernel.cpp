...
#pragma simd
          for (int i = 0; i < SIMD_VEC; i++) {
            accelerate_kernel((const double *)p_a[0] + i * 1 * 1,
        ...
        for (int n_x = start[0] + ((end[0] - start[0]) / SIMD_VEC) * SIMD_VEC;
          ...
          accelerate_kernel((const double *)p_a[0], (const double *)p_a[1],
                            ...
                            (const double *)p_a[10], (const double *)p_a[11],
                            (double *)p_a[12], (const double *)p_a[13]);
