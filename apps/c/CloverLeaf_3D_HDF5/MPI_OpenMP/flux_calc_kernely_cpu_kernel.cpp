...
//
#define OPS_ACC0(x,y,z) (n_x*1 + x + (n_y*1+(y))*xdim0_flux_calc_kernely + (n_z*1+(z))*xdim0_flux_calc_kernely*ydim0_flux_calc_kernely)
#define OPS_ACC1(x,y,z) (n_x*1 + x + (n_y*1+(y))*xdim1_flux_calc_kernely + (n_z*1+(z))*xdim1_flux_calc_kernely*ydim1_flux_calc_kernely)
#define OPS_ACC2(x,y,z) (n_x*1 + x + (n_y*1+(y))*xdim2_flux_calc_kernely + (n_z*1+(z))*xdim2_flux_calc_kernely*ydim2_flux_calc_kernely)
#define OPS_ACC3(x,y,z) (n_x*1 + x + (n_y*1+(y))*xdim3_flux_calc_kernely + (n_z*1+(z))*xdim3_flux_calc_kernely*ydim3_flux_calc_kernely)
