...
#pragma simd
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        ACC<double> vol_flux_z(
            ...
            vol_flux_z_p + n_x * 1 +
                n_y * xdim0_update_halo_kernel5_minus_2_back * 1 +
