...
#pragma simd
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        ACC<double> vol_flux_z(xdim0_update_halo_kernel5_plus_4_a,
        ...
        ACC<double> mass_flux_z(xdim1_update_halo_kernel5_plus_4_a,
                                ydim1_update_halo_kernel5_plus_4_a,
                                mass_flux_z_p + n_x * 1 +
                                    n_y * xdim1_update_halo_kernel5_plus_4_a *
                                        1 +
