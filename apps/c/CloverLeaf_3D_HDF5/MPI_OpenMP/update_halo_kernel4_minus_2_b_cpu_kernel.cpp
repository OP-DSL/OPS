...
#define OPS_ACC0(x, y, z)                                                      \
  (n_x * 1 + x + (n_y * 1 + (y)) * xdim0_update_halo_kernel4_minus_2_b +       \
   (n_z * 1 + (z)) * xdim0_update_halo_kernel4_minus_2_b *                     \
       ydim0_update_halo_kernel4_minus_2_b)
#define OPS_ACC1(x, y, z)                                                      \
  (n_x * 1 + x + (n_y * 1 + (y)) * xdim1_update_halo_kernel4_minus_2_b +       \
   (n_z * 1 + (z)) * xdim1_update_halo_kernel4_minus_2_b *                     \
