...
#pragma simd
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        ACC<double> node_flux(xdim0_advec_mom_kernel_mass_flux_x,
                              ydim0_advec_mom_kernel_mass_flux_x,
                              node_flux_p + n_x * 1 +
                                  n_y * xdim0_advec_mom_kernel_mass_flux_x * 1 +
        ...
        const ACC<double> mass_flux_x(
            ...
            mass_flux_x_p + n_x * 1 +
                n_y * xdim1_advec_mom_kernel_mass_flux_x * 1 +
                n_z * xdim1_advec_mom_kernel_mass_flux_x *
                    ydim1_advec_mom_kernel_mass_flux_x * 1);

        node_flux(0, 0, 0) =
            0.125 * (mass_flux_x(0, -1, 0) + mass_flux_x(0, 0, 0) +
