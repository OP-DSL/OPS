...
void ops_par_loop_advec_cell_kernel4_zdir_execute(ops_kernel_descriptor *desc) {
  ...
  if (OPS_diags > 1) {
    ...
    OPS_kernels[119].mpi_time += __t1-__t2;
  }
...
#pragma simd
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        ...
        post_mass(0, 0, 0) =
            pre_mass(0, 0, 0) + mass_flux_z(0, 0, 0) - mass_flux_z(0, 0, 1);
        post_ener(0, 0, 0) = (energy1(0, 0, 0) * pre_mass(0, 0, 0) +
                              ener_flux(0, 0, 0) - ener_flux(0, 0, 1)) /
                             post_mass(0, 0, 0);
        advec_vol(0, 0, 0) =
            pre_vol(0, 0, 0) + vol_flux_z(0, 0, 0) - vol_flux_z(0, 0, 1);
  ...
  if (OPS_diags > 1) {
    ops_timers_core(&__c2,&__t2);
    OPS_kernels[119].time += __t2-__t1;
  }
  #ifndef OPS_LAZY
