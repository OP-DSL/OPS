...
#pragma simd
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        ACC<double> vel1(xdim0_advec_mom_kernel2_x, ydim0_advec_mom_kernel2_x,
                         vel1_p + n_x * 1 +
                             n_y * xdim0_advec_mom_kernel2_x * 1 +
                             n_z * xdim0_advec_mom_kernel2_x *
                                 ydim0_advec_mom_kernel2_x * 1);
        const ACC<double> node_mass_post(
            ...
            node_mass_post_p + n_x * 1 + n_y * xdim1_advec_mom_kernel2_x * 1 +
                n_z * xdim1_advec_mom_kernel2_x * ydim1_advec_mom_kernel2_x *
                    1);
        const ACC<double> node_mass_pre(
            ...
            node_mass_pre_p + n_x * 1 + n_y * xdim2_advec_mom_kernel2_x * 1 +
                n_z * xdim2_advec_mom_kernel2_x * ydim2_advec_mom_kernel2_x *
                    1);
