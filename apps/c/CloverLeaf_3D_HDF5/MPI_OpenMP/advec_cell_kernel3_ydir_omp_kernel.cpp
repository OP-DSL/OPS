...
#pragma simd
          for (int i = 0; i < SIMD_VEC; i++) {
            advec_cell_kernel3_ydir((const double *)p_a[0] + i * 1 * 1,
                                    (const double *)p_a[1] + i * 1 * 1,
                                    (const int *)p_a[2] + i * 0 * 1,
                                    (const double *)p_a[3] + i * 0 * 1,
        ...
        for (int n_x = start[0] + ((end[0] - start[0]) / SIMD_VEC) * SIMD_VEC;
          ...
          advec_cell_kernel3_ydir(
              (const double *)p_a[0], (const double *)p_a[1],
              (const int *)p_a[2], (const double *)p_a[3],
              (const double *)p_a[4], (const double *)p_a[5], (double *)p_a[6],
              (double *)p_a[7]);
