...
#pragma simd
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        ACC<double> vol_flux_x(
            ...
            vol_flux_x_p + n_x * 1 +
                n_y * xdim0_update_halo_kernel3_plus_2_back * 1 +
        ...
        ACC<double> mass_flux_x(
            ...
            mass_flux_x_p + n_x * 1 +
                n_y * xdim1_update_halo_kernel3_plus_2_back * 1 +
                n_z * xdim1_update_halo_kernel3_plus_2_back *
                    ydim1_update_halo_kernel3_plus_2_back * 1);

        if (fields[FIELD_VOL_FLUX_X] == 1)
          vol_flux_x(0, 0, 0) = vol_flux_x(0, 0, 2);
        if (fields[FIELD_MASS_FLUX_X] == 1)
          mass_flux_x(0, 0, 0) = mass_flux_x(0, 0, 2);
      }
    }
  }
  if (OPS_diags > 1) {
