...
#define OPS_ACC0(x, y, z)                                                      \
  (n_x * 1 + x + (n_y * 1 + (y)) * xdim0_update_halo_kernel1_r2 +              \
   (n_z * 1 + (z)) * xdim0_update_halo_kernel1_r2 *                            \
       ydim0_update_halo_kernel1_r2)
#define OPS_ACC1(x, y, z)                                                      \
  (n_x * 1 + x + (n_y * 1 + (y)) * xdim1_update_halo_kernel1_r2 +              \
   (n_z * 1 + (z)) * xdim1_update_halo_kernel1_r2 *                            \
       ydim1_update_halo_kernel1_r2)
#define OPS_ACC2(x, y, z)                                                      \
  (n_x * 1 + x + (n_y * 1 + (y)) * xdim2_update_halo_kernel1_r2 +              \
   (n_z * 1 + (z)) * xdim2_update_halo_kernel1_r2 *                            \
       ydim2_update_halo_kernel1_r2)
#define OPS_ACC3(x, y, z)                                                      \
  (n_x * 1 + x + (n_y * 1 + (y)) * xdim3_update_halo_kernel1_r2 +              \
   (n_z * 1 + (z)) * xdim3_update_halo_kernel1_r2 *                            \
       ydim3_update_halo_kernel1_r2)
#define OPS_ACC4(x, y, z)                                                      \
  (n_x * 1 + x + (n_y * 1 + (y)) * xdim4_update_halo_kernel1_r2 +              \
   (n_z * 1 + (z)) * xdim4_update_halo_kernel1_r2 *                            \
       ydim4_update_halo_kernel1_r2)
#define OPS_ACC5(x, y, z)                                                      \
  (n_x * 1 + x + (n_y * 1 + (y)) * xdim5_update_halo_kernel1_r2 +              \
   (n_z * 1 + (z)) * xdim5_update_halo_kernel1_r2 *                            \
       ydim5_update_halo_kernel1_r2)
#define OPS_ACC6(x, y, z)                                                      \
  (n_x * 1 + x + (n_y * 1 + (y)) * xdim6_update_halo_kernel1_r2 +              \
   (n_z * 1 + (z)) * xdim6_update_halo_kernel1_r2 *                            \
