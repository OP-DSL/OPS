...
#pragma simd
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        ...
        const ACC<double> volume(
            ...
            volume_p + n_x * 1 + n_y * xdim2_advec_mom_kernel_z3 * 1 +
        ...
        const ACC<double> vol_flux_z(
            ...
            vol_flux_z_p + n_x * 1 + n_y * xdim3_advec_mom_kernel_z3 * 1 +
