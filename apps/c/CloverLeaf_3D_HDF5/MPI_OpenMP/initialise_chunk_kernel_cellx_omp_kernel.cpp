...
// user function
inline void initialise_chunk_kernel_cellx(const double *vertexx, double *cellx,
                                          double *celldx) {
...
#pragma simd
          for (int i = 0; i < SIMD_VEC; i++) {
            initialise_chunk_kernel_cellx((const double *)p_a[0] + i * 1 * 1,
                                          (double *)p_a[1] + i * 1 * 1,
                                          (double *)p_a[2] + i * 1 * 1);
          }
        ...
        for (int n_x = start[0] + ((end[0] - start[0]) / SIMD_VEC) * SIMD_VEC;
          ...
          initialise_chunk_kernel_cellx((const double *)p_a[0],
