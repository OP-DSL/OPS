...
//
#define OPS_ACC0(x,y,z) (n_x*1 + x + (n_y*1+(y))*xdim0_revert_kernel + (n_z*1+(z))*xdim0_revert_kernel*ydim0_revert_kernel)
#define OPS_ACC1(x,y,z) (n_x*1 + x + (n_y*1+(y))*xdim1_revert_kernel + (n_z*1+(z))*xdim1_revert_kernel*ydim1_revert_kernel)
#define OPS_ACC2(x,y,z) (n_x*1 + x + (n_y*1+(y))*xdim2_revert_kernel + (n_z*1+(z))*xdim2_revert_kernel*ydim2_revert_kernel)
#define OPS_ACC3(x,y,z) (n_x*1 + x + (n_y*1+(y))*xdim3_revert_kernel + (n_z*1+(z))*xdim3_revert_kernel*ydim3_revert_kernel)
