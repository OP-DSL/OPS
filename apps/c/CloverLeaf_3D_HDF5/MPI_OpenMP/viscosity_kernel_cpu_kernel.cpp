...
#pragma simd
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        ...
        double ugradx2 =
            xvel0(1, 0, 0) + xvel0(1, 1, 0) + xvel0(1, 0, 1) + xvel0(1, 1, 1);
        double ugrady1 =
            xvel0(0, 0, 0) + xvel0(1, 0, 0) + xvel0(0, 0, 1) + xvel0(1, 0, 1);
        double ugrady2 =
            xvel0(0, 1, 0) + xvel0(1, 1, 0) + xvel0(0, 1, 1) + xvel0(1, 1, 1);
        double ugradz1 =
            xvel0(0, 0, 0) + xvel0(1, 0, 0) + xvel0(0, 1, 0) + xvel0(1, 1, 0);
        double ugradz2 =
            xvel0(0, 0, 1) + xvel0(1, 0, 1) + xvel0(0, 1, 1) + xvel0(1, 1, 1);

        double vgradx1 =
            yvel0(0, 0, 0) + yvel0(0, 1, 0) + yvel0(0, 0, 1) + yvel0(0, 1, 1);
        double vgradx2 =
            yvel0(1, 0, 0) + yvel0(1, 1, 0) + yvel0(1, 0, 1) + yvel0(1, 1, 1);
        double vgrady1 =
            yvel0(0, 0, 0) + yvel0(1, 0, 0) + yvel0(0, 0, 1) + yvel0(1, 0, 1);
        double vgrady2 =
            yvel0(0, 1, 0) + yvel0(1, 1, 0) + yvel0(0, 1, 1) + yvel0(1, 1, 1);
        double vgradz1 =
            yvel0(0, 0, 0) + yvel0(1, 0, 0) + yvel0(0, 1, 0) + yvel0(1, 1, 0);
        double vgradz2 =
            yvel0(0, 0, 1) + yvel0(1, 0, 1) + yvel0(0, 1, 1) + yvel0(1, 1, 1);

        double wgradx1 =
            zvel0(0, 0, 0) + zvel0(0, 1, 0) + zvel0(0, 0, 1) + zvel0(0, 1, 1);
        double wgradx2 =
            zvel0(1, 0, 0) + zvel0(1, 1, 0) + zvel0(1, 0, 1) + zvel0(1, 1, 1);
        double wgrady1 =
            zvel0(0, 0, 0) + zvel0(1, 0, 0) + zvel0(0, 0, 1) + zvel0(1, 0, 1);
        double wgrady2 =
            zvel0(0, 1, 0) + zvel0(1, 1, 0) + zvel0(0, 1, 1) + zvel0(1, 1, 1);
        double wgradz1 =
            zvel0(0, 0, 0) + zvel0(1, 0, 0) + zvel0(0, 1, 0) + zvel0(1, 1, 0);
        double wgradz2 =
            zvel0(0, 0, 1) + zvel0(1, 0, 1) + zvel0(0, 1, 1) + zvel0(1, 1, 1);

        div = xarea(0, 0, 0) * (ugradx2 - ugradx1) +
              yarea(0, 0, 0) * (vgrady2 - vgrady1) +
              zarea(0, 0, 0) * (wgradz2 - wgradz1);
        ...
        double xy = 0.25 * (ugrady2 - ugrady1) / (celldy(0, 0, 0)) +
                    0.25 * (vgradx2 - vgradx1) / (celldx(0, 0, 0));
        double xz = 0.25 * (ugradz2 - ugradz1) / (celldz(0, 0, 0)) +
                    0.25 * (wgradx2 - wgradx1) / (celldx(0, 0, 0));
        double yz = 0.25 * (vgradz2 - vgradz1) / (celldz(0, 0, 0)) +
                    0.25 * (wgrady2 - wgrady1) / (celldy(0, 0, 0));

        pgradx = (pressure(1, 0, 0) - pressure(-1, 0, 0)) /
                 (celldx(0, 0, 0) + celldx(1, 0, 0));
        pgrady = (pressure(0, 1, 0) - pressure(0, -1, 0)) /
                 (celldy(0, 0, 0) + celldy(0, 1, 0));
        pgradz = (pressure(0, 0, 1) - pressure(0, 0, -1)) /
                 (celldz(0, 0, 0) + celldz(0, 0, 1));
