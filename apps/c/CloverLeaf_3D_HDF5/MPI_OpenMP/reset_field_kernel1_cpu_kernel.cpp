...
void ops_par_loop_reset_field_kernel1_execute(ops_kernel_descriptor *desc) {
  ...
  if (OPS_diags > 1) {
    ...
    OPS_kernels[138].mpi_time += __t1-__t2;
  }
...
#pragma simd
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        ACC<double> density0(
            ...
            density0_p + n_x * 1 + n_y * xdim0_reset_field_kernel1 * 1 +
        ...
        const ACC<double> energy1(
            ...
            energy1_p + n_x * 1 + n_y * xdim3_reset_field_kernel1 * 1 +
  ...
  if (OPS_diags > 1) {
    ops_timers_core(&__c2,&__t2);
    OPS_kernels[138].time += __t2-__t1;
  }
  #ifndef OPS_LAZY
