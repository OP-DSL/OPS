...
#pragma simd
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        ACC<double> vel1(xdim0_advec_mom_kernel2_z, ydim0_advec_mom_kernel2_z,
                         vel1_p + n_x * 1 +
                             n_y * xdim0_advec_mom_kernel2_z * 1 +
                             n_z * xdim0_advec_mom_kernel2_z *
                                 ydim0_advec_mom_kernel2_z * 1);
