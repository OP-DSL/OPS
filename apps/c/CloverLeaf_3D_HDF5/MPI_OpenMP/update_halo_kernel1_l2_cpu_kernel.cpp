...
#pragma simd
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        ...
        if (fields[FIELD_DENSITY0] == 1)
          density0(0, 0, 0) = density0(3, 0, 0);
        if (fields[FIELD_DENSITY1] == 1)
          density1(0, 0, 0) = density1(3, 0, 0);
        if (fields[FIELD_ENERGY0] == 1)
          energy0(0, 0, 0) = energy0(3, 0, 0);
        if (fields[FIELD_ENERGY1] == 1)
          energy1(0, 0, 0) = energy1(3, 0, 0);
        if (fields[FIELD_PRESSURE] == 1)
          pressure(0, 0, 0) = pressure(3, 0, 0);
        if (fields[FIELD_VISCOSITY] == 1)
          viscosity(0, 0, 0) = viscosity(3, 0, 0);
        if (fields[FIELD_SOUNDSPEED] == 1)
          soundspeed(0, 0, 0) = soundspeed(3, 0, 0);
      }
    }
  }
  if (OPS_diags > 1) {
