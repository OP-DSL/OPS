...
//
#define OPS_ACC0(x,y,z) (n_x*1 + x + (n_y*1+(y))*xdim0_ideal_gas_kernel + (n_z*1+(z))*xdim0_ideal_gas_kernel*ydim0_ideal_gas_kernel)
#define OPS_ACC1(x,y,z) (n_x*1 + x + (n_y*1+(y))*xdim1_ideal_gas_kernel + (n_z*1+(z))*xdim1_ideal_gas_kernel*ydim1_ideal_gas_kernel)
#define OPS_ACC2(x,y,z) (n_x*1 + x + (n_y*1+(y))*xdim2_ideal_gas_kernel + (n_z*1+(z))*xdim2_ideal_gas_kernel*ydim2_ideal_gas_kernel)
#define OPS_ACC3(x,y,z) (n_x*1 + x + (n_y*1+(y))*xdim3_ideal_gas_kernel + (n_z*1+(z))*xdim3_ideal_gas_kernel*ydim3_ideal_gas_kernel)
