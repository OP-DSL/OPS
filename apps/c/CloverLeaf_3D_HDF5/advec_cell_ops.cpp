...
void advec_cell(int sweep_number, int dir) {
  ...
  int rangexyz_inner_plus2yz[] = {x_min,     x_max, y_min,
                                  y_max + 2, z_min, z_max + 2};
  ...
  if (dir == g_xdir) {
    ...
    if (sweep_number == 1) {
      ops_par_loop_advec_cell_kernel1_xdir(
          "advec_cell_kernel1_xdir", clover_grid, 3, rangexyz,
      ...
      ops_par_loop_advec_cell_kernel2_xdir(
          "advec_cell_kernel2_xdir", clover_grid, 3, rangexyz,
          ops_arg_dat(work_array1, 1, S3D_000, "double", OPS_WRITE),
          ops_arg_dat(work_array2, 1, S3D_000, "double", OPS_WRITE),
          ops_arg_dat(volume, 1, S3D_000, "double", OPS_READ),
          ops_arg_dat(vol_flux_x, 1, S3D_000_P100, "double", OPS_READ));
    ...
    ops_par_loop_advec_cell_kernel3_xdir(
        "advec_cell_kernel3_xdir", clover_grid, 3, rangexyz_inner_plus2x,
        ...
        ops_arg_dat(vertexdx, 1, S3D_000_P100_M100_STRID3D_X, "double",
                    OPS_READ),
    ...
    ops_par_loop_advec_cell_kernel4_xdir(
        "advec_cell_kernel4_xdir", clover_grid, 3, rangexyz_inner,
    ...
    if (sweep_number == 2) {
      if (advect_x) {
        ops_par_loop_advec_cell_kernel1_ydir(
            "advec_cell_kernel1_ydir", clover_grid, 3, rangexyz,
            ops_arg_dat(work_array1, 1, S3D_000, "double", OPS_WRITE),
            ops_arg_dat(work_array2, 1, S3D_000, "double", OPS_WRITE),
            ops_arg_dat(volume, 1, S3D_000, "double", OPS_READ),
            ops_arg_dat(vol_flux_z, 1, S3D_000_00P1, "double", OPS_READ),
        ...
        ops_par_loop_advec_cell_kernel2_ydir(
            "advec_cell_kernel2_ydir", clover_grid, 3, rangexyz,
            ops_arg_dat(work_array1, 1, S3D_000, "double", OPS_WRITE),
            ops_arg_dat(work_array2, 1, S3D_000, "double", OPS_WRITE),
            ops_arg_dat(volume, 1, S3D_000, "double", OPS_READ),
            ops_arg_dat(vol_flux_y, 1, S3D_000_0P10, "double", OPS_READ),
    ...
    ops_par_loop_advec_cell_kernel3_ydir(
        ...
        ops_arg_dat(vertexdy, 1, S3D_000_0P10_0M10_STRID3D_Y, "double",
                    OPS_READ),
    ...
    ops_par_loop_advec_cell_kernel4_ydir(
        "advec_cell_kernel4_ydir", clover_grid, 3, rangexyz_inner,
        ops_arg_dat(density1, 1, S3D_000, "double", OPS_RW),
        ops_arg_dat(energy1, 1, S3D_000, "double", OPS_RW),
    ...
    if (sweep_number == 1) {
      ops_par_loop_advec_cell_kernel1_zdir(
          "advec_cell_kernel1_zdir", clover_grid, 3, rangexyz,
          ops_arg_dat(work_array1, 1, S3D_000, "double", OPS_WRITE),
          ops_arg_dat(work_array2, 1, S3D_000, "double", OPS_WRITE),
          ops_arg_dat(volume, 1, S3D_000, "double", OPS_READ),
          ops_arg_dat(vol_flux_x, 1, S3D_000_P100, "double", OPS_READ),
      ...
      ops_par_loop_advec_cell_kernel2_zdir(
          "advec_cell_kernel2_zdir", clover_grid, 3, rangexyz,
          ops_arg_dat(work_array1, 1, S3D_000, "double", OPS_WRITE),
          ops_arg_dat(work_array2, 1, S3D_000, "double", OPS_WRITE),
          ops_arg_dat(volume, 1, S3D_000, "double", OPS_READ),
          ops_arg_dat(vol_flux_z, 1, S3D_000_00P1, "double", OPS_READ));
    ...
    ops_par_loop_advec_cell_kernel3_zdir(
        "advec_cell_kernel3_zdir", clover_grid, 3, rangexyz_inner_plus2z,
        ...
        ops_arg_dat(vertexdz, 1, S3D_000_00P1_00M1_STRID3D_Z, "double",
                    OPS_READ),
    ...
    ops_par_loop_advec_cell_kernel4_zdir(
        "advec_cell_kernel4_zdir", clover_grid, 3, rangexyz_inner,
        ops_arg_dat(density1, 1, S3D_000, "double", OPS_RW),
        ops_arg_dat(energy1, 1, S3D_000, "double", OPS_RW),
