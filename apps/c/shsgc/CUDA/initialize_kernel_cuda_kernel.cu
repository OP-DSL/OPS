...
void ops_par_loop_initialize_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_initialize_kernel_h[0][0] ||
      xdim1 != dims_initialize_kernel_h[1][0] ||
      xdim2 != dims_initialize_kernel_h[2][0] ||
      xdim3 != dims_initialize_kernel_h[3][0] ||
      xdim4 != dims_initialize_kernel_h[4][0]) {
    ...
    cutilSafeCall(cudaMemcpyToSymbol(dims_initialize_kernel,
                                     dims_initialize_kernel_h,
                                     sizeof(dims_initialize_kernel)));
  }
  ...
  if (x_size > 0)
    ops_initialize_kernel<<<grid, tblock>>>(
