...
__global__ void ops_updateRK3_kernel(
    ...
    const double *__restrict arg8, const double arg9, const double arg10,
    int size0) {
...
void ops_par_loop_updateRK3_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_updateRK3_kernel_h[0][0] ||
      xdim1 != dims_updateRK3_kernel_h[1][0] ||
      xdim2 != dims_updateRK3_kernel_h[2][0] ||
      xdim3 != dims_updateRK3_kernel_h[3][0] ||
      xdim4 != dims_updateRK3_kernel_h[4][0] ||
      xdim5 != dims_updateRK3_kernel_h[5][0] ||
      xdim6 != dims_updateRK3_kernel_h[6][0] ||
      xdim7 != dims_updateRK3_kernel_h[7][0] ||
      xdim8 != dims_updateRK3_kernel_h[8][0]) {
    ...
    cutilSafeCall(cudaMemcpyToSymbol(dims_updateRK3_kernel,
                                     dims_updateRK3_kernel_h,
                                     sizeof(dims_updateRK3_kernel)));
  }
