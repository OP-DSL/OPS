...
__global__ void ops_drhoudx_kernel(const double *__restrict arg0,
...
void ops_par_loop_drhoudx_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_drhoudx_kernel_h[0][0] ||
      xdim1 != dims_drhoudx_kernel_h[1][0]) {
    dims_drhoudx_kernel_h[0][0] = xdim0;
    dims_drhoudx_kernel_h[1][0] = xdim1;
    cutilSafeCall(cudaMemcpyToSymbol(dims_drhoudx_kernel, dims_drhoudx_kernel_h,
                                     sizeof(dims_drhoudx_kernel)));
  }
