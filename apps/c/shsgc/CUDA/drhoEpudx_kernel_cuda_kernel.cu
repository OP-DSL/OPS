...
void ops_par_loop_drhoEpudx_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_drhoEpudx_kernel_h[0][0] ||
      xdim1 != dims_drhoEpudx_kernel_h[1][0] ||
      xdim2 != dims_drhoEpudx_kernel_h[2][0] ||
      xdim3 != dims_drhoEpudx_kernel_h[3][0]) {
    ...
    cutilSafeCall(cudaMemcpyToSymbol(dims_drhoEpudx_kernel,
                                     dims_drhoEpudx_kernel_h,
                                     sizeof(dims_drhoEpudx_kernel)));
  }
