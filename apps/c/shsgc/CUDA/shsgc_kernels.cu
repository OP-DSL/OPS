...
int size, char *dat, char const *name){
  ...
  if (!strcmp(name,"yhalo")) {
    cutilSafeCall(OPS_instance::getOPSInstance()->ostream(),cudaMemcpyToSymbol(yhalo, dat, dim*size));
  }
  else
  if (!strcmp(name,"xmin")) {
  ...
  if (!strcmp(name,"ymin")) {
    cutilSafeCall(OPS_instance::getOPSInstance()->ostream(),cudaMemcpyToSymbol(ymin, dat, dim*size));
  }
  else
  if (!strcmp(name,"xmax")) {
  ...
  if (!strcmp(name,"ymax")) {
    cutilSafeCall(OPS_instance::getOPSInstance()->ostream(),cudaMemcpyToSymbol(ymax, dat, dim*size));
  }
  else
  if (!strcmp(name,"dx")) {
