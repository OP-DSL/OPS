...
void ops_par_loop_zerores_kernel(char const *, ops_block, int, int *, ops_arg,
                                 ops_arg, ops_arg);

void ops_par_loop_drhoudx_kernel(char const *, ops_block, int, int *, ops_arg,
                                 ops_arg);

void ops_par_loop_drhouupdx_kernel(char const *, ops_block, int, int *, ops_arg,
                                   ops_arg, ops_arg, ops_arg);

void ops_par_loop_drhoEpudx_kernel(char const *, ops_block, int, int *, ops_arg,
                                   ops_arg, ops_arg, ops_arg);
...
void ops_par_loop_test_kernel(char const *, ops_block, int, int *, ops_arg,
                              ops_arg);
...
int main(int argc, char **argv) {
  ...
  rho_old = ops_decl_dat(shsgc_grid, 1, size, base, d_m, d_p, temp, "double",
                         "rho_old");
  rho_new = ops_decl_dat(shsgc_grid, 1, size, base, d_m, d_p, temp, "double",
                         "rho_new");
  rho_res = ops_decl_dat(shsgc_grid, 1, size, base, d_m, d_p, temp, "double",
                         "rho_res");

  rhou_old = ops_decl_dat(shsgc_grid, 1, size, base, d_m, d_p, temp, "double",
                          "rhou_old");
  rhou_new = ops_decl_dat(shsgc_grid, 1, size, base, d_m, d_p, temp, "double",
                          "rhou_new");
  rhou_res = ops_decl_dat(shsgc_grid, 1, size, base, d_m, d_p, temp, "double",
                          "rhou_res");

  rhov_old = ops_decl_dat(shsgc_grid, 1, size, base, d_m, d_p, temp, "double",
                          "rhov_old");
  rhov_new = ops_decl_dat(shsgc_grid, 1, size, base, d_m, d_p, temp, "double",
                          "rhov_new");

  rhoE_old = ops_decl_dat(shsgc_grid, 1, size, base, d_m, d_p, temp, "double",
                          "rhoE_old");
  rhoE_new = ops_decl_dat(shsgc_grid, 1, size, base, d_m, d_p, temp, "double",
                          "rhoE_new");
  rhoE_res = ops_decl_dat(shsgc_grid, 1, size, base, d_m, d_p, temp, "double",
                          "rhoE_res");

  rhoin = ops_decl_dat(shsgc_grid, 1, size, base, d_m, d_p, temp, "double",
                       "rhoin");

  r = ops_decl_dat(shsgc_grid, 9, size, base, d_m, d_p, temp, "double", "r");
  al = ops_decl_dat(shsgc_grid, 3, size, base, d_m, d_p, temp, "double", "al");
  alam =
      ops_decl_dat(shsgc_grid, 3, size, base, d_m, d_p, temp, "double", "alam");
  gt = ops_decl_dat(shsgc_grid, 3, size, base, d_m, d_p, temp, "double", "gt");
  tht =
      ops_decl_dat(shsgc_grid, 3, size, base, d_m, d_p, temp, "double", "tht");
  ep2 =
      ops_decl_dat(shsgc_grid, 3, size, base, d_m, d_p, temp, "double", "ep2");
  cmp =
      ops_decl_dat(shsgc_grid, 3, size, base, d_m, d_p, temp, "double", "cmp");
  cf = ops_decl_dat(shsgc_grid, 3, size, base, d_m, d_p, temp, "double", "cf");
  eff =
      ops_decl_dat(shsgc_grid, 3, size, base, d_m, d_p, temp, "double", "eff");
  ...
  int nxp_range[] = {0, nxp};
  ops_par_loop_initialize_kernel(
      "initialize_kernel", shsgc_grid, 1, nxp_range,
      ...
      ops_arg_dat(rhoin, 1, S1D_0, "double", OPS_WRITE), ops_arg_idx());
  ...
  for (int iter = 0; iter < niter; iter++) {
    ...
    ops_par_loop_save_kernel(
        "save_kernel", shsgc_grid, 1, nxp_range,
    ...
    for (int nrk = 0; nrk < 3; nrk++) {
      ...
      ops_par_loop_zerores_kernel(
          "zerores_kernel", shsgc_grid, 1, nxp_range,
      ...
      ops_par_loop_drhoudx_kernel(
          "drhoudx_kernel", shsgc_grid, 1, nxp_range_1,
          ops_arg_dat(rhou_new, 1, S1D_0M1M2P1P2, "double", OPS_READ),
          ops_arg_dat(rho_res, 1, S1D_0, "double", OPS_WRITE));

      ops_par_loop_drhouupdx_kernel(
          "drhouupdx_kernel", shsgc_grid, 1, nxp_range_1,
          ops_arg_dat(rhou_new, 1, S1D_0M1M2P1P2, "double", OPS_READ),
          ops_arg_dat(rho_new, 1, S1D_0M1M2P1P2, "double", OPS_READ),
          ops_arg_dat(rhoE_new, 1, S1D_0M1M2P1P2, "double", OPS_READ),
          ops_arg_dat(rhou_res, 1, S1D_0, "double", OPS_WRITE));

      ops_par_loop_drhoEpudx_kernel(
          "drhoEpudx_kernel", shsgc_grid, 1, nxp_range_1,
          ops_arg_dat(rhou_new, 1, S1D_0M1M2P1P2, "double", OPS_READ),
          ops_arg_dat(rho_new, 1, S1D_0M1M2P1P2, "double", OPS_READ),
          ops_arg_dat(rhoE_new, 1, S1D_0M1M2P1P2, "double", OPS_READ),
          ops_arg_dat(rhoE_res, 1, S1D_0, "double", OPS_WRITE));
      ...
      ops_par_loop_updateRK3_kernel(
          "updateRK3_kernel", shsgc_grid, 1, nxp_range_2,
          ops_arg_dat(rho_new, 1, S1D_0, "double", OPS_WRITE),
          ops_arg_dat(rhou_new, 1, S1D_0, "double", OPS_WRITE),
          ops_arg_dat(rhoE_new, 1, S1D_0, "double", OPS_WRITE),
    ...
    ops_par_loop_Riemann_kernel(
        "Riemann_kernel", shsgc_grid, 1, nxp_range_3,
    ...
    ops_par_loop_calupwindeff_kernel(
        "calupwindeff_kernel", shsgc_grid, 1, nxp_range_3,
    ...
    ops_par_loop_update_kernel(
        "update_kernel", shsgc_grid, 1, nxp_range_5,
