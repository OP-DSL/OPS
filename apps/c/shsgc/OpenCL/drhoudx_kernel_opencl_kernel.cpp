...
void buildOpenCLKernels_drhoudx_kernel(OPS_instance *instance, int xdim0,
                                       int xdim1) {
  ...
  if (!isbuilt_drhoudx_kernel) {
    ...
    instance->ostream() << "Compiling drhoudx_kernel " << OCL_FMA
                        << " source -- start \n";
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts,
                ...
                "-Dxdim0_drhoudx_kernel=%d  -Dxdim1_drhoudx_kernel=%d ",
