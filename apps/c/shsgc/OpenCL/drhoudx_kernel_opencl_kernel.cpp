...
void buildOpenCLKernels_drhoudx_kernel(int xdim0, int xdim1) {
  ...
  if(!isbuilt_drhoudx_kernel) {
    ...
    OPS_opencl_core.kernel[3] = clCreateKernel(OPS_opencl_core.program, "ops_drhoudx_kernel", &ret);
    clSafeCall( ret );
...
void ops_par_loop_drhoudx_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[3], 2, sizeof(cl_double), (void*) &dx ));
