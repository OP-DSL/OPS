...
void buildOpenCLKernels_drhoEpudx_kernel(int xdim0, int xdim1, int xdim2, int xdim3) {
  ...
  if(!isbuilt_drhoEpudx_kernel) {
    ...
    OPS_opencl_core.kernel[5] = clCreateKernel(OPS_opencl_core.program, "ops_drhoEpudx_kernel", &ret);
    clSafeCall( ret );
...
void ops_par_loop_drhoEpudx_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3) {
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[5], 4, sizeof(cl_double), (void*) &dx ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[5], 5, sizeof(cl_double), (void*) &gam1 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[5], 6, sizeof(cl_int), (void*) &base0 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[5], 7, sizeof(cl_int), (void*) &base1 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[5], 8, sizeof(cl_int), (void*) &base2 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[5], 9, sizeof(cl_int), (void*) &base3 ));
