...
void buildOpenCLKernels_drhouupdx_kernel(int xdim0, int xdim1, int xdim2, int xdim3) {
  ...
  if(!isbuilt_drhouupdx_kernel) {
    ...
    OPS_opencl_core.kernel[4] = clCreateKernel(OPS_opencl_core.program, "ops_drhouupdx_kernel", &ret);
    clSafeCall( ret );
...
void ops_par_loop_drhouupdx_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3) {
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[4], 4, sizeof(cl_double), (void*) &dx ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[4], 5, sizeof(cl_double), (void*) &gam1 ));
