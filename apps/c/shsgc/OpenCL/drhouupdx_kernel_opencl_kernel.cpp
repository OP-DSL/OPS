...
void buildOpenCLKernels_drhouupdx_kernel(int xdim0, int xdim1, int xdim2,
                                         int xdim3) {
  ...
  if (!isbuilt_drhouupdx_kernel) {
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts,
                ...
                "-Dxdim0_drhouupdx_kernel=%d  -Dxdim1_drhouupdx_kernel=%d  "
                "-Dxdim2_drhouupdx_kernel=%d  -Dxdim3_drhouupdx_kernel=%d ",
    ...
    OPS_opencl_core.kernel[4] =
        clCreateKernel(OPS_opencl_core.program, "ops_drhouupdx_kernel", &ret);
    clSafeCall(ret);
...
void ops_par_loop_drhouupdx_kernel(char const *name, ops_block block, int dim,
  ...
  buildOpenCLKernels_drhouupdx_kernel(xdim0, xdim1, xdim2, xdim3);
  ...
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 3, sizeof(cl_mem),
                            (void *)&arg3.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 4, sizeof(cl_double),
                            (void *)&dx));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 5, sizeof(cl_double),
                            (void *)&gam1));
  ...
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 9, sizeof(cl_int),
                            (void *)&base3));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 10, sizeof(cl_int),
                            (void *)&x_size));
