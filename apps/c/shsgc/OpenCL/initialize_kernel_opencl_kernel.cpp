...
void buildOpenCLKernels_initialize_kernel(OPS_instance *instance, int xdim0,
  ...
  if (!isbuilt_initialize_kernel) {
    ...
    instance->ostream() << "Compiling initialize_kernel " << OCL_FMA
                        << " source -- start \n";
