...
void buildOpenCLKernels_zerores_kernel(int xdim0, int xdim1, int xdim2) {
  ...
  if(!isbuilt_zerores_kernel) {
    ...
    OPS_opencl_core.kernel[2] = clCreateKernel(OPS_opencl_core.program, "ops_zerores_kernel", &ret);
    clSafeCall( ret );
...
void ops_par_loop_zerores_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[2], 4, sizeof(cl_int), (void*) &base1 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[2], 5, sizeof(cl_int), (void*) &base2 ));
