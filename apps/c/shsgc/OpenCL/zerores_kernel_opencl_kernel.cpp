...
void buildOpenCLKernels_zerores_kernel(OPS_instance *instance, int xdim0,
                                       int xdim1, int xdim2) {
  ...
  if (!isbuilt_zerores_kernel) {
    ...
    instance->ostream() << "Compiling zerores_kernel " << OCL_FMA
                        << " source -- start \n";
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts,
                ...
                "-Dxdim0_zerores_kernel=%d  -Dxdim1_zerores_kernel=%d  "
