...
void buildOpenCLKernels_limiter_kernel(int xdim0, int xdim1, int xdim2) {
  ...
  if(!isbuilt_limiter_kernel) {
    ...
    printf("Compiling limiter_kernel %d source -- start \n",OCL_FMA);
      ...
      if (pPath!=NULL)
        if(OCL_FMA)
          sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/c/include -DOPS_WARPSIZE=%d  -Dxdim0_limiter_kernel=%d  -Dxdim1_limiter_kernel=%d  -Dxdim2_limiter_kernel=%d ", pPath, 32,xdim0,xdim1,xdim2);
        else
      ...
      printf("compiling limiter_kernel -- done\n");

    // Create the OpenCL kernel
    OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[8] = clCreateKernel(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.program, "ops_limiter_kernel", &ret);
    clSafeCall( ret );
...
void ops_par_loop_limiter_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  buildOpenCLKernels_limiter_kernel(
  xdim0,xdim1,xdim2);
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[8], 3, sizeof(cl_double), (void*) &del2 ));
    ...
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[8], 7, sizeof(cl_int), (void*) &x_size ));
