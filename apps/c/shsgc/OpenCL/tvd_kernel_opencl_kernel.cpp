...
void buildOpenCLKernels_tvd_kernel(OPS_instance *instance, int xdim0,
                                   int xdim1) {
  ...
  if (!isbuilt_tvd_kernel) {
    ...
    instance->ostream() << "Compiling tvd_kernel " << OCL_FMA
                        << " source -- start \n";
    ...
    instance->opencl_instance->OPS_opencl_core.kernel[9] =
