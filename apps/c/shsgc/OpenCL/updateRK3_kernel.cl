...
// user function
void updateRK3_kernel(__global double *restrict rho_new,
                      __global double *restrict rhou_new,
                      __global double *restrict rhoE_new,
                      __global double *restrict rho_old,
                      __global double *restrict rhou_old,
                      __global double *restrict rhoE_old,
                      const __global double *restrict rho_res,
                      const __global double *restrict rhou_res,
                      const __global double *restrict rhoE_res,
                      const double *restrict a1, const double *restrict a2,
...
__kernel void ops_updateRK3_kernel(
    ...
    __global const double *restrict arg8, const double arg9, const double arg10,
