...
// user function
void calupwindeff_kernel(const __global double *restrict cmp,
                         const __global double *restrict gt,
                         const __global double *restrict cf,
                         const __global double *restrict al,
                         const __global double *restrict ep2,
                         const __global double *restrict r,
                         __global double *restrict eff)
...
__kernel void ops_calupwindeff_kernel(
  ...
  if (idx_x < size0) {
    calupwindeff_kernel(
        &arg0[base0 + idx_x * 1 * 3], &arg1[base1 + idx_x * 1 * 3],
        &arg2[base2 + idx_x * 1 * 3], &arg3[base3 + idx_x * 1 * 3],
        &arg4[base4 + idx_x * 1 * 3], &arg5[base5 + idx_x * 1 * 9],
