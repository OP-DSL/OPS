...
void ops_par_loop_zerores_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  double *__restrict__ rho_res = (double *)(args[0].data + base0);

  int base1 = args[1].dat->base_offset;
  double *__restrict__ rhou_res = (double *)(args[1].data + base1);

  int base2 = args[2].dat->base_offset;
  double *__restrict__ rhoE_res = (double *)(args[2].data + base2);
