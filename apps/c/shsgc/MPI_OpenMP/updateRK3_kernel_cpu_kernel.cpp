...
void ops_par_loop_updateRK3_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  const double *__restrict__ rho_res = (double *)(args[6].data + base6);

  int base7 = args[7].dat->base_offset;
  const double *__restrict__ rhou_res = (double *)(args[7].data + base7);

  int base8 = args[8].dat->base_offset;
  const double *__restrict__ rhoE_res = (double *)(args[8].data + base8);
