...
#define OPS_ACC_MD4(d, x) ((n_x * 1 + x) * 9 + (d))
#define OPS_ACC_MD5(d, x) ((n_x * 1 + x) * 3 + (d))
...
void ops_par_loop_Riemann_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  const double *__restrict__ rho_new = (double *)(args[0].data + base0);

  int base1 = args[1].dat->base_offset;
  const double *__restrict__ rhou_new = (double *)(args[1].data + base1);

  int base2 = args[2].dat->base_offset;
  const double *__restrict__ rhoE_new = (double *)(args[2].data + base2);

  int base3 = args[3].dat->base_offset;
  double *__restrict__ alam = (double *)(args[3].data + base3);

  int base4 = args[4].dat->base_offset;
  double *__restrict__ r = (double *)(args[4].data + base4);

  int base5 = args[5].dat->base_offset;
  double *__restrict__ al = (double *)(args[5].data + base5);
