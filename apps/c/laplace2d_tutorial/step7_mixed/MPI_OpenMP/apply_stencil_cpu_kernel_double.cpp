...
// host stub function
#ifndef OPS_LAZY
void ops_par_loop_apply_stencil_double(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
#else
void ops_par_loop_apply_stencil_double_execute(ops_kernel_descriptor *desc) {
...
void ops_par_loop_apply_stencil_double(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  create_kerneldesc_and_enque(name, args, 3, 3, dim, 0, range, block, ops_par_loop_apply_stencil_double_execute);
}
#endif
