...
// host stub function
#ifndef OPS_LAZY
void ops_par_loop_right_bndcon_double(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
#else
void ops_par_loop_right_bndcon_double_execute(ops_kernel_descriptor *desc) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,2,"right_bndcon");
...
void ops_par_loop_right_bndcon_double(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  create_kerneldesc_and_enque(name, args, 2, 2, dim, 0, range, block, ops_par_loop_right_bndcon_double_execute);
}
#endif
