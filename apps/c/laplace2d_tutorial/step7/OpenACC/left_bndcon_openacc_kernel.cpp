...
extern int xdim0_left_bndcon;
int xdim0_left_bndcon_h = -1;

#ifdef __cplusplus
extern "C" {
#endif
void left_bndcon_c_wrapper(double *p_a0, int *p_a1, int arg_idx0, int arg_idx1,
...
// Halo Exchanges
  ...
  left_bndcon_c_wrapper(p_a0, p_a1, arg_idx[0], arg_idx[1], x_size, y_size);
