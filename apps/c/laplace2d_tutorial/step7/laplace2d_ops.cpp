...
void ops_par_loop_left_bndcon(char const *, ops_block, int, int *, ops_arg,
                              ops_arg);

void ops_par_loop_right_bndcon(char const *, ops_block, int, int *, ops_arg,
                               ops_arg);

void ops_par_loop_apply_stencil(char const *, ops_block, int, int *, ops_arg,
                                ops_arg, ops_arg);
...
int main(int argc, char **argv) {
  ...
  while (error > tol && iter < iter_max) {
    ...
    ops_par_loop_apply_stencil(
        "apply_stencil", block, 2, interior_range,
