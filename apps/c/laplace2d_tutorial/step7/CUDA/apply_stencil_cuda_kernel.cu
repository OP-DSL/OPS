...
//
__constant__ int xdim0_apply_stencil;
int xdim0_apply_stencil_h = -1;
__constant__ int xdim1_apply_stencil;
int xdim1_apply_stencil_h = -1;
...
void apply_stencil_gpu(const double *A, double *Anew, double *error) {
...
int size1 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * xdim0_apply_stencil;
  arg1 += idx_x * 1*1 + idx_y * 1*1 * xdim1_apply_stencil;
...
void ops_par_loop_apply_stencil_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_apply_stencil_h || xdim1 != xdim1_apply_stencil_h) {
    cudaMemcpyToSymbol( xdim0_apply_stencil, &xdim0, sizeof(int) );
    xdim0_apply_stencil_h = xdim0;
    cudaMemcpyToSymbol( xdim1_apply_stencil, &xdim1, sizeof(int) );
    xdim1_apply_stencil_h = xdim1;
  }
