...
//
__constant__ int xdim0_right_bndcon;
...
void right_bndcon_gpu(double *A, const int *idx) {
...
int size1 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * xdim0_right_bndcon;
...
void ops_par_loop_right_bndcon_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_right_bndcon_h) {
    cudaMemcpyToSymbol( xdim0_right_bndcon, &xdim0, sizeof(int) );
