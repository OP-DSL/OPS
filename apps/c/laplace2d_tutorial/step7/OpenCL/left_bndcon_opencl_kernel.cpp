...
void buildOpenCLKernels_left_bndcon(OPS_instance *instance, int xdim0) {
  ...
  if(!isbuilt_left_bndcon) {
    ...
    instance->ostream() <<"Compiling left_bndcon "<<OCL_FMA<<" source -- start \n";
      ...
      instance->ostream() << "compiling left_bndcon -- done\n";

    // Create the OpenCL kernel
    instance->opencl_instance->OPS_opencl_core.kernel[2] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_left_bndcon", &ret);
    clSafeCall( ret );
...
void ops_par_loop_left_bndcon(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  buildOpenCLKernels_left_bndcon(block->instance,
  xdim0);
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[2], 1, sizeof(cl_int), (void*) &jmax ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[2], 2, sizeof(cl_double), (void*) &pi ));
