...
void buildOpenCLKernels_left_bndcon(int xdim0) {
  ...
  if (!isbuilt_left_bndcon) {
    ...
    OPS_opencl_core.kernel[2] =
        clCreateKernel(OPS_opencl_core.program, "ops_left_bndcon", &ret);
    clSafeCall(ret);
...
void ops_par_loop_left_bndcon(char const *name, ops_block block, int dim,
  ...
  buildOpenCLKernels_left_bndcon(xdim0);
