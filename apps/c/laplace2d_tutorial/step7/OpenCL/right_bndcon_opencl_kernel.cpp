...
void buildOpenCLKernels_right_bndcon(int xdim0) {
  ...
  if (!isbuilt_right_bndcon) {
    ...
    OPS_opencl_core.kernel[3] =
        clCreateKernel(OPS_opencl_core.program, "ops_right_bndcon", &ret);
    clSafeCall(ret);
...
void ops_par_loop_right_bndcon(char const *name, ops_block block, int dim,
  ...
  buildOpenCLKernels_right_bndcon(xdim0);
  ...
  if (globalWorkSize[0] > 0 && globalWorkSize[1] > 0 && globalWorkSize[2] > 0) {
    ...
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[3], 0, sizeof(cl_mem),
                              (void *)&arg0.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[3], 1, sizeof(cl_int),
                              (void *)&jmax));
