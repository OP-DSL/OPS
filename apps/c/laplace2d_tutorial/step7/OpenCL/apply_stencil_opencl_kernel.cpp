...
void buildOpenCLKernels_apply_stencil(int xdim0, int xdim1) {
  ...
  if(!isbuilt_apply_stencil) {
    ...
    printf("Compiling apply_stencil %d source -- start \n",OCL_FMA);
      ...
      printf("compiling apply_stencil -- done\n");

    // Create the OpenCL kernel
    OPS_opencl_core.kernel[4] = clCreateKernel(OPS_opencl_core.program, "ops_apply_stencil", &ret);
    clSafeCall( ret );
...
void ops_par_loop_apply_stencil(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  buildOpenCLKernels_apply_stencil(
  xdim0,xdim1);
