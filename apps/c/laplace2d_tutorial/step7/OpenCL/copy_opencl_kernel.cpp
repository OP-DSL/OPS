...
void buildOpenCLKernels_copy(OPS_instance *instance, int xdim0, int xdim1) {
  ...
  if(!isbuilt_copy) {
    ...
    instance->ostream() <<"Compiling copy "<<OCL_FMA<<" source -- start \n";
      ...
      instance->ostream() << "compiling copy -- done\n";

    // Create the OpenCL kernel
    instance->opencl_instance->OPS_opencl_core.kernel[5] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_copy", &ret);
    clSafeCall( ret );
...
void ops_par_loop_copy(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  buildOpenCLKernels_copy(block->instance,
  xdim0,xdim1);
