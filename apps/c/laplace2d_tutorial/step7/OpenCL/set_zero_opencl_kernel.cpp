...
void buildOpenCLKernels_set_zero(OPS_instance *instance, int xdim0) {
  ...
  if(!isbuilt_set_zero) {
    ...
    instance->ostream() <<"Compiling set_zero "<<OCL_FMA<<" source -- start \n";
      ...
      instance->ostream() << "compiling set_zero -- done\n";

    // Create the OpenCL kernel
    instance->opencl_instance->OPS_opencl_core.kernel[1] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_set_zero", &ret);
    clSafeCall( ret );
...
void ops_par_loop_set_zero(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0) {
  ...
  buildOpenCLKernels_set_zero(block->instance,
  xdim0);
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 3, sizeof(cl_int), (void*) &y_size ));
