...
make clean
make
cd $OPS_INSTALL_PATH/../apps/c/laplace2d_tutorial/step7/

make clean
#rm -f .generated
#make IEEE=1 -j
make IEEE=1 laplace2d_dev_seq laplace2d_dev_mpi laplace2d_seq laplace2d_tiled laplace2d_openmp laplace2d_mpi \
laplace2d_mpi_tiled laplace2d_mpi_openmp
echo '============> Running OpenMP'
...
KMP_AFFINITY=compact OMP_NUM_THREADS=20 ./laplace2d_tiled OPS_TILING > perf_out
grep "PASSED" perf_out
rc=$?; if [[ $rc != 0 ]]; then echo "TEST FAILED";exit $rc; fi
rm perf_out
...
$MPI_INSTALL_PATH/bin/mpirun -np 20 ./laplace2d_dev_mpi > perf_out
grep "PASSED" perf_out
rc=$?; if [[ $rc != 0 ]]; then echo "TEST FAILED";exit $rc; fi
rm perf_out
...
export OMP_NUM_THREADS=10;$MPI_INSTALL_PATH/bin/mpirun -np 2 ./laplace2d_mpi_tiled OPS_TILING OPS_TILING_MAXDEPTH=10 > perf_out
grep "PASSED" perf_out
rc=$?; if [[ $rc != 0 ]]; then echo "TEST FAILED";exit $rc; fi
rm perf_out

if [[ -v CUDA_INSTALL_PATH ]]; then
make IEEE=1 laplace2d_cuda laplace2d_mpi_cuda laplace2d_mpi_cuda_tiled
...
$MPI_INSTALL_PATH/bin/mpirun -np 2 ./laplace2d_mpi_cuda_tiled OPS_TILING OPS_TILING_MAXDEPTH=10 OPS_BLOCK_SIZE_X=64 OPS_BLOCK_SIZE_Y=4 > perf_out
grep "PASSED" perf_out
rc=$?; if [[ $rc != 0 ]]; then echo "TEST FAILED";exit $rc; fi
rm perf_out
...
cd $OPS_INSTALL_PATH/../apps/c/laplace2d_tutorial/step7
make clean
make IEEE=1 laplace2d_dev_seq laplace2d_dev_mpi laplace2d_seq laplace2d_tiled laplace2d_openmp laplace2d_mpi laplace2d_mpi_tiled \
laplace2d_mpi_openmp laplace2d_ompoffload laplace2d_mpi_ompoffload laplace2d_mpi_ompoffload_tiled
...
echo '============> Running MPI+OpenMP'
export OMP_NUM_THREADS=2;$MPI_INSTALL_PATH/bin/mpirun -np 2 ./laplace2d_mpi_openmp > perf_out
grep "PASSED" perf_out
rc=$?; if [[ $rc != 0 ]]; then echo "TEST FAILED";exit $rc; fi
rm perf_out
...
echo '============> Running DEV_MPI'
$MPI_INSTALL_PATH/bin/mpirun -np 2 ./laplace2d_dev_mpi > perf_out
grep "PASSED" perf_out
rc=$?; if [[ $rc != 0 ]]; then echo "TEST FAILED";exit $rc; fi
rm perf_out

echo '============> Running MPI'
$MPI_INSTALL_PATH/bin/mpirun -np 2 ./laplace2d_mpi > perf_out
grep "PASSED" perf_out
rc=$?; if [[ $rc != 0 ]]; then echo "TEST FAILED";exit $rc; fi
rm perf_out

echo '============> Running MPI_Tiled'
export OMP_NUM_THREADS=10;$MPI_INSTALL_PATH/bin/mpirun -np 2 numawrap2 ./laplace2d_mpi_tiled OPS_TILING OPS_TILING_MAXDEPTH=10 > perf_out
grep "PASSED" perf_out
rc=$?; if [[ $rc != 0 ]]; then echo "TEST FAILED";exit $rc; fi
rm perf_out
...
if [[ -v CUDA_INSTALL_PATH ]]; then
make IEEE=1 laplace2d_cuda laplace2d_mpi_cuda laplace2d_mpi_cuda_tiled
#laplace2d_openacc laplace2d_mpi_openacc laplace2d_mpi_openacc_tiled
...
#./laplace2d_openacc OPS_BLOCK_SIZE_X=64 OPS_BLOCK_SIZE_Y=4 > perf_out
#grep "PASSED" perf_out
#rc=$?; if [[ $rc != 0 ]]; then echo "TEST FAILED";exit $rc; fi
#rm perf_out

#echo '============> Running MPI+OpenACC'
#$MPI_INSTALL_PATH/bin/mpirun -np 2 ./laplace2d_mpi_openacc OPS_BLOCK_SIZE_X=64 OPS_BLOCK_SIZE_Y=4 > perf_out
#grep "PASSED" perf_out
#rc=$?; if [[ $rc != 0 ]]; then echo "TEST FAILED";exit $rc; fi
#rm perf_out
...
rm -f .generated
#make IEEE=1 -j
make IEEE=1 laplace2d_hip laplace2d_mpi_hip #laplace2d_hip_tiled laplace2d_mpi_hip_tiled

echo '============> Running HIP'
./laplace2d_hip OPS_BLOCK_SIZE_X=64 OPS_BLOCK_SIZE_Y=4 > perf_out
grep "PASSED" perf_out
rc=$?; if [[ $rc != 0 ]]; then echo "TEST FAILED";exit $rc; fi
rm perf_out

echo '============> Running MPI+HIP'
#mpirun --allow-run-as-root -np 2 ./laplace2d_mpi_hip OPS_BLOCK_SIZE_X=64 OPS_BLOCK_SIZE_Y=4 > perf_out
mpirun -np 2 ./laplace2d_mpi_hip OPS_BLOCK_SIZE_X=64 OPS_BLOCK_SIZE_Y=4 > perf_out
grep "PASSED" perf_out
rc=$?; if [[ $rc != 0 ]]; then echo "TEST FAILED";exit $rc; fi
rm perf_out
