// Auto-generated at 2024-12-18 22:21:36.322099 by ops-translator
...
//  ==================
#ifndef OPS_LAZY
void ops_par_loop_right_bndcon(
    const char *name,
    ops_block block,
    int dim,
    int *range,
    ...
    )
{
    ...
    create_kerneldesc_and_enque("right_bndcon", args, 2, 3, dim, 0, range, block, ops_par_loop_right_bndcon_execute);
}
#endif
