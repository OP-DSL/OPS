...
void ops_par_loop_convective_kernel(char const *, ops_block, int , int*,
  ops_arg,
  ops_arg,
  ops_arg,
  ops_arg,
  ...
  for(int iter =0; iter<niter; iter++){
    ...
    for(int nrk=0; nrk<3; nrk++){
      ...
      for(int i=0; i<nblock; i++){
        ...
        ops_par_loop_convective_kernel("convective_kernel", shsgc_grid[i], 1, range,
        ...
        ops_par_loop_updateRK3_kernel("updateRK3_kernel", shsgc_grid[i], 1, range,
                     ops_arg_dat(rho_new[i], 1, S1D_0, "double", OPS_WRITE),
                     ops_arg_dat(rhou_new[i], 1, S1D_0, "double", OPS_WRITE),
                     ops_arg_dat(rhoE_new[i], 1, S1D_0, "double", OPS_WRITE),
