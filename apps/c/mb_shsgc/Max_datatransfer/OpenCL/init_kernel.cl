...
void init_kernel(const ptr_double x,
  ...
  ptr_double rho_old,
  ptr_double rhou_old,
  ptr_double rhoE_old, const double pl, const double pr, const double rhol, const double ul2, const double ur, const double gam1, const double eps, const double lambda)
{
  if (OPS_ACCS(x, 0) >= -4.0){
