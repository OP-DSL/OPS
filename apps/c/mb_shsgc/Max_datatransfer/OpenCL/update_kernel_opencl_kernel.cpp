...
void buildOpenCLKernels_update_kernel(int xdim0, int xdim1, int xdim2,
  ...
  if (!isbuilt_update_kernel) {
    ...
    OPS_opencl_core.kernel[13] =
        clCreateKernel(OPS_opencl_core.program, "ops_update_kernel", &ret);
    clSafeCall(ret);
...
void ops_par_loop_update_kernel(char const *name, ops_block block, int dim,
  ...
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[13], 3, sizeof(cl_mem),
                            (void *)&arg3.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[13], 4, sizeof(cl_int),
                            (void *)&base0));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[13], 5, sizeof(cl_int),
                            (void *)&base1));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[13], 6, sizeof(cl_int),
                            (void *)&base2));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[13], 7, sizeof(cl_int),
                            (void *)&base3));
