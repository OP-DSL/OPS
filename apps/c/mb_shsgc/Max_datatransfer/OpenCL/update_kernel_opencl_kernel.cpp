...
void buildOpenCLKernels_update_kernel(OPS_instance *instance, int xdim0,
  ...
  if (!isbuilt_update_kernel) {
    ...
    instance->ostream() << "Compiling update_kernel " << OCL_FMA
                        << " source -- start \n";
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts,
                ...
                "-Dxdim2_update_kernel=%d  -Dxdim3_update_kernel=%d ",
    ...
    instance->opencl_instance->OPS_opencl_core.kernel[13] =
