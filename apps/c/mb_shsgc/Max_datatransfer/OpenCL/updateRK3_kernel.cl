...
__global double * restrict rho_old,__global double* restrict  rhou_old,__global double* restrict  rhoE_old,__global double * restrict rho_res,
__global double * restrict rhou_res,__global double * restrict rhoE_res,const  double* restrict  a1,const  double* restrict  a2,
