...
void buildOpenCLKernels_save_kernel(int xdim0, int xdim1, int xdim2, int xdim3, int xdim4, int xdim5) {
  ...
  if(!isbuilt_save_kernel) {
    ...
    OPS_opencl_core.kernel[2] = clCreateKernel(OPS_opencl_core.program, "ops_save_kernel", &ret);
    clSafeCall( ret );
...
void ops_par_loop_save_kernel(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5) {
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[2], 6, sizeof(cl_int), (void*) &base0 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[2], 7, sizeof(cl_int), (void*) &base1 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[2], 8, sizeof(cl_int), (void*) &base2 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[2], 9, sizeof(cl_int), (void*) &base3 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[2], 10, sizeof(cl_int), (void*) &base4 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[2], 11, sizeof(cl_int), (void*) &base5 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[2], 12, sizeof(cl_int), (void*) &x_size ));
