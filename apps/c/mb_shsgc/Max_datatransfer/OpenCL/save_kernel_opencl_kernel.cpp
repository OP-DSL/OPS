...
void buildOpenCLKernels_save_kernel(int xdim0, int xdim1, int xdim2, int xdim3,
                                    int xdim4, int xdim5) {
  ...
  if (!isbuilt_save_kernel) {
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts, "-cl-mad-enable -DOCL_FMA -I%s/c/include "
                           "-DOPS_WARPSIZE=%d  -Dxdim0_save_kernel=%d  "
                           "-Dxdim1_save_kernel=%d  -Dxdim2_save_kernel=%d  "
                           "-Dxdim3_save_kernel=%d  -Dxdim4_save_kernel=%d  "
                           "-Dxdim5_save_kernel=%d ",
                pPath, 32, xdim0, xdim1, xdim2, xdim3, xdim4, xdim5);
      else
        sprintf(buildOpts, "-cl-mad-enable -I%s/c/include -DOPS_WARPSIZE=%d  "
                           "-Dxdim0_save_kernel=%d  -Dxdim1_save_kernel=%d  "
                           "-Dxdim2_save_kernel=%d  -Dxdim3_save_kernel=%d  "
                           "-Dxdim4_save_kernel=%d  -Dxdim5_save_kernel=%d ",
                pPath, 32, xdim0, xdim1, xdim2, xdim3, xdim4, xdim5);
    else {
    ...
    OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[2] =
...
void ops_par_loop_save_kernel(char const *name, ops_block block, int dim,
  ...
  buildOpenCLKernels_save_kernel(xdim0, xdim1, xdim2, xdim3, xdim4, xdim5);
  ...
  if (globalWorkSize[0] > 0 && globalWorkSize[1] > 0 && globalWorkSize[2] > 0) {
    ...
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[2],
    ...
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[2],
                              6, sizeof(cl_int), (void *)&base0));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[2],
                              7, sizeof(cl_int), (void *)&base1));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[2],
                              8, sizeof(cl_int), (void *)&base2));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[2],
                              9, sizeof(cl_int), (void *)&base3));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[2],
                              10, sizeof(cl_int), (void *)&base4));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[2],
                              11, sizeof(cl_int), (void *)&base5));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[2],
