...
void buildOpenCLKernels_checkop_kernel(OPS_instance *instance, int xdim0,
                                       int xdim1, int xdim2) {
  ...
  if (!isbuilt_checkop_kernel) {
    ...
    instance->ostream() << "Compiling checkop_kernel " << OCL_FMA
                        << " source -- start \n";
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts,
                ...
                "-Dxdim0_checkop_kernel=%d  -Dxdim1_checkop_kernel=%d  "
    ...
    instance->opencl_instance->OPS_opencl_core.kernel[14] =
