...
void buildOpenCLKernels_init_kernel(int xdim0, int xdim1, int xdim2, int xdim3,
  ...
  if (!isbuilt_init_kernel) {
    ...
    OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.program =
        clCreateProgramWithSource(
            OPS_instance::getOPSInstance()
                ->opencl_instance->OPS_opencl_core.context,
            1, (const char **)&source_str, (const size_t *)&source_size, &ret);
    clSafeCall(ret);
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts, "-cl-mad-enable -DOCL_FMA -I%s/c/include "
                           "-DOPS_WARPSIZE=%d  -Dxdim0_init_kernel=%d  "
                           "-Dxdim1_init_kernel=%d  -Dxdim2_init_kernel=%d  "
                           "-Dxdim3_init_kernel=%d  -Dxdim4_init_kernel=%d  "
                           "-Dxdim5_init_kernel=%d  -Dxdim6_init_kernel=%d  "
                           "-Dxdim7_init_kernel=%d ",
                pPath, 32, xdim0, xdim1, xdim2, xdim3, xdim4, xdim5, xdim6,
                xdim7);
      else
        sprintf(buildOpts, "-cl-mad-enable -I%s/c/include -DOPS_WARPSIZE=%d  "
                           "-Dxdim0_init_kernel=%d  -Dxdim1_init_kernel=%d  "
                           "-Dxdim2_init_kernel=%d  -Dxdim3_init_kernel=%d  "
                           "-Dxdim4_init_kernel=%d  -Dxdim5_init_kernel=%d  "
                           "-Dxdim6_init_kernel=%d  -Dxdim7_init_kernel=%d ",
                pPath, 32, xdim0, xdim1, xdim2, xdim3, xdim4, xdim5, xdim6,
                xdim7);
    else {
    ...
    ret = clBuildProgram(OPS_instance::getOPSInstance()
                             ->opencl_instance->OPS_opencl_core.program,
                         1, &OPS_instance::getOPSInstance()
                                 ->opencl_instance->OPS_opencl_core.device_id,
                         buildOpts, NULL, NULL);
    ...
    OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[1] =
        clCreateKernel(OPS_instance::getOPSInstance()
                           ->opencl_instance->OPS_opencl_core.program,
                       "ops_init_kernel", &ret);
    clSafeCall(ret);
...
void ops_par_loop_init_kernel(char const *name, ops_block block, int dim,
  ...
  buildOpenCLKernels_init_kernel(xdim0, xdim1, xdim2, xdim3, xdim4, xdim5,
                                 xdim6, xdim7);
  ...
  size_t globalWorkSize[3] = {
      ...
      1, 1};
  size_t localWorkSize[3] = {OPS_instance::getOPSInstance()->OPS_block_size_x,
                             1, 1};
  ...
  if (globalWorkSize[0] > 0 && globalWorkSize[1] > 0 && globalWorkSize[2] > 0) {
    ...
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              0, sizeof(cl_mem), (void *)&arg0.data_d));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              1, sizeof(cl_mem), (void *)&arg1.data_d));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              2, sizeof(cl_mem), (void *)&arg2.data_d));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              3, sizeof(cl_mem), (void *)&arg3.data_d));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              4, sizeof(cl_mem), (void *)&arg4.data_d));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              5, sizeof(cl_mem), (void *)&arg5.data_d));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              6, sizeof(cl_mem), (void *)&arg6.data_d));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              7, sizeof(cl_mem), (void *)&arg7.data_d));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              8, sizeof(cl_double), (void *)&pl));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              9, sizeof(cl_double), (void *)&pr));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              10, sizeof(cl_double), (void *)&rhol));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              11, sizeof(cl_double), (void *)&ul));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              12, sizeof(cl_double), (void *)&ur));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              13, sizeof(cl_double), (void *)&gam1));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              14, sizeof(cl_double), (void *)&eps));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              15, sizeof(cl_double), (void *)&lambda));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              16, sizeof(cl_int), (void *)&base0));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              17, sizeof(cl_int), (void *)&base1));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              18, sizeof(cl_int), (void *)&base2));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              19, sizeof(cl_int), (void *)&base3));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              20, sizeof(cl_int), (void *)&base4));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              21, sizeof(cl_int), (void *)&base5));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              22, sizeof(cl_int), (void *)&base6));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              23, sizeof(cl_int), (void *)&base7));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              24, sizeof(cl_int), (void *)&x_size));
    ...
    clSafeCall(clEnqueueNDRangeKernel(
        ...
        OPS_instance::getOPSInstance()
            ->opencl_instance->OPS_opencl_core.kernel[1],
        3, NULL, globalWorkSize, localWorkSize, 0, NULL, NULL));
  }
  if (OPS_instance::getOPSInstance()->OPS_diags > 1) {
