...
void buildOpenCLKernels_residue_eval(int xdim0, int xdim1, int xdim2, int xdim3,
                                     int xdim4, int xdim5) {
  ...
  if (!isbuilt_residue_eval) {
    ...
    printf("Compiling residue_eval %d source -- start \n", OCL_FMA);
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts, "-cl-mad-enable -DOCL_FMA -I%s/c/include "
                           "-DOPS_WARPSIZE=%d  -Dxdim0_residue_eval=%d  "
                           "-Dxdim1_residue_eval=%d  -Dxdim2_residue_eval=%d  "
                           "-Dxdim3_residue_eval=%d  -Dxdim4_residue_eval=%d  "
                           "-Dxdim5_residue_eval=%d ",
    ...
    printf("compiling residue_eval -- done\n");

    // Create the OpenCL kernel
    OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[5] =
...
void ops_par_loop_residue_eval(char const *name, ops_block block, int dim,
  ...
  buildOpenCLKernels_residue_eval(xdim0, xdim1, xdim2, xdim3, xdim4, xdim5);
  ...
  if (globalWorkSize[0] > 0 && globalWorkSize[1] > 0 && globalWorkSize[2] > 0) {
    ...
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[5],
