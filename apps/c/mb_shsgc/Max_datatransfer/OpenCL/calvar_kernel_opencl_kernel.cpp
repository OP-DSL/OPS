...
void buildOpenCLKernels_calvar_kernel(OPS_instance *instance, int xdim0,
  ...
  if (!isbuilt_calvar_kernel) {
    ...
    instance->ostream() << "Compiling calvar_kernel " << OCL_FMA
                        << " source -- start \n";
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts,
                ...
                "-Dxdim2_calvar_kernel=%d  -Dxdim3_calvar_kernel=%d  "
    ...
    instance->opencl_instance->OPS_opencl_core.kernel[3] =
