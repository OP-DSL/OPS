...
void buildOpenCLKernels_calvar_kernel(int xdim0, int xdim1, int xdim2,
  ...
  if (!isbuilt_calvar_kernel) {
    ...
    OPS_opencl_core.kernel[3] =
        clCreateKernel(OPS_opencl_core.program, "ops_calvar_kernel", &ret);
    clSafeCall(ret);
...
void ops_par_loop_calvar_kernel(char const *name, ops_block block, int dim,
  ...
  if (globalWorkSize[0] > 0 && globalWorkSize[1] > 0 && globalWorkSize[2] > 0) {
    ...
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[3], 4, sizeof(cl_mem),
                              (void *)&arg4.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[3], 5, sizeof(cl_double),
                              (void *)&gam1));
    ...
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[3], 10, sizeof(cl_int),
                              (void *)&base4));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[3], 11, sizeof(cl_int),
                              (void *)&x_size));
