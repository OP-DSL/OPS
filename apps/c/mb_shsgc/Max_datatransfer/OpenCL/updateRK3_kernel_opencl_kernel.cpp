...
void buildOpenCLKernels_updateRK3_kernel(int xdim0, int xdim1, int xdim2,
  ...
  if (!isbuilt_updateRK3_kernel) {
    ...
    OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[6] =
        clCreateKernel(OPS_instance::getOPSInstance()
                           ->opencl_instance->OPS_opencl_core.program,
                       "ops_updateRK3_kernel", &ret);
    clSafeCall(ret);
...
void ops_par_loop_updateRK3_kernel(char const *name, ops_block block, int dim,
  ...
  if (globalWorkSize[0] > 0 && globalWorkSize[1] > 0 && globalWorkSize[2] > 0) {
    ...
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[6],
    ...
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[6],
                              8, sizeof(cl_mem), (void *)&arg8.data_d));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[6],
                              9, sizeof(cl_double), (void *)arg9.data));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[6],
                              10, sizeof(cl_double), (void *)arg10.data));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[6],
                              11, sizeof(cl_double), (void *)&dt));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[6],
                              12, sizeof(cl_int), (void *)&base0));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[6],
                              13, sizeof(cl_int), (void *)&base1));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[6],
                              14, sizeof(cl_int), (void *)&base2));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[6],
                              15, sizeof(cl_int), (void *)&base3));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[6],
                              16, sizeof(cl_int), (void *)&base4));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[6],
                              17, sizeof(cl_int), (void *)&base5));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[6],
                              18, sizeof(cl_int), (void *)&base6));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[6],
                              19, sizeof(cl_int), (void *)&base7));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[6],
                              20, sizeof(cl_int), (void *)&base8));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[6],
                              21, sizeof(cl_int), (void *)&x_size));
