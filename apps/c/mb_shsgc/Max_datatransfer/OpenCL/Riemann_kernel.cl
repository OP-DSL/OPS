...
void Riemann_kernel(const ptr_double rho_new, const ptr_double rhou_new,
                    const ptr_double rhoE_new, ptrm_double alam, ptrm_double r,
  ...
  double fni =
      OPS_ACCS(rhou_new, 0) * OPS_ACCS(rhou_new, 0) / OPS_ACCS(rho_new, 0);
...
#endif
    Riemann_kernel(ptr0, ptr1, ptr2, ptr3, ptr4, ptr5, gam1);
  }
}
