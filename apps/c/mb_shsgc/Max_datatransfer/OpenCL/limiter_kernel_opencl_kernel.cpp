...
void buildOpenCLKernels_limiter_kernel(OPS_instance *instance, int xdim0,
                                       int xdim1, int xdim2) {
  ...
  if (!isbuilt_limiter_kernel) {
    ...
    instance->ostream() << "Compiling limiter_kernel " << OCL_FMA
                        << " source -- start \n";
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts,
                ...
                "-Dxdim0_limiter_kernel=%d  -Dxdim1_limiter_kernel=%d  "
