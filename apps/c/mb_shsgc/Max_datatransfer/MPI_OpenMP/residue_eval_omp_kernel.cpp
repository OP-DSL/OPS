...
// user function
inline void residue_eval(const double *der1, const double *der2,
                         const double *der3, double *rho_res, double *rhou_res,
                         double *rhoE_res) {
...
#pragma simd
      for (int i = 0; i < SIMD_VEC; i++) {
        residue_eval((const double *)p_a[0] + i * 1 * 1,
    ...
    for (int n_x = start_i + ((finish_i - start_i) / SIMD_VEC) * SIMD_VEC;
      ...
      residue_eval((const double *)p_a[0], (const double *)p_a[1],
