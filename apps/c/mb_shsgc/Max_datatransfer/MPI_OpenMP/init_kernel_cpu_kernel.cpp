...
void ops_par_loop_init_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  const double *__restrict__ x = (double *)(args[0].data + base0);
  ...
  double *__restrict__ rho_old = (double *)(args[5].data + base5);

  int base6 = args[6].dat->base_offset;
  double *__restrict__ rhou_old = (double *)(args[6].data + base6);

  int base7 = args[7].dat->base_offset;
  double *__restrict__ rhoE_old = (double *)(args[7].data + base7);
