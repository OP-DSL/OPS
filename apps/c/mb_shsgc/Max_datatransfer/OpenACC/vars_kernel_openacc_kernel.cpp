...
void ops_par_loop_vars_kernel(char const *name, ops_block block, int dim,
  ...
  if (xdim0 != xdim0_vars_kernel_h || xdim1 != xdim1_vars_kernel_h ||
      xdim2 != xdim2_vars_kernel_h || xdim3 != xdim3_vars_kernel_h ||
      xdim4 != xdim4_vars_kernel_h) {
...
// Halo Exchanges
  ...
  vars_kernel_c_wrapper(p_a0, p_a1, p_a2, p_a3, p_a4, x_size);
