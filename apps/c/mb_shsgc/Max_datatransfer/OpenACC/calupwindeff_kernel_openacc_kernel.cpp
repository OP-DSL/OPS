...
void ops_par_loop_calupwindeff_kernel(char const *name, ops_block block,
  ...
  if (xdim0 != xdim0_calupwindeff_kernel_h ||
      xdim1 != xdim1_calupwindeff_kernel_h ||
      xdim2 != xdim2_calupwindeff_kernel_h ||
      xdim3 != xdim3_calupwindeff_kernel_h ||
      xdim4 != xdim4_calupwindeff_kernel_h ||
      xdim5 != xdim5_calupwindeff_kernel_h ||
      xdim6 != xdim6_calupwindeff_kernel_h) {
...
// Halo Exchanges
  ...
  calupwindeff_kernel_c_wrapper(p_a0, p_a1, p_a2, p_a3, p_a4, p_a5, p_a6,
                                x_size);
