...
// user function
#pragma acc routine
inline void checkop_kernel(const ptr_double rho_new, const ptr_double x,
                           const ptr_double rhoin, double *pre, double *post,
                           int *num) {
  double diff;
...
#pragma acc loop reduction(+ : p_a3_0) reduction(+ : p_a4_0)                   \
  ...
  for (int n_x = 0; n_x < x_size; n_x++) {
    ...
    checkop_kernel(ptr0, ptr1, ptr2, &p_a3_0, &p_a4_0, &p_a5_0);
  }
  p_a3[0] = p_a3_0;
  p_a4[0] = p_a4_0;
  p_a5[0] = p_a5_0;
