...
extern "C" {
#endif
void residue_eval_c_wrapper(double *p_a0, double *p_a1, double *p_a2,
...
void ops_par_loop_residue_eval(char const *name, ops_block block, int dim,
  ...
  int base3 =
      args[3].dat->base_offset +
      (OPS_instance::getOPSInstance()->OPS_soa ? args[3].dat->type_size
...
// Halo Exchanges
  ...
  residue_eval_c_wrapper(p_a0, p_a1, p_a2, p_a3, p_a4, p_a5, x_size);
