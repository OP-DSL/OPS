...
void ops_par_loop_save_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_save_kernel_h[0][0] || xdim1 != dims_save_kernel_h[1][0] ||
      xdim2 != dims_save_kernel_h[2][0] || xdim3 != dims_save_kernel_h[3][0] ||
      xdim4 != dims_save_kernel_h[4][0] || xdim5 != dims_save_kernel_h[5][0]) {
    ...
    cutilSafeCall(cudaMemcpyToSymbol(dims_save_kernel, dims_save_kernel_h,
                                     sizeof(dims_save_kernel)));
  }
