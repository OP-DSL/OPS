...
void ops_par_loop_limiter_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_limiter_kernel_h[0][0] ||
      xdim1 != dims_limiter_kernel_h[1][0] ||
      xdim2 != dims_limiter_kernel_h[2][0]) {
    dims_limiter_kernel_h[0][0] = xdim0;
    dims_limiter_kernel_h[1][0] = xdim1;
    dims_limiter_kernel_h[2][0] = xdim2;
    cutilSafeCall(cudaMemcpyToSymbol(dims_limiter_kernel, dims_limiter_kernel_h,
                                     sizeof(dims_limiter_kernel)));
  }
