...
void ops_par_loop_calupwindeff_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_calupwindeff_kernel_h[0][0] ||
      xdim1 != dims_calupwindeff_kernel_h[1][0] ||
      xdim2 != dims_calupwindeff_kernel_h[2][0] ||
      xdim3 != dims_calupwindeff_kernel_h[3][0] ||
      xdim4 != dims_calupwindeff_kernel_h[4][0] ||
      xdim5 != dims_calupwindeff_kernel_h[5][0] ||
      xdim6 != dims_calupwindeff_kernel_h[6][0]) {
    ...
    cutilSafeCall(cudaMemcpyToSymbol(dims_calupwindeff_kernel,
                                     dims_calupwindeff_kernel_h,
                                     sizeof(dims_calupwindeff_kernel)));
  }
  ...
  if (x_size > 0)
    ops_calupwindeff_kernel<<<grid, tblock>>>(
        (double *)p_a[0], (double *)p_a[1], (double *)p_a[2], (double *)p_a[3],
        (double *)p_a[4], (double *)p_a[5], (double *)p_a[6], x_size);
