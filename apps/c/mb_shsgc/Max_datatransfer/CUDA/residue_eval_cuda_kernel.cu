...
void ops_par_loop_residue_eval_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_residue_eval_h[0][0] ||
      xdim1 != dims_residue_eval_h[1][0] ||
      xdim2 != dims_residue_eval_h[2][0] ||
      xdim3 != dims_residue_eval_h[3][0] ||
      xdim4 != dims_residue_eval_h[4][0] ||
      xdim5 != dims_residue_eval_h[5][0]) {
    ...
    cutilSafeCall(cudaMemcpyToSymbol(dims_residue_eval, dims_residue_eval_h,
                                     sizeof(dims_residue_eval)));
  }
