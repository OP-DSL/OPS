...
void buildOpenCLKernels_fact_kernel(int xdim0, int xdim1) {
  ...
  if(!isbuilt_fact_kernel) {
    ...
    OPS_opencl_core.kernel[12] = clCreateKernel(OPS_opencl_core.program, "ops_fact_kernel", &ret);
    clSafeCall( ret );
...
void ops_par_loop_fact_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 2, sizeof(cl_double), (void*) &dx ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 3, sizeof(cl_double), (void*) &dt ));
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 6, sizeof(cl_int), (void*) &x_size ));
