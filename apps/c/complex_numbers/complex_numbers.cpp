...
int main(int argc, const char **argv) {
  ...
  ops_par_loop(complex_numbers_block0_5_kernel, "Initialisation",
               complex_numbers_block, 1, iter_range5,
  ...
  for (int iteration = 0; iteration < 1; iteration++) {
    ...
    ops_par_loop(complex_numbers_block0_4_kernel, "Save equations",
