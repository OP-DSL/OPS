...
void ops_par_loop_complex_numbers_block0_5_kernel(char const *, ops_block, int,
                                                  int *, ops_arg, ops_arg);

void ops_par_loop_complex_numbers_block0_4_kernel(char const *, ops_block, int,
                                                  int *, ops_arg, ops_arg);

void ops_par_loop_complex_numbers_block0_0_kernel(char const *, ops_block, int,
                                                  int *, ops_arg, ops_arg);

void ops_par_loop_complex_numbers_block0_1_kernel(char const *, ops_block, int,
                                                  int *, ops_arg, ops_arg);

void ops_par_loop_complex_numbers_block0_2_kernel(char const *, ops_block, int,
                                                  int *, ops_arg, ops_arg,
                                                  ops_arg, ops_arg);

void ops_par_loop_complex_numbers_block0_3_kernel(char const *, ops_block, int,
                                                  int *, ops_arg, ops_arg,
                                                  ops_arg);

void ops_par_loop_complex_numbers_block0_cn_kernel(char const *, ops_block, int,
                                                   int *, ops_arg, ops_arg,
                                                   ops_arg);
