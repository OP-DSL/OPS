...
// user function
#pragma acc routine
inline void accelerate_kernel(const ptr_double density0,
                              const ptr_double volume, ptr_double stepbymass,
                              const ptr_double xvel0, ptr_double xvel1,
