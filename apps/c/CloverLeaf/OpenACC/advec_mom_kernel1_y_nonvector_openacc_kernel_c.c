...
#pragma acc loop
    ...
    for (int n_x = 0; n_x < x_size; n_x++) {
      const ptr_double ptr0 = {p_a0 + n_x * 1 * 1 +
                                   n_y * xdim0_advec_mom_kernel1_y_nonvector *
                                       1 * 1,
                               xdim0_advec_mom_kernel1_y_nonvector};
      const ptr_double ptr1 = {p_a1 + n_x * 1 * 1 +
                                   n_y * xdim1_advec_mom_kernel1_y_nonvector *
                                       1 * 1,
      ...
      const ptr_double ptr3 = {p_a3 + n_x * 0 * 1 +
                                   n_y * xdim3_advec_mom_kernel1_y_nonvector *
                                       1 * 1,
                               xdim3_advec_mom_kernel1_y_nonvector};
      const ptr_double ptr4 = {p_a4 + n_x * 1 * 1 +
                                   n_y * xdim4_advec_mom_kernel1_y_nonvector *
                                       1 * 1,
