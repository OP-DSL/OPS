...
inline void ideal_gas_kernel(const ptr_double density, const ptr_double energy,
  ...
  sound_speed_squared =
      v * v * (OPS_ACC(pressure, 0, 0) * pressurebyenergy - pressurebyvolume);
