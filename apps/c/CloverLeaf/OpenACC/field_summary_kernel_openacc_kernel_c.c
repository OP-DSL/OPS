...
#ifdef OPS_GPU
#pragma acc parallel deviceptr(p_a0, p_a1, p_a2, p_a3, p_a4, p_a5) reduction(  \
    + : p_a6_0) reduction(+ : p_a7_0) reduction(+ : p_a8_0) reduction(         \
        + : p_a9_0) reduction(+ : p_a10_0)
#pragma acc loop reduction(+ : p_a6_0) reduction(+ : p_a7_0) reduction(        \
...
#pragma acc loop reduction(+ : p_a6_0) reduction(+ : p_a7_0) reduction(        \
    ...
    for (int n_x = 0; n_x < x_size; n_x++) {
      ...
      field_summary_kernel(ptr0, ptr1, ptr2, ptr3, ptr4, ptr5, &p_a6_0, &p_a7_0,
