...
void reset_field_kernel1_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    ...
    for ( int n_x=0; n_x<x_size; n_x++ ){
      reset_field_kernel1(  p_a0 + n_x*1*1 + n_y*xdim0_reset_field_kernel1*1*1,
           p_a1 + n_x*1*1 + n_y*xdim1_reset_field_kernel1*1*1, p_a2 + n_x*1*1 + n_y*xdim2_reset_field_kernel1*1*1,
