...
inline void PdV_kernel_predict(
  ...
  left_flux =
      (OPS_ACC(xarea, 0, 0) * (OPS_ACC(xvel0, 0, 0) + OPS_ACC(xvel0, 0, 1) +
                               OPS_ACC(xvel0, 0, 0) + OPS_ACC(xvel0, 0, 1))) *
      0.25 * dt * 0.5;
  right_flux =
      (OPS_ACC(xarea, 1, 0) * (OPS_ACC(xvel0, 1, 0) + OPS_ACC(xvel0, 1, 1) +
                               OPS_ACC(xvel0, 1, 0) + OPS_ACC(xvel0, 1, 1))) *
      0.25 * dt * 0.5;

  bottom_flux =
      (OPS_ACC(yarea, 0, 0) * (OPS_ACC(yvel0, 0, 0) + OPS_ACC(yvel0, 1, 0) +
                               OPS_ACC(yvel0, 0, 0) + OPS_ACC(yvel0, 1, 0))) *
      0.25 * dt * 0.5;
  top_flux =
      (OPS_ACC(yarea, 0, 1) * (OPS_ACC(yvel0, 0, 1) + OPS_ACC(yvel0, 1, 1) +
