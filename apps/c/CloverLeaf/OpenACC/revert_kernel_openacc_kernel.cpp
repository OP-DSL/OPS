...
void ops_par_loop_revert_kernel(char const *name, ops_block block, int dim,
  ...
  if (xdim0 != xdim0_revert_kernel_h || xdim1 != xdim1_revert_kernel_h ||
      xdim2 != xdim2_revert_kernel_h || xdim3 != xdim3_revert_kernel_h) {
...
// Halo Exchanges
  ...
  revert_kernel_c_wrapper(p_a0, p_a1, p_a2, p_a3, x_size, y_size);
