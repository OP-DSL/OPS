...
#pragma omp parallel for
  for (int n_y = 0; n_y < y_size; n_y++) {
    for (int n_x = 0; n_x < x_size; n_x++) {
      ...
      ptr_double stepbymass = {stepbymass_p + n_x * 1 +
      ...
      ptr_double xvel1 = {xvel1_p + n_x * 1 + n_y * xdim4_accelerate_kernel * 1,
      ...
      ptr_double yvel1 = {yvel1_p + n_x * 1 + n_y * xdim8_accelerate_kernel * 1,
