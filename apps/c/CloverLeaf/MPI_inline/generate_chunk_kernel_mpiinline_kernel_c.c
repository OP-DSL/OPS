...
void generate_chunk_kernel_c_wrapper(
    const double *restrict vertexx, const double *restrict vertexy,
    double *restrict energy0, double *restrict density0, double *restrict xvel0,
    double *restrict yvel0, const double *restrict cellx,
    const double *restrict celly, int x_size, int y_size) {
