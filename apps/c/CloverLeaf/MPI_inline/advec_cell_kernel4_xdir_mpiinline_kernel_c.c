...
#define OPS_ACC0(x,y) (n_x*1 + x + (n_y*1+(y))*xdim0_advec_cell_kernel4_xdir)
#define OPS_ACC1(x,y) (n_x*1 + x + (n_y*1+(y))*xdim1_advec_cell_kernel4_xdir)
#define OPS_ACC2(x,y) (n_x*1 + x + (n_y*1+(y))*xdim2_advec_cell_kernel4_xdir)
#define OPS_ACC3(x,y) (n_x*1 + x + (n_y*1+(y))*xdim3_advec_cell_kernel4_xdir)
#define OPS_ACC4(x,y) (n_x*1 + x + (n_y*1+(y))*xdim4_advec_cell_kernel4_xdir)
#define OPS_ACC5(x,y) (n_x*1 + x + (n_y*1+(y))*xdim5_advec_cell_kernel4_xdir)
#define OPS_ACC6(x,y) (n_x*1 + x + (n_y*1+(y))*xdim6_advec_cell_kernel4_xdir)
#define OPS_ACC7(x,y) (n_x*1 + x + (n_y*1+(y))*xdim7_advec_cell_kernel4_xdir)
#define OPS_ACC8(x,y) (n_x*1 + x + (n_y*1+(y))*xdim8_advec_cell_kernel4_xdir)
#define OPS_ACC9(x,y) (n_x*1 + x + (n_y*1+(y))*xdim9_advec_cell_kernel4_xdir)
#define OPS_ACC10(x,y) (n_x*1 + x + (n_y*1+(y))*xdim10_advec_cell_kernel4_xdir)
//user function
