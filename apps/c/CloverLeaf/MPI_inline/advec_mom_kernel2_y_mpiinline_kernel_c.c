...
#pragma omp parallel for
  for (int n_y = 0; n_y < y_size; n_y++) {
    for (int n_x = 0; n_x < x_size; n_x++) {
      ptr_double vel1 = {vel1_p + n_x * 1 + n_y * xdim0_advec_mom_kernel2_y * 1,
      ...
      const ptr_double node_mass_pre = {node_mass_pre_p + n_x * 1 +
                                            n_y * xdim2_advec_mom_kernel2_y * 1,
                                        xdim2_advec_mom_kernel2_y};
      const ptr_double mom_flux = {mom_flux_p + n_x * 1 +
