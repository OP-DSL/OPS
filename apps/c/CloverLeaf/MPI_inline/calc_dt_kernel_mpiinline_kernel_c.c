...
void calc_dt_kernel_c_wrapper(
    ...
    double *restrict dt_min_p, int x_size, int y_size) {
#pragma omp parallel for
  for (int n_y = 0; n_y < y_size; n_y++) {
    for (int n_x = 0; n_x < x_size; n_x++) {
      ...
      const ptr_double soundspeed = {soundspeed_p + n_x * 1 +
      ...
      ptr_double dt_min = {dt_min_p + n_x * 1 + n_y * xdim10_calc_dt_kernel * 1,
