...
inline void advec_cell_kernel4_ydir(
    ACC<double> &density1, ACC<double> &energy1, const ACC<double> &mass_flux_y,
    const ACC<double> &vol_flux_y, const ACC<double> &pre_vol,
    const ACC<double> &post_vol, ACC<double> &pre_mass, ACC<double> &post_mass,
