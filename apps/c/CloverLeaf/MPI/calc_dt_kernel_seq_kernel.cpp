...
// user function
inline void calc_dt_kernel(const ACC<double> &celldx, const ACC<double> &celldy,
                           const ACC<double> &soundspeed,
                           const ACC<double> &viscosity,
                           const ACC<double> &density0,
                           const ACC<double> &xvel0, const ACC<double> &xarea,
                           const ACC<double> &volume, const ACC<double> &yvel0,
