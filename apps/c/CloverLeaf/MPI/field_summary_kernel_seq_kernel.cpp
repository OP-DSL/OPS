...
// user function
inline void
field_summary_kernel(const ACC<double> &volume, const ACC<double> &density0,
                     const ACC<double> &energy0, const ACC<double> &pressure,
                     const ACC<double> &xvel0, const ACC<double> &yvel0,
  ...
  vsqrd = 0.0;
  vsqrd =
      vsqrd + 0.25 * (xvel0(0, 0) * xvel0(0, 0) + yvel0(0, 0) * yvel0(0, 0));
  vsqrd =
      vsqrd + 0.25 * (xvel0(1, 0) * xvel0(1, 0) + yvel0(1, 0) * yvel0(1, 0));
  vsqrd =
      vsqrd + 0.25 * (xvel0(0, 1) * xvel0(0, 1) + yvel0(0, 1) * yvel0(0, 1));
  vsqrd =
      vsqrd + 0.25 * (xvel0(1, 1) * xvel0(1, 1) + yvel0(1, 1) * yvel0(1, 1));
