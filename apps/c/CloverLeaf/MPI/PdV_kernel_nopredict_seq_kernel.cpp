...
// user function
inline void
PdV_kernel_nopredict(const ACC<double> &xarea, const ACC<double> &xvel0,
                     const ACC<double> &xvel1, const ACC<double> &yarea,
  ...
  left_flux =
      (xarea(0, 0) * (xvel0(0, 0) + xvel0(0, 1) + xvel1(0, 0) + xvel1(0, 1))) *
      0.25 * dt;
  right_flux =
      (xarea(1, 0) * (xvel0(1, 0) + xvel0(1, 1) + xvel1(1, 0) + xvel1(1, 1))) *
      0.25 * dt;

  bottom_flux =
      (yarea(0, 0) * (yvel0(0, 0) + yvel0(1, 0) + yvel1(0, 0) + yvel1(1, 0))) *
      0.25 * dt;
  top_flux =
      (yarea(0, 1) * (yvel0(0, 1) + yvel0(1, 1) + yvel1(0, 1) + yvel1(1, 1))) *
      0.25 * dt;
