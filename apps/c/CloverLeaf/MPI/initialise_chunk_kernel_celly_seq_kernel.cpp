...
// user function
inline void initialise_chunk_kernel_celly(const ACC<double> &vertexy,
                                          ACC<double> &celly,
                                          ACC<double> &celldy) {
...
#pragma simd
      for (int i = 0; i < SIMD_VEC; i++) {
        initialise_chunk_kernel_celly((double *)p_a[0] + i * 0 * 1,
                                      (double *)p_a[1] + i * 0 * 1,
                                      (double *)p_a[2] + i * 0 * 1);
      }
    ...
    for (int n_x = start[0] + ((end[0] - start[0]) / SIMD_VEC) * SIMD_VEC;
      ...
      initialise_chunk_kernel_celly((double *)p_a[0], (double *)p_a[1],
                                    (double *)p_a[2]);
