...
#define OPS_ACC0(x, y) (x + dims_update_halo_kernel1_t1[0][0] * (y))
#define OPS_ACC1(x, y) (x + dims_update_halo_kernel1_t1[1][0] * (y))
#define OPS_ACC2(x, y) (x + dims_update_halo_kernel1_t1[2][0] * (y))
#define OPS_ACC3(x, y) (x + dims_update_halo_kernel1_t1[3][0] * (y))
#define OPS_ACC4(x, y) (x + dims_update_halo_kernel1_t1[4][0] * (y))
#define OPS_ACC5(x, y) (x + dims_update_halo_kernel1_t1[5][0] * (y))
#define OPS_ACC6(x, y) (x + dims_update_halo_kernel1_t1[6][0] * (y))
