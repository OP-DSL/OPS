...
void ops_decl_const_char(int dim, char const *type, int size, char *dat,
  ...
  if (!strcmp(name, "g_small")) {
    cutilSafeCall(OPS_instance::getOPSInstance()->ostream(),
                  cudaMemcpyToSymbol(g_small, dat, dim * size));
  } else if (!strcmp(name, "g_big")) {
    cutilSafeCall(OPS_instance::getOPSInstance()->ostream(),
                  cudaMemcpyToSymbol(g_big, dat, dim * size));
  } else if (!strcmp(name, "dtc_safe")) {
    cutilSafeCall(OPS_instance::getOPSInstance()->ostream(),
                  cudaMemcpyToSymbol(dtc_safe, dat, dim * size));
  } else if (!strcmp(name, "dtu_safe")) {
    cutilSafeCall(OPS_instance::getOPSInstance()->ostream(),
                  cudaMemcpyToSymbol(dtu_safe, dat, dim * size));
  } else if (!strcmp(name, "dtv_safe")) {
    cutilSafeCall(OPS_instance::getOPSInstance()->ostream(),
                  cudaMemcpyToSymbol(dtv_safe, dat, dim * size));
  } else if (!strcmp(name, "dtdiv_safe")) {
    cutilSafeCall(OPS_instance::getOPSInstance()->ostream(),
                  cudaMemcpyToSymbol(dtdiv_safe, dat, dim * size));
  } else if (!strcmp(name, "field")) {
    cutilSafeCall(OPS_instance::getOPSInstance()->ostream(),
                  cudaMemcpyToSymbol(field, dat, dim * size));
  } else if (!strcmp(name, "grid")) {
    cutilSafeCall(OPS_instance::getOPSInstance()->ostream(),
                  cudaMemcpyToSymbol(grid, dat, dim * size));
  } else if (!strcmp(name, "number_of_states")) {
    cutilSafeCall(OPS_instance::getOPSInstance()->ostream(),
                  cudaMemcpyToSymbol(number_of_states, dat, dim * size));
  } else if (!strcmp(name, "states")) {
    char *temp;
    cutilSafeCall(OPS_instance::getOPSInstance()->ostream(),
                  cudaMalloc((void **)&temp, dim * size));
    cutilSafeCall(OPS_instance::getOPSInstance()->ostream(),
                  cudaMemcpy(temp, dat, dim * size, cudaMemcpyHostToDevice));
    cutilSafeCall(OPS_instance::getOPSInstance()->ostream(),
                  cudaMemcpyToSymbol(states, &temp, sizeof(char *)));
  } else if (!strcmp(name, "g_circ")) {
    cutilSafeCall(OPS_instance::getOPSInstance()->ostream(),
                  cudaMemcpyToSymbol(g_circ, dat, dim * size));
  } else if (!strcmp(name, "g_point")) {
    cutilSafeCall(OPS_instance::getOPSInstance()->ostream(),
                  cudaMemcpyToSymbol(g_point, dat, dim * size));
  } else if (!strcmp(name, "g_rect")) {
    cutilSafeCall(OPS_instance::getOPSInstance()->ostream(),
                  cudaMemcpyToSymbol(g_rect, dat, dim * size));
  } else if (!strcmp(name, "dt")) {
    cutilSafeCall(OPS_instance::getOPSInstance()->ostream(),
                  cudaMemcpyToSymbol(dt, dat, dim * size));
  } else {
