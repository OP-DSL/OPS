...
#define OPS_ACC0(x, y) (x + dims_advec_cell_kernel4_xdir[0][0] * (y))
#define OPS_ACC1(x, y) (x + dims_advec_cell_kernel4_xdir[1][0] * (y))
#define OPS_ACC2(x, y) (x + dims_advec_cell_kernel4_xdir[2][0] * (y))
#define OPS_ACC3(x, y) (x + dims_advec_cell_kernel4_xdir[3][0] * (y))
#define OPS_ACC4(x, y) (x + dims_advec_cell_kernel4_xdir[4][0] * (y))
#define OPS_ACC5(x, y) (x + dims_advec_cell_kernel4_xdir[5][0] * (y))
#define OPS_ACC6(x, y) (x + dims_advec_cell_kernel4_xdir[6][0] * (y))
#define OPS_ACC7(x, y) (x + dims_advec_cell_kernel4_xdir[7][0] * (y))
#define OPS_ACC8(x, y) (x + dims_advec_cell_kernel4_xdir[8][0] * (y))
#define OPS_ACC9(x, y) (x + dims_advec_cell_kernel4_xdir[9][0] * (y))
#define OPS_ACC10(x, y) (x + dims_advec_cell_kernel4_xdir[10][0] * (y))
