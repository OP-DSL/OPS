...
#define OPS_ACC0(x, y) (x + dims_reset_field_kernel2[0][0] * (y))
#define OPS_ACC1(x, y) (x + dims_reset_field_kernel2[1][0] * (y))
#define OPS_ACC2(x, y) (x + dims_reset_field_kernel2[2][0] * (y))
#define OPS_ACC3(x, y) (x + dims_reset_field_kernel2[3][0] * (y))
...
__global__ void ops_reset_field_kernel2(double *__restrict arg0,
