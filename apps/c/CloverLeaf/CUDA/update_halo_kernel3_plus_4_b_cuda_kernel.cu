...
#define OPS_ACC0(x, y) (x + dims_update_halo_kernel3_plus_4_b[0][0] * (y))
#define OPS_ACC1(x, y) (x + dims_update_halo_kernel3_plus_4_b[1][0] * (y))
...
__global__ void ops_update_halo_kernel3_plus_4_b(double *__restrict arg0,
  ...
  arg0 +=
      idx_x * 1 * 1 + idx_y * 1 * 1 * dims_update_halo_kernel3_plus_4_b[0][0];
  arg1 +=
      idx_x * 1 * 1 + idx_y * 1 * 1 * dims_update_halo_kernel3_plus_4_b[1][0];
