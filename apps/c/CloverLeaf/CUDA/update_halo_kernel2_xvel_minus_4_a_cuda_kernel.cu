...
#define OPS_ACC0(x, y) (x + dims_update_halo_kernel2_xvel_minus_4_a[0][0] * (y))
#define OPS_ACC1(x, y) (x + dims_update_halo_kernel2_xvel_minus_4_a[1][0] * (y))
...
__global__ void ops_update_halo_kernel2_xvel_minus_4_a(
  ...
  arg0 += idx_x * 1 * 1 +
          idx_y * 1 * 1 * dims_update_halo_kernel2_xvel_minus_4_a[0][0];
  arg1 += idx_x * 1 * 1 +
          idx_y * 1 * 1 * dims_update_halo_kernel2_xvel_minus_4_a[1][0];
...
void ops_par_loop_update_halo_kernel2_xvel_minus_4_a_execute(
  ...
  if (xdim0 != dims_update_halo_kernel2_xvel_minus_4_a_h[0][0] ||
      xdim1 != dims_update_halo_kernel2_xvel_minus_4_a_h[1][0]) {
    dims_update_halo_kernel2_xvel_minus_4_a_h[0][0] = xdim0;
    dims_update_halo_kernel2_xvel_minus_4_a_h[1][0] = xdim1;
    cutilSafeCall(
        cudaMemcpyToSymbol(dims_update_halo_kernel2_xvel_minus_4_a,
                           dims_update_halo_kernel2_xvel_minus_4_a_h,
                           sizeof(dims_update_halo_kernel2_xvel_minus_4_a)));
  }
