...
#define OPS_ACC0(x, y) (x + dims_advec_mom_kernel_post_pre_advec_x[0][0] * (y))
#define OPS_ACC1(x, y) (x + dims_advec_mom_kernel_post_pre_advec_x[1][0] * (y))
#define OPS_ACC2(x, y) (x + dims_advec_mom_kernel_post_pre_advec_x[2][0] * (y))
#define OPS_ACC3(x, y) (x + dims_advec_mom_kernel_post_pre_advec_x[3][0] * (y))
#define OPS_ACC4(x, y) (x + dims_advec_mom_kernel_post_pre_advec_x[4][0] * (y))
...
void ops_par_loop_advec_mom_kernel_post_pre_advec_x_execute(
  ...
  if (!ops_checkpointing_before(args, 5, range, 74))
    return;
#endif
