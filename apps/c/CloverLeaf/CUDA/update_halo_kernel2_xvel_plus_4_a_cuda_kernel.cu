...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    update_halo_kernel2_xvel_plus_4_a_gpu(argp0,
                   argp1,
                   arg2);
  }
...
void ops_par_loop_update_halo_kernel2_xvel_plus_4_a_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_update_halo_kernel2_xvel_plus_4_a_h[0][0] || xdim1 != dims_update_halo_kernel2_xvel_plus_4_a_h[1][0]) {
    ...
    cutilSafeCall(cudaMemcpyToSymbol( dims_update_halo_kernel2_xvel_plus_4_a, dims_update_halo_kernel2_xvel_plus_4_a_h, sizeof(dims_update_halo_kernel2_xvel_plus_4_a)));
  }
