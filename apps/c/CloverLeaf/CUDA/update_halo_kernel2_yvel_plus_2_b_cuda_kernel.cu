...
#define OPS_ACC0(x, y) (x + dims_update_halo_kernel2_yvel_plus_2_b[0][0] * (y))
#define OPS_ACC1(x, y) (x + dims_update_halo_kernel2_yvel_plus_2_b[1][0] * (y))
...
__global__ void ops_update_halo_kernel2_yvel_plus_2_b(
  ...
  arg0 += idx_x * 1 * 1 +
          idx_y * 1 * 1 * dims_update_halo_kernel2_yvel_plus_2_b[0][0];
  arg1 += idx_x * 1 * 1 +
          idx_y * 1 * 1 * dims_update_halo_kernel2_yvel_plus_2_b[1][0];
...
void ops_par_loop_update_halo_kernel2_yvel_plus_2_b_execute(
  ...
  if (xdim0 != dims_update_halo_kernel2_yvel_plus_2_b_h[0][0] ||
      xdim1 != dims_update_halo_kernel2_yvel_plus_2_b_h[1][0]) {
    dims_update_halo_kernel2_yvel_plus_2_b_h[0][0] = xdim0;
    dims_update_halo_kernel2_yvel_plus_2_b_h[1][0] = xdim1;
    cutilSafeCall(
        cudaMemcpyToSymbol(dims_update_halo_kernel2_yvel_plus_2_b,
                           dims_update_halo_kernel2_yvel_plus_2_b_h,
                           sizeof(dims_update_halo_kernel2_yvel_plus_2_b)));
  }
