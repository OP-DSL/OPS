...
__global__ void ops_advec_mom_kernel1_y_nonvector(const double *__restrict arg0,
  ...
  arg0 +=
      idx_x * 1 * 1 + idx_y * 1 * 1 * dims_advec_mom_kernel1_y_nonvector[0][0];
  arg1 +=
      idx_x * 1 * 1 + idx_y * 1 * 1 * dims_advec_mom_kernel1_y_nonvector[1][0];
  arg2 +=
      idx_x * 1 * 1 + idx_y * 1 * 1 * dims_advec_mom_kernel1_y_nonvector[2][0];
  arg3 +=
      idx_x * 0 * 1 + idx_y * 1 * 1 * dims_advec_mom_kernel1_y_nonvector[3][0];
  arg4 +=
      idx_x * 1 * 1 + idx_y * 1 * 1 * dims_advec_mom_kernel1_y_nonvector[4][0];
