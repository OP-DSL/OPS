...
#define OPS_ACC0(x, y) (x + dims_advec_mom_kernel1_x_nonvector[0][0] * (y))
#define OPS_ACC1(x, y) (x + dims_advec_mom_kernel1_x_nonvector[1][0] * (y))
#define OPS_ACC2(x, y) (x + dims_advec_mom_kernel1_x_nonvector[2][0] * (y))
#define OPS_ACC3(x, y) (x + dims_advec_mom_kernel1_x_nonvector[3][0] * (y))
#define OPS_ACC4(x, y) (x + dims_advec_mom_kernel1_x_nonvector[4][0] * (y))
...
__global__ void ops_advec_mom_kernel1_x_nonvector(const double *__restrict arg0,
  ...
  arg0 +=
      idx_x * 1 * 1 + idx_y * 1 * 1 * dims_advec_mom_kernel1_x_nonvector[0][0];
  arg1 +=
      idx_x * 1 * 1 + idx_y * 1 * 1 * dims_advec_mom_kernel1_x_nonvector[1][0];
  arg2 +=
      idx_x * 1 * 1 + idx_y * 1 * 1 * dims_advec_mom_kernel1_x_nonvector[2][0];
  arg3 +=
      idx_x * 1 * 1 + idx_y * 0 * 1 * dims_advec_mom_kernel1_x_nonvector[3][0];
  arg4 +=
      idx_x * 1 * 1 + idx_y * 1 * 1 * dims_advec_mom_kernel1_x_nonvector[4][0];
