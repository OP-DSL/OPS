...
#define OPS_ACC0(x, y) (x + dims_advec_cell_kernel4_ydir[0][0] * (y))
#define OPS_ACC1(x, y) (x + dims_advec_cell_kernel4_ydir[1][0] * (y))
#define OPS_ACC2(x, y) (x + dims_advec_cell_kernel4_ydir[2][0] * (y))
#define OPS_ACC3(x, y) (x + dims_advec_cell_kernel4_ydir[3][0] * (y))
#define OPS_ACC4(x, y) (x + dims_advec_cell_kernel4_ydir[4][0] * (y))
#define OPS_ACC5(x, y) (x + dims_advec_cell_kernel4_ydir[5][0] * (y))
#define OPS_ACC6(x, y) (x + dims_advec_cell_kernel4_ydir[6][0] * (y))
#define OPS_ACC7(x, y) (x + dims_advec_cell_kernel4_ydir[7][0] * (y))
#define OPS_ACC8(x, y) (x + dims_advec_cell_kernel4_ydir[8][0] * (y))
#define OPS_ACC9(x, y) (x + dims_advec_cell_kernel4_ydir[9][0] * (y))
#define OPS_ACC10(x, y) (x + dims_advec_cell_kernel4_ydir[10][0] * (y))
...
void ops_par_loop_advec_cell_kernel4_ydir_execute(ops_kernel_descriptor *desc) {
  ...
  if (!ops_checkpointing_before(args, 11, range, 68))
    return;
#endif
