...
void ops_par_loop_update_halo_kernel2_xvel_plus_4_b_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_update_halo_kernel2_xvel_plus_4_b_h[0][0] || xdim1 != dims_update_halo_kernel2_xvel_plus_4_b_h[1][0]) {
    ...
    cutilSafeCall(cudaMemcpyToSymbol( dims_update_halo_kernel2_xvel_plus_4_b, dims_update_halo_kernel2_xvel_plus_4_b_h, sizeof(dims_update_halo_kernel2_xvel_plus_4_b)));
  }
