...
#define OPS_ACC0(x, y) (x + dims_advec_mom_kernel_mass_flux_y[0][0] * (y))
#define OPS_ACC1(x, y) (x + dims_advec_mom_kernel_mass_flux_y[1][0] * (y))
...
__global__ void ops_advec_mom_kernel_mass_flux_y(double *__restrict arg0,
  ...
  arg0 +=
      idx_x * 1 * 1 + idx_y * 1 * 1 * dims_advec_mom_kernel_mass_flux_y[0][0];
  arg1 +=
      idx_x * 1 * 1 + idx_y * 1 * 1 * dims_advec_mom_kernel_mass_flux_y[1][0];
