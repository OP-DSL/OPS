...
#define OPS_ACC0(x, y) (x + dims_advec_cell_kernel1_xdir[0][0] * (y))
#define OPS_ACC1(x, y) (x + dims_advec_cell_kernel1_xdir[1][0] * (y))
#define OPS_ACC2(x, y) (x + dims_advec_cell_kernel1_xdir[2][0] * (y))
#define OPS_ACC3(x, y) (x + dims_advec_cell_kernel1_xdir[3][0] * (y))
#define OPS_ACC4(x, y) (x + dims_advec_cell_kernel1_xdir[4][0] * (y))
...
__global__ void ops_advec_cell_kernel1_xdir(double *__restrict arg0,
  ...
  if (idx_x < size0 && idx_y < size1) {
    advec_cell_kernel1_xdir_gpu(arg0, arg1, arg2, arg3, arg4);
  }
}
