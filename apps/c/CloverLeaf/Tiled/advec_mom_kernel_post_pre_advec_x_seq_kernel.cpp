...
void ops_par_loop_advec_mom_kernel_post_pre_advec_x_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ ACC<> &node_mass_post = (double *)(args[0].data + base0);

  int base1 = args[1].dat->base_offset;
  const double * __restrict__ ACC<> &post_vol = (double *)(args[1].data + base1);

  int base2 = args[2].dat->base_offset;
  const double * __restrict__ ACC<> &density1 = (double *)(args[2].data + base2);

  int base3 = args[3].dat->base_offset;
  double * __restrict__ ACC<> &node_mass_pre = (double *)(args[3].data + base3);

  int base4 = args[4].dat->base_offset;
  const double * __restrict__ ACC<> &node_flux = (double *)(args[4].data + base4);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    #pragma omp simd aligned(ACC<> &node_mass_post,ACC<> &post_vol,ACC<> &density1,ACC<> &node_mass_pre,ACC<> &node_flux)
    #else
    #pragma simd
    #endif
