...
void ops_par_loop_flux_calc_kernely_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ ACC<> &vol_flux_y = (double *)(args[0].data + base0);

  int base1 = args[1].dat->base_offset;
  const double * __restrict__ ACC<> &yarea = (double *)(args[1].data + base1);

  int base2 = args[2].dat->base_offset;
  const double * __restrict__ ACC<> &yvel0 = (double *)(args[2].data + base2);

  int base3 = args[3].dat->base_offset;
  const double * __restrict__ ACC<> &yvel1 = (double *)(args[3].data + base3);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    #pragma omp simd aligned(ACC<> &vol_flux_y,ACC<> &yarea,ACC<> &yvel0,ACC<> &yvel1)
    #else
    #pragma simd
    #endif
