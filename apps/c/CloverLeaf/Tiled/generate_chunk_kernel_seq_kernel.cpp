...
#define OPS_ACC5(x, y)                                                         \
  (n_x * 1 + n_y * xdim5_generate_chunk_kernel * 1 + x +                       \
   xdim5_generate_chunk_kernel * (y))
#define OPS_ACC6(x, y)                                                         \
  (n_x * 1 + n_y * xdim6_generate_chunk_kernel * 0 + x +                       \
   xdim6_generate_chunk_kernel * (y))
#define OPS_ACC7(x, y)                                                         \
  (n_x * 0 + n_y * xdim7_generate_chunk_kernel * 1 + x +                       \
...
#pragma omp simd aligned(vertexx, vertexy, energy0, density0, xvel0, yvel0,    \
                         cellx, celly)
#else
#pragma simd
#endif
