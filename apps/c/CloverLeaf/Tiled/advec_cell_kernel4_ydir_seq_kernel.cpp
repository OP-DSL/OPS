...
void ops_par_loop_advec_cell_kernel4_ydir_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ ACC<> &density1 = (double *)(args[0].data + base0);

  int base1 = args[1].dat->base_offset;
  double * __restrict__ ACC<> &energy1 = (double *)(args[1].data + base1);

  int base2 = args[2].dat->base_offset;
  const double * __restrict__ ACC<> &mass_flux_y = (double *)(args[2].data + base2);

  int base3 = args[3].dat->base_offset;
  const double * __restrict__ ACC<> &vol_flux_y = (double *)(args[3].data + base3);

  int base4 = args[4].dat->base_offset;
  const double * __restrict__ ACC<> &pre_vol = (double *)(args[4].data + base4);

  int base5 = args[5].dat->base_offset;
  const double * __restrict__ ACC<> &post_vol = (double *)(args[5].data + base5);

  int base6 = args[6].dat->base_offset;
  double * __restrict__ ACC<> &pre_mass = (double *)(args[6].data + base6);

  int base7 = args[7].dat->base_offset;
  double * __restrict__ ACC<> &post_mass = (double *)(args[7].data + base7);

  int base8 = args[8].dat->base_offset;
  double * __restrict__ ACC<> &advec_vol = (double *)(args[8].data + base8);

  int base9 = args[9].dat->base_offset;
  double * __restrict__ ACC<> &post_ener = (double *)(args[9].data + base9);

  int base10 = args[10].dat->base_offset;
  const double * __restrict__ ACC<> &ener_flux = (double *)(args[10].data + base10);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    #pragma omp simd aligned(ACC<> &density1,ACC<> &energy1,ACC<> &mass_flux_y,ACC<> &vol_flux_y,ACC<> &pre_vol,ACC<> &post_vol,ACC<> &pre_mass,ACC<> &post_mass,ACC<> &advec_vol,ACC<> &post_ener,ACC<> &ener_flux)
    #else
    #pragma simd
    #endif
