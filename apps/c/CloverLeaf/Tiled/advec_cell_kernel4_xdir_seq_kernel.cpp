...
void ops_par_loop_advec_cell_kernel4_xdir_execute(ops_kernel_descriptor *desc) {
  ...
  const double * __restrict__ ACC<> &mass_flux_x = (double *)(args[2].data + base2);

  int base3 = args[3].dat->base_offset;
  const double * __restrict__ ACC<> &vol_flux_x = (double *)(args[3].data + base3);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    #pragma omp simd aligned(ACC<> &density1,ACC<> &energy1,ACC<> &mass_flux_x,ACC<> &vol_flux_x,ACC<> &pre_vol,ACC<> &post_vol,ACC<> &pre_mass,ACC<> &post_mass,ACC<> &advec_vol,ACC<> &post_ener,ACC<> &ener_flux)
    #else
    #pragma simd
    #endif
