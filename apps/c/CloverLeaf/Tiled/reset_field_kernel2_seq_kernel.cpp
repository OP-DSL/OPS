...
void ops_par_loop_reset_field_kernel2_execute(ops_kernel_descriptor *desc) {
  ...
  const double * __restrict__ ACC<> &xvel1 = (double *)(args[1].data + base1);

  int base2 = args[2].dat->base_offset;
  double * __restrict__ ACC<> &yvel0 = (double *)(args[2].data + base2);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    #pragma omp simd aligned(ACC<> &xvel0,ACC<> &xvel1,ACC<> &yvel0,ACC<> &yvel1)
    #else
    #pragma simd
    #endif
