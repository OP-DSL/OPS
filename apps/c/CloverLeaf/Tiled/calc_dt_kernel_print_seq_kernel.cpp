...
void ops_par_loop_calc_dt_kernel_print_execute(ops_kernel_descriptor *desc) {
  ...
  const double * __restrict__ ACC<> &density0 = (double *)(args[2].data + base2);

  int base3 = args[3].dat->base_offset;
  const double * __restrict__ ACC<> &energy0 = (double *)(args[3].data + base3);

  int base4 = args[4].dat->base_offset;
  const double * __restrict__ ACC<> &pressure = (double *)(args[4].data + base4);

  int base5 = args[5].dat->base_offset;
  const double * __restrict__ ACC<> &soundspeed = (double *)(args[5].data + base5);
