...
void ops_par_loop_calc_dt_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  const double * __restrict__ ACC<> &celldx = (double *)(args[0].data + base0);

  int base1 = args[1].dat->base_offset;
  const double * __restrict__ ACC<> &celldy = (double *)(args[1].data + base1);

  int base2 = args[2].dat->base_offset;
  const double * __restrict__ ACC<> &soundspeed = (double *)(args[2].data + base2);

  int base3 = args[3].dat->base_offset;
  const double * __restrict__ ACC<> &viscosity = (double *)(args[3].data + base3);

  int base4 = args[4].dat->base_offset;
  const double * __restrict__ ACC<> &density0 = (double *)(args[4].data + base4);

  int base5 = args[5].dat->base_offset;
  const double * __restrict__ ACC<> &xvel0 = (double *)(args[5].data + base5);

  int base6 = args[6].dat->base_offset;
  const double * __restrict__ ACC<> &xarea = (double *)(args[6].data + base6);

  int base7 = args[7].dat->base_offset;
  const double * __restrict__ ACC<> &volume = (double *)(args[7].data + base7);

  int base8 = args[8].dat->base_offset;
  const double * __restrict__ ACC<> &yvel0 = (double *)(args[8].data + base8);

  int base9 = args[9].dat->base_offset;
  const double * __restrict__ ACC<> &yarea = (double *)(args[9].data + base9);

  int base10 = args[10].dat->base_offset;
  double * __restrict__ ACC<> &dt_min = (double *)(args[10].data + base10);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    #pragma omp simd aligned(ACC<> &celldx,ACC<> &celldy,ACC<> &soundspeed,ACC<> &viscosity,ACC<> &density0,ACC<> &xvel0,ACC<> &xarea,ACC<> &volume,ACC<> &yvel0,ACC<> &yarea,ACC<> &dt_min)
    #else
    #pragma simd
    #endif
