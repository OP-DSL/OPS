...
void ops_par_loop_calc_dt_kernel_get_execute(ops_kernel_descriptor *desc) {
  ...
  const double * __restrict__ ACC<> &cellx = (double *)(args[0].data + base0);

  int base1 = args[1].dat->base_offset;
  const double * __restrict__ ACC<> &celly = (double *)(args[1].data + base1);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    #pragma omp simd reduction(+:p_a2_0) reduction(+:p_a3_0) aligned(ACC<> &cellx,ACC<> &celly)
    #else
