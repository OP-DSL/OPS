...
void ops_par_loop_ideal_gas_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  const double * __restrict__ ACC<> &density = (double *)(args[0].data + base0);

  int base1 = args[1].dat->base_offset;
  const double * __restrict__ ACC<> &energy = (double *)(args[1].data + base1);

  int base2 = args[2].dat->base_offset;
  double * __restrict__ ACC<> &pressure = (double *)(args[2].data + base2);

  int base3 = args[3].dat->base_offset;
  double * __restrict__ ACC<> &soundspeed = (double *)(args[3].data + base3);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    #pragma omp simd aligned(ACC<> &density,ACC<> &energy,ACC<> &pressure,ACC<> &soundspeed)
    #else
    #pragma simd
    #endif
