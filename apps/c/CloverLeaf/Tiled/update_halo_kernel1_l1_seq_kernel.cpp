...
void ops_par_loop_update_halo_kernel1_l1_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ ACC<> &density0 = (double *)(args[0].data + base0);

  int base1 = args[1].dat->base_offset;
  double * __restrict__ ACC<> &density1 = (double *)(args[1].data + base1);

  int base2 = args[2].dat->base_offset;
  double * __restrict__ ACC<> &energy0 = (double *)(args[2].data + base2);

  int base3 = args[3].dat->base_offset;
  double * __restrict__ ACC<> &energy1 = (double *)(args[3].data + base3);

  int base4 = args[4].dat->base_offset;
  double * __restrict__ ACC<> &pressure = (double *)(args[4].data + base4);

  int base5 = args[5].dat->base_offset;
  double * __restrict__ ACC<> &viscosity = (double *)(args[5].data + base5);

  int base6 = args[6].dat->base_offset;
  double * __restrict__ ACC<> &soundspeed = (double *)(args[6].data + base6);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    #pragma omp simd aligned(ACC<> &density0,ACC<> &density1,ACC<> &energy0,ACC<> &energy1,ACC<> &pressure,ACC<> &viscosity,ACC<> &soundspeed)
    #else
    #pragma simd
    #endif
