...
void ops_par_loop_advec_cell_kernel3_ydir_execute(ops_kernel_descriptor *desc) {
  ...
  const double * __restrict__ ACC<> &vol_flux_y = (double *)(args[0].data + base0);

  int base1 = args[1].dat->base_offset;
  const double * __restrict__ ACC<> &pre_vol = (double *)(args[1].data + base1);

  int base2 = args[2].dat->base_offset;
  const int * __restrict__ ACC<> &yy = (int *)(args[2].data + base2);

  int base3 = args[3].dat->base_offset;
  const double * __restrict__ ACC<> &vertexdy = (double *)(args[3].data + base3);
  ...
  double * __restrict__ ACC<> &mass_flux_y = (double *)(args[6].data + base6);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    #pragma omp simd aligned(ACC<> &vol_flux_y,ACC<> &pre_vol,ACC<> &yy,ACC<> &vertexdy,ACC<> &density1,ACC<> &energy1,ACC<> &mass_flux_y,ACC<> &ener_flux)
    #else
    #pragma simd
    #endif
