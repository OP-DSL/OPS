...
void ops_par_loop_initialise_chunk_kernel_y_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ ACC<> &vertexy = (double *)(args[0].data + base0);

  int base1 = args[1].dat->base_offset;
  const int * __restrict__ ACC<> &yy = (int *)(args[1].data + base1);

  int base2 = args[2].dat->base_offset;
  double * __restrict__ ACC<> &vertexdy = (double *)(args[2].data + base2);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    #pragma omp simd aligned(ACC<> &vertexy,ACC<> &yy,ACC<> &vertexdy)
    #else
    #pragma simd
    #endif
