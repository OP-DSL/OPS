...
void ops_par_loop_flux_calc_kernelx_execute(ops_kernel_descriptor *desc) {
  ...
  const double * __restrict__ ACC<> &xarea = (double *)(args[1].data + base1);

  int base2 = args[2].dat->base_offset;
  const double * __restrict__ ACC<> &xvel0 = (double *)(args[2].data + base2);

  int base3 = args[3].dat->base_offset;
  const double * __restrict__ ACC<> &xvel1 = (double *)(args[3].data + base3);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    #pragma omp simd aligned(ACC<> &vol_flux_x,ACC<> &xarea,ACC<> &xvel0,ACC<> &xvel1)
    #else
    #pragma simd
    #endif
