...
void ops_par_loop_advec_mom_kernel2_x_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ ACC<> &vel1 = (double *)(args[0].data + base0);

  int base1 = args[1].dat->base_offset;
  const double * __restrict__ ACC<> &node_mass_post = (double *)(args[1].data + base1);

  int base2 = args[2].dat->base_offset;
  const double * __restrict__ ACC<> &node_mass_pre = (double *)(args[2].data + base2);

  int base3 = args[3].dat->base_offset;
  const double * __restrict__ ACC<> &mom_flux = (double *)(args[3].data + base3);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    #pragma omp simd aligned(ACC<> &vel1,ACC<> &node_mass_post,ACC<> &node_mass_pre,ACC<> &mom_flux)
    #else
    #pragma simd
    #endif
