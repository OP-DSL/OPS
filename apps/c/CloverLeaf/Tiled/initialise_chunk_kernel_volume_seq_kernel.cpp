...
void ops_par_loop_initialise_chunk_kernel_volume_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ ACC<> &volume = (double *)(args[0].data + base0);

  int base1 = args[1].dat->base_offset;
  const double * __restrict__ ACC<> &celldy = (double *)(args[1].data + base1);

  int base2 = args[2].dat->base_offset;
  double * __restrict__ ACC<> &xarea = (double *)(args[2].data + base2);

  int base3 = args[3].dat->base_offset;
  const double * __restrict__ ACC<> &celldx = (double *)(args[3].data + base3);

  int base4 = args[4].dat->base_offset;
  double * __restrict__ ACC<> &yarea = (double *)(args[4].data + base4);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    #pragma omp simd aligned(ACC<> &volume,ACC<> &celldy,ACC<> &xarea,ACC<> &celldx,ACC<> &yarea)
    #else
    #pragma simd
    #endif
