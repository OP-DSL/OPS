...
void ops_par_loop_PdV_kernel_nopredict_execute(ops_kernel_descriptor *desc) {
  ...
  const double * __restrict__ ACC<> &xvel1 = (double *)(args[2].data + base2);

  int base3 = args[3].dat->base_offset;
  const double * __restrict__ ACC<> &yarea = (double *)(args[3].data + base3);

  int base4 = args[4].dat->base_offset;
  const double * __restrict__ ACC<> &yvel0 = (double *)(args[4].data + base4);

  int base5 = args[5].dat->base_offset;
  const double * __restrict__ ACC<> &yvel1 = (double *)(args[5].data + base5);

  int base6 = args[6].dat->base_offset;
  double * __restrict__ ACC<> &volume_change = (double *)(args[6].data + base6);

  int base7 = args[7].dat->base_offset;
  const double * __restrict__ ACC<> &volume = (double *)(args[7].data + base7);

  int base8 = args[8].dat->base_offset;
  const double * __restrict__ ACC<> &pressure = (double *)(args[8].data + base8);

  int base9 = args[9].dat->base_offset;
  const double * __restrict__ ACC<> &density0 = (double *)(args[9].data + base9);

  int base10 = args[10].dat->base_offset;
  double * __restrict__ ACC<> &density1 = (double *)(args[10].data + base10);

  int base11 = args[11].dat->base_offset;
  const double * __restrict__ ACC<> &viscosity = (double *)(args[11].data + base11);

  int base12 = args[12].dat->base_offset;
  const double * __restrict__ ACC<> &energy0 = (double *)(args[12].data + base12);

  int base13 = args[13].dat->base_offset;
  double * __restrict__ ACC<> &energy1 = (double *)(args[13].data + base13);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    #pragma omp simd aligned(ACC<> &xarea,ACC<> &xvel0,ACC<> &xvel1,ACC<> &yarea,ACC<> &yvel0,ACC<> &yvel1,ACC<> &volume_change,ACC<> &volume,ACC<> &pressure,ACC<> &density0,ACC<> &density1,ACC<> &viscosity,ACC<> &energy0,ACC<> &energy1)
    #else
    #pragma simd
    #endif
