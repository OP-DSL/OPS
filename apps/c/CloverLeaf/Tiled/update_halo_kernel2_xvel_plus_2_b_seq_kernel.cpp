...
void ops_par_loop_update_halo_kernel2_xvel_plus_2_b_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ ACC<> &xvel0 = (double *)(args[0].data + base0);

  int base1 = args[1].dat->base_offset;
  double * __restrict__ ACC<> &xvel1 = (double *)(args[1].data + base1);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    #pragma omp simd aligned(ACC<> &xvel0,ACC<> &xvel1)
    #else
    #pragma simd
    #endif
