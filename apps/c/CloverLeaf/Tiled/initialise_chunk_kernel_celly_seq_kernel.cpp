...
void ops_par_loop_initialise_chunk_kernel_celly_execute(ops_kernel_descriptor *desc) {
  ...
  const double * __restrict__ ACC<> &vertexy = (double *)(args[0].data + base0);

  int base1 = args[1].dat->base_offset;
  double * __restrict__ ACC<> &celly = (double *)(args[1].data + base1);

  int base2 = args[2].dat->base_offset;
  double * __restrict__ ACC<> &celldy = (double *)(args[2].data + base2);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    #pragma omp simd aligned(ACC<> &vertexy,ACC<> &celly,ACC<> &celldy)
    #else
    #pragma simd
    #endif
