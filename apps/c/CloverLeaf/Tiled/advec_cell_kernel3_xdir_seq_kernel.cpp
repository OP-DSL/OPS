...
void ops_par_loop_advec_cell_kernel3_xdir_execute(ops_kernel_descriptor *desc) {
  ...
  const double * __restrict__ ACC<> &vol_flux_x = (double *)(args[0].data + base0);

  int base1 = args[1].dat->base_offset;
  const double * __restrict__ ACC<> &pre_vol = (double *)(args[1].data + base1);

  int base2 = args[2].dat->base_offset;
  const int * __restrict__ ACC<> &xx = (int *)(args[2].data + base2);

  int base3 = args[3].dat->base_offset;
  const double * __restrict__ ACC<> &vertexdx = (double *)(args[3].data + base3);

  int base4 = args[4].dat->base_offset;
  const double * __restrict__ ACC<> &density1 = (double *)(args[4].data + base4);

  int base5 = args[5].dat->base_offset;
  const double * __restrict__ ACC<> &energy1 = (double *)(args[5].data + base5);

  int base6 = args[6].dat->base_offset;
  double * __restrict__ ACC<> &mass_flux_x = (double *)(args[6].data + base6);

  int base7 = args[7].dat->base_offset;
  double * __restrict__ ACC<> &ener_flux = (double *)(args[7].data + base7);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    #pragma omp simd aligned(ACC<> &vol_flux_x,ACC<> &pre_vol,ACC<> &xx,ACC<> &vertexdx,ACC<> &density1,ACC<> &energy1,ACC<> &mass_flux_x,ACC<> &ener_flux)
    #else
    #pragma simd
    #endif
