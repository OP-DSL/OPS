...
void ops_par_loop_advec_mom_kernel1_x_nonvector_execute(ops_kernel_descriptor *desc) {
  ...
  const double * __restrict__ ACC<> &node_flux = (double *)(args[0].data + base0);

  int base1 = args[1].dat->base_offset;
  const double * __restrict__ ACC<> &node_mass_pre = (double *)(args[1].data + base1);

  int base2 = args[2].dat->base_offset;
  double * __restrict__ ACC<> &mom_flux = (double *)(args[2].data + base2);

  int base3 = args[3].dat->base_offset;
  const double * __restrict__ ACC<> &celldx = (double *)(args[3].data + base3);

  int base4 = args[4].dat->base_offset;
  const double * __restrict__ ACC<> &vel1 = (double *)(args[4].data + base4);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    #pragma omp simd aligned(ACC<> &node_flux,ACC<> &node_mass_pre,ACC<> &mom_flux,ACC<> &celldx,ACC<> &vel1)
    #else
    #pragma simd
    #endif
