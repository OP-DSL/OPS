...
void ops_par_loop_initialise_chunk_kernel_cellx_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ ACC<> &cellx = (double *)(args[1].data + base1);

  int base2 = args[2].dat->base_offset;
  double * __restrict__ ACC<> &celldx = (double *)(args[2].data + base2);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    #pragma omp simd aligned(ACC<> &vertexx,ACC<> &cellx,ACC<> &celldx)
    #else
    #pragma simd
    #endif
