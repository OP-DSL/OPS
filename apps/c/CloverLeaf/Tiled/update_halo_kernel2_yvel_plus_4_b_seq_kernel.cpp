...
void ops_par_loop_update_halo_kernel2_yvel_plus_4_b_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ ACC<> &yvel0 = (double *)(args[0].data + base0);

  int base1 = args[1].dat->base_offset;
  double * __restrict__ ACC<> &yvel1 = (double *)(args[1].data + base1);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    #pragma omp simd aligned(ACC<> &yvel0,ACC<> &yvel1)
    #else
    #pragma simd
    #endif
