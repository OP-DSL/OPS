...
#pragma simd
      ...
      for (int n_x = start[0] + ((end[0] - start[0]) / SIMD_VEC) * SIMD_VEC;
        ...
        accelerate_kernel(
            (const double *)p_a[0], (const double *)p_a[1], (double *)p_a[2],
            (const double *)p_a[3], (double *)p_a[4], (const double *)p_a[5],
            (const double *)p_a[6], (const double *)p_a[7], (double *)p_a[8],
            (const double *)p_a[9], (const double *)p_a[10]);
