...
#pragma simd
    ...
    for (int n_x = start[0]; n_x < end[0]; n_x++) {
      ACC<double> vol_flux_y(xdim0_update_halo_kernel4_plus_4_a,
                             vol_flux_y_p + n_x * 1 +
                                 n_y * xdim0_update_halo_kernel4_plus_4_a * 1);
      ACC<double> mass_flux_y(xdim1_update_halo_kernel4_plus_4_a,
                              mass_flux_y_p + n_x * 1 +
