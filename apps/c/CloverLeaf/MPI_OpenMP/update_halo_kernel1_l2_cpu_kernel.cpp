...
void ops_par_loop_update_halo_kernel1_l2_execute(ops_kernel_descriptor *desc) {
  ...
  if (OPS_instance::getOPSInstance()->OPS_diags > 1) {
    ...
    OPS_instance::getOPSInstance()->OPS_kernels[13].mpi_time += __t1-__t2;
  }
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      ACC<double> density1(xdim1_update_halo_kernel1_l2, density1_p + n_x*1 + n_y * xdim1_update_halo_kernel1_l2*1);
      ACC<double> energy0(xdim2_update_halo_kernel1_l2, energy0_p + n_x*1 + n_y * xdim2_update_halo_kernel1_l2*1);
      ACC<double> energy1(xdim3_update_halo_kernel1_l2, energy1_p + n_x*1 + n_y * xdim3_update_halo_kernel1_l2*1);
      ACC<double> pressure(xdim4_update_halo_kernel1_l2, pressure_p + n_x*1 + n_y * xdim4_update_halo_kernel1_l2*1);
      ACC<double> viscosity(xdim5_update_halo_kernel1_l2, viscosity_p + n_x*1 + n_y * xdim5_update_halo_kernel1_l2*1);
      ACC<double> soundspeed(xdim6_update_halo_kernel1_l2, soundspeed_p + n_x*1 + n_y * xdim6_update_halo_kernel1_l2*1);
  ...
  if (OPS_instance::getOPSInstance()->OPS_diags > 1) {
    ops_timers_core(&__c2,&__t2);
    OPS_instance::getOPSInstance()->OPS_kernels[13].time += __t2-__t1;
  }
  #ifndef OPS_LAZY
