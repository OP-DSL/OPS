...
#pragma simd
    ...
    for (int n_x = start[0]; n_x < end[0]; n_x++) {
      ACC<double> vol_flux_x(xdim0_flux_calc_kernelx,
                             vol_flux_x_p + n_x * 1 +
                                 n_y * xdim0_flux_calc_kernelx * 1);
      const ACC<double> xarea(xdim1_flux_calc_kernelx,
                              xarea_p + n_x * 1 +
                                  n_y * xdim1_flux_calc_kernelx * 1);
      const ACC<double> xvel0(xdim2_flux_calc_kernelx,
                              xvel0_p + n_x * 1 +
                                  n_y * xdim2_flux_calc_kernelx * 1);
      const ACC<double> xvel1(xdim3_flux_calc_kernelx,
                              xvel1_p + n_x * 1 +
                                  n_y * xdim3_flux_calc_kernelx * 1);
