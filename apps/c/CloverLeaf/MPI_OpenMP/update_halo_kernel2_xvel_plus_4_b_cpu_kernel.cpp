...
void ops_par_loop_update_halo_kernel2_xvel_plus_4_b_execute(ops_kernel_descriptor *desc) {
  ...
  #ifdef OPS_DEBUG
  ops_register_args(block->instance, args, "update_halo_kernel2_xvel_plus_4_b");
  #endif
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ACC<double> xvel0(xdim0_update_halo_kernel2_xvel_plus_4_b, xvel0_p + n_x*1 + n_y * xdim0_update_halo_kernel2_xvel_plus_4_b*1);
      ACC<double> xvel1(xdim1_update_halo_kernel2_xvel_plus_4_b, xvel1_p + n_x*1 + n_y * xdim1_update_halo_kernel2_xvel_plus_4_b*1);
