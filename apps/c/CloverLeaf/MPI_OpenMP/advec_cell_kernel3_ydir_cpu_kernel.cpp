...
#pragma omp simd aligned(vol_flux_y_p, pre_vol_p, yy_p, vertexdy_p,            \
                         density1_p, energy1_p, mass_flux_y_p, ener_flux_p)
...
#pragma simd
    ...
    for (int n_x = start[0]; n_x < end[0]; n_x++) {
      const ACC<double> vol_flux_y(xdim0_advec_cell_kernel3_ydir,
                                   vol_flux_y_p + n_x * 1 +
                                       n_y * xdim0_advec_cell_kernel3_ydir * 1);
      const ACC<double> pre_vol(xdim1_advec_cell_kernel3_ydir,
                                pre_vol_p + n_x * 1 +
                                    n_y * xdim1_advec_cell_kernel3_ydir * 1);
      const ACC<int> yy(xdim2_advec_cell_kernel3_ydir,
                        yy_p + n_x * 0 +
                            n_y * xdim2_advec_cell_kernel3_ydir * 1);
      const ACC<double> vertexdy(xdim3_advec_cell_kernel3_ydir,
                                 vertexdy_p + n_x * 0 +
                                     n_y * xdim3_advec_cell_kernel3_ydir * 1);
      const ACC<double> density1(xdim4_advec_cell_kernel3_ydir,
                                 density1_p + n_x * 1 +
                                     n_y * xdim4_advec_cell_kernel3_ydir * 1);
      const ACC<double> energy1(xdim5_advec_cell_kernel3_ydir,
                                energy1_p + n_x * 1 +
                                    n_y * xdim5_advec_cell_kernel3_ydir * 1);
      ACC<double> mass_flux_y(xdim6_advec_cell_kernel3_ydir,
                              mass_flux_y_p + n_x * 1 +
                                  n_y * xdim6_advec_cell_kernel3_ydir * 1);
      ACC<double> ener_flux(xdim7_advec_cell_kernel3_ydir,
                            ener_flux_p + n_x * 1 +
                                n_y * xdim7_advec_cell_kernel3_ydir * 1);
      ...
      sigmam =
          fabs(mass_flux_y(0, 0)) / (density1(0, donor) * pre_vol(0, donor));
