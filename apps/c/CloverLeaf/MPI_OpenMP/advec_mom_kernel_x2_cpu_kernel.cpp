...
#pragma simd
    ...
    for (int n_x = start[0]; n_x < end[0]; n_x++) {
      ACC<double> pre_vol(xdim0_advec_mom_kernel_x2,
                          pre_vol_p + n_x * 1 +
                              n_y * xdim0_advec_mom_kernel_x2 * 1);
      ACC<double> post_vol(xdim1_advec_mom_kernel_x2,
                           post_vol_p + n_x * 1 +
                               n_y * xdim1_advec_mom_kernel_x2 * 1);
      const ACC<double> volume(xdim2_advec_mom_kernel_x2,
                               volume_p + n_x * 1 +
                                   n_y * xdim2_advec_mom_kernel_x2 * 1);
      const ACC<double> vol_flux_y(xdim3_advec_mom_kernel_x2,
                                   vol_flux_y_p + n_x * 1 +
