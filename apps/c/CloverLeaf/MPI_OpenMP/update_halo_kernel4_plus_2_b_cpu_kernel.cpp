...
void ops_par_loop_update_halo_kernel4_plus_2_b_execute(ops_kernel_descriptor *desc) {
  ...
  if (OPS_instance::getOPSInstance()->OPS_diags > 1) {
    ...
    OPS_instance::getOPSInstance()->OPS_kernels[48].mpi_time += __t1-__t2;
  }
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ACC<double> vol_flux_y(xdim0_update_halo_kernel4_plus_2_b, vol_flux_y_p + n_x*1 + n_y * xdim0_update_halo_kernel4_plus_2_b*1);
      ACC<double> mass_flux_y(xdim1_update_halo_kernel4_plus_2_b, mass_flux_y_p + n_x*1 + n_y * xdim1_update_halo_kernel4_plus_2_b*1);
  ...
  if (OPS_instance::getOPSInstance()->OPS_diags > 1) {
    ops_timers_core(&__c2,&__t2);
    OPS_instance::getOPSInstance()->OPS_kernels[48].time += __t2-__t1;
  }
  #ifndef OPS_LAZY
