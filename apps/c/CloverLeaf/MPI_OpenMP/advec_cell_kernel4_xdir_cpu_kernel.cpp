...
#pragma omp simd aligned(density1_p, energy1_p, mass_flux_x_p, vol_flux_x_p,   \
...
#pragma simd
    ...
    for (int n_x = start[0]; n_x < end[0]; n_x++) {
      ACC<double> density1(xdim0_advec_cell_kernel4_xdir,
                           density1_p + n_x * 1 +
                               n_y * xdim0_advec_cell_kernel4_xdir * 1);
      ACC<double> energy1(xdim1_advec_cell_kernel4_xdir,
                          energy1_p + n_x * 1 +
      ...
      const ACC<double> vol_flux_x(xdim3_advec_cell_kernel4_xdir,
                                   vol_flux_x_p + n_x * 1 +
                                       n_y * xdim3_advec_cell_kernel4_xdir * 1);
      const ACC<double> pre_vol(xdim4_advec_cell_kernel4_xdir,
                                pre_vol_p + n_x * 1 +
                                    n_y * xdim4_advec_cell_kernel4_xdir * 1);
      const ACC<double> post_vol(xdim5_advec_cell_kernel4_xdir,
                                 post_vol_p + n_x * 1 +
                                     n_y * xdim5_advec_cell_kernel4_xdir * 1);
      ACC<double> pre_mass(xdim6_advec_cell_kernel4_xdir,
                           pre_mass_p + n_x * 1 +
                               n_y * xdim6_advec_cell_kernel4_xdir * 1);
      ACC<double> post_mass(xdim7_advec_cell_kernel4_xdir,
                            post_mass_p + n_x * 1 +
                                n_y * xdim7_advec_cell_kernel4_xdir * 1);
      ACC<double> advec_vol(xdim8_advec_cell_kernel4_xdir,
                            advec_vol_p + n_x * 1 +
                                n_y * xdim8_advec_cell_kernel4_xdir * 1);
      ACC<double> post_ener(xdim9_advec_cell_kernel4_xdir,
                            post_ener_p + n_x * 1 +
                                n_y * xdim9_advec_cell_kernel4_xdir * 1);
      const ACC<double> ener_flux(xdim10_advec_cell_kernel4_xdir,
                                  ener_flux_p + n_x * 1 +
                                      n_y * xdim10_advec_cell_kernel4_xdir * 1);
