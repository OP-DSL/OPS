...
void ops_par_loop_advec_cell_kernel4_xdir_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    #pragma omp simd aligned(density1_p,energy1_p,mass_flux_x_p,vol_flux_x_p,pre_vol_p,post_vol_p,pre_mass_p,post_mass_p,advec_vol_p,post_ener_p,ener_flux_p)
