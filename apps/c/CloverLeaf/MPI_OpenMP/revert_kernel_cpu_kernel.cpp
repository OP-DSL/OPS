...
#pragma simd
    ...
    for (int n_x = start[0]; n_x < end[0]; n_x++) {
      const ACC<double> density0(xdim0_revert_kernel,
                                 density0_p + n_x * 1 +
                                     n_y * xdim0_revert_kernel * 1);
      ACC<double> density1(xdim1_revert_kernel,
                           density1_p + n_x * 1 +
                               n_y * xdim1_revert_kernel * 1);
      const ACC<double> energy0(xdim2_revert_kernel,
                                energy0_p + n_x * 1 +
                                    n_y * xdim2_revert_kernel * 1);
      ACC<double> energy1(xdim3_revert_kernel,
