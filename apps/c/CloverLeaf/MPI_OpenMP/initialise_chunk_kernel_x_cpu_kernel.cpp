...
#pragma omp simd aligned(vertexx_p, xx_p, vertexdx_p)
...
#pragma simd
    ...
    for (int n_x = start[0]; n_x < end[0]; n_x++) {
      ACC<double> vertexx(xdim0_initialise_chunk_kernel_x,
                          vertexx_p + n_x * 1 +
                              n_y * xdim0_initialise_chunk_kernel_x * 0);
      const ACC<int> xx(xdim1_initialise_chunk_kernel_x,
                        xx_p + n_x * 1 +
                            n_y * xdim1_initialise_chunk_kernel_x * 0);
      ACC<double> vertexdx(xdim2_initialise_chunk_kernel_x,
                           vertexdx_p + n_x * 1 +
                               n_y * xdim2_initialise_chunk_kernel_x * 0);
