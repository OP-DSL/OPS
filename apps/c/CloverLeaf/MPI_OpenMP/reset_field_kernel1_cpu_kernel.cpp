...
#pragma simd
    ...
    for (int n_x = start[0]; n_x < end[0]; n_x++) {
      ACC<double> density0(xdim0_reset_field_kernel1,
                           density0_p + n_x * 1 +
                               n_y * xdim0_reset_field_kernel1 * 1);
      const ACC<double> density1(xdim1_reset_field_kernel1,
                                 density1_p + n_x * 1 +
                                     n_y * xdim1_reset_field_kernel1 * 1);
      ACC<double> energy0(xdim2_reset_field_kernel1,
                          energy0_p + n_x * 1 +
                              n_y * xdim2_reset_field_kernel1 * 1);
      const ACC<double> energy1(xdim3_reset_field_kernel1,
                                energy1_p + n_x * 1 +
