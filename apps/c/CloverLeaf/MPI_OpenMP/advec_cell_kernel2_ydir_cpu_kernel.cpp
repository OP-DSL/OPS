...
#pragma simd
    ...
    for (int n_x = start[0]; n_x < end[0]; n_x++) {
      ACC<double> pre_vol(xdim0_advec_cell_kernel2_ydir,
                          pre_vol_p + n_x * 1 +
                              n_y * xdim0_advec_cell_kernel2_ydir * 1);
      ACC<double> post_vol(xdim1_advec_cell_kernel2_ydir,
                           post_vol_p + n_x * 1 +
                               n_y * xdim1_advec_cell_kernel2_ydir * 1);
      const ACC<double> volume(xdim2_advec_cell_kernel2_ydir,
                               volume_p + n_x * 1 +
                                   n_y * xdim2_advec_cell_kernel2_ydir * 1);
      const ACC<double> vol_flux_y(xdim3_advec_cell_kernel2_ydir,
                                   vol_flux_y_p + n_x * 1 +
                                       n_y * xdim3_advec_cell_kernel2_ydir * 1);
