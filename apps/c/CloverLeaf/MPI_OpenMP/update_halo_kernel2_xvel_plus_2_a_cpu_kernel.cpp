...
#pragma simd
    ...
    for (int n_x = start[0]; n_x < end[0]; n_x++) {
      ACC<double> xvel0(xdim0_update_halo_kernel2_xvel_plus_2_a,
                        xvel0_p + n_x * 1 +
                            n_y * xdim0_update_halo_kernel2_xvel_plus_2_a * 1);
      ACC<double> xvel1(xdim1_update_halo_kernel2_xvel_plus_2_a,
                        xvel1_p + n_x * 1 +
                            n_y * xdim1_update_halo_kernel2_xvel_plus_2_a * 1);
