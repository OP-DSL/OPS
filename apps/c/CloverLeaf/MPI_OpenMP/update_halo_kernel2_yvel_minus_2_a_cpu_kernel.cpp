...
#pragma simd
    ...
    for (int n_x = start[0]; n_x < end[0]; n_x++) {
      ACC<double> yvel0(xdim0_update_halo_kernel2_yvel_minus_2_a,
                        yvel0_p + n_x * 1 +
                            n_y * xdim0_update_halo_kernel2_yvel_minus_2_a * 1);
      ACC<double> yvel1(xdim1_update_halo_kernel2_yvel_minus_2_a,
                        yvel1_p + n_x * 1 +
                            n_y * xdim1_update_halo_kernel2_yvel_minus_2_a * 1);
