...
#pragma simd
    ...
    for (int n_x = start[0]; n_x < end[0]; n_x++) {
      ACC<double> xvel0(xdim0_reset_field_kernel2,
                        xvel0_p + n_x * 1 +
                            n_y * xdim0_reset_field_kernel2 * 1);
      const ACC<double> xvel1(xdim1_reset_field_kernel2,
                              xvel1_p + n_x * 1 +
                                  n_y * xdim1_reset_field_kernel2 * 1);
      ACC<double> yvel0(xdim2_reset_field_kernel2,
                        yvel0_p + n_x * 1 +
                            n_y * xdim2_reset_field_kernel2 * 1);
      const ACC<double> yvel1(xdim3_reset_field_kernel2,
                              yvel1_p + n_x * 1 +
                                  n_y * xdim3_reset_field_kernel2 * 1);
