...
//
#define OPS_ACC0(x,y) (n_x*1 + x + (n_y*1+(y))*xdim0_advec_mom_kernel_y2)
#define OPS_ACC1(x,y) (n_x*1 + x + (n_y*1+(y))*xdim1_advec_mom_kernel_y2)
#define OPS_ACC2(x,y) (n_x*1 + x + (n_y*1+(y))*xdim2_advec_mom_kernel_y2)
#define OPS_ACC3(x,y) (n_x*1 + x + (n_y*1+(y))*xdim3_advec_mom_kernel_y2)
