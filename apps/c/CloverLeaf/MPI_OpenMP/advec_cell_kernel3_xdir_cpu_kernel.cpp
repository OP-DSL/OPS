...
#pragma omp simd aligned(vol_flux_x_p, pre_vol_p, xx_p, vertexdx_p,            \
                         density1_p, energy1_p, mass_flux_x_p, ener_flux_p)
...
#pragma simd
    ...
    for (int n_x = start[0]; n_x < end[0]; n_x++) {
      const ACC<double> vol_flux_x(xdim0_advec_cell_kernel3_xdir,
                                   vol_flux_x_p + n_x * 1 +
                                       n_y * xdim0_advec_cell_kernel3_xdir * 1);
      const ACC<double> pre_vol(xdim1_advec_cell_kernel3_xdir,
                                pre_vol_p + n_x * 1 +
                                    n_y * xdim1_advec_cell_kernel3_xdir * 1);
      const ACC<int> xx(xdim2_advec_cell_kernel3_xdir,
                        xx_p + n_x * 1 +
                            n_y * xdim2_advec_cell_kernel3_xdir * 0);
      const ACC<double> vertexdx(xdim3_advec_cell_kernel3_xdir,
                                 vertexdx_p + n_x * 1 +
                                     n_y * xdim3_advec_cell_kernel3_xdir * 0);
      const ACC<double> density1(xdim4_advec_cell_kernel3_xdir,
                                 density1_p + n_x * 1 +
                                     n_y * xdim4_advec_cell_kernel3_xdir * 1);
      const ACC<double> energy1(xdim5_advec_cell_kernel3_xdir,
                                energy1_p + n_x * 1 +
                                    n_y * xdim5_advec_cell_kernel3_xdir * 1);
      ACC<double> mass_flux_x(xdim6_advec_cell_kernel3_xdir,
                              mass_flux_x_p + n_x * 1 +
                                  n_y * xdim6_advec_cell_kernel3_xdir * 1);
      ACC<double> ener_flux(xdim7_advec_cell_kernel3_xdir,
                            ener_flux_p + n_x * 1 +
      ...
      sigmam =
          fabs(mass_flux_x(0, 0)) / (density1(donor, 0) * pre_vol(donor, 0));
