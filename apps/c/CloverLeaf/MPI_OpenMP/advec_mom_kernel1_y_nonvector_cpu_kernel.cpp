...
#pragma omp simd aligned(node_flux_p, node_mass_pre_p, mom_flux_p, celldy_p,   \
                         vel1_p)
...
#pragma simd
    ...
    for (int n_x = start[0]; n_x < end[0]; n_x++) {
      ...
      const ACC<double> vel1(xdim4_advec_mom_kernel1_y_nonvector,
                             vel1_p + n_x * 1 +
                                 n_y * xdim4_advec_mom_kernel1_y_nonvector * 1);
