...
#pragma simd
    ...
    for (int n_x = start[0]; n_x < end[0]; n_x++) {
      ACC<double> density0(xdim0_update_halo_kernel1_b1,
                           density0_p + n_x * 1 +
                               n_y * xdim0_update_halo_kernel1_b1 * 1);
      ACC<double> density1(xdim1_update_halo_kernel1_b1,
                           density1_p + n_x * 1 +
                               n_y * xdim1_update_halo_kernel1_b1 * 1);
      ACC<double> energy0(xdim2_update_halo_kernel1_b1,
                          energy0_p + n_x * 1 +
                              n_y * xdim2_update_halo_kernel1_b1 * 1);
      ACC<double> energy1(xdim3_update_halo_kernel1_b1,
                          energy1_p + n_x * 1 +
                              n_y * xdim3_update_halo_kernel1_b1 * 1);
      ACC<double> pressure(xdim4_update_halo_kernel1_b1,
                           pressure_p + n_x * 1 +
                               n_y * xdim4_update_halo_kernel1_b1 * 1);
      ACC<double> viscosity(xdim5_update_halo_kernel1_b1,
                            viscosity_p + n_x * 1 +
                                n_y * xdim5_update_halo_kernel1_b1 * 1);
      ACC<double> soundspeed(xdim6_update_halo_kernel1_b1,
                             soundspeed_p + n_x * 1 +
