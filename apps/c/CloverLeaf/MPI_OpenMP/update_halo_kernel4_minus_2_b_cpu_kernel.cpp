...
void ops_par_loop_update_halo_kernel4_minus_2_b_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ACC<double> vol_flux_y(xdim0_update_halo_kernel4_minus_2_b, vol_flux_y_p + n_x*1 + n_y * xdim0_update_halo_kernel4_minus_2_b*1);
      ACC<double> mass_flux_y(xdim1_update_halo_kernel4_minus_2_b, mass_flux_y_p + n_x*1 + n_y * xdim1_update_halo_kernel4_minus_2_b*1);
