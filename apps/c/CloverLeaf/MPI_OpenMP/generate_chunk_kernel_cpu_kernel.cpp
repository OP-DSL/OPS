...
#pragma omp simd aligned(vertexx_p, vertexy_p, energy0_p, density0_p, xvel0_p, \
                         yvel0_p, cellx_p, celly_p)
...
#pragma simd
    ...
    for (int n_x = start[0]; n_x < end[0]; n_x++) {
      ...
      ACC<double> xvel0(xdim4_generate_chunk_kernel,
                        xvel0_p + n_x * 1 +
                            n_y * xdim4_generate_chunk_kernel * 1);
      ACC<double> yvel0(xdim5_generate_chunk_kernel,
                        yvel0_p + n_x * 1 +
                            n_y * xdim5_generate_chunk_kernel * 1);
      const ACC<double> cellx(xdim6_generate_chunk_kernel,
                              cellx_p + n_x * 1 +
                                  n_y * xdim6_generate_chunk_kernel * 0);
      const ACC<double> celly(xdim7_generate_chunk_kernel,
                              celly_p + n_x * 0 +
