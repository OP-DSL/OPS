 ...
 ops_arg arg9, ops_arg arg10) {
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[49], 6, sizeof(cl_mem),
                              (void *)&arg6.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[49], 7,
                              nthread * sizeof(double), NULL));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[49], 8, sizeof(cl_int),
                              (void *)&r_bytes6));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[49], 9, sizeof(cl_mem),
                              (void *)&arg7.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[49], 10,
                              nthread * sizeof(double), NULL));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[49], 11, sizeof(cl_int),
                              (void *)&r_bytes7));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[49], 12, sizeof(cl_mem),
                              (void *)&arg8.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[49], 13,
                              nthread * sizeof(double), NULL));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[49], 14, sizeof(cl_int),
                              (void *)&r_bytes8));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[49], 15, sizeof(cl_mem),
                              (void *)&arg9.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[49], 16,
                              nthread * sizeof(double), NULL));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[49], 17, sizeof(cl_int),
                              (void *)&r_bytes9));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[49], 18, sizeof(cl_mem),
                              (void *)&arg10.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[49], 19,
                              nthread * sizeof(double), NULL));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[49], 20, sizeof(cl_int),
                              (void *)&r_bytes10));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[49], 21, sizeof(cl_int),
                              (void *)&base0));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[49], 22, sizeof(cl_int),
                              (void *)&base1));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[49], 23, sizeof(cl_int),
                              (void *)&base2));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[49], 24, sizeof(cl_int),
                              (void *)&base3));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[49], 25, sizeof(cl_int),
                              (void *)&base4));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[49], 26, sizeof(cl_int),
                              (void *)&base5));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[49], 27, sizeof(cl_int),
                              (void *)&x_size));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[49], 28, sizeof(cl_int),
                              (void *)&y_size));
