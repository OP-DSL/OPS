...
void ops_par_loop_initialise_chunk_kernel_y(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  //Timing
  double t1,t2,c1,c2;
  ops_timing_realloc(73,"initialise_chunk_kernel_y");
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[73], 3, sizeof(cl_mem), (void*) &OPS_opencl_core.constant[6]) );
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[73], 4, sizeof(cl_mem), (void*) &OPS_opencl_core.constant[7]) );
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[73], 5, sizeof(cl_int), (void*) &base0 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[73], 6, sizeof(cl_int), (void*) &base1 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[73], 7, sizeof(cl_int), (void*) &base2 ));
