...
void buildOpenCLKernels_advec_mom_kernel1_x_nonvector(int xdim0, int xdim1, int xdim2, int xdim3, int xdim4) {
  ...
  if(!isbuilt_advec_mom_kernel1_x_nonvector) {
    ...
    OPS_opencl_core.kernel[75] = clCreateKernel(OPS_opencl_core.program, "ops_advec_mom_kernel1_x_nonvector", &ret);
    clSafeCall( ret );
...
void ops_par_loop_advec_mom_kernel1_x_nonvector(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[75], 8, sizeof(cl_int), (void*) &base3 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[75], 9, sizeof(cl_int), (void*) &base4 ));
