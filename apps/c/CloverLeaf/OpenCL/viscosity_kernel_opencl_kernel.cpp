...
void buildOpenCLKernels_viscosity_kernel(OPS_instance *instance, int xdim0,
  ...
  if (!isbuilt_viscosity_kernel) {
    ...
    instance->ostream() << "Compiling viscosity_kernel " << OCL_FMA
                        << " source -- start \n";
    ...
    instance->opencl_instance->OPS_opencl_core.kernel[50] =
        clCreateKernel(instance->opencl_instance->OPS_opencl_core.program,
                       "ops_viscosity_kernel", &ret);
    clSafeCall(ret);
