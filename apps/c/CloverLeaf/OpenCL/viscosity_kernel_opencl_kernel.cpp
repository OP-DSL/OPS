...
void buildOpenCLKernels_viscosity_kernel(int xdim0, int xdim1, int xdim2,
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts,
                ...
                "-Dxdim0_viscosity_kernel=%d  -Dxdim1_viscosity_kernel=%d  "
                "-Dxdim2_viscosity_kernel=%d  -Dxdim3_viscosity_kernel=%d  "
                "-Dxdim4_viscosity_kernel=%d  -Dxdim5_viscosity_kernel=%d  "
                "-Dxdim6_viscosity_kernel=%d ",
...
void ops_par_loop_viscosity_kernel(char const *name, ops_block block, int dim,
  ...
  buildOpenCLKernels_viscosity_kernel(xdim0, xdim1, xdim2, xdim3, xdim4, xdim5,
                                      xdim6);
  ...
  if (globalWorkSize[0] > 0 && globalWorkSize[1] > 0 && globalWorkSize[2] > 0) {
    ...
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[34], 4, sizeof(cl_mem),
                              (void *)&arg4.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[34], 5, sizeof(cl_mem),
                              (void *)&arg5.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[34], 6, sizeof(cl_mem),
                              (void *)&arg6.data_d));
    ...
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[34], 12, sizeof(cl_int),
                              (void *)&base5));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[34], 13, sizeof(cl_int),
                              (void *)&base6));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[34], 14, sizeof(cl_int),
                              (void *)&x_size));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[34], 15, sizeof(cl_int),
                              (void *)&y_size));
