...
void buildOpenCLKernels_accelerate_kernel(int xdim0, int xdim1, int xdim2,
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts,
                ...
                "-Dxdim0_accelerate_kernel=%d  -Dxdim1_accelerate_kernel=%d  "
                "-Dxdim2_accelerate_kernel=%d  -Dxdim3_accelerate_kernel=%d  "
                "-Dxdim4_accelerate_kernel=%d  -Dxdim5_accelerate_kernel=%d  "
                "-Dxdim6_accelerate_kernel=%d  -Dxdim7_accelerate_kernel=%d  "
                "-Dxdim8_accelerate_kernel=%d  -Dxdim9_accelerate_kernel=%d  "
                "-Dxdim10_accelerate_kernel=%d ",
...
void ops_par_loop_accelerate_kernel(char const *name, ops_block block, int dim,
  ...
  buildOpenCLKernels_accelerate_kernel(xdim0, xdim1, xdim2, xdim3, xdim4, xdim5,
