...
void buildOpenCLKernels_update_halo_kernel3_plus_2_a(OPS_instance *instance,
                                                     int xdim0, int xdim1) {
  ...
  if (!isbuilt_update_halo_kernel3_plus_2_a) {
    ...
    instance->ostream() << "Compiling update_halo_kernel3_plus_2_a " << OCL_FMA
                        << " source -- start \n";
    ...
    instance->opencl_instance->OPS_opencl_core.kernel[34] =
        clCreateKernel(instance->opencl_instance->OPS_opencl_core.program,
                       "ops_update_halo_kernel3_plus_2_a", &ret);
    clSafeCall(ret);
