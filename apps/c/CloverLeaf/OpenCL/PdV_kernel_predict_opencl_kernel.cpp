...
void buildOpenCLKernels_PdV_kernel_predict(OPS_instance *instance, int xdim0,
                                           int xdim1, int xdim2, int xdim3,
                                           int xdim4, int xdim5, int xdim6,
                                           int xdim7, int xdim8, int xdim9,
                                           int xdim10, int xdim11) {
  ...
  if (!isbuilt_PdV_kernel_predict) {
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(
            ...
            "-Dxdim10_PdV_kernel_predict=%d  -Dxdim11_PdV_kernel_predict=%d ",
            pPath, 32, xdim0, xdim1, xdim2, xdim3, xdim4, xdim5, xdim6, xdim7,
            xdim8, xdim9, xdim10, xdim11);
      else
        sprintf(
            buildOpts,
    ...
    instance->opencl_instance->OPS_opencl_core.kernel[55] =
