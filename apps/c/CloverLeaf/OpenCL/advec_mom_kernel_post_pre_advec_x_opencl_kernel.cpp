...
void buildOpenCLKernels_advec_mom_kernel_post_pre_advec_x(int xdim0, int xdim1, int xdim2, int xdim3, int xdim4) {
  ...
  if(!isbuilt_advec_mom_kernel_post_pre_advec_x) {
    ...
    OPS_opencl_core.kernel[74] = clCreateKernel(OPS_opencl_core.program, "ops_advec_mom_kernel_post_pre_advec_x", &ret);
    clSafeCall( ret );
...
void ops_par_loop_advec_mom_kernel_post_pre_advec_x(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[74], 8, sizeof(cl_int), (void*) &base3 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[74], 9, sizeof(cl_int), (void*) &base4 ));
