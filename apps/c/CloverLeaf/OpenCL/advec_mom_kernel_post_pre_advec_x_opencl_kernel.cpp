...
void buildOpenCLKernels_advec_mom_kernel_post_pre_advec_x(int xdim0, int xdim1,
                                                          int xdim2, int xdim3,
                                                          int xdim4) {
...
void ops_par_loop_advec_mom_kernel_post_pre_advec_x(
  ...
  buildOpenCLKernels_advec_mom_kernel_post_pre_advec_x(xdim0, xdim1, xdim2,
                                                       xdim3, xdim4);
  ...
  if (globalWorkSize[0] > 0 && globalWorkSize[1] > 0 && globalWorkSize[2] > 0) {
    ...
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[20], 4, sizeof(cl_mem),
                              (void *)&arg4.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[20], 5, sizeof(cl_int),
                              (void *)&base0));
