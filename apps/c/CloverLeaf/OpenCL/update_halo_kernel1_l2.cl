...
inline void update_halo_kernel1_l2(ptr_double density0, ptr_double density1,
  ...
  if (fields[FIELD_DENSITY0] == 1)
    OPS_ACCS(density0, 0, 0) = OPS_ACCS(density0, 3, 0);
  if (fields[FIELD_DENSITY1] == 1)
    OPS_ACCS(density1, 0, 0) = OPS_ACCS(density1, 3, 0);
  if (fields[FIELD_ENERGY0] == 1)
    OPS_ACCS(energy0, 0, 0) = OPS_ACCS(energy0, 3, 0);
  if (fields[FIELD_ENERGY1] == 1)
    OPS_ACCS(energy1, 0, 0) = OPS_ACCS(energy1, 3, 0);
  if (fields[FIELD_PRESSURE] == 1)
    OPS_ACCS(pressure, 0, 0) = OPS_ACCS(pressure, 3, 0);
  if (fields[FIELD_VISCOSITY] == 1)
    OPS_ACCS(viscosity, 0, 0) = OPS_ACCS(viscosity, 3, 0);
  if (fields[FIELD_SOUNDSPEED] == 1)
    OPS_ACCS(soundspeed, 0, 0) = OPS_ACCS(soundspeed, 3, 0);
}
