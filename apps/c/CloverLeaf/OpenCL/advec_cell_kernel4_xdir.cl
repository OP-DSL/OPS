...
inline void advec_cell_kernel4_xdir(
  ...
  OPS_ACCS(post_mass, 0, 0) = OPS_ACCS(pre_mass, 0, 0) +
                              OPS_ACCS(mass_flux_x, 0, 0) -
                              OPS_ACCS(mass_flux_x, 1, 0);
  OPS_ACCS(post_ener, 0, 0) =
      (OPS_ACCS(energy1, 0, 0) * OPS_ACCS(pre_mass, 0, 0) +
       OPS_ACCS(ener_flux, 0, 0) - OPS_ACCS(ener_flux, 1, 0)) /
      OPS_ACCS(post_mass, 0, 0);
  OPS_ACCS(advec_vol, 0, 0) = OPS_ACCS(pre_vol, 0, 0) +
                              OPS_ACCS(vol_flux_x, 0, 0) -
                              OPS_ACCS(vol_flux_x, 1, 0);
  OPS_ACCS(density1, 0, 0) =
      OPS_ACCS(post_mass, 0, 0) / OPS_ACCS(advec_vol, 0, 0);
...
__kernel void ops_advec_cell_kernel4_xdir(
    ...
    const int base10, const int size0, const int size1) {
