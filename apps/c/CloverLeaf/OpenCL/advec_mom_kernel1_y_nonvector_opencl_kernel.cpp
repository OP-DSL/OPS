...
void buildOpenCLKernels_advec_mom_kernel1_y_nonvector(int xdim0, int xdim1,
                                                      int xdim2, int xdim3,
                                                      int xdim4) {
...
void ops_par_loop_advec_mom_kernel1_y_nonvector(char const *name,
...
#ifdef CHECKPOINTING
  if (!ops_checkpointing_before(args, 5, range, 25))
    return;
#endif
  ...
  buildOpenCLKernels_advec_mom_kernel1_y_nonvector(xdim0, xdim1, xdim2, xdim3,
                                                   xdim4);
  ...
  if (globalWorkSize[0] > 0 && globalWorkSize[1] > 0 && globalWorkSize[2] > 0) {
    ...
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[25], 1, sizeof(cl_mem),
                              (void *)&arg1.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[25], 2, sizeof(cl_mem),
                              (void *)&arg2.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[25], 3, sizeof(cl_mem),
                              (void *)&arg3.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[25], 4, sizeof(cl_mem),
                              (void *)&arg4.data_d));
    ...
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[25], 6, sizeof(cl_int),
                              (void *)&base1));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[25], 7, sizeof(cl_int),
                              (void *)&base2));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[25], 8, sizeof(cl_int),
                              (void *)&base3));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[25], 9, sizeof(cl_int),
                              (void *)&base4));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[25], 10, sizeof(cl_int),
                              (void *)&x_size));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[25], 11, sizeof(cl_int),
                              (void *)&y_size));
