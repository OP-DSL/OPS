...
static bool isbuilt_initialise_chunk_kernel_x = false;

void buildOpenCLKernels_initialise_chunk_kernel_x(int xdim0,
 int xdim1,
 int xdim2) {

  if(!isbuilt_initialise_chunk_kernel_x) {
    buildOpenCLKernels();
    //clSafeCall( clUnloadCompiler() );
    cl_int ret;
    char* source_filename[1] = {"./OpenCL/initialise_chunk_kernel_x.cl"};
    ...
    printf("Compiling initialise_chunk_kernel_x source -- start \n");
      ...
      if (pPath!=NULL)
        sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_initialise_chunk_kernel_x=%d -Dxdim1_initialise_chunk_kernel_x=%d -Dxdim2_initialise_chunk_kernel_x=%d", pPath, 32,xdim0,xdim1,xdim2);
      else {
...
void ops_par_loop_initialise_chunk_kernel_x(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  buildOpenCLKernels_initialise_chunk_kernel_x(
  xdim0,
  xdim1,
  xdim2);
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[72], 5, sizeof(cl_int), (void*) &base0 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[72], 6, sizeof(cl_int), (void*) &base1 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[72], 7, sizeof(cl_int), (void*) &base2 ));
