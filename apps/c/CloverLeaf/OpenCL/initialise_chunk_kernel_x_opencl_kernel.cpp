...
void buildOpenCLKernels_initialise_chunk_kernel_x(int xdim0, int xdim1,
                                                  int xdim2) {
  ...
  if (!isbuilt_initialise_chunk_kernel_x) {
    ...
    if (pPath != NULL)
      sprintf(buildOpts, "-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  "
                         "-Dxdim0_initialise_chunk_kernel_x=%d "
                         "-Dxdim1_initialise_chunk_kernel_x=%d "
                         "-Dxdim2_initialise_chunk_kernel_x=%d",
    ...
    OPS_opencl_core.kernel[72] = clCreateKernel(
        OPS_opencl_core.program, "ops_initialise_chunk_kernel_x", &ret);
    clSafeCall(ret);
