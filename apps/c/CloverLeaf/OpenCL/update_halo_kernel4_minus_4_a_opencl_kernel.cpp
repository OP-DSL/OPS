...
void buildOpenCLKernels_update_halo_kernel4_minus_4_a(int xdim0, int xdim1) {
  ...
  if(!isbuilt_update_halo_kernel4_minus_4_a) {
    ...
    OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[41] = clCreateKernel(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.program, "ops_update_halo_kernel4_minus_4_a", &ret);
    clSafeCall( ret );
