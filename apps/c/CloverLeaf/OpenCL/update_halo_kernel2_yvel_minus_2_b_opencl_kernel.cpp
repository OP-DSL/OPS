...
void buildOpenCLKernels_update_halo_kernel2_yvel_minus_2_b(int xdim0, int xdim1) {
  ...
  if(!isbuilt_update_halo_kernel2_yvel_minus_2_b) {
    ...
    printf("Compiling update_halo_kernel2_yvel_minus_2_b %d source -- start \n",OCL_FMA);
      ...
      if (pPath!=NULL)
        if(OCL_FMA)
          sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/c/include -DOPS_WARPSIZE=%d  -Dxdim0_update_halo_kernel2_yvel_minus_2_b=%d  -Dxdim1_update_halo_kernel2_yvel_minus_2_b=%d ", pPath, 32,xdim0,xdim1);
        else
    ...
    OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[28] = clCreateKernel(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.program, "ops_update_halo_kernel2_yvel_minus_2_b", &ret);
    clSafeCall( ret );
...
void ops_par_loop_update_halo_kernel2_yvel_minus_2_b(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  if (OPS_instance::getOPSInstance()->OPS_diags > 1) {
    ops_timing_realloc(28,"update_halo_kernel2_yvel_minus_2_b");
