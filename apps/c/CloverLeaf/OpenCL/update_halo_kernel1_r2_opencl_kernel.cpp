...
void buildOpenCLKernels_update_halo_kernel1_r2(OPS_instance *instance,
  ...
  if (!isbuilt_update_halo_kernel1_r2) {
    ...
    instance->ostream() << "Compiling update_halo_kernel1_r2 " << OCL_FMA
                        << " source -- start \n";
    ...
    instance->opencl_instance->OPS_opencl_core.kernel[15] =
        clCreateKernel(instance->opencl_instance->OPS_opencl_core.program,
                       "ops_update_halo_kernel1_r2", &ret);
    clSafeCall(ret);
