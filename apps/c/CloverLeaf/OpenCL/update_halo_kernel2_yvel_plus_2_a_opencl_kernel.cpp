...
void buildOpenCLKernels_update_halo_kernel2_yvel_plus_2_a(
  ...
  if (!isbuilt_update_halo_kernel2_yvel_plus_2_a) {
    ...
    instance->ostream() << "Compiling update_halo_kernel2_yvel_plus_2_a "
    ...
    instance->ostream()
        << "compiling update_halo_kernel2_yvel_plus_2_a -- done\n";
