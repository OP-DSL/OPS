...
//user function
inline void update_halo_kernel1_t2(ACC<__global double> &density0,ACC<__global double> &density1,ACC<__global double> &energy0,
...
const int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    update_halo_kernel1_t2(&arg0[base0 + idx_x * 1*1 + idx_y * 1*1 * xdim0_update_halo_kernel1_t2],
                       ...
                       &arg6[base6 + idx_x * 1*1 + idx_y * 1*1 * xdim6_update_halo_kernel1_t2],
                       arg7);
  }
