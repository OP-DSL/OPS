...
inline void update_halo_kernel1_t2(ptr_double density0,  ptr_double density1, 
  ...
  if(fields[FIELD_DENSITY0] == 1) OPS_ACCS(density0, 0,0) = OPS_ACCS(density0, 0,-3);
  if(fields[FIELD_DENSITY1] == 1) OPS_ACCS(density1, 0,0) = OPS_ACCS(density1, 0,-3);
  ...
  if(fields[FIELD_PRESSURE] == 1) OPS_ACCS(pressure, 0,0) = OPS_ACCS(pressure, 0,-3);
  if(fields[FIELD_VISCOSITY] == 1) OPS_ACCS(viscosity, 0,0) = OPS_ACCS(viscosity, 0,-3);
  if(fields[FIELD_SOUNDSPEED] == 1) OPS_ACCS(soundspeed, 0,0) = OPS_ACCS(soundspeed, 0,-3);
...
const int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    ptr_double ptr6 = { &arg6[base6 + idx_x * 1*1 + idx_y * 1*1 * xdim6_update_halo_kernel1_t2], xdim6_update_halo_kernel1_t2};
