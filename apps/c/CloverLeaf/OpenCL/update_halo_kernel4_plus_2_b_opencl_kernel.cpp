...
void buildOpenCLKernels_update_halo_kernel4_plus_2_b(int xdim0, int xdim1) {
  ...
  if(!isbuilt_update_halo_kernel4_plus_2_b) {
    ...
    OPS_opencl_core.kernel[81] = clCreateKernel(OPS_opencl_core.program, "ops_update_halo_kernel4_plus_2_b", &ret);
    clSafeCall( ret );
...
void ops_par_loop_update_halo_kernel4_plus_2_b(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  if (OPS_diags > 1) {
    ops_timing_realloc(81,"update_halo_kernel4_plus_2_b");
