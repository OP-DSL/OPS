...
void buildOpenCLKernels_update_halo_kernel2_xvel_plus_2_b(
  ...
  if (!isbuilt_update_halo_kernel2_xvel_plus_2_b) {
    ...
    instance->ostream() << "Compiling update_halo_kernel2_xvel_plus_2_b "
    ...
    instance->ostream()
        << "compiling update_halo_kernel2_xvel_plus_2_b -- done\n";

    // Create the OpenCL kernel
    instance->opencl_instance->OPS_opencl_core.kernel[20] =
