...
void buildOpenCLKernels_update_halo_kernel2_xvel_plus_2_a(int xdim0, int xdim1) {
  ...
  if(!isbuilt_update_halo_kernel2_xvel_plus_2_a) {
    ...
    OPS_opencl_core.kernel[18] = clCreateKernel(OPS_opencl_core.program, "ops_update_halo_kernel2_xvel_plus_2_a", &ret);
    clSafeCall( ret );
...
void ops_par_loop_update_halo_kernel2_xvel_plus_2_a(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[18], 3, sizeof(cl_int), (void*) &base0 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[18], 4, sizeof(cl_int), (void*) &base1 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[18], 5, sizeof(cl_int), (void*) &x_size ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[18], 6, sizeof(cl_int), (void*) &y_size ));
