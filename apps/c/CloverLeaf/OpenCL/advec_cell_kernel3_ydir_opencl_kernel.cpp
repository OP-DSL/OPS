...
void buildOpenCLKernels_advec_cell_kernel3_ydir(int xdim0, int xdim1, int xdim2,
      ...
      if (OCL_FMA)
        sprintf(
            buildOpts, "-cl-mad-enable -DOCL_FMA -I%s/c/include "
                       "-DOPS_WARPSIZE=%d  -Dxdim0_advec_cell_kernel3_ydir=%d  "
...
void ops_par_loop_advec_cell_kernel3_ydir(char const *name, ops_block block,
  ...
  buildOpenCLKernels_advec_cell_kernel3_ydir(xdim0, xdim1, xdim2, xdim3, xdim4,
                                             xdim5, xdim6, xdim7);
