  ...
  if(!isbuilt_advec_mom_kernel_mass_flux_y) {
    ...
    // Create the OpenCL kernel
      OPS_opencl_core.kernel[23] = clCreateKernel(
          OPS_opencl_core.program, "ops_advec_mom_kernel_mass_flux_y", &ret);
      clSafeCall(ret);
 ...
 ops_arg arg0, ops_arg arg1) {
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[23], 1, sizeof(cl_mem),
                              (void *)&arg1.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[23], 2, sizeof(cl_int),
                              (void *)&base0));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[23], 3, sizeof(cl_int),
                              (void *)&base1));
