...
void buildOpenCLKernels_PdV_kernel_nopredict(int xdim0, int xdim1, int xdim2,
                                             int xdim3, int xdim4, int xdim5,
                                             int xdim6, int xdim7, int xdim8,
                                             int xdim9, int xdim10, int xdim11,
                                             int xdim12, int xdim13) {
...
void ops_par_loop_PdV_kernel_nopredict(char const *name, ops_block block,
  ...
  buildOpenCLKernels_PdV_kernel_nopredict(xdim0, xdim1, xdim2, xdim3, xdim4,
                                          xdim5, xdim6, xdim7, xdim8, xdim9,
                                          xdim10, xdim11, xdim12, xdim13);
