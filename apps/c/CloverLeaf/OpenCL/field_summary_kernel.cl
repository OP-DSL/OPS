...
void field_summary_kernel(const ptr_double volume, const ptr_double density0,
  ...
  vsqrd = 0.0;
  vsqrd = vsqrd +
          0.25 * (OPS_ACCS(xvel0, 0, 0) * OPS_ACCS(xvel0, 0, 0) +
                  OPS_ACCS(yvel0, 0, 0) * OPS_ACCS(yvel0, 0, 0));
  vsqrd = vsqrd +
          0.25 * (OPS_ACCS(xvel0, 1, 0) * OPS_ACCS(xvel0, 1, 0) +
                  OPS_ACCS(yvel0, 1, 0) * OPS_ACCS(yvel0, 1, 0));
  vsqrd = vsqrd +
          0.25 * (OPS_ACCS(xvel0, 0, 1) * OPS_ACCS(xvel0, 0, 1) +
                  OPS_ACCS(yvel0, 0, 1) * OPS_ACCS(yvel0, 0, 1));
  vsqrd = vsqrd +
          0.25 * (OPS_ACCS(xvel0, 1, 1) * OPS_ACCS(xvel0, 1, 1) +
                  OPS_ACCS(yvel0, 1, 1) * OPS_ACCS(yvel0, 1, 1));
...
__kernel void ops_field_summary_kernel(
    ...
    __global double *restrict arg8, __local double *scratch8, int r_bytes8,
    __global double *restrict arg9, __local double *scratch9, int r_bytes9,
    __global double *restrict arg10, __local double *scratch10, int r_bytes10,
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    field_summary_kernel(ptr0, ptr1, ptr2, ptr3, ptr4, ptr5, arg6_l, arg7_l,
