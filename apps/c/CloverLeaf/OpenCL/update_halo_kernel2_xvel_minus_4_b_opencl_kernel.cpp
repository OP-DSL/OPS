...
void buildOpenCLKernels_update_halo_kernel2_xvel_minus_4_b(
  ...
  if (!isbuilt_update_halo_kernel2_xvel_minus_4_b) {
    ...
    instance->ostream() << "Compiling update_halo_kernel2_xvel_minus_4_b "
    ...
    instance->ostream()
        << "compiling update_halo_kernel2_xvel_minus_4_b -- done\n";
