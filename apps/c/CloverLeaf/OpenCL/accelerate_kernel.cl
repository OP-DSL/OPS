...
void accelerate_kernel(const ptr_double density0, const ptr_double volume,
  ...
  nodal_mass = (OPS_ACCS(density0, -1, -1) * OPS_ACCS(volume, -1, -1) +
                ...
                OPS_ACCS(density0, -1, 0) * OPS_ACCS(volume, -1, 0)) *
               0.25;
  ...
  OPS_ACCS(xvel1, 0, 0) =
      OPS_ACCS(xvel0, 0, 0) -
      OPS_ACCS(stepbymass, 0, 0) *
          (OPS_ACCS(xarea, 0, 0) *
               (OPS_ACCS(pressure, 0, 0) - OPS_ACCS(pressure, -1, 0)) +
           OPS_ACCS(xarea, 0, -1) *
               (OPS_ACCS(pressure, 0, -1) - OPS_ACCS(pressure, -1, -1)));

  OPS_ACCS(yvel1, 0, 0) =
      OPS_ACCS(yvel0, 0, 0) -
      OPS_ACCS(stepbymass, 0, 0) *
          (OPS_ACCS(yarea, 0, 0) *
               (OPS_ACCS(pressure, 0, 0) - OPS_ACCS(pressure, 0, -1)) +
           OPS_ACCS(yarea, -1, 0) *
               (OPS_ACCS(pressure, -1, 0) - OPS_ACCS(pressure, -1, -1)));
  ...
  OPS_ACCS(xvel1, 0, 0) =
      ...
      OPS_ACCS(stepbymass, 0, 0) *
          (OPS_ACCS(xarea, 0, 0) *
           ...
           OPS_ACCS(xarea, 0, -1) *
               (OPS_ACCS(viscosity, 0, -1) - OPS_ACCS(viscosity, -1, -1)));

  OPS_ACCS(yvel1, 0, 0) =
      OPS_ACCS(yvel1, 0, 0) -
      OPS_ACCS(stepbymass, 0, 0) *
          (OPS_ACCS(yarea, 0, 0) *
               (OPS_ACCS(viscosity, 0, 0) - OPS_ACCS(viscosity, 0, -1)) +
           OPS_ACCS(yarea, -1, 0) *
               (OPS_ACCS(viscosity, -1, 0) - OPS_ACCS(viscosity, -1, -1)));
}
