...
void buildOpenCLKernels_update_halo_kernel1_t2(int xdim0, int xdim1, int xdim2, int xdim3, int xdim4, int xdim5, int xdim6) {
  ...
  if(!isbuilt_update_halo_kernel1_t2) {
    ...
    OPS_opencl_core.kernel[45] = clCreateKernel(OPS_opencl_core.program, "ops_update_halo_kernel1_t2", &ret);
    clSafeCall( ret );
...
void ops_par_loop_update_halo_kernel1_t2(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6, ops_arg arg7) {
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[45], 7, sizeof(cl_int), (void*) arg7.data ));
