...
void buildOpenCLKernels_flux_calc_kernelx(int xdim0, int xdim1, int xdim2,
                                          int xdim3) {
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts,
                ...
                "-Dxdim0_flux_calc_kernelx=%d  -Dxdim1_flux_calc_kernelx=%d  "
                "-Dxdim2_flux_calc_kernelx=%d  -Dxdim3_flux_calc_kernelx=%d ",
...
void ops_par_loop_flux_calc_kernelx(char const *name, ops_block block, int dim,
  ...
  buildOpenCLKernels_flux_calc_kernelx(xdim0, xdim1, xdim2, xdim3);
