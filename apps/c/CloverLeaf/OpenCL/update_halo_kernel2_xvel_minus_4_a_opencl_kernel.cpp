...
void buildOpenCLKernels_update_halo_kernel2_xvel_minus_4_a(
  ...
  if (!isbuilt_update_halo_kernel2_xvel_minus_4_a) {
    ...
    instance->ostream() << "Compiling update_halo_kernel2_xvel_minus_4_a "
    ...
    instance->ostream()
        << "compiling update_halo_kernel2_xvel_minus_4_a -- done\n";
