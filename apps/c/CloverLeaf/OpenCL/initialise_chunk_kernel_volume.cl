...
// user function
void initialise_chunk_kernel_volume(__global double *restrict volume,
...
__kernel void ops_initialise_chunk_kernel_volume(
  ...
  if (idx_x < size0 && idx_y < size1) {
    initialise_chunk_kernel_volume(
        &arg0[base0 + idx_x * 1 +
              idx_y * 1 * xdim0_initialise_chunk_kernel_volume],
        &arg1[base1 + idx_x * 0 +
              idx_y * 1 * xdim1_initialise_chunk_kernel_volume],
        &arg2[base2 + idx_x * 1 +
              idx_y * 1 * xdim2_initialise_chunk_kernel_volume],
        &arg3[base3 + idx_x * 1 +
              idx_y * 0 * xdim3_initialise_chunk_kernel_volume],
        &arg4[base4 + idx_x * 1 +
              idx_y * 1 * xdim4_initialise_chunk_kernel_volume],
        *grid);
  }
}