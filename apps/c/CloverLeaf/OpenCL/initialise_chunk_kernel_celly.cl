...
// user function
void initialise_chunk_kernel_celly(const __global double *restrict vertexy,
...
__kernel void ops_initialise_chunk_kernel_celly(
  ...
  if (idx_x < size0 && idx_y < size1) {
    initialise_chunk_kernel_celly(
        &arg0[base0 + idx_x * 0 +
              idx_y * 1 * xdim0_initialise_chunk_kernel_celly],
        &arg1[base1 + idx_x * 0 +
              idx_y * 1 * xdim1_initialise_chunk_kernel_celly],
        &arg2[base2 + idx_x * 0 +
              idx_y * 1 * xdim2_initialise_chunk_kernel_celly],
        *field, *grid);
  }
}