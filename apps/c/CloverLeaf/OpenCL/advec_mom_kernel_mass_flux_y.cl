...
const int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    advec_mom_kernel_mass_flux_y(&arg0[base0 + idx_x * 1*1 + idx_y * 1*1 * xdim0_advec_mom_kernel_mass_flux_y],
                     &arg1[base1 + idx_x * 1*1 + idx_y * 1*1 * xdim1_advec_mom_kernel_mass_flux_y]);
  }
