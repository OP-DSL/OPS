 ...
 ops_arg arg9, ops_arg arg10) {
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[64], 7, sizeof(cl_mem),
                              (void *)&arg7.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[64], 8, sizeof(cl_mem),
                              (void *)&arg8.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[64], 9, sizeof(cl_mem),
                              (void *)&arg9.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[64], 10, sizeof(cl_mem),
                              (void *)&arg10.data_d));
    ...
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[64], 17, sizeof(cl_int),
                              (void *)&base6));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[64], 18, sizeof(cl_int),
                              (void *)&base7));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[64], 19, sizeof(cl_int),
                              (void *)&base8));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[64], 20, sizeof(cl_int),
                              (void *)&base9));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[64], 21, sizeof(cl_int),
                              (void *)&base10));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[64], 22, sizeof(cl_int),
                              (void *)&x_size));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[64], 23, sizeof(cl_int),
                              (void *)&y_size));
