...
//
#include "./OpenMP4/accelerate_kernel_openmp4_kernel_c.c"
...
// ops_H_D_exchanges_host(args, 11);
  ...
  accelerate_kernel_c_wrapper(p_a0, base0 / args[0].dat->elem_size, tot0, p_a1,
                              ...
                              base10 / args[10].dat->elem_size, tot10, x_size,
                              y_size);
