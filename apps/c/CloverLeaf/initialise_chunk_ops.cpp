...
void initialise_chunk() {
  ...
  ops_par_loop_initialise_chunk_kernel_y(
      "initialise_chunk_kernel_y", clover_grid, 2, rangey,
  ...
  ops_par_loop_initialise_chunk_kernel_cellx(
      "initialise_chunk_kernel_cellx", clover_grid, 2, rangex,
  ...
  ops_par_loop_initialise_chunk_kernel_celly(
      "initialise_chunk_kernel_celly", clover_grid, 2, rangey,
  ...
  ops_par_loop_initialise_chunk_kernel_volume(
      "initialise_chunk_kernel_volume", clover_grid, 2, rangexy,
