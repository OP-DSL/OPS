...
//
__constant__ int xdim0_calc;
int xdim0_calc_h = -1;
__constant__ int ydim0_calc;
int ydim0_calc_h = -1;
__constant__ int xdim1_calc;
int xdim1_calc_h = -1;
__constant__ int ydim1_calc;
int ydim1_calc_h = -1;
__constant__ int xdim2_calc;
int xdim2_calc_h = -1;
__constant__ int ydim2_calc;
int ydim2_calc_h = -1;
__constant__ int xdim3_calc;
int xdim3_calc_h = -1;
__constant__ int ydim3_calc;
int ydim3_calc_h = -1;
__constant__ int xdim4_calc;
int xdim4_calc_h = -1;
__constant__ int ydim4_calc;
int ydim4_calc_h = -1;
__constant__ int xdim5_calc;
int xdim5_calc_h = -1;
__constant__ int ydim5_calc;
int ydim5_calc_h = -1;
__constant__ int xdim6_calc;
int xdim6_calc_h = -1;
__constant__ int ydim6_calc;
int ydim6_calc_h = -1;
...
__device__
    ...
    void
    calc_gpu(double *dat3D, const double *dat2D_xy, const double *dat2D_yz,
...
__global__ void
ops_calc(double *__restrict arg0, const double *__restrict arg1,
         const double *__restrict arg2, const double *__restrict arg3,
         const double *__restrict arg4, const double *__restrict arg5,
         const double *__restrict arg6, int size0, int size1, int size2) {

  int idx_z = blockDim.z * blockIdx.z + threadIdx.z;
  int idx_y = blockDim.y * blockIdx.y + threadIdx.y;
  int idx_x = blockDim.x * blockIdx.x + threadIdx.x;

  arg0 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim0_calc +
          idx_z * 1 * 1 * xdim0_calc * ydim0_calc;
  arg1 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim1_calc +
          idx_z * 0 * 1 * xdim1_calc * ydim1_calc;
  arg2 += idx_x * 0 * 1 + idx_y * 1 * 1 * xdim2_calc +
          idx_z * 1 * 1 * xdim2_calc * ydim2_calc;
  arg3 += idx_x * 1 * 1 + idx_y * 0 * 1 * xdim3_calc +
          idx_z * 1 * 1 * xdim3_calc * ydim3_calc;
  arg4 += idx_x * 1 * 1 + idx_y * 0 * 1 * xdim4_calc +
          idx_z * 0 * 1 * xdim4_calc * ydim4_calc;
  arg5 += idx_x * 0 * 1 + idx_y * 1 * 1 * xdim5_calc +
          idx_z * 0 * 1 * xdim5_calc * ydim5_calc;
  arg6 += idx_x * 0 * 1 + idx_y * 0 * 1 * xdim6_calc +
          idx_z * 1 * 1 * xdim6_calc * ydim6_calc;

  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    calc_gpu(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
  }
}
...
void ops_par_loop_calc_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_calc_h || ydim0 != ydim0_calc_h || xdim1 != xdim1_calc_h ||
    ...
    cudaMemcpyToSymbol(xdim0_calc, &xdim0, sizeof(int));
    xdim0_calc_h = xdim0;
    cudaMemcpyToSymbol(ydim0_calc, &ydim0, sizeof(int));
    ydim0_calc_h = ydim0;
    cudaMemcpyToSymbol(xdim1_calc, &xdim1, sizeof(int));
    xdim1_calc_h = xdim1;
    cudaMemcpyToSymbol(ydim1_calc, &ydim1, sizeof(int));
    ydim1_calc_h = ydim1;
    cudaMemcpyToSymbol(xdim2_calc, &xdim2, sizeof(int));
    xdim2_calc_h = xdim2;
    cudaMemcpyToSymbol(ydim2_calc, &ydim2, sizeof(int));
    ydim2_calc_h = ydim2;
    cudaMemcpyToSymbol(xdim3_calc, &xdim3, sizeof(int));
    xdim3_calc_h = xdim3;
    cudaMemcpyToSymbol(ydim3_calc, &ydim3, sizeof(int));
    ydim3_calc_h = ydim3;
    cudaMemcpyToSymbol(xdim4_calc, &xdim4, sizeof(int));
    xdim4_calc_h = xdim4;
    cudaMemcpyToSymbol(ydim4_calc, &ydim4, sizeof(int));
    ydim4_calc_h = ydim4;
    cudaMemcpyToSymbol(xdim5_calc, &xdim5, sizeof(int));
    xdim5_calc_h = xdim5;
    cudaMemcpyToSymbol(ydim5_calc, &ydim5, sizeof(int));
    ydim5_calc_h = ydim5;
    cudaMemcpyToSymbol(xdim6_calc, &xdim6, sizeof(int));
    xdim6_calc_h = xdim6;
    cudaMemcpyToSymbol(ydim6_calc, &ydim6, sizeof(int));
    ydim6_calc_h = ydim6;
  }
