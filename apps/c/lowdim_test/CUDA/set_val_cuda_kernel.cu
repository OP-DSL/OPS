...
//
__constant__ int xdim0_set_val;
int xdim0_set_val_h = -1;
__constant__ int ydim0_set_val;
int ydim0_set_val_h = -1;

#undef OPS_ACC0

#define OPS_ACC0(x, y, z)                                                      \
  (x + xdim0_set_val * (y) + xdim0_set_val * ydim0_set_val * (z))

// user function
__device__

    void
    set_val_gpu(double *dat, const double *val) {
...
__global__ void ops_set_val(double *__restrict arg0, const double arg1,
  ...
  arg0 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim0_set_val +
          idx_z * 1 * 1 * xdim0_set_val * ydim0_set_val;
...
void ops_par_loop_set_val_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_set_val_h || ydim0 != ydim0_set_val_h) {
    cudaMemcpyToSymbol(xdim0_set_val, &xdim0, sizeof(int));
    xdim0_set_val_h = xdim0;
    cudaMemcpyToSymbol(ydim0_set_val, &ydim0, sizeof(int));
  ...
  if (x_size > 0 && y_size > 0 && z_size > 0)
    ops_set_val<<<grid, tblock>>>((double *)p_a[0], *(double *)arg1.data,
