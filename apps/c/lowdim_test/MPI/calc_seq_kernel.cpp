...
#pragma simd
        for (int i = 0; i < SIMD_VEC; i++) {
          calc((double *)p_a[0] + i * 1 * 1, (double *)p_a[1] + i * 1 * 1,
               (double *)p_a[2] + i * 0 * 1, (double *)p_a[3] + i * 1 * 1,
               (double *)p_a[4] + i * 1 * 1, (double *)p_a[5] + i * 0 * 1,
               (double *)p_a[6] + i * 0 * 1);
        }
      ...
      for (int n_x = start[0] + ((end[0] - start[0]) / SIMD_VEC) * SIMD_VEC;
        ...
        calc((double *)p_a[0], (double *)p_a[1], (double *)p_a[2],
