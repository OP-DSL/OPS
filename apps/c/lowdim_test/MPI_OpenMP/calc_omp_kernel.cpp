...
#pragma omp parallel for
  for (int thr = 0; thr < nthreads; thr++) {
    ...
    base1 = base1 + dat1 * args[1].dat->size[0] *
                        (start1 * args[1].stencil->stride[1] -
                         args[1].dat->base[1] - d_m[1]);
    base1 = base1 + dat1 * args[1].dat->size[0] * args[1].dat->size[1] *
                        (start2 * args[1].stencil->stride[2] -
    ...
    base2 = base2 + dat2 * args[2].dat->size[0] *
                        (start1 * args[2].stencil->stride[1] -
                         args[2].dat->base[1] - d_m[1]);
    base2 = base2 + dat2 * args[2].dat->size[0] * args[2].dat->size[1] *
                        (start2 * args[2].stencil->stride[2] -
...
#pragma simd
          for (int i = 0; i < SIMD_VEC; i++) {
            calc((double *)p_a[0] + i * 1 * 1,
                 (const double *)p_a[1] + i * 1 * 1,
                 (const double *)p_a[2] + i * 0 * 1,
                 (const double *)p_a[3] + i * 1 * 1,
                 (const double *)p_a[4] + i * 1 * 1,
                 (const double *)p_a[5] + i * 0 * 1,
                 (const double *)p_a[6] + i * 0 * 1);
          }
        ...
        for (int n_x = start[0] + ((end[0] - start[0]) / SIMD_VEC) * SIMD_VEC;
          ...
          calc((double *)p_a[0], (const double *)p_a[1], (const double *)p_a[2],
               (const double *)p_a[3], (const double *)p_a[4],
               (const double *)p_a[5], (const double *)p_a[6]);
