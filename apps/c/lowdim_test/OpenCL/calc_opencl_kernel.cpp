...
void buildOpenCLKernels_calc(int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3, int xdim4, int ydim4, int xdim5, int ydim5, int xdim6, int ydim6) {
  ...
  if(!isbuilt_calc) {
    ...
    printf("Compiling calc %d source -- start \n",OCL_FMA);
      ...
      printf("compiling calc -- done\n");

    // Create the OpenCL kernel
    OPS_opencl_core.kernel[7] = clCreateKernel(OPS_opencl_core.program, "ops_calc", &ret);
    clSafeCall( ret );
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6) {
  ...
  if (globalWorkSize[0] > 0 && globalWorkSize[1] > 0 && globalWorkSize[2] > 0) {
    ...
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[7], 5, sizeof(cl_mem),
                              (void *)&arg5.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[7], 6, sizeof(cl_mem),
                              (void *)&arg6.data_d));
    ...
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[7], 14, sizeof(cl_int),
                              (void *)&x_size));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[7], 15, sizeof(cl_int),
                              (void *)&y_size));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[7], 16, sizeof(cl_int),
                              (void *)&z_size));
