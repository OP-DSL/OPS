...
void buildOpenCLKernels_set_val(int xdim0, int ydim0) {
  ...
  if(!isbuilt_set_val) {
    ...
    printf("Compiling set_val %d source -- start \n",OCL_FMA);
      ...
      printf("compiling set_val -- done\n");

    // Create the OpenCL kernel
    OPS_opencl_core.kernel[6] = clCreateKernel(OPS_opencl_core.program, "ops_set_val", &ret);
    clSafeCall( ret );
...
void ops_par_loop_set_val(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 1, sizeof(cl_double), (void*) arg1.data ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 2, sizeof(cl_int), (void*) &base0 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 3, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 4, sizeof(cl_int), (void*) &y_size ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 5, sizeof(cl_int), (void*) &z_size ));
