/* STEP 1 - Setting up OPS and handling first parallel loop in OPS 
 - Include proper header files, initialize and finalize OPS
 - Convert simple loops which involves zero-point stencil 
   and working on ops_dats only (no loop indexes or constants/globals)
*/
