...
void flux_calc() {
  ...
  ops_par_loop_flux_calc_kernelx(
      "flux_calc_kernelx", clover_grid, 3, rangexyz_inner_plus1x,
  ...
  ops_par_loop_flux_calc_kernely(
      "flux_calc_kernely", clover_grid, 3, rangexyz_inner_plus1y,
  ...
  ops_par_loop_flux_calc_kernelz(
      "flux_calc_kernelz", clover_grid, 3, rangexyz_inner_plus1z,
