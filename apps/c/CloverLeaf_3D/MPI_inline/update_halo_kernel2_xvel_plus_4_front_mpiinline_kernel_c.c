...
void update_halo_kernel2_xvel_plus_4_front_c_wrapper(double *restrict xvel0_p,
  ...
  for (int n_z = 0; n_z < z_size; n_z++) {
    for (int n_y = 0; n_y < y_size; n_y++) {
      for (int n_x = 0; n_x < x_size; n_x++) {
        ptr_double xvel0 = {
            xvel0_p + n_x * 1 +
                n_y * xdim0_update_halo_kernel2_xvel_plus_4_front * 1 +
        ...
        ptr_double xvel1 = {
            xvel1_p + n_x * 1 +
                n_y * xdim1_update_halo_kernel2_xvel_plus_4_front * 1 +
