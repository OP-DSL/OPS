  ...
  for ( int n_z=0; n_z<z_size; n_z++ ){
    for ( int n_y=0; n_y<y_size; n_y++ ){
      for ( int n_x=0; n_x<x_size; n_x++ ){
        const ptr_double xarea = { xarea_p + n_x*1 + n_y * xdim0_PdV_kernel_predict*1 + n_z * xdim0_PdV_kernel_predict * ydim0_PdV_kernel_predict*1, xdim0_PdV_kernel_predict, ydim0_PdV_kernel_predict};
        const ptr_double xvel0 = { xvel0_p + n_x*1 + n_y * xdim1_PdV_kernel_predict*1 + n_z * xdim1_PdV_kernel_predict * ydim1_PdV_kernel_predict*1, xdim1_PdV_kernel_predict, ydim1_PdV_kernel_predict};
        const ptr_double yarea = { yarea_p + n_x*1 + n_y * xdim2_PdV_kernel_predict*1 + n_z * xdim2_PdV_kernel_predict * ydim2_PdV_kernel_predict*1, xdim2_PdV_kernel_predict, ydim2_PdV_kernel_predict};
        const ptr_double yvel0 = { yvel0_p + n_x*1 + n_y * xdim3_PdV_kernel_predict*1 + n_z * xdim3_PdV_kernel_predict * ydim3_PdV_kernel_predict*1, xdim3_PdV_kernel_predict, ydim3_PdV_kernel_predict};
        ptr_double volume_change = { volume_change_p + n_x*1 + n_y * xdim4_PdV_kernel_predict*1 + n_z * xdim4_PdV_kernel_predict * ydim4_PdV_kernel_predict*1, xdim4_PdV_kernel_predict, ydim4_PdV_kernel_predict};
        const ptr_double volume = { volume_p + n_x*1 + n_y * xdim5_PdV_kernel_predict*1 + n_z * xdim5_PdV_kernel_predict * ydim5_PdV_kernel_predict*1, xdim5_PdV_kernel_predict, ydim5_PdV_kernel_predict};
        const ptr_double pressure = { pressure_p + n_x*1 + n_y * xdim6_PdV_kernel_predict*1 + n_z * xdim6_PdV_kernel_predict * ydim6_PdV_kernel_predict*1, xdim6_PdV_kernel_predict, ydim6_PdV_kernel_predict};
        const ptr_double density0 = { density0_p + n_x*1 + n_y * xdim7_PdV_kernel_predict*1 + n_z * xdim7_PdV_kernel_predict * ydim7_PdV_kernel_predict*1, xdim7_PdV_kernel_predict, ydim7_PdV_kernel_predict};
        ptr_double density1 = { density1_p + n_x*1 + n_y * xdim8_PdV_kernel_predict*1 + n_z * xdim8_PdV_kernel_predict * ydim8_PdV_kernel_predict*1, xdim8_PdV_kernel_predict, ydim8_PdV_kernel_predict};
        const ptr_double viscosity = { viscosity_p + n_x*1 + n_y * xdim9_PdV_kernel_predict*1 + n_z * xdim9_PdV_kernel_predict * ydim9_PdV_kernel_predict*1, xdim9_PdV_kernel_predict, ydim9_PdV_kernel_predict};
        const ptr_double energy0 = { energy0_p + n_x*1 + n_y * xdim10_PdV_kernel_predict*1 + n_z * xdim10_PdV_kernel_predict * ydim10_PdV_kernel_predict*1, xdim10_PdV_kernel_predict, ydim10_PdV_kernel_predict};
        ptr_double energy1 = { energy1_p + n_x*1 + n_y * xdim11_PdV_kernel_predict*1 + n_z * xdim11_PdV_kernel_predict * ydim11_PdV_kernel_predict*1, xdim11_PdV_kernel_predict, ydim11_PdV_kernel_predict};
        const ptr_double zarea = { zarea_p + n_x*1 + n_y * xdim12_PdV_kernel_predict*1 + n_z * xdim12_PdV_kernel_predict * ydim12_PdV_kernel_predict*1, xdim12_PdV_kernel_predict, ydim12_PdV_kernel_predict};
        const ptr_double zvel0 = { zvel0_p + n_x*1 + n_y * xdim13_PdV_kernel_predict*1 + n_z * xdim13_PdV_kernel_predict * ydim13_PdV_kernel_predict*1, xdim13_PdV_kernel_predict, ydim13_PdV_kernel_predict};
