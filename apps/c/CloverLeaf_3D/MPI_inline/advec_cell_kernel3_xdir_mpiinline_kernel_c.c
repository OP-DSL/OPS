  ...
  for (int n_z = 0; n_z < z_size; n_z++) {
    for (int n_y = 0; n_y < y_size; n_y++) {
      for (int n_x = 0; n_x < x_size; n_x++) {
        ...
        sigmat =
            fabs(OPS_ACC(vol_flux_x, 0, 0, 0)) / OPS_ACC(pre_vol, donor, 0, 0);
        sigma3 = (1.0 + sigmat) *
        ...
        diffuw =
            OPS_ACC(density1, donor, 0, 0) - OPS_ACC(density1, upwind, 0, 0);
        diffdw =
            OPS_ACC(density1, downwind, 0, 0) - OPS_ACC(density1, donor, 0, 0);
        ...
        OPS_ACC(ener_flux, 0, 0, 0) = OPS_ACC(mass_flux_x, 0, 0, 0) *
                                      (OPS_ACC(energy1, donor, 0, 0) + limiter);
      }
    }
  }
}
