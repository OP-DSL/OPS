...
#define OPS_ACC0(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim0_advec_cell_kernel3_xdir * 1 +                         \
...
#define OPS_ACC1(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim1_advec_cell_kernel3_xdir * 1 +                         \
...
#define OPS_ACC2(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim2_advec_cell_kernel3_xdir * 0 +                         \
...
#define OPS_ACC3(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim3_advec_cell_kernel3_xdir * 0 +                         \
...
#define OPS_ACC4(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim4_advec_cell_kernel3_xdir * 1 +                         \
...
#define OPS_ACC5(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim5_advec_cell_kernel3_xdir * 1 +                         \
...
#define OPS_ACC6(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim6_advec_cell_kernel3_xdir * 1 +                         \
...
#define OPS_ACC7(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim7_advec_cell_kernel3_xdir * 1 +                         \
...
void advec_cell_kernel3_xdir_c_wrapper(
    const double *restrict vol_flux_x, const double *restrict pre_vol,
    const int *restrict xx, const double *restrict vertexdx,
    const double *restrict density1, const double *restrict energy1,
    double *restrict mass_flux_x, double *restrict ener_flux, int x_size,
