...
#define OPS_ACC0(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim0_advec_mom_kernel1_z_nonvector * 1 +                   \
...
#define OPS_ACC1(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim1_advec_mom_kernel1_z_nonvector * 1 +                   \
...
#define OPS_ACC2(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim2_advec_mom_kernel1_z_nonvector * 1 +                   \
...
#define OPS_ACC3(x, y, z)                                                      \
  (n_x * 0 + n_y * xdim3_advec_mom_kernel1_z_nonvector * 0 +                   \
...
#define OPS_ACC4(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim4_advec_mom_kernel1_z_nonvector * 1 +                   \
...
void advec_mom_kernel1_z_nonvector_c_wrapper(
    const double *restrict node_flux, const double *restrict node_mass_pre,
    double *restrict mom_flux, const double *restrict celldz,
    const double *restrict vel1, int x_size, int y_size, int z_size) {
