...
#define OPS_ACC0(x, y, z)                                                      \
  (n_x * 1 + x + (n_y * 1 + (y)) * xdim0_flux_calc_kernelx +                   \
   (n_z * 1 + (z)) * xdim0_flux_calc_kernelx * ydim0_flux_calc_kernelx)
#define OPS_ACC1(x, y, z)                                                      \
  (n_x * 1 + x + (n_y * 1 + (y)) * xdim1_flux_calc_kernelx +                   \
   (n_z * 1 + (z)) * xdim1_flux_calc_kernelx * ydim1_flux_calc_kernelx)
#define OPS_ACC2(x, y, z)                                                      \
  (n_x * 1 + x + (n_y * 1 + (y)) * xdim2_flux_calc_kernelx +                   \
   (n_z * 1 + (z)) * xdim2_flux_calc_kernelx * ydim2_flux_calc_kernelx)
#define OPS_ACC3(x, y, z)                                                      \
  (n_x * 1 + x + (n_y * 1 + (y)) * xdim3_flux_calc_kernelx +                   \
   (n_z * 1 + (z)) * xdim3_flux_calc_kernelx * ydim3_flux_calc_kernelx)
// user function
