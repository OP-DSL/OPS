...
void generate_chunk_kernel_c_wrapper(
    ...
    double *restrict vertexz_p, double *restrict energy0_p,
    double *restrict density0_p, double *restrict xvel0_p,
    double *restrict yvel0_p, double *restrict zvel0_p,
    double *restrict cellx_p, double *restrict celly_p,
    double *restrict cellz_p, int x_size, int y_size, int z_size) {
#pragma omp parallel for
  for (int n_z = 0; n_z < z_size; n_z++) {
    for (int n_y = 0; n_y < y_size; n_y++) {
      for (int n_x = 0; n_x < x_size; n_x++) {
        const ptr_double vertexx = {
            vertexx_p + n_x * 1 + n_y * xdim0_generate_chunk_kernel * 0 +
                n_z * xdim0_generate_chunk_kernel *
                    ydim0_generate_chunk_kernel * 0,
            xdim0_generate_chunk_kernel, ydim0_generate_chunk_kernel};
        const ptr_double vertexy = {
            vertexy_p + n_x * 0 + n_y * xdim1_generate_chunk_kernel * 1 +
                n_z * xdim1_generate_chunk_kernel *
                    ydim1_generate_chunk_kernel * 0,
            xdim1_generate_chunk_kernel, ydim1_generate_chunk_kernel};
        const ptr_double vertexz = {
            vertexz_p + n_x * 0 + n_y * xdim2_generate_chunk_kernel * 0 +
                n_z * xdim2_generate_chunk_kernel *
                    ydim2_generate_chunk_kernel * 1,
            xdim2_generate_chunk_kernel, ydim2_generate_chunk_kernel};
        ptr_double energy0 = {
            energy0_p + n_x * 1 + n_y * xdim3_generate_chunk_kernel * 1 +
                n_z * xdim3_generate_chunk_kernel *
                    ydim3_generate_chunk_kernel * 1,
            xdim3_generate_chunk_kernel, ydim3_generate_chunk_kernel};
        ptr_double density0 = {
            density0_p + n_x * 1 + n_y * xdim4_generate_chunk_kernel * 1 +
                n_z * xdim4_generate_chunk_kernel *
                    ydim4_generate_chunk_kernel * 1,
            xdim4_generate_chunk_kernel, ydim4_generate_chunk_kernel};
        ptr_double xvel0 = {
            xvel0_p + n_x * 1 + n_y * xdim5_generate_chunk_kernel * 1 +
                n_z * xdim5_generate_chunk_kernel *
                    ydim5_generate_chunk_kernel * 1,
            xdim5_generate_chunk_kernel, ydim5_generate_chunk_kernel};
        ptr_double yvel0 = {
            yvel0_p + n_x * 1 + n_y * xdim6_generate_chunk_kernel * 1 +
                n_z * xdim6_generate_chunk_kernel *
                    ydim6_generate_chunk_kernel * 1,
            xdim6_generate_chunk_kernel, ydim6_generate_chunk_kernel};
        ptr_double zvel0 = {
            zvel0_p + n_x * 1 + n_y * xdim7_generate_chunk_kernel * 1 +
                n_z * xdim7_generate_chunk_kernel *
                    ydim7_generate_chunk_kernel * 1,
            xdim7_generate_chunk_kernel, ydim7_generate_chunk_kernel};
        const ptr_double cellx = {
            cellx_p + n_x * 1 + n_y * xdim8_generate_chunk_kernel * 0 +
                n_z * xdim8_generate_chunk_kernel *
                    ydim8_generate_chunk_kernel * 0,
            xdim8_generate_chunk_kernel, ydim8_generate_chunk_kernel};
        const ptr_double celly = {
            celly_p + n_x * 0 + n_y * xdim9_generate_chunk_kernel * 1 +
                n_z * xdim9_generate_chunk_kernel *
                    ydim9_generate_chunk_kernel * 0,
            xdim9_generate_chunk_kernel, ydim9_generate_chunk_kernel};
        const ptr_double cellz = {
            cellz_p + n_x * 0 + n_y * xdim10_generate_chunk_kernel * 0 +
