...
void generate_chunk_kernel_c_wrapper(
    ...
    const double *restrict vertexz, double *restrict energy0,
    double *restrict density0, double *restrict xvel0, double *restrict yvel0,
    double *restrict zvel0, const double *restrict cellx,
    const double *restrict celly, const double *restrict cellz, int x_size,
