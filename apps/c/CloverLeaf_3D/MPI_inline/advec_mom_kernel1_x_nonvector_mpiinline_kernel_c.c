...
#define OPS_ACC0(x, y, z)                                                      \
  (n_x * 1 + x + (n_y * 1 + (y)) * xdim0_advec_mom_kernel1_x_nonvector +       \
   (n_z * 1 + (z)) * xdim0_advec_mom_kernel1_x_nonvector *                     \
       ydim0_advec_mom_kernel1_x_nonvector)
#define OPS_ACC1(x, y, z)                                                      \
  (n_x * 1 + x + (n_y * 1 + (y)) * xdim1_advec_mom_kernel1_x_nonvector +       \
   (n_z * 1 + (z)) * xdim1_advec_mom_kernel1_x_nonvector *                     \
       ydim1_advec_mom_kernel1_x_nonvector)
#define OPS_ACC2(x, y, z)                                                      \
  (n_x * 1 + x + (n_y * 1 + (y)) * xdim2_advec_mom_kernel1_x_nonvector +       \
   (n_z * 1 + (z)) * xdim2_advec_mom_kernel1_x_nonvector *                     \
       ydim2_advec_mom_kernel1_x_nonvector)
#define OPS_ACC3(x, y, z)                                                      \
  (n_x * 1 + x + (n_y * 0 + (y)) * xdim3_advec_mom_kernel1_x_nonvector +       \
   (n_z * 0 + (z)) * xdim3_advec_mom_kernel1_x_nonvector *                     \
       ydim3_advec_mom_kernel1_x_nonvector)
#define OPS_ACC4(x, y, z)                                                      \
  (n_x * 1 + x + (n_y * 1 + (y)) * xdim4_advec_mom_kernel1_x_nonvector +       \
   (n_z * 1 + (z)) * xdim4_advec_mom_kernel1_x_nonvector *                     \
