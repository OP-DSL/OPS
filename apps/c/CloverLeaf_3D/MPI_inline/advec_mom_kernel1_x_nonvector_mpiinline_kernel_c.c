...
#define OPS_ACC0(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim0_advec_mom_kernel1_x_nonvector * 1 +                   \
...
#define OPS_ACC1(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim1_advec_mom_kernel1_x_nonvector * 1 +                   \
...
#define OPS_ACC2(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim2_advec_mom_kernel1_x_nonvector * 1 +                   \
...
#define OPS_ACC3(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim3_advec_mom_kernel1_x_nonvector * 0 +                   \
...
#define OPS_ACC4(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim4_advec_mom_kernel1_x_nonvector * 1 +                   \
...
void advec_mom_kernel1_x_nonvector_c_wrapper(
    ...
    double *restrict mom_flux, const double *restrict celldx,
    ...
    for (int n_y = 0; n_y < y_size; n_y++) {
      for (int n_x = 0; n_x < x_size; n_x++) {
        ...
        sigma = fabs(node_flux[OPS_ACC0(0, 0, 0)]) /
                node_mass_pre[OPS_ACC1(donor, 0, 0)];
