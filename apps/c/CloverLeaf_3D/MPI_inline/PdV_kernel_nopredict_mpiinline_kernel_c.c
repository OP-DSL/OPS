...
#define OPS_ACC0(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim0_PdV_kernel_nopredict * 1 +                            \
...
#define OPS_ACC1(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim1_PdV_kernel_nopredict * 1 +                            \
...
#define OPS_ACC2(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim2_PdV_kernel_nopredict * 1 +                            \
...
#define OPS_ACC3(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim3_PdV_kernel_nopredict * 1 +                            \
...
#define OPS_ACC4(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim4_PdV_kernel_nopredict * 1 +                            \
...
#define OPS_ACC5(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim5_PdV_kernel_nopredict * 1 +                            \
...
#define OPS_ACC6(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim6_PdV_kernel_nopredict * 1 +                            \
...
#define OPS_ACC7(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim7_PdV_kernel_nopredict * 1 +                            \
...
#define OPS_ACC8(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim8_PdV_kernel_nopredict * 1 +                            \
...
#define OPS_ACC9(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim9_PdV_kernel_nopredict * 1 +                            \
...
#define OPS_ACC10(x, y, z)                                                     \
  (n_x * 1 + n_y * xdim10_PdV_kernel_nopredict * 1 +                           \
...
#define OPS_ACC11(x, y, z)                                                     \
  (n_x * 1 + n_y * xdim11_PdV_kernel_nopredict * 1 +                           \
...
#define OPS_ACC12(x, y, z)                                                     \
  (n_x * 1 + n_y * xdim12_PdV_kernel_nopredict * 1 +                           \
...
#define OPS_ACC13(x, y, z)                                                     \
  (n_x * 1 + n_y * xdim13_PdV_kernel_nopredict * 1 +                           \
...
#define OPS_ACC14(x, y, z)                                                     \
  (n_x * 1 + n_y * xdim14_PdV_kernel_nopredict * 1 +                           \
...
#define OPS_ACC15(x, y, z)                                                     \
  (n_x * 1 + n_y * xdim15_PdV_kernel_nopredict * 1 +                           \
...
#define OPS_ACC16(x, y, z)                                                     \
  (n_x * 1 + n_y * xdim16_PdV_kernel_nopredict * 1 +                           \
...
void PdV_kernel_nopredict_c_wrapper(
    ...
    const double *restrict zarea, const double *restrict zvel0,
    const double *restrict zvel1, int x_size, int y_size, int z_size) {
