...
#define OPS_ACC0(x,y,z) (n_x*0 + x + (n_y*1+(y))*xdim0_initialise_chunk_kernel_celly + (n_z*0+(z))*xdim0_initialise_chunk_kernel_celly*ydim0_initialise_chunk_kernel_celly)
#define OPS_ACC1(x,y,z) (n_x*0 + x + (n_y*1+(y))*xdim1_initialise_chunk_kernel_celly + (n_z*0+(z))*xdim1_initialise_chunk_kernel_celly*ydim1_initialise_chunk_kernel_celly)
#define OPS_ACC2(x,y,z) (n_x*0 + x + (n_y*1+(y))*xdim2_initialise_chunk_kernel_celly + (n_z*0+(z))*xdim2_initialise_chunk_kernel_celly*ydim2_initialise_chunk_kernel_celly)
//user function
