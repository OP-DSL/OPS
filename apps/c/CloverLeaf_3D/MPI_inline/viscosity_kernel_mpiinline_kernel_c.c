  ...
  for ( int n_z=0; n_z<z_size; n_z++ ){
    for ( int n_y=0; n_y<y_size; n_y++ ){
      for ( int n_x=0; n_x<x_size; n_x++ ){
        const ptr_double xvel0 = { xvel0_p + n_x*1 + n_y * xdim0_viscosity_kernel*1 + n_z * xdim0_viscosity_kernel * ydim0_viscosity_kernel*1, xdim0_viscosity_kernel, ydim0_viscosity_kernel};
        const ptr_double yvel0 = { yvel0_p + n_x*1 + n_y * xdim1_viscosity_kernel*1 + n_z * xdim1_viscosity_kernel * ydim1_viscosity_kernel*1, xdim1_viscosity_kernel, ydim1_viscosity_kernel};
        const ptr_double celldx = { celldx_p + n_x*1 + n_y * xdim2_viscosity_kernel*0 + n_z * xdim2_viscosity_kernel * ydim2_viscosity_kernel*0, xdim2_viscosity_kernel, ydim2_viscosity_kernel};
        const ptr_double celldy = { celldy_p + n_x*0 + n_y * xdim3_viscosity_kernel*1 + n_z * xdim3_viscosity_kernel * ydim3_viscosity_kernel*0, xdim3_viscosity_kernel, ydim3_viscosity_kernel};
        const ptr_double pressure = { pressure_p + n_x*1 + n_y * xdim4_viscosity_kernel*1 + n_z * xdim4_viscosity_kernel * ydim4_viscosity_kernel*1, xdim4_viscosity_kernel, ydim4_viscosity_kernel};
        const ptr_double density0 = { density0_p + n_x*1 + n_y * xdim5_viscosity_kernel*1 + n_z * xdim5_viscosity_kernel * ydim5_viscosity_kernel*1, xdim5_viscosity_kernel, ydim5_viscosity_kernel};
        ptr_double viscosity = { viscosity_p + n_x*1 + n_y * xdim6_viscosity_kernel*1 + n_z * xdim6_viscosity_kernel * ydim6_viscosity_kernel*1, xdim6_viscosity_kernel, ydim6_viscosity_kernel};
        const ptr_double zvel0 = { zvel0_p + n_x*1 + n_y * xdim7_viscosity_kernel*1 + n_z * xdim7_viscosity_kernel * ydim7_viscosity_kernel*1, xdim7_viscosity_kernel, ydim7_viscosity_kernel};
        const ptr_double celldz = { celldz_p + n_x*0 + n_y * xdim8_viscosity_kernel*0 + n_z * xdim8_viscosity_kernel * ydim8_viscosity_kernel*1, xdim8_viscosity_kernel, ydim8_viscosity_kernel};
        const ptr_double xarea = { xarea_p + n_x*1 + n_y * xdim9_viscosity_kernel*1 + n_z * xdim9_viscosity_kernel * ydim9_viscosity_kernel*1, xdim9_viscosity_kernel, ydim9_viscosity_kernel};
        const ptr_double yarea = { yarea_p + n_x*1 + n_y * xdim10_viscosity_kernel*1 + n_z * xdim10_viscosity_kernel * ydim10_viscosity_kernel*1, xdim10_viscosity_kernel, ydim10_viscosity_kernel};
        const ptr_double zarea = { zarea_p + n_x*1 + n_y * xdim11_viscosity_kernel*1 + n_z * xdim11_viscosity_kernel * ydim11_viscosity_kernel*1, xdim11_viscosity_kernel, ydim11_viscosity_kernel};
