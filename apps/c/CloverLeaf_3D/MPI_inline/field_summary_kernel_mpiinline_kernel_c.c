...
#define OPS_ACC0(x, y, z)                                                      \
  (n_x * 1 + x + (n_y * 1 + (y)) * xdim0_field_summary_kernel +                \
   (n_z * 1 + (z)) * xdim0_field_summary_kernel * ydim0_field_summary_kernel)
#define OPS_ACC1(x, y, z)                                                      \
  (n_x * 1 + x + (n_y * 1 + (y)) * xdim1_field_summary_kernel +                \
   (n_z * 1 + (z)) * xdim1_field_summary_kernel * ydim1_field_summary_kernel)
#define OPS_ACC2(x, y, z)                                                      \
  (n_x * 1 + x + (n_y * 1 + (y)) * xdim2_field_summary_kernel +                \
   (n_z * 1 + (z)) * xdim2_field_summary_kernel * ydim2_field_summary_kernel)
#define OPS_ACC3(x, y, z)                                                      \
  (n_x * 1 + x + (n_y * 1 + (y)) * xdim3_field_summary_kernel +                \
   (n_z * 1 + (z)) * xdim3_field_summary_kernel * ydim3_field_summary_kernel)
#define OPS_ACC4(x, y, z)                                                      \
  (n_x * 1 + x + (n_y * 1 + (y)) * xdim4_field_summary_kernel +                \
   (n_z * 1 + (z)) * xdim4_field_summary_kernel * ydim4_field_summary_kernel)
#define OPS_ACC5(x, y, z)                                                      \
  (n_x * 1 + x + (n_y * 1 + (y)) * xdim5_field_summary_kernel +                \
   (n_z * 1 + (z)) * xdim5_field_summary_kernel * ydim5_field_summary_kernel)
#define OPS_ACC6(x, y, z)                                                      \
  (n_x * 1 + x + (n_y * 1 + (y)) * xdim6_field_summary_kernel +                \
   (n_z * 1 + (z)) * xdim6_field_summary_kernel * ydim6_field_summary_kernel)
//user function
