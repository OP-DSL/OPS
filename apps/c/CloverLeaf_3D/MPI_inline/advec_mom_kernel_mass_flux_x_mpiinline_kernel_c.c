  ...
  for ( int n_z=0; n_z<z_size; n_z++ ){
    for ( int n_y=0; n_y<y_size; n_y++ ){
      for ( int n_x=0; n_x<x_size; n_x++ ){
        ptr_double node_flux = { node_flux_p + n_x*1 + n_y * xdim0_advec_mom_kernel_mass_flux_x*1 + n_z * xdim0_advec_mom_kernel_mass_flux_x * ydim0_advec_mom_kernel_mass_flux_x*1, xdim0_advec_mom_kernel_mass_flux_x, ydim0_advec_mom_kernel_mass_flux_x};
        const ptr_double mass_flux_x = { mass_flux_x_p + n_x*1 + n_y * xdim1_advec_mom_kernel_mass_flux_x*1 + n_z * xdim1_advec_mom_kernel_mass_flux_x * ydim1_advec_mom_kernel_mass_flux_x*1, xdim1_advec_mom_kernel_mass_flux_x, ydim1_advec_mom_kernel_mass_flux_x};
