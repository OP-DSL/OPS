...
void advec_mom_kernel_mass_flux_x_c_wrapper(double *restrict node_flux_p,
    ...
    for (int n_y = 0; n_y < y_size; n_y++) {
      for (int n_x = 0; n_x < x_size; n_x++) {
        ptr_double node_flux = {node_flux_p + n_x * 1 +
                                    n_y * xdim0_advec_mom_kernel_mass_flux_x *
                                        1 +
        ...
        OPS_ACC(node_flux, 0, 0, 0) =
            0.125 *
            (OPS_ACC(mass_flux_x, 0, -1, 0) + OPS_ACC(mass_flux_x, 0, 0, 0) +
