    ...
    for (int n_y = 0; n_y < y_size; n_y++) {
      for (int n_x = 0; n_x < x_size; n_x++) {
        ...
        ptr_double viscosity = {
            viscosity_p + n_x * 1 + n_y * xdim5_update_halo_kernel1_r2 * 1 +
        ...
        ptr_double soundspeed = {
            soundspeed_p + n_x * 1 + n_y * xdim6_update_halo_kernel1_r2 * 1 +
