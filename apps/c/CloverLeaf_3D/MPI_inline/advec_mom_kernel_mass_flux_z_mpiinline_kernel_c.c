  ...
  for ( int n_z=0; n_z<z_size; n_z++ ){
    for ( int n_y=0; n_y<y_size; n_y++ ){
      for ( int n_x=0; n_x<x_size; n_x++ ){
        ptr_double node_flux = { node_flux_p + n_x*1 + n_y * xdim0_advec_mom_kernel_mass_flux_z*1 + n_z * xdim0_advec_mom_kernel_mass_flux_z * ydim0_advec_mom_kernel_mass_flux_z*1, xdim0_advec_mom_kernel_mass_flux_z, ydim0_advec_mom_kernel_mass_flux_z};
        const ptr_double mass_flux_z = { mass_flux_z_p + n_x*1 + n_y * xdim1_advec_mom_kernel_mass_flux_z*1 + n_z * xdim1_advec_mom_kernel_mass_flux_z * ydim1_advec_mom_kernel_mass_flux_z*1, xdim1_advec_mom_kernel_mass_flux_z, ydim1_advec_mom_kernel_mass_flux_z};
