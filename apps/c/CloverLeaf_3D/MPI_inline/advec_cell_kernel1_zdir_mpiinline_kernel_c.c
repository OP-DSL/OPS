...
#define OPS_ACC0(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim0_advec_cell_kernel1_zdir * 1 +                         \
...
#define OPS_ACC1(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim1_advec_cell_kernel1_zdir * 1 +                         \
...
#define OPS_ACC2(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim2_advec_cell_kernel1_zdir * 1 +                         \
...
#define OPS_ACC3(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim3_advec_cell_kernel1_zdir * 1 +                         \
...
#define OPS_ACC4(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim4_advec_cell_kernel1_zdir * 1 +                         \
...
#define OPS_ACC5(x, y, z)                                                      \
  (n_x * 1 + n_y * xdim5_advec_cell_kernel1_zdir * 1 +                         \
...
void advec_cell_kernel1_zdir_c_wrapper(double *restrict pre_vol,
