...
inline void advec_mom_kernel1_y_nonvector(const ptr_double node_flux,
  ...
  sigma =
      fabs(OPS_ACC(node_flux, 0, 0, 0)) / OPS_ACC(node_mass_pre, 0, donor, 0);
      ...
      for (int n_x = 0; n_x < x_size; n_x++) {
        const ptr_double ptr0 = {
            p_a0 + n_x * 1 * 1 +
                ...
                n_z * xdim0_advec_mom_kernel1_y_nonvector *
                    ydim0_advec_mom_kernel1_y_nonvector * 1 * 1,
        ...
        const ptr_double ptr1 = {
            p_a1 + n_x * 1 * 1 +
                ...
                n_z * xdim1_advec_mom_kernel1_y_nonvector *
                    ydim1_advec_mom_kernel1_y_nonvector * 1 * 1,
        ...
        ptr_double ptr2 = {p_a2 + n_x * 1 * 1 +
                               ...
                               n_z * xdim2_advec_mom_kernel1_y_nonvector *
                                   ydim2_advec_mom_kernel1_y_nonvector * 1 * 1,
        ...
        const ptr_double ptr3 = {
            p_a3 + n_x * 0 * 1 +
                ...
                n_z * xdim3_advec_mom_kernel1_y_nonvector *
                    ydim3_advec_mom_kernel1_y_nonvector * 0 * 1,
        ...
        const ptr_double ptr4 = {
            p_a4 + n_x * 1 * 1 +
                ...
                n_z * xdim4_advec_mom_kernel1_y_nonvector *
                    ydim4_advec_mom_kernel1_y_nonvector * 1 * 1,
