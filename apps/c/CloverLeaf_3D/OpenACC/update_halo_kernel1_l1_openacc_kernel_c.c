        ...
        ptr_double ptr0 = {
            p_a0 + n_x * 1 * 1 + n_y * xdim0_update_halo_kernel1_l1 * 1 * 1 +
                n_z * xdim0_update_halo_kernel1_l1 *
                    ydim0_update_halo_kernel1_l1 * 1 * 1,
        ...
        ptr_double ptr1 = {
            p_a1 + n_x * 1 * 1 + n_y * xdim1_update_halo_kernel1_l1 * 1 * 1 +
                n_z * xdim1_update_halo_kernel1_l1 *
                    ydim1_update_halo_kernel1_l1 * 1 * 1,
        ...
        ptr_double ptr2 = {
            p_a2 + n_x * 1 * 1 + n_y * xdim2_update_halo_kernel1_l1 * 1 * 1 +
                n_z * xdim2_update_halo_kernel1_l1 *
                    ydim2_update_halo_kernel1_l1 * 1 * 1,
        ...
        ptr_double ptr3 = {
            p_a3 + n_x * 1 * 1 + n_y * xdim3_update_halo_kernel1_l1 * 1 * 1 +
                n_z * xdim3_update_halo_kernel1_l1 *
                    ydim3_update_halo_kernel1_l1 * 1 * 1,
        ...
        ptr_double ptr4 = {
            p_a4 + n_x * 1 * 1 + n_y * xdim4_update_halo_kernel1_l1 * 1 * 1 +
                n_z * xdim4_update_halo_kernel1_l1 *
                    ydim4_update_halo_kernel1_l1 * 1 * 1,
        ...
        ptr_double ptr5 = {
            p_a5 + n_x * 1 * 1 + n_y * xdim5_update_halo_kernel1_l1 * 1 * 1 +
                n_z * xdim5_update_halo_kernel1_l1 *
                    ydim5_update_halo_kernel1_l1 * 1 * 1,
        ...
        ptr_double ptr6 = {
            p_a6 + n_x * 1 * 1 + n_y * xdim6_update_halo_kernel1_l1 * 1 * 1 +
                n_z * xdim6_update_halo_kernel1_l1 *
                    ydim6_update_halo_kernel1_l1 * 1 * 1,
            xdim6_update_halo_kernel1_l1, ydim6_update_halo_kernel1_l1};
        update_halo_kernel1_l1(ptr0, ptr1, ptr2, ptr3, ptr4, ptr5, ptr6, p_a7);
      }
    }
  }
}
