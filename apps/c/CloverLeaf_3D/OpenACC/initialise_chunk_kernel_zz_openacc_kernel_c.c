  ...
  for ( int n_z=0; n_z<z_size; n_z++ ){
    ...
    for ( int n_y=0; n_y<y_size; n_y++ ){
      ...
      for ( int n_x=0; n_x<x_size; n_x++ ){
        ...
        initialise_chunk_kernel_zz(  p_a0 + n_x*0*1 + n_y*xdim0_initialise_chunk_kernel_zz*0*1 + n_z*xdim0_initialise_chunk_kernel_zz*ydim0_initialise_chunk_kernel_zz*1,
          arg_idx );
