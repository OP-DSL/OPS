  ...
  for ( int n_z=0; n_z<z_size; n_z++ ){
    ...
    for ( int n_y=0; n_y<y_size; n_y++ ){
      ...
      for ( int n_x=0; n_x<x_size; n_x++ ){
        advec_mom_kernel1_z_nonvector(  p_a0 + n_x*1*1 + n_y*xdim0_advec_mom_kernel1_z_nonvector*1*1 + n_z*xdim0_advec_mom_kernel1_z_nonvector*ydim0_advec_mom_kernel1_z_nonvector*1,
           p_a1 + n_x*1*1 + n_y*xdim1_advec_mom_kernel1_z_nonvector*1*1 + n_z*xdim1_advec_mom_kernel1_z_nonvector*ydim1_advec_mom_kernel1_z_nonvector*1,
           p_a2 + n_x*1*1 + n_y*xdim2_advec_mom_kernel1_z_nonvector*1*1 + n_z*xdim2_advec_mom_kernel1_z_nonvector*ydim2_advec_mom_kernel1_z_nonvector*1,
           p_a3 + n_x*0*1 + n_y*xdim3_advec_mom_kernel1_z_nonvector*0*1 + n_z*xdim3_advec_mom_kernel1_z_nonvector*ydim3_advec_mom_kernel1_z_nonvector*1,
           p_a4 + n_x*1*1 + n_y*xdim4_advec_mom_kernel1_z_nonvector*1*1 + n_z*xdim4_advec_mom_kernel1_z_nonvector*ydim4_advec_mom_kernel1_z_nonvector*1 );
