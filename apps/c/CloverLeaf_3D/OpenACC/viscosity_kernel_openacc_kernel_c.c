...
// user function
#pragma acc routine
inline void viscosity_kernel(const ptr_double xvel0, const ptr_double yvel0,
                             const ptr_double celldx, const ptr_double celldy,
                             const ptr_double pressure,
                             const ptr_double density0, ptr_double viscosity,
                             const ptr_double zvel0, const ptr_double celldz,
                             const ptr_double xarea, const ptr_double yarea,
      ...
      for (int n_x = 0; n_x < x_size; n_x++) {
        ...
        const ptr_double ptr11 = {
            p_a11 + n_x * 1 * 1 + n_y * xdim11_viscosity_kernel * 1 * 1 +
                n_z * xdim11_viscosity_kernel * ydim11_viscosity_kernel * 1 * 1,
            xdim11_viscosity_kernel, ydim11_viscosity_kernel};
        viscosity_kernel(ptr0, ptr1, ptr2, ptr3, ptr4, ptr5, ptr6, ptr7, ptr8,
                         ptr9, ptr10, ptr11);
      }
    }
  }
