...
void ops_par_loop_calc_dt_kernel_get_execute(ops_kernel_descriptor *desc) {
  ...
  if (ops_hybrid) arg3h =  (double *)(((ops_reduction)args[3].data)->data + ((ops_reduction)args[3].data)->size * (2*block->index));
  #else //OPS_MPI
  ...
  if (ops_hybrid) arg5h =  (double *)(((ops_reduction)args[5].data)->data + ((ops_reduction)args[5].data)->size * (2*block->index));
  #else //OPS_MPI
