...
void ops_par_loop_advec_mom_kernel1_z_nonvector_execute(ops_kernel_descriptor *desc) {
  ...
  cl::sycl::buffer<double,1> celldz_p = static_cast<cl::sycl::buffer<char,1> *>((void*)args[3].data_d)->reinterpret<double,1>(cl::sycl::range<1>(args[3].dat->mem/sizeof(double)));
  ...
  block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
    ...
    cgh.parallel_for<class advec_mom_kernel1_z_nonvector_kernel>(cl::sycl::nd_range<3>(cl::sycl::range<3>(
      ...
      const ACC<double> node_flux(xdim0_advec_mom_kernel1_z_nonvector, ydim0_advec_mom_kernel1_z_nonvector, &Accessor_node_flux[0] + base0 + n_x*1 + n_y * xdim0_advec_mom_kernel1_z_nonvector*1 + n_z * xdim0_advec_mom_kernel1_z_nonvector * ydim0_advec_mom_kernel1_z_nonvector*1);
      const ACC<double> node_mass_pre(xdim1_advec_mom_kernel1_z_nonvector, ydim1_advec_mom_kernel1_z_nonvector, &Accessor_node_mass_pre[0] + base1 + n_x*1 + n_y * xdim1_advec_mom_kernel1_z_nonvector*1 + n_z * xdim1_advec_mom_kernel1_z_nonvector * ydim1_advec_mom_kernel1_z_nonvector*1);
      ACC<double> mom_flux(xdim2_advec_mom_kernel1_z_nonvector, ydim2_advec_mom_kernel1_z_nonvector, &Accessor_mom_flux[0] + base2 + n_x*1 + n_y * xdim2_advec_mom_kernel1_z_nonvector*1 + n_z * xdim2_advec_mom_kernel1_z_nonvector * ydim2_advec_mom_kernel1_z_nonvector*1);
      const ACC<double> celldz(xdim3_advec_mom_kernel1_z_nonvector, ydim3_advec_mom_kernel1_z_nonvector, &Accessor_celldz[0] + base3 + n_x*0 + n_y * xdim3_advec_mom_kernel1_z_nonvector*0 + n_z * xdim3_advec_mom_kernel1_z_nonvector * ydim3_advec_mom_kernel1_z_nonvector*1);
      const ACC<double> vel1(xdim4_advec_mom_kernel1_z_nonvector, ydim4_advec_mom_kernel1_z_nonvector, &Accessor_vel1[0] + base4 + n_x*1 + n_y * xdim4_advec_mom_kernel1_z_nonvector*1 + n_z * xdim4_advec_mom_kernel1_z_nonvector * ydim4_advec_mom_kernel1_z_nonvector*1);
      //USER CODE
  ...
  sigma = cl::sycl::fabs(node_flux(0,0,0))/node_mass_pre(0,0,donor);
  width = celldz(0,0,0);
