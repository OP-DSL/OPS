...
void ops_par_loop_initialise_chunk_kernel_yy_execute(ops_kernel_descriptor *desc) {
  ...
  cl::sycl::buffer<int,1> yy_p = static_cast<cl::sycl::buffer<char,1> *>((void*)args[0].data_d)->reinterpret<int,1>(cl::sycl::range<1>(args[0].dat->mem/sizeof(int)));
  ...
  block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
    ...
    cgh.parallel_for<class initialise_chunk_kernel_yy_kernel>(cl::sycl::nd_range<3>(cl::sycl::range<3>(
      ...
      ACC<int> yy(xdim0_initialise_chunk_kernel_yy, ydim0_initialise_chunk_kernel_yy, &Accessor_yy[0] + base0 + n_x*0 + n_y * xdim0_initialise_chunk_kernel_yy*1 + n_z * xdim0_initialise_chunk_kernel_yy * ydim0_initialise_chunk_kernel_yy*0);
      //USER CODE
