...
void ops_par_loop_advec_cell_kernel2_ydir_execute(ops_kernel_descriptor *desc) {
  ...
  cl::sycl::buffer<double,1> vol_flux_x_p = static_cast<cl::sycl::buffer<char,1> *>((void*)args[4].data_d)->reinterpret<double,1>(cl::sycl::range<1>(args[4].dat->mem/sizeof(double)));
  ...
  block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
    ...
    cgh.parallel_for<class advec_cell_kernel2_ydir_kernel>(cl::sycl::nd_range<3>(cl::sycl::range<3>(
      ...
      ACC<double> pre_vol(xdim0_advec_cell_kernel2_ydir, ydim0_advec_cell_kernel2_ydir, &Accessor_pre_vol[0] + base0 + n_x*1 + n_y * xdim0_advec_cell_kernel2_ydir*1 + n_z * xdim0_advec_cell_kernel2_ydir * ydim0_advec_cell_kernel2_ydir*1);
      ACC<double> post_vol(xdim1_advec_cell_kernel2_ydir, ydim1_advec_cell_kernel2_ydir, &Accessor_post_vol[0] + base1 + n_x*1 + n_y * xdim1_advec_cell_kernel2_ydir*1 + n_z * xdim1_advec_cell_kernel2_ydir * ydim1_advec_cell_kernel2_ydir*1);
      const ACC<double> volume(xdim2_advec_cell_kernel2_ydir, ydim2_advec_cell_kernel2_ydir, &Accessor_volume[0] + base2 + n_x*1 + n_y * xdim2_advec_cell_kernel2_ydir*1 + n_z * xdim2_advec_cell_kernel2_ydir * ydim2_advec_cell_kernel2_ydir*1);
      const ACC<double> vol_flux_y(xdim3_advec_cell_kernel2_ydir, ydim3_advec_cell_kernel2_ydir, &Accessor_vol_flux_y[0] + base3 + n_x*1 + n_y * xdim3_advec_cell_kernel2_ydir*1 + n_z * xdim3_advec_cell_kernel2_ydir * ydim3_advec_cell_kernel2_ydir*1);
      const ACC<double> vol_flux_x(xdim4_advec_cell_kernel2_ydir, ydim4_advec_cell_kernel2_ydir, &Accessor_vol_flux_x[0] + base4 + n_x*1 + n_y * xdim4_advec_cell_kernel2_ydir*1 + n_z * xdim4_advec_cell_kernel2_ydir * ydim4_advec_cell_kernel2_ydir*1);
      //USER CODE
