...
void ops_par_loop_PdV_kernel_predict_execute(ops_kernel_descriptor *desc) {
 ...
 arg10, arg11, arg12, arg13};
  ...
  cl::sycl::buffer<double,1> yarea_p = static_cast<cl::sycl::buffer<char,1> *>((void*)args[2].data_d)->reinterpret<double,1>(cl::sycl::range<1>(args[2].dat->mem/sizeof(double)));

  int base3 = args[3].dat->base_offset/sizeof(double);
  cl::sycl::buffer<double,1> yvel0_p = static_cast<cl::sycl::buffer<char,1> *>((void*)args[3].data_d)->reinterpret<double,1>(cl::sycl::range<1>(args[3].dat->mem/sizeof(double)));

  int base4 = args[4].dat->base_offset/sizeof(double);
  cl::sycl::buffer<double,1> volume_change_p = static_cast<cl::sycl::buffer<char,1> *>((void*)args[4].data_d)->reinterpret<double,1>(cl::sycl::range<1>(args[4].dat->mem/sizeof(double)));

  int base5 = args[5].dat->base_offset/sizeof(double);
  cl::sycl::buffer<double,1> volume_p = static_cast<cl::sycl::buffer<char,1> *>((void*)args[5].data_d)->reinterpret<double,1>(cl::sycl::range<1>(args[5].dat->mem/sizeof(double)));
  ...
  cl::sycl::buffer<double,1> density0_p = static_cast<cl::sycl::buffer<char,1> *>((void*)args[7].data_d)->reinterpret<double,1>(cl::sycl::range<1>(args[7].dat->mem/sizeof(double)));

  int base8 = args[8].dat->base_offset/sizeof(double);
  cl::sycl::buffer<double,1> density1_p = static_cast<cl::sycl::buffer<char,1> *>((void*)args[8].data_d)->reinterpret<double,1>(cl::sycl::range<1>(args[8].dat->mem/sizeof(double)));

  int base9 = args[9].dat->base_offset/sizeof(double);
  cl::sycl::buffer<double,1> viscosity_p = static_cast<cl::sycl::buffer<char,1> *>((void*)args[9].data_d)->reinterpret<double,1>(cl::sycl::range<1>(args[9].dat->mem/sizeof(double)));

  int base10 = args[10].dat->base_offset/sizeof(double);
  cl::sycl::buffer<double,1> energy0_p = static_cast<cl::sycl::buffer<char,1> *>((void*)args[10].data_d)->reinterpret<double,1>(cl::sycl::range<1>(args[10].dat->mem/sizeof(double)));

  int base11 = args[11].dat->base_offset/sizeof(double);
  cl::sycl::buffer<double,1> energy1_p = static_cast<cl::sycl::buffer<char,1> *>((void*)args[11].data_d)->reinterpret<double,1>(cl::sycl::range<1>(args[11].dat->mem/sizeof(double)));

  int base12 = args[12].dat->base_offset/sizeof(double);
  cl::sycl::buffer<double,1> zarea_p = static_cast<cl::sycl::buffer<char,1> *>((void*)args[12].data_d)->reinterpret<double,1>(cl::sycl::range<1>(args[12].dat->mem/sizeof(double)));

  int base13 = args[13].dat->base_offset/sizeof(double);
  cl::sycl::buffer<double,1> zvel0_p = static_cast<cl::sycl::buffer<char,1> *>((void*)args[13].data_d)->reinterpret<double,1>(cl::sycl::range<1>(args[13].dat->mem/sizeof(double)));
  ...
  block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
    ...
    cgh.parallel_for<class PdV_kernel_predict_kernel>(cl::sycl::nd_range<3>(cl::sycl::range<3>(
      ...
      const ACC<double> xarea(xdim0_PdV_kernel_predict, ydim0_PdV_kernel_predict, &Accessor_xarea[0] + base0 + n_x*1 + n_y * xdim0_PdV_kernel_predict*1 + n_z * xdim0_PdV_kernel_predict * ydim0_PdV_kernel_predict*1);
      const ACC<double> xvel0(xdim1_PdV_kernel_predict, ydim1_PdV_kernel_predict, &Accessor_xvel0[0] + base1 + n_x*1 + n_y * xdim1_PdV_kernel_predict*1 + n_z * xdim1_PdV_kernel_predict * ydim1_PdV_kernel_predict*1);
      const ACC<double> yarea(xdim2_PdV_kernel_predict, ydim2_PdV_kernel_predict, &Accessor_yarea[0] + base2 + n_x*1 + n_y * xdim2_PdV_kernel_predict*1 + n_z * xdim2_PdV_kernel_predict * ydim2_PdV_kernel_predict*1);
      const ACC<double> yvel0(xdim3_PdV_kernel_predict, ydim3_PdV_kernel_predict, &Accessor_yvel0[0] + base3 + n_x*1 + n_y * xdim3_PdV_kernel_predict*1 + n_z * xdim3_PdV_kernel_predict * ydim3_PdV_kernel_predict*1);
      ACC<double> volume_change(xdim4_PdV_kernel_predict, ydim4_PdV_kernel_predict, &Accessor_volume_change[0] + base4 + n_x*1 + n_y * xdim4_PdV_kernel_predict*1 + n_z * xdim4_PdV_kernel_predict * ydim4_PdV_kernel_predict*1);
      const ACC<double> volume(xdim5_PdV_kernel_predict, ydim5_PdV_kernel_predict, &Accessor_volume[0] + base5 + n_x*1 + n_y * xdim5_PdV_kernel_predict*1 + n_z * xdim5_PdV_kernel_predict * ydim5_PdV_kernel_predict*1);
      const ACC<double> pressure(xdim6_PdV_kernel_predict, ydim6_PdV_kernel_predict, &Accessor_pressure[0] + base6 + n_x*1 + n_y * xdim6_PdV_kernel_predict*1 + n_z * xdim6_PdV_kernel_predict * ydim6_PdV_kernel_predict*1);
      const ACC<double> density0(xdim7_PdV_kernel_predict, ydim7_PdV_kernel_predict, &Accessor_density0[0] + base7 + n_x*1 + n_y * xdim7_PdV_kernel_predict*1 + n_z * xdim7_PdV_kernel_predict * ydim7_PdV_kernel_predict*1);
      ACC<double> density1(xdim8_PdV_kernel_predict, ydim8_PdV_kernel_predict, &Accessor_density1[0] + base8 + n_x*1 + n_y * xdim8_PdV_kernel_predict*1 + n_z * xdim8_PdV_kernel_predict * ydim8_PdV_kernel_predict*1);
      const ACC<double> viscosity(xdim9_PdV_kernel_predict, ydim9_PdV_kernel_predict, &Accessor_viscosity[0] + base9 + n_x*1 + n_y * xdim9_PdV_kernel_predict*1 + n_z * xdim9_PdV_kernel_predict * ydim9_PdV_kernel_predict*1);
      const ACC<double> energy0(xdim10_PdV_kernel_predict, ydim10_PdV_kernel_predict, &Accessor_energy0[0] + base10 + n_x*1 + n_y * xdim10_PdV_kernel_predict*1 + n_z * xdim10_PdV_kernel_predict * ydim10_PdV_kernel_predict*1);
      ACC<double> energy1(xdim11_PdV_kernel_predict, ydim11_PdV_kernel_predict, &Accessor_energy1[0] + base11 + n_x*1 + n_y * xdim11_PdV_kernel_predict*1 + n_z * xdim11_PdV_kernel_predict * ydim11_PdV_kernel_predict*1);
      const ACC<double> zarea(xdim12_PdV_kernel_predict, ydim12_PdV_kernel_predict, &Accessor_zarea[0] + base12 + n_x*1 + n_y * xdim12_PdV_kernel_predict*1 + n_z * xdim12_PdV_kernel_predict * ydim12_PdV_kernel_predict*1);
      const ACC<double> zvel0(xdim13_PdV_kernel_predict, ydim13_PdV_kernel_predict, &Accessor_zvel0[0] + base13 + n_x*1 + n_y * xdim13_PdV_kernel_predict*1 + n_z * xdim13_PdV_kernel_predict * ydim13_PdV_kernel_predict*1);
      //USER CODE
