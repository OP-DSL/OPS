...
void ops_par_loop_update_halo_kernel1_fr1_execute(ops_kernel_descriptor *desc) {
 ...
 arg5, arg6, arg7};
  ...
  block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
    ...
    cgh.parallel_for<class update_halo_kernel1_fr1_kernel>(cl::sycl::nd_range<3>(cl::sycl::range<3>(
      ...
      ACC<double> density0(xdim0_update_halo_kernel1_fr1, ydim0_update_halo_kernel1_fr1, &Accessor_density0[0] + base0 + n_x*1 + n_y * xdim0_update_halo_kernel1_fr1*1 + n_z * xdim0_update_halo_kernel1_fr1 * ydim0_update_halo_kernel1_fr1*1);
      ACC<double> density1(xdim1_update_halo_kernel1_fr1, ydim1_update_halo_kernel1_fr1, &Accessor_density1[0] + base1 + n_x*1 + n_y * xdim1_update_halo_kernel1_fr1*1 + n_z * xdim1_update_halo_kernel1_fr1 * ydim1_update_halo_kernel1_fr1*1);
      ACC<double> energy0(xdim2_update_halo_kernel1_fr1, ydim2_update_halo_kernel1_fr1, &Accessor_energy0[0] + base2 + n_x*1 + n_y * xdim2_update_halo_kernel1_fr1*1 + n_z * xdim2_update_halo_kernel1_fr1 * ydim2_update_halo_kernel1_fr1*1);
      ACC<double> energy1(xdim3_update_halo_kernel1_fr1, ydim3_update_halo_kernel1_fr1, &Accessor_energy1[0] + base3 + n_x*1 + n_y * xdim3_update_halo_kernel1_fr1*1 + n_z * xdim3_update_halo_kernel1_fr1 * ydim3_update_halo_kernel1_fr1*1);
      ACC<double> pressure(xdim4_update_halo_kernel1_fr1, ydim4_update_halo_kernel1_fr1, &Accessor_pressure[0] + base4 + n_x*1 + n_y * xdim4_update_halo_kernel1_fr1*1 + n_z * xdim4_update_halo_kernel1_fr1 * ydim4_update_halo_kernel1_fr1*1);
      ACC<double> viscosity(xdim5_update_halo_kernel1_fr1, ydim5_update_halo_kernel1_fr1, &Accessor_viscosity[0] + base5 + n_x*1 + n_y * xdim5_update_halo_kernel1_fr1*1 + n_z * xdim5_update_halo_kernel1_fr1 * ydim5_update_halo_kernel1_fr1*1);
      ACC<double> soundspeed(xdim6_update_halo_kernel1_fr1, ydim6_update_halo_kernel1_fr1, &Accessor_soundspeed[0] + base6 + n_x*1 + n_y * xdim6_update_halo_kernel1_fr1*1 + n_z * xdim6_update_halo_kernel1_fr1 * ydim6_update_halo_kernel1_fr1*1);
