...
void ops_par_loop_advec_mom_kernel_mass_flux_y_execute(ops_kernel_descriptor *desc) {
  ...
  block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
    ...
    cgh.parallel_for<class advec_mom_kernel_mass_flux_y_kernel>(cl::sycl::nd_range<3>(cl::sycl::range<3>(
      ...
      ACC<double> node_flux(xdim0_advec_mom_kernel_mass_flux_y, ydim0_advec_mom_kernel_mass_flux_y, &Accessor_node_flux[0] + base0 + n_x*1 + n_y * xdim0_advec_mom_kernel_mass_flux_y*1 + n_z * xdim0_advec_mom_kernel_mass_flux_y * ydim0_advec_mom_kernel_mass_flux_y*1);
      const ACC<double> mass_flux_y(xdim1_advec_mom_kernel_mass_flux_y, ydim1_advec_mom_kernel_mass_flux_y, &Accessor_mass_flux_y[0] + base1 + n_x*1 + n_y * xdim1_advec_mom_kernel_mass_flux_y*1 + n_z * xdim1_advec_mom_kernel_mass_flux_y * ydim1_advec_mom_kernel_mass_flux_y*1);
      //USER CODE
