...
void ops_par_loop_update_halo_kernel5_plus_2_right_execute(ops_kernel_descriptor *desc) {
  ...
  block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
    ...
    cgh.parallel_for<class update_halo_kernel5_plus_2_right_kernel>(cl::sycl::nd_range<3>(cl::sycl::range<3>(
      ...
      ACC<double> vol_flux_z(xdim0_update_halo_kernel5_plus_2_right, ydim0_update_halo_kernel5_plus_2_right, &Accessor_vol_flux_z[0] + base0 + n_x*1 + n_y * xdim0_update_halo_kernel5_plus_2_right*1 + n_z * xdim0_update_halo_kernel5_plus_2_right * ydim0_update_halo_kernel5_plus_2_right*1);
      ACC<double> mass_flux_z(xdim1_update_halo_kernel5_plus_2_right, ydim1_update_halo_kernel5_plus_2_right, &Accessor_mass_flux_z[0] + base1 + n_x*1 + n_y * xdim1_update_halo_kernel5_plus_2_right*1 + n_z * xdim1_update_halo_kernel5_plus_2_right * ydim1_update_halo_kernel5_plus_2_right*1);
