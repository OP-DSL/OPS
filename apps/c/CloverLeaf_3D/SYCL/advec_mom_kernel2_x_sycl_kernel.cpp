...
void ops_par_loop_advec_mom_kernel2_x_execute(ops_kernel_descriptor *desc) {
  ...
  block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
    ...
    cgh.parallel_for<class advec_mom_kernel2_x_kernel>(cl::sycl::nd_range<3>(cl::sycl::range<3>(
      ...
      ACC<double> vel1(xdim0_advec_mom_kernel2_x, ydim0_advec_mom_kernel2_x, &Accessor_vel1[0] + base0 + n_x*1 + n_y * xdim0_advec_mom_kernel2_x*1 + n_z * xdim0_advec_mom_kernel2_x * ydim0_advec_mom_kernel2_x*1);
      const ACC<double> node_mass_post(xdim1_advec_mom_kernel2_x, ydim1_advec_mom_kernel2_x, &Accessor_node_mass_post[0] + base1 + n_x*1 + n_y * xdim1_advec_mom_kernel2_x*1 + n_z * xdim1_advec_mom_kernel2_x * ydim1_advec_mom_kernel2_x*1);
      const ACC<double> node_mass_pre(xdim2_advec_mom_kernel2_x, ydim2_advec_mom_kernel2_x, &Accessor_node_mass_pre[0] + base2 + n_x*1 + n_y * xdim2_advec_mom_kernel2_x*1 + n_z * xdim2_advec_mom_kernel2_x * ydim2_advec_mom_kernel2_x*1);
      const ACC<double> mom_flux(xdim3_advec_mom_kernel2_x, ydim3_advec_mom_kernel2_x, &Accessor_mom_flux[0] + base3 + n_x*1 + n_y * xdim3_advec_mom_kernel2_x*1 + n_z * xdim3_advec_mom_kernel2_x * ydim3_advec_mom_kernel2_x*1);
      //USER CODE
