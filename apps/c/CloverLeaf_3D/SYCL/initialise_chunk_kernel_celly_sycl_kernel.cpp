...
void ops_par_loop_initialise_chunk_kernel_celly_execute(ops_kernel_descriptor *desc) {
  ...
  cl::sycl::buffer<double,1> celldy_p = static_cast<cl::sycl::buffer<char,1> *>((void*)args[2].data_d)->reinterpret<double,1>(cl::sycl::range<1>(args[2].dat->mem/sizeof(double)));
  ...
  block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
    ...
    cgh.parallel_for<class initialise_chunk_kernel_celly_kernel>(cl::sycl::nd_range<3>(cl::sycl::range<3>(
      ...
      const ACC<double> vertexy(xdim0_initialise_chunk_kernel_celly, ydim0_initialise_chunk_kernel_celly, &Accessor_vertexy[0] + base0 + n_x*0 + n_y * xdim0_initialise_chunk_kernel_celly*1 + n_z * xdim0_initialise_chunk_kernel_celly * ydim0_initialise_chunk_kernel_celly*0);
      ACC<double> celly(xdim1_initialise_chunk_kernel_celly, ydim1_initialise_chunk_kernel_celly, &Accessor_celly[0] + base1 + n_x*0 + n_y * xdim1_initialise_chunk_kernel_celly*1 + n_z * xdim1_initialise_chunk_kernel_celly * ydim1_initialise_chunk_kernel_celly*0);
      ACC<double> celldy(xdim2_initialise_chunk_kernel_celly, ydim2_initialise_chunk_kernel_celly, &Accessor_celldy[0] + base2 + n_x*0 + n_y * xdim2_initialise_chunk_kernel_celly*1 + n_z * xdim2_initialise_chunk_kernel_celly * ydim2_initialise_chunk_kernel_celly*0);
      //USER CODE
      if (n_x < end_0 && n_y < end_1 && n_z < end_2) {
        
  double d_y = (grid_sycl[0].ymax - grid_sycl[0].ymin)/(double)grid_sycl[0].y_cells;
