...
void ops_par_loop_revert_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
    ...
    cgh.parallel_for<class revert_kernel_kernel>(cl::sycl::nd_range<3>(cl::sycl::range<3>(
      ...
      const ACC<double> density0(xdim0_revert_kernel, ydim0_revert_kernel, &Accessor_density0[0] + base0 + n_x*1 + n_y * xdim0_revert_kernel*1 + n_z * xdim0_revert_kernel * ydim0_revert_kernel*1);
      ACC<double> density1(xdim1_revert_kernel, ydim1_revert_kernel, &Accessor_density1[0] + base1 + n_x*1 + n_y * xdim1_revert_kernel*1 + n_z * xdim1_revert_kernel * ydim1_revert_kernel*1);
      const ACC<double> energy0(xdim2_revert_kernel, ydim2_revert_kernel, &Accessor_energy0[0] + base2 + n_x*1 + n_y * xdim2_revert_kernel*1 + n_z * xdim2_revert_kernel * ydim2_revert_kernel*1);
      ACC<double> energy1(xdim3_revert_kernel, ydim3_revert_kernel, &Accessor_energy1[0] + base3 + n_x*1 + n_y * xdim3_revert_kernel*1 + n_z * xdim3_revert_kernel * ydim3_revert_kernel*1);
      //USER CODE
