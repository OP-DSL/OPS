...
void ops_par_loop_advec_mom_kernel_x2_execute(ops_kernel_descriptor *desc) {
  ...
  cl::sycl::buffer<double,1> vol_flux_z_p = static_cast<cl::sycl::buffer<char,1> *>((void*)args[4].data_d)->reinterpret<double,1>(cl::sycl::range<1>(args[4].dat->mem/sizeof(double)));
  ...
  block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
    ...
    cgh.parallel_for<class advec_mom_kernel_x2_kernel>(cl::sycl::nd_range<3>(cl::sycl::range<3>(
      ...
      ACC<double> pre_vol(xdim0_advec_mom_kernel_x2, ydim0_advec_mom_kernel_x2, &Accessor_pre_vol[0] + base0 + n_x*1 + n_y * xdim0_advec_mom_kernel_x2*1 + n_z * xdim0_advec_mom_kernel_x2 * ydim0_advec_mom_kernel_x2*1);
      ACC<double> post_vol(xdim1_advec_mom_kernel_x2, ydim1_advec_mom_kernel_x2, &Accessor_post_vol[0] + base1 + n_x*1 + n_y * xdim1_advec_mom_kernel_x2*1 + n_z * xdim1_advec_mom_kernel_x2 * ydim1_advec_mom_kernel_x2*1);
      const ACC<double> volume(xdim2_advec_mom_kernel_x2, ydim2_advec_mom_kernel_x2, &Accessor_volume[0] + base2 + n_x*1 + n_y * xdim2_advec_mom_kernel_x2*1 + n_z * xdim2_advec_mom_kernel_x2 * ydim2_advec_mom_kernel_x2*1);
      const ACC<double> vol_flux_y(xdim3_advec_mom_kernel_x2, ydim3_advec_mom_kernel_x2, &Accessor_vol_flux_y[0] + base3 + n_x*1 + n_y * xdim3_advec_mom_kernel_x2*1 + n_z * xdim3_advec_mom_kernel_x2 * ydim3_advec_mom_kernel_x2*1);
      const ACC<double> vol_flux_z(xdim4_advec_mom_kernel_x2, ydim4_advec_mom_kernel_x2, &Accessor_vol_flux_z[0] + base4 + n_x*1 + n_y * xdim4_advec_mom_kernel_x2*1 + n_z * xdim4_advec_mom_kernel_x2 * ydim4_advec_mom_kernel_x2*1);
      //USER CODE
