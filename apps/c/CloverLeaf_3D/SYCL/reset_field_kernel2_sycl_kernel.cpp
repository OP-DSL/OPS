...
void ops_par_loop_reset_field_kernel2_execute(ops_kernel_descriptor *desc) {
 ...
 arg5};
  ...
  cl::sycl::buffer<double,1> xvel1_p = static_cast<cl::sycl::buffer<char,1> *>((void*)args[1].data_d)->reinterpret<double,1>(cl::sycl::range<1>(args[1].dat->mem/sizeof(double)));

  int base2 = args[2].dat->base_offset/sizeof(double);
  cl::sycl::buffer<double,1> yvel0_p = static_cast<cl::sycl::buffer<char,1> *>((void*)args[2].data_d)->reinterpret<double,1>(cl::sycl::range<1>(args[2].dat->mem/sizeof(double)));

  int base3 = args[3].dat->base_offset/sizeof(double);
  cl::sycl::buffer<double,1> yvel1_p = static_cast<cl::sycl::buffer<char,1> *>((void*)args[3].data_d)->reinterpret<double,1>(cl::sycl::range<1>(args[3].dat->mem/sizeof(double)));

  int base4 = args[4].dat->base_offset/sizeof(double);
  cl::sycl::buffer<double,1> zvel0_p = static_cast<cl::sycl::buffer<char,1> *>((void*)args[4].data_d)->reinterpret<double,1>(cl::sycl::range<1>(args[4].dat->mem/sizeof(double)));

  int base5 = args[5].dat->base_offset/sizeof(double);
  cl::sycl::buffer<double,1> zvel1_p = static_cast<cl::sycl::buffer<char,1> *>((void*)args[5].data_d)->reinterpret<double,1>(cl::sycl::range<1>(args[5].dat->mem/sizeof(double)));
  ...
  block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
    ...
    cgh.parallel_for<class reset_field_kernel2_kernel>(cl::sycl::nd_range<3>(cl::sycl::range<3>(
      ...
      ACC<double> xvel0(xdim0_reset_field_kernel2, ydim0_reset_field_kernel2, &Accessor_xvel0[0] + base0 + n_x*1 + n_y * xdim0_reset_field_kernel2*1 + n_z * xdim0_reset_field_kernel2 * ydim0_reset_field_kernel2*1);
      const ACC<double> xvel1(xdim1_reset_field_kernel2, ydim1_reset_field_kernel2, &Accessor_xvel1[0] + base1 + n_x*1 + n_y * xdim1_reset_field_kernel2*1 + n_z * xdim1_reset_field_kernel2 * ydim1_reset_field_kernel2*1);
      ACC<double> yvel0(xdim2_reset_field_kernel2, ydim2_reset_field_kernel2, &Accessor_yvel0[0] + base2 + n_x*1 + n_y * xdim2_reset_field_kernel2*1 + n_z * xdim2_reset_field_kernel2 * ydim2_reset_field_kernel2*1);
      const ACC<double> yvel1(xdim3_reset_field_kernel2, ydim3_reset_field_kernel2, &Accessor_yvel1[0] + base3 + n_x*1 + n_y * xdim3_reset_field_kernel2*1 + n_z * xdim3_reset_field_kernel2 * ydim3_reset_field_kernel2*1);
      ACC<double> zvel0(xdim4_reset_field_kernel2, ydim4_reset_field_kernel2, &Accessor_zvel0[0] + base4 + n_x*1 + n_y * xdim4_reset_field_kernel2*1 + n_z * xdim4_reset_field_kernel2 * ydim4_reset_field_kernel2*1);
      const ACC<double> zvel1(xdim5_reset_field_kernel2, ydim5_reset_field_kernel2, &Accessor_zvel1[0] + base5 + n_x*1 + n_y * xdim5_reset_field_kernel2*1 + n_z * xdim5_reset_field_kernel2 * ydim5_reset_field_kernel2*1);
      //USER CODE
