...
void ops_par_loop_advec_cell_kernel4_zdir_execute(ops_kernel_descriptor *desc) {
 ...
 arg10};
  ...
  cl::sycl::buffer<double,1> mass_flux_z_p = static_cast<cl::sycl::buffer<char,1> *>((void*)args[2].data_d)->reinterpret<double,1>(cl::sycl::range<1>(args[2].dat->mem/sizeof(double)));
  ...
  block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
    ...
    cgh.parallel_for<class advec_cell_kernel4_zdir_kernel>(cl::sycl::nd_range<3>(cl::sycl::range<3>(
      ...
      ACC<double> density1(xdim0_advec_cell_kernel4_zdir, ydim0_advec_cell_kernel4_zdir, &Accessor_density1[0] + base0 + n_x*1 + n_y * xdim0_advec_cell_kernel4_zdir*1 + n_z * xdim0_advec_cell_kernel4_zdir * ydim0_advec_cell_kernel4_zdir*1);
      ACC<double> energy1(xdim1_advec_cell_kernel4_zdir, ydim1_advec_cell_kernel4_zdir, &Accessor_energy1[0] + base1 + n_x*1 + n_y * xdim1_advec_cell_kernel4_zdir*1 + n_z * xdim1_advec_cell_kernel4_zdir * ydim1_advec_cell_kernel4_zdir*1);
      const ACC<double> mass_flux_z(xdim2_advec_cell_kernel4_zdir, ydim2_advec_cell_kernel4_zdir, &Accessor_mass_flux_z[0] + base2 + n_x*1 + n_y * xdim2_advec_cell_kernel4_zdir*1 + n_z * xdim2_advec_cell_kernel4_zdir * ydim2_advec_cell_kernel4_zdir*1);
      const ACC<double> vol_flux_z(xdim3_advec_cell_kernel4_zdir, ydim3_advec_cell_kernel4_zdir, &Accessor_vol_flux_z[0] + base3 + n_x*1 + n_y * xdim3_advec_cell_kernel4_zdir*1 + n_z * xdim3_advec_cell_kernel4_zdir * ydim3_advec_cell_kernel4_zdir*1);
      const ACC<double> pre_vol(xdim4_advec_cell_kernel4_zdir, ydim4_advec_cell_kernel4_zdir, &Accessor_pre_vol[0] + base4 + n_x*1 + n_y * xdim4_advec_cell_kernel4_zdir*1 + n_z * xdim4_advec_cell_kernel4_zdir * ydim4_advec_cell_kernel4_zdir*1);
      const ACC<double> post_vol(xdim5_advec_cell_kernel4_zdir, ydim5_advec_cell_kernel4_zdir, &Accessor_post_vol[0] + base5 + n_x*1 + n_y * xdim5_advec_cell_kernel4_zdir*1 + n_z * xdim5_advec_cell_kernel4_zdir * ydim5_advec_cell_kernel4_zdir*1);
      ACC<double> pre_mass(xdim6_advec_cell_kernel4_zdir, ydim6_advec_cell_kernel4_zdir, &Accessor_pre_mass[0] + base6 + n_x*1 + n_y * xdim6_advec_cell_kernel4_zdir*1 + n_z * xdim6_advec_cell_kernel4_zdir * ydim6_advec_cell_kernel4_zdir*1);
      ACC<double> post_mass(xdim7_advec_cell_kernel4_zdir, ydim7_advec_cell_kernel4_zdir, &Accessor_post_mass[0] + base7 + n_x*1 + n_y * xdim7_advec_cell_kernel4_zdir*1 + n_z * xdim7_advec_cell_kernel4_zdir * ydim7_advec_cell_kernel4_zdir*1);
      ACC<double> advec_vol(xdim8_advec_cell_kernel4_zdir, ydim8_advec_cell_kernel4_zdir, &Accessor_advec_vol[0] + base8 + n_x*1 + n_y * xdim8_advec_cell_kernel4_zdir*1 + n_z * xdim8_advec_cell_kernel4_zdir * ydim8_advec_cell_kernel4_zdir*1);
      ACC<double> post_ener(xdim9_advec_cell_kernel4_zdir, ydim9_advec_cell_kernel4_zdir, &Accessor_post_ener[0] + base9 + n_x*1 + n_y * xdim9_advec_cell_kernel4_zdir*1 + n_z * xdim9_advec_cell_kernel4_zdir * ydim9_advec_cell_kernel4_zdir*1);
      const ACC<double> ener_flux(xdim10_advec_cell_kernel4_zdir, ydim10_advec_cell_kernel4_zdir, &Accessor_ener_flux[0] + base10 + n_x*1 + n_y * xdim10_advec_cell_kernel4_zdir*1 + n_z * xdim10_advec_cell_kernel4_zdir * ydim10_advec_cell_kernel4_zdir*1);
      //USER CODE
