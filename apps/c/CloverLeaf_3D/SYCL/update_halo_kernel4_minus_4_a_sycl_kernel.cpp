...
void ops_par_loop_update_halo_kernel4_minus_4_a_execute(ops_kernel_descriptor *desc) {
  ...
  block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
    ...
    cgh.parallel_for<class update_halo_kernel4_minus_4_a_kernel>(cl::sycl::nd_range<3>(cl::sycl::range<3>(
      ...
      ACC<double> vol_flux_y(xdim0_update_halo_kernel4_minus_4_a, ydim0_update_halo_kernel4_minus_4_a, &Accessor_vol_flux_y[0] + base0 + n_x*1 + n_y * xdim0_update_halo_kernel4_minus_4_a*1 + n_z * xdim0_update_halo_kernel4_minus_4_a * ydim0_update_halo_kernel4_minus_4_a*1);
      ACC<double> mass_flux_y(xdim1_update_halo_kernel4_minus_4_a, ydim1_update_halo_kernel4_minus_4_a, &Accessor_mass_flux_y[0] + base1 + n_x*1 + n_y * xdim1_update_halo_kernel4_minus_4_a*1 + n_z * xdim1_update_halo_kernel4_minus_4_a * ydim1_update_halo_kernel4_minus_4_a*1);
