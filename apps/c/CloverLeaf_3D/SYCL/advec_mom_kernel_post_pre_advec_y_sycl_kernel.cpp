...
void ops_par_loop_advec_mom_kernel_post_pre_advec_y_execute(ops_kernel_descriptor *desc) {
  ...
  block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
    ...
    cgh.parallel_for<class advec_mom_kernel_post_pre_advec_y_kernel>(cl::sycl::nd_range<3>(cl::sycl::range<3>(
      ...
      ACC<double> node_mass_post(xdim0_advec_mom_kernel_post_pre_advec_y, ydim0_advec_mom_kernel_post_pre_advec_y, &Accessor_node_mass_post[0] + base0 + n_x*1 + n_y * xdim0_advec_mom_kernel_post_pre_advec_y*1 + n_z * xdim0_advec_mom_kernel_post_pre_advec_y * ydim0_advec_mom_kernel_post_pre_advec_y*1);
      const ACC<double> post_vol(xdim1_advec_mom_kernel_post_pre_advec_y, ydim1_advec_mom_kernel_post_pre_advec_y, &Accessor_post_vol[0] + base1 + n_x*1 + n_y * xdim1_advec_mom_kernel_post_pre_advec_y*1 + n_z * xdim1_advec_mom_kernel_post_pre_advec_y * ydim1_advec_mom_kernel_post_pre_advec_y*1);
      const ACC<double> density1(xdim2_advec_mom_kernel_post_pre_advec_y, ydim2_advec_mom_kernel_post_pre_advec_y, &Accessor_density1[0] + base2 + n_x*1 + n_y * xdim2_advec_mom_kernel_post_pre_advec_y*1 + n_z * xdim2_advec_mom_kernel_post_pre_advec_y * ydim2_advec_mom_kernel_post_pre_advec_y*1);
      ACC<double> node_mass_pre(xdim3_advec_mom_kernel_post_pre_advec_y, ydim3_advec_mom_kernel_post_pre_advec_y, &Accessor_node_mass_pre[0] + base3 + n_x*1 + n_y * xdim3_advec_mom_kernel_post_pre_advec_y*1 + n_z * xdim3_advec_mom_kernel_post_pre_advec_y * ydim3_advec_mom_kernel_post_pre_advec_y*1);
      const ACC<double> node_flux(xdim4_advec_mom_kernel_post_pre_advec_y, ydim4_advec_mom_kernel_post_pre_advec_y, &Accessor_node_flux[0] + base4 + n_x*1 + n_y * xdim4_advec_mom_kernel_post_pre_advec_y*1 + n_z * xdim4_advec_mom_kernel_post_pre_advec_y * ydim4_advec_mom_kernel_post_pre_advec_y*1);
      //USER CODE
