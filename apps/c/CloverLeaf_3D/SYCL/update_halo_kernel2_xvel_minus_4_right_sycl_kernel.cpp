...
void ops_par_loop_update_halo_kernel2_xvel_minus_4_right_execute(ops_kernel_descriptor *desc) {
  ...
  block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
    ...
    cgh.parallel_for<class update_halo_kernel2_xvel_minus_4_right_kernel>(cl::sycl::nd_range<3>(cl::sycl::range<3>(
      ...
      ACC<double> xvel0(xdim0_update_halo_kernel2_xvel_minus_4_right, ydim0_update_halo_kernel2_xvel_minus_4_right, &Accessor_xvel0[0] + base0 + n_x*1 + n_y * xdim0_update_halo_kernel2_xvel_minus_4_right*1 + n_z * xdim0_update_halo_kernel2_xvel_minus_4_right * ydim0_update_halo_kernel2_xvel_minus_4_right*1);
      ACC<double> xvel1(xdim1_update_halo_kernel2_xvel_minus_4_right, ydim1_update_halo_kernel2_xvel_minus_4_right, &Accessor_xvel1[0] + base1 + n_x*1 + n_y * xdim1_update_halo_kernel2_xvel_minus_4_right*1 + n_z * xdim1_update_halo_kernel2_xvel_minus_4_right * ydim1_update_halo_kernel2_xvel_minus_4_right*1);
