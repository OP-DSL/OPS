...
void ops_par_loop_reset_field_kernel1_execute(ops_kernel_descriptor *desc) {
  ...
  block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
    ...
    cgh.parallel_for<class reset_field_kernel1_kernel>(cl::sycl::nd_range<3>(cl::sycl::range<3>(
      ...
      ACC<double> density0(xdim0_reset_field_kernel1, ydim0_reset_field_kernel1, &Accessor_density0[0] + base0 + n_x*1 + n_y * xdim0_reset_field_kernel1*1 + n_z * xdim0_reset_field_kernel1 * ydim0_reset_field_kernel1*1);
      const ACC<double> density1(xdim1_reset_field_kernel1, ydim1_reset_field_kernel1, &Accessor_density1[0] + base1 + n_x*1 + n_y * xdim1_reset_field_kernel1*1 + n_z * xdim1_reset_field_kernel1 * ydim1_reset_field_kernel1*1);
      ACC<double> energy0(xdim2_reset_field_kernel1, ydim2_reset_field_kernel1, &Accessor_energy0[0] + base2 + n_x*1 + n_y * xdim2_reset_field_kernel1*1 + n_z * xdim2_reset_field_kernel1 * ydim2_reset_field_kernel1*1);
      const ACC<double> energy1(xdim3_reset_field_kernel1, ydim3_reset_field_kernel1, &Accessor_energy1[0] + base3 + n_x*1 + n_y * xdim3_reset_field_kernel1*1 + n_z * xdim3_reset_field_kernel1 * ydim3_reset_field_kernel1*1);
      //USER CODE
