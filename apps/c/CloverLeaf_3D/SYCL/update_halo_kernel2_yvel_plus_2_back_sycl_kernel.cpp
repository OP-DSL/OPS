...
void ops_par_loop_update_halo_kernel2_yvel_plus_2_back_execute(ops_kernel_descriptor *desc) {
  ...
  block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
    ...
    cgh.parallel_for<class update_halo_kernel2_yvel_plus_2_back_kernel>(cl::sycl::nd_range<3>(cl::sycl::range<3>(
      ...
      ACC<double> yvel0(xdim0_update_halo_kernel2_yvel_plus_2_back, ydim0_update_halo_kernel2_yvel_plus_2_back, &Accessor_yvel0[0] + base0 + n_x*1 + n_y * xdim0_update_halo_kernel2_yvel_plus_2_back*1 + n_z * xdim0_update_halo_kernel2_yvel_plus_2_back * ydim0_update_halo_kernel2_yvel_plus_2_back*1);
      ACC<double> yvel1(xdim1_update_halo_kernel2_yvel_plus_2_back, ydim1_update_halo_kernel2_yvel_plus_2_back, &Accessor_yvel1[0] + base1 + n_x*1 + n_y * xdim1_update_halo_kernel2_yvel_plus_2_back*1 + n_z * xdim1_update_halo_kernel2_yvel_plus_2_back * ydim1_update_halo_kernel2_yvel_plus_2_back*1);
