...
void ops_par_loop_initialise_chunk_kernel_cellx_execute(ops_kernel_descriptor *desc) {
  ...
  cl::sycl::buffer<double,1> cellx_p = static_cast<cl::sycl::buffer<char,1> *>((void*)args[1].data_d)->reinterpret<double,1>(cl::sycl::range<1>(args[1].dat->mem/sizeof(double)));
  ...
  block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
    ...
    cgh.parallel_for<class initialise_chunk_kernel_cellx_kernel>(cl::sycl::nd_range<3>(cl::sycl::range<3>(
      ...
      const ACC<double> vertexx(xdim0_initialise_chunk_kernel_cellx, ydim0_initialise_chunk_kernel_cellx, &Accessor_vertexx[0] + base0 + n_x*1 + n_y * xdim0_initialise_chunk_kernel_cellx*0 + n_z * xdim0_initialise_chunk_kernel_cellx * ydim0_initialise_chunk_kernel_cellx*0);
      ACC<double> cellx(xdim1_initialise_chunk_kernel_cellx, ydim1_initialise_chunk_kernel_cellx, &Accessor_cellx[0] + base1 + n_x*1 + n_y * xdim1_initialise_chunk_kernel_cellx*0 + n_z * xdim1_initialise_chunk_kernel_cellx * ydim1_initialise_chunk_kernel_cellx*0);
      ACC<double> celldx(xdim2_initialise_chunk_kernel_cellx, ydim2_initialise_chunk_kernel_cellx, &Accessor_celldx[0] + base2 + n_x*1 + n_y * xdim2_initialise_chunk_kernel_cellx*0 + n_z * xdim2_initialise_chunk_kernel_cellx * ydim2_initialise_chunk_kernel_cellx*0);
      //USER CODE
      if (n_x < end_0 && n_y < end_1 && n_z < end_2) {
        
  double d_x = (grid_sycl[0].xmax - grid_sycl[0].xmin)/(double)grid_sycl[0].x_cells;
