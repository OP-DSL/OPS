...
void ops_par_loop_initialise_chunk_kernel_xx_execute(ops_kernel_descriptor *desc) {
  ...
  cl::sycl::buffer<int,1> xx_p = static_cast<cl::sycl::buffer<char,1> *>((void*)args[0].data_d)->reinterpret<int,1>(cl::sycl::range<1>(args[0].dat->mem/sizeof(int)));
  ...
  block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
    ...
    cgh.parallel_for<class initialise_chunk_kernel_xx_kernel>(cl::sycl::nd_range<3>(cl::sycl::range<3>(
      ...
      ACC<int> xx(xdim0_initialise_chunk_kernel_xx, ydim0_initialise_chunk_kernel_xx, &Accessor_xx[0] + base0 + n_x*1 + n_y * xdim0_initialise_chunk_kernel_xx*0 + n_z * xdim0_initialise_chunk_kernel_xx * ydim0_initialise_chunk_kernel_xx*0);
      //USER CODE
