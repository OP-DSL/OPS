...
void buildOpenCLKernels_advec_cell_kernel4_xdir(
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts, "-cl-mad-enable -DOCL_FMA -I%s/c/include "
                           "-DOPS_WARPSIZE=%d  "
                           "-Dxdim0_advec_cell_kernel4_xdir=%d  "
                           "-Dydim0_advec_cell_kernel4_xdir=%d  "
                           "-Dxdim1_advec_cell_kernel4_xdir=%d  "
                           "-Dydim1_advec_cell_kernel4_xdir=%d  "
                           "-Dxdim2_advec_cell_kernel4_xdir=%d  "
                           "-Dydim2_advec_cell_kernel4_xdir=%d  "
                           "-Dxdim3_advec_cell_kernel4_xdir=%d  "
                           "-Dydim3_advec_cell_kernel4_xdir=%d  "
                           "-Dxdim4_advec_cell_kernel4_xdir=%d  "
                           "-Dydim4_advec_cell_kernel4_xdir=%d  "
                           "-Dxdim5_advec_cell_kernel4_xdir=%d  "
                           "-Dydim5_advec_cell_kernel4_xdir=%d  "
                           "-Dxdim6_advec_cell_kernel4_xdir=%d  "
                           "-Dydim6_advec_cell_kernel4_xdir=%d  "
                           "-Dxdim7_advec_cell_kernel4_xdir=%d  "
                           "-Dydim7_advec_cell_kernel4_xdir=%d  "
                           "-Dxdim8_advec_cell_kernel4_xdir=%d  "
                           "-Dydim8_advec_cell_kernel4_xdir=%d  "
                           "-Dxdim9_advec_cell_kernel4_xdir=%d  "
                           "-Dydim9_advec_cell_kernel4_xdir=%d  "
                           "-Dxdim10_advec_cell_kernel4_xdir=%d  "
                           "-Dydim10_advec_cell_kernel4_xdir=%d ",
