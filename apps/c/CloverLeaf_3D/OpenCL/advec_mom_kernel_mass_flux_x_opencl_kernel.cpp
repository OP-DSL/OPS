...
void buildOpenCLKernels_advec_mom_kernel_mass_flux_x(OPS_instance *instance,
                                                     int xdim0, int ydim0,
                                                     int xdim1, int ydim1) {
  ...
  if (!isbuilt_advec_mom_kernel_mass_flux_x) {
    ...
    instance->ostream() << "Compiling advec_mom_kernel_mass_flux_x " << OCL_FMA
                        << " source -- start \n";
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts,
                ...
                "-Dydim0_advec_mom_kernel_mass_flux_x=%d  "
                "-Dxdim1_advec_mom_kernel_mass_flux_x=%d  "
                "-Dydim1_advec_mom_kernel_mass_flux_x=%d ",
    ...
    instance->opencl_instance->OPS_opencl_core.kernel[127] =
        clCreateKernel(instance->opencl_instance->OPS_opencl_core.program,
                       "ops_advec_mom_kernel_mass_flux_x", &ret);
    clSafeCall(ret);
