...
void calc_dt_kernel_print(const ptr_double xvel0, const ptr_double yvel0,
                          const ptr_double zvel0, const ptr_double density0,
                          const ptr_double energy0, const ptr_double pressure,
                          const ptr_double soundspeed, double *output) {
...
__kernel void ops_calc_dt_kernel_print(
    ...
    __local double *scratch7, int r_bytes7, const int base0, const int base1,
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    const ptr_double ptr0 = {&arg0[base0 + idx_x * 1 * 1 +
                                   ...
                                   idx_z * 1 * 1 * xdim0_calc_dt_kernel_print *
    ...
    const ptr_double ptr3 = {&arg3[base3 + idx_x * 1 * 1 +
                                   ...
                                   idx_z * 1 * 1 * xdim3_calc_dt_kernel_print *
                                       ydim3_calc_dt_kernel_print],
                             xdim3_calc_dt_kernel_print,
                             ydim3_calc_dt_kernel_print};
    const ptr_double ptr4 = {&arg4[base4 + idx_x * 1 * 1 +
                                   idx_y * 1 * 1 * xdim4_calc_dt_kernel_print +
                                   idx_z * 1 * 1 * xdim4_calc_dt_kernel_print *
                                       ydim4_calc_dt_kernel_print],
                             xdim4_calc_dt_kernel_print,
                             ydim4_calc_dt_kernel_print};
    const ptr_double ptr5 = {&arg5[base5 + idx_x * 1 * 1 +
                                   idx_y * 1 * 1 * xdim5_calc_dt_kernel_print +
                                   idx_z * 1 * 1 * xdim5_calc_dt_kernel_print *
                                       ydim5_calc_dt_kernel_print],
                             xdim5_calc_dt_kernel_print,
                             ydim5_calc_dt_kernel_print};
    const ptr_double ptr6 = {&arg6[base6 + idx_x * 1 * 1 +
                                   idx_y * 1 * 1 * xdim6_calc_dt_kernel_print +
                                   idx_z * 1 * 1 * xdim6_calc_dt_kernel_print *
                                       ydim6_calc_dt_kernel_print],
                             xdim6_calc_dt_kernel_print,
                             ydim6_calc_dt_kernel_print};
    calc_dt_kernel_print(ptr0, ptr1, ptr2, ptr3, ptr4, ptr5, ptr6, arg7_l);
  }
