...
inline void advec_mom_kernel2_y(ptr_double vel1,
  ...
  OPS_ACCS(vel1, 0, 0, 0) =
      (OPS_ACCS(vel1, 0, 0, 0) * OPS_ACCS(node_mass_pre, 0, 0, 0) +
       OPS_ACCS(mom_flux, 0, -1, 0) - OPS_ACCS(mom_flux, 0, 0, 0)) /
...
__kernel void ops_advec_mom_kernel2_y(
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ptr_double ptr0 = {&arg0[base0 + idx_x * 1 * 1 +
                             idx_y * 1 * 1 * xdim0_advec_mom_kernel2_y +
                             idx_z * 1 * 1 * xdim0_advec_mom_kernel2_y *
                                 ydim0_advec_mom_kernel2_y],
                       xdim0_advec_mom_kernel2_y, ydim0_advec_mom_kernel2_y};
    const ptr_double ptr1 = {&arg1[base1 + idx_x * 1 * 1 +
                                   idx_y * 1 * 1 * xdim1_advec_mom_kernel2_y +
                                   idx_z * 1 * 1 * xdim1_advec_mom_kernel2_y *
                                       ydim1_advec_mom_kernel2_y],
                             xdim1_advec_mom_kernel2_y,
                             ydim1_advec_mom_kernel2_y};
    const ptr_double ptr2 = {&arg2[base2 + idx_x * 1 * 1 +
                                   idx_y * 1 * 1 * xdim2_advec_mom_kernel2_y +
                                   idx_z * 1 * 1 * xdim2_advec_mom_kernel2_y *
                                       ydim2_advec_mom_kernel2_y],
                             xdim2_advec_mom_kernel2_y,
                             ydim2_advec_mom_kernel2_y};
    const ptr_double ptr3 = {&arg3[base3 + idx_x * 1 * 1 +
                                   idx_y * 1 * 1 * xdim3_advec_mom_kernel2_y +
                                   idx_z * 1 * 1 * xdim3_advec_mom_kernel2_y *
                                       ydim3_advec_mom_kernel2_y],
