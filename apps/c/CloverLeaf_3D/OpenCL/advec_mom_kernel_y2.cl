...
__kernel void ops_advec_mom_kernel_y2(
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ptr_double ptr0 = {&arg0[base0 + idx_x * 1 * 1 +
                             idx_y * 1 * 1 * xdim0_advec_mom_kernel_y2 +
                             idx_z * 1 * 1 * xdim0_advec_mom_kernel_y2 *
                                 ydim0_advec_mom_kernel_y2],
                       xdim0_advec_mom_kernel_y2, ydim0_advec_mom_kernel_y2};
    ptr_double ptr1 = {&arg1[base1 + idx_x * 1 * 1 +
                             idx_y * 1 * 1 * xdim1_advec_mom_kernel_y2 +
                             idx_z * 1 * 1 * xdim1_advec_mom_kernel_y2 *
                                 ydim1_advec_mom_kernel_y2],
                       xdim1_advec_mom_kernel_y2, ydim1_advec_mom_kernel_y2};
    const ptr_double ptr2 = {&arg2[base2 + idx_x * 1 * 1 +
                                   idx_y * 1 * 1 * xdim2_advec_mom_kernel_y2 +
                                   idx_z * 1 * 1 * xdim2_advec_mom_kernel_y2 *
                                       ydim2_advec_mom_kernel_y2],
                             xdim2_advec_mom_kernel_y2,
                             ydim2_advec_mom_kernel_y2};
    const ptr_double ptr3 = {&arg3[base3 + idx_x * 1 * 1 +
                                   idx_y * 1 * 1 * xdim3_advec_mom_kernel_y2 +
                                   idx_z * 1 * 1 * xdim3_advec_mom_kernel_y2 *
                                       ydim3_advec_mom_kernel_y2],
                             xdim3_advec_mom_kernel_y2,
                             ydim3_advec_mom_kernel_y2};
    const ptr_double ptr4 = {&arg4[base4 + idx_x * 1 * 1 +
                                   idx_y * 1 * 1 * xdim4_advec_mom_kernel_y2 +
                                   idx_z * 1 * 1 * xdim4_advec_mom_kernel_y2 *
                                       ydim4_advec_mom_kernel_y2],
                             xdim4_advec_mom_kernel_y2,
                             ydim4_advec_mom_kernel_y2};
