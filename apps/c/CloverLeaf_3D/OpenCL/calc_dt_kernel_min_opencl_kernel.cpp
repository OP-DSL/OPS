...
void buildOpenCLKernels_calc_dt_kernel_min(int xdim0, int ydim0) {
  ...
  if(!isbuilt_calc_dt_kernel_min) {
    ...
    OPS_opencl_core.kernel[99] = clCreateKernel(OPS_opencl_core.program, "ops_calc_dt_kernel_min", &ret);
    clSafeCall( ret );
...
void ops_par_loop_calc_dt_kernel_min(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[99], 2, nthread*sizeof(double), NULL));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[99], 3, sizeof(cl_int), (void*) &r_bytes1 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[99], 4, sizeof(cl_int), (void*) &base0 ));
