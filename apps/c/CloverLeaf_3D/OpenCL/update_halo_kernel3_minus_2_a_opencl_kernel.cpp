...
void buildOpenCLKernels_update_halo_kernel3_minus_2_a(int xdim0, int ydim0, int xdim1, int ydim1) {
  ...
  if(!isbuilt_update_halo_kernel3_minus_2_a) {
    ...
    OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[65] = clCreateKernel(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.program, "ops_update_halo_kernel3_minus_2_a", &ret);
    clSafeCall( ret );
