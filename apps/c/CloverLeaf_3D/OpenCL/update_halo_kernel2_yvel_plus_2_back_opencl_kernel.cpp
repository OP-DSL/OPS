...
void buildOpenCLKernels_update_halo_kernel2_yvel_plus_2_back(
  ...
  if (!isbuilt_update_halo_kernel2_yvel_plus_2_back) {
    ...
    instance->ostream() << "Compiling update_halo_kernel2_yvel_plus_2_back "
    ...
    instance->ostream()
        << "compiling update_halo_kernel2_yvel_plus_2_back -- done\n";
