...
void buildOpenCLKernels_update_halo_kernel5_plus_4_left(OPS_instance *instance,
                                                        int xdim0, int ydim0,
                                                        int xdim1, int ydim1) {
  ...
  if (!isbuilt_update_halo_kernel5_plus_4_left) {
    ...
    instance->ostream() << "Compiling update_halo_kernel5_plus_4_left "
