...
=======
  if (!ops_checkpointing_before(args, 8, range, 19))
>>>>>>> 3f8b285... Regenerating files to resolve conflicts
    return;
  #endif
...
<<<<<<< HEAD
    ...
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[64], 6, sizeof(cl_mem),
                              (void *)&arg6.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[64], 7, sizeof(cl_mem),
                              (void *)&arg7.data_d));
...
=======
    ...
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[19], 6, sizeof(cl_mem),
                              (void *)&arg6.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[19], 7, sizeof(cl_mem),
                              (void *)&arg7.data_d));
    ...
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[19], 14, sizeof(cl_int),
                              (void *)&base6));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[19], 15, sizeof(cl_int),
                              (void *)&x_size));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[19], 16, sizeof(cl_int),
                              (void *)&y_size));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[19], 17, sizeof(cl_int),
>>>>>>> 3f8b285... Regenerating files to resolve conflicts
                              (void *)&z_size));
