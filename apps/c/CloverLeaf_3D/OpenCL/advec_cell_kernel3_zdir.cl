...
advec_cell_kernel3_zdir(const ptr_double vol_flux_z, const ptr_double pre_vol,
  ...
  sigma3 = (1.0 + sigmat) *
           (OPS_ACCS(vertexdz, 0, 0, 0) / OPS_ACCS(vertexdz, 0, 0, dif));
  sigma4 = 2.0 - sigmat;
  ...
  OPS_ACCS(mass_flux_z, 0, 0, 0) = OPS_ACCS(vol_flux_z, 0, 0, 0) *
                                   (OPS_ACCS(density1, 0, 0, donor) + limiter);

  sigmam = fabs(OPS_ACCS(mass_flux_z, 0, 0, 0)) /
           (OPS_ACCS(density1, 0, 0, donor) * OPS_ACCS(pre_vol, 0, 0, donor));
  ...
  OPS_ACCS(ener_flux, 0, 0, 0) = OPS_ACCS(mass_flux_z, 0, 0, 0) *
                                 (OPS_ACCS(energy1, 0, 0, donor) + limiter);
}
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    const ptr_double ptr0 = {
        &arg0[base0 + idx_x * 1 * 1 +
              idx_y * 1 * 1 * xdim0_advec_cell_kernel3_zdir +
    ...
    const ptr_double ptr1 = {
        &arg1[base1 + idx_x * 1 * 1 +
              idx_y * 1 * 1 * xdim1_advec_cell_kernel3_zdir +
    ...
    const ptr_double ptr4 = {
        &arg4[base4 + idx_x * 1 * 1 +
              idx_y * 1 * 1 * xdim4_advec_cell_kernel3_zdir +
    ...
    const ptr_double ptr5 = {
        &arg5[base5 + idx_x * 1 * 1 +
              idx_y * 1 * 1 * xdim5_advec_cell_kernel3_zdir +
