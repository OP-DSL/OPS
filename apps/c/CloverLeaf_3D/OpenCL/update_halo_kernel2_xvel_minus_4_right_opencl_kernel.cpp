...
=======
  if (!ops_checkpointing_before(args, 3, range, 30))
>>>>>>> 3f8b285... Regenerating files to resolve conflicts
    return;
  #endif
...
<<<<<<< HEAD
    ...
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[75], 1, sizeof(cl_mem),
                              (void *)&arg1.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[75], 2, sizeof(cl_mem),
                              (void *)&arg2.data_d));
...
=======
    ...
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[30], 2, sizeof(cl_mem),
                              (void *)&arg2.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[30], 3, sizeof(cl_int),
                              (void *)&base0));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[30], 4, sizeof(cl_int),
                              (void *)&base1));
