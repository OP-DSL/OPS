...
void buildOpenCLKernels() {
  ...
  if(!isbuilt) {
    ...
    OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.n_kernels = 141;
    OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel = (cl_kernel*) malloc(141*sizeof(cl_kernel));
  }
  isbuilt = true;
}
