...
void buildOpenCLKernels_calc_dt_kernel_get(int xdim0, int ydim0, int xdim1, int ydim1, int xdim4, int ydim4) {
  ...
  if(!isbuilt_calc_dt_kernel_get) {
    ...
    OPS_opencl_core.kernel[100] = clCreateKernel(OPS_opencl_core.program, "ops_calc_dt_kernel_get", &ret);
    clSafeCall( ret );
...
void ops_par_loop_calc_dt_kernel_get(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5) {
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[100], 3, nthread*sizeof(double), NULL));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[100], 4, sizeof(cl_int), (void*) &r_bytes2 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[100], 5, sizeof(cl_mem), (void*) &arg3.data_d ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[100], 6, nthread*sizeof(double), NULL));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[100], 7, sizeof(cl_int), (void*) &r_bytes3 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[100], 8, sizeof(cl_mem), (void*) &arg4.data_d ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[100], 9, sizeof(cl_mem), (void*) &arg5.data_d ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[100], 10, nthread*sizeof(double), NULL));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[100], 11, sizeof(cl_int), (void*) &r_bytes5 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[100], 12, sizeof(cl_int), (void*) &base0 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[100], 13, sizeof(cl_int), (void*) &base1 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[100], 14, sizeof(cl_int), (void*) &base4 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[100], 15, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[100], 16, sizeof(cl_int), (void*) &y_size ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[100], 17, sizeof(cl_int), (void*) &z_size ));
