...
void buildOpenCLKernels_update_halo_kernel4_plus_2_b(int xdim0, int ydim0, int xdim1, int ydim1) {
  ...
  if(!isbuilt_update_halo_kernel4_plus_2_b) {
    ...
    OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[79] = clCreateKernel(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.program, "ops_update_halo_kernel4_plus_2_b", &ret);
    clSafeCall( ret );
