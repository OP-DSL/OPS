...
void buildOpenCLKernels_advec_mom_kernel2_x(OPS_instance *instance, int xdim0,
  ...
  if (!isbuilt_advec_mom_kernel2_x) {
    ...
    instance->ostream() << "Compiling advec_mom_kernel2_x " << OCL_FMA
                        << " source -- start \n";
    ...
    instance->opencl_instance->OPS_opencl_core.kernel[130] =
        clCreateKernel(instance->opencl_instance->OPS_opencl_core.program,
                       "ops_advec_mom_kernel2_x", &ret);
    clSafeCall(ret);
