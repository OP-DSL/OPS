...
inline void
update_halo_kernel3_plus_2_front(ptr_double vol_flux_x, ptr_double mass_flux_x,
                                 const __global int *restrict fields) {
  if (fields[FIELD_VOL_FLUX_X] == 1)
    OPS_ACCS(vol_flux_x, 0, 0, 0) = OPS_ACCS(vol_flux_x, 0, 0, -2);
  if (fields[FIELD_MASS_FLUX_X] == 1)
    OPS_ACCS(mass_flux_x, 0, 0, 0) = OPS_ACCS(mass_flux_x, 0, 0, -2);
}
...
__kernel void ops_update_halo_kernel3_plus_2_front(
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ...
    ptr_double ptr1 = {
        ...
        ydim1_update_halo_kernel3_plus_2_front};
    update_halo_kernel3_plus_2_front(ptr0, ptr1, arg2);
  }
}
