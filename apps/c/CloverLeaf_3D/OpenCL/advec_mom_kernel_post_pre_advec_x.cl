...
inline void advec_mom_kernel_post_pre_advec_x(ptr_double node_mass_post,
  ...
  OPS_ACCS(node_mass_post, 0, 0, 0) =
      0.125 * (OPS_ACCS(density1, 0, -1, 0) * OPS_ACCS(post_vol, 0, -1, 0) +
  ...
  OPS_ACCS(node_mass_pre, 0, 0, 0) = OPS_ACCS(node_mass_post, 0, 0, 0) -
                                     OPS_ACCS(node_flux, -1, 0, 0) +
