...
void buildOpenCLKernels_update_halo_kernel2_xvel_minus_4_left(
  ...
  if (!isbuilt_update_halo_kernel2_xvel_minus_4_left) {
    ...
    instance->ostream() << "Compiling update_halo_kernel2_xvel_minus_4_left "
    ...
    instance->ostream()
        << "compiling update_halo_kernel2_xvel_minus_4_left -- done\n";
