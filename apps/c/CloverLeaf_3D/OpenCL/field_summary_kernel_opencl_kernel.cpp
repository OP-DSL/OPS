...
void buildOpenCLKernels_field_summary_kernel(int xdim0, int ydim0, int xdim1,
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(
            ...
            "-Dxdim0_field_summary_kernel=%d  -Dydim0_field_summary_kernel=%d  "
            "-Dxdim1_field_summary_kernel=%d  -Dydim1_field_summary_kernel=%d  "
            "-Dxdim2_field_summary_kernel=%d  -Dydim2_field_summary_kernel=%d  "
            "-Dxdim3_field_summary_kernel=%d  -Dydim3_field_summary_kernel=%d  "
            "-Dxdim4_field_summary_kernel=%d  -Dydim4_field_summary_kernel=%d  "
            "-Dxdim5_field_summary_kernel=%d  -Dydim5_field_summary_kernel=%d  "
            "-Dxdim6_field_summary_kernel=%d  -Dydim6_field_summary_kernel=%d ",
...
void ops_par_loop_field_summary_kernel(char const *name, ops_block block,
  ...
  buildOpenCLKernels_field_summary_kernel(xdim0, ydim0, xdim1, ydim1, xdim2,
