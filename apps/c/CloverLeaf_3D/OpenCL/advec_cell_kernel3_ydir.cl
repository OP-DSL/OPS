...
advec_cell_kernel3_ydir(const ptr_double vol_flux_y, const ptr_double pre_vol,
  ...
  sigma3 = (1.0 + sigmat) *
           (OPS_ACCS(vertexdy, 0, 0, 0) / OPS_ACCS(vertexdy, 0, dif, 0));
  sigma4 = 2.0 - sigmat;
  ...
  OPS_ACCS(mass_flux_y, 0, 0, 0) = (OPS_ACCS(vol_flux_y, 0, 0, 0)) *
                                   (OPS_ACCS(density1, 0, donor, 0) + limiter);

  sigmam = fabs(OPS_ACCS(mass_flux_y, 0, 0, 0)) /
           (OPS_ACCS(density1, 0, donor, 0) * OPS_ACCS(pre_vol, 0, donor, 0));
  ...
  OPS_ACCS(ener_flux, 0, 0, 0) = OPS_ACCS(mass_flux_y, 0, 0, 0) *
                                 (OPS_ACCS(energy1, 0, donor, 0) + limiter);
}
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    const ptr_double ptr0 = {
        &arg0[base0 + idx_x * 1 * 1 +
              ...
              idx_z * 1 * 1 * xdim0_advec_cell_kernel3_ydir *
    ...
    const ptr_double ptr3 = {
        &arg3[base3 + idx_x * 0 * 1 +
              ...
              idx_z * 0 * 1 * xdim3_advec_cell_kernel3_ydir *
    ...
    const ptr_double ptr4 = {
        &arg4[base4 + idx_x * 1 * 1 +
              ...
              idx_z * 1 * 1 * xdim4_advec_cell_kernel3_ydir *
    ...
    ptr_double ptr6 = {&arg6[base6 + idx_x * 1 * 1 +
                             ...
                             idx_z * 1 * 1 * xdim6_advec_cell_kernel3_ydir *
    ...
    ptr_double ptr7 = {&arg7[base7 + idx_x * 1 * 1 +
                             ...
                             idx_z * 1 * 1 * xdim7_advec_cell_kernel3_ydir *
