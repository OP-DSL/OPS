...
void buildOpenCLKernels_advec_mom_kernel_z1(OPS_instance *instance, int xdim0,
  ...
  if (!isbuilt_advec_mom_kernel_z1) {
    ...
    instance->ostream() << "Compiling advec_mom_kernel_z1 " << OCL_FMA
                        << " source -- start \n";
