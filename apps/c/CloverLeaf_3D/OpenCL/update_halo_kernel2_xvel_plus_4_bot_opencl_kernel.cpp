...
void buildOpenCLKernels_update_halo_kernel2_xvel_plus_4_bot(
  ...
  if (!isbuilt_update_halo_kernel2_xvel_plus_4_bot) {
    ...
    instance->ostream() << "Compiling update_halo_kernel2_xvel_plus_4_bot "
    ...
    instance->ostream()
        << "compiling update_halo_kernel2_xvel_plus_4_bot -- done\n";
