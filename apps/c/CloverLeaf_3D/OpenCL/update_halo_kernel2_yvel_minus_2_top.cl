...
inline void
update_halo_kernel2_yvel_minus_2_top(ptr_double yvel0, ptr_double yvel1,
                                     const __global int *restrict fields) {
  if (fields[FIELD_YVEL0] == 1)
    OPS_ACCS(yvel0, 0, 0, 0) = -OPS_ACCS(yvel0, 0, -2, 0);
  if (fields[FIELD_YVEL1] == 1)
    OPS_ACCS(yvel1, 0, 0, 0) = -OPS_ACCS(yvel1, 0, -2, 0);
}
...
__kernel void ops_update_halo_kernel2_yvel_minus_2_top(
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ...
    ptr_double ptr1 = {
        ...
        ydim1_update_halo_kernel2_yvel_minus_2_top};
    update_halo_kernel2_yvel_minus_2_top(ptr0, ptr1, arg2);
  }
}
