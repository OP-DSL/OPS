...
void buildOpenCLKernels_advec_cell_kernel3_ydir(int xdim0, int ydim0, int xdim1,
                                                int ydim1, int xdim2, int ydim2,
                                                int xdim3, int ydim3, int xdim4,
                                                int ydim4, int xdim5, int ydim5,
                                                int xdim6, int ydim6, int xdim7,
                                                int ydim7) {
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts, "-cl-mad-enable -DOCL_FMA -I%s/c/include "
                           "-DOPS_WARPSIZE=%d  "
                           "-Dxdim0_advec_cell_kernel3_ydir=%d  "
                           "-Dydim0_advec_cell_kernel3_ydir=%d  "
                           "-Dxdim1_advec_cell_kernel3_ydir=%d  "
                           "-Dydim1_advec_cell_kernel3_ydir=%d  "
                           "-Dxdim2_advec_cell_kernel3_ydir=%d  "
                           "-Dydim2_advec_cell_kernel3_ydir=%d  "
                           "-Dxdim3_advec_cell_kernel3_ydir=%d  "
                           "-Dydim3_advec_cell_kernel3_ydir=%d  "
                           "-Dxdim4_advec_cell_kernel3_ydir=%d  "
                           "-Dydim4_advec_cell_kernel3_ydir=%d  "
                           "-Dxdim5_advec_cell_kernel3_ydir=%d  "
                           "-Dydim5_advec_cell_kernel3_ydir=%d  "
                           "-Dxdim6_advec_cell_kernel3_ydir=%d  "
                           "-Dydim6_advec_cell_kernel3_ydir=%d  "
                           "-Dxdim7_advec_cell_kernel3_ydir=%d  "
                           "-Dydim7_advec_cell_kernel3_ydir=%d ",
...
void ops_par_loop_advec_cell_kernel3_ydir(char const *name, ops_block block,
  ...
  buildOpenCLKernels_advec_cell_kernel3_ydir(
      ...
      xdim5, ydim5, xdim6, ydim6, xdim7, ydim7);
