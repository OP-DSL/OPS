...
void buildOpenCLKernels_flux_calc_kernelz(int xdim0, int ydim0, int xdim1,
  ...
  if (!isbuilt_flux_calc_kernelz) {
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts,
                ...
                "-Dxdim0_flux_calc_kernelz=%d  -Dydim0_flux_calc_kernelz=%d  "
                "-Dxdim1_flux_calc_kernelz=%d  -Dydim1_flux_calc_kernelz=%d  "
                "-Dxdim2_flux_calc_kernelz=%d  -Dydim2_flux_calc_kernelz=%d  "
                "-Dxdim3_flux_calc_kernelz=%d  -Dydim3_flux_calc_kernelz=%d ",
    ...
    OPS_opencl_core.kernel[44] =
        clCreateKernel(OPS_opencl_core.program, "ops_flux_calc_kernelz", &ret);
    clSafeCall(ret);
...
void ops_par_loop_flux_calc_kernelz(char const *name, ops_block block, int dim,
  ...
  buildOpenCLKernels_flux_calc_kernelz(xdim0, ydim0, xdim1, ydim1, xdim2, ydim2,
                                       xdim3, ydim3);
