...
void buildOpenCLKernels_update_halo_kernel2_zvel_plus_2_bot(
  ...
  if (!isbuilt_update_halo_kernel2_zvel_plus_2_bot) {
    ...
    instance->ostream() << "Compiling update_halo_kernel2_zvel_plus_2_bot "
    ...
    instance->ostream()
        << "compiling update_halo_kernel2_zvel_plus_2_bot -- done\n";
