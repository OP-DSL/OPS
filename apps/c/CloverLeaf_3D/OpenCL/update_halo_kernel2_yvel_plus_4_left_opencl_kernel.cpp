...
void buildOpenCLKernels_update_halo_kernel2_yvel_plus_4_left(int xdim0, int ydim0, int xdim1, int ydim1) {
  ...
  if(!isbuilt_update_halo_kernel2_yvel_plus_4_left) {
    ...
    OPS_opencl_core.kernel[40] = clCreateKernel(OPS_opencl_core.program, "ops_update_halo_kernel2_yvel_plus_4_left", &ret);
    clSafeCall( ret );
 ...
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  if (globalWorkSize[0] > 0 && globalWorkSize[1] > 0 && globalWorkSize[2] > 0) {
    ...
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[40], 2, sizeof(cl_mem),
                              (void *)&arg2.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[40], 3, sizeof(cl_int),
                              (void *)&base0));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[40], 4, sizeof(cl_int),
                              (void *)&base1));
