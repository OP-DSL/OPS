...
void buildOpenCLKernels_flux_calc_kernelx(int xdim0, int ydim0, int xdim1,
  ...
  if (!isbuilt_flux_calc_kernelx) {
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts,
                ...
                "-Dxdim0_flux_calc_kernelx=%d  -Dydim0_flux_calc_kernelx=%d  "
                "-Dxdim1_flux_calc_kernelx=%d  -Dydim1_flux_calc_kernelx=%d  "
                "-Dxdim2_flux_calc_kernelx=%d  -Dydim2_flux_calc_kernelx=%d  "
                "-Dxdim3_flux_calc_kernelx=%d  -Dydim3_flux_calc_kernelx=%d ",
    ...
    OPS_opencl_core.kernel[42] =
        clCreateKernel(OPS_opencl_core.program, "ops_flux_calc_kernelx", &ret);
    clSafeCall(ret);
...
void ops_par_loop_flux_calc_kernelx(char const *name, ops_block block, int dim,
  ...
  buildOpenCLKernels_flux_calc_kernelx(xdim0, ydim0, xdim1, ydim1, xdim2, ydim2,
                                       xdim3, ydim3);
