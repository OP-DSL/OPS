...
__kernel void ops_PdV_kernel_predict(
    ...
    __global const double *restrict arg10, __global double *restrict arg11,
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    const ptr_double ptr0 = {
        &arg0[base0 + idx_x * 1 * 1 + idx_y * 1 * 1 * xdim0_PdV_kernel_predict +
              idx_z * 1 * 1 * xdim0_PdV_kernel_predict *
                  ydim0_PdV_kernel_predict],
        xdim0_PdV_kernel_predict, ydim0_PdV_kernel_predict};
    const ptr_double ptr1 = {
        &arg1[base1 + idx_x * 1 * 1 + idx_y * 1 * 1 * xdim1_PdV_kernel_predict +
              idx_z * 1 * 1 * xdim1_PdV_kernel_predict *
                  ydim1_PdV_kernel_predict],
        xdim1_PdV_kernel_predict, ydim1_PdV_kernel_predict};
    const ptr_double ptr2 = {
        &arg2[base2 + idx_x * 1 * 1 + idx_y * 1 * 1 * xdim2_PdV_kernel_predict +
              idx_z * 1 * 1 * xdim2_PdV_kernel_predict *
                  ydim2_PdV_kernel_predict],
        xdim2_PdV_kernel_predict, ydim2_PdV_kernel_predict};
    const ptr_double ptr3 = {
        &arg3[base3 + idx_x * 1 * 1 + idx_y * 1 * 1 * xdim3_PdV_kernel_predict +
              idx_z * 1 * 1 * xdim3_PdV_kernel_predict *
                  ydim3_PdV_kernel_predict],
        xdim3_PdV_kernel_predict, ydim3_PdV_kernel_predict};
    ptr_double ptr4 = {
        &arg4[base4 + idx_x * 1 * 1 + idx_y * 1 * 1 * xdim4_PdV_kernel_predict +
              idx_z * 1 * 1 * xdim4_PdV_kernel_predict *
                  ydim4_PdV_kernel_predict],
        xdim4_PdV_kernel_predict, ydim4_PdV_kernel_predict};
    const ptr_double ptr5 = {
        &arg5[base5 + idx_x * 1 * 1 + idx_y * 1 * 1 * xdim5_PdV_kernel_predict +
              idx_z * 1 * 1 * xdim5_PdV_kernel_predict *
                  ydim5_PdV_kernel_predict],
        xdim5_PdV_kernel_predict, ydim5_PdV_kernel_predict};
    const ptr_double ptr6 = {
        &arg6[base6 + idx_x * 1 * 1 + idx_y * 1 * 1 * xdim6_PdV_kernel_predict +
              idx_z * 1 * 1 * xdim6_PdV_kernel_predict *
                  ydim6_PdV_kernel_predict],
        xdim6_PdV_kernel_predict, ydim6_PdV_kernel_predict};
    const ptr_double ptr7 = {
        &arg7[base7 + idx_x * 1 * 1 + idx_y * 1 * 1 * xdim7_PdV_kernel_predict +
              idx_z * 1 * 1 * xdim7_PdV_kernel_predict *
                  ydim7_PdV_kernel_predict],
        xdim7_PdV_kernel_predict, ydim7_PdV_kernel_predict};
    ptr_double ptr8 = {
        &arg8[base8 + idx_x * 1 * 1 + idx_y * 1 * 1 * xdim8_PdV_kernel_predict +
              idx_z * 1 * 1 * xdim8_PdV_kernel_predict *
                  ydim8_PdV_kernel_predict],
        xdim8_PdV_kernel_predict, ydim8_PdV_kernel_predict};
    const ptr_double ptr9 = {
        &arg9[base9 + idx_x * 1 * 1 + idx_y * 1 * 1 * xdim9_PdV_kernel_predict +
              idx_z * 1 * 1 * xdim9_PdV_kernel_predict *
                  ydim9_PdV_kernel_predict],
        xdim9_PdV_kernel_predict, ydim9_PdV_kernel_predict};
    const ptr_double ptr10 = {&arg10[base10 + idx_x * 1 * 1 +
                                     idx_y * 1 * 1 * xdim10_PdV_kernel_predict +
                                     idx_z * 1 * 1 * xdim10_PdV_kernel_predict *
                                         ydim10_PdV_kernel_predict],
                              xdim10_PdV_kernel_predict,
                              ydim10_PdV_kernel_predict};
    ptr_double ptr11 = {&arg11[base11 + idx_x * 1 * 1 +
                               idx_y * 1 * 1 * xdim11_PdV_kernel_predict +
                               idx_z * 1 * 1 * xdim11_PdV_kernel_predict *
                                   ydim11_PdV_kernel_predict],
                        xdim11_PdV_kernel_predict, ydim11_PdV_kernel_predict};
    const ptr_double ptr12 = {&arg12[base12 + idx_x * 1 * 1 +
                                     idx_y * 1 * 1 * xdim12_PdV_kernel_predict +
                                     idx_z * 1 * 1 * xdim12_PdV_kernel_predict *
                                         ydim12_PdV_kernel_predict],
                              xdim12_PdV_kernel_predict,
                              ydim12_PdV_kernel_predict};
    const ptr_double ptr13 = {&arg13[base13 + idx_x * 1 * 1 +
                                     idx_y * 1 * 1 * xdim13_PdV_kernel_predict +
                                     idx_z * 1 * 1 * xdim13_PdV_kernel_predict *
                                         ydim13_PdV_kernel_predict],
                              xdim13_PdV_kernel_predict,
                              ydim13_PdV_kernel_predict};
