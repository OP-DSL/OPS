...
<<<<<<< HEAD
      OPS_opencl_core.kernel[37] =
=======
      OPS_opencl_core.kernel[98] =
>>>>>>> 3f8b285... Regenerating files to resolve conflicts
          clCreateKernel(OPS_opencl_core.program, "ops_calc_dt_kernel", &ret);
      clSafeCall(ret);
...
=======
  if (!ops_checkpointing_before(args, 14, range, 98))
>>>>>>> 3f8b285... Regenerating files to resolve conflicts
    return;
  #endif
...
<<<<<<< HEAD
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[37], 0, sizeof(cl_mem),
                              (void *)&arg0.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[37], 1, sizeof(cl_mem),
                              (void *)&arg1.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[37], 2, sizeof(cl_mem),
                              (void *)&arg2.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[37], 3, sizeof(cl_mem),
                              (void *)&arg3.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[37], 4, sizeof(cl_mem),
                              (void *)&arg4.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[37], 5, sizeof(cl_mem),
                              (void *)&arg5.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[37], 6, sizeof(cl_mem),
                              (void *)&arg6.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[37], 7, sizeof(cl_mem),
                              (void *)&arg7.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[37], 8, sizeof(cl_mem),
                              (void *)&arg8.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[37], 9, sizeof(cl_mem),
                              (void *)&arg9.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[37], 10, sizeof(cl_mem),
                              (void *)&arg10.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[37], 11, sizeof(cl_mem),
                              (void *)&arg11.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[37], 12, sizeof(cl_mem),
                              (void *)&arg12.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[37], 13, sizeof(cl_mem),
                              (void *)&arg13.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[37], 14, sizeof(cl_double),
                              (void *)&g_small));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[37], 15, sizeof(cl_double),
                              (void *)&dtc_safe));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[37], 16, sizeof(cl_double),
                              (void *)&dtu_safe));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[37], 17, sizeof(cl_double),
                              (void *)&dtv_safe));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[37], 18, sizeof(cl_double),
                              (void *)&dtw_safe));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[37], 19, sizeof(cl_double),
                              (void *)&dtdiv_safe));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[37], 20, sizeof(cl_int),
                              (void *)&base0));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[37], 21, sizeof(cl_int),
                              (void *)&base1));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[37], 22, sizeof(cl_int),
                              (void *)&base2));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[37], 23, sizeof(cl_int),
                              (void *)&base3));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[37], 24, sizeof(cl_int),
                              (void *)&base4));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[37], 25, sizeof(cl_int),
                              (void *)&base5));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[37], 26, sizeof(cl_int),
                              (void *)&base6));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[37], 27, sizeof(cl_int),
                              (void *)&base7));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[37], 28, sizeof(cl_int),
                              (void *)&base8));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[37], 29, sizeof(cl_int),
                              (void *)&base9));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[37], 30, sizeof(cl_int),
                              (void *)&base10));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[37], 31, sizeof(cl_int),
                              (void *)&base11));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[37], 32, sizeof(cl_int),
                              (void *)&base12));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[37], 33, sizeof(cl_int),
                              (void *)&base13));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[37], 34, sizeof(cl_int),
                              (void *)&x_size));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[37], 35, sizeof(cl_int),
                              (void *)&y_size));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[37], 36, sizeof(cl_int),
=======
    ...
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[98], 1, sizeof(cl_mem),
                              (void *)&arg1.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[98], 2, sizeof(cl_mem),
                              (void *)&arg2.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[98], 3, sizeof(cl_mem),
                              (void *)&arg3.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[98], 4, sizeof(cl_mem),
                              (void *)&arg4.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[98], 5, sizeof(cl_mem),
                              (void *)&arg5.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[98], 6, sizeof(cl_mem),
                              (void *)&arg6.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[98], 7, sizeof(cl_mem),
                              (void *)&arg7.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[98], 8, sizeof(cl_mem),
                              (void *)&arg8.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[98], 9, sizeof(cl_mem),
                              (void *)&arg9.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[98], 10, sizeof(cl_mem),
                              (void *)&arg10.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[98], 11, sizeof(cl_mem),
                              (void *)&arg11.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[98], 12, sizeof(cl_mem),
                              (void *)&arg12.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[98], 13, sizeof(cl_mem),
                              (void *)&arg13.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[98], 14, sizeof(cl_double),
                              (void *)&g_small));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[98], 15, sizeof(cl_double),
                              (void *)&dtc_safe));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[98], 16, sizeof(cl_double),
                              (void *)&dtu_safe));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[98], 17, sizeof(cl_double),
                              (void *)&dtv_safe));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[98], 18, sizeof(cl_double),
                              (void *)&dtw_safe));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[98], 19, sizeof(cl_double),
                              (void *)&dtdiv_safe));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[98], 20, sizeof(cl_int),
                              (void *)&base0));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[98], 21, sizeof(cl_int),
                              (void *)&base1));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[98], 22, sizeof(cl_int),
                              (void *)&base2));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[98], 23, sizeof(cl_int),
                              (void *)&base3));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[98], 24, sizeof(cl_int),
                              (void *)&base4));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[98], 25, sizeof(cl_int),
                              (void *)&base5));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[98], 26, sizeof(cl_int),
                              (void *)&base6));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[98], 27, sizeof(cl_int),
                              (void *)&base7));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[98], 28, sizeof(cl_int),
                              (void *)&base8));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[98], 29, sizeof(cl_int),
                              (void *)&base9));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[98], 30, sizeof(cl_int),
                              (void *)&base10));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[98], 31, sizeof(cl_int),
                              (void *)&base11));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[98], 32, sizeof(cl_int),
                              (void *)&base12));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[98], 33, sizeof(cl_int),
                              (void *)&base13));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[98], 34, sizeof(cl_int),
                              (void *)&x_size));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[98], 35, sizeof(cl_int),
                              (void *)&y_size));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[98], 36, sizeof(cl_int),
>>>>>>> 3f8b285... Regenerating files to resolve conflicts
                              (void *)&z_size));
...
<<<<<<< HEAD
        OPS_opencl_core.command_queue, OPS_opencl_core.kernel[37], 3, NULL,
=======
