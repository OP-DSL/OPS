...
void buildOpenCLKernels_accelerate_kernel(
  ...
  if (!isbuilt_accelerate_kernel) {
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts,
                ...
                "-Dxdim0_accelerate_kernel=%d  -Dydim0_accelerate_kernel=%d  "
                "-Dxdim1_accelerate_kernel=%d  -Dydim1_accelerate_kernel=%d  "
                "-Dxdim2_accelerate_kernel=%d  -Dydim2_accelerate_kernel=%d  "
                "-Dxdim3_accelerate_kernel=%d  -Dydim3_accelerate_kernel=%d  "
                "-Dxdim4_accelerate_kernel=%d  -Dydim4_accelerate_kernel=%d  "
                "-Dxdim5_accelerate_kernel=%d  -Dydim5_accelerate_kernel=%d  "
                "-Dxdim6_accelerate_kernel=%d  -Dydim6_accelerate_kernel=%d  "
                "-Dxdim7_accelerate_kernel=%d  -Dydim7_accelerate_kernel=%d  "
                "-Dxdim8_accelerate_kernel=%d  -Dydim8_accelerate_kernel=%d  "
                "-Dxdim9_accelerate_kernel=%d  -Dydim9_accelerate_kernel=%d  "
                "-Dxdim10_accelerate_kernel=%d  -Dydim10_accelerate_kernel=%d  "
                "-Dxdim11_accelerate_kernel=%d  -Dydim11_accelerate_kernel=%d  "
                "-Dxdim12_accelerate_kernel=%d  -Dydim12_accelerate_kernel=%d  "
                "-Dxdim13_accelerate_kernel=%d  -Dydim13_accelerate_kernel=%d ",
    ...
    OPS_opencl_core.kernel[6] =
        clCreateKernel(OPS_opencl_core.program, "ops_accelerate_kernel", &ret);
    clSafeCall(ret);
