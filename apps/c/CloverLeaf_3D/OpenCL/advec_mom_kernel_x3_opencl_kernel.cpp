...
void buildOpenCLKernels_advec_mom_kernel_x3(int xdim0, int ydim0, int xdim1,
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(
            ...
            "-Dxdim0_advec_mom_kernel_x3=%d  -Dydim0_advec_mom_kernel_x3=%d  "
            "-Dxdim1_advec_mom_kernel_x3=%d  -Dydim1_advec_mom_kernel_x3=%d  "
            "-Dxdim2_advec_mom_kernel_x3=%d  -Dydim2_advec_mom_kernel_x3=%d  "
            "-Dxdim3_advec_mom_kernel_x3=%d  -Dydim3_advec_mom_kernel_x3=%d ",
...
void ops_par_loop_advec_mom_kernel_x3(char const *name, ops_block block,
  ...
  buildOpenCLKernels_advec_mom_kernel_x3(xdim0, ydim0, xdim1, ydim1, xdim2,
                                         ydim2, xdim3, ydim3);
