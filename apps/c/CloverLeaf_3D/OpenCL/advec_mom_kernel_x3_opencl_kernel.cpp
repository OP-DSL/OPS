...
void buildOpenCLKernels_advec_mom_kernel_x3(int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3) {
  ...
  if(!isbuilt_advec_mom_kernel_x3) {
    ...
    OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[125] = clCreateKernel(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.program, "ops_advec_mom_kernel_x3", &ret);
    clSafeCall( ret );
