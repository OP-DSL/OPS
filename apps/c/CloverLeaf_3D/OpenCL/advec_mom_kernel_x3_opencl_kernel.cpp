...
void buildOpenCLKernels_advec_mom_kernel_x3(int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3) {
  ...
  if(!isbuilt_advec_mom_kernel_x3) {
    ...
    OPS_opencl_core.kernel[23] = clCreateKernel(OPS_opencl_core.program, "ops_advec_mom_kernel_x3", &ret);
    clSafeCall( ret );
...
void ops_par_loop_advec_mom_kernel_x3(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3) {
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[23], 10, sizeof(cl_int), (void*) &z_size ));
