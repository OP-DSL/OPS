...
inline void update_halo_kernel1_ba2(ptr_double density0, ptr_double density1,
  ...
  if (fields[FIELD_DENSITY0] == 1)
    OPS_ACCS(density0, 0, 0, 0) = OPS_ACCS(density0, 0, 0, 3);
  if (fields[FIELD_DENSITY1] == 1)
    OPS_ACCS(density1, 0, 0, 0) = OPS_ACCS(density1, 0, 0, 3);
  if (fields[FIELD_ENERGY0] == 1)
    OPS_ACCS(energy0, 0, 0, 0) = OPS_ACCS(energy0, 0, 0, 3);
  if (fields[FIELD_ENERGY1] == 1)
    OPS_ACCS(energy1, 0, 0, 0) = OPS_ACCS(energy1, 0, 0, 3);
  if (fields[FIELD_PRESSURE] == 1)
    OPS_ACCS(pressure, 0, 0, 0) = OPS_ACCS(pressure, 0, 0, 3);
  if (fields[FIELD_VISCOSITY] == 1)
    OPS_ACCS(viscosity, 0, 0, 0) = OPS_ACCS(viscosity, 0, 0, 3);
  if (fields[FIELD_SOUNDSPEED] == 1)
    OPS_ACCS(soundspeed, 0, 0, 0) = OPS_ACCS(soundspeed, 0, 0, 3);
}
...
__kernel void ops_update_halo_kernel1_ba2(
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ...
    ptr_double ptr6 = {&arg6[base6 + idx_x * 1 * 1 +
                       ...
                       xdim6_update_halo_kernel1_ba2,
                       ydim6_update_halo_kernel1_ba2};
    update_halo_kernel1_ba2(ptr0, ptr1, ptr2, ptr3, ptr4, ptr5, ptr6, arg7);
  }
}
