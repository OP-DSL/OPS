...
void buildOpenCLKernels_advec_mom_kernel_post_pre_advec_y(int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3, int xdim4, int ydim4) {
  ...
  if(!isbuilt_advec_mom_kernel_post_pre_advec_y) {
    ...
    OPS_opencl_core.kernel[30] = clCreateKernel(OPS_opencl_core.program, "ops_advec_mom_kernel_post_pre_advec_y", &ret);
    clSafeCall( ret );
...
void ops_par_loop_advec_mom_kernel_post_pre_advec_y(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[30], 7, sizeof(cl_int), (void*) &base2 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[30], 8, sizeof(cl_int), (void*) &base3 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[30], 9, sizeof(cl_int), (void*) &base4 ));
