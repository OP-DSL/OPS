...
void buildOpenCLKernels_advec_mom_kernel_post_pre_advec_y(int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3, int xdim4, int ydim4) {
  ...
  if(!isbuilt_advec_mom_kernel_post_pre_advec_y) {
    ...
    printf("Compiling advec_mom_kernel_post_pre_advec_y %d source -- start \n",OCL_FMA);
    ...
    OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[132] = clCreateKernel(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.program, "ops_advec_mom_kernel_post_pre_advec_y", &ret);
    clSafeCall( ret );
