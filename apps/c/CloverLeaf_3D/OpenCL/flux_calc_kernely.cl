...
const int size2 ){
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    flux_calc_kernely(&arg0[base0 + idx_x * 1*1 + idx_y * 1*1 * xdim0_flux_calc_kernely + idx_z * 1*1 * xdim0_flux_calc_kernely * ydim0_flux_calc_kernely],
                     &arg1[base1 + idx_x * 1*1 + idx_y * 1*1 * xdim1_flux_calc_kernely + idx_z * 1*1 * xdim1_flux_calc_kernely * ydim1_flux_calc_kernely],
                     &arg2[base2 + idx_x * 1*1 + idx_y * 1*1 * xdim2_flux_calc_kernely + idx_z * 1*1 * xdim2_flux_calc_kernely * ydim2_flux_calc_kernely],
                     &arg3[base3 + idx_x * 1*1 + idx_y * 1*1 * xdim3_flux_calc_kernely + idx_z * 1*1 * xdim3_flux_calc_kernely * ydim3_flux_calc_kernely],
                     dt);
  }
