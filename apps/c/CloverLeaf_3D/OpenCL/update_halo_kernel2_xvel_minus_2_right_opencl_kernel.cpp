...
void buildOpenCLKernels_update_halo_kernel2_xvel_minus_2_right(
  ...
  if (!isbuilt_update_halo_kernel2_xvel_minus_2_right) {
    ...
    instance->ostream() << "Compiling update_halo_kernel2_xvel_minus_2_right "
    ...
    instance->ostream()
        << "compiling update_halo_kernel2_xvel_minus_2_right -- done\n";
