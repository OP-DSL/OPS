...
void buildOpenCLKernels_advec_mom_kernel_post_pre_advec_x(
  ...
  if (!isbuilt_advec_mom_kernel_post_pre_advec_x) {
    ...
    char *source_filename[1] = {
        (char *)"./OpenCL/advec_mom_kernel_post_pre_advec_x.cl"};
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts, "-cl-mad-enable -DOCL_FMA -I%s/c/include "
                           ...
                           "-Dydim0_advec_mom_kernel_post_pre_advec_x=%d  "
                           "-Dxdim1_advec_mom_kernel_post_pre_advec_x=%d  "
                           "-Dydim1_advec_mom_kernel_post_pre_advec_x=%d  "
                           "-Dxdim2_advec_mom_kernel_post_pre_advec_x=%d  "
                           "-Dydim2_advec_mom_kernel_post_pre_advec_x=%d  "
                           "-Dxdim3_advec_mom_kernel_post_pre_advec_x=%d  "
                           "-Dydim3_advec_mom_kernel_post_pre_advec_x=%d  "
                           "-Dxdim4_advec_mom_kernel_post_pre_advec_x=%d  "
                           "-Dydim4_advec_mom_kernel_post_pre_advec_x=%d ",
    ...
    OPS_opencl_core.kernel[26] = clCreateKernel(
        OPS_opencl_core.program, "ops_advec_mom_kernel_post_pre_advec_x", &ret);
    clSafeCall(ret);
