...
__kernel void ops_reset_field_kernel2(
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ptr_double ptr0 = {&arg0[base0 + idx_x * 1 * 1 +
                             idx_y * 1 * 1 * xdim0_reset_field_kernel2 +
                             idx_z * 1 * 1 * xdim0_reset_field_kernel2 *
                                 ydim0_reset_field_kernel2],
                       xdim0_reset_field_kernel2, ydim0_reset_field_kernel2};
    const ptr_double ptr1 = {&arg1[base1 + idx_x * 1 * 1 +
                                   idx_y * 1 * 1 * xdim1_reset_field_kernel2 +
                                   idx_z * 1 * 1 * xdim1_reset_field_kernel2 *
                                       ydim1_reset_field_kernel2],
                             xdim1_reset_field_kernel2,
                             ydim1_reset_field_kernel2};
    ptr_double ptr2 = {&arg2[base2 + idx_x * 1 * 1 +
                             idx_y * 1 * 1 * xdim2_reset_field_kernel2 +
                             idx_z * 1 * 1 * xdim2_reset_field_kernel2 *
                                 ydim2_reset_field_kernel2],
                       xdim2_reset_field_kernel2, ydim2_reset_field_kernel2};
    const ptr_double ptr3 = {&arg3[base3 + idx_x * 1 * 1 +
                                   idx_y * 1 * 1 * xdim3_reset_field_kernel2 +
                                   idx_z * 1 * 1 * xdim3_reset_field_kernel2 *
                                       ydim3_reset_field_kernel2],
                             xdim3_reset_field_kernel2,
                             ydim3_reset_field_kernel2};
    ptr_double ptr4 = {&arg4[base4 + idx_x * 1 * 1 +
                             idx_y * 1 * 1 * xdim4_reset_field_kernel2 +
                             idx_z * 1 * 1 * xdim4_reset_field_kernel2 *
                                 ydim4_reset_field_kernel2],
                       xdim4_reset_field_kernel2, ydim4_reset_field_kernel2};
    const ptr_double ptr5 = {&arg5[base5 + idx_x * 1 * 1 +
                                   idx_y * 1 * 1 * xdim5_reset_field_kernel2 +
                                   idx_z * 1 * 1 * xdim5_reset_field_kernel2 *
                                       ydim5_reset_field_kernel2],
                             xdim5_reset_field_kernel2,
                             ydim5_reset_field_kernel2};
