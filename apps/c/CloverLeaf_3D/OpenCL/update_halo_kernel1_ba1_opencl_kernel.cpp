...
void buildOpenCLKernels_update_halo_kernel1_ba1(OPS_instance *instance,
  ...
  if (!isbuilt_update_halo_kernel1_ba1) {
    ...
    instance->ostream() << "Compiling update_halo_kernel1_ba1 " << OCL_FMA
                        << " source -- start \n";
    ...
    instance->opencl_instance->OPS_opencl_core.kernel[21] =
        clCreateKernel(instance->opencl_instance->OPS_opencl_core.program,
                       "ops_update_halo_kernel1_ba1", &ret);
    clSafeCall(ret);
