...
void buildOpenCLKernels_reset_field_kernel2(int xdim0, int ydim0, int xdim1,
  ...
  if (!isbuilt_reset_field_kernel2) {
    ...
    OPS_opencl_core.kernel[2] = clCreateKernel(OPS_opencl_core.program,
                                               "ops_reset_field_kernel2", &ret);
    clSafeCall(ret);
...
void ops_par_loop_reset_field_kernel2(char const *name, ops_block block,
  ...
  if (globalWorkSize[0] > 0 && globalWorkSize[1] > 0 && globalWorkSize[2] > 0) {
    ...
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[2], 9, sizeof(cl_int),
                              (void *)&base3));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[2], 10, sizeof(cl_int),
                              (void *)&base4));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[2], 11, sizeof(cl_int),
                              (void *)&base5));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[2], 12, sizeof(cl_int),
                              (void *)&x_size));
