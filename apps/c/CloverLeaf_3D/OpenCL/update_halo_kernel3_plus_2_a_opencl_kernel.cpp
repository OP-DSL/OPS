...
void buildOpenCLKernels_update_halo_kernel3_plus_2_a(int xdim0, int ydim0, int xdim1, int ydim1) {
  ...
  if(!isbuilt_update_halo_kernel3_plus_2_a) {
    ...
    printf("Compiling update_halo_kernel3_plus_2_a %d source -- start \n",OCL_FMA);
      ...
      if (pPath!=NULL)
        if(OCL_FMA)
          sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/c/include -DOPS_WARPSIZE=%d  -Dxdim0_update_halo_kernel3_plus_2_a=%d  -Dydim0_update_halo_kernel3_plus_2_a=%d  -Dxdim1_update_halo_kernel3_plus_2_a=%d  -Dydim1_update_halo_kernel3_plus_2_a=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1);
        else
    ...
    OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[61] = clCreateKernel(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.program, "ops_update_halo_kernel3_plus_2_a", &ret);
    clSafeCall( ret );
