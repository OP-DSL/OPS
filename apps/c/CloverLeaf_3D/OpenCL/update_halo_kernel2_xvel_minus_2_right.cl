...
inline void
update_halo_kernel2_xvel_minus_2_right(ptr_double xvel0, ptr_double xvel1,
                                       const __global int *restrict fields) {
  if (fields[FIELD_XVEL0] == 1)
    OPS_ACCS(xvel0, 0, 0, 0) = -OPS_ACCS(xvel0, -2, 0, 0);
  if (fields[FIELD_XVEL1] == 1)
    OPS_ACCS(xvel1, 0, 0, 0) = -OPS_ACCS(xvel1, -2, 0, 0);
}
...
__kernel void ops_update_halo_kernel2_xvel_minus_2_right(
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ...
    ptr_double ptr1 = {
        ...
        ydim1_update_halo_kernel2_xvel_minus_2_right};
    update_halo_kernel2_xvel_minus_2_right(ptr0, ptr1, arg2);
  }
}
