...
void accelerate_kernel(
    ...
    __global double *restrict stepbymass, const __global double *restrict xvel0,
    __global double *restrict xvel1, const __global double *restrict xarea,
    const __global double *restrict pressure,
    const __global double *restrict yvel0, __global double *restrict yvel1,
    const __global double *restrict yarea,
    const __global double *restrict viscosity,
    const __global double *restrict zvel0, __global double *restrict zvel1,
    const __global double *restrict zarea, const double dt)
