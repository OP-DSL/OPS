...
void buildOpenCLKernels_update_halo_kernel2_xvel_plus_2_front(
  ...
  if (!isbuilt_update_halo_kernel2_xvel_plus_2_front) {
    ...
    instance->ostream() << "Compiling update_halo_kernel2_xvel_plus_2_front "
    ...
    instance->ostream()
        << "compiling update_halo_kernel2_xvel_plus_2_front -- done\n";
