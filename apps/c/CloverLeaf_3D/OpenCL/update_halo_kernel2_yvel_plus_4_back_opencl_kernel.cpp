...
void buildOpenCLKernels_update_halo_kernel2_yvel_plus_4_back(
  ...
  if (!isbuilt_update_halo_kernel2_yvel_plus_4_back) {
    ...
    instance->ostream() << "Compiling update_halo_kernel2_yvel_plus_4_back "
    ...
    instance->ostream()
        << "compiling update_halo_kernel2_yvel_plus_4_back -- done\n";
