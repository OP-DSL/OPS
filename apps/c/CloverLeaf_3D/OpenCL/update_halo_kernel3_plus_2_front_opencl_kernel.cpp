...
void buildOpenCLKernels_update_halo_kernel3_plus_2_front(OPS_instance *instance,
                                                         int xdim0, int ydim0,
                                                         int xdim1, int ydim1) {
  ...
  if (!isbuilt_update_halo_kernel3_plus_2_front) {
    ...
    instance->ostream() << "Compiling update_halo_kernel3_plus_2_front "
