...
void buildOpenCLKernels_advec_cell_kernel3_zdir(int xdim0, int ydim0, int xdim1,
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts, "-cl-mad-enable -DOCL_FMA -I%s/c/include "
                           "-DOPS_WARPSIZE=%d  "
                           "-Dxdim0_advec_cell_kernel3_zdir=%d  "
                           "-Dydim0_advec_cell_kernel3_zdir=%d  "
                           "-Dxdim1_advec_cell_kernel3_zdir=%d  "
                           "-Dydim1_advec_cell_kernel3_zdir=%d  "
                           "-Dxdim2_advec_cell_kernel3_zdir=%d  "
                           "-Dydim2_advec_cell_kernel3_zdir=%d  "
                           "-Dxdim3_advec_cell_kernel3_zdir=%d  "
                           "-Dydim3_advec_cell_kernel3_zdir=%d  "
                           "-Dxdim4_advec_cell_kernel3_zdir=%d  "
                           "-Dydim4_advec_cell_kernel3_zdir=%d  "
                           "-Dxdim5_advec_cell_kernel3_zdir=%d  "
                           "-Dydim5_advec_cell_kernel3_zdir=%d  "
                           "-Dxdim6_advec_cell_kernel3_zdir=%d  "
                           "-Dydim6_advec_cell_kernel3_zdir=%d  "
                           "-Dxdim7_advec_cell_kernel3_zdir=%d  "
                           "-Dydim7_advec_cell_kernel3_zdir=%d ",
