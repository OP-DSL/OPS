...
inline void advec_cell_kernel4_xdir(
  ...
  OPS_ACCS(post_mass, 0, 0, 0) = OPS_ACCS(pre_mass, 0, 0, 0) +
                                 OPS_ACCS(mass_flux_x, 0, 0, 0) -
                                 OPS_ACCS(mass_flux_x, 1, 0, 0);
  OPS_ACCS(post_ener, 0, 0, 0) =
      (OPS_ACCS(energy1, 0, 0, 0) * OPS_ACCS(pre_mass, 0, 0, 0) +
       OPS_ACCS(ener_flux, 0, 0, 0) - OPS_ACCS(ener_flux, 1, 0, 0)) /
...
__kernel void ops_advec_cell_kernel4_xdir(
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ptr_double ptr0 = {&arg0[base0 + idx_x * 1 * 1 +
                             idx_y * 1 * 1 * xdim0_advec_cell_kernel4_xdir +
    ...
    ptr_double ptr1 = {&arg1[base1 + idx_x * 1 * 1 +
                             idx_y * 1 * 1 * xdim1_advec_cell_kernel4_xdir +
    ...
    const ptr_double ptr2 = {
        &arg2[base2 + idx_x * 1 * 1 +
              idx_y * 1 * 1 * xdim2_advec_cell_kernel4_xdir +
    ...
    const ptr_double ptr3 = {
        &arg3[base3 + idx_x * 1 * 1 +
              idx_y * 1 * 1 * xdim3_advec_cell_kernel4_xdir +
    ...
    const ptr_double ptr4 = {
        &arg4[base4 + idx_x * 1 * 1 +
              idx_y * 1 * 1 * xdim4_advec_cell_kernel4_xdir +
    ...
    const ptr_double ptr5 = {
        &arg5[base5 + idx_x * 1 * 1 +
              idx_y * 1 * 1 * xdim5_advec_cell_kernel4_xdir +
    ...
    ptr_double ptr6 = {&arg6[base6 + idx_x * 1 * 1 +
                             idx_y * 1 * 1 * xdim6_advec_cell_kernel4_xdir +
    ...
    ptr_double ptr7 = {&arg7[base7 + idx_x * 1 * 1 +
                             idx_y * 1 * 1 * xdim7_advec_cell_kernel4_xdir +
    ...
    ptr_double ptr8 = {&arg8[base8 + idx_x * 1 * 1 +
                             idx_y * 1 * 1 * xdim8_advec_cell_kernel4_xdir +
    ...
    ptr_double ptr9 = {&arg9[base9 + idx_x * 1 * 1 +
                             idx_y * 1 * 1 * xdim9_advec_cell_kernel4_xdir +
    ...
    const ptr_double ptr10 = {
        &arg10[base10 + idx_x * 1 * 1 +
               idx_y * 1 * 1 * xdim10_advec_cell_kernel4_xdir +
