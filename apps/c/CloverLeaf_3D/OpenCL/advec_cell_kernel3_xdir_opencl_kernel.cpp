...
void buildOpenCLKernels_advec_cell_kernel3_xdir(int xdim0, int ydim0, int xdim1,
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts, "-cl-mad-enable -DOCL_FMA -I%s/c/include "
                           "-DOPS_WARPSIZE=%d  "
                           "-Dxdim0_advec_cell_kernel3_xdir=%d  "
                           "-Dydim0_advec_cell_kernel3_xdir=%d  "
                           "-Dxdim1_advec_cell_kernel3_xdir=%d  "
                           "-Dydim1_advec_cell_kernel3_xdir=%d  "
                           "-Dxdim2_advec_cell_kernel3_xdir=%d  "
                           "-Dydim2_advec_cell_kernel3_xdir=%d  "
                           "-Dxdim3_advec_cell_kernel3_xdir=%d  "
                           "-Dydim3_advec_cell_kernel3_xdir=%d  "
                           "-Dxdim4_advec_cell_kernel3_xdir=%d  "
                           "-Dydim4_advec_cell_kernel3_xdir=%d  "
                           "-Dxdim5_advec_cell_kernel3_xdir=%d  "
                           "-Dydim5_advec_cell_kernel3_xdir=%d  "
                           "-Dxdim6_advec_cell_kernel3_xdir=%d  "
                           "-Dydim6_advec_cell_kernel3_xdir=%d  "
                           "-Dxdim7_advec_cell_kernel3_xdir=%d  "
                           "-Dydim7_advec_cell_kernel3_xdir=%d ",
