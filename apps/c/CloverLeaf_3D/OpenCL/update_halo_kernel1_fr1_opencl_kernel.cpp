...
<<<<<<< HEAD
    ...
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[68], 6, sizeof(cl_mem),
                              (void *)&arg6.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[68], 7, sizeof(cl_mem),
                              (void *)&arg7.data_d));
...
=======
    ...
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[23], 5, sizeof(cl_mem),
                              (void *)&arg5.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[23], 6, sizeof(cl_mem),
                              (void *)&arg6.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[23], 7, sizeof(cl_mem),
                              (void *)&arg7.data_d));
    ...
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[23], 15, sizeof(cl_int),
                              (void *)&x_size));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[23], 16, sizeof(cl_int),
                              (void *)&y_size));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[23], 17, sizeof(cl_int),
>>>>>>> 3f8b285... Regenerating files to resolve conflicts
                              (void *)&z_size));
...
=======
    ...
    OPS_kernels[23].transfer += ops_compute_transfer(dim, start, end, &arg6);
>>>>>>> 3f8b285... Regenerating files to resolve conflicts
  }
}
