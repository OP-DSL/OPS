...
void buildOpenCLKernels_advec_cell_kernel2_zdir(OPS_instance *instance,
  ...
  if (!isbuilt_advec_cell_kernel2_zdir) {
    ...
    instance->ostream() << "Compiling advec_cell_kernel2_zdir " << OCL_FMA
                        << " source -- start \n";
    ...
    instance->opencl_instance->OPS_opencl_core.kernel[118] =
        clCreateKernel(instance->opencl_instance->OPS_opencl_core.program,
                       "ops_advec_cell_kernel2_zdir", &ret);
    clSafeCall(ret);
