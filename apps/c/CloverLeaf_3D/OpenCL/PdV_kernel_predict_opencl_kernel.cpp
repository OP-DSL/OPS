...
>>>>>>> 3f8b285... Regenerating files to resolve conflicts
          OPS_opencl_core.program, "ops_PdV_kernel_predict", &ret);
      clSafeCall(ret);
...
<<<<<<< HEAD
    ...
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 10, sizeof(cl_mem),
                              (void *)&arg10.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 11, sizeof(cl_mem),
                              (void *)&arg11.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 12, sizeof(cl_mem),
                              (void *)&arg12.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 13, sizeof(cl_mem),
                              (void *)&arg13.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[4], 14, sizeof(cl_double),
                              (void *)&dt));
...
=======
    ...
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[102], 13, sizeof(cl_mem),
                              (void *)&arg13.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[102], 14,
                              sizeof(cl_double), (void *)&dt));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[102], 15, sizeof(cl_int),
                              (void *)&base0));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[102], 16, sizeof(cl_int),
                              (void *)&base1));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[102], 17, sizeof(cl_int),
                              (void *)&base2));
