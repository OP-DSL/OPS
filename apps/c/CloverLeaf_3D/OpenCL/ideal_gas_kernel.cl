...
void ideal_gas_kernel(const ptr_double density, const ptr_double energy,
  ...
  OPS_ACCS(pressure, 0, 0, 0) =
      (1.4 - 1.0) * OPS_ACCS(density, 0, 0, 0) * OPS_ACCS(energy, 0, 0, 0);

  pressurebyenergy = (1.4 - 1.0) * OPS_ACCS(density, 0, 0, 0);
  pressurebyvolume =
      -1.0 * OPS_ACCS(density, 0, 0, 0) * OPS_ACCS(pressure, 0, 0, 0);
  sound_speed_squared =
      v * v *
      (OPS_ACCS(pressure, 0, 0, 0) * pressurebyenergy - pressurebyvolume);
