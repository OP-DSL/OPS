...
inline void
update_halo_kernel5_plus_2_right(ptr_double vol_flux_z, ptr_double mass_flux_z,
                                 const __global int *restrict fields) {
  if (fields[FIELD_VOL_FLUX_Z] == 1)
    OPS_ACCS(vol_flux_z, 0, 0, 0) = (OPS_ACCS(vol_flux_z, -2, 0, 0));
  if (fields[FIELD_MASS_FLUX_Z] == 1)
    OPS_ACCS(mass_flux_z, 0, 0, 0) = (OPS_ACCS(mass_flux_z, -2, 0, 0));
}
...
__kernel void ops_update_halo_kernel5_plus_2_right(
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ...
    ptr_double ptr1 = {
        ...
        ydim1_update_halo_kernel5_plus_2_right};
    update_halo_kernel5_plus_2_right(ptr0, ptr1, arg2);
  }
}
