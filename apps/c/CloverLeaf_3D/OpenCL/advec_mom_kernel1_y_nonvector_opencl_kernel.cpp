...
void buildOpenCLKernels_advec_mom_kernel1_y_nonvector(int xdim0, int ydim0,
                                                      int xdim1, int ydim1,
                                                      int xdim2, int ydim2,
                                                      int xdim3, int ydim3,
                                                      int xdim4, int ydim4) {
  ...
  if (!isbuilt_advec_mom_kernel1_y_nonvector) {
    ...
    char *source_filename[1] = {
        (char *)"./OpenCL/advec_mom_kernel1_y_nonvector.cl"};
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts, "-cl-mad-enable -DOCL_FMA -I%s/c/include "
                           "-DOPS_WARPSIZE=%d  "
                           "-Dxdim0_advec_mom_kernel1_y_nonvector=%d  "
                           "-Dydim0_advec_mom_kernel1_y_nonvector=%d  "
                           "-Dxdim1_advec_mom_kernel1_y_nonvector=%d  "
                           "-Dydim1_advec_mom_kernel1_y_nonvector=%d  "
                           "-Dxdim2_advec_mom_kernel1_y_nonvector=%d  "
                           "-Dydim2_advec_mom_kernel1_y_nonvector=%d  "
                           "-Dxdim3_advec_mom_kernel1_y_nonvector=%d  "
                           "-Dydim3_advec_mom_kernel1_y_nonvector=%d  "
                           "-Dxdim4_advec_mom_kernel1_y_nonvector=%d  "
                           "-Dydim4_advec_mom_kernel1_y_nonvector=%d ",
