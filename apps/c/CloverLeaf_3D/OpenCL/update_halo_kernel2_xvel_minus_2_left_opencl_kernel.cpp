...
void buildOpenCLKernels_update_halo_kernel2_xvel_minus_2_left(int xdim0, int ydim0, int xdim1, int ydim1) {
  ...
  if(!isbuilt_update_halo_kernel2_xvel_minus_2_left) {
    ...
    OPS_opencl_core.kernel[29] = clCreateKernel(OPS_opencl_core.program, "ops_update_halo_kernel2_xvel_minus_2_left", &ret);
    clSafeCall( ret );
...
void ops_par_loop_update_halo_kernel2_xvel_minus_2_left(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[29], 3, sizeof(cl_int), (void*) &base0 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[29], 4, sizeof(cl_int), (void*) &base1 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[29], 5, sizeof(cl_int), (void*) &x_size ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[29], 6, sizeof(cl_int), (void*) &y_size ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[29], 7, sizeof(cl_int), (void*) &z_size ));
