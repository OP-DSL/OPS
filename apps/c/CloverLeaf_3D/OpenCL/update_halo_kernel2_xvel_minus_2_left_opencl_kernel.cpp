...
void buildOpenCLKernels_update_halo_kernel2_xvel_minus_2_left(
  ...
  if (!isbuilt_update_halo_kernel2_xvel_minus_2_left) {
    ...
    instance->ostream() << "Compiling update_halo_kernel2_xvel_minus_2_left "
    ...
    instance->ostream()
        << "compiling update_halo_kernel2_xvel_minus_2_left -- done\n";
