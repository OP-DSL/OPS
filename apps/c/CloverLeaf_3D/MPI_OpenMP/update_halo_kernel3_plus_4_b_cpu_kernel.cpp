...
#define OPS_ACC0(x, y, z)                                                      \
  (n_x * 1 + x + (n_y * 1 + (y)) * xdim0_update_halo_kernel3_plus_4_b +        \
   (n_z * 1 + (z)) * xdim0_update_halo_kernel3_plus_4_b *                      \
       ydim0_update_halo_kernel3_plus_4_b)
#define OPS_ACC1(x, y, z)                                                      \
  (n_x * 1 + x + (n_y * 1 + (y)) * xdim1_update_halo_kernel3_plus_4_b +        \
   (n_z * 1 + (z)) * xdim1_update_halo_kernel3_plus_4_b *                      \
