...
//
#define OPS_ACC0(x,y,z) (n_x*1 + x + (n_y*1+(y))*xdim0_update_halo_kernel5_plus_4_right + (n_z*1+(z))*xdim0_update_halo_kernel5_plus_4_right*ydim0_update_halo_kernel5_plus_4_right)
#define OPS_ACC1(x,y,z) (n_x*1 + x + (n_y*1+(y))*xdim1_update_halo_kernel5_plus_4_right + (n_z*1+(z))*xdim1_update_halo_kernel5_plus_4_right*ydim1_update_halo_kernel5_plus_4_right)
