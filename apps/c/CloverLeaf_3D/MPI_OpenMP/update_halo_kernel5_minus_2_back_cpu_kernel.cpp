...
//
#define OPS_ACC0(x,y,z) (n_x*1 + x + (n_y*1+(y))*xdim0_update_halo_kernel5_minus_2_back + (n_z*1+(z))*xdim0_update_halo_kernel5_minus_2_back*ydim0_update_halo_kernel5_minus_2_back)
#define OPS_ACC1(x,y,z) (n_x*1 + x + (n_y*1+(y))*xdim1_update_halo_kernel5_minus_2_back + (n_z*1+(z))*xdim1_update_halo_kernel5_minus_2_back*ydim1_update_halo_kernel5_minus_2_back)
