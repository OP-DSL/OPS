...
//
#define OPS_ACC0(x,y,z) (n_x*1 + x + (n_y*1+(y))*xdim0_advec_cell_kernel4_xdir + (n_z*1+(z))*xdim0_advec_cell_kernel4_xdir*ydim0_advec_cell_kernel4_xdir)
#define OPS_ACC1(x,y,z) (n_x*1 + x + (n_y*1+(y))*xdim1_advec_cell_kernel4_xdir + (n_z*1+(z))*xdim1_advec_cell_kernel4_xdir*ydim1_advec_cell_kernel4_xdir)
#define OPS_ACC2(x,y,z) (n_x*1 + x + (n_y*1+(y))*xdim2_advec_cell_kernel4_xdir + (n_z*1+(z))*xdim2_advec_cell_kernel4_xdir*ydim2_advec_cell_kernel4_xdir)
#define OPS_ACC3(x,y,z) (n_x*1 + x + (n_y*1+(y))*xdim3_advec_cell_kernel4_xdir + (n_z*1+(z))*xdim3_advec_cell_kernel4_xdir*ydim3_advec_cell_kernel4_xdir)
#define OPS_ACC4(x,y,z) (n_x*1 + x + (n_y*1+(y))*xdim4_advec_cell_kernel4_xdir + (n_z*1+(z))*xdim4_advec_cell_kernel4_xdir*ydim4_advec_cell_kernel4_xdir)
#define OPS_ACC5(x,y,z) (n_x*1 + x + (n_y*1+(y))*xdim5_advec_cell_kernel4_xdir + (n_z*1+(z))*xdim5_advec_cell_kernel4_xdir*ydim5_advec_cell_kernel4_xdir)
#define OPS_ACC6(x,y,z) (n_x*1 + x + (n_y*1+(y))*xdim6_advec_cell_kernel4_xdir + (n_z*1+(z))*xdim6_advec_cell_kernel4_xdir*ydim6_advec_cell_kernel4_xdir)
#define OPS_ACC7(x,y,z) (n_x*1 + x + (n_y*1+(y))*xdim7_advec_cell_kernel4_xdir + (n_z*1+(z))*xdim7_advec_cell_kernel4_xdir*ydim7_advec_cell_kernel4_xdir)
#define OPS_ACC8(x,y,z) (n_x*1 + x + (n_y*1+(y))*xdim8_advec_cell_kernel4_xdir + (n_z*1+(z))*xdim8_advec_cell_kernel4_xdir*ydim8_advec_cell_kernel4_xdir)
#define OPS_ACC9(x,y,z) (n_x*1 + x + (n_y*1+(y))*xdim9_advec_cell_kernel4_xdir + (n_z*1+(z))*xdim9_advec_cell_kernel4_xdir*ydim9_advec_cell_kernel4_xdir)
#define OPS_ACC10(x,y,z) (n_x*1 + x + (n_y*1+(y))*xdim10_advec_cell_kernel4_xdir + (n_z*1+(z))*xdim10_advec_cell_kernel4_xdir*ydim10_advec_cell_kernel4_xdir)
...
void ops_par_loop_advec_cell_kernel4_xdir_execute(ops_kernel_descriptor *desc) {
  ...
  if (OPS_diags > 1) {
    ...
    OPS_kernels[112].mpi_time += __t1-__t2;
  }
  ...
  if (OPS_diags > 1) {
    ops_timers_core(&__c2,&__t2);
    OPS_kernels[112].time += __t2-__t1;
  }
  #ifndef OPS_LAZY
