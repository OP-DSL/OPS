...
//
#define OPS_ACC0(x,y,z) (n_x*1 + x + (n_y*0+(y))*xdim0_generate_chunk_kernel + (n_z*0+(z))*xdim0_generate_chunk_kernel*ydim0_generate_chunk_kernel)
#define OPS_ACC1(x,y,z) (n_x*0 + x + (n_y*1+(y))*xdim1_generate_chunk_kernel + (n_z*0+(z))*xdim1_generate_chunk_kernel*ydim1_generate_chunk_kernel)
#define OPS_ACC2(x,y,z) (n_x*0 + x + (n_y*0+(y))*xdim2_generate_chunk_kernel + (n_z*1+(z))*xdim2_generate_chunk_kernel*ydim2_generate_chunk_kernel)
#define OPS_ACC3(x,y,z) (n_x*1 + x + (n_y*1+(y))*xdim3_generate_chunk_kernel + (n_z*1+(z))*xdim3_generate_chunk_kernel*ydim3_generate_chunk_kernel)
#define OPS_ACC4(x,y,z) (n_x*1 + x + (n_y*1+(y))*xdim4_generate_chunk_kernel + (n_z*1+(z))*xdim4_generate_chunk_kernel*ydim4_generate_chunk_kernel)
#define OPS_ACC5(x,y,z) (n_x*1 + x + (n_y*1+(y))*xdim5_generate_chunk_kernel + (n_z*1+(z))*xdim5_generate_chunk_kernel*ydim5_generate_chunk_kernel)
#define OPS_ACC6(x,y,z) (n_x*1 + x + (n_y*1+(y))*xdim6_generate_chunk_kernel + (n_z*1+(z))*xdim6_generate_chunk_kernel*ydim6_generate_chunk_kernel)
#define OPS_ACC7(x,y,z) (n_x*1 + x + (n_y*1+(y))*xdim7_generate_chunk_kernel + (n_z*1+(z))*xdim7_generate_chunk_kernel*ydim7_generate_chunk_kernel)
#define OPS_ACC8(x,y,z) (n_x*1 + x + (n_y*0+(y))*xdim8_generate_chunk_kernel + (n_z*0+(z))*xdim8_generate_chunk_kernel*ydim8_generate_chunk_kernel)
#define OPS_ACC9(x,y,z) (n_x*0 + x + (n_y*1+(y))*xdim9_generate_chunk_kernel + (n_z*0+(z))*xdim9_generate_chunk_kernel*ydim9_generate_chunk_kernel)
#define OPS_ACC10(x,y,z) (n_x*0 + x + (n_y*0+(y))*xdim10_generate_chunk_kernel + (n_z*1+(z))*xdim10_generate_chunk_kernel*ydim10_generate_chunk_kernel)
