...
//
#define OPS_ACC0(x,y,z) (n_x*1 + x + (n_y*1+(y))*xdim0_advec_mom_kernel1_x_nonvector + (n_z*1+(z))*xdim0_advec_mom_kernel1_x_nonvector*ydim0_advec_mom_kernel1_x_nonvector)
#define OPS_ACC1(x,y,z) (n_x*1 + x + (n_y*1+(y))*xdim1_advec_mom_kernel1_x_nonvector + (n_z*1+(z))*xdim1_advec_mom_kernel1_x_nonvector*ydim1_advec_mom_kernel1_x_nonvector)
#define OPS_ACC2(x,y,z) (n_x*1 + x + (n_y*1+(y))*xdim2_advec_mom_kernel1_x_nonvector + (n_z*1+(z))*xdim2_advec_mom_kernel1_x_nonvector*ydim2_advec_mom_kernel1_x_nonvector)
#define OPS_ACC3(x,y,z) (n_x*1 + x + (n_y*0+(y))*xdim3_advec_mom_kernel1_x_nonvector + (n_z*0+(z))*xdim3_advec_mom_kernel1_x_nonvector*ydim3_advec_mom_kernel1_x_nonvector)
#define OPS_ACC4(x,y,z) (n_x*1 + x + (n_y*1+(y))*xdim4_advec_mom_kernel1_x_nonvector + (n_z*1+(z))*xdim4_advec_mom_kernel1_x_nonvector*ydim4_advec_mom_kernel1_x_nonvector)
...
void ops_par_loop_advec_mom_kernel1_x_nonvector_execute(ops_kernel_descriptor *desc) {
  ...
  if (OPS_diags > 1) {
    ...
    OPS_kernels[129].mpi_time += __t1-__t2;
  }
  ...
  if (OPS_diags > 1) {
    ops_timers_core(&__c2,&__t2);
    OPS_kernels[129].time += __t2-__t1;
  }
  #ifndef OPS_LAZY
