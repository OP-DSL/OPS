...
#define OPS_ACC0(x, y, z)                                                      \
  (n_x * 1 * 1 + n_y * xdim0_calc_dt_kernel_get * 0 * 1 +                      \
...
#define OPS_ACC1(x, y, z)                                                      \
  (n_x * 0 * 1 + n_y * xdim1_calc_dt_kernel_get * 1 * 1 +                      \
...
#define OPS_ACC4(x, y, z)                                                      \
  (n_x * 0 * 1 + n_y * xdim4_calc_dt_kernel_get * 0 * 1 +                      \
...
#pragma omp target teams distribute parallel for map(tofrom : p_a2_0)          \
    map(tofrom : p_a3_0) map(tofrom : p_a5_0)                                  \
