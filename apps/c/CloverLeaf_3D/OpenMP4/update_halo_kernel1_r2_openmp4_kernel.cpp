...
#ifdef CHECKPOINTING
  if (!ops_checkpointing_before(args, 8, range, 52))
    return;
#endif

  if (OPS_diags > 1) {
    ops_timing_realloc(52, "update_halo_kernel1_r2");
...
// ops_set_dirtybit_host(args, 8);
  ...
  if (OPS_diags > 1) {
    ...
    OPS_kernels[52].transfer += ops_compute_transfer(dim, start, end, &arg6);
  }
}
