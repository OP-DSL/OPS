...
#include "./OpenMP4/revert_kernel_openmp4_kernel_c.c"
...
// ops_H_D_exchanges_host(args, 4);
  ...
  revert_kernel_c_wrapper(p_a0, base0 / args[0].dat->elem_size, tot0, p_a1,
                          base1 / args[1].dat->elem_size, tot1, p_a2,
                          base2 / args[2].dat->elem_size, tot2, p_a3,
                          base3 / args[3].dat->elem_size, tot3, x_size, y_size,
                          z_size);
