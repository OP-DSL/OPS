...
#include "./OpenMP4/initialise_chunk_kernel_zz_openmp4_kernel_c.c"
...
#ifdef CHECKPOINTING
  if (!ops_checkpointing_before(args, 2, range, 133))
    return;
#endif

  if (OPS_diags > 1) {
    ops_timing_realloc(133, "initialise_chunk_kernel_zz");
...
// ops_H_D_exchanges_host(args, 2);
  ...
  initialise_chunk_kernel_zz_c_wrapper(p_a0, base0 / args[0].dat->elem_size,
