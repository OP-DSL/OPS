...
#include "./OpenMP4/update_halo_kernel1_l2_openmp4_kernel_c.c"
...
void ops_par_loop_update_halo_kernel1_l2(char const *name, ops_block block,
  ...
  if (OPS_diags > 1) {
    ops_timing_realloc(50, "update_halo_kernel1_l2");
...
// ops_H_D_exchanges_host(args, 8);
  ...
  update_halo_kernel1_l2_c_wrapper(p_a0, base0 / args[0].dat->elem_size, tot0,
