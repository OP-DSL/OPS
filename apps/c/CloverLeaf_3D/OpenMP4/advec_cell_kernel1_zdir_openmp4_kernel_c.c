...
#define OPS_ACC0(x, y, z)                                                      \
  (n_x * 1 * 1 + n_y * xdim0_advec_cell_kernel1_zdir * 1 * 1 +                 \
   n_z * xdim0_advec_cell_kernel1_zdir * ydim0_advec_cell_kernel1_zdir * 1 +   \
   x + xdim0_advec_cell_kernel1_zdir * (y) +                                   \
   xdim0_advec_cell_kernel1_zdir * ydim0_advec_cell_kernel1_zdir * (z))
#define OPS_ACC1(x, y, z)                                                      \
  (n_x * 1 * 1 + n_y * xdim1_advec_cell_kernel1_zdir * 1 * 1 +                 \
   n_z * xdim1_advec_cell_kernel1_zdir * ydim1_advec_cell_kernel1_zdir * 1 +   \
   x + xdim1_advec_cell_kernel1_zdir * (y) +                                   \
   xdim1_advec_cell_kernel1_zdir * ydim1_advec_cell_kernel1_zdir * (z))
#define OPS_ACC2(x, y, z)                                                      \
  (n_x * 1 * 1 + n_y * xdim2_advec_cell_kernel1_zdir * 1 * 1 +                 \
   n_z * xdim2_advec_cell_kernel1_zdir * ydim2_advec_cell_kernel1_zdir * 1 +   \
   x + xdim2_advec_cell_kernel1_zdir * (y) +                                   \
   xdim2_advec_cell_kernel1_zdir * ydim2_advec_cell_kernel1_zdir * (z))
#define OPS_ACC3(x, y, z)                                                      \
  (n_x * 1 * 1 + n_y * xdim3_advec_cell_kernel1_zdir * 1 * 1 +                 \
   n_z * xdim3_advec_cell_kernel1_zdir * ydim3_advec_cell_kernel1_zdir * 1 +   \
   x + xdim3_advec_cell_kernel1_zdir * (y) +                                   \
   xdim3_advec_cell_kernel1_zdir * ydim3_advec_cell_kernel1_zdir * (z))
#define OPS_ACC4(x, y, z)                                                      \
  (n_x * 1 * 1 + n_y * xdim4_advec_cell_kernel1_zdir * 1 * 1 +                 \
   n_z * xdim4_advec_cell_kernel1_zdir * ydim4_advec_cell_kernel1_zdir * 1 +   \
   x + xdim4_advec_cell_kernel1_zdir * (y) +                                   \
   xdim4_advec_cell_kernel1_zdir * ydim4_advec_cell_kernel1_zdir * (z))
#define OPS_ACC5(x, y, z)                                                      \
  (n_x * 1 * 1 + n_y * xdim5_advec_cell_kernel1_zdir * 1 * 1 +                 \
   n_z * xdim5_advec_cell_kernel1_zdir * ydim5_advec_cell_kernel1_zdir * 1 +   \
