...
#define OPS_ACC0(x, y, z)                                                      \
  (n_x * 0 * 1 + n_y * xdim0_initialise_chunk_kernel_celly * 1 * 1 +           \
...
#define OPS_ACC1(x, y, z)                                                      \
  (n_x * 0 * 1 + n_y * xdim1_initialise_chunk_kernel_celly * 1 * 1 +           \
...
#define OPS_ACC2(x, y, z)                                                      \
  (n_x * 0 * 1 + n_y * xdim2_initialise_chunk_kernel_celly * 1 * 1 +           \
