...
#define OPS_ACC0(x, y, z)                                                      \
  (n_x * 1 * 1 + n_y * xdim0_advec_mom_kernel_post_pre_advec_z * 1 * 1 +       \
...
#define OPS_ACC1(x, y, z)                                                      \
  (n_x * 1 * 1 + n_y * xdim1_advec_mom_kernel_post_pre_advec_z * 1 * 1 +       \
...
#define OPS_ACC2(x, y, z)                                                      \
  (n_x * 1 * 1 + n_y * xdim2_advec_mom_kernel_post_pre_advec_z * 1 * 1 +       \
...
#define OPS_ACC3(x, y, z)                                                      \
  (n_x * 1 * 1 + n_y * xdim3_advec_mom_kernel_post_pre_advec_z * 1 * 1 +       \
...
#define OPS_ACC4(x, y, z)                                                      \
  (n_x * 1 * 1 + n_y * xdim4_advec_mom_kernel_post_pre_advec_z * 1 * 1 +       \
