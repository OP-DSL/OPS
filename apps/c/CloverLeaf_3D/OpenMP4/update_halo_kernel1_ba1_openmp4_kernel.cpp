...
#include "./OpenMP4/update_halo_kernel1_ba1_openmp4_kernel_c.c"
...
#ifdef CHECKPOINTING
  if (!ops_checkpointing_before(args, 8, range, 55))
    return;
#endif

  if (OPS_diags > 1) {
    ops_timing_realloc(55, "update_halo_kernel1_ba1");
...
// ops_H_D_exchanges_host(args, 8);
  ...
  update_halo_kernel1_ba1_c_wrapper(p_a0, base0 / args[0].dat->elem_size, tot0,
