...
#define OPS_ACC0(x, y, z)                                                      \
  (n_x * 1 * 1 + n_y * xdim0_calc_dt_kernel_print * 1 * 1 +                    \
...
#define OPS_ACC1(x, y, z)                                                      \
  (n_x * 1 * 1 + n_y * xdim1_calc_dt_kernel_print * 1 * 1 +                    \
...
#define OPS_ACC2(x, y, z)                                                      \
  (n_x * 1 * 1 + n_y * xdim2_calc_dt_kernel_print * 1 * 1 +                    \
...
#define OPS_ACC3(x, y, z)                                                      \
  (n_x * 1 * 1 + n_y * xdim3_calc_dt_kernel_print * 1 * 1 +                    \
...
#define OPS_ACC4(x, y, z)                                                      \
  (n_x * 1 * 1 + n_y * xdim4_calc_dt_kernel_print * 1 * 1 +                    \
...
#define OPS_ACC5(x, y, z)                                                      \
  (n_x * 1 * 1 + n_y * xdim5_calc_dt_kernel_print * 1 * 1 +                    \
...
#define OPS_ACC6(x, y, z)                                                      \
  (n_x * 1 * 1 + n_y * xdim6_calc_dt_kernel_print * 1 * 1 +                    \
...
#pragma omp target teams distribute parallel for map(                           \
  ...
  for (int i = 0; i < y_size * x_size * z_size; i++) {
    ...
    const double *density0 = p_a3;

    const double *energy0 = p_a4;

    const double *pressure = p_a5;

    const double *soundspeed = p_a6;
