  ...
  for (int n_z = 0; n_z < z_size; n_z++) {
    ...
    for (int n_y = 0; n_y < y_size; n_y++) {
      ...
      for (int n_x = 0; n_x < x_size; n_x++) {
        ...
        sigmat = fabs(vol_flux_x[OPS_ACC0(0, 0, 0)]) /
                 pre_vol[OPS_ACC1(donor, 0, 0)];
        sigma3 = (1.0 + sigmat) *
        ...
        diffuw =
            density1[OPS_ACC4(donor, 0, 0)] - density1[OPS_ACC4(upwind, 0, 0)];
        diffdw = density1[OPS_ACC4(downwind, 0, 0)] -
                 density1[OPS_ACC4(donor, 0, 0)];
        ...
        sigmam =
            fabs(mass_flux_x[OPS_ACC6(0, 0, 0)]) /
            (density1[OPS_ACC4(donor, 0, 0)] * pre_vol[OPS_ACC1(donor, 0, 0)]);
        diffuw =
            energy1[OPS_ACC5(donor, 0, 0)] - energy1[OPS_ACC5(upwind, 0, 0)];
        diffdw =
            energy1[OPS_ACC5(downwind, 0, 0)] - energy1[OPS_ACC5(donor, 0, 0)];
