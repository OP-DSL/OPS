...
#define OPS_ACC0(x, y, z)                                                      \
  (n_x * 1 * 1 + n_y * xdim0_advec_cell_kernel3_zdir * 1 * 1 +                 \
...
#define OPS_ACC1(x, y, z)                                                      \
  (n_x * 1 * 1 + n_y * xdim1_advec_cell_kernel3_zdir * 1 * 1 +                 \
...
#define OPS_ACC2(x, y, z)                                                      \
  (n_x * 0 * 1 + n_y * xdim2_advec_cell_kernel3_zdir * 0 * 1 +                 \
...
#define OPS_ACC3(x, y, z)                                                      \
  (n_x * 0 * 1 + n_y * xdim3_advec_cell_kernel3_zdir * 0 * 1 +                 \
...
#define OPS_ACC4(x, y, z)                                                      \
  (n_x * 1 * 1 + n_y * xdim4_advec_cell_kernel3_zdir * 1 * 1 +                 \
...
#define OPS_ACC5(x, y, z)                                                      \
  (n_x * 1 * 1 + n_y * xdim5_advec_cell_kernel3_zdir * 1 * 1 +                 \
...
#define OPS_ACC6(x, y, z)                                                      \
  (n_x * 1 * 1 + n_y * xdim6_advec_cell_kernel3_zdir * 1 * 1 +                 \
...
#define OPS_ACC7(x, y, z)                                                      \
  (n_x * 1 * 1 + n_y * xdim7_advec_cell_kernel3_zdir * 1 * 1 +                 \
...
#pragma omp target teams distribute parallel for
  ...
  for (int i = 0; i < y_size * x_size * z_size; i++) {
    ...
    const double *vol_flux_z = p_a0;

    const double *pre_vol = p_a1;

    const int *zz = p_a2;

    const double *vertexdz = p_a3;

    const double *density1 = p_a4;

    const double *energy1 = p_a5;

    double *mass_flux_z = p_a6;
    ...
    sigmat =
        fabs(vol_flux_z[OPS_ACC0(0, 0, 0)]) / pre_vol[OPS_ACC1(0, 0, donor)];
    sigma3 = (1.0 + sigmat) *
    ...
    diffdw =
        density1[OPS_ACC4(0, 0, downwind)] - density1[OPS_ACC4(0, 0, donor)];
