...
#include "./OpenMP4/initialise_chunk_kernel_volume_openmp4_kernel_c.c"
...
#ifdef CHECKPOINTING
  if (!ops_checkpointing_before(args, 7, range, 140))
    return;
#endif

  if (OPS_diags > 1) {
    ops_timing_realloc(140, "initialise_chunk_kernel_volume");
...
// ops_H_D_exchanges_host(args, 7);
  ...
  initialise_chunk_kernel_volume_c_wrapper(
      ...
      base6 / args[6].dat->elem_size, tot6, x_size, y_size, z_size);
...
// ops_set_dirtybit_host(args, 7);
  ...
  if (OPS_diags > 1) {
    ...
    OPS_kernels[140].transfer += ops_compute_transfer(dim, start, end, &arg6);
  }
}
