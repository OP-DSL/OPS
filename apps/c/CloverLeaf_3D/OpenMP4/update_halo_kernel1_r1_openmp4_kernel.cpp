...
#include "./OpenMP4/update_halo_kernel1_r1_openmp4_kernel_c.c"
...
#ifdef CHECKPOINTING
  if (!ops_checkpointing_before(args, 8, range, 53))
    return;
#endif

  if (OPS_diags > 1) {
    ops_timing_realloc(53, "update_halo_kernel1_r1");
...
// ops_H_D_exchanges_host(args, 8);
  ...
  update_halo_kernel1_r1_c_wrapper(p_a0, base0 / args[0].dat->elem_size, tot0,
...
// ops_set_dirtybit_host(args, 8);
  ...
  if (OPS_diags > 1) {
    ...
    OPS_kernels[53].transfer += ops_compute_transfer(dim, start, end, &arg6);
  }
}
