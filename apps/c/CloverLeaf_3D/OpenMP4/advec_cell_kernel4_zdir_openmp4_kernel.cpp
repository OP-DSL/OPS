...
//
#include "./OpenMP4/advec_cell_kernel4_zdir_openmp4_kernel_c.c"
...
// ops_H_D_exchanges_host(args, 11);
  ...
  advec_cell_kernel4_zdir_c_wrapper(p_a0, base0 / args[0].dat->elem_size, tot0,
