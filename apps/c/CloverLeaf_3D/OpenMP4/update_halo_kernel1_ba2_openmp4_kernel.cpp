...
#include "./OpenMP4/update_halo_kernel1_ba2_openmp4_kernel_c.c"
...
#ifdef CHECKPOINTING
  if (!ops_checkpointing_before(args, 8, range, 54))
    return;
#endif

  if (OPS_diags > 1) {
    ops_timing_realloc(54, "update_halo_kernel1_ba2");
...
// ops_H_D_exchanges_host(args, 8);
  ...
  update_halo_kernel1_ba2_c_wrapper(p_a0, base0 / args[0].dat->elem_size, tot0,
...
// ops_set_dirtybit_host(args, 8);
  ...
  if (OPS_diags > 1) {
    ...
    OPS_kernels[54].transfer += ops_compute_transfer(dim, start, end, &arg6);
  }
}
