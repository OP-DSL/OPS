...
#define OPS_ACC0(x, y, z)                                                      \
  (n_x * 1 * 1 + n_y * xdim0_PdV_kernel_nopredict * 1 * 1 +                    \
   n_z * xdim0_PdV_kernel_nopredict * ydim0_PdV_kernel_nopredict * 1 + x +     \
   xdim0_PdV_kernel_nopredict * (y) +                                          \
   xdim0_PdV_kernel_nopredict * ydim0_PdV_kernel_nopredict * (z))
#define OPS_ACC1(x, y, z)                                                      \
  (n_x * 1 * 1 + n_y * xdim1_PdV_kernel_nopredict * 1 * 1 +                    \
   n_z * xdim1_PdV_kernel_nopredict * ydim1_PdV_kernel_nopredict * 1 + x +     \
   xdim1_PdV_kernel_nopredict * (y) +                                          \
   xdim1_PdV_kernel_nopredict * ydim1_PdV_kernel_nopredict * (z))
#define OPS_ACC2(x, y, z)                                                      \
  (n_x * 1 * 1 + n_y * xdim2_PdV_kernel_nopredict * 1 * 1 +                    \
   n_z * xdim2_PdV_kernel_nopredict * ydim2_PdV_kernel_nopredict * 1 + x +     \
   xdim2_PdV_kernel_nopredict * (y) +                                          \
   xdim2_PdV_kernel_nopredict * ydim2_PdV_kernel_nopredict * (z))
#define OPS_ACC3(x, y, z)                                                      \
  (n_x * 1 * 1 + n_y * xdim3_PdV_kernel_nopredict * 1 * 1 +                    \
   n_z * xdim3_PdV_kernel_nopredict * ydim3_PdV_kernel_nopredict * 1 + x +     \
   xdim3_PdV_kernel_nopredict * (y) +                                          \
   xdim3_PdV_kernel_nopredict * ydim3_PdV_kernel_nopredict * (z))
#define OPS_ACC4(x, y, z)                                                      \
  (n_x * 1 * 1 + n_y * xdim4_PdV_kernel_nopredict * 1 * 1 +                    \
   n_z * xdim4_PdV_kernel_nopredict * ydim4_PdV_kernel_nopredict * 1 + x +     \
   xdim4_PdV_kernel_nopredict * (y) +                                          \
   xdim4_PdV_kernel_nopredict * ydim4_PdV_kernel_nopredict * (z))
#define OPS_ACC5(x, y, z)                                                      \
  (n_x * 1 * 1 + n_y * xdim5_PdV_kernel_nopredict * 1 * 1 +                    \
   n_z * xdim5_PdV_kernel_nopredict * ydim5_PdV_kernel_nopredict * 1 + x +     \
   xdim5_PdV_kernel_nopredict * (y) +                                          \
   xdim5_PdV_kernel_nopredict * ydim5_PdV_kernel_nopredict * (z))
#define OPS_ACC6(x, y, z)                                                      \
  (n_x * 1 * 1 + n_y * xdim6_PdV_kernel_nopredict * 1 * 1 +                    \
   n_z * xdim6_PdV_kernel_nopredict * ydim6_PdV_kernel_nopredict * 1 + x +     \
   xdim6_PdV_kernel_nopredict * (y) +                                          \
   xdim6_PdV_kernel_nopredict * ydim6_PdV_kernel_nopredict * (z))
#define OPS_ACC7(x, y, z)                                                      \
  (n_x * 1 * 1 + n_y * xdim7_PdV_kernel_nopredict * 1 * 1 +                    \
   n_z * xdim7_PdV_kernel_nopredict * ydim7_PdV_kernel_nopredict * 1 + x +     \
   xdim7_PdV_kernel_nopredict * (y) +                                          \
   xdim7_PdV_kernel_nopredict * ydim7_PdV_kernel_nopredict * (z))
#define OPS_ACC8(x, y, z)                                                      \
  (n_x * 1 * 1 + n_y * xdim8_PdV_kernel_nopredict * 1 * 1 +                    \
   n_z * xdim8_PdV_kernel_nopredict * ydim8_PdV_kernel_nopredict * 1 + x +     \
   xdim8_PdV_kernel_nopredict * (y) +                                          \
   xdim8_PdV_kernel_nopredict * ydim8_PdV_kernel_nopredict * (z))
#define OPS_ACC9(x, y, z)                                                      \
  (n_x * 1 * 1 + n_y * xdim9_PdV_kernel_nopredict * 1 * 1 +                    \
   n_z * xdim9_PdV_kernel_nopredict * ydim9_PdV_kernel_nopredict * 1 + x +     \
   xdim9_PdV_kernel_nopredict * (y) +                                          \
   xdim9_PdV_kernel_nopredict * ydim9_PdV_kernel_nopredict * (z))
#define OPS_ACC10(x, y, z)                                                     \
  (n_x * 1 * 1 + n_y * xdim10_PdV_kernel_nopredict * 1 * 1 +                   \
   n_z * xdim10_PdV_kernel_nopredict * ydim10_PdV_kernel_nopredict * 1 + x +   \
   xdim10_PdV_kernel_nopredict * (y) +                                         \
   xdim10_PdV_kernel_nopredict * ydim10_PdV_kernel_nopredict * (z))
#define OPS_ACC11(x, y, z)                                                     \
  (n_x * 1 * 1 + n_y * xdim11_PdV_kernel_nopredict * 1 * 1 +                   \
   n_z * xdim11_PdV_kernel_nopredict * ydim11_PdV_kernel_nopredict * 1 + x +   \
   xdim11_PdV_kernel_nopredict * (y) +                                         \
   xdim11_PdV_kernel_nopredict * ydim11_PdV_kernel_nopredict * (z))
#define OPS_ACC12(x, y, z)                                                     \
  (n_x * 1 * 1 + n_y * xdim12_PdV_kernel_nopredict * 1 * 1 +                   \
   n_z * xdim12_PdV_kernel_nopredict * ydim12_PdV_kernel_nopredict * 1 + x +   \
   xdim12_PdV_kernel_nopredict * (y) +                                         \
   xdim12_PdV_kernel_nopredict * ydim12_PdV_kernel_nopredict * (z))
#define OPS_ACC13(x, y, z)                                                     \
  (n_x * 1 * 1 + n_y * xdim13_PdV_kernel_nopredict * 1 * 1 +                   \
   n_z * xdim13_PdV_kernel_nopredict * ydim13_PdV_kernel_nopredict * 1 + x +   \
   xdim13_PdV_kernel_nopredict * (y) +                                         \
   xdim13_PdV_kernel_nopredict * ydim13_PdV_kernel_nopredict * (z))
#define OPS_ACC14(x, y, z)                                                     \
  (n_x * 1 * 1 + n_y * xdim14_PdV_kernel_nopredict * 1 * 1 +                   \
   n_z * xdim14_PdV_kernel_nopredict * ydim14_PdV_kernel_nopredict * 1 + x +   \
   xdim14_PdV_kernel_nopredict * (y) +                                         \
   xdim14_PdV_kernel_nopredict * ydim14_PdV_kernel_nopredict * (z))
#define OPS_ACC15(x, y, z)                                                     \
  (n_x * 1 * 1 + n_y * xdim15_PdV_kernel_nopredict * 1 * 1 +                   \
   n_z * xdim15_PdV_kernel_nopredict * ydim15_PdV_kernel_nopredict * 1 + x +   \
   xdim15_PdV_kernel_nopredict * (y) +                                         \
   xdim15_PdV_kernel_nopredict * ydim15_PdV_kernel_nopredict * (z))
#define OPS_ACC16(x, y, z)                                                     \
  (n_x * 1 * 1 + n_y * xdim16_PdV_kernel_nopredict * 1 * 1 +                   \
   n_z * xdim16_PdV_kernel_nopredict * ydim16_PdV_kernel_nopredict * 1 + x +   \
   xdim16_PdV_kernel_nopredict * (y) +                                         \
...
#pragma omp target teams distribute parallel for
  ...
  for (int i = 0; i < y_size * x_size * z_size; i++) {
    ...
    const double *zarea = p_a14;

    const double *zvel0 = p_a15;

    const double *zvel1 = p_a16;
