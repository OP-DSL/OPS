...
#else
#ifdef OPS_HYBRID
void ops_par_loop_update_halo_kernel2_zvel_plus_2_right_execute_gpu(ops_kernel_descriptor *desc) {
#else
void ops_par_loop_update_halo_kernel2_zvel_plus_2_right_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_update_halo_kernel2_zvel_plus_2_right_h || ydim0 != ydim0_update_halo_kernel2_zvel_plus_2_right_h || xdim1 != xdim1_update_halo_kernel2_zvel_plus_2_right_h || ydim1 != ydim1_update_halo_kernel2_zvel_plus_2_right_h) {
    cudaMemcpyToSymbolAsync( xdim0_update_halo_kernel2_zvel_plus_2_right, &xdim0, sizeof(int),0 );
    xdim0_update_halo_kernel2_zvel_plus_2_right_h = xdim0;
    cudaMemcpyToSymbolAsync( ydim0_update_halo_kernel2_zvel_plus_2_right, &ydim0, sizeof(int),0 );
    ydim0_update_halo_kernel2_zvel_plus_2_right_h = ydim0;
    cudaMemcpyToSymbolAsync( xdim1_update_halo_kernel2_zvel_plus_2_right, &xdim1, sizeof(int),0 );
    xdim1_update_halo_kernel2_zvel_plus_2_right_h = xdim1;
    cudaMemcpyToSymbolAsync( ydim1_update_halo_kernel2_zvel_plus_2_right, &ydim1, sizeof(int),0 );
...
void ops_par_loop_update_halo_kernel2_zvel_plus_2_right_execute(ops_kernel_descriptor *desc) {
  if (desc->device == 1) {
    ops_par_loop_update_halo_kernel2_zvel_plus_2_right_execute_gpu(desc);
  }
  else {
    ops_par_loop_update_halo_kernel2_zvel_plus_2_right_execute_cpu(desc);
  }
}
#endif
