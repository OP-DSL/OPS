...
int size2 ){
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ...
    initialise_chunk_kernel_cellz_gpu(argp0,
                   argp1,
                   argp2);
  }
...
void ops_par_loop_initialise_chunk_kernel_cellz_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_initialise_chunk_kernel_cellz_h[0][0] || ydim0 != dims_initialise_chunk_kernel_cellz_h[0][1] || xdim1 != dims_initialise_chunk_kernel_cellz_h[1][0] || ydim1 != dims_initialise_chunk_kernel_cellz_h[1][1] || xdim2 != dims_initialise_chunk_kernel_cellz_h[2][0] || ydim2 != dims_initialise_chunk_kernel_cellz_h[2][1]) {
    ...
    cutilSafeCall(cudaMemcpyToSymbol( dims_initialise_chunk_kernel_cellz, dims_initialise_chunk_kernel_cellz_h, sizeof(dims_initialise_chunk_kernel_cellz)));
  }
