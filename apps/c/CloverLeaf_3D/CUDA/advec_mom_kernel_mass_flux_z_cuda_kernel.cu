...
#else
#ifdef OPS_HYBRID
void ops_par_loop_advec_mom_kernel_mass_flux_z_execute_gpu(ops_kernel_descriptor *desc) {
#else
void ops_par_loop_advec_mom_kernel_mass_flux_z_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_advec_mom_kernel_mass_flux_z_h || ydim0 != ydim0_advec_mom_kernel_mass_flux_z_h || xdim1 != xdim1_advec_mom_kernel_mass_flux_z_h || ydim1 != ydim1_advec_mom_kernel_mass_flux_z_h) {
    cudaMemcpyToSymbolAsync( xdim0_advec_mom_kernel_mass_flux_z, &xdim0, sizeof(int),0 );
    xdim0_advec_mom_kernel_mass_flux_z_h = xdim0;
    cudaMemcpyToSymbolAsync( ydim0_advec_mom_kernel_mass_flux_z, &ydim0, sizeof(int),0 );
    ydim0_advec_mom_kernel_mass_flux_z_h = ydim0;
    cudaMemcpyToSymbolAsync( xdim1_advec_mom_kernel_mass_flux_z, &xdim1, sizeof(int),0 );
    xdim1_advec_mom_kernel_mass_flux_z_h = xdim1;
    cudaMemcpyToSymbolAsync( ydim1_advec_mom_kernel_mass_flux_z, &ydim1, sizeof(int),0 );
...
void ops_par_loop_advec_mom_kernel_mass_flux_z_execute(ops_kernel_descriptor *desc) {
  if (desc->device == 1) {
    ops_par_loop_advec_mom_kernel_mass_flux_z_execute_gpu(desc);
  }
  else {
    ops_par_loop_advec_mom_kernel_mass_flux_z_execute_cpu(desc);
  }
}
#endif
