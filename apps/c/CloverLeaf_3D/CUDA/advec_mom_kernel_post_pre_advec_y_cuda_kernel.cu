...
__device__
    ...
    inline void
    advec_mom_kernel_post_pre_advec_y(double *node_mass_post,
...
__global__ void ops_advec_mom_kernel_post_pre_advec_y(
  ...
  arg0 += idx_x * 1 * 1 +
          ...
          idx_z * 1 * 1 * xdim0_advec_mom_kernel_post_pre_advec_y *
...
void ops_par_loop_advec_mom_kernel_post_pre_advec_y(
  ...
  if (xdim0 != xdim0_advec_mom_kernel_post_pre_advec_y_h ||
    ...
    cudaMemcpyToSymbol(ydim0_advec_mom_kernel_post_pre_advec_y, &ydim0,
                       sizeof(int));
    ...
    cudaMemcpyToSymbol(ydim1_advec_mom_kernel_post_pre_advec_y, &ydim1,
                       sizeof(int));
    ...
    cudaMemcpyToSymbol(ydim2_advec_mom_kernel_post_pre_advec_y, &ydim2,
                       sizeof(int));
    ...
    cudaMemcpyToSymbol(ydim3_advec_mom_kernel_post_pre_advec_y, &ydim3,
                       sizeof(int));
    ...
    cudaMemcpyToSymbol(ydim4_advec_mom_kernel_post_pre_advec_y, &ydim4,
                       sizeof(int));
