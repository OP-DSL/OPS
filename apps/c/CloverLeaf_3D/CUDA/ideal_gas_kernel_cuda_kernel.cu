...
#else
#ifdef OPS_HYBRID
void ops_par_loop_ideal_gas_kernel_execute_gpu(ops_kernel_descriptor *desc) {
#else
void ops_par_loop_ideal_gas_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_ideal_gas_kernel_h || ydim0 != ydim0_ideal_gas_kernel_h || xdim1 != xdim1_ideal_gas_kernel_h || ydim1 != ydim1_ideal_gas_kernel_h || xdim2 != xdim2_ideal_gas_kernel_h || ydim2 != ydim2_ideal_gas_kernel_h || xdim3 != xdim3_ideal_gas_kernel_h || ydim3 != ydim3_ideal_gas_kernel_h) {
    ...
    cudaMemcpyToSymbolAsync( ydim0_ideal_gas_kernel, &ydim0, sizeof(int),0 );
    ...
    cudaMemcpyToSymbolAsync( ydim1_ideal_gas_kernel, &ydim1, sizeof(int),0 );
    ...
    cudaMemcpyToSymbolAsync( ydim2_ideal_gas_kernel, &ydim2, sizeof(int),0 );
    ...
    cudaMemcpyToSymbolAsync( ydim3_ideal_gas_kernel, &ydim3, sizeof(int),0 );
...
void ops_par_loop_ideal_gas_kernel_execute(ops_kernel_descriptor *desc) {
  if (desc->device == 1) {
    ops_par_loop_ideal_gas_kernel_execute_gpu(desc);
  }
  else {
    ops_par_loop_ideal_gas_kernel_execute_cpu(desc);
  }
}
#endif
