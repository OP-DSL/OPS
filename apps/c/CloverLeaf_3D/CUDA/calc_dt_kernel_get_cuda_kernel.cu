...
#define OPS_ACC0(x, y, z)                                                      \
  (x + dims_calc_dt_kernel_get[0][0] * (y) +                                   \
   dims_calc_dt_kernel_get[0][0] * dims_calc_dt_kernel_get[0][1] * (z))
#define OPS_ACC1(x, y, z)                                                      \
  (x + dims_calc_dt_kernel_get[1][0] * (y) +                                   \
   dims_calc_dt_kernel_get[1][0] * dims_calc_dt_kernel_get[1][1] * (z))
#define OPS_ACC4(x, y, z)                                                      \
  (x + dims_calc_dt_kernel_get[4][0] * (y) +                                   \
   dims_calc_dt_kernel_get[4][0] * dims_calc_dt_kernel_get[4][1] * (z))
...
__global__ void ops_calc_dt_kernel_get(const double *__restrict arg0,
  ...
  arg0 += idx_x * 1 * 1 + idx_y * 0 * 1 * dims_calc_dt_kernel_get[0][0] +
          idx_z * 0 * 1 * dims_calc_dt_kernel_get[0][0] *
              dims_calc_dt_kernel_get[0][1];
  arg1 += idx_x * 0 * 1 + idx_y * 1 * 1 * dims_calc_dt_kernel_get[1][0] +
          idx_z * 0 * 1 * dims_calc_dt_kernel_get[1][0] *
              dims_calc_dt_kernel_get[1][1];
  arg4 += idx_x * 0 * 1 + idx_y * 0 * 1 * dims_calc_dt_kernel_get[4][0] +
          idx_z * 1 * 1 * dims_calc_dt_kernel_get[4][0] *
              dims_calc_dt_kernel_get[4][1];
...
void ops_par_loop_calc_dt_kernel_get_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_calc_dt_kernel_get_h[0][0] ||
      ydim0 != dims_calc_dt_kernel_get_h[0][1] ||
      xdim1 != dims_calc_dt_kernel_get_h[1][0] ||
      ydim1 != dims_calc_dt_kernel_get_h[1][1] ||
      xdim4 != dims_calc_dt_kernel_get_h[4][0] ||
      ydim4 != dims_calc_dt_kernel_get_h[4][1]) {
