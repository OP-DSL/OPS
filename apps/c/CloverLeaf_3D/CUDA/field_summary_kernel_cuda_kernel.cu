...
void CUDART_CB field_summary_kernel_reduce_callback(cudaStream_t stream, cudaError_t status, void *data) {
  ...
  double*arg8h = *(double**)(&buf[sizeof(int)+1*2*(sizeof(int*))]);
  double*arg8data = *(double**)(&buf[sizeof(int)+1*2*(sizeof(int*))+sizeof(int*)]);
  double*arg9h = *(double**)(&buf[sizeof(int)+2*2*(sizeof(int*))]);
  double*arg9data = *(double**)(&buf[sizeof(int)+2*2*(sizeof(int*))+sizeof(int*)]);
  double*arg10h = *(double**)(&buf[sizeof(int)+3*2*(sizeof(int*))]);
  double*arg10data = *(double**)(&buf[sizeof(int)+3*2*(sizeof(int*))+sizeof(int*)]);
  double*arg11h = *(double**)(&buf[sizeof(int)+4*2*(sizeof(int*))]);
  double*arg11data = *(double**)(&buf[sizeof(int)+4*2*(sizeof(int*))+sizeof(int*)]);
  ...
  for ( int b=0; b<maxblocks; b++ ){
    for ( int d=0; d<1; d++ ){
      arg11h[d] = arg11h[d] + arg11data[d+b*1];
    }
  }
...
#else
#ifdef OPS_HYBRID
void ops_par_loop_field_summary_kernel_execute_gpu(ops_kernel_descriptor *desc) {
#else
void ops_par_loop_field_summary_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_field_summary_kernel_h || ydim0 != ydim0_field_summary_kernel_h || xdim1 != xdim1_field_summary_kernel_h || ydim1 != ydim1_field_summary_kernel_h || xdim2 != xdim2_field_summary_kernel_h || ydim2 != ydim2_field_summary_kernel_h || xdim3 != xdim3_field_summary_kernel_h || ydim3 != ydim3_field_summary_kernel_h || xdim4 != xdim4_field_summary_kernel_h || ydim4 != ydim4_field_summary_kernel_h || xdim5 != xdim5_field_summary_kernel_h || ydim5 != ydim5_field_summary_kernel_h || xdim6 != xdim6_field_summary_kernel_h || ydim6 != ydim6_field_summary_kernel_h) {
    ...
    cudaMemcpyToSymbolAsync( ydim0_field_summary_kernel, &ydim0, sizeof(int),0 );
    ...
    cudaMemcpyToSymbolAsync( ydim1_field_summary_kernel, &ydim1, sizeof(int),0 );
    ...
    cudaMemcpyToSymbolAsync( ydim2_field_summary_kernel, &ydim2, sizeof(int),0 );
    ...
    cudaMemcpyToSymbolAsync( ydim3_field_summary_kernel, &ydim3, sizeof(int),0 );
    ...
    cudaMemcpyToSymbolAsync( ydim4_field_summary_kernel, &ydim4, sizeof(int),0 );
    ...
    cudaMemcpyToSymbolAsync( ydim5_field_summary_kernel, &ydim5, sizeof(int),0 );
    ydim5_field_summary_kernel_h = ydim5;
    cudaMemcpyToSymbolAsync( xdim6_field_summary_kernel, &xdim6, sizeof(int),0 );
    xdim6_field_summary_kernel_h = xdim6;
    cudaMemcpyToSymbolAsync( ydim6_field_summary_kernel, &ydim6, sizeof(int),0 );
  ...
  if (ops_hybrid) arg11h =  (double *)(((ops_reduction)args[11].data)->data + ((ops_reduction)args[11].data)->size * (2*block->index+1));
  #else
  double *arg11h = (double *)(((ops_reduction)args[11].data)->data);
  if (ops_hybrid) arg11h = (double *)(((ops_reduction)args[11].data)->data + ((ops_reduction)args[11].data)->size);
  #endif
  ...
  if (ops_hybrid) {
    ...
    *(double**)(&buf[sizeof(int)+1*2*(sizeof(int*))]) = arg8h;
    *(char**)(&buf[sizeof(int)+1*2*(sizeof(int*))+sizeof(int*)]) = arg8.data;
    arg8.data = (char *)arg8h;
    *(double**)(&buf[sizeof(int)+2*2*(sizeof(int*))]) = arg9h;
    *(char**)(&buf[sizeof(int)+2*2*(sizeof(int*))+sizeof(int*)]) = arg9.data;
    arg9.data = (char *)arg9h;
    *(double**)(&buf[sizeof(int)+3*2*(sizeof(int*))]) = arg10h;
    *(char**)(&buf[sizeof(int)+3*2*(sizeof(int*))+sizeof(int*)]) = arg10.data;
    arg10.data = (char *)arg10h;
    *(double**)(&buf[sizeof(int)+4*2*(sizeof(int*))]) = arg11h;
    *(char**)(&buf[sizeof(int)+4*2*(sizeof(int*))+sizeof(int*)]) = arg11.data;
...
#ifdef OPS_HYBRID
void ops_par_loop_field_summary_kernel_execute_cpu(ops_kernel_descriptor *desc);
void ops_par_loop_field_summary_kernel_execute(ops_kernel_descriptor *desc) {
  if (desc->device == 1) {
    ops_par_loop_field_summary_kernel_execute_gpu(desc);
  }
  else {
    ops_par_loop_field_summary_kernel_execute_cpu(desc);
  }
}
#endif
