...
#else
#ifdef OPS_HYBRID
void ops_par_loop_advec_mom_kernel_mass_flux_y_execute_gpu(ops_kernel_descriptor *desc) {
#else
void ops_par_loop_advec_mom_kernel_mass_flux_y_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_advec_mom_kernel_mass_flux_y_h || ydim0 != ydim0_advec_mom_kernel_mass_flux_y_h || xdim1 != xdim1_advec_mom_kernel_mass_flux_y_h || ydim1 != ydim1_advec_mom_kernel_mass_flux_y_h) {
    cudaMemcpyToSymbolAsync( xdim0_advec_mom_kernel_mass_flux_y, &xdim0, sizeof(int),0 );
    xdim0_advec_mom_kernel_mass_flux_y_h = xdim0;
    cudaMemcpyToSymbolAsync( ydim0_advec_mom_kernel_mass_flux_y, &ydim0, sizeof(int),0 );
    ydim0_advec_mom_kernel_mass_flux_y_h = ydim0;
    cudaMemcpyToSymbolAsync( xdim1_advec_mom_kernel_mass_flux_y, &xdim1, sizeof(int),0 );
    xdim1_advec_mom_kernel_mass_flux_y_h = xdim1;
    cudaMemcpyToSymbolAsync( ydim1_advec_mom_kernel_mass_flux_y, &ydim1, sizeof(int),0 );
...
#ifdef OPS_HYBRID
void ops_par_loop_advec_mom_kernel_mass_flux_y_execute_cpu(ops_kernel_descriptor *desc);
void ops_par_loop_advec_mom_kernel_mass_flux_y_execute(ops_kernel_descriptor *desc) {
  if (desc->device == 1) {
    ops_par_loop_advec_mom_kernel_mass_flux_y_execute_gpu(desc);
  }
  else {
    ops_par_loop_advec_mom_kernel_mass_flux_y_execute_cpu(desc);
  }
}
#endif
