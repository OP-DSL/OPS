...
#define OPS_ACC0(x, y, z)                                                      \
  (x + dims_advec_mom_kernel_mass_flux_y[0][0] * (y) +                         \
   dims_advec_mom_kernel_mass_flux_y[0][0] *                                   \
       dims_advec_mom_kernel_mass_flux_y[0][1] * (z))
#define OPS_ACC1(x, y, z)                                                      \
  (x + dims_advec_mom_kernel_mass_flux_y[1][0] * (y) +                         \
   dims_advec_mom_kernel_mass_flux_y[1][0] *                                   \
       dims_advec_mom_kernel_mass_flux_y[1][1] * (z))

// user function
__device__

    inline void
    advec_mom_kernel_mass_flux_y_gpu(double *node_flux,
...
__global__ void ops_advec_mom_kernel_mass_flux_y(double *__restrict arg0,
  ...
  arg0 += idx_x * 1 * 1 +
          idx_y * 1 * 1 * dims_advec_mom_kernel_mass_flux_y[0][0] +
          idx_z * 1 * 1 * dims_advec_mom_kernel_mass_flux_y[0][0] *
              dims_advec_mom_kernel_mass_flux_y[0][1];
  arg1 += idx_x * 1 * 1 +
          idx_y * 1 * 1 * dims_advec_mom_kernel_mass_flux_y[1][0] +
          idx_z * 1 * 1 * dims_advec_mom_kernel_mass_flux_y[1][0] *
              dims_advec_mom_kernel_mass_flux_y[1][1];
...
void ops_par_loop_advec_mom_kernel_mass_flux_y_execute(
  ...
  if (xdim0 != dims_advec_mom_kernel_mass_flux_y_h[0][0] ||
      ydim0 != dims_advec_mom_kernel_mass_flux_y_h[0][1] ||
      xdim1 != dims_advec_mom_kernel_mass_flux_y_h[1][0] ||
      ydim1 != dims_advec_mom_kernel_mass_flux_y_h[1][1]) {
    ...
    cutilSafeCall(cudaMemcpyToSymbol(
        dims_advec_mom_kernel_mass_flux_y, dims_advec_mom_kernel_mass_flux_y_h,
        sizeof(dims_advec_mom_kernel_mass_flux_y)));
  }
