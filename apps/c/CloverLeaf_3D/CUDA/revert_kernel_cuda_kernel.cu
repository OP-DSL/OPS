...
#else
#ifdef OPS_HYBRID
void ops_par_loop_revert_kernel_execute_gpu(ops_kernel_descriptor *desc) {
#else
void ops_par_loop_revert_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_revert_kernel_h || ydim0 != ydim0_revert_kernel_h || xdim1 != xdim1_revert_kernel_h || ydim1 != ydim1_revert_kernel_h || xdim2 != xdim2_revert_kernel_h || ydim2 != ydim2_revert_kernel_h || xdim3 != xdim3_revert_kernel_h || ydim3 != ydim3_revert_kernel_h) {
    cudaMemcpyToSymbolAsync( xdim0_revert_kernel, &xdim0, sizeof(int),0 );
    xdim0_revert_kernel_h = xdim0;
    cudaMemcpyToSymbolAsync( ydim0_revert_kernel, &ydim0, sizeof(int),0 );
    ydim0_revert_kernel_h = ydim0;
    cudaMemcpyToSymbolAsync( xdim1_revert_kernel, &xdim1, sizeof(int),0 );
    xdim1_revert_kernel_h = xdim1;
    cudaMemcpyToSymbolAsync( ydim1_revert_kernel, &ydim1, sizeof(int),0 );
    ydim1_revert_kernel_h = ydim1;
    cudaMemcpyToSymbolAsync( xdim2_revert_kernel, &xdim2, sizeof(int),0 );
    xdim2_revert_kernel_h = xdim2;
    cudaMemcpyToSymbolAsync( ydim2_revert_kernel, &ydim2, sizeof(int),0 );
    ydim2_revert_kernel_h = ydim2;
    cudaMemcpyToSymbolAsync( xdim3_revert_kernel, &xdim3, sizeof(int),0 );
    xdim3_revert_kernel_h = xdim3;
    cudaMemcpyToSymbolAsync( ydim3_revert_kernel, &ydim3, sizeof(int),0 );
...
#ifdef OPS_HYBRID
void ops_par_loop_revert_kernel_execute_cpu(ops_kernel_descriptor *desc);
void ops_par_loop_revert_kernel_execute(ops_kernel_descriptor *desc) {
  if (desc->device == 1) {
    ops_par_loop_revert_kernel_execute_gpu(desc);
  }
  else {
    ops_par_loop_revert_kernel_execute_cpu(desc);
  }
}
#endif
