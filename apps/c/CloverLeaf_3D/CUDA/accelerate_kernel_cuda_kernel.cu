...
#else
#ifdef OPS_HYBRID
void ops_par_loop_accelerate_kernel_execute_gpu(ops_kernel_descriptor *desc) {
#else
void ops_par_loop_accelerate_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_accelerate_kernel_h || ydim0 != ydim0_accelerate_kernel_h || xdim1 != xdim1_accelerate_kernel_h || ydim1 != ydim1_accelerate_kernel_h || xdim2 != xdim2_accelerate_kernel_h || ydim2 != ydim2_accelerate_kernel_h || xdim3 != xdim3_accelerate_kernel_h || ydim3 != ydim3_accelerate_kernel_h || xdim4 != xdim4_accelerate_kernel_h || ydim4 != ydim4_accelerate_kernel_h || xdim5 != xdim5_accelerate_kernel_h || ydim5 != ydim5_accelerate_kernel_h || xdim6 != xdim6_accelerate_kernel_h || ydim6 != ydim6_accelerate_kernel_h || xdim7 != xdim7_accelerate_kernel_h || ydim7 != ydim7_accelerate_kernel_h || xdim8 != xdim8_accelerate_kernel_h || ydim8 != ydim8_accelerate_kernel_h || xdim9 != xdim9_accelerate_kernel_h || ydim9 != ydim9_accelerate_kernel_h || xdim10 != xdim10_accelerate_kernel_h || ydim10 != ydim10_accelerate_kernel_h || xdim11 != xdim11_accelerate_kernel_h || ydim11 != ydim11_accelerate_kernel_h || xdim12 != xdim12_accelerate_kernel_h || ydim12 != ydim12_accelerate_kernel_h || xdim13 != xdim13_accelerate_kernel_h || ydim13 != ydim13_accelerate_kernel_h) {
    ...
    cudaMemcpyToSymbolAsync( ydim0_accelerate_kernel, &ydim0, sizeof(int),0 );
    ...
    cudaMemcpyToSymbolAsync( ydim1_accelerate_kernel, &ydim1, sizeof(int),0 );
    ...
    cudaMemcpyToSymbolAsync( ydim2_accelerate_kernel, &ydim2, sizeof(int),0 );
    ...
    cudaMemcpyToSymbolAsync( ydim3_accelerate_kernel, &ydim3, sizeof(int),0 );
    ...
    cudaMemcpyToSymbolAsync( ydim4_accelerate_kernel, &ydim4, sizeof(int),0 );
    ...
    cudaMemcpyToSymbolAsync( ydim5_accelerate_kernel, &ydim5, sizeof(int),0 );
    ...
    cudaMemcpyToSymbolAsync( ydim6_accelerate_kernel, &ydim6, sizeof(int),0 );
    ...
    cudaMemcpyToSymbolAsync( ydim7_accelerate_kernel, &ydim7, sizeof(int),0 );
    ...
    cudaMemcpyToSymbolAsync( ydim8_accelerate_kernel, &ydim8, sizeof(int),0 );
    ...
    cudaMemcpyToSymbolAsync( ydim9_accelerate_kernel, &ydim9, sizeof(int),0 );
    ...
    cudaMemcpyToSymbolAsync( ydim10_accelerate_kernel, &ydim10, sizeof(int),0 );
    ydim10_accelerate_kernel_h = ydim10;
    cudaMemcpyToSymbolAsync( xdim11_accelerate_kernel, &xdim11, sizeof(int),0 );
    xdim11_accelerate_kernel_h = xdim11;
    cudaMemcpyToSymbolAsync( ydim11_accelerate_kernel, &ydim11, sizeof(int),0 );
    ydim11_accelerate_kernel_h = ydim11;
    cudaMemcpyToSymbolAsync( xdim12_accelerate_kernel, &xdim12, sizeof(int),0 );
    xdim12_accelerate_kernel_h = xdim12;
    cudaMemcpyToSymbolAsync( ydim12_accelerate_kernel, &ydim12, sizeof(int),0 );
    ydim12_accelerate_kernel_h = ydim12;
    cudaMemcpyToSymbolAsync( xdim13_accelerate_kernel, &xdim13, sizeof(int),0 );
    xdim13_accelerate_kernel_h = xdim13;
    cudaMemcpyToSymbolAsync( ydim13_accelerate_kernel, &ydim13, sizeof(int),0 );
...
void ops_par_loop_accelerate_kernel_execute(ops_kernel_descriptor *desc) {
  if (desc->device == 1) {
    ops_par_loop_accelerate_kernel_execute_gpu(desc);
  }
  else {
    ops_par_loop_accelerate_kernel_execute_cpu(desc);
  }
}
#endif
