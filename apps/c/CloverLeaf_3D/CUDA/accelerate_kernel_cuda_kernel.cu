...
#define OPS_ACC0(x,y,z) (x+dims_accelerate_kernel[0][0]*(y)+dims_accelerate_kernel[0][0]*dims_accelerate_kernel[0][1]*(z))
#define OPS_ACC1(x,y,z) (x+dims_accelerate_kernel[1][0]*(y)+dims_accelerate_kernel[1][0]*dims_accelerate_kernel[1][1]*(z))
#define OPS_ACC2(x,y,z) (x+dims_accelerate_kernel[2][0]*(y)+dims_accelerate_kernel[2][0]*dims_accelerate_kernel[2][1]*(z))
#define OPS_ACC3(x,y,z) (x+dims_accelerate_kernel[3][0]*(y)+dims_accelerate_kernel[3][0]*dims_accelerate_kernel[3][1]*(z))
#define OPS_ACC4(x,y,z) (x+dims_accelerate_kernel[4][0]*(y)+dims_accelerate_kernel[4][0]*dims_accelerate_kernel[4][1]*(z))
#define OPS_ACC5(x,y,z) (x+dims_accelerate_kernel[5][0]*(y)+dims_accelerate_kernel[5][0]*dims_accelerate_kernel[5][1]*(z))
#define OPS_ACC6(x,y,z) (x+dims_accelerate_kernel[6][0]*(y)+dims_accelerate_kernel[6][0]*dims_accelerate_kernel[6][1]*(z))
#define OPS_ACC7(x,y,z) (x+dims_accelerate_kernel[7][0]*(y)+dims_accelerate_kernel[7][0]*dims_accelerate_kernel[7][1]*(z))
#define OPS_ACC8(x,y,z) (x+dims_accelerate_kernel[8][0]*(y)+dims_accelerate_kernel[8][0]*dims_accelerate_kernel[8][1]*(z))
#define OPS_ACC9(x,y,z) (x+dims_accelerate_kernel[9][0]*(y)+dims_accelerate_kernel[9][0]*dims_accelerate_kernel[9][1]*(z))
#define OPS_ACC10(x,y,z) (x+dims_accelerate_kernel[10][0]*(y)+dims_accelerate_kernel[10][0]*dims_accelerate_kernel[10][1]*(z))
#define OPS_ACC11(x,y,z) (x+dims_accelerate_kernel[11][0]*(y)+dims_accelerate_kernel[11][0]*dims_accelerate_kernel[11][1]*(z))
#define OPS_ACC12(x,y,z) (x+dims_accelerate_kernel[12][0]*(y)+dims_accelerate_kernel[12][0]*dims_accelerate_kernel[12][1]*(z))
#define OPS_ACC13(x,y,z) (x+dims_accelerate_kernel[13][0]*(y)+dims_accelerate_kernel[13][0]*dims_accelerate_kernel[13][1]*(z))
