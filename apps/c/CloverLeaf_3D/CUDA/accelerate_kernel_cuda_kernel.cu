...
#define OPS_ACC0(x, y, z)                                                      \
  (x + dims_accelerate_kernel[0][0] * (y) +                                    \
   dims_accelerate_kernel[0][0] * dims_accelerate_kernel[0][1] * (z))
#define OPS_ACC1(x, y, z)                                                      \
  (x + dims_accelerate_kernel[1][0] * (y) +                                    \
   dims_accelerate_kernel[1][0] * dims_accelerate_kernel[1][1] * (z))
#define OPS_ACC2(x, y, z)                                                      \
  (x + dims_accelerate_kernel[2][0] * (y) +                                    \
   dims_accelerate_kernel[2][0] * dims_accelerate_kernel[2][1] * (z))
#define OPS_ACC3(x, y, z)                                                      \
  (x + dims_accelerate_kernel[3][0] * (y) +                                    \
   dims_accelerate_kernel[3][0] * dims_accelerate_kernel[3][1] * (z))
#define OPS_ACC4(x, y, z)                                                      \
  (x + dims_accelerate_kernel[4][0] * (y) +                                    \
   dims_accelerate_kernel[4][0] * dims_accelerate_kernel[4][1] * (z))
#define OPS_ACC5(x, y, z)                                                      \
  (x + dims_accelerate_kernel[5][0] * (y) +                                    \
   dims_accelerate_kernel[5][0] * dims_accelerate_kernel[5][1] * (z))
#define OPS_ACC6(x, y, z)                                                      \
  (x + dims_accelerate_kernel[6][0] * (y) +                                    \
   dims_accelerate_kernel[6][0] * dims_accelerate_kernel[6][1] * (z))
#define OPS_ACC7(x, y, z)                                                      \
  (x + dims_accelerate_kernel[7][0] * (y) +                                    \
   dims_accelerate_kernel[7][0] * dims_accelerate_kernel[7][1] * (z))
#define OPS_ACC8(x, y, z)                                                      \
  (x + dims_accelerate_kernel[8][0] * (y) +                                    \
   dims_accelerate_kernel[8][0] * dims_accelerate_kernel[8][1] * (z))
#define OPS_ACC9(x, y, z)                                                      \
  (x + dims_accelerate_kernel[9][0] * (y) +                                    \
   dims_accelerate_kernel[9][0] * dims_accelerate_kernel[9][1] * (z))
#define OPS_ACC10(x, y, z)                                                     \
  (x + dims_accelerate_kernel[10][0] * (y) +                                   \
   dims_accelerate_kernel[10][0] * dims_accelerate_kernel[10][1] * (z))
#define OPS_ACC11(x, y, z)                                                     \
  (x + dims_accelerate_kernel[11][0] * (y) +                                   \
   dims_accelerate_kernel[11][0] * dims_accelerate_kernel[11][1] * (z))
#define OPS_ACC12(x, y, z)                                                     \
  (x + dims_accelerate_kernel[12][0] * (y) +                                   \
   dims_accelerate_kernel[12][0] * dims_accelerate_kernel[12][1] * (z))
#define OPS_ACC13(x, y, z)                                                     \
  (x + dims_accelerate_kernel[13][0] * (y) +                                   \
   dims_accelerate_kernel[13][0] * dims_accelerate_kernel[13][1] * (z))
...
__global__ void ops_accelerate_kernel(
  ...
  arg0 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_accelerate_kernel[0][0] +
          idx_z * 1 * 1 * dims_accelerate_kernel[0][0] *
              dims_accelerate_kernel[0][1];
  arg1 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_accelerate_kernel[1][0] +
          idx_z * 1 * 1 * dims_accelerate_kernel[1][0] *
              dims_accelerate_kernel[1][1];
  arg2 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_accelerate_kernel[2][0] +
          idx_z * 1 * 1 * dims_accelerate_kernel[2][0] *
              dims_accelerate_kernel[2][1];
  arg3 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_accelerate_kernel[3][0] +
          idx_z * 1 * 1 * dims_accelerate_kernel[3][0] *
              dims_accelerate_kernel[3][1];
  arg4 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_accelerate_kernel[4][0] +
          idx_z * 1 * 1 * dims_accelerate_kernel[4][0] *
              dims_accelerate_kernel[4][1];
  arg5 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_accelerate_kernel[5][0] +
          idx_z * 1 * 1 * dims_accelerate_kernel[5][0] *
              dims_accelerate_kernel[5][1];
  arg6 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_accelerate_kernel[6][0] +
          idx_z * 1 * 1 * dims_accelerate_kernel[6][0] *
              dims_accelerate_kernel[6][1];
  arg7 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_accelerate_kernel[7][0] +
          idx_z * 1 * 1 * dims_accelerate_kernel[7][0] *
              dims_accelerate_kernel[7][1];
  arg8 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_accelerate_kernel[8][0] +
          idx_z * 1 * 1 * dims_accelerate_kernel[8][0] *
              dims_accelerate_kernel[8][1];
  arg9 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_accelerate_kernel[9][0] +
          idx_z * 1 * 1 * dims_accelerate_kernel[9][0] *
              dims_accelerate_kernel[9][1];
  arg10 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_accelerate_kernel[10][0] +
           idx_z * 1 * 1 * dims_accelerate_kernel[10][0] *
               dims_accelerate_kernel[10][1];
  arg11 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_accelerate_kernel[11][0] +
           idx_z * 1 * 1 * dims_accelerate_kernel[11][0] *
               dims_accelerate_kernel[11][1];
  arg12 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_accelerate_kernel[12][0] +
           idx_z * 1 * 1 * dims_accelerate_kernel[12][0] *
               dims_accelerate_kernel[12][1];
  arg13 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_accelerate_kernel[13][0] +
           idx_z * 1 * 1 * dims_accelerate_kernel[13][0] *
               dims_accelerate_kernel[13][1];
...
void ops_par_loop_accelerate_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_accelerate_kernel_h[0][0] ||
      ydim0 != dims_accelerate_kernel_h[0][1] ||
      xdim1 != dims_accelerate_kernel_h[1][0] ||
      ydim1 != dims_accelerate_kernel_h[1][1] ||
      xdim2 != dims_accelerate_kernel_h[2][0] ||
      ydim2 != dims_accelerate_kernel_h[2][1] ||
      xdim3 != dims_accelerate_kernel_h[3][0] ||
      ydim3 != dims_accelerate_kernel_h[3][1] ||
      xdim4 != dims_accelerate_kernel_h[4][0] ||
      ydim4 != dims_accelerate_kernel_h[4][1] ||
      xdim5 != dims_accelerate_kernel_h[5][0] ||
      ydim5 != dims_accelerate_kernel_h[5][1] ||
      xdim6 != dims_accelerate_kernel_h[6][0] ||
      ydim6 != dims_accelerate_kernel_h[6][1] ||
      xdim7 != dims_accelerate_kernel_h[7][0] ||
      ydim7 != dims_accelerate_kernel_h[7][1] ||
      xdim8 != dims_accelerate_kernel_h[8][0] ||
      ydim8 != dims_accelerate_kernel_h[8][1] ||
      xdim9 != dims_accelerate_kernel_h[9][0] ||
      ydim9 != dims_accelerate_kernel_h[9][1] ||
      xdim10 != dims_accelerate_kernel_h[10][0] ||
      ydim10 != dims_accelerate_kernel_h[10][1] ||
      xdim11 != dims_accelerate_kernel_h[11][0] ||
      ydim11 != dims_accelerate_kernel_h[11][1] ||
      xdim12 != dims_accelerate_kernel_h[12][0] ||
      ydim12 != dims_accelerate_kernel_h[12][1] ||
      xdim13 != dims_accelerate_kernel_h[13][0] ||
      ydim13 != dims_accelerate_kernel_h[13][1]) {
    ...
    cutilSafeCall(cudaMemcpyToSymbol(dims_accelerate_kernel,
                                     dims_accelerate_kernel_h,
                                     sizeof(dims_accelerate_kernel)));
  }
