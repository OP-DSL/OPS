...
#else
#ifdef OPS_HYBRID
void ops_par_loop_advec_mom_kernel_x2_execute_gpu(ops_kernel_descriptor *desc) {
#else
void ops_par_loop_advec_mom_kernel_x2_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_advec_mom_kernel_x2_h || ydim0 != ydim0_advec_mom_kernel_x2_h || xdim1 != xdim1_advec_mom_kernel_x2_h || ydim1 != ydim1_advec_mom_kernel_x2_h || xdim2 != xdim2_advec_mom_kernel_x2_h || ydim2 != ydim2_advec_mom_kernel_x2_h || xdim3 != xdim3_advec_mom_kernel_x2_h || ydim3 != ydim3_advec_mom_kernel_x2_h || xdim4 != xdim4_advec_mom_kernel_x2_h || ydim4 != ydim4_advec_mom_kernel_x2_h) {
    ...
    cudaMemcpyToSymbolAsync( ydim0_advec_mom_kernel_x2, &ydim0, sizeof(int),0 );
    ...
    cudaMemcpyToSymbolAsync( ydim1_advec_mom_kernel_x2, &ydim1, sizeof(int),0 );
    ...
    cudaMemcpyToSymbolAsync( ydim2_advec_mom_kernel_x2, &ydim2, sizeof(int),0 );
    ...
    cudaMemcpyToSymbolAsync( ydim3_advec_mom_kernel_x2, &ydim3, sizeof(int),0 );
    ydim3_advec_mom_kernel_x2_h = ydim3;
    cudaMemcpyToSymbolAsync( xdim4_advec_mom_kernel_x2, &xdim4, sizeof(int),0 );
    xdim4_advec_mom_kernel_x2_h = xdim4;
    cudaMemcpyToSymbolAsync( ydim4_advec_mom_kernel_x2, &ydim4, sizeof(int),0 );
...
#ifdef OPS_HYBRID
void ops_par_loop_advec_mom_kernel_x2_execute_cpu(ops_kernel_descriptor *desc);
void ops_par_loop_advec_mom_kernel_x2_execute(ops_kernel_descriptor *desc) {
  if (desc->device == 1) {
    ops_par_loop_advec_mom_kernel_x2_execute_gpu(desc);
  }
  else {
    ops_par_loop_advec_mom_kernel_x2_execute_cpu(desc);
  }
}
#endif
