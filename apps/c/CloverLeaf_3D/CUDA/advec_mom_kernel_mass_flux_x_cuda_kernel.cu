...
#else
#ifdef OPS_HYBRID
void ops_par_loop_advec_mom_kernel_mass_flux_x_execute_gpu(ops_kernel_descriptor *desc) {
#else
void ops_par_loop_advec_mom_kernel_mass_flux_x_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_advec_mom_kernel_mass_flux_x_h || ydim0 != ydim0_advec_mom_kernel_mass_flux_x_h || xdim1 != xdim1_advec_mom_kernel_mass_flux_x_h || ydim1 != ydim1_advec_mom_kernel_mass_flux_x_h) {
    ...
    cudaMemcpyToSymbolAsync( ydim0_advec_mom_kernel_mass_flux_x, &ydim0, sizeof(int),0 );
    ...
    cudaMemcpyToSymbolAsync( ydim1_advec_mom_kernel_mass_flux_x, &ydim1, sizeof(int),0 );
...
void ops_par_loop_advec_mom_kernel_mass_flux_x_execute(ops_kernel_descriptor *desc) {
  if (desc->device == 1) {
    ops_par_loop_advec_mom_kernel_mass_flux_x_execute_gpu(desc);
  }
  else {
    ops_par_loop_advec_mom_kernel_mass_flux_x_execute_cpu(desc);
  }
}
#endif
