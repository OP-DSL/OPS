...
void ops_par_loop_PdV_kernel_nopredict(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg14, ops_arg arg15, ops_arg arg16) {
  ...
  if (OPS_diags > 1) {
    ...
    ops_timers_core(&c2,&t2);
    OPS_kernels[5].mpi_time += t2-t1;
    OPS_kernels[5].transfer += ops_compute_transfer2(dim, start, end, &arg0);
    OPS_kernels[5].transfer += ops_compute_transfer2(dim, start, end, &arg1);
    OPS_kernels[5].transfer += ops_compute_transfer2(dim, start, end, &arg2);
    OPS_kernels[5].transfer += ops_compute_transfer2(dim, start, end, &arg3);
    OPS_kernels[5].transfer += ops_compute_transfer2(dim, start, end, &arg4);
    OPS_kernels[5].transfer += ops_compute_transfer2(dim, start, end, &arg5);
    OPS_kernels[5].transfer += ops_compute_transfer2(dim, start, end, &arg6);
    OPS_kernels[5].transfer += ops_compute_transfer2(dim, start, end, &arg7);
    OPS_kernels[5].transfer += ops_compute_transfer2(dim, start, end, &arg8);
    OPS_kernels[5].transfer += ops_compute_transfer2(dim, start, end, &arg9);
    OPS_kernels[5].transfer += ops_compute_transfer2(dim, start, end, &arg10);
    OPS_kernels[5].transfer += ops_compute_transfer2(dim, start, end, &arg11);
    OPS_kernels[5].transfer += ops_compute_transfer2(dim, start, end, &arg12);
    OPS_kernels[5].transfer += ops_compute_transfer2(dim, start, end, &arg13);
    OPS_kernels[5].transfer += ops_compute_transfer2(dim, start, end, &arg14);
    OPS_kernels[5].transfer += ops_compute_transfer2(dim, start, end, &arg15);
    OPS_kernels[5].transfer += ops_compute_transfer2(dim, start, end, &arg16);
  }
}
