...
#else
#ifdef OPS_HYBRID
void ops_par_loop_reset_field_kernel1_execute_gpu(ops_kernel_descriptor *desc) {
#else
void ops_par_loop_reset_field_kernel1_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_reset_field_kernel1_h || ydim0 != ydim0_reset_field_kernel1_h || xdim1 != xdim1_reset_field_kernel1_h || ydim1 != ydim1_reset_field_kernel1_h || xdim2 != xdim2_reset_field_kernel1_h || ydim2 != ydim2_reset_field_kernel1_h || xdim3 != xdim3_reset_field_kernel1_h || ydim3 != ydim3_reset_field_kernel1_h) {
    ...
    cudaMemcpyToSymbolAsync( ydim0_reset_field_kernel1, &ydim0, sizeof(int),0 );
    ...
    cudaMemcpyToSymbolAsync( ydim1_reset_field_kernel1, &ydim1, sizeof(int),0 );
    ...
    cudaMemcpyToSymbolAsync( ydim2_reset_field_kernel1, &ydim2, sizeof(int),0 );
    ...
    cudaMemcpyToSymbolAsync( ydim3_reset_field_kernel1, &ydim3, sizeof(int),0 );
...
#ifdef OPS_HYBRID
void ops_par_loop_reset_field_kernel1_execute_cpu(ops_kernel_descriptor *desc);
void ops_par_loop_reset_field_kernel1_execute(ops_kernel_descriptor *desc) {
  if (desc->device == 1) {
    ops_par_loop_reset_field_kernel1_execute_gpu(desc);
  }
  else {
    ops_par_loop_reset_field_kernel1_execute_cpu(desc);
  }
}
#endif
