...
#else
#ifdef OPS_HYBRID
void ops_par_loop_flux_calc_kernely_execute_gpu(ops_kernel_descriptor *desc) {
#else
void ops_par_loop_flux_calc_kernely_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_flux_calc_kernely_h || ydim0 != ydim0_flux_calc_kernely_h || xdim1 != xdim1_flux_calc_kernely_h || ydim1 != ydim1_flux_calc_kernely_h || xdim2 != xdim2_flux_calc_kernely_h || ydim2 != ydim2_flux_calc_kernely_h || xdim3 != xdim3_flux_calc_kernely_h || ydim3 != ydim3_flux_calc_kernely_h) {
    cudaMemcpyToSymbolAsync( xdim0_flux_calc_kernely, &xdim0, sizeof(int),0 );
    xdim0_flux_calc_kernely_h = xdim0;
    cudaMemcpyToSymbolAsync( ydim0_flux_calc_kernely, &ydim0, sizeof(int),0 );
    ydim0_flux_calc_kernely_h = ydim0;
    cudaMemcpyToSymbolAsync( xdim1_flux_calc_kernely, &xdim1, sizeof(int),0 );
    xdim1_flux_calc_kernely_h = xdim1;
    cudaMemcpyToSymbolAsync( ydim1_flux_calc_kernely, &ydim1, sizeof(int),0 );
    ydim1_flux_calc_kernely_h = ydim1;
    cudaMemcpyToSymbolAsync( xdim2_flux_calc_kernely, &xdim2, sizeof(int),0 );
    xdim2_flux_calc_kernely_h = xdim2;
    cudaMemcpyToSymbolAsync( ydim2_flux_calc_kernely, &ydim2, sizeof(int),0 );
    ydim2_flux_calc_kernely_h = ydim2;
    cudaMemcpyToSymbolAsync( xdim3_flux_calc_kernely, &xdim3, sizeof(int),0 );
    xdim3_flux_calc_kernely_h = xdim3;
    cudaMemcpyToSymbolAsync( ydim3_flux_calc_kernely, &ydim3, sizeof(int),0 );
...
#ifdef OPS_HYBRID
void ops_par_loop_flux_calc_kernely_execute_cpu(ops_kernel_descriptor *desc);
void ops_par_loop_flux_calc_kernely_execute(ops_kernel_descriptor *desc) {
  if (desc->device == 1) {
    ops_par_loop_flux_calc_kernely_execute_gpu(desc);
  }
  else {
    ops_par_loop_flux_calc_kernely_execute_cpu(desc);
  }
}
#endif
