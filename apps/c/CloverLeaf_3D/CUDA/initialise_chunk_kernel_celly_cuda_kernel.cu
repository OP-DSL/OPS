...
#else
#ifdef OPS_HYBRID
void ops_par_loop_initialise_chunk_kernel_celly_execute_gpu(ops_kernel_descriptor *desc) {
#else
void ops_par_loop_initialise_chunk_kernel_celly_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_initialise_chunk_kernel_celly_h || ydim0 != ydim0_initialise_chunk_kernel_celly_h || xdim1 != xdim1_initialise_chunk_kernel_celly_h || ydim1 != ydim1_initialise_chunk_kernel_celly_h || xdim2 != xdim2_initialise_chunk_kernel_celly_h || ydim2 != ydim2_initialise_chunk_kernel_celly_h) {
    ...
    cudaMemcpyToSymbolAsync( ydim0_initialise_chunk_kernel_celly, &ydim0, sizeof(int),0 );
    ...
    cudaMemcpyToSymbolAsync( ydim1_initialise_chunk_kernel_celly, &ydim1, sizeof(int),0 );
    ...
    cudaMemcpyToSymbolAsync( ydim2_initialise_chunk_kernel_celly, &ydim2, sizeof(int),0 );
...
#ifdef OPS_HYBRID
void ops_par_loop_initialise_chunk_kernel_celly_execute_cpu(ops_kernel_descriptor *desc);
void ops_par_loop_initialise_chunk_kernel_celly_execute(ops_kernel_descriptor *desc) {
  if (desc->device == 1) {
    ops_par_loop_initialise_chunk_kernel_celly_execute_gpu(desc);
  }
  else {
    ops_par_loop_initialise_chunk_kernel_celly_execute_cpu(desc);
  }
}
#endif
