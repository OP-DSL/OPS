...
__global__ void ops_advec_cell_kernel1_xdir(double *__restrict arg0,
  ...
  arg0 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim0_advec_cell_kernel1_xdir +
          idx_z * 1 * 1 * xdim0_advec_cell_kernel1_xdir *
  ...
  arg1 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim1_advec_cell_kernel1_xdir +
          idx_z * 1 * 1 * xdim1_advec_cell_kernel1_xdir *
              ydim1_advec_cell_kernel1_xdir;
  arg2 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim2_advec_cell_kernel1_xdir +
          idx_z * 1 * 1 * xdim2_advec_cell_kernel1_xdir *
              ydim2_advec_cell_kernel1_xdir;
  arg3 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim3_advec_cell_kernel1_xdir +
          idx_z * 1 * 1 * xdim3_advec_cell_kernel1_xdir *
              ydim3_advec_cell_kernel1_xdir;
  arg4 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim4_advec_cell_kernel1_xdir +
          idx_z * 1 * 1 * xdim4_advec_cell_kernel1_xdir *
              ydim4_advec_cell_kernel1_xdir;
  arg5 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim5_advec_cell_kernel1_xdir +
          idx_z * 1 * 1 * xdim5_advec_cell_kernel1_xdir *
              ydim5_advec_cell_kernel1_xdir;
...
void ops_par_loop_advec_cell_kernel1_xdir_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_advec_cell_kernel1_xdir_h ||
      ydim0 != ydim0_advec_cell_kernel1_xdir_h ||
      xdim1 != xdim1_advec_cell_kernel1_xdir_h ||
      ydim1 != ydim1_advec_cell_kernel1_xdir_h ||
      xdim2 != xdim2_advec_cell_kernel1_xdir_h ||
      ydim2 != ydim2_advec_cell_kernel1_xdir_h ||
      xdim3 != xdim3_advec_cell_kernel1_xdir_h ||
      ydim3 != ydim3_advec_cell_kernel1_xdir_h ||
      xdim4 != xdim4_advec_cell_kernel1_xdir_h ||
      ydim4 != ydim4_advec_cell_kernel1_xdir_h ||
      xdim5 != xdim5_advec_cell_kernel1_xdir_h ||
      ydim5 != ydim5_advec_cell_kernel1_xdir_h) {
