...
#define OPS_ACC0(x,y,z) (x+dims_advec_cell_kernel1_xdir[0][0]*(y)+dims_advec_cell_kernel1_xdir[0][0]*dims_advec_cell_kernel1_xdir[0][1]*(z))
#define OPS_ACC1(x,y,z) (x+dims_advec_cell_kernel1_xdir[1][0]*(y)+dims_advec_cell_kernel1_xdir[1][0]*dims_advec_cell_kernel1_xdir[1][1]*(z))
#define OPS_ACC2(x,y,z) (x+dims_advec_cell_kernel1_xdir[2][0]*(y)+dims_advec_cell_kernel1_xdir[2][0]*dims_advec_cell_kernel1_xdir[2][1]*(z))
#define OPS_ACC3(x,y,z) (x+dims_advec_cell_kernel1_xdir[3][0]*(y)+dims_advec_cell_kernel1_xdir[3][0]*dims_advec_cell_kernel1_xdir[3][1]*(z))
#define OPS_ACC4(x,y,z) (x+dims_advec_cell_kernel1_xdir[4][0]*(y)+dims_advec_cell_kernel1_xdir[4][0]*dims_advec_cell_kernel1_xdir[4][1]*(z))
#define OPS_ACC5(x,y,z) (x+dims_advec_cell_kernel1_xdir[5][0]*(y)+dims_advec_cell_kernel1_xdir[5][0]*dims_advec_cell_kernel1_xdir[5][1]*(z))
