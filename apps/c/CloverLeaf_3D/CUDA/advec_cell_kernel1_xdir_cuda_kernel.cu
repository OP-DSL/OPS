...
#else
#ifdef OPS_HYBRID
void ops_par_loop_advec_cell_kernel1_xdir_execute_gpu(ops_kernel_descriptor *desc) {
#else
void ops_par_loop_advec_cell_kernel1_xdir_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_advec_cell_kernel1_xdir_h || ydim0 != ydim0_advec_cell_kernel1_xdir_h || xdim1 != xdim1_advec_cell_kernel1_xdir_h || ydim1 != ydim1_advec_cell_kernel1_xdir_h || xdim2 != xdim2_advec_cell_kernel1_xdir_h || ydim2 != ydim2_advec_cell_kernel1_xdir_h || xdim3 != xdim3_advec_cell_kernel1_xdir_h || ydim3 != ydim3_advec_cell_kernel1_xdir_h || xdim4 != xdim4_advec_cell_kernel1_xdir_h || ydim4 != ydim4_advec_cell_kernel1_xdir_h || xdim5 != xdim5_advec_cell_kernel1_xdir_h || ydim5 != ydim5_advec_cell_kernel1_xdir_h) {
    ...
    cudaMemcpyToSymbolAsync( ydim0_advec_cell_kernel1_xdir, &ydim0, sizeof(int),0 );
    ...
    cudaMemcpyToSymbolAsync( ydim1_advec_cell_kernel1_xdir, &ydim1, sizeof(int),0 );
    ...
    cudaMemcpyToSymbolAsync( ydim2_advec_cell_kernel1_xdir, &ydim2, sizeof(int),0 );
    ...
    cudaMemcpyToSymbolAsync( ydim3_advec_cell_kernel1_xdir, &ydim3, sizeof(int),0 );
    ...
    cudaMemcpyToSymbolAsync( ydim4_advec_cell_kernel1_xdir, &ydim4, sizeof(int),0 );
    ydim4_advec_cell_kernel1_xdir_h = ydim4;
    cudaMemcpyToSymbolAsync( xdim5_advec_cell_kernel1_xdir, &xdim5, sizeof(int),0 );
    xdim5_advec_cell_kernel1_xdir_h = xdim5;
    cudaMemcpyToSymbolAsync( ydim5_advec_cell_kernel1_xdir, &ydim5, sizeof(int),0 );
...
void ops_par_loop_advec_cell_kernel1_xdir_execute(ops_kernel_descriptor *desc) {
  if (desc->device == 1) {
    ops_par_loop_advec_cell_kernel1_xdir_execute_gpu(desc);
  }
  else {
    ops_par_loop_advec_cell_kernel1_xdir_execute_cpu(desc);
  }
}
#endif
