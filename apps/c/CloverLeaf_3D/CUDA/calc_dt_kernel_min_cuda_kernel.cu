...
#define OPS_ACC0(x, y, z)                                                      \
  (x + dims_calc_dt_kernel_min[0][0] * (y) +                                   \
   dims_calc_dt_kernel_min[0][0] * dims_calc_dt_kernel_min[0][1] * (z))
...
__global__ void ops_calc_dt_kernel_min(const double *__restrict arg0,
  ...
  arg0 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_calc_dt_kernel_min[0][0] +
          idx_z * 1 * 1 * dims_calc_dt_kernel_min[0][0] *
              dims_calc_dt_kernel_min[0][1];
...
void ops_par_loop_calc_dt_kernel_min_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_calc_dt_kernel_min_h[0][0] ||
      ydim0 != dims_calc_dt_kernel_min_h[0][1]) {
    dims_calc_dt_kernel_min_h[0][0] = xdim0;
    dims_calc_dt_kernel_min_h[0][1] = ydim0;
    cutilSafeCall(cudaMemcpyToSymbol(dims_calc_dt_kernel_min,
                                     dims_calc_dt_kernel_min_h,
                                     sizeof(dims_calc_dt_kernel_min)));
  }
