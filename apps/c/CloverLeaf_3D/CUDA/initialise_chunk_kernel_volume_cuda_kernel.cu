...
#else
#ifdef OPS_HYBRID
void ops_par_loop_initialise_chunk_kernel_volume_execute_gpu(ops_kernel_descriptor *desc) {
#else
void ops_par_loop_initialise_chunk_kernel_volume_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_initialise_chunk_kernel_volume_h || ydim0 != ydim0_initialise_chunk_kernel_volume_h || xdim1 != xdim1_initialise_chunk_kernel_volume_h || ydim1 != ydim1_initialise_chunk_kernel_volume_h || xdim2 != xdim2_initialise_chunk_kernel_volume_h || ydim2 != ydim2_initialise_chunk_kernel_volume_h || xdim3 != xdim3_initialise_chunk_kernel_volume_h || ydim3 != ydim3_initialise_chunk_kernel_volume_h || xdim4 != xdim4_initialise_chunk_kernel_volume_h || ydim4 != ydim4_initialise_chunk_kernel_volume_h || xdim5 != xdim5_initialise_chunk_kernel_volume_h || ydim5 != ydim5_initialise_chunk_kernel_volume_h || xdim6 != xdim6_initialise_chunk_kernel_volume_h || ydim6 != ydim6_initialise_chunk_kernel_volume_h) {
    ...
    cudaMemcpyToSymbolAsync( ydim0_initialise_chunk_kernel_volume, &ydim0, sizeof(int),0 );
    ...
    cudaMemcpyToSymbolAsync( ydim1_initialise_chunk_kernel_volume, &ydim1, sizeof(int),0 );
    ...
    cudaMemcpyToSymbolAsync( ydim2_initialise_chunk_kernel_volume, &ydim2, sizeof(int),0 );
    ...
    cudaMemcpyToSymbolAsync( ydim3_initialise_chunk_kernel_volume, &ydim3, sizeof(int),0 );
    ...
    cudaMemcpyToSymbolAsync( ydim4_initialise_chunk_kernel_volume, &ydim4, sizeof(int),0 );
    ydim4_initialise_chunk_kernel_volume_h = ydim4;
    cudaMemcpyToSymbolAsync( xdim5_initialise_chunk_kernel_volume, &xdim5, sizeof(int),0 );
    xdim5_initialise_chunk_kernel_volume_h = xdim5;
    cudaMemcpyToSymbolAsync( ydim5_initialise_chunk_kernel_volume, &ydim5, sizeof(int),0 );
    ydim5_initialise_chunk_kernel_volume_h = ydim5;
    cudaMemcpyToSymbolAsync( xdim6_initialise_chunk_kernel_volume, &xdim6, sizeof(int),0 );
    xdim6_initialise_chunk_kernel_volume_h = xdim6;
    cudaMemcpyToSymbolAsync( ydim6_initialise_chunk_kernel_volume, &ydim6, sizeof(int),0 );
...
#ifdef OPS_HYBRID
void ops_par_loop_initialise_chunk_kernel_volume_execute_cpu(ops_kernel_descriptor *desc);
void ops_par_loop_initialise_chunk_kernel_volume_execute(ops_kernel_descriptor *desc) {
  if (desc->device == 1) {
    ops_par_loop_initialise_chunk_kernel_volume_execute_gpu(desc);
  }
  else {
    ops_par_loop_initialise_chunk_kernel_volume_execute_cpu(desc);
  }
}
#endif
