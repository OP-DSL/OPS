...
#define OPS_ACC0(x, y, z)                                                      \
  (x + dims_advec_mom_kernel_x1[0][0] * (y) +                                  \
   dims_advec_mom_kernel_x1[0][0] * dims_advec_mom_kernel_x1[0][1] * (z))
#define OPS_ACC1(x, y, z)                                                      \
  (x + dims_advec_mom_kernel_x1[1][0] * (y) +                                  \
   dims_advec_mom_kernel_x1[1][0] * dims_advec_mom_kernel_x1[1][1] * (z))
#define OPS_ACC2(x, y, z)                                                      \
  (x + dims_advec_mom_kernel_x1[2][0] * (y) +                                  \
   dims_advec_mom_kernel_x1[2][0] * dims_advec_mom_kernel_x1[2][1] * (z))
#define OPS_ACC3(x, y, z)                                                      \
  (x + dims_advec_mom_kernel_x1[3][0] * (y) +                                  \
   dims_advec_mom_kernel_x1[3][0] * dims_advec_mom_kernel_x1[3][1] * (z))
#define OPS_ACC4(x, y, z)                                                      \
  (x + dims_advec_mom_kernel_x1[4][0] * (y) +                                  \
   dims_advec_mom_kernel_x1[4][0] * dims_advec_mom_kernel_x1[4][1] * (z))
#define OPS_ACC5(x, y, z)                                                      \
  (x + dims_advec_mom_kernel_x1[5][0] * (y) +                                  \
   dims_advec_mom_kernel_x1[5][0] * dims_advec_mom_kernel_x1[5][1] * (z))
...
__global__ void ops_advec_mom_kernel_x1(double *__restrict arg0,
  ...
  arg0 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_advec_mom_kernel_x1[0][0] +
          idx_z * 1 * 1 * dims_advec_mom_kernel_x1[0][0] *
              dims_advec_mom_kernel_x1[0][1];
  arg1 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_advec_mom_kernel_x1[1][0] +
          idx_z * 1 * 1 * dims_advec_mom_kernel_x1[1][0] *
              dims_advec_mom_kernel_x1[1][1];
  arg2 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_advec_mom_kernel_x1[2][0] +
          idx_z * 1 * 1 * dims_advec_mom_kernel_x1[2][0] *
              dims_advec_mom_kernel_x1[2][1];
  arg3 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_advec_mom_kernel_x1[3][0] +
          idx_z * 1 * 1 * dims_advec_mom_kernel_x1[3][0] *
              dims_advec_mom_kernel_x1[3][1];
  arg4 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_advec_mom_kernel_x1[4][0] +
          idx_z * 1 * 1 * dims_advec_mom_kernel_x1[4][0] *
              dims_advec_mom_kernel_x1[4][1];
  arg5 += idx_x * 1 * 1 + idx_y * 1 * 1 * dims_advec_mom_kernel_x1[5][0] +
          idx_z * 1 * 1 * dims_advec_mom_kernel_x1[5][0] *
              dims_advec_mom_kernel_x1[5][1];

  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    advec_mom_kernel_x1_gpu(arg0, arg1, arg2, arg3, arg4, arg5);
  }
}
...
void ops_par_loop_advec_mom_kernel_x1_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_advec_mom_kernel_x1_h[0][0] ||
      ydim0 != dims_advec_mom_kernel_x1_h[0][1] ||
      xdim1 != dims_advec_mom_kernel_x1_h[1][0] ||
      ydim1 != dims_advec_mom_kernel_x1_h[1][1] ||
      xdim2 != dims_advec_mom_kernel_x1_h[2][0] ||
      ydim2 != dims_advec_mom_kernel_x1_h[2][1] ||
      xdim3 != dims_advec_mom_kernel_x1_h[3][0] ||
      ydim3 != dims_advec_mom_kernel_x1_h[3][1] ||
      xdim4 != dims_advec_mom_kernel_x1_h[4][0] ||
      ydim4 != dims_advec_mom_kernel_x1_h[4][1] ||
      xdim5 != dims_advec_mom_kernel_x1_h[5][0] ||
      ydim5 != dims_advec_mom_kernel_x1_h[5][1]) {
    ...
    cutilSafeCall(cudaMemcpyToSymbol(dims_advec_mom_kernel_x1,
                                     dims_advec_mom_kernel_x1_h,
                                     sizeof(dims_advec_mom_kernel_x1)));
  }
