...
#define OPS_ACC0(x, y, z)                                                      \
  (x + xdim0_advec_mom_kernel_z1 * (y) +                                       \
   xdim0_advec_mom_kernel_z1 * ydim0_advec_mom_kernel_z1 * (z))
#define OPS_ACC1(x, y, z)                                                      \
  (x + xdim1_advec_mom_kernel_z1 * (y) +                                       \
   xdim1_advec_mom_kernel_z1 * ydim1_advec_mom_kernel_z1 * (z))
#define OPS_ACC2(x, y, z)                                                      \
  (x + xdim2_advec_mom_kernel_z1 * (y) +                                       \
   xdim2_advec_mom_kernel_z1 * ydim2_advec_mom_kernel_z1 * (z))
#define OPS_ACC3(x, y, z)                                                      \
  (x + xdim3_advec_mom_kernel_z1 * (y) +                                       \
   xdim3_advec_mom_kernel_z1 * ydim3_advec_mom_kernel_z1 * (z))
#define OPS_ACC4(x, y, z)                                                      \
  (x + xdim4_advec_mom_kernel_z1 * (y) +                                       \
   xdim4_advec_mom_kernel_z1 * ydim4_advec_mom_kernel_z1 * (z))
#define OPS_ACC5(x, y, z)                                                      \
  (x + xdim5_advec_mom_kernel_z1 * (y) +                                       \
   xdim5_advec_mom_kernel_z1 * ydim5_advec_mom_kernel_z1 * (z))

// user function
__device__

    inline void
    advec_mom_kernel_z1(double *pre_vol, double *post_vol, const double *volume,
...
__global__ void ops_advec_mom_kernel_z1(double *__restrict arg0,
  ...
  arg0 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim0_advec_mom_kernel_z1 +
          idx_z * 1 * 1 * xdim0_advec_mom_kernel_z1 * ydim0_advec_mom_kernel_z1;
  arg1 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim1_advec_mom_kernel_z1 +
          idx_z * 1 * 1 * xdim1_advec_mom_kernel_z1 * ydim1_advec_mom_kernel_z1;
  arg2 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim2_advec_mom_kernel_z1 +
          idx_z * 1 * 1 * xdim2_advec_mom_kernel_z1 * ydim2_advec_mom_kernel_z1;
  arg3 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim3_advec_mom_kernel_z1 +
          idx_z * 1 * 1 * xdim3_advec_mom_kernel_z1 * ydim3_advec_mom_kernel_z1;
  arg4 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim4_advec_mom_kernel_z1 +
          idx_z * 1 * 1 * xdim4_advec_mom_kernel_z1 * ydim4_advec_mom_kernel_z1;
  arg5 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim5_advec_mom_kernel_z1 +
          idx_z * 1 * 1 * xdim5_advec_mom_kernel_z1 * ydim5_advec_mom_kernel_z1;

  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    advec_mom_kernel_z1(arg0, arg1, arg2, arg3, arg4, arg5);
  }
}
...
void ops_par_loop_advec_mom_kernel_z1(char const *name, ops_block block,
  ...
  if (xdim0 != xdim0_advec_mom_kernel_z1_h ||
      ydim0 != ydim0_advec_mom_kernel_z1_h ||
      xdim1 != xdim1_advec_mom_kernel_z1_h ||
      ydim1 != ydim1_advec_mom_kernel_z1_h ||
      xdim2 != xdim2_advec_mom_kernel_z1_h ||
      ydim2 != ydim2_advec_mom_kernel_z1_h ||
      xdim3 != xdim3_advec_mom_kernel_z1_h ||
      ydim3 != ydim3_advec_mom_kernel_z1_h ||
      xdim4 != xdim4_advec_mom_kernel_z1_h ||
      ydim4 != ydim4_advec_mom_kernel_z1_h ||
      xdim5 != xdim5_advec_mom_kernel_z1_h ||
      ydim5 != ydim5_advec_mom_kernel_z1_h) {
