...
#else
#ifdef OPS_HYBRID
void ops_par_loop_update_halo_kernel4_plus_4_a_execute_gpu(ops_kernel_descriptor *desc) {
#else
void ops_par_loop_update_halo_kernel4_plus_4_a_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_update_halo_kernel4_plus_4_a_h || ydim0 != ydim0_update_halo_kernel4_plus_4_a_h || xdim1 != xdim1_update_halo_kernel4_plus_4_a_h || ydim1 != ydim1_update_halo_kernel4_plus_4_a_h) {
    cudaMemcpyToSymbolAsync( xdim0_update_halo_kernel4_plus_4_a, &xdim0, sizeof(int),0 );
    xdim0_update_halo_kernel4_plus_4_a_h = xdim0;
    cudaMemcpyToSymbolAsync( ydim0_update_halo_kernel4_plus_4_a, &ydim0, sizeof(int),0 );
    ydim0_update_halo_kernel4_plus_4_a_h = ydim0;
    cudaMemcpyToSymbolAsync( xdim1_update_halo_kernel4_plus_4_a, &xdim1, sizeof(int),0 );
    xdim1_update_halo_kernel4_plus_4_a_h = xdim1;
    cudaMemcpyToSymbolAsync( ydim1_update_halo_kernel4_plus_4_a, &ydim1, sizeof(int),0 );
...
#ifdef OPS_HYBRID
void ops_par_loop_update_halo_kernel4_plus_4_a_execute_cpu(ops_kernel_descriptor *desc);
void ops_par_loop_update_halo_kernel4_plus_4_a_execute(ops_kernel_descriptor *desc) {
  if (desc->device == 1) {
    ops_par_loop_update_halo_kernel4_plus_4_a_execute_gpu(desc);
  }
  else {
    ops_par_loop_update_halo_kernel4_plus_4_a_execute_cpu(desc);
  }
}
#endif
