...
void ops_par_loop_calc_dt_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  int dat11 = (OPS_instance::getOPSInstance()->OPS_soa ? args[11].dat->type_size : args[11].dat->elem_size);
  int dat12 = (OPS_instance::getOPSInstance()->OPS_soa ? args[12].dat->type_size : args[12].dat->elem_size);
  int dat13 = (OPS_instance::getOPSInstance()->OPS_soa ? args[13].dat->type_size : args[13].dat->elem_size);
