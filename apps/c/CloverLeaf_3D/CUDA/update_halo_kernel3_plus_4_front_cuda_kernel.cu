...
#define OPS_ACC0(x,y,z) (x+dims_update_halo_kernel3_plus_4_front[0][0]*(y)+dims_update_halo_kernel3_plus_4_front[0][0]*dims_update_halo_kernel3_plus_4_front[0][1]*(z))
#define OPS_ACC1(x,y,z) (x+dims_update_halo_kernel3_plus_4_front[1][0]*(y)+dims_update_halo_kernel3_plus_4_front[1][0]*dims_update_halo_kernel3_plus_4_front[1][1]*(z))
