...
#else
#ifdef OPS_HYBRID
void ops_par_loop_advec_mom_kernel2_x_execute_gpu(ops_kernel_descriptor *desc) {
#else
void ops_par_loop_advec_mom_kernel2_x_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_advec_mom_kernel2_x_h || ydim0 != ydim0_advec_mom_kernel2_x_h || xdim1 != xdim1_advec_mom_kernel2_x_h || ydim1 != ydim1_advec_mom_kernel2_x_h || xdim2 != xdim2_advec_mom_kernel2_x_h || ydim2 != ydim2_advec_mom_kernel2_x_h || xdim3 != xdim3_advec_mom_kernel2_x_h || ydim3 != ydim3_advec_mom_kernel2_x_h) {
    cudaMemcpyToSymbolAsync( xdim0_advec_mom_kernel2_x, &xdim0, sizeof(int),0 );
    xdim0_advec_mom_kernel2_x_h = xdim0;
    cudaMemcpyToSymbolAsync( ydim0_advec_mom_kernel2_x, &ydim0, sizeof(int),0 );
    ydim0_advec_mom_kernel2_x_h = ydim0;
    cudaMemcpyToSymbolAsync( xdim1_advec_mom_kernel2_x, &xdim1, sizeof(int),0 );
    xdim1_advec_mom_kernel2_x_h = xdim1;
    cudaMemcpyToSymbolAsync( ydim1_advec_mom_kernel2_x, &ydim1, sizeof(int),0 );
    ydim1_advec_mom_kernel2_x_h = ydim1;
    cudaMemcpyToSymbolAsync( xdim2_advec_mom_kernel2_x, &xdim2, sizeof(int),0 );
    xdim2_advec_mom_kernel2_x_h = xdim2;
    cudaMemcpyToSymbolAsync( ydim2_advec_mom_kernel2_x, &ydim2, sizeof(int),0 );
    ydim2_advec_mom_kernel2_x_h = ydim2;
    cudaMemcpyToSymbolAsync( xdim3_advec_mom_kernel2_x, &xdim3, sizeof(int),0 );
    xdim3_advec_mom_kernel2_x_h = xdim3;
    cudaMemcpyToSymbolAsync( ydim3_advec_mom_kernel2_x, &ydim3, sizeof(int),0 );
...
#ifdef OPS_HYBRID
void ops_par_loop_advec_mom_kernel2_x_execute_cpu(ops_kernel_descriptor *desc);
void ops_par_loop_advec_mom_kernel2_x_execute(ops_kernel_descriptor *desc) {
  if (desc->device == 1) {
    ops_par_loop_advec_mom_kernel2_x_execute_gpu(desc);
  }
  else {
    ops_par_loop_advec_mom_kernel2_x_execute_cpu(desc);
  }
}
#endif
