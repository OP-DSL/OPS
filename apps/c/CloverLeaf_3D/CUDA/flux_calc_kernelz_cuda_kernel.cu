...
#else
#ifdef OPS_HYBRID
void ops_par_loop_flux_calc_kernelz_execute_gpu(ops_kernel_descriptor *desc) {
#else
void ops_par_loop_flux_calc_kernelz_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != xdim0_flux_calc_kernelz_h || ydim0 != ydim0_flux_calc_kernelz_h || xdim1 != xdim1_flux_calc_kernelz_h || ydim1 != ydim1_flux_calc_kernelz_h || xdim2 != xdim2_flux_calc_kernelz_h || ydim2 != ydim2_flux_calc_kernelz_h || xdim3 != xdim3_flux_calc_kernelz_h || ydim3 != ydim3_flux_calc_kernelz_h) {
    cudaMemcpyToSymbolAsync( xdim0_flux_calc_kernelz, &xdim0, sizeof(int),0 );
    xdim0_flux_calc_kernelz_h = xdim0;
    cudaMemcpyToSymbolAsync( ydim0_flux_calc_kernelz, &ydim0, sizeof(int),0 );
    ydim0_flux_calc_kernelz_h = ydim0;
    cudaMemcpyToSymbolAsync( xdim1_flux_calc_kernelz, &xdim1, sizeof(int),0 );
    xdim1_flux_calc_kernelz_h = xdim1;
    cudaMemcpyToSymbolAsync( ydim1_flux_calc_kernelz, &ydim1, sizeof(int),0 );
    ydim1_flux_calc_kernelz_h = ydim1;
    cudaMemcpyToSymbolAsync( xdim2_flux_calc_kernelz, &xdim2, sizeof(int),0 );
    xdim2_flux_calc_kernelz_h = xdim2;
    cudaMemcpyToSymbolAsync( ydim2_flux_calc_kernelz, &ydim2, sizeof(int),0 );
    ydim2_flux_calc_kernelz_h = ydim2;
    cudaMemcpyToSymbolAsync( xdim3_flux_calc_kernelz, &xdim3, sizeof(int),0 );
    xdim3_flux_calc_kernelz_h = xdim3;
    cudaMemcpyToSymbolAsync( ydim3_flux_calc_kernelz, &ydim3, sizeof(int),0 );
...
void ops_par_loop_flux_calc_kernelz_execute(ops_kernel_descriptor *desc) {
  if (desc->device == 1) {
    ops_par_loop_flux_calc_kernelz_execute_gpu(desc);
  }
  else {
    ops_par_loop_flux_calc_kernelz_execute_cpu(desc);
  }
}
#endif
