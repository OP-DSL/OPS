...
__global__ void ops_flux_calc_kernelz(double *__restrict arg0,
  ...
  arg0 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim0_flux_calc_kernelz +
          idx_z * 1 * 1 * xdim0_flux_calc_kernelz * ydim0_flux_calc_kernelz;
  arg1 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim1_flux_calc_kernelz +
          idx_z * 1 * 1 * xdim1_flux_calc_kernelz * ydim1_flux_calc_kernelz;
  arg2 += idx_x * 1 * 1 + idx_y * 1 * 1 * xdim2_flux_calc_kernelz +
          idx_z * 1 * 1 * xdim2_flux_calc_kernelz * ydim2_flux_calc_kernelz;
