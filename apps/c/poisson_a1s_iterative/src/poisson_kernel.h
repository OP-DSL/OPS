...
void poisson_kernel_populate(const int *dispx, const int *dispy, const int *idx,
                             ACC<double> &u, ACC<double> &f, ACC<double> &ref) {
...
void poisson_kernel_initialguess(ACC<double> &u) { u(0, 0) = 0.0; }
...
void poisson_kernel_error(const ACC<double> &u, const ACC<double> &ref,
                          double *err) {
