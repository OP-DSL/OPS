...
int main(int argc, char **argv) {
  ...
  ops_scalar dx_scl = ops_decl_scalar(&dx, 1, "dx");
  ops_scalar dy_scl = ops_decl_scalar(&dy, 1, "dy");
  ...
  ops_dag_end_initphase2(ops_eao::get_instance());
  ...
  for (int j = 0; j < ngrid_y; j++) {
    for (int i = 0; i < ngrid_x; i++) {
      ...
      ops_par_loop_poisson_kernel_populate(
          ...
          ops_arg_scalar(dx_scl, 1, "double", OPS_READ),
          ops_arg_scalar(dy_scl, 1, "double", OPS_READ),
  ...
  double err_ad = 1;
  ops_eao::set_adjoint(red_err, &err_ad);

  ops_interpret_adjoints();

  std::cout << "========================================\n";
  std::cout << "dF/ddx = " << *(double *)dx_scl->adjoint << std::endl;
  std::cout << "dF/ddy = " << *(double *)dy_scl->adjoint << std::endl;
  std::cout << "========================================\n";
