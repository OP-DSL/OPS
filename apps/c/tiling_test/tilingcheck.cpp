...
/*  ---------------------------- RHSCAL ---------------------------- */
    for(int ispec = 0; ispec < 2; ispec++) {
        ...
        ops_par_loop(eqB, "eq_B rhscal 1013", block, 1, iter_range,
        ...
        iter_range[0] = 0;   iter_range[1] = imax;
        ops_par_loop(eqB, "eq_B rhscal 1455", block, 1, iter_range,
                ops_arg_dat(store4, 1, S1D_0, "double", OPS_WRITE),
    ...
    iter_range[0] = 0;   iter_range[1] = imax;
    ops_par_loop(eqB, "eq_B rhscal 2585", block, 1, iter_range,
            ops_arg_dat(store4, 1, S1D_0, "double", OPS_WRITE),
