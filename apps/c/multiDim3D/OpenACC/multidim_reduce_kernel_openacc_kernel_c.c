...
#pragma acc parallel deviceptr(p_a0)                                           \
    reduction(+ : p_a1_0) reduction(+ : p_a1_1) reduction(+ : p_a1_2)
      ...
      for (int n_x = 0; n_x < x_size; n_x++) {
        ...
        const ptrm_double ptr0 = {
            p_a0 + n_x * 1 + n_y * xdim0_multidim_reduce_kernel * 1 +
                n_z * xdim0_multidim_reduce_kernel *
                    ydim0_multidim_reduce_kernel * 1,
        ...
        const ptrm_double ptr0 = {
            p_a0 + n_x * 1 + n_y * xdim0_multidim_reduce_kernel * 1 +
                n_z * xdim0_multidim_reduce_kernel *
                    ydim0_multidim_reduce_kernel * 1,
            xdim0_multidim_reduce_kernel, ydim0_multidim_reduce_kernel, 3};
#endif
