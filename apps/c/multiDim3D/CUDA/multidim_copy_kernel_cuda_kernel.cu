...
#define OPS_ACC_MD0(d, x, y, z)                                                \
  ((x) + (dims_multidim_copy_kernel[0][0] * (y)) +                             \
   (dims_multidim_copy_kernel[0][0] * dims_multidim_copy_kernel[0][1] * (z)) + \
   (d)*dims_multidim_copy_kernel[0][0] * dims_multidim_copy_kernel[0][1] *     \
       dims_multidim_copy_kernel[0][2])
#define OPS_ACC_MD1(d, x, y, z)                                                \
  ((x) + (dims_multidim_copy_kernel[1][0] * (y)) +                             \
   (dims_multidim_copy_kernel[1][0] * dims_multidim_copy_kernel[1][1] * (z)) + \
   (d)*dims_multidim_copy_kernel[1][0] * dims_multidim_copy_kernel[1][1] *     \
       dims_multidim_copy_kernel[1][2])
// user function
__device__
...
__global__ void ops_multidim_copy_kernel(const double *__restrict arg0,
  ...
  arg0 += idx_x * 1 + idx_y * 1 * dims_multidim_copy_kernel[0][0] +
          idx_z * 1 * dims_multidim_copy_kernel[0][0] *
              dims_multidim_copy_kernel[0][1];
  arg1 += idx_x * 1 + idx_y * 1 * dims_multidim_copy_kernel[1][0] +
          idx_z * 1 * dims_multidim_copy_kernel[1][0] *
              dims_multidim_copy_kernel[1][1];
...
void ops_par_loop_multidim_copy_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_multidim_copy_kernel_h[0][0] ||
      ydim0 != dims_multidim_copy_kernel_h[0][1] ||
      zdim0 != dims_multidim_copy_kernel_h[0][2] ||
      xdim1 != dims_multidim_copy_kernel_h[1][0] ||
      ydim1 != dims_multidim_copy_kernel_h[1][1] ||
      zdim1 != dims_multidim_copy_kernel_h[1][2]) {
    ...
    cutilSafeCall(cudaMemcpyToSymbol(dims_multidim_copy_kernel,
                                     dims_multidim_copy_kernel_h,
                                     sizeof(dims_multidim_copy_kernel)));
  }
