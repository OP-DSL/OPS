...
#define OPS_ACC_MD0(d,x,y,z) ((x)+(dims_multidim_kernel[0][0]*(y))+(dims_multidim_kernel[0][0]*dims_multidim_kernel[0][1]*(z))+(d)*dims_multidim_kernel[0][0]*dims_multidim_kernel[0][1]*dims_multidim_kernel[0][2])
//user function
__device__
...
void ops_par_loop_multidim_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_multidim_kernel_h[0][0] || ydim0 != dims_multidim_kernel_h[0][1] || zdim0 != dims_multidim_kernel_h[0][2]) {
    ...
    cutilSafeCall(cudaMemcpyToSymbol( dims_multidim_kernel, dims_multidim_kernel_h, sizeof(dims_multidim_kernel)));
  }
