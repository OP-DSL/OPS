...
#define OPS_ACC_MD0(d, x, y, z)                                                \
  ((x) + (dims_multidim_reduce_kernel[0][0] * (y)) +                           \
   (dims_multidim_reduce_kernel[0][0] * dims_multidim_reduce_kernel[0][1] *    \
    (z)) +                                                                     \
   (d)*dims_multidim_reduce_kernel[0][0] * dims_multidim_reduce_kernel[0][1] * \
       dims_multidim_reduce_kernel[0][2])
// user function
__device__
...
__global__ void ops_multidim_reduce_kernel(const double *__restrict arg0,
  ...
  arg0 += idx_x * 1 + idx_y * 1 * dims_multidim_reduce_kernel[0][0] +
          idx_z * 1 * dims_multidim_reduce_kernel[0][0] *
              dims_multidim_reduce_kernel[0][1];
...
void ops_par_loop_multidim_reduce_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_multidim_reduce_kernel_h[0][0] ||
      ydim0 != dims_multidim_reduce_kernel_h[0][1] ||
      zdim0 != dims_multidim_reduce_kernel_h[0][2]) {
    dims_multidim_reduce_kernel_h[0][0] = xdim0;
    dims_multidim_reduce_kernel_h[0][1] = ydim0;
    dims_multidim_reduce_kernel_h[0][2] = zdim0;
    cutilSafeCall(cudaMemcpyToSymbol(dims_multidim_reduce_kernel,
                                     dims_multidim_reduce_kernel_h,
                                     sizeof(dims_multidim_reduce_kernel)));
  }
