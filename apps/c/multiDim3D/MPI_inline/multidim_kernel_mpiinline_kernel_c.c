...
void multidim_kernel_c_wrapper(double *restrict val_p, int *restrict idx,
...
#ifdef OPS_SOA
        ptrm_double val = {val_p + n_x * 1 + n_y * xdim0_multidim_kernel * 1 +
                               n_z * xdim0_multidim_kernel *
                                   ydim0_multidim_kernel * 1,
                           xdim0_multidim_kernel, ydim0_multidim_kernel,
                           zdim0_multidim_kernel};
#else
        ptrm_double val = {val_p + n_x * 1 + n_y * xdim0_multidim_kernel * 1 +
                               n_z * xdim0_multidim_kernel *
                                   ydim0_multidim_kernel * 1,
