...
void buildOpenCLKernels_multidim_copy_kernel(OPS_instance *instance, int xdim0,
                                             int ydim0, int zdim0, int xdim1,
                                             int ydim1, int zdim1) {
  ...
  if (!isbuilt_multidim_copy_kernel) {
    ...
    instance->ostream() << "Compiling multidim_copy_kernel " << OCL_FMA
                        << " source -- start \n";
    ...
    instance->opencl_instance->OPS_opencl_core.kernel[1] =
        clCreateKernel(instance->opencl_instance->OPS_opencl_core.program,
                       "ops_multidim_copy_kernel", &ret);
    clSafeCall(ret);
