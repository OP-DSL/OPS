...
void buildOpenCLKernels_multidim_copy_kernel(int xdim0, int ydim0, int zdim0, int xdim1, int ydim1, int zdim1) {
  ...
  if(!isbuilt_multidim_copy_kernel) {
    ...
    printf("Compiling multidim_copy_kernel %d source -- start \n",OCL_FMA);
      ...
      if (pPath!=NULL)
        if(OCL_FMA)
          sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/c/include -DOPS_WARPSIZE=%d  -Dxdim0_multidim_copy_kernel=%d  -Dydim0_multidim_copy_kernel=%d  -Dzdim0_multidim_copy_kernel=%d  -Dxdim1_multidim_copy_kernel=%d  -Dydim1_multidim_copy_kernel=%d  -Dzdim1_multidim_copy_kernel=%d ", pPath, 32,xdim0,ydim0,zdim0,xdim1,ydim1,zdim1);
        else
          sprintf(buildOpts,"-cl-mad-enable -I%s/c/include -DOPS_WARPSIZE=%d  -Dxdim0_multidim_copy_kernel=%d  -Dydim0_multidim_copy_kernel=%d  -Dzdim0_multidim_copy_kernel=%d  -Dxdim1_multidim_copy_kernel=%d  -Dydim1_multidim_copy_kernel=%d  -Dzdim1_multidim_copy_kernel=%d ", pPath, 32,xdim0,ydim0,zdim0,xdim1,ydim1,zdim1);
      else {
      ...
      printf("compiling multidim_copy_kernel -- done\n");

    // Create the OpenCL kernel
    OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[1] = clCreateKernel(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.program, "ops_multidim_copy_kernel", &ret);
    clSafeCall( ret );
...
void ops_par_loop_multidim_copy_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  buildOpenCLKernels_multidim_copy_kernel(
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[1], 2, sizeof(cl_int), (void*) &base0 ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[1], 3, sizeof(cl_int), (void*) &base1 ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[1], 4, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[1], 5, sizeof(cl_int), (void*) &y_size ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[1], 6, sizeof(cl_int), (void*) &z_size ));
