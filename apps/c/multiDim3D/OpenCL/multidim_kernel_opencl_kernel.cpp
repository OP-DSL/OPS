...
void buildOpenCLKernels_multidim_kernel(int xdim0, int ydim0, int zdim0) {
  ...
  if(!isbuilt_multidim_kernel) {
    ...
    printf("Compiling multidim_kernel %d source -- start \n",OCL_FMA);
      ...
      if (pPath!=NULL)
        if(OCL_FMA)
          sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/c/include -DOPS_WARPSIZE=%d  -Dxdim0_multidim_kernel=%d  -Dydim0_multidim_kernel=%d  -Dzdim0_multidim_kernel=%d ", pPath, 32,xdim0,ydim0,zdim0);
        else
          sprintf(buildOpts,"-cl-mad-enable -I%s/c/include -DOPS_WARPSIZE=%d  -Dxdim0_multidim_kernel=%d  -Dydim0_multidim_kernel=%d  -Dzdim0_multidim_kernel=%d ", pPath, 32,xdim0,ydim0,zdim0);
      else {
    ...
    OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[0] = clCreateKernel(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.program, "ops_multidim_kernel", &ret);
    clSafeCall( ret );
...
void ops_par_loop_multidim_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  buildOpenCLKernels_multidim_kernel(
  xdim0,ydim0,zdim0);
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[0], 1, sizeof(cl_int), (void*) &base0 ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[0], 2, sizeof(cl_int), (void*) &arg_idx[0] ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[0], 3, sizeof(cl_int), (void*) &arg_idx[1] ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[0], 4, sizeof(cl_int), (void*) &arg_idx[2] ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[0], 5, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[0], 6, sizeof(cl_int), (void*) &y_size ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[0], 7, sizeof(cl_int), (void*) &z_size ));
