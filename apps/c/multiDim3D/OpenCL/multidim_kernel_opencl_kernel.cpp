...
void buildOpenCLKernels_multidim_kernel(int xdim0, int ydim0, int zdim0) {
  ...
  if(!isbuilt_multidim_kernel) {
    ...
    OPS_opencl_core.kernel[0] = clCreateKernel(OPS_opencl_core.program, "ops_multidim_kernel", &ret);
    clSafeCall( ret );
...
void ops_par_loop_multidim_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[0], 2, sizeof(cl_int), (void*) &arg_idx[0] ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[0], 3, sizeof(cl_int), (void*) &arg_idx[1] ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[0], 4, sizeof(cl_int), (void*) &arg_idx[2] ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[0], 5, sizeof(cl_int), (void*) &x_size ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[0], 6, sizeof(cl_int), (void*) &y_size ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[0], 7, sizeof(cl_int), (void*) &z_size ));
