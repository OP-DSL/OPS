...
void mgrid_prolong_kernel_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    ...
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ...
      mgrid_prolong_kernel(  p_a0 + (n_x+global_idx0%stride_00)/stride_00*1*1 + (n_y+global_idx1%stride_01)/stride_01*xdim0_mgrid_prolong_kernel*1*1,
           p_a1 + n_x*1*1 + n_y*xdim1_mgrid_prolong_kernel*1*1,arg_idx );
