...
void ops_par_loop_prolong_check(char const *, ops_block, int , int*,
  ops_arg,
  ops_arg,
  ops_arg,
  ops_arg,
...
void ops_par_loop_restrict_check(char const *, ops_block, int , int*,
  ops_arg,
  ops_arg,
  ops_arg,
  ops_arg );
...
#define ZEROBASE
  ...
  ops_par_loop_mgrid_populate_kernel_3("mgrid_populate_kernel_3", grid0, 2, iter_range_large,
               ops_arg_dat(data5, 1, S2D_00, "double", OPS_WRITE),
               ops_arg_idx());
