...
#define OPS_ACC0(x,y) (x+dims_mgrid_prolong_kernel[0][0]*(y))
#define OPS_ACC1(x,y) (x+dims_mgrid_prolong_kernel[1][0]*(y))
...
void ops_par_loop_mgrid_prolong_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_mgrid_prolong_kernel_h[0][0] || xdim1 != dims_mgrid_prolong_kernel_h[1][0]) {
    ...
    cutilSafeCall(cudaMemcpyToSymbol( dims_mgrid_prolong_kernel, dims_mgrid_prolong_kernel_h, sizeof(dims_mgrid_prolong_kernel)));
  }
