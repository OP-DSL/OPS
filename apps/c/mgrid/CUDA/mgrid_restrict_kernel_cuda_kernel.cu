...
__device__
    ...
    void
    mgrid_restrict_kernel_gpu(const double *fine, double *coarse, int *idx) {
...
__global__ void ops_mgrid_restrict_kernel(const double *__restrict arg0,
  ...
  arg0 += idx_x * stride_00 * 1 * 1 +
          idx_y * stride_01 * 1 * 1 * xdim0_mgrid_restrict_kernel;
