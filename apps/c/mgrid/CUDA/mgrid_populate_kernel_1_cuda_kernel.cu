...
#define OPS_ACC0(x,y) (x+dims_mgrid_populate_kernel_1[0][0]*(y))
...
void ops_par_loop_mgrid_populate_kernel_1_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_mgrid_populate_kernel_1_h[0][0]) {
    ...
    cutilSafeCall(cudaMemcpyToSymbol( dims_mgrid_populate_kernel_1, dims_mgrid_populate_kernel_1_h, sizeof(dims_mgrid_populate_kernel_1)));
  }
