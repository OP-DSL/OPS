...
void initialise_chunk()
{
  ...
  ops_par_loop_passive(initialise_chunk_kernel_xx, "initialise_chunk_kernel_xx", clover_grid, 2, rangefull,
               ops_arg_dat(xx, 1, S2D_00_STRID2D_X, "int", OPS_WRITE),
               ops_arg_idx());

  ops_par_loop_passive(initialise_chunk_kernel_yy, "initialise_chunk_kernel_yy", clover_grid, 2, rangefull,
               ops_arg_dat(yy, 1, S2D_00_STRID2D_Y, "int", OPS_WRITE),
               ops_arg_idx());

  ops_par_loop_passive(initialise_chunk_kernel_x, "initialise_chunk_kernel_x", clover_grid, 2, rangex,
  ...
  ops_par_loop_passive(initialise_chunk_kernel_y, "initialise_chunk_kernel_y", clover_grid, 2, rangey,
  ...
  ops_par_loop_passive(initialise_chunk_kernel_cellx, "initialise_chunk_kernel_cellx", clover_grid, 2, rangex,
  ...
  ops_par_loop_passive(initialise_chunk_kernel_celly, "initialise_chunk_kernel_celly", clover_grid, 2, rangey,
  ...
  ops_par_loop_passive(initialise_chunk_kernel_volume, "initialise_chunk_kernel_volume", clover_grid, 2, rangexy,
