	...
	int preconditioner_type, int coef)
{
  ...
  *ry = dt/(dy*dy);
  ...
  if (coef == RECIP_CONDUCTIVITY) {
    ops_par_loop(tea_leaf_recip_kernel, "tea_leaf_recip_kernel", tea_grid, 2, rangexy,
  ...
  ops_par_loop(tea_leaf_common_init_Kx_Ky_kernel, "tea_leaf_common_init_Kx_Ky_kernel", tea_grid, 2, rangexy,
