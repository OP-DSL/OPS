...
void ops_par_loop_tea_leaf_cg_calc_w_reduce_kernel(char const *, ops_block, int,
                                                   int *, ops_arg, ops_arg,
                                                   ops_arg, ops_arg, ops_arg,
                                                   ops_arg, ops_arg);
...
void ops_par_loop_tea_leaf_cg_calc_ur_r_reduce_kernel(char const *, ops_block,
                                                      int, int *, ops_arg,
                                                      ops_arg, ops_arg,
                                                      ops_arg);
...
void tea_leaf_cg_init(ops_dat p, ops_dat r, ops_dat Mi, ops_dat z, ops_dat Kx,
                      ops_dat Ky, ops_dat cp, ops_dat bfp, double rx, double ry,
...
void tea_leaf_cg_calc_w(ops_dat p, ops_dat w, ops_dat Kx, ops_dat Ky, double rx,
                        double ry, double *pw) {
  int x_min = field.x_min;
  int x_max = field.x_max;
  int y_min = field.y_min;
  ...
  *pw = 0.0;
  ops_par_loop_tea_leaf_cg_calc_w_reduce_kernel(
      "tea_leaf_cg_calc_w_reduce_kernel", tea_grid, 2, rangexy,
...
void tea_leaf_cg_calc_ur(ops_dat u, ops_dat p, ops_dat r, ops_dat Mi, ops_dat w,
                         ops_dat z, ops_dat cp, ops_dat bfp, ops_dat Kx,
                         ops_dat Ky, double rx, double ry, double alpha,
                         double *rnn, int preconditioner_type) {
  int x_min = field.x_min;
  int x_max = field.x_max;
  int y_min = field.y_min;
  int y_max = field.y_max;
  ...
  *rnn = 0.0;
  if (preconditioner_type != TL_PREC_NONE) {
    ops_par_loop_tea_leaf_axpy_kernel(
        "tea_leaf_axpy_kernel", tea_grid, 2, rangexy,
    ...
    ops_par_loop_tea_leaf_cg_calc_ur_r_reduce_kernel(
        "tea_leaf_cg_calc_ur_r_reduce_kernel", tea_grid, 2, rangexy,
        ops_arg_dat(r, 1, S2D_00, "double", OPS_INC),
        ops_arg_dat(w, 1, S2D_00, "double", OPS_READ),
        ops_arg_gbl(&alpha, 1, "double", OPS_READ),
        ops_arg_reduce(red_temp, 1, "double", OPS_INC));
...
void tea_leaf_cg_calc_p(ops_dat p, ops_dat r, ops_dat z, double beta,
