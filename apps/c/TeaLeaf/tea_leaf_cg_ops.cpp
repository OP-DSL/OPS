...
void ops_par_loop_tea_leaf_cg_calc_w_reduce_kernel(char const *, ops_block, int , int*,
  ops_arg,
  ops_arg,
  ops_arg,
  ops_arg,
...
void ops_par_loop_tea_leaf_cg_calc_ur_r_reduce_kernel(char const *, ops_block, int , int*,
  ops_arg,
  ops_arg,
  ops_arg,
  ops_arg );
  ...
  double rx, double ry, double *pw)
{
  ...
  *pw = 0.0;
  ops_par_loop_tea_leaf_cg_calc_w_reduce_kernel("tea_leaf_cg_calc_w_reduce_kernel", tea_grid, 2, rangexy,
  ...
  double rx, double ry, double alpha, double *rnn, int preconditioner_type)
{
  ...
  *rnn = 0.0;
  if (preconditioner_type != TL_PREC_NONE) {
    ...
    ops_par_loop_tea_leaf_cg_calc_ur_r_reduce_kernel("tea_leaf_cg_calc_ur_r_reduce_kernel", tea_grid, 2, rangexy,
                 ops_arg_dat(r, 1, S2D_00, "double", OPS_INC),
                 ops_arg_dat(w, 1, S2D_00, "double", OPS_READ),
                 ops_arg_gbl(&alpha, 1, "double", OPS_READ),
                 ops_arg_reduce(red_temp, 1, "double", OPS_INC));
