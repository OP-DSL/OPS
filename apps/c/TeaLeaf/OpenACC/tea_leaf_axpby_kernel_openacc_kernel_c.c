...
void tea_leaf_axpby_kernel_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    ...
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ptr_double ptr0 = {  p_a0 + n_x*1*1 + n_y*xdim0_tea_leaf_axpby_kernel*1*1, xdim0_tea_leaf_axpby_kernel};
      const ptr_double ptr1 = {  p_a1 + n_x*1*1 + n_y*xdim1_tea_leaf_axpby_kernel*1*1, xdim1_tea_leaf_axpby_kernel};
