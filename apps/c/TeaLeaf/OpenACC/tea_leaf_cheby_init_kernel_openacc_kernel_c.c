...
//user function
inline void tea_leaf_cheby_init_kernel(ptr_double w, ptr_double r,
                                       const ptr_double Kx, const ptr_double Ky,
                                       const ptr_double u, const ptr_double u0,
...
void tea_leaf_cheby_init_kernel_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    ...
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ...
      tea_leaf_cheby_init_kernel(ptr0, ptr1, ptr2, ptr3, ptr4, ptr5, &p_a6,
                                 &p_a7);
    }
  }
}
