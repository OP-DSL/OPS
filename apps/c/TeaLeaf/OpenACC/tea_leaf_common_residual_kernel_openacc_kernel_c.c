...
//user function
inline void tea_leaf_common_residual_kernel(
    ptr_double r, const ptr_double Kx, const ptr_double Ky, const ptr_double u,
    const ptr_double u0, const double *rx, const double *ry) {
  double smvp = 0.0;
