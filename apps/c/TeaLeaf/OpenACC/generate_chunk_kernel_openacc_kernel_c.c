...
void generate_chunk_kernel_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    ...
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ...
      const ptr_double ptr5 = {  p_a5 + n_x*1*1 + n_y*xdim5_generate_chunk_kernel*0*1, xdim5_generate_chunk_kernel};
      const ptr_double ptr6 = {  p_a6 + n_x*0*1 + n_y*xdim6_generate_chunk_kernel*1*1, xdim6_generate_chunk_kernel};
