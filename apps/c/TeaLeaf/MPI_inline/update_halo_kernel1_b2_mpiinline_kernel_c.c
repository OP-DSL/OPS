...
#pragma omp parallel for
  for (int n_y = 0; n_y < y_size; n_y++) {
    for (int n_x = 0; n_x < x_size; n_x++) {
      ...
      ptr_double u = {u_p + n_x * 1 + n_y * xdim3_update_halo_kernel1_b2 * 1,
                      xdim3_update_halo_kernel1_b2};
      ptr_double p = {p_p + n_x * 1 + n_y * xdim4_update_halo_kernel1_b2 * 1,
                      xdim4_update_halo_kernel1_b2};
      ptr_double sd = {sd_p + n_x * 1 + n_y * xdim5_update_halo_kernel1_b2 * 1,
