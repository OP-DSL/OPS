...
void tea_leaf_common_init_kernel_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ptr_double w = { w_p + n_x*1 + n_y * xdim0_tea_leaf_common_init_kernel*1, xdim0_tea_leaf_common_init_kernel};
      ptr_double r = { r_p + n_x*1 + n_y * xdim1_tea_leaf_common_init_kernel*1, xdim1_tea_leaf_common_init_kernel};
      const ptr_double Kx = { Kx_p + n_x*1 + n_y * xdim2_tea_leaf_common_init_kernel*1, xdim2_tea_leaf_common_init_kernel};
      const ptr_double Ky = { Ky_p + n_x*1 + n_y * xdim3_tea_leaf_common_init_kernel*1, xdim3_tea_leaf_common_init_kernel};
      const ptr_double u = { u_p + n_x*1 + n_y * xdim4_tea_leaf_common_init_kernel*1, xdim4_tea_leaf_common_init_kernel};
