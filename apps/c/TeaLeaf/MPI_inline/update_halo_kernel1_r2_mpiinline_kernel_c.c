...
void update_halo_kernel1_r2_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ...
      ptr_double energy0 = { energy0_p + n_x*1 + n_y * xdim1_update_halo_kernel1_r2*1, xdim1_update_halo_kernel1_r2};
      ptr_double energy1 = { energy1_p + n_x*1 + n_y * xdim2_update_halo_kernel1_r2*1, xdim2_update_halo_kernel1_r2};
      ptr_double u = { u_p + n_x*1 + n_y * xdim3_update_halo_kernel1_r2*1, xdim3_update_halo_kernel1_r2};
      ptr_double p = { p_p + n_x*1 + n_y * xdim4_update_halo_kernel1_r2*1, xdim4_update_halo_kernel1_r2};
      ptr_double sd = { sd_p + n_x*1 + n_y * xdim5_update_halo_kernel1_r2*1, xdim5_update_halo_kernel1_r2};
