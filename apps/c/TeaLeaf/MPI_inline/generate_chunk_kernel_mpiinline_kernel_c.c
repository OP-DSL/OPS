...
#define OPS_ACC5(x,y) (n_x*1+n_y*xdim5_generate_chunk_kernel*0+x+xdim5_generate_chunk_kernel*(y))
#define OPS_ACC6(x,y) (n_x*0+n_y*xdim6_generate_chunk_kernel*1+x+xdim6_generate_chunk_kernel*(y))
