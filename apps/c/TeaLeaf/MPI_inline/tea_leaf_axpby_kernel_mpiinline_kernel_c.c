...
void tea_leaf_axpby_kernel_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ptr_double u = { u_p + n_x*1 + n_y * xdim0_tea_leaf_axpby_kernel*1, xdim0_tea_leaf_axpby_kernel};
      const ptr_double p = { p_p + n_x*1 + n_y * xdim1_tea_leaf_axpby_kernel*1, xdim1_tea_leaf_axpby_kernel};
