...
// host stub function
void ops_par_loop_tea_leaf_ppcg_init1_kernel_execute(
...
#ifdef CHECKPOINTING
  if (!ops_checkpointing_before(args, 6, range, 43))
    return;
#endif
...
#ifdef OPS_DEBUG
  ops_register_args(args, "tea_leaf_ppcg_init1_kernel");
#endif
  ...
  const double *__restrict__ z = (double *)(args[3].data + base3);

  int base4 = args[4].dat->base_offset;
  const double *__restrict__ r = (double *)(args[4].data + base4);

  const double *__restrict__ theta_r = (double *)args[5].data;
...
#pragma omp simd aligned(sd, rtemp, utemp, z, r)
#else
#pragma simd
#endif
...
void ops_par_loop_tea_leaf_ppcg_init1_kernel(char const *name, ops_block block,
