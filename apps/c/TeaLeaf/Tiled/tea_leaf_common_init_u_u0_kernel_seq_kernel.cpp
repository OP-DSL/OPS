...
//
#define OPS_ACC0(x,y) (n_x*1+n_y*xdim0_tea_leaf_common_init_u_u0_kernel*1+x+xdim0_tea_leaf_common_init_u_u0_kernel*(y))
#define OPS_ACC1(x,y) (n_x*1+n_y*xdim1_tea_leaf_common_init_u_u0_kernel*1+x+xdim1_tea_leaf_common_init_u_u0_kernel*(y))
#define OPS_ACC2(x,y) (n_x*1+n_y*xdim2_tea_leaf_common_init_u_u0_kernel*1+x+xdim2_tea_leaf_common_init_u_u0_kernel*(y))
#define OPS_ACC3(x,y) (n_x*1+n_y*xdim3_tea_leaf_common_init_u_u0_kernel*1+x+xdim3_tea_leaf_common_init_u_u0_kernel*(y))
...
void ops_par_loop_tea_leaf_common_init_u_u0_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  #ifdef OPS_DEBUG
  ops_register_args(args, "tea_leaf_common_init_u_u0_kernel");
  #endif
  ...
  double * __restrict__ u0 = (double *)(args[1].data + base1);

  int base2 = args[2].dat->base_offset;
  const double * __restrict__ energy = (double *)(args[2].data + base2);

  int base3 = args[3].dat->base_offset;
  const double * __restrict__ density = (double *)(args[3].data + base3);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    #pragma omp simd aligned(u,u0,energy,density)
    #else
    #pragma simd
    #endif
