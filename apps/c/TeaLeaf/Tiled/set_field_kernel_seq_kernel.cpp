...
//
#define OPS_ACC0(x,y) (n_x*1+n_y*xdim0_set_field_kernel*1+x+xdim0_set_field_kernel*(y))
#define OPS_ACC1(x,y) (n_x*1+n_y*xdim1_set_field_kernel*1+x+xdim1_set_field_kernel*(y))
...
void ops_par_loop_set_field_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  const double * __restrict__ energy0 = (double *)(args[0].data + base0);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    #pragma omp simd aligned(energy0,energy1)
    #else
    #pragma simd
    #endif
