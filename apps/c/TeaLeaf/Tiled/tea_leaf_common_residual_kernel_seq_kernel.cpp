...
//
#define OPS_ACC0(x,y) (n_x*1+n_y*xdim0_tea_leaf_common_residual_kernel*1+x+xdim0_tea_leaf_common_residual_kernel*(y))
#define OPS_ACC1(x,y) (n_x*1+n_y*xdim1_tea_leaf_common_residual_kernel*1+x+xdim1_tea_leaf_common_residual_kernel*(y))
#define OPS_ACC2(x,y) (n_x*1+n_y*xdim2_tea_leaf_common_residual_kernel*1+x+xdim2_tea_leaf_common_residual_kernel*(y))
#define OPS_ACC3(x,y) (n_x*1+n_y*xdim3_tea_leaf_common_residual_kernel*1+x+xdim3_tea_leaf_common_residual_kernel*(y))
#define OPS_ACC4(x,y) (n_x*1+n_y*xdim4_tea_leaf_common_residual_kernel*1+x+xdim4_tea_leaf_common_residual_kernel*(y))
...
void ops_par_loop_tea_leaf_common_residual_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  #ifdef OPS_DEBUG
  ops_register_args(args, "tea_leaf_common_residual_kernel");
  #endif
  ...
  const double * __restrict__ u = (double *)(args[3].data + base3);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    #pragma omp simd aligned(r,Kx,Ky,u,u0)
    #else
    #pragma simd
    #endif
