...
void ops_par_loop_field_summary_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  const double * __restrict__ density = (double *)(args[1].data + base1);

  int base2 = args[2].dat->base_offset;
  const double * __restrict__ energy = (double *)(args[2].data + base2);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    #pragma omp simd reduction(+:p_a4_0) reduction(+:p_a5_0) reduction(+:p_a6_0) reduction(+:p_a7_0) aligned(volume,density,energy,u)
    #else
    #pragma simd reduction(+:p_a4_0) reduction(+:p_a5_0) reduction(+:p_a6_0) reduction(+:p_a7_0)
    #endif
