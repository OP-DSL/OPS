...
//
#define OPS_ACC0(x,y) (n_x*1+n_y*xdim0_tea_leaf_xpy_kernel*1+x+xdim0_tea_leaf_xpy_kernel*(y))
#define OPS_ACC1(x,y) (n_x*1+n_y*xdim1_tea_leaf_xpy_kernel*1+x+xdim1_tea_leaf_xpy_kernel*(y))
