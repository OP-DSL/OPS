...
#define OPS_ACC0(x, y) (x + dims_tea_leaf_yeqx_kernel[0][0] * (y))
#define OPS_ACC1(x, y) (x + dims_tea_leaf_yeqx_kernel[1][0] * (y))
...
void ops_par_loop_tea_leaf_yeqx_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_tea_leaf_yeqx_kernel_h[0][0] ||
      xdim1 != dims_tea_leaf_yeqx_kernel_h[1][0]) {
    dims_tea_leaf_yeqx_kernel_h[0][0] = xdim0;
    dims_tea_leaf_yeqx_kernel_h[1][0] = xdim1;
    cutilSafeCall(cudaMemcpyToSymbol(dims_tea_leaf_yeqx_kernel,
                                     dims_tea_leaf_yeqx_kernel_h,
                                     sizeof(dims_tea_leaf_yeqx_kernel)));
  }
  ...
  if (x_size > 0 && y_size > 0)
    ops_tea_leaf_yeqx_kernel<<<grid, tblock>>>(
