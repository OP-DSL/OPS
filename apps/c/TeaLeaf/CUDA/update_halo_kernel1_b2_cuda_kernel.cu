...
__device__
    ...
    inline void
    update_halo_kernel1_b2_gpu(double *density0, double *energy0,
...
ops_update_halo_kernel1_b2(double *__restrict arg0, double *__restrict arg1,
  ...
  if (idx_x < size0 && idx_y < size1) {
    update_halo_kernel1_b2_gpu(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
  }
}
...
void ops_par_loop_update_halo_kernel1_b2_execute(ops_kernel_descriptor *desc) {
  ...
  if (!ops_checkpointing_before(args, 7, range, 49))
    return;
#endif
