...
__global__ void ops_initialise_chunk_kernel_volume(
  ...
  arg0 +=
      idx_x * 1 * 1 + idx_y * 1 * 1 * dims_initialise_chunk_kernel_volume[0][0];
  arg1 +=
      idx_x * 0 * 1 + idx_y * 1 * 1 * dims_initialise_chunk_kernel_volume[1][0];
  arg2 +=
      idx_x * 1 * 1 + idx_y * 1 * 1 * dims_initialise_chunk_kernel_volume[2][0];
  arg3 +=
      idx_x * 1 * 1 + idx_y * 0 * 1 * dims_initialise_chunk_kernel_volume[3][0];
  arg4 +=
      idx_x * 1 * 1 + idx_y * 1 * 1 * dims_initialise_chunk_kernel_volume[4][0];
