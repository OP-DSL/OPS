...
__global__ void ops_tea_leaf_ppcg_inner2_kernel(double *__restrict arg0,
  ...
  arg0 +=
      idx_x * 1 * 1 + idx_y * 1 * 1 * dims_tea_leaf_ppcg_inner2_kernel[0][0];
  arg1 +=
      idx_x * 1 * 1 + idx_y * 1 * 1 * dims_tea_leaf_ppcg_inner2_kernel[1][0];
  arg2 +=
      idx_x * 1 * 1 + idx_y * 1 * 1 * dims_tea_leaf_ppcg_inner2_kernel[2][0];
...
void ops_par_loop_tea_leaf_ppcg_inner2_kernel_execute(
  ...
  if (xdim0 != dims_tea_leaf_ppcg_inner2_kernel_h[0][0] ||
      xdim1 != dims_tea_leaf_ppcg_inner2_kernel_h[1][0] ||
      xdim2 != dims_tea_leaf_ppcg_inner2_kernel_h[2][0]) {
    ...
    cutilSafeCall(cudaMemcpyToSymbol(dims_tea_leaf_ppcg_inner2_kernel,
                                     dims_tea_leaf_ppcg_inner2_kernel_h,
                                     sizeof(dims_tea_leaf_ppcg_inner2_kernel)));
  }
