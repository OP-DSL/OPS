...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    tea_leaf_cg_calc_ur_r_reduce_kernel_gpu(argp0,
                   argp1,
                   &arg2,
                   arg3_l);
  }
...
void ops_par_loop_tea_leaf_cg_calc_ur_r_reduce_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_tea_leaf_cg_calc_ur_r_reduce_kernel_h[0][0] || xdim1 != dims_tea_leaf_cg_calc_ur_r_reduce_kernel_h[1][0]) {
    ...
    cutilSafeCall(cudaMemcpyToSymbol( dims_tea_leaf_cg_calc_ur_r_reduce_kernel, dims_tea_leaf_cg_calc_ur_r_reduce_kernel_h, sizeof(dims_tea_leaf_cg_calc_ur_r_reduce_kernel)));
  }
