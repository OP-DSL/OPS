...
int size1 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * xdim0_tea_leaf_cg_calc_ur_r_reduce_kernel;
  arg1 += idx_x * 1*1 + idx_y * 1*1 * xdim1_tea_leaf_cg_calc_ur_r_reduce_kernel;
...
void ops_par_loop_tea_leaf_cg_calc_ur_r_reduce_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3) {
  ...
  if (xdim0 != xdim0_tea_leaf_cg_calc_ur_r_reduce_kernel_h || xdim1 != xdim1_tea_leaf_cg_calc_ur_r_reduce_kernel_h) {
    cudaMemcpyToSymbol( xdim0_tea_leaf_cg_calc_ur_r_reduce_kernel, &xdim0, sizeof(int) );
    xdim0_tea_leaf_cg_calc_ur_r_reduce_kernel_h = xdim0;
    cudaMemcpyToSymbol( xdim1_tea_leaf_cg_calc_ur_r_reduce_kernel, &xdim1, sizeof(int) );
