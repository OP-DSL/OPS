...
__device__
    ...
    void
    tea_leaf_dot_kernel_gpu(const double *r, const double *p, double *rro) {
...
__global__ void ops_tea_leaf_dot_kernel(const double *__restrict arg0,
...
void ops_par_loop_tea_leaf_dot_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_tea_leaf_dot_kernel_h[0][0] ||
      xdim1 != dims_tea_leaf_dot_kernel_h[1][0]) {
    dims_tea_leaf_dot_kernel_h[0][0] = xdim0;
    dims_tea_leaf_dot_kernel_h[1][0] = xdim1;
    cutilSafeCall(cudaMemcpyToSymbol(dims_tea_leaf_dot_kernel,
                                     dims_tea_leaf_dot_kernel_h,
                                     sizeof(dims_tea_leaf_dot_kernel)));
  }
  ...
  if (x_size > 0 && y_size > 0)
    ops_tea_leaf_dot_kernel<<<grid, tblock, nshared>>>(
