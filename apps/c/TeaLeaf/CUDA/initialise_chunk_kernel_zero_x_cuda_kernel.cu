...
//
__constant__ int xdim0_initialise_chunk_kernel_zero_x;
...
__global__ void ops_initialise_chunk_kernel_zero_x(double *__restrict arg0,
  ...
  arg0 += idx_x * 1 * 1 + idx_y * 0 * 1 * xdim0_initialise_chunk_kernel_zero_x;
...
void ops_par_loop_initialise_chunk_kernel_zero_x_execute(
  ...
  if (xdim0 != xdim0_initialise_chunk_kernel_zero_x_h) {
    cudaMemcpyToSymbol(xdim0_initialise_chunk_kernel_zero_x, &xdim0,
                       sizeof(int));
  ...
  ops_initialise_chunk_kernel_zero_x<<<grid, tblock>>>((double *)p_a[0], x_size,
                                                       y_size);
