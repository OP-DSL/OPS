...
void ops_par_loop_tea_leaf_ppcg_init1_kernel(char const *name, ops_block block,
  ...
  if (xdim0 != xdim0_tea_leaf_ppcg_init1_kernel_h ||
      xdim1 != xdim1_tea_leaf_ppcg_init1_kernel_h ||
      xdim2 != xdim2_tea_leaf_ppcg_init1_kernel_h ||
      xdim3 != xdim3_tea_leaf_ppcg_init1_kernel_h ||
      xdim4 != xdim4_tea_leaf_ppcg_init1_kernel_h) {
