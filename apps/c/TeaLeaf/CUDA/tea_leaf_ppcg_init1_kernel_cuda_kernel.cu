...
__device__
    ...
    void
    tea_leaf_ppcg_init1_kernel_gpu(double *sd, double *rtemp, double *utemp,
...
__global__ void ops_tea_leaf_ppcg_init1_kernel(
    ...
    const double *__restrict arg3, const double *__restrict arg4,
    const double arg5, int size0, int size1) {
  ...
  if (idx_x < size0 && idx_y < size1) {
    tea_leaf_ppcg_init1_kernel_gpu(arg0, arg1, arg2, arg3, arg4, &arg5);
  }
}
...
void ops_par_loop_tea_leaf_ppcg_init1_kernel_execute(
  ...
  if (xdim0 != dims_tea_leaf_ppcg_init1_kernel_h[0][0] ||
      xdim1 != dims_tea_leaf_ppcg_init1_kernel_h[1][0] ||
      xdim2 != dims_tea_leaf_ppcg_init1_kernel_h[2][0] ||
      xdim3 != dims_tea_leaf_ppcg_init1_kernel_h[3][0] ||
      xdim4 != dims_tea_leaf_ppcg_init1_kernel_h[4][0]) {
    ...
    cutilSafeCall(cudaMemcpyToSymbol(dims_tea_leaf_ppcg_init1_kernel,
                                     dims_tea_leaf_ppcg_init1_kernel_h,
                                     sizeof(dims_tea_leaf_ppcg_init1_kernel)));
  }
  ...
  if (x_size > 0 && y_size > 0)
    ops_tea_leaf_ppcg_init1_kernel<<<grid, tblock>>>(
