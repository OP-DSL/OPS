...
#define OPS_ACC0(x, y) (x + dims_tea_leaf_common_init_u_u0_kernel[0][0] * (y))
#define OPS_ACC1(x, y) (x + dims_tea_leaf_common_init_u_u0_kernel[1][0] * (y))
#define OPS_ACC2(x, y) (x + dims_tea_leaf_common_init_u_u0_kernel[2][0] * (y))
#define OPS_ACC3(x, y) (x + dims_tea_leaf_common_init_u_u0_kernel[3][0] * (y))
...
__global__ void ops_tea_leaf_common_init_u_u0_kernel(
  ...
  arg0 += idx_x * 1 * 1 +
          idx_y * 1 * 1 * dims_tea_leaf_common_init_u_u0_kernel[0][0];
  arg1 += idx_x * 1 * 1 +
          idx_y * 1 * 1 * dims_tea_leaf_common_init_u_u0_kernel[1][0];
  arg2 += idx_x * 1 * 1 +
          idx_y * 1 * 1 * dims_tea_leaf_common_init_u_u0_kernel[2][0];
  arg3 += idx_x * 1 * 1 +
          idx_y * 1 * 1 * dims_tea_leaf_common_init_u_u0_kernel[3][0];
...
void ops_par_loop_tea_leaf_common_init_u_u0_kernel_execute(
  ...
  if (xdim0 != dims_tea_leaf_common_init_u_u0_kernel_h[0][0] ||
      xdim1 != dims_tea_leaf_common_init_u_u0_kernel_h[1][0] ||
      xdim2 != dims_tea_leaf_common_init_u_u0_kernel_h[2][0] ||
      xdim3 != dims_tea_leaf_common_init_u_u0_kernel_h[3][0]) {
    ...
    cutilSafeCall(
        cudaMemcpyToSymbol(dims_tea_leaf_common_init_u_u0_kernel,
                           dims_tea_leaf_common_init_u_u0_kernel_h,
                           sizeof(dims_tea_leaf_common_init_u_u0_kernel)));
  }
