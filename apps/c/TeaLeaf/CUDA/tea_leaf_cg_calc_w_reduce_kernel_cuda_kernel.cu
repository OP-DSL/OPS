...
__device__
    ...
    void
    tea_leaf_cg_calc_w_reduce_kernel_gpu(double *w, const double *Kx,
...
__global__ void ops_tea_leaf_cg_calc_w_reduce_kernel(
    ...
    const double arg4, const double arg5, double *__restrict arg6, int size0,
    int size1) {
  ...
  arg0 +=
      idx_x * 1 * 1 + idx_y * 1 * 1 * xdim0_tea_leaf_cg_calc_w_reduce_kernel;
  arg1 +=
      idx_x * 1 * 1 + idx_y * 1 * 1 * xdim1_tea_leaf_cg_calc_w_reduce_kernel;
  arg2 +=
      idx_x * 1 * 1 + idx_y * 1 * 1 * xdim2_tea_leaf_cg_calc_w_reduce_kernel;
  arg3 +=
      idx_x * 1 * 1 + idx_y * 1 * 1 * xdim3_tea_leaf_cg_calc_w_reduce_kernel;

  if (idx_x < size0 && idx_y < size1) {
    tea_leaf_cg_calc_w_reduce_kernel_gpu(arg0, arg1, arg2, arg3, &arg4, &arg5,
                                         arg6_l);
  }
  for (int d = 0; d < 1; d++)
...
void ops_par_loop_tea_leaf_cg_calc_w_reduce_kernel(char const *name,
  ...
  if (xdim0 != xdim0_tea_leaf_cg_calc_w_reduce_kernel_h ||
    ...
    cudaMemcpyToSymbol(xdim0_tea_leaf_cg_calc_w_reduce_kernel, &xdim0,
                       sizeof(int));
    xdim0_tea_leaf_cg_calc_w_reduce_kernel_h = xdim0;
    cudaMemcpyToSymbol(xdim1_tea_leaf_cg_calc_w_reduce_kernel, &xdim1,
                       sizeof(int));
    xdim1_tea_leaf_cg_calc_w_reduce_kernel_h = xdim1;
    cudaMemcpyToSymbol(xdim2_tea_leaf_cg_calc_w_reduce_kernel, &xdim2,
                       sizeof(int));
    xdim2_tea_leaf_cg_calc_w_reduce_kernel_h = xdim2;
    cudaMemcpyToSymbol(xdim3_tea_leaf_cg_calc_w_reduce_kernel, &xdim3,
                       sizeof(int));
