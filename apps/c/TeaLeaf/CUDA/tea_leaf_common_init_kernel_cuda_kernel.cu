...
#define OPS_ACC0(x, y) (x + dims_tea_leaf_common_init_kernel[0][0] * (y))
#define OPS_ACC1(x, y) (x + dims_tea_leaf_common_init_kernel[1][0] * (y))
#define OPS_ACC2(x, y) (x + dims_tea_leaf_common_init_kernel[2][0] * (y))
#define OPS_ACC3(x, y) (x + dims_tea_leaf_common_init_kernel[3][0] * (y))
#define OPS_ACC4(x, y) (x + dims_tea_leaf_common_init_kernel[4][0] * (y))

// user function
__device__

    void
    tea_leaf_common_init_kernel_gpu(double *w, double *r, const double *Kx,
...
__global__ void ops_tea_leaf_common_init_kernel(
  ...
  arg0 +=
      idx_x * 1 * 1 + idx_y * 1 * 1 * dims_tea_leaf_common_init_kernel[0][0];
  arg1 +=
      idx_x * 1 * 1 + idx_y * 1 * 1 * dims_tea_leaf_common_init_kernel[1][0];
  arg2 +=
      idx_x * 1 * 1 + idx_y * 1 * 1 * dims_tea_leaf_common_init_kernel[2][0];
  arg3 +=
      idx_x * 1 * 1 + idx_y * 1 * 1 * dims_tea_leaf_common_init_kernel[3][0];
  arg4 +=
      idx_x * 1 * 1 + idx_y * 1 * 1 * dims_tea_leaf_common_init_kernel[4][0];

  if (idx_x < size0 && idx_y < size1) {
    tea_leaf_common_init_kernel_gpu(arg0, arg1, arg2, arg3, arg4, &arg5, &arg6);
  }
}
...
void ops_par_loop_tea_leaf_common_init_kernel_execute(
  ...
  if (xdim0 != dims_tea_leaf_common_init_kernel_h[0][0] ||
      xdim1 != dims_tea_leaf_common_init_kernel_h[1][0] ||
      xdim2 != dims_tea_leaf_common_init_kernel_h[2][0] ||
      xdim3 != dims_tea_leaf_common_init_kernel_h[3][0] ||
      xdim4 != dims_tea_leaf_common_init_kernel_h[4][0]) {
    ...
    cutilSafeCall(cudaMemcpyToSymbol(dims_tea_leaf_common_init_kernel,
                                     dims_tea_leaf_common_init_kernel_h,
  ...
  if (x_size > 0 && y_size > 0)
    ops_tea_leaf_common_init_kernel<<<grid, tblock>>>(
