...
void ops_par_loop_tea_leaf_init_zero2_kernel_execute(
  ...
  if (xdim0 != dims_tea_leaf_init_zero2_kernel_h[0][0] ||
      xdim1 != dims_tea_leaf_init_zero2_kernel_h[1][0]) {
    dims_tea_leaf_init_zero2_kernel_h[0][0] = xdim0;
    dims_tea_leaf_init_zero2_kernel_h[1][0] = xdim1;
    cutilSafeCall(cudaMemcpyToSymbol(dims_tea_leaf_init_zero2_kernel,
                                     dims_tea_leaf_init_zero2_kernel_h,
                                     sizeof(dims_tea_leaf_init_zero2_kernel)));
  }
