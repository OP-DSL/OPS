...
void ops_par_loop_tea_leaf_jacobi_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_tea_leaf_jacobi_kernel_h[0][0] ||
      xdim1 != dims_tea_leaf_jacobi_kernel_h[1][0] ||
      xdim2 != dims_tea_leaf_jacobi_kernel_h[2][0] ||
      xdim3 != dims_tea_leaf_jacobi_kernel_h[3][0] ||
      xdim4 != dims_tea_leaf_jacobi_kernel_h[4][0]) {
    ...
    cutilSafeCall(cudaMemcpyToSymbol(dims_tea_leaf_jacobi_kernel,
                                     dims_tea_leaf_jacobi_kernel_h,
                                     sizeof(dims_tea_leaf_jacobi_kernel)));
  }
