...
void ops_par_loop_tea_leaf_common_residual_kernel(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6) {
  ...
  if (xdim0 != xdim0_tea_leaf_common_residual_kernel_h || xdim1 != xdim1_tea_leaf_common_residual_kernel_h || xdim2 != xdim2_tea_leaf_common_residual_kernel_h || xdim3 != xdim3_tea_leaf_common_residual_kernel_h || xdim4 != xdim4_tea_leaf_common_residual_kernel_h) {
    cudaMemcpyToSymbol( xdim0_tea_leaf_common_residual_kernel, &xdim0, sizeof(int) );
    xdim0_tea_leaf_common_residual_kernel_h = xdim0;
    cudaMemcpyToSymbol( xdim1_tea_leaf_common_residual_kernel, &xdim1, sizeof(int) );
    xdim1_tea_leaf_common_residual_kernel_h = xdim1;
    cudaMemcpyToSymbol( xdim2_tea_leaf_common_residual_kernel, &xdim2, sizeof(int) );
    xdim2_tea_leaf_common_residual_kernel_h = xdim2;
    cudaMemcpyToSymbol( xdim3_tea_leaf_common_residual_kernel, &xdim3, sizeof(int) );
    xdim3_tea_leaf_common_residual_kernel_h = xdim3;
    cudaMemcpyToSymbol( xdim4_tea_leaf_common_residual_kernel, &xdim4, sizeof(int) );
