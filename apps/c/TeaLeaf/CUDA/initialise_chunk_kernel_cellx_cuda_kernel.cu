...
__global__ void ops_initialise_chunk_kernel_cellx(const double *__restrict arg0,
  ...
  arg0 +=
      idx_x * 1 * 1 + idx_y * 0 * 1 * dims_initialise_chunk_kernel_cellx[0][0];
  arg1 +=
      idx_x * 1 * 1 + idx_y * 0 * 1 * dims_initialise_chunk_kernel_cellx[1][0];
  arg2 +=
      idx_x * 1 * 1 + idx_y * 0 * 1 * dims_initialise_chunk_kernel_cellx[2][0];
