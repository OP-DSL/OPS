...
void ops_par_loop_set_field_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_set_field_kernel_h[0][0] ||
      xdim1 != dims_set_field_kernel_h[1][0]) {
    dims_set_field_kernel_h[0][0] = xdim0;
    dims_set_field_kernel_h[1][0] = xdim1;
    cutilSafeCall(cudaMemcpyToSymbol(dims_set_field_kernel,
                                     dims_set_field_kernel_h,
                                     sizeof(dims_set_field_kernel)));
  }
