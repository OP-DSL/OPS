...
__global__ void ops_initialise_chunk_kernel_zero_y(double *__restrict arg0,
  ...
  arg0 +=
      idx_x * 0 * 1 + idx_y * 1 * 1 * dims_initialise_chunk_kernel_zero_y[0][0];
...
void ops_par_loop_initialise_chunk_kernel_zero_y_execute(
  ...
  if (xdim0 != dims_initialise_chunk_kernel_zero_y_h[0][0]) {
    ...
    cutilSafeCall(
        cudaMemcpyToSymbol(dims_initialise_chunk_kernel_zero_y,
                           dims_initialise_chunk_kernel_zero_y_h,
                           sizeof(dims_initialise_chunk_kernel_zero_y)));
  }
