...
#define OPS_ACC0(x,y) (x+dims_initialise_chunk_kernel_zero_y[0][0]*(y))
...
void ops_par_loop_initialise_chunk_kernel_zero_y_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_initialise_chunk_kernel_zero_y_h[0][0]) {
    ...
    cutilSafeCall(cudaMemcpyToSymbol( dims_initialise_chunk_kernel_zero_y, dims_initialise_chunk_kernel_zero_y_h, sizeof(dims_initialise_chunk_kernel_zero_y)));
  }
