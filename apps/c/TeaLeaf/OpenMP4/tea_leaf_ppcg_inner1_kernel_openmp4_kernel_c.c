...
#define OPS_ACC0(x, y)                                                         \
  (n_x * 1 * 1 + n_y * xdim0_tea_leaf_ppcg_inner1_kernel * 1 * 1 + x +         \
   xdim0_tea_leaf_ppcg_inner1_kernel * (y))
#define OPS_ACC1(x, y)                                                         \
  (n_x * 1 * 1 + n_y * xdim1_tea_leaf_ppcg_inner1_kernel * 1 * 1 + x +         \
   xdim1_tea_leaf_ppcg_inner1_kernel * (y))
#define OPS_ACC2(x, y)                                                         \
  (n_x * 1 * 1 + n_y * xdim2_tea_leaf_ppcg_inner1_kernel * 1 * 1 + x +         \
   xdim2_tea_leaf_ppcg_inner1_kernel * (y))
#define OPS_ACC3(x, y)                                                         \
  (n_x * 1 * 1 + n_y * xdim3_tea_leaf_ppcg_inner1_kernel * 1 * 1 + x +         \
