...
#define OPS_ACC0(x, y)                                                         \
  (n_x * 1 * 1 + n_y * xdim0_tea_leaf_cheby_init_kernel * 1 * 1 + x +          \
   xdim0_tea_leaf_cheby_init_kernel * (y))
#define OPS_ACC1(x, y)                                                         \
  (n_x * 1 * 1 + n_y * xdim1_tea_leaf_cheby_init_kernel * 1 * 1 + x +          \
   xdim1_tea_leaf_cheby_init_kernel * (y))
#define OPS_ACC2(x, y)                                                         \
  (n_x * 1 * 1 + n_y * xdim2_tea_leaf_cheby_init_kernel * 1 * 1 + x +          \
   xdim2_tea_leaf_cheby_init_kernel * (y))
#define OPS_ACC3(x, y)                                                         \
  (n_x * 1 * 1 + n_y * xdim3_tea_leaf_cheby_init_kernel * 1 * 1 + x +          \
   xdim3_tea_leaf_cheby_init_kernel * (y))
#define OPS_ACC4(x, y)                                                         \
  (n_x * 1 * 1 + n_y * xdim4_tea_leaf_cheby_init_kernel * 1 * 1 + x +          \
   xdim4_tea_leaf_cheby_init_kernel * (y))
#define OPS_ACC5(x, y)                                                         \
  (n_x * 1 * 1 + n_y * xdim5_tea_leaf_cheby_init_kernel * 1 * 1 + x +          \
