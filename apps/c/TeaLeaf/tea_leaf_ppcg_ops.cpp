...
void ops_par_loop_tea_leaf_ppcg_init1_kernel(char const *, ops_block, int,
                                             int *, ops_arg, ops_arg, ops_arg,
                                             ops_arg, ops_arg, ops_arg);

void ops_par_loop_tea_leaf_ppcg_init2_kernel(char const *, ops_block, int,
                                             int *, ops_arg, ops_arg, ops_arg,
                                             ops_arg, ops_arg);

void ops_par_loop_tea_leaf_init_zero2_kernel(char const *, ops_block, int,
                                             int *, ops_arg, ops_arg);
...
void ops_par_loop_tea_leaf_ppcg_inner1_kernel(char const *, ops_block, int,
                                              int *, ops_arg, ops_arg, ops_arg,
                                              ops_arg, ops_arg, ops_arg);

void ops_par_loop_tea_leaf_ppcg_inner2_kernel(char const *, ops_block, int,
                                              int *, ops_arg, ops_arg, ops_arg,
                                              ops_arg, ops_arg);
...
void ops_par_loop_tea_leaf_ppcg_reduce_kernel(char const *, ops_block, int,
                                              int *, ops_arg, ops_arg, ops_arg,
                                              ops_arg);
...
void tea_leaf_ppcg_init_sd(ops_dat r, ops_dat rtemp, ops_dat kx, ops_dat ky,
                           ops_dat sd, ops_dat z, ops_dat utemp, ops_dat cp,
  ...
  if (preconditioner_type != TL_PREC_NONE) {
    ops_par_loop_tea_leaf_ppcg_init1_kernel(
        "tea_leaf_ppcg_init1_kernel", tea_grid, 2, rangexy,
    ...
    ops_par_loop_tea_leaf_ppcg_init2_kernel(
        "tea_leaf_ppcg_init2_kernel", tea_grid, 2, rangexy,
        ops_arg_dat(sd, 1, S2D_00, "double", OPS_WRITE),
        ops_arg_dat(rtemp, 1, S2D_00, "double", OPS_WRITE),
        ops_arg_dat(utemp, 1, S2D_00, "double", OPS_WRITE),
        ops_arg_dat(r, 1, S2D_00, "double", OPS_READ),
...
void tea_leaf_ppcg_init(ops_dat p, ops_dat r, ops_dat Mi, ops_dat z, ops_dat Kx,
                        ops_dat Ky, ops_dat cp, ops_dat bfp, double rx,
                        double ry, double *rro, int preconditioner_type,
                        int ppcg_inner_iters, double *ch_alphas,
                        double *ch_betas, double theta, double solve_time,
                        int step) {
  ...
  *rro = 0.0;
  ...
  if (step == 1) {
    ops_par_loop_tea_leaf_init_zero2_kernel(
        "tea_leaf_init_zero2_kernel", tea_grid, 2, rangexy,
        ops_arg_dat(p, 1, S2D_00, "double", OPS_WRITE),
        ops_arg_dat(z, 1, S2D_00, "double", OPS_WRITE));
  } else if (step == 3) {
    ops_par_loop_tea_leaf_init_zero_kernel(
        "tea_leaf_init_zero_kernel", tea_grid, 2, rangexy,
        ops_arg_dat(p, 1, S2D_00, "double", OPS_WRITE));
  }
  ...
  if (step == 1 || step == 3) {
    ops_par_loop_tea_leaf_dot_kernel(
        "tea_leaf_dot_kernel", tea_grid, 2, rangexy,
...
void tea_leaf_kernel_ppcg_inner(double *alpha, double *beta, double rx,
                                double ry, int inner_step, ops_dat u, ops_dat r,
                                ops_dat rtemp, ops_dat Kx, ops_dat Ky,
                                ops_dat sd, ops_dat z, ops_dat utemp,
                                ops_dat cp, ops_dat bfp, ops_dat Mi,
  ...
  ops_par_loop_tea_leaf_ppcg_inner1_kernel(
      "tea_leaf_ppcg_inner1_kernel", tea_grid, 2, rangexy,
  ...
  if (preconditioner_type != TL_PREC_NONE) {
    ...
    ops_par_loop_tea_leaf_ppcg_inner2_kernel(
        "tea_leaf_ppcg_inner2_kernel", tea_grid, 2, rangexy,
...
void tea_leaf_ppcg_calc_zrnorm(ops_dat z, ops_dat r, int preconditioner_type,
                               double *norm) {
...
void tea_leaf_ppcg_update_z(ops_dat z, ops_dat utemp) {
...
void tea_leaf_ppcg_store_r(ops_dat r, ops_dat rstore) {
...
void tea_leaf_ppcg_calc_rrn(ops_dat r, ops_dat rstore, ops_dat z, double *rrn) {
  ...
  *rrn = 0.0;
  ...
  ops_par_loop_tea_leaf_ppcg_reduce_kernel(
      "tea_leaf_ppcg_reduce_kernel", tea_grid, 2, rangexy,
...
void tea_leaf_run_ppcg_inner_steps(double *ch_alphas, double *ch_betas,
                                   double *theta, int tl_ppcg_inner_steps,
                                   double *solve_time, double rx, double ry) {
  ...
  tea_leaf_ppcg_init_sd(vector_r, vector_rtemp, vector_Kx, vector_Ky, vector_sd,
                        vector_z, vector_utemp, tri_cp, tri_bfp, vector_Mi, rx,
                        ry, *theta, tl_preconditioner_type);

  for (ppcg_cur_step = 1; ppcg_cur_step <= tl_ppcg_inner_steps;
       ppcg_cur_step++) {
    ...
    tea_leaf_kernel_ppcg_inner(ch_alphas, ch_betas, rx, ry, inner_step, u,
                               vector_r, vector_rtemp, vector_Kx, vector_Ky,
                               vector_sd, vector_z, vector_utemp, tri_cp,
                               tri_bfp, vector_Mi, tl_preconditioner_type);

    if (ppcg_cur_step % tiling_frequency == 0)
      ops_execute();
  }
