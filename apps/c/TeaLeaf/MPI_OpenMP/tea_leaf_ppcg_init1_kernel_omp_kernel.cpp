...
#pragma simd
        for (int i = 0; i < SIMD_VEC; i++) {
          tea_leaf_ppcg_init1_kernel(
              ...
              (double *)p_a[2] + i * 1 * 1, (const double *)p_a[3] + i * 1 * 1,
              (const double *)p_a[4] + i * 1 * 1, (double *)p_a[5]);
        }
      ...
      for (int n_x = start[0] + ((end[0] - start[0]) / SIMD_VEC) * SIMD_VEC;
        ...
        tea_leaf_ppcg_init1_kernel((double *)p_a[0], (double *)p_a[1],
                                   (double *)p_a[2], (const double *)p_a[3],
                                   (const double *)p_a[4], (double *)p_a[5]);
