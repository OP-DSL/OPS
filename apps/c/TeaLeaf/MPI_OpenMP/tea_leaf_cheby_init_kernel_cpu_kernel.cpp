...
#pragma simd
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ACC<double> w(xdim0_tea_leaf_cheby_init_kernel,
                    w_p + n_x * 1 + n_y * xdim0_tea_leaf_cheby_init_kernel * 1);
      ACC<double> r(xdim1_tea_leaf_cheby_init_kernel,
                    r_p + n_x * 1 + n_y * xdim1_tea_leaf_cheby_init_kernel * 1);
      const ACC<double> Kx(xdim2_tea_leaf_cheby_init_kernel,
                           Kx_p + n_x * 1 +
                               n_y * xdim2_tea_leaf_cheby_init_kernel * 1);
      const ACC<double> Ky(xdim3_tea_leaf_cheby_init_kernel,
                           Ky_p + n_x * 1 +
                               n_y * xdim3_tea_leaf_cheby_init_kernel * 1);
      const ACC<double> u(xdim4_tea_leaf_cheby_init_kernel,
                          u_p + n_x * 1 +
                              n_y * xdim4_tea_leaf_cheby_init_kernel * 1);
      const ACC<double> u0(xdim5_tea_leaf_cheby_init_kernel,
                           u0_p + n_x * 1 +
                               n_y * xdim5_tea_leaf_cheby_init_kernel * 1);
