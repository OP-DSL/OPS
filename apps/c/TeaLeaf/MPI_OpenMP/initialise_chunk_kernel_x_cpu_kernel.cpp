...
//
#define OPS_ACC0(x,y) (n_x*1 + x + (n_y*0+(y))*xdim0_initialise_chunk_kernel_x)
#define OPS_ACC1(x,y) (n_x*1 + x + (n_y*0+(y))*xdim1_initialise_chunk_kernel_x)
#define OPS_ACC2(x,y) (n_x*1 + x + (n_y*0+(y))*xdim2_initialise_chunk_kernel_x)
