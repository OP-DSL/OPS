...
#pragma simd
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ACC<double> rtemp(xdim0_tea_leaf_ppcg_inner1_kernel,
                        rtemp_p + n_x * 1 +
                            n_y * xdim0_tea_leaf_ppcg_inner1_kernel * 1);
      const ACC<double> Kx(xdim1_tea_leaf_ppcg_inner1_kernel,
                           Kx_p + n_x * 1 +
                               n_y * xdim1_tea_leaf_ppcg_inner1_kernel * 1);
      const ACC<double> Ky(xdim2_tea_leaf_ppcg_inner1_kernel,
                           Ky_p + n_x * 1 +
                               n_y * xdim2_tea_leaf_ppcg_inner1_kernel * 1);
      const ACC<double> sd(xdim3_tea_leaf_ppcg_inner1_kernel,
                           sd_p + n_x * 1 +
