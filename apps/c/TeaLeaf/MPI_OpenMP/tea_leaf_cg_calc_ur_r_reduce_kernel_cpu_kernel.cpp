...
#pragma simd
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ACC<double> r(xdim0_tea_leaf_cg_calc_ur_r_reduce_kernel,
                    r_p + n_x * 1 +
                        n_y * xdim0_tea_leaf_cg_calc_ur_r_reduce_kernel * 1);
      const ACC<double> w(
          xdim1_tea_leaf_cg_calc_ur_r_reduce_kernel,
          w_p + n_x * 1 + n_y * xdim1_tea_leaf_cg_calc_ur_r_reduce_kernel * 1);
      double rnn[1];
      rnn[0] = ZERO_double;
