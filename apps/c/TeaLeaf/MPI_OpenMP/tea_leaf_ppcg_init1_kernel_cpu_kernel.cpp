...
//
#define OPS_ACC0(x, y)                                                         \
  (n_x * 1 + x + (n_y * 1 + (y)) * xdim0_tea_leaf_ppcg_init1_kernel)
#define OPS_ACC1(x, y)                                                         \
  (n_x * 1 + x + (n_y * 1 + (y)) * xdim1_tea_leaf_ppcg_init1_kernel)
#define OPS_ACC2(x, y)                                                         \
  (n_x * 1 + x + (n_y * 1 + (y)) * xdim2_tea_leaf_ppcg_init1_kernel)
#define OPS_ACC3(x, y)                                                         \
  (n_x * 1 + x + (n_y * 1 + (y)) * xdim3_tea_leaf_ppcg_init1_kernel)
#define OPS_ACC4(x, y)                                                         \
  (n_x * 1 + x + (n_y * 1 + (y)) * xdim4_tea_leaf_ppcg_init1_kernel)
