...
#pragma simd
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ACC<double> sd(xdim0_tea_leaf_ppcg_init1_kernel,
                     sd_p + n_x * 1 +
                         n_y * xdim0_tea_leaf_ppcg_init1_kernel * 1);
      ACC<double> rtemp(xdim1_tea_leaf_ppcg_init1_kernel,
                        rtemp_p + n_x * 1 +
                            n_y * xdim1_tea_leaf_ppcg_init1_kernel * 1);
      ACC<double> utemp(xdim2_tea_leaf_ppcg_init1_kernel,
                        utemp_p + n_x * 1 +
                            n_y * xdim2_tea_leaf_ppcg_init1_kernel * 1);
      const ACC<double> z(xdim3_tea_leaf_ppcg_init1_kernel,
                          z_p + n_x * 1 +
                              n_y * xdim3_tea_leaf_ppcg_init1_kernel * 1);
      const ACC<double> r(xdim4_tea_leaf_ppcg_init1_kernel,
                          r_p + n_x * 1 +
