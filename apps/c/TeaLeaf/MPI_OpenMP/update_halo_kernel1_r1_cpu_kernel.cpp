...
#pragma simd
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      ACC<double> energy0(xdim1_update_halo_kernel1_r1,
                          energy0_p + n_x * 1 +
                              n_y * xdim1_update_halo_kernel1_r1 * 1);
      ACC<double> energy1(xdim2_update_halo_kernel1_r1,
                          energy1_p + n_x * 1 +
                              n_y * xdim2_update_halo_kernel1_r1 * 1);
      ACC<double> u(xdim3_update_halo_kernel1_r1,
                    u_p + n_x * 1 + n_y * xdim3_update_halo_kernel1_r1 * 1);
      ACC<double> p(xdim4_update_halo_kernel1_r1,
                    p_p + n_x * 1 + n_y * xdim4_update_halo_kernel1_r1 * 1);
      ACC<double> sd(xdim5_update_halo_kernel1_r1,
                     sd_p + n_x * 1 + n_y * xdim5_update_halo_kernel1_r1 * 1);
