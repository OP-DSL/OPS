...
#pragma simd
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      const ACC<double> rstore(xdim0_tea_leaf_ppcg_reduce_kernel,
                               rstore_p + n_x * 1 +
                                   n_y * xdim0_tea_leaf_ppcg_reduce_kernel * 1);
      const ACC<double> r(xdim1_tea_leaf_ppcg_reduce_kernel,
                          r_p + n_x * 1 +
                              n_y * xdim1_tea_leaf_ppcg_reduce_kernel * 1);
      const ACC<double> z(xdim2_tea_leaf_ppcg_reduce_kernel,
                          z_p + n_x * 1 +
