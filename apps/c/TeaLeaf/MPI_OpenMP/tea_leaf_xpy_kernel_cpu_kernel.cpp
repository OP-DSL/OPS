...
#pragma simd
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ACC<double> u(xdim0_tea_leaf_xpy_kernel,
                    u_p + n_x * 1 + n_y * xdim0_tea_leaf_xpy_kernel * 1);
      const ACC<double> p(xdim1_tea_leaf_xpy_kernel,
                          p_p + n_x * 1 + n_y * xdim1_tea_leaf_xpy_kernel * 1);
