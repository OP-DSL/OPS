...
#pragma simd
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      const ACC<double> r(xdim0_tea_leaf_dot_kernel,
                          r_p + n_x * 1 + n_y * xdim0_tea_leaf_dot_kernel * 1);
      const ACC<double> p(xdim1_tea_leaf_dot_kernel,
                          p_p + n_x * 1 + n_y * xdim1_tea_leaf_dot_kernel * 1);
      double rro[1];
      rro[0] = ZERO_double;
