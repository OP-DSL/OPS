...
#pragma simd
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ACC<double> p(xdim0_tea_leaf_yeqx_kernel,
                    p_p + n_x * 1 + n_y * xdim0_tea_leaf_yeqx_kernel * 1);
      const ACC<double> x(xdim1_tea_leaf_yeqx_kernel,
                          x_p + n_x * 1 + n_y * xdim1_tea_leaf_yeqx_kernel * 1);
