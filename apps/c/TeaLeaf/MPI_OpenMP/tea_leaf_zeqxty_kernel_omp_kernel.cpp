...
// user function
inline void tea_leaf_zeqxty_kernel(double *z, const double *x,
                                   const double *y) {
...
#pragma simd
        for (int i = 0; i < SIMD_VEC; i++) {
          tea_leaf_zeqxty_kernel((double *)p_a[0] + i * 1 * 1,
      ...
      for (int n_x = start[0] + ((end[0] - start[0]) / SIMD_VEC) * SIMD_VEC;
        ...
        tea_leaf_zeqxty_kernel((double *)p_a[0], (const double *)p_a[1],
                               (const double *)p_a[2]);
