...
void buildOpenCLKernels_tea_leaf_cheby_init_kernel(int xdim0, int xdim1,
                                                   int xdim2, int xdim3,
                                                   int xdim4, int xdim5) {
  ...
  if (!isbuilt_tea_leaf_cheby_init_kernel) {
    ...
    char *source_filename[1] = {
        (char *)"./OpenCL/tea_leaf_cheby_init_kernel.cl"};
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts, "-cl-mad-enable -DOCL_FMA -I%s/c/include "
                           "-DOPS_WARPSIZE=%d  "
                           "-Dxdim0_tea_leaf_cheby_init_kernel=%d  "
                           "-Dxdim1_tea_leaf_cheby_init_kernel=%d  "
                           "-Dxdim2_tea_leaf_cheby_init_kernel=%d  "
                           "-Dxdim3_tea_leaf_cheby_init_kernel=%d  "
                           "-Dxdim4_tea_leaf_cheby_init_kernel=%d  "
                           "-Dxdim5_tea_leaf_cheby_init_kernel=%d ",
    ...
    OPS_opencl_core.kernel[23] = clCreateKernel(
        OPS_opencl_core.program, "ops_tea_leaf_cheby_init_kernel", &ret);
    clSafeCall(ret);
...
void ops_par_loop_tea_leaf_cheby_init_kernel(char const *name, ops_block block,
  ...
  buildOpenCLKernels_tea_leaf_cheby_init_kernel(xdim0, xdim1, xdim2, xdim3,
                                                xdim4, xdim5);
  ...
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[23], 0, sizeof(cl_mem),
                            (void *)&arg0.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[23], 1, sizeof(cl_mem),
                            (void *)&arg1.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[23], 2, sizeof(cl_mem),
                            (void *)&arg2.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[23], 3, sizeof(cl_mem),
                            (void *)&arg3.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[23], 4, sizeof(cl_mem),
                            (void *)&arg4.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[23], 5, sizeof(cl_mem),
                            (void *)&arg5.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[23], 6, sizeof(cl_double),
                            (void *)arg6.data));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[23], 7, sizeof(cl_double),
                            (void *)arg7.data));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[23], 8, sizeof(cl_int),
                            (void *)&base0));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[23], 9, sizeof(cl_int),
                            (void *)&base1));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[23], 10, sizeof(cl_int),
                            (void *)&base2));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[23], 11, sizeof(cl_int),
                            (void *)&base3));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[23], 12, sizeof(cl_int),
                            (void *)&base4));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[23], 13, sizeof(cl_int),
                            (void *)&base5));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[23], 14, sizeof(cl_int),
                            (void *)&x_size));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[23], 15, sizeof(cl_int),
                            (void *)&y_size));

  // call/enque opencl kernel wrapper function
  clSafeCall(clEnqueueNDRangeKernel(
      OPS_opencl_core.command_queue, OPS_opencl_core.kernel[23], 3, NULL,
