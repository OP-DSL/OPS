...
void buildOpenCLKernels_tea_leaf_cg_calc_w_reduce_kernel(int xdim0, int xdim1, int xdim2, int xdim3) {
  ...
  if(!isbuilt_tea_leaf_cg_calc_w_reduce_kernel) {
    ...
    OPS_opencl_core.kernel[19] = clCreateKernel(OPS_opencl_core.program, "ops_tea_leaf_cg_calc_w_reduce_kernel", &ret);
    clSafeCall( ret );
...
void ops_par_loop_tea_leaf_cg_calc_w_reduce_kernel(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6) {
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[19], 4, sizeof(cl_double), (void*) arg4.data ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[19], 5, sizeof(cl_double), (void*) arg5.data ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[19], 6, sizeof(cl_mem), (void*) &arg6.data_d ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[19], 7, nthread*sizeof(double), NULL));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[19], 8, sizeof(cl_int), (void*) &r_bytes6 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[19], 9, sizeof(cl_int), (void*) &base0 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[19], 10, sizeof(cl_int), (void*) &base1 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[19], 11, sizeof(cl_int), (void*) &base2 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[19], 12, sizeof(cl_int), (void*) &base3 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[19], 13, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[19], 14, sizeof(cl_int), (void*) &y_size ));
