...
void buildOpenCLKernels_tea_leaf_zeqxty_kernel(int xdim0, int xdim1, int xdim2) {
  ...
  if(!isbuilt_tea_leaf_zeqxty_kernel) {
    ...
    OPS_opencl_core.kernel[41] = clCreateKernel(OPS_opencl_core.program, "ops_tea_leaf_zeqxty_kernel", &ret);
    clSafeCall( ret );
...
void ops_par_loop_tea_leaf_zeqxty_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[41], 5, sizeof(cl_int), (void*) &base2 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[41], 6, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[41], 7, sizeof(cl_int), (void*) &y_size ));
