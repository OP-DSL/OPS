...
void buildOpenCLKernels_tea_leaf_common_init_Kx_Ky_kernel(
  ...
  if (!isbuilt_tea_leaf_common_init_Kx_Ky_kernel) {
    ...
    instance->ostream() << "Compiling tea_leaf_common_init_Kx_Ky_kernel "
