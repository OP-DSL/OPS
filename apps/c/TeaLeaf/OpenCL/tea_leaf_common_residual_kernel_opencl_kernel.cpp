...
void buildOpenCLKernels_tea_leaf_common_residual_kernel(int xdim0, int xdim1, int xdim2, int xdim3, int xdim4) {
  ...
  if(!isbuilt_tea_leaf_common_residual_kernel) {
    ...
    OPS_opencl_core.kernel[38] = clCreateKernel(OPS_opencl_core.program, "ops_tea_leaf_common_residual_kernel", &ret);
    clSafeCall( ret );
...
void ops_par_loop_tea_leaf_common_residual_kernel(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6) {
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[38], 4, sizeof(cl_mem), (void*) &arg4.data_d ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[38], 5, sizeof(cl_double), (void*) arg5.data ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[38], 6, sizeof(cl_double), (void*) arg6.data ));
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[38], 9, sizeof(cl_int), (void*) &base2 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[38], 10, sizeof(cl_int), (void*) &base3 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[38], 11, sizeof(cl_int), (void*) &base4 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[38], 12, sizeof(cl_int), (void*) &x_size ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[38], 13, sizeof(cl_int), (void*) &y_size ));
