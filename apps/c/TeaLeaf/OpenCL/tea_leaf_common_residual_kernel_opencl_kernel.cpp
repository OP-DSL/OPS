...
void buildOpenCLKernels_tea_leaf_common_residual_kernel(OPS_instance *instance,
                                                        int xdim0, int xdim1,
                                                        int xdim2, int xdim3,
                                                        int xdim4) {
  ...
  if (!isbuilt_tea_leaf_common_residual_kernel) {
    ...
    instance->ostream() << "Compiling tea_leaf_common_residual_kernel "
    ...
    instance->ostream()
        << "compiling tea_leaf_common_residual_kernel -- done\n";

    // Create the OpenCL kernel
    instance->opencl_instance->OPS_opencl_core.kernel[38] =
        clCreateKernel(instance->opencl_instance->OPS_opencl_core.program,
                       "ops_tea_leaf_common_residual_kernel", &ret);
    clSafeCall(ret);
