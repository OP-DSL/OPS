...
//user function
void tea_leaf_common_init_Kx_Ky_kernel(__global double * restrict Kx,__global double * restrict Ky,const __global double * restrict w)
...
const int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    tea_leaf_common_init_Kx_Ky_kernel(&arg0[base0 + idx_x * 1*1 + idx_y * 1*1 * xdim0_tea_leaf_common_init_Kx_Ky_kernel],
                                      &arg1[base1 + idx_x * 1*1 + idx_y * 1*1 * xdim1_tea_leaf_common_init_Kx_Ky_kernel],
                                      &arg2[base2 + idx_x * 1*1 + idx_y * 1*1 * xdim2_tea_leaf_common_init_Kx_Ky_kernel]);
  }
