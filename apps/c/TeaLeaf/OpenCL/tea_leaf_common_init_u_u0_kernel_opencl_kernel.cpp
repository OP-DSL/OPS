...
void buildOpenCLKernels_tea_leaf_common_init_u_u0_kernel(int xdim0, int xdim1,
                                                         int xdim2, int xdim3) {
  ...
  if (!isbuilt_tea_leaf_common_init_u_u0_kernel) {
    ...
    char *source_filename[1] = {
        (char *)"./OpenCL/tea_leaf_common_init_u_u0_kernel.cl"};
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts, "-cl-mad-enable -DOCL_FMA -I%s/c/include "
                           "-DOPS_WARPSIZE=%d  "
                           "-Dxdim0_tea_leaf_common_init_u_u0_kernel=%d  "
                           "-Dxdim1_tea_leaf_common_init_u_u0_kernel=%d  "
                           "-Dxdim2_tea_leaf_common_init_u_u0_kernel=%d  "
                           "-Dxdim3_tea_leaf_common_init_u_u0_kernel=%d ",
    ...
    OPS_opencl_core.kernel[28] = clCreateKernel(
        OPS_opencl_core.program, "ops_tea_leaf_common_init_u_u0_kernel", &ret);
    clSafeCall(ret);
...
void ops_par_loop_tea_leaf_common_init_u_u0_kernel(char const *name,
  ...
  buildOpenCLKernels_tea_leaf_common_init_u_u0_kernel(xdim0, xdim1, xdim2,
                                                      xdim3);
