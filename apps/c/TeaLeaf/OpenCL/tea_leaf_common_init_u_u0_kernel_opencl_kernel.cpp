...
void buildOpenCLKernels_tea_leaf_common_init_u_u0_kernel(OPS_instance *instance,
                                                         int xdim0, int xdim1,
                                                         int xdim2, int xdim3) {
  ...
  if (!isbuilt_tea_leaf_common_init_u_u0_kernel) {
    ...
    instance->ostream() << "Compiling tea_leaf_common_init_u_u0_kernel "
