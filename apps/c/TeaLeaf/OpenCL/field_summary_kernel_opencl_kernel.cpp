...
void buildOpenCLKernels_field_summary_kernel(int xdim0, int xdim1, int xdim2, int xdim3) {
  ...
  if(!isbuilt_field_summary_kernel) {
    ...
    OPS_opencl_core.kernel[0] = clCreateKernel(OPS_opencl_core.program, "ops_field_summary_kernel", &ret);
    clSafeCall( ret );
...
void ops_par_loop_field_summary_kernel(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6, ops_arg arg7) {
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[0], 5, nthread*sizeof(double), NULL));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[0], 6, sizeof(cl_int), (void*) &r_bytes4 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[0], 7, sizeof(cl_mem), (void*) &arg5.data_d ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[0], 8, nthread*sizeof(double), NULL));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[0], 9, sizeof(cl_int), (void*) &r_bytes5 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[0], 10, sizeof(cl_mem), (void*) &arg6.data_d ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[0], 11, nthread*sizeof(double), NULL));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[0], 12, sizeof(cl_int), (void*) &r_bytes6 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[0], 13, sizeof(cl_mem), (void*) &arg7.data_d ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[0], 14, nthread*sizeof(double), NULL));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[0], 15, sizeof(cl_int), (void*) &r_bytes7 ));
