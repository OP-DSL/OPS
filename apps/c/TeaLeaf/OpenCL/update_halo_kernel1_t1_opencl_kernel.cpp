...
void buildOpenCLKernels_update_halo_kernel1_t1(int xdim0, int xdim1, int xdim2, int xdim3, int xdim4, int xdim5) {
  ...
  if(!isbuilt_update_halo_kernel1_t1) {
    ...
    OPS_opencl_core.kernel[52] = clCreateKernel(OPS_opencl_core.program, "ops_update_halo_kernel1_t1", &ret);
    clSafeCall( ret );
...
void ops_par_loop_update_halo_kernel1_t1(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6) {
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[52], 9, sizeof(cl_int), (void*) &base2 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[52], 10, sizeof(cl_int), (void*) &base3 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[52], 11, sizeof(cl_int), (void*) &base4 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[52], 12, sizeof(cl_int), (void*) &base5 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[52], 13, sizeof(cl_int), (void*) &x_size ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[52], 14, sizeof(cl_int), (void*) &y_size ));
