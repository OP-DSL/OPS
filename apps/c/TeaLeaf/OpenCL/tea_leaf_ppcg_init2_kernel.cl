...
void tea_leaf_ppcg_init2_kernel(ptr_double sd, ptr_double rtemp,
...
__kernel void ops_tea_leaf_ppcg_init2_kernel(
    ...
    const double arg4, const int base0, const int base1, const int base2,
