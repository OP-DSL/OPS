...
//user function
void tea_leaf_cheby_init_kernel(__global double * restrict w,__global double * restrict r,const __global double * restrict Kx,
const __global double * restrict Ky,const __global double * restrict u,const __global double * restrict u0,const  double * restrict rx,
...
const int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    tea_leaf_cheby_init_kernel(&arg0[base0 + idx_x * 1*1 + idx_y * 1*1 * xdim0_tea_leaf_cheby_init_kernel],
                               &arg1[base1 + idx_x * 1*1 + idx_y * 1*1 * xdim1_tea_leaf_cheby_init_kernel],
                               &arg2[base2 + idx_x * 1*1 + idx_y * 1*1 * xdim2_tea_leaf_cheby_init_kernel],
                               &arg3[base3 + idx_x * 1*1 + idx_y * 1*1 * xdim3_tea_leaf_cheby_init_kernel],
                               &arg4[base4 + idx_x * 1*1 + idx_y * 1*1 * xdim4_tea_leaf_cheby_init_kernel],
                               &arg5[base5 + idx_x * 1*1 + idx_y * 1*1 * xdim5_tea_leaf_cheby_init_kernel],
                               &arg6,
                               &arg7);
  }
