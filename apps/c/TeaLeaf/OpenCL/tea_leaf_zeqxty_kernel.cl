...
// user function
void tea_leaf_zeqxty_kernel(__global double *restrict z,
                            const __global double *restrict x,
                            const __global double *restrict y)

{
  z[OPS_ACC0(0, 0)] = x[OPS_ACC1(0, 0)] * y[OPS_ACC2(0, 0)];
}

__kernel void ops_tea_leaf_zeqxty_kernel(__global double *restrict arg0,
  ...
  if (idx_x < size0 && idx_y < size1) {
    tea_leaf_zeqxty_kernel(&arg0[base0 + idx_x * 1 * 1 +
                                 idx_y * 1 * 1 * xdim0_tea_leaf_zeqxty_kernel],
                           &arg1[base1 + idx_x * 1 * 1 +
                                 idx_y * 1 * 1 * xdim1_tea_leaf_zeqxty_kernel],
                           &arg2[base2 + idx_x * 1 * 1 +
                                 idx_y * 1 * 1 * xdim2_tea_leaf_zeqxty_kernel]);
  }
}
