...
void buildOpenCLKernels_tea_leaf_init_zero_kernel(OPS_instance *instance,
                                                  int xdim0) {
  ...
  if (!isbuilt_tea_leaf_init_zero_kernel) {
    ...
    instance->ostream() << "Compiling tea_leaf_init_zero_kernel " << OCL_FMA
                        << " source -- start \n";
    ...
    instance->opencl_instance->OPS_opencl_core.kernel[45] =
        clCreateKernel(instance->opencl_instance->OPS_opencl_core.program,
                       "ops_tea_leaf_init_zero_kernel", &ret);
    clSafeCall(ret);
