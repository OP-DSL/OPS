...
void buildOpenCLKernels_tea_leaf_init_zero_kernel(int xdim0) {
  ...
  if(!isbuilt_tea_leaf_init_zero_kernel) {
    ...
    OPS_opencl_core.kernel[45] = clCreateKernel(OPS_opencl_core.program, "ops_tea_leaf_init_zero_kernel", &ret);
    clSafeCall( ret );
...
void ops_par_loop_tea_leaf_init_zero_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0) {
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[45], 1, sizeof(cl_int), (void*) &base0 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[45], 2, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[45], 3, sizeof(cl_int), (void*) &y_size ));
