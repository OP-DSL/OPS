...
void buildOpenCLKernels_tea_leaf_recip2_kernel(int xdim0, int xdim1,
                                               int xdim2) {
  ...
  if (!isbuilt_tea_leaf_recip2_kernel) {
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts, "-cl-mad-enable -DOCL_FMA -I%s/c/include "
                           "-DOPS_WARPSIZE=%d  "
                           "-Dxdim0_tea_leaf_recip2_kernel=%d  "
                           "-Dxdim1_tea_leaf_recip2_kernel=%d  "
                           "-Dxdim2_tea_leaf_recip2_kernel=%d ",
    ...
    OPS_opencl_core.kernel[37] = clCreateKernel(
        OPS_opencl_core.program, "ops_tea_leaf_recip2_kernel", &ret);
    clSafeCall(ret);
...
void ops_par_loop_tea_leaf_recip2_kernel(char const *name, ops_block block,
  ...
  buildOpenCLKernels_tea_leaf_recip2_kernel(xdim0, xdim1, xdim2);
