...
void buildOpenCLKernels_tea_leaf_dot_kernel(int xdim0, int xdim1) {
  ...
  if(!isbuilt_tea_leaf_dot_kernel) {
    ...
    OPS_opencl_core.kernel[18] = clCreateKernel(OPS_opencl_core.program, "ops_tea_leaf_dot_kernel", &ret);
    clSafeCall( ret );
...
void ops_par_loop_tea_leaf_dot_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[18], 3, nthread*sizeof(double), NULL));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[18], 4, sizeof(cl_int), (void*) &r_bytes2 ));
