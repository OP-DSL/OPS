...
void buildOpenCLKernels_tea_leaf_recip3_kernel(OPS_instance *instance,
                                               int xdim0, int xdim1) {
  ...
  if (!isbuilt_tea_leaf_recip3_kernel) {
    ...
    instance->ostream() << "Compiling tea_leaf_recip3_kernel " << OCL_FMA
                        << " source -- start \n";
    ...
    instance->opencl_instance->OPS_opencl_core.kernel[24] =
        clCreateKernel(instance->opencl_instance->OPS_opencl_core.program,
                       "ops_tea_leaf_recip3_kernel", &ret);
    clSafeCall(ret);
