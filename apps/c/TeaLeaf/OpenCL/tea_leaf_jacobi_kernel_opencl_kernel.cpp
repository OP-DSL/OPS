...
void buildOpenCLKernels_tea_leaf_jacobi_kernel(int xdim0, int xdim1, int xdim2, int xdim3, int xdim4) {
  ...
  if(!isbuilt_tea_leaf_jacobi_kernel) {
    ...
    OPS_opencl_core.kernel[42] = clCreateKernel(OPS_opencl_core.program, "ops_tea_leaf_jacobi_kernel", &ret);
    clSafeCall( ret );
...
void ops_par_loop_tea_leaf_jacobi_kernel(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6, ops_arg arg7) {
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[42], 5, sizeof(cl_double), (void*) arg5.data ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[42], 6, sizeof(cl_double), (void*) arg6.data ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[42], 7, sizeof(cl_mem), (void*) &arg7.data_d ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[42], 8, nthread*sizeof(double), NULL));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[42], 9, sizeof(cl_int), (void*) &r_bytes7 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[42], 10, sizeof(cl_int), (void*) &base0 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[42], 11, sizeof(cl_int), (void*) &base1 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[42], 12, sizeof(cl_int), (void*) &base2 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[42], 13, sizeof(cl_int), (void*) &base3 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[42], 14, sizeof(cl_int), (void*) &base4 ));
