...
void buildOpenCLKernels_tea_leaf_jacobi_kernel(OPS_instance *instance,
  ...
  if (!isbuilt_tea_leaf_jacobi_kernel) {
    ...
    instance->ostream() << "Compiling tea_leaf_jacobi_kernel " << OCL_FMA
                        << " source -- start \n";
    ...
    instance->opencl_instance->OPS_opencl_core.kernel[42] =
        clCreateKernel(instance->opencl_instance->OPS_opencl_core.program,
                       "ops_tea_leaf_jacobi_kernel", &ret);
    clSafeCall(ret);
