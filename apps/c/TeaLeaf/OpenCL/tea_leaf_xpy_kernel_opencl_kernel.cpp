...
void buildOpenCLKernels_tea_leaf_xpy_kernel(OPS_instance *instance, int xdim0,
                                            int xdim1) {
  ...
  if (!isbuilt_tea_leaf_xpy_kernel) {
    ...
    instance->ostream() << "Compiling tea_leaf_xpy_kernel " << OCL_FMA
                        << " source -- start \n";
