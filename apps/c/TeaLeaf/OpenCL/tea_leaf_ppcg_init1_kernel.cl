...
void tea_leaf_ppcg_init1_kernel(ptr_double sd, ptr_double rtemp,
                                ptr_double utemp, const ptr_double z,
                                const ptr_double r, const double *theta_r) {
...
__kernel void ops_tea_leaf_ppcg_init1_kernel(
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    tea_leaf_ppcg_init1_kernel(ptr0, ptr1, ptr2, ptr3, ptr4, &arg5);
  }
}
