...
void buildOpenCLKernels_tea_leaf_cg_calc_ur_r_reduce_kernel(
  ...
  if (!isbuilt_tea_leaf_cg_calc_ur_r_reduce_kernel) {
    ...
    instance->ostream() << "Compiling tea_leaf_cg_calc_ur_r_reduce_kernel "
    ...
    instance->ostream()
        << "compiling tea_leaf_cg_calc_ur_r_reduce_kernel -- done\n";

    // Create the OpenCL kernel
    instance->opencl_instance->OPS_opencl_core.kernel[21] =
