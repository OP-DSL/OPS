...
void buildOpenCLKernels_tea_leaf_yeqx_kernel(OPS_instance *instance, int xdim0,
                                             int xdim1) {
  ...
  if (!isbuilt_tea_leaf_yeqx_kernel) {
    ...
    instance->ostream() << "Compiling tea_leaf_yeqx_kernel " << OCL_FMA
                        << " source -- start \n";
    ...
    instance->opencl_instance->OPS_opencl_core.kernel[30] =
        clCreateKernel(instance->opencl_instance->OPS_opencl_core.program,
                       "ops_tea_leaf_yeqx_kernel", &ret);
    clSafeCall(ret);
