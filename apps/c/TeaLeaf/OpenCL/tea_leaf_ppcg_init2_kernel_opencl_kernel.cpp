...
void buildOpenCLKernels_tea_leaf_ppcg_init2_kernel(OPS_instance *instance,
                                                   int xdim0, int xdim1,
                                                   int xdim2, int xdim3) {
  ...
  if (!isbuilt_tea_leaf_ppcg_init2_kernel) {
    ...
    instance->ostream() << "Compiling tea_leaf_ppcg_init2_kernel " << OCL_FMA
                        << " source -- start \n";
    ...
    instance->opencl_instance->OPS_opencl_core.kernel[44] =
        clCreateKernel(instance->opencl_instance->OPS_opencl_core.program,
                       "ops_tea_leaf_ppcg_init2_kernel", &ret);
    clSafeCall(ret);
