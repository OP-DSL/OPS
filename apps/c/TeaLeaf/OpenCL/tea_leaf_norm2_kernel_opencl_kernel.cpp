...
void buildOpenCLKernels_tea_leaf_norm2_kernel(int xdim0) {
  ...
  if (!isbuilt_tea_leaf_norm2_kernel) {
    ...
    OPS_opencl_core.kernel[39] = clCreateKernel(
        OPS_opencl_core.program, "ops_tea_leaf_norm2_kernel", &ret);
    clSafeCall(ret);
...
void ops_par_loop_tea_leaf_norm2_kernel(char const *name, ops_block block,
  ...
  buildOpenCLKernels_tea_leaf_norm2_kernel(xdim0);
  ...
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[39], 1, sizeof(cl_mem),
                            (void *)&arg1.data_d));
  clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[39], 2,
