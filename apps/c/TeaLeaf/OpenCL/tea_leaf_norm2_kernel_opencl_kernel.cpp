...
void buildOpenCLKernels_tea_leaf_norm2_kernel(int xdim0) {
  ...
  if(!isbuilt_tea_leaf_norm2_kernel) {
    ...
    printf("Compiling tea_leaf_norm2_kernel %d source -- start \n",OCL_FMA);
      ...
      if (pPath!=NULL)
        if(OCL_FMA)
          sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/c/include -DOPS_WARPSIZE=%d  -Dxdim0_tea_leaf_norm2_kernel=%d ", pPath, 32,xdim0);
        else
          sprintf(buildOpts,"-cl-mad-enable -I%s/c/include -DOPS_WARPSIZE=%d  -Dxdim0_tea_leaf_norm2_kernel=%d ", pPath, 32,xdim0);
      else {
      ...
      printf("compiling tea_leaf_norm2_kernel -- done\n");

    // Create the OpenCL kernel
    OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[39] = clCreateKernel(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.program, "ops_tea_leaf_norm2_kernel", &ret);
    clSafeCall( ret );
...
void ops_par_loop_tea_leaf_norm2_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  buildOpenCLKernels_tea_leaf_norm2_kernel(
  xdim0);
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[39], 2, nthread*sizeof(double), NULL));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[39], 3, sizeof(cl_int), (void*) &r_bytes1 ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[39], 4, sizeof(cl_int), (void*) &base0 ));
