...
void buildOpenCLKernels_tea_leaf_axpy_kernel(OPS_instance *instance, int xdim0,
                                             int xdim1) {
  ...
  if (!isbuilt_tea_leaf_axpy_kernel) {
    ...
    instance->ostream() << "Compiling tea_leaf_axpy_kernel " << OCL_FMA
                        << " source -- start \n";
