...
void buildOpenCLKernels_tea_leaf_axpy_kernel(int xdim0, int xdim1) {
  ...
  if(!isbuilt_tea_leaf_axpy_kernel) {
    ...
    printf("Compiling tea_leaf_axpy_kernel %d source -- start \n",OCL_FMA);
      ...
      if (pPath!=NULL)
        if(OCL_FMA)
          sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/c/include -DOPS_WARPSIZE=%d  -Dxdim0_tea_leaf_axpy_kernel=%d  -Dxdim1_tea_leaf_axpy_kernel=%d ", pPath, 32,xdim0,xdim1);
        else
          sprintf(buildOpts,"-cl-mad-enable -I%s/c/include -DOPS_WARPSIZE=%d  -Dxdim0_tea_leaf_axpy_kernel=%d  -Dxdim1_tea_leaf_axpy_kernel=%d ", pPath, 32,xdim0,xdim1);
      else {
      ...
      printf("compiling tea_leaf_axpy_kernel -- done\n");

    // Create the OpenCL kernel
    OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[20] = clCreateKernel(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.program, "ops_tea_leaf_axpy_kernel", &ret);
    clSafeCall( ret );
...
void ops_par_loop_tea_leaf_axpy_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  buildOpenCLKernels_tea_leaf_axpy_kernel(
  xdim0,xdim1);
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[20], 2, sizeof(cl_double), (void*) arg2.data ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[20], 3, sizeof(cl_int), (void*) &base0 ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[20], 4, sizeof(cl_int), (void*) &base1 ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[20], 5, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[20], 6, sizeof(cl_int), (void*) &y_size ));
