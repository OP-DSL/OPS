...
void buildOpenCLKernels_tea_leaf_ppcg_inner2_kernel(int xdim0, int xdim1,
                                                    int xdim2) {
  ...
  if (!isbuilt_tea_leaf_ppcg_inner2_kernel) {
    ...
    char *source_filename[1] = {
        (char *)"./OpenCL/tea_leaf_ppcg_inner2_kernel.cl"};
    ...
    OPS_opencl_core.kernel[47] = clCreateKernel(
        OPS_opencl_core.program, "ops_tea_leaf_ppcg_inner2_kernel", &ret);
    clSafeCall(ret);
...
void ops_par_loop_tea_leaf_ppcg_inner2_kernel(char const *name, ops_block block,
  ...
  buildOpenCLKernels_tea_leaf_ppcg_inner2_kernel(xdim0, xdim1, xdim2);
  ...
  if (globalWorkSize[0] > 0 && globalWorkSize[1] > 0 && globalWorkSize[2] > 0) {
    ...
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[47], 2, sizeof(cl_mem),
                              (void *)&arg2.data_d));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[47], 3, sizeof(cl_double),
                              (void *)arg3.data));
    clSafeCall(clSetKernelArg(OPS_opencl_core.kernel[47], 4, sizeof(cl_double),
                              (void *)arg4.data));
