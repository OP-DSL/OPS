...
inline void update_halo_kernel1_l1(ptr_double density0, ptr_double energy0,
  ...
  if (fields[FIELD_U] == 1)
    OPS_ACCS(u, 0, 0) = OPS_ACCS(u, 1, 0);
  if (fields[FIELD_P] == 1)
    OPS_ACCS(p, 0, 0) = OPS_ACCS(p, 1, 0);
  if (fields[FIELD_SD] == 1)
    OPS_ACCS(sd, 0, 0) = OPS_ACCS(sd, 1, 0);
}
...
__kernel void ops_update_halo_kernel1_l1(
    ...
    __global const int *restrict arg6, const int base0, const int base1,
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    update_halo_kernel1_l1(ptr0, ptr1, ptr2, ptr3, ptr4, ptr5, arg6);
  }
}
