...
void buildOpenCLKernels_set_field_kernel(OPS_instance *instance, int xdim0,
                                         int xdim1) {
  ...
  if (!isbuilt_set_field_kernel) {
    ...
    instance->ostream() << "Compiling set_field_kernel " << OCL_FMA
                        << " source -- start \n";
    ...
    instance->opencl_instance->OPS_opencl_core.kernel[15] =
        clCreateKernel(instance->opencl_instance->OPS_opencl_core.program,
                       "ops_set_field_kernel", &ret);
    clSafeCall(ret);
