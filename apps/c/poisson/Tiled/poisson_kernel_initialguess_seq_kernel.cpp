...
//
<<<<<<< HEAD:apps/c/poisson/Tiled/poisson_kernel_initialguess_seq_kernel.cpp
#define OPS_ACC0(x, y)                                                         \
  (n_x * 1 + n_y * xdim0_poisson_kernel_initialguess * 1 + x +                 \
   xdim0_poisson_kernel_initialguess * (y))
=======
