...
//
<<<<<<< HEAD:apps/c/poisson/Tiled/poisson_kernel_error_seq_kernel.cpp
#define OPS_ACC0(x, y)                                                         \
  (n_x * 1 + n_y * xdim0_poisson_kernel_error * 1 + x +                        \
   xdim0_poisson_kernel_error * (y))
#define OPS_ACC1(x, y)                                                         \
  (n_x * 1 + n_y * xdim1_poisson_kernel_error * 1 + x +                        \
   xdim1_poisson_kernel_error * (y))
=======
>>>>>>> 1d8186c... Works on CPU with poisson:apps/c/poisson/MPI_OpenMP/poisson_kernel_error_cpu_kernel.cpp
