...
void buildOpenCLKernels_poisson_kernel_stencil(OPS_instance *instance,
                                               int xdim0, int xdim1) {
  ...
  if (!isbuilt_poisson_kernel_stencil) {
    ...
    instance->ostream() << "Compiling poisson_kernel_stencil " << OCL_FMA
                        << " source -- start \n";
    ...
    instance->opencl_instance->OPS_opencl_core.kernel[3] =
        clCreateKernel(instance->opencl_instance->OPS_opencl_core.program,
                       "ops_poisson_kernel_stencil", &ret);
    clSafeCall(ret);
