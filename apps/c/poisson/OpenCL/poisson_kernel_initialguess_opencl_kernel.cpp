...
void buildOpenCLKernels_poisson_kernel_initialguess(OPS_instance *instance,
                                                    int xdim0) {
  ...
  if (!isbuilt_poisson_kernel_initialguess) {
    ...
    char *source_filename[1] = {
        (char *)"./OpenCL/poisson_kernel_initialguess.cl"};
    ...
    instance->ostream() << "Compiling poisson_kernel_initialguess " << OCL_FMA
                        << " source -- start \n";
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts, "-cl-mad-enable -DOCL_FMA -I%s/include "
                           "-DOPS_WARPSIZE=%d  "
                           "-Dxdim0_poisson_kernel_initialguess=%d ",
                pPath, 32, xdim0);
      else
    ...
    instance->opencl_instance->OPS_opencl_core.kernel[2] =
        clCreateKernel(instance->opencl_instance->OPS_opencl_core.program,
                       "ops_poisson_kernel_initialguess", &ret);
    clSafeCall(ret);
