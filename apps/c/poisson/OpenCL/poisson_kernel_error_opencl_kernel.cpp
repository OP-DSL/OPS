...
void buildOpenCLKernels_poisson_kernel_error(int xdim0, int xdim1) {
  ...
  if(!isbuilt_poisson_kernel_error) {
    ...
    printf("Compiling poisson_kernel_error %d source -- start \n",OCL_FMA);
    ...
    OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[4] = clCreateKernel(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.program, "ops_poisson_kernel_error", &ret);
    clSafeCall( ret );
...
void ops_par_loop_poisson_kernel_error(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[4], 3, nthread*sizeof(double), NULL));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[4], 4, sizeof(cl_int), (void*) &r_bytes2 ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[4], 5, sizeof(cl_int), (void*) &base0 ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[4], 6, sizeof(cl_int), (void*) &base1 ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[4], 7, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[4], 8, sizeof(cl_int), (void*) &y_size ));
