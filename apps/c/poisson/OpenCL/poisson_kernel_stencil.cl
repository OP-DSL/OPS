...
// user function
void poisson_kernel_stencil(const __global double *restrict u,
                            const __global double *restrict f,
                            __global double *restrict u2,
