...
void buildOpenCLKernels_poisson_kernel_populate(OPS_instance *instance,
                                                int xdim3, int xdim4,
                                                int xdim5) {
  ...
  if (!isbuilt_poisson_kernel_populate) {
    ...
    instance->ostream() << "Compiling poisson_kernel_populate " << OCL_FMA
                        << " source -- start \n";
    ...
    instance->opencl_instance->OPS_opencl_core.kernel[0] =
        clCreateKernel(instance->opencl_instance->OPS_opencl_core.program,
                       "ops_poisson_kernel_populate", &ret);
    clSafeCall(ret);
