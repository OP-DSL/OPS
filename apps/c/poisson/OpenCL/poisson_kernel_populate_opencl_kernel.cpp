...
void ops_par_loop_poisson_kernel_populate(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5) {
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[0], 5, sizeof(cl_double), (void*) &dx ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[0], 6, sizeof(cl_double), (void*) &dy ));
