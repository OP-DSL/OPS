...
// user function
void poisson_kernel_populate(const int *restrict dispx,
                             const int *restrict dispy, const int *restrict idx,
                             __global double *restrict u,
                             __global double *restrict f,
                             __global double *restrict ref, const double dx,
                             const double dy)
