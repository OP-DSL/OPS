...
void buildOpenCLKernels_poisson_kernel_update(OPS_instance *instance, int xdim0,
                                              int xdim1) {
  ...
  if (!isbuilt_poisson_kernel_update) {
    ...
    instance->ostream() << "Compiling poisson_kernel_update " << OCL_FMA
                        << " source -- start \n";
