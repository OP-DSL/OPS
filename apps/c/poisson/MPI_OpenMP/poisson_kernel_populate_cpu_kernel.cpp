  ...
  for ( int n_2=bounds_2_l; n_2<bounds_2_u; n_2++ ){
    ...
    for ( int n_1=bounds_1_l; n_1<bounds_1_u; n_1++ ){
      ...
      for ( int n_0=bounds_0_l; n_0<bounds_0_u; n_0++ ){
        ...
        #endif
        ACC<double> u(xdim3, ydim3, u_p + n_0 + n_1 * xdim3 + n_2 * xdim3 * ydim3);
        ACC<double> f(xdim4, ydim4, f_p + n_0 + n_1 * xdim4 + n_2 * xdim4 * ydim4);
        ACC<double> ref(xdim5, ydim5, ref_p + n_0 + n_1 * xdim5 + n_2 * xdim5 * ydim5);
