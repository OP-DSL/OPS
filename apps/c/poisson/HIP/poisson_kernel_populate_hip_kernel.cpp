...
void poisson_kernel_populate_gpu(const int *dispx,
  ...
  ACC<double> &f,
  ACC<double> &ref) {
  //double x = dx_OPSCONSTANT * (double)(idx[0]+dispx[0]);
  double x = 0.01 * (double)(idx[0]+dispx[0]);
  //double y = dy_OPSCONSTANT * (double)(idx[1]+dispy[0]);
  double y = 0.01 * (double)(idx[1]+dispy[0]);
