...
#define OPS_ACC0(x, y) (x + dims_poisson_kernel_update[0][0] * (y))
#define OPS_ACC1(x, y) (x + dims_poisson_kernel_update[1][0] * (y))
...
__global__ void ops_poisson_kernel_update(const double *__restrict arg0,
...
void ops_par_loop_poisson_kernel_update_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_poisson_kernel_update_h[0][0] ||
      xdim1 != dims_poisson_kernel_update_h[1][0]) {
    dims_poisson_kernel_update_h[0][0] = xdim0;
    dims_poisson_kernel_update_h[1][0] = xdim1;
    cutilSafeCall(cudaMemcpyToSymbol(dims_poisson_kernel_update,
                                     dims_poisson_kernel_update_h,
                                     sizeof(dims_poisson_kernel_update)));
  }
  ...
  if (x_size > 0 && y_size > 0)
    ops_poisson_kernel_update<<<grid, tblock>>>(
