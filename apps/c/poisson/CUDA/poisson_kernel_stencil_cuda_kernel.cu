...
//
__constant__ int dims_poisson_kernel_stencil [2][3];
static int dims_poisson_kernel_stencil_h [2][3] = {0};
...
int bounds_2_l, int bounds_2_u) {
  ...
  if (n_0 < bounds_0_u && n_1 < bounds_1_u && n_2 < bounds_2_u) {
    const ACC<double> u(dims_poisson_kernel_stencil[0][0], dims_poisson_kernel_stencil[0][1], u_p + n_0 + n_1 * dims_poisson_kernel_stencil[0][0] + n_2 * dims_poisson_kernel_stencil[0][0] * dims_poisson_kernel_stencil[0][1]);
    ACC<double> u2(dims_poisson_kernel_stencil[1][0], dims_poisson_kernel_stencil[1][1], u2_p + n_0 + n_1 * dims_poisson_kernel_stencil[1][0] + n_2 * dims_poisson_kernel_stencil[1][0] * dims_poisson_kernel_stencil[1][1]);
...
void ops_par_loop_poisson_kernel_stencil_execute(const char *name, ops_block block, int blockidx_start, int blockidx_end, int dim, int *range, int nargs, ops_arg* args) {
  ...
  #endif
  if (args[0].dat->size[0] != dims_poisson_kernel_stencil_h[0][0] || args[0].dat->size[1] != dims_poisson_kernel_stencil_h[0][1] || args[0].dat->size[2] != dims_poisson_kernel_stencil_h[0][2] || args[1].dat->size[0] != dims_poisson_kernel_stencil_h[1][0] || args[1].dat->size[1] != dims_poisson_kernel_stencil_h[1][1] || args[1].dat->size[2] != dims_poisson_kernel_stencil_h[1][2]) {
    dims_poisson_kernel_stencil_h[0][0] = args[0].dat->size[0];
    dims_poisson_kernel_stencil_h[0][1] = args[0].dat->size[1];
    dims_poisson_kernel_stencil_h[0][2] = args[0].dat->size[2];
    dims_poisson_kernel_stencil_h[1][0] = args[1].dat->size[0];
    dims_poisson_kernel_stencil_h[1][1] = args[1].dat->size[1];
    dims_poisson_kernel_stencil_h[1][2] = args[1].dat->size[2];
    cutilSafeCall(cudaMemcpyToSymbol( dims_poisson_kernel_stencil, dims_poisson_kernel_stencil_h, sizeof(dims_poisson_kernel_stencil)));
  }

  //set up initial pointers
  double * __restrict__ u_p = (double *)(args[0].data_d + args[0].dat->base_offset + blockidx_start * args[0].dat->batch_offset);

  double * __restrict__ u2_p = (double *)(args[1].data_d + args[1].dat->base_offset + blockidx_start * args[1].dat->batch_offset);
  ...
  if (x_size > 0 && y_size > 0)
    ops_poisson_kernel_stencil<<<grid, tblock >>> (  u_p, u2_p,         bounds_0_l, bounds_0_u, bounds_1_l, bounds_1_u,
