...
void ops_par_loop_poisson_kernel_populate_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim3 != dims_poisson_kernel_populate_h[3][0] ||
      xdim4 != dims_poisson_kernel_populate_h[4][0] ||
      xdim5 != dims_poisson_kernel_populate_h[5][0]) {
    dims_poisson_kernel_populate_h[3][0] = xdim3;
    dims_poisson_kernel_populate_h[4][0] = xdim4;
    dims_poisson_kernel_populate_h[5][0] = xdim5;
    cutilSafeCall(cudaMemcpyToSymbol(dims_poisson_kernel_populate,
                                     dims_poisson_kernel_populate_h,
                                     sizeof(dims_poisson_kernel_populate)));
  }
