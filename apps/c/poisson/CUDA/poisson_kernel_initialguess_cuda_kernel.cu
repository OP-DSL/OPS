...
__global__ void ops_poisson_kernel_initialguess(double *__restrict arg0,
                                                int size0, int size1) {
  ...
  arg0 +=
      idx_x * 1 * 1 + idx_y * 1 * 1 * dims_poisson_kernel_initialguess[0][0];
...
void ops_par_loop_poisson_kernel_initialguess_execute(
  ...
  if (xdim0 != dims_poisson_kernel_initialguess_h[0][0]) {
    ...
    cutilSafeCall(cudaMemcpyToSymbol(dims_poisson_kernel_initialguess,
                                     dims_poisson_kernel_initialguess_h,
                                     sizeof(dims_poisson_kernel_initialguess)));
  }
