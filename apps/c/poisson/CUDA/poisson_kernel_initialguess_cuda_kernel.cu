...
//
__constant__ int dims_poisson_kernel_initialguess [1][3];
static int dims_poisson_kernel_initialguess_h [1][3] = {0};
...
int bounds_2_l, int bounds_2_u) {
  ...
  if (n_0 < bounds_0_u && n_1 < bounds_1_u && n_2 < bounds_2_u) {
    ACC<double> u(dims_poisson_kernel_initialguess[0][0], dims_poisson_kernel_initialguess[0][1], u_p + n_0 + n_1 * dims_poisson_kernel_initialguess[0][0] + n_2 * dims_poisson_kernel_initialguess[0][0] * dims_poisson_kernel_initialguess[0][1]);
...
void ops_par_loop_poisson_kernel_initialguess_execute(const char *name, ops_block block, int blockidx_start, int blockidx_end, int dim, int *range, int nargs, ops_arg* args) {
  ...
  #endif
  if (args[0].dat->size[0] != dims_poisson_kernel_initialguess_h[0][0] || args[0].dat->size[1] != dims_poisson_kernel_initialguess_h[0][1] || args[0].dat->size[2] != dims_poisson_kernel_initialguess_h[0][2]) {
    dims_poisson_kernel_initialguess_h[0][0] = args[0].dat->size[0];
    dims_poisson_kernel_initialguess_h[0][1] = args[0].dat->size[1];
    dims_poisson_kernel_initialguess_h[0][2] = args[0].dat->size[2];
  ...
  if (x_size > 0 && y_size > 0)
    ops_poisson_kernel_initialguess<<<grid, tblock >>> (  u_p,         bounds_0_l, bounds_0_u, bounds_1_l, bounds_1_u,
