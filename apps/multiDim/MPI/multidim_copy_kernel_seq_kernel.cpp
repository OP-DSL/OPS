...
//
int mdim0_multidim_copy_kernel;
int mdim1_multidim_copy_kernel;
#define OPS_ACC_MD0(d,x,y) ((x)*mdim0_multidim_copy_kernel+(d)+(xdim0*(y)*mdim0_multidim_copy_kernel))
#define OPS_ACC_MD1(d,x,y) ((x)*mdim1_multidim_copy_kernel+(d)+(xdim1*(y)*mdim1_multidim_copy_kernel))
