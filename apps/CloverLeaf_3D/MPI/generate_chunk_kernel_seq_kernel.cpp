...
void ops_par_loop_generate_chunk_kernel(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8, ops_arg arg9, ops_arg arg10) {
  ...
  int* start = (int *)xmalloc(sizeof(int)*3);
  int* end = (int *)xmalloc(sizeof(int)*3);
  for ( int n=0; n<3; n++ ){
    ...
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      for( n_x=start[0]; n_x<start[0]+((end[0]-start[0])/SIMD_VEC)*SIMD_VEC; n_x+=SIMD_VEC ) {
        ...
        for ( int i=0; i<SIMD_VEC; i++ ){
          generate_chunk_kernel(  (double *)p_a[0]+ i*1, (double *)p_a[1]+ i*0, (double *)p_a[2]+ i*0,
           (double *)p_a[3]+ i*1, (double *)p_a[4]+ i*1, (double *)p_a[5]+ i*1, (double *)p_a[6]+ i*1,
           (double *)p_a[7]+ i*1, (double *)p_a[8]+ i*1, (double *)p_a[9]+ i*0, (double *)p_a[10]+ i*0 );
