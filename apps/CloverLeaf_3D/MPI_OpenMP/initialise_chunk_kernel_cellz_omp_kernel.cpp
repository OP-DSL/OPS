...
void ops_par_loop_initialise_chunk_kernel_cellz(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
      ...
      for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
        for ( int n_x=start[0]; n_x<start[0]+(end[0]-start[0])/SIMD_VEC; n_x++ ){
          ...
          for ( int i=0; i<SIMD_VEC; i++ ){
            initialise_chunk_kernel_cellz(  (const double * )p_a[0]+ i*0, (double * )p_a[1]+ i*0, (double * )p_a[2]+ i*0 );
        ...
        for ( int n_x=start[0]+((end[0]-start[0])/SIMD_VEC)*SIMD_VEC; n_x<end[0]; n_x++ ){
          ...
          initialise_chunk_kernel_cellz(  (const double * )p_a[0], (double * )p_a[1], (double * )p_a[2] );
  ...
  #ifdef OPS_DEBUG
  ops_dump3(arg1.dat,"initialise_chunk_kernel_cellz");
  ops_dump3(arg2.dat,"initialise_chunk_kernel_cellz");
  #endif
