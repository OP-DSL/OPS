...
void ops_par_loop_advec_mom_kernel_z3(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3) {
      ...
      for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
        for ( int n_x=start[0]; n_x<start[0]+(end[0]-start[0])/SIMD_VEC; n_x++ ){
          ...
          for ( int i=0; i<SIMD_VEC; i++ ){
            advec_mom_kernel_z3(  (double * restrict)p_a[0]+ i*1, (double * restrict)p_a[1]+ i*1, (const double * restrict)p_a[2]+ i*1,
        ...
        for ( int n_x=start[0]+((end[0]-start[0])/SIMD_VEC)*SIMD_VEC; n_x<end[0]; n_x++ ){
          ...
          advec_mom_kernel_z3(  (double * restrict)p_a[0], (double * restrict)p_a[1], (const double * restrict)p_a[2],
  ...
  #ifdef OPS_DEBUG
  ops_dump3(arg0.dat,"advec_mom_kernel_z3");
  ops_dump3(arg1.dat,"advec_mom_kernel_z3");
  #endif
