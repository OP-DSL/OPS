      ...
      for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
        for ( int n_x=start[0]; n_x<start[0]+(end[0]-start[0])/SIMD_VEC; n_x++ ){
          ...
          for ( int i=0; i<SIMD_VEC; i++ ){
            PdV_kernel_predict(  (const double * restrict)p_a[0]+ i*1, (const double * restrict)p_a[1]+ i*1, (const double * restrict)p_a[2]+ i*1,
           ...
           (double * restrict)p_a[11]+ i*1, (const double * restrict)p_a[12]+ i*1, (const double * restrict)p_a[13]+ i*1 );
        ...
        for ( int n_x=start[0]+((end[0]-start[0])/SIMD_VEC)*SIMD_VEC; n_x<end[0]; n_x++ ){
          ...
          PdV_kernel_predict(  (const double * restrict)p_a[0], (const double * restrict)p_a[1], (const double * restrict)p_a[2],
           ...
           (double * restrict)p_a[11], (const double * restrict)p_a[12], (const double * restrict)p_a[13] );
