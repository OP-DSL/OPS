...
void ops_par_loop_PdV_kernel_nopredict(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg16) {
  ...
  for ( int thr=0; thr<nthreads; thr++ ){
    ...
    int base14 = dat14 * 1 * 
    (start0 * args[14].stencil->stride[0] - args[14].dat->base[0] - args[14].dat->d_m[0]);
    base14 = base14+ dat14 *
      args[14].dat->size[0] *
      (start1 * args[14].stencil->stride[1] - args[14].dat->base[1] - args[14].dat->d_m[1]);
    base14 = base14+ dat14 *
      args[14].dat->size[0] *
      args[14].dat->size[1] *
      (start2 * args[14].stencil->stride[2] - args[14].dat->base[2] - args[14].dat->d_m[2]);
    p_a[14] = (char *)args[14].data + base14;

    int base15 = dat15 * 1 * 
    (start0 * args[15].stencil->stride[0] - args[15].dat->base[0] - args[15].dat->d_m[0]);
    base15 = base15+ dat15 *
      args[15].dat->size[0] *
      (start1 * args[15].stencil->stride[1] - args[15].dat->base[1] - args[15].dat->d_m[1]);
    base15 = base15+ dat15 *
      args[15].dat->size[0] *
      args[15].dat->size[1] *
      (start2 * args[15].stencil->stride[2] - args[15].dat->base[2] - args[15].dat->d_m[2]);
    p_a[15] = (char *)args[15].data + base15;

    int base16 = dat16 * 1 * 
    (start0 * args[16].stencil->stride[0] - args[16].dat->base[0] - args[16].dat->d_m[0]);
    base16 = base16+ dat16 *
      args[16].dat->size[0] *
      (start1 * args[16].stencil->stride[1] - args[16].dat->base[1] - args[16].dat->d_m[1]);
    base16 = base16+ dat16 *
      args[16].dat->size[0] *
      args[16].dat->size[1] *
      (start2 * args[16].stencil->stride[2] - args[16].dat->base[2] - args[16].dat->d_m[2]);
      ...
      for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
        ...
        for ( int n_x=start[0]+((end[0]-start[0])/SIMD_VEC)*SIMD_VEC; n_x<end[0]; n_x++ ){
          ...
          PdV_kernel_nopredict(  (const double * )p_a[0], (const double * )p_a[1], (const double * )p_a[2],
           ...
           (const double * )p_a[11], (const double * )p_a[12], (double * )p_a[13], (const double * )p_a[14],
           (const double * )p_a[15], (const double * )p_a[16] );
