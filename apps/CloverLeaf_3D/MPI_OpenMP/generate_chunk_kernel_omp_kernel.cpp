...
void ops_par_loop_generate_chunk_kernel(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8, ops_arg arg9, ops_arg arg10) {
  ...
  //Timing
  double t1,t2,c1,c2;
  ops_timing_realloc(137,"generate_chunk_kernel");
      ...
      for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
        for ( int n_x=start[0]; n_x<start[0]+(end[0]-start[0])/SIMD_VEC; n_x++ ){
          ...
          for ( int i=0; i<SIMD_VEC; i++ ){
            generate_chunk_kernel(  (const double * )p_a[0]+ i*1, (const double * )p_a[1]+ i*0, (const double * )p_a[2]+ i*0,
           (double * )p_a[3]+ i*1, (double * )p_a[4]+ i*1, (double * )p_a[5]+ i*1, (double * )p_a[6]+ i*1,
           (double * )p_a[7]+ i*1, (const double * )p_a[8]+ i*1, (const double * )p_a[9]+ i*0, (const double * )p_a[10]+ i*0 );
        ...
        for ( int n_x=start[0]+((end[0]-start[0])/SIMD_VEC)*SIMD_VEC; n_x<end[0]; n_x++ ){
          ...
          generate_chunk_kernel(  (const double * )p_a[0], (const double * )p_a[1], (const double * )p_a[2],
           (double * )p_a[3], (double * )p_a[4], (double * )p_a[5], (double * )p_a[6],
           (double * )p_a[7], (const double * )p_a[8], (const double * )p_a[9], (const double * )p_a[10] );
  ...
  ops_dump3(arg6.dat,"generate_chunk_kernel");
  ops_dump3(arg7.dat,"generate_chunk_kernel");
  #endif
  ...
  OPS_kernels[137].transfer += ops_compute_transfer(dim, range, &arg2);
  OPS_kernels[137].transfer += ops_compute_transfer(dim, range, &arg3);
  OPS_kernels[137].transfer += ops_compute_transfer(dim, range, &arg4);
  OPS_kernels[137].transfer += ops_compute_transfer(dim, range, &arg5);
  OPS_kernels[137].transfer += ops_compute_transfer(dim, range, &arg6);
  OPS_kernels[137].transfer += ops_compute_transfer(dim, range, &arg7);
  OPS_kernels[137].transfer += ops_compute_transfer(dim, range, &arg8);
  OPS_kernels[137].transfer += ops_compute_transfer(dim, range, &arg9);
  OPS_kernels[137].transfer += ops_compute_transfer(dim, range, &arg10);
}
