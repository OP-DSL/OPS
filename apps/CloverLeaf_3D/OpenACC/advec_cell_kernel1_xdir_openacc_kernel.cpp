...
void ops_par_loop_advec_cell_kernel1_xdir(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3, ops_arg arg4, ops_arg arg5) {
  ...
  if (OPS_kernels[7].count == 0) {
    ...
    ydim0_advec_cell_kernel1_xdir = args[0].dat->size[1];
    xdim1_advec_cell_kernel1_xdir = args[1].dat->size[0]*args[1].dat->dim;
    ydim1_advec_cell_kernel1_xdir = args[1].dat->size[1];
    xdim2_advec_cell_kernel1_xdir = args[2].dat->size[0]*args[2].dat->dim;
    ydim2_advec_cell_kernel1_xdir = args[2].dat->size[1];
    xdim3_advec_cell_kernel1_xdir = args[3].dat->size[0]*args[3].dat->dim;
    ydim3_advec_cell_kernel1_xdir = args[3].dat->size[1];
    xdim4_advec_cell_kernel1_xdir = args[4].dat->size[0]*args[4].dat->dim;
    ydim4_advec_cell_kernel1_xdir = args[4].dat->size[1];
    xdim5_advec_cell_kernel1_xdir = args[5].dat->size[0]*args[5].dat->dim;
    ydim5_advec_cell_kernel1_xdir = args[5].dat->size[1];
  }
