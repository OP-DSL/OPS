...
void ops_par_loop_accelerate_kernel(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3, ops_arg arg4, ops_arg arg5, ops_arg arg6, ops_arg arg7, ops_arg arg8, ops_arg arg9, ops_arg arg10, ops_arg arg11, ops_arg arg12, ops_arg arg13) {
  ...
  if (OPS_kernels[1].count == 0) {
    ...
    ydim0_accelerate_kernel = args[0].dat->block_size[1];
    xdim1_accelerate_kernel = args[1].dat->block_size[0]*args[1].dat->dim;
    ydim1_accelerate_kernel = args[1].dat->block_size[1];
    xdim2_accelerate_kernel = args[2].dat->block_size[0]*args[2].dat->dim;
    ydim2_accelerate_kernel = args[2].dat->block_size[1];
    xdim3_accelerate_kernel = args[3].dat->block_size[0]*args[3].dat->dim;
    ydim3_accelerate_kernel = args[3].dat->block_size[1];
    xdim4_accelerate_kernel = args[4].dat->block_size[0]*args[4].dat->dim;
    ydim4_accelerate_kernel = args[4].dat->block_size[1];
    xdim5_accelerate_kernel = args[5].dat->block_size[0]*args[5].dat->dim;
    ydim5_accelerate_kernel = args[5].dat->block_size[1];
    xdim6_accelerate_kernel = args[6].dat->block_size[0]*args[6].dat->dim;
    ydim6_accelerate_kernel = args[6].dat->block_size[1];
    xdim7_accelerate_kernel = args[7].dat->block_size[0]*args[7].dat->dim;
    ydim7_accelerate_kernel = args[7].dat->block_size[1];
    xdim8_accelerate_kernel = args[8].dat->block_size[0]*args[8].dat->dim;
    ydim8_accelerate_kernel = args[8].dat->block_size[1];
    xdim9_accelerate_kernel = args[9].dat->block_size[0]*args[9].dat->dim;
    ydim9_accelerate_kernel = args[9].dat->block_size[1];
    xdim10_accelerate_kernel = args[10].dat->block_size[0]*args[10].dat->dim;
    ydim10_accelerate_kernel = args[10].dat->block_size[1];
    xdim11_accelerate_kernel = args[11].dat->block_size[0]*args[11].dat->dim;
    ydim11_accelerate_kernel = args[11].dat->block_size[1];
    xdim12_accelerate_kernel = args[12].dat->block_size[0]*args[12].dat->dim;
    ydim12_accelerate_kernel = args[12].dat->block_size[1];
    xdim13_accelerate_kernel = args[13].dat->block_size[0]*args[13].dat->dim;
    ydim13_accelerate_kernel = args[13].dat->block_size[1];
  }
