...
void ops_par_loop_update_halo_kernel2_zvel_plus_4_left(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  if (OPS_kernels[94].count == 0) {
    xdim0_update_halo_kernel2_zvel_plus_4_left = args[0].dat->block_size[0]*args[0].dat->dim;
    ydim0_update_halo_kernel2_zvel_plus_4_left = args[0].dat->block_size[1];
    xdim1_update_halo_kernel2_zvel_plus_4_left = args[1].dat->block_size[0]*args[1].dat->dim;
    ydim1_update_halo_kernel2_zvel_plus_4_left = args[1].dat->block_size[1];
  }
