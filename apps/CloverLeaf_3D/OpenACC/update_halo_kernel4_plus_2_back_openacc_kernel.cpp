...
void ops_par_loop_update_halo_kernel4_plus_2_back(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  //Timing
  double t1,t2,c1,c2;
  ops_timing_realloc(123,"update_halo_kernel4_plus_2_back");
  ops_timers_core(&c2,&t2);

  if (OPS_kernels[123].count == 0) {
    xdim0_update_halo_kernel4_plus_2_back = args[0].dat->block_size[0]*args[0].dat->dim;
    ydim0_update_halo_kernel4_plus_2_back = args[0].dat->block_size[1];
    xdim1_update_halo_kernel4_plus_2_back = args[1].dat->block_size[0]*args[1].dat->dim;
    ydim1_update_halo_kernel4_plus_2_back = args[1].dat->block_size[1];
  }
