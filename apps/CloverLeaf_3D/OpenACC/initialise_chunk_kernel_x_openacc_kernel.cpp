...
void ops_par_loop_initialise_chunk_kernel_x(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  if (OPS_kernels[46].count == 0) {
    ...
    ydim0_initialise_chunk_kernel_x = args[0].dat->block_size[1];
    xdim1_initialise_chunk_kernel_x = args[1].dat->block_size[0]*args[1].dat->dim;
    ydim1_initialise_chunk_kernel_x = args[1].dat->block_size[1];
    xdim2_initialise_chunk_kernel_x = args[2].dat->block_size[0]*args[2].dat->dim;
    ydim2_initialise_chunk_kernel_x = args[2].dat->block_size[1];
  }
