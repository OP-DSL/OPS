  ...
  for ( int n_z=0; n_z<z_size; n_z++ ){
    ...
    for ( int n_y=0; n_y<y_size; n_y++ ){
      ...
      for ( int n_x=0; n_x<x_size; n_x++ ){
        ...
        initialise_chunk_kernel_yy(  p_a0 + n_x*0*1 + n_y*xdim0_initialise_chunk_kernel_yy*1*1 + n_z*xdim0_initialise_chunk_kernel_yy*ydim0_initialise_chunk_kernel_yy*0,
          arg_idx );
