...
void ops_par_loop_update_halo_kernel1_ba1(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3, ops_arg arg4, ops_arg arg5, ops_arg arg6, ops_arg arg7) {
  ...
  if (OPS_kernels[66].count == 1) {
    xdim0_update_halo_kernel1_ba1 = args[0].dat->size[0]*args[0].dat->dim;
    ydim0_update_halo_kernel1_ba1 = args[0].dat->size[1];
    xdim1_update_halo_kernel1_ba1 = args[1].dat->size[0]*args[1].dat->dim;
    ydim1_update_halo_kernel1_ba1 = args[1].dat->size[1];
    xdim2_update_halo_kernel1_ba1 = args[2].dat->size[0]*args[2].dat->dim;
    ydim2_update_halo_kernel1_ba1 = args[2].dat->size[1];
    xdim3_update_halo_kernel1_ba1 = args[3].dat->size[0]*args[3].dat->dim;
    ydim3_update_halo_kernel1_ba1 = args[3].dat->size[1];
    xdim4_update_halo_kernel1_ba1 = args[4].dat->size[0]*args[4].dat->dim;
    ydim4_update_halo_kernel1_ba1 = args[4].dat->size[1];
    xdim5_update_halo_kernel1_ba1 = args[5].dat->size[0]*args[5].dat->dim;
    ydim5_update_halo_kernel1_ba1 = args[5].dat->size[1];
    xdim6_update_halo_kernel1_ba1 = args[6].dat->size[0]*args[6].dat->dim;
    ydim6_update_halo_kernel1_ba1 = args[6].dat->size[1];
  }
