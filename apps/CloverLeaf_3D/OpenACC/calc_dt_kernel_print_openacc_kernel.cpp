...
void ops_par_loop_calc_dt_kernel_print(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3, ops_arg arg4, ops_arg arg5, ops_arg arg6, ops_arg arg7) {
  ...
  if (OPS_kernels[129].count == 0) {
    xdim0_calc_dt_kernel_print = args[0].dat->block_size[0]*args[0].dat->dim;
    ydim0_calc_dt_kernel_print = args[0].dat->block_size[1];
    xdim1_calc_dt_kernel_print = args[1].dat->block_size[0]*args[1].dat->dim;
    ydim1_calc_dt_kernel_print = args[1].dat->block_size[1];
    xdim2_calc_dt_kernel_print = args[2].dat->block_size[0]*args[2].dat->dim;
    ydim2_calc_dt_kernel_print = args[2].dat->block_size[1];
    xdim3_calc_dt_kernel_print = args[3].dat->block_size[0]*args[3].dat->dim;
    ydim3_calc_dt_kernel_print = args[3].dat->block_size[1];
    xdim4_calc_dt_kernel_print = args[4].dat->block_size[0]*args[4].dat->dim;
    ydim4_calc_dt_kernel_print = args[4].dat->block_size[1];
    xdim5_calc_dt_kernel_print = args[5].dat->block_size[0]*args[5].dat->dim;
    ydim5_calc_dt_kernel_print = args[5].dat->block_size[1];
    xdim6_calc_dt_kernel_print = args[6].dat->block_size[0]*args[6].dat->dim;
    ydim6_calc_dt_kernel_print = args[6].dat->block_size[1];
  }
