...
void ops_par_loop_advec_mom_kernel_mass_flux_z(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  if (OPS_kernels[33].count == 0) {
    xdim0_advec_mom_kernel_mass_flux_z = args[0].dat->size[0]*args[0].dat->dim;
    ydim0_advec_mom_kernel_mass_flux_z = args[0].dat->size[1];
    xdim1_advec_mom_kernel_mass_flux_z = args[1].dat->size[0]*args[1].dat->dim;
    ydim1_advec_mom_kernel_mass_flux_z = args[1].dat->size[1];
  }
