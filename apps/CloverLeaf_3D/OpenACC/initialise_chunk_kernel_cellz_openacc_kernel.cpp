...
void ops_par_loop_initialise_chunk_kernel_cellz(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  //Timing
  double t1,t2,c1,c2;
  ops_timing_realloc(135,"initialise_chunk_kernel_cellz");
  ops_timers_core(&c2,&t2);

  if (OPS_kernels[135].count == 0) {
    xdim0_initialise_chunk_kernel_cellz = args[0].dat->block_size[0]*args[0].dat->dim;
    ydim0_initialise_chunk_kernel_cellz = args[0].dat->block_size[1];
    xdim1_initialise_chunk_kernel_cellz = args[1].dat->block_size[0]*args[1].dat->dim;
    ydim1_initialise_chunk_kernel_cellz = args[1].dat->block_size[1];
    xdim2_initialise_chunk_kernel_cellz = args[2].dat->block_size[0]*args[2].dat->dim;
    ydim2_initialise_chunk_kernel_cellz = args[2].dat->block_size[1];
  }
