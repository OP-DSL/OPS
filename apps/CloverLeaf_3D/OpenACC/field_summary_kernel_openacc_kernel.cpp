...
void ops_par_loop_field_summary_kernel(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3, ops_arg arg4, ops_arg arg5, ops_arg arg6, ops_arg arg7, ops_arg arg8, ops_arg arg9, ops_arg arg10, ops_arg arg11) {
  ...
  if (OPS_kernels[125].count == 0) {
    ...
    ydim0_field_summary_kernel = args[0].dat->size[1];
    xdim1_field_summary_kernel = args[1].dat->size[0]*args[1].dat->dim;
    ydim1_field_summary_kernel = args[1].dat->size[1];
    xdim2_field_summary_kernel = args[2].dat->size[0]*args[2].dat->dim;
    ydim2_field_summary_kernel = args[2].dat->size[1];
    xdim3_field_summary_kernel = args[3].dat->size[0]*args[3].dat->dim;
    ydim3_field_summary_kernel = args[3].dat->size[1];
    xdim4_field_summary_kernel = args[4].dat->size[0]*args[4].dat->dim;
    ydim4_field_summary_kernel = args[4].dat->size[1];
    xdim5_field_summary_kernel = args[5].dat->size[0]*args[5].dat->dim;
    ydim5_field_summary_kernel = args[5].dat->size[1];
    xdim6_field_summary_kernel = args[6].dat->size[0]*args[6].dat->dim;
    ydim6_field_summary_kernel = args[6].dat->size[1];
  }
