...
void ops_par_loop_field_summary_kernel(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3, ops_arg arg4, ops_arg arg5, ops_arg arg6, ops_arg arg7, ops_arg arg8, ops_arg arg9, ops_arg arg10, ops_arg arg11) {
  ...
  if (OPS_kernels[125].count == 0) {
    ...
    ydim0_field_summary_kernel = args[0].dat->block_size[1];
    xdim1_field_summary_kernel = args[1].dat->block_size[0]*args[1].dat->dim;
    ydim1_field_summary_kernel = args[1].dat->block_size[1];
    xdim2_field_summary_kernel = args[2].dat->block_size[0]*args[2].dat->dim;
    ydim2_field_summary_kernel = args[2].dat->block_size[1];
    xdim3_field_summary_kernel = args[3].dat->block_size[0]*args[3].dat->dim;
    ydim3_field_summary_kernel = args[3].dat->block_size[1];
    xdim4_field_summary_kernel = args[4].dat->block_size[0]*args[4].dat->dim;
    ydim4_field_summary_kernel = args[4].dat->block_size[1];
    xdim5_field_summary_kernel = args[5].dat->block_size[0]*args[5].dat->dim;
    ydim5_field_summary_kernel = args[5].dat->block_size[1];
    xdim6_field_summary_kernel = args[6].dat->block_size[0]*args[6].dat->dim;
    ydim6_field_summary_kernel = args[6].dat->block_size[1];
  }
  ...
  double *p_a11 = (double *)args[11].data;
  ...
  *(double *)args[11].data = *p_a11;
  ...
  ops_mpi_reduce(&arg11,(double *)args[11].data);
  ops_timers_core(&c1,&t1);
  OPS_kernels[125].mpi_time += t1-t2;
  #ifdef OPS_GPU
