...
void ops_par_loop_generate_chunk_kernel(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3, ops_arg arg4, ops_arg arg5, ops_arg arg6, ops_arg arg7, ops_arg arg8, ops_arg arg9, ops_arg arg10) {
  ...
  //Timing
  double t1,t2,c1,c2;
  ops_timing_realloc(53,"generate_chunk_kernel");
  ...
  OPS_kernels[53].transfer += ops_compute_transfer(dim, range, &arg3);
  OPS_kernels[53].transfer += ops_compute_transfer(dim, range, &arg4);
  OPS_kernels[53].transfer += ops_compute_transfer(dim, range, &arg5);
  OPS_kernels[53].transfer += ops_compute_transfer(dim, range, &arg6);
  OPS_kernels[53].transfer += ops_compute_transfer(dim, range, &arg7);
  OPS_kernels[53].transfer += ops_compute_transfer(dim, range, &arg8);
  OPS_kernels[53].transfer += ops_compute_transfer(dim, range, &arg9);
  OPS_kernels[53].transfer += ops_compute_transfer(dim, range, &arg10);
}
