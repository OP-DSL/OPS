...
void ops_par_loop_generate_chunk_kernel(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3, ops_arg arg4, ops_arg arg5, ops_arg arg6, ops_arg arg7, ops_arg arg8, ops_arg arg9, ops_arg arg10) {
  ...
  if (OPS_kernels[137].count == 0) {
    xdim0_generate_chunk_kernel = args[0].dat->block_size[0]*args[0].dat->dim;
    ydim0_generate_chunk_kernel = args[0].dat->block_size[1];
    xdim1_generate_chunk_kernel = args[1].dat->block_size[0]*args[1].dat->dim;
    ydim1_generate_chunk_kernel = args[1].dat->block_size[1];
    xdim2_generate_chunk_kernel = args[2].dat->block_size[0]*args[2].dat->dim;
    ydim2_generate_chunk_kernel = args[2].dat->block_size[1];
    xdim3_generate_chunk_kernel = args[3].dat->block_size[0]*args[3].dat->dim;
    ydim3_generate_chunk_kernel = args[3].dat->block_size[1];
    xdim4_generate_chunk_kernel = args[4].dat->block_size[0]*args[4].dat->dim;
    ydim4_generate_chunk_kernel = args[4].dat->block_size[1];
    xdim5_generate_chunk_kernel = args[5].dat->block_size[0]*args[5].dat->dim;
    ydim5_generate_chunk_kernel = args[5].dat->block_size[1];
    xdim6_generate_chunk_kernel = args[6].dat->block_size[0]*args[6].dat->dim;
    ydim6_generate_chunk_kernel = args[6].dat->block_size[1];
    xdim7_generate_chunk_kernel = args[7].dat->block_size[0]*args[7].dat->dim;
    ydim7_generate_chunk_kernel = args[7].dat->block_size[1];
    xdim8_generate_chunk_kernel = args[8].dat->block_size[0]*args[8].dat->dim;
    ydim8_generate_chunk_kernel = args[8].dat->block_size[1];
    xdim9_generate_chunk_kernel = args[9].dat->block_size[0]*args[9].dat->dim;
    ydim9_generate_chunk_kernel = args[9].dat->block_size[1];
    xdim10_generate_chunk_kernel = args[10].dat->block_size[0]*args[10].dat->dim;
    ydim10_generate_chunk_kernel = args[10].dat->block_size[1];
  }
