...
void ops_par_loop_PdV_kernel_predict(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3, ops_arg arg4, ops_arg arg5, ops_arg arg6, ops_arg arg7, ops_arg arg8, ops_arg arg9, ops_arg arg10, ops_arg arg11, ops_arg arg12, ops_arg arg13) {
  ...
  if (OPS_kernels[5].count == 0) {
    ...
    ydim0_PdV_kernel_predict = args[0].dat->block_size[1];
    xdim1_PdV_kernel_predict = args[1].dat->block_size[0]*args[1].dat->dim;
    ydim1_PdV_kernel_predict = args[1].dat->block_size[1];
    xdim2_PdV_kernel_predict = args[2].dat->block_size[0]*args[2].dat->dim;
    ydim2_PdV_kernel_predict = args[2].dat->block_size[1];
    xdim3_PdV_kernel_predict = args[3].dat->block_size[0]*args[3].dat->dim;
    ydim3_PdV_kernel_predict = args[3].dat->block_size[1];
    xdim4_PdV_kernel_predict = args[4].dat->block_size[0]*args[4].dat->dim;
    ydim4_PdV_kernel_predict = args[4].dat->block_size[1];
    xdim5_PdV_kernel_predict = args[5].dat->block_size[0]*args[5].dat->dim;
    ydim5_PdV_kernel_predict = args[5].dat->block_size[1];
    xdim6_PdV_kernel_predict = args[6].dat->block_size[0]*args[6].dat->dim;
    ydim6_PdV_kernel_predict = args[6].dat->block_size[1];
    xdim7_PdV_kernel_predict = args[7].dat->block_size[0]*args[7].dat->dim;
    ydim7_PdV_kernel_predict = args[7].dat->block_size[1];
    xdim8_PdV_kernel_predict = args[8].dat->block_size[0]*args[8].dat->dim;
    ydim8_PdV_kernel_predict = args[8].dat->block_size[1];
    xdim9_PdV_kernel_predict = args[9].dat->block_size[0]*args[9].dat->dim;
    ydim9_PdV_kernel_predict = args[9].dat->block_size[1];
    xdim10_PdV_kernel_predict = args[10].dat->block_size[0]*args[10].dat->dim;
    ydim10_PdV_kernel_predict = args[10].dat->block_size[1];
    xdim11_PdV_kernel_predict = args[11].dat->block_size[0]*args[11].dat->dim;
    ydim11_PdV_kernel_predict = args[11].dat->block_size[1];
    xdim12_PdV_kernel_predict = args[12].dat->block_size[0]*args[12].dat->dim;
    ydim12_PdV_kernel_predict = args[12].dat->block_size[1];
    xdim13_PdV_kernel_predict = args[13].dat->block_size[0]*args[13].dat->dim;
    ydim13_PdV_kernel_predict = args[13].dat->block_size[1];
  }
