...
//user function
inline void update_halo_kernel2_xvel_minus_4_right(__global double * restrict xvel0, __global double * restrict xvel1, const __global int* restrict  fields)
...
const int size2 ){
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    update_halo_kernel2_xvel_minus_4_right(&arg0[base0 + idx_x * 1*1 + idx_y * 1*1 * xdim0_update_halo_kernel2_xvel_minus_4_right + idx_z * 1*1 * xdim0_update_halo_kernel2_xvel_minus_4_right * ydim0_update_halo_kernel2_xvel_minus_4_right],
                       &arg1[base1 + idx_x * 1*1 + idx_y * 1*1 * xdim1_update_halo_kernel2_xvel_minus_4_right + idx_z * 1*1 * xdim1_update_halo_kernel2_xvel_minus_4_right * ydim1_update_halo_kernel2_xvel_minus_4_right],
                       arg2);
  }
