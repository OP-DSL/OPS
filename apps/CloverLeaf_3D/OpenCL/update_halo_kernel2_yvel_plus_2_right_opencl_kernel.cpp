...
void buildOpenCLKernels_update_halo_kernel2_yvel_plus_2_right(int xdim0, int ydim0,
 int xdim1, int ydim1) {
  ...
  if(!isbuilt_update_halo_kernel2_yvel_plus_2_right) {
    ...
    printf("Compiling update_halo_kernel2_yvel_plus_2_right %d source -- start \n",OCL_FMA);
      ...
      if (pPath!=NULL)
        if(OCL_FMA)
          sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA=1 -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_update_halo_kernel2_yvel_plus_2_right=%d -Dydim0_update_halo_kernel2_yvel_plus_2_right=%d -Dxdim1_update_halo_kernel2_yvel_plus_2_right=%d -Dydim1_update_halo_kernel2_yvel_plus_2_right=%d", pPath, 32,xdim0, ydim0,xdim1, ydim1);
        else
          sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA=0 -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_update_halo_kernel2_yvel_plus_2_right=%d -Dydim0_update_halo_kernel2_yvel_plus_2_right=%d -Dxdim1_update_halo_kernel2_yvel_plus_2_right=%d -Dydim1_update_halo_kernel2_yvel_plus_2_right=%d", pPath, 32,xdim0, ydim0,xdim1, ydim1);
      else {
    ...
    OPS_opencl_core.kernel[72] = clCreateKernel(OPS_opencl_core.program, "ops_update_halo_kernel2_yvel_plus_2_right", &ret);
    clSafeCall( ret );
...
void ops_par_loop_update_halo_kernel2_yvel_plus_2_right(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  //Timing
  double t1,t2,c1,c2;
  ops_timing_realloc(72,"update_halo_kernel2_yvel_plus_2_right");
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[72], 7, sizeof(cl_int), (void*) &z_size ));
