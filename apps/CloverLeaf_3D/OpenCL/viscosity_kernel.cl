 ...
 const int size2 ){
   ...
   if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
     viscosity_kernel(&arg0[base0 + idx_x * 1 + idx_y * 1 * xdim0_viscosity_kernel+ idx_z * 1 * xdim0_viscosity_kernel * ydim0_viscosity_kernel],
                      ...
                      &arg2[base2 + idx_x * 1 + idx_y * 1 * xdim2_viscosity_kernel+ idx_z * 1 * xdim2_viscosity_kernel * ydim2_viscosity_kernel],
                      &arg3[base3 + idx_x * 1 + idx_y * 0 * xdim3_viscosity_kernel+ idx_z * 0 * xdim3_viscosity_kernel * ydim3_viscosity_kernel],
                      &arg4[base4 + idx_x * 0 + idx_y * 0 * xdim4_viscosity_kernel+ idx_z * 1 * xdim4_viscosity_kernel * ydim4_viscosity_kernel],
                      &arg5[base5 + idx_x * 1 + idx_y * 0 * xdim5_viscosity_kernel+ idx_z * 1 * xdim5_viscosity_kernel * ydim5_viscosity_kernel],
                      ...
                      &arg8[base8 + idx_x * 1 + idx_y * 1 * xdim8_viscosity_kernel+ idx_z * 1 * xdim8_viscosity_kernel * ydim8_viscosity_kernel],
                      ...
                      &arg11[base11 + idx_x * 1 + idx_y * 1 * xdim11_viscosity_kernel+ idx_z * 0 * xdim11_viscosity_kernel * ydim11_viscosity_kernel]);
   }
