 ...
 const int size2 ){
   ...
   if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
     viscosity_kernel(&arg0[base0 + idx_x * 1 + idx_y * 1 * xdim0_viscosity_kernel],
                      ...
                      &arg3[base3 + idx_x * 1 + idx_y * 0 * xdim3_viscosity_kernel],
                      &arg4[base4 + idx_x * 0 + idx_y * 0 * xdim4_viscosity_kernel],
                      &arg5[base5 + idx_x * 1 + idx_y * 0 * xdim5_viscosity_kernel],
                      &arg6[base6 + idx_x * 1 + idx_y * 1 * xdim6_viscosity_kernel],
                      &arg7[base7 + idx_x * 1 + idx_y * 1 * xdim7_viscosity_kernel],
                      &arg8[base8 + idx_x * 1 + idx_y * 1 * xdim8_viscosity_kernel],
                      &arg9[base9 + idx_x * 1 + idx_y * 1 * xdim9_viscosity_kernel],
                      &arg10[base10 + idx_x * 1 + idx_y * 1 * xdim10_viscosity_kernel],
                      &arg11[base11 + idx_x * 1 + idx_y * 1 * xdim11_viscosity_kernel]);
   }
