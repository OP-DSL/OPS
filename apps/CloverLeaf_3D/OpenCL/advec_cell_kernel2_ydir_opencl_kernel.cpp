 ...
 int xdim4) {
  ...
  if(!isbuilt_advec_cell_kernel2_ydir) {
    ...
    printf("Compiling advec_cell_kernel2_ydir source -- start \n");
      ...
      if (pPath!=NULL)
        sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_advec_cell_kernel2_ydir=%d -Dxdim1_advec_cell_kernel2_ydir=%d -Dxdim2_advec_cell_kernel2_ydir=%d -Dxdim3_advec_cell_kernel2_ydir=%d -Dxdim4_advec_cell_kernel2_ydir=%d", pPath, 32,xdim0,xdim1,xdim2,xdim3,xdim4);
      else {
