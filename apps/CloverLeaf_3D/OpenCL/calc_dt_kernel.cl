 ...
 const int size2 ){
   ...
   if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
     calc_dt_kernel(&arg0[base0 + idx_x * 1 + idx_y * 0 * xdim0_calc_dt_kernel+ idx_z * 0 * xdim0_calc_dt_kernel * ydim0_calc_dt_kernel],
                    &arg1[base1 + idx_x * 0 + idx_y * 0 * xdim1_calc_dt_kernel+ idx_z * 1 * xdim1_calc_dt_kernel * ydim1_calc_dt_kernel],
                    &arg2[base2 + idx_x * 1 + idx_y * 0 * xdim2_calc_dt_kernel+ idx_z * 1 * xdim2_calc_dt_kernel * ydim2_calc_dt_kernel],
                    ...
                    &arg11[base11 + idx_x * 1 + idx_y * 1 * xdim11_calc_dt_kernel+ idx_z * 1 * xdim11_calc_dt_kernel * ydim11_calc_dt_kernel],
