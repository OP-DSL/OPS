...
void buildOpenCLKernels_advec_mom_kernel_x3(int xdim0,
 int xdim1,
 int xdim2,
 int xdim3) {
  ...
  if(!isbuilt_advec_mom_kernel_x3) {
    ...
    printf("Compiling advec_mom_kernel_x3 source -- start \n");
      ...
      if (pPath!=NULL)
        sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_advec_mom_kernel_x3=%d -Dxdim1_advec_mom_kernel_x3=%d -Dxdim2_advec_mom_kernel_x3=%d -Dxdim3_advec_mom_kernel_x3=%d", pPath, 32,xdim0,xdim1,xdim2,xdim3);
      else {
