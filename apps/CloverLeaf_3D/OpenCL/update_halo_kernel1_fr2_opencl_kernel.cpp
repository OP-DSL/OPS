...
void buildOpenCLKernels_update_halo_kernel1_fr2(int xdim0,
 int xdim1,
 int xdim2,
 int xdim3,
 int xdim4,
 ...
 int xdim6) {
  ...
  if(!isbuilt_update_halo_kernel1_fr2) {
    ...
    printf("Compiling update_halo_kernel1_fr2 source -- start \n");
      ...
      if (pPath!=NULL)
        sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_update_halo_kernel1_fr2=%d -Dxdim1_update_halo_kernel1_fr2=%d -Dxdim2_update_halo_kernel1_fr2=%d -Dxdim3_update_halo_kernel1_fr2=%d -Dxdim4_update_halo_kernel1_fr2=%d -Dxdim5_update_halo_kernel1_fr2=%d -Dxdim6_update_halo_kernel1_fr2=%d", pPath, 32,xdim0,xdim1,xdim2,xdim3,xdim4,xdim5,xdim6);
      else {
