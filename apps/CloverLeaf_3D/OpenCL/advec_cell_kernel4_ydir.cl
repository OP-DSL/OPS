...
__global double * restrict post_mass, __global double * restrict advec_vol, __global double * restrict post_ener, const __global double * restrict ener_flux)
 ...
 const int size2 ){
   ...
   if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
     advec_cell_kernel4_ydir(&arg0[base0 + idx_x * 1 + idx_y * 1 * xdim0_advec_cell_kernel4_ydir + idx_z * 1 * xdim0_advec_cell_kernel4_ydir * ydim0_advec_cell_kernel4_ydir],
                       &arg1[base1 + idx_x * 1 + idx_y * 1 * xdim1_advec_cell_kernel4_ydir + idx_z * 1 * xdim1_advec_cell_kernel4_ydir * ydim1_advec_cell_kernel4_ydir],
                       &arg2[base2 + idx_x * 1 + idx_y * 1 * xdim2_advec_cell_kernel4_ydir + idx_z * 1 * xdim2_advec_cell_kernel4_ydir * ydim2_advec_cell_kernel4_ydir],
                       &arg3[base3 + idx_x * 1 + idx_y * 1 * xdim3_advec_cell_kernel4_ydir + idx_z * 1 * xdim3_advec_cell_kernel4_ydir * ydim3_advec_cell_kernel4_ydir],
                       &arg4[base4 + idx_x * 1 + idx_y * 1 * xdim4_advec_cell_kernel4_ydir + idx_z * 1 * xdim4_advec_cell_kernel4_ydir * ydim4_advec_cell_kernel4_ydir],
                       &arg5[base5 + idx_x * 1 + idx_y * 1 * xdim5_advec_cell_kernel4_ydir + idx_z * 1 * xdim5_advec_cell_kernel4_ydir * ydim5_advec_cell_kernel4_ydir],
                       &arg6[base6 + idx_x * 1 + idx_y * 1 * xdim6_advec_cell_kernel4_ydir + idx_z * 1 * xdim6_advec_cell_kernel4_ydir * ydim6_advec_cell_kernel4_ydir],
                       &arg7[base7 + idx_x * 1 + idx_y * 1 * xdim7_advec_cell_kernel4_ydir + idx_z * 1 * xdim7_advec_cell_kernel4_ydir * ydim7_advec_cell_kernel4_ydir],
                       &arg8[base8 + idx_x * 1 + idx_y * 1 * xdim8_advec_cell_kernel4_ydir + idx_z * 1 * xdim8_advec_cell_kernel4_ydir * ydim8_advec_cell_kernel4_ydir],
                       &arg9[base9 + idx_x * 1 + idx_y * 1 * xdim9_advec_cell_kernel4_ydir + idx_z * 1 * xdim9_advec_cell_kernel4_ydir * ydim9_advec_cell_kernel4_ydir],
                       &arg10[base10 + idx_x * 1 + idx_y * 1 * xdim10_advec_cell_kernel4_ydir + idx_z * 1 * xdim10_advec_cell_kernel4_ydir * ydim10_advec_cell_kernel4_ydir]);
   }
