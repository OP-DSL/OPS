 ...
 const int size2 ){
   ...
   if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
     PdV_kernel_nopredict(&arg0[base0 + idx_x * 1 + idx_y * 1 * xdim0_PdV_kernel_nopredict],
                ...
                &arg14[base14 + idx_x * 1 + idx_y * 1 * xdim14_PdV_kernel_nopredict],
                &arg15[base15 + idx_x * 1 + idx_y * 1 * xdim15_PdV_kernel_nopredict],
                &arg16[base16 + idx_x * 1 + idx_y * 1 * xdim16_PdV_kernel_nopredict],
                *dt);
   }
