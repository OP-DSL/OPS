 ...
 const int size2 ){
   ...
   if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
     calc_dt_kernel_get(&arg0[base0 + idx_x * 1 + idx_y * 0 * xdim0_calc_dt_kernel_get+ idx_z * 0 * xdim0_calc_dt_kernel_get * ydim0_calc_dt_kernel_get],
                    &arg1[base1 + idx_x * 0 + idx_y * 0 * xdim1_calc_dt_kernel_get+ idx_z * 1 * xdim1_calc_dt_kernel_get * ydim1_calc_dt_kernel_get],
                    arg2_l,
                    arg3_l,
                    &arg4[base4 + idx_x * 1 + idx_y * 1 * xdim4_calc_dt_kernel_get+ idx_z * 1 * xdim4_calc_dt_kernel_get * ydim4_calc_dt_kernel_get],
                    arg5_l);
   }
