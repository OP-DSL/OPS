...
void buildOpenCLKernels_advec_mom_kernel_post_pre_advec_z(int xdim0,
 int xdim1,
 int xdim2,
 int xdim3,
 int xdim4) {
  ...
  if(!isbuilt_advec_mom_kernel_post_pre_advec_z) {
    ...
    printf("Compiling advec_mom_kernel_post_pre_advec_z source -- start \n");
      ...
      if (pPath!=NULL)
        sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_advec_mom_kernel_post_pre_advec_z=%d -Dxdim1_advec_mom_kernel_post_pre_advec_z=%d -Dxdim2_advec_mom_kernel_post_pre_advec_z=%d -Dxdim3_advec_mom_kernel_post_pre_advec_z=%d -Dxdim4_advec_mom_kernel_post_pre_advec_z=%d", pPath, 32,xdim0,xdim1,xdim2,xdim3,xdim4);
      else {
    ...
    OPS_opencl_core.kernel[26] = clCreateKernel(OPS_opencl_core.program, "ops_advec_mom_kernel_post_pre_advec_z", &ret);
    clSafeCall( ret );
