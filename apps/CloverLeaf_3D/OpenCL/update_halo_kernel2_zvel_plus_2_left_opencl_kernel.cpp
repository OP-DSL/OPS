 ...
 int xdim1, int ydim1) {
  ...
  if(!isbuilt_update_halo_kernel2_zvel_plus_2_left) {
    ...
    printf("Compiling update_halo_kernel2_zvel_plus_2_left %d source -- start \n",OCL_FMA);
      ...
      if (pPath!=NULL)
        if(OCL_FMA)
          sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA=1 -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_update_halo_kernel2_zvel_plus_2_left=%d -Dydim0_update_halo_kernel2_zvel_plus_2_left=%d -Dxdim1_update_halo_kernel2_zvel_plus_2_left=%d -Dydim1_update_halo_kernel2_zvel_plus_2_left=%d", pPath, 32,xdim0, ydim0,xdim1, ydim1);
        else
          sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA=0 -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_update_halo_kernel2_zvel_plus_2_left=%d -Dydim0_update_halo_kernel2_zvel_plus_2_left=%d -Dxdim1_update_halo_kernel2_zvel_plus_2_left=%d -Dydim1_update_halo_kernel2_zvel_plus_2_left=%d", pPath, 32,xdim0, ydim0,xdim1, ydim1);
      else {
    ...
    OPS_opencl_core.kernel[82] = clCreateKernel(OPS_opencl_core.program, "ops_update_halo_kernel2_zvel_plus_2_left", &ret);
    clSafeCall( ret );
...
void ops_par_loop_update_halo_kernel2_zvel_plus_2_left(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[82], 7, sizeof(cl_int), (void*) &z_size ));
