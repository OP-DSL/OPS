...
void buildOpenCLKernels_advec_mom_kernel_x1(int xdim0, int ydim0,
 ...
 int xdim5, int ydim5) {
  ...
  if(!isbuilt_advec_mom_kernel_x1) {
    ...
    OPS_opencl_core.kernel[11] = clCreateKernel(OPS_opencl_core.program, "ops_advec_mom_kernel_x1", &ret);
    clSafeCall( ret );
...
void ops_par_loop_advec_mom_kernel_x1(char const *name, ops_block Block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5) {
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[11], 6, sizeof(cl_int), (void*) &base0 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[11], 7, sizeof(cl_int), (void*) &base1 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[11], 8, sizeof(cl_int), (void*) &base2 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[11], 9, sizeof(cl_int), (void*) &base3 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[11], 10, sizeof(cl_int), (void*) &base4 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[11], 11, sizeof(cl_int), (void*) &base5 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[11], 12, sizeof(cl_int), (void*) &x_size ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[11], 13, sizeof(cl_int), (void*) &y_size ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[11], 14, sizeof(cl_int), (void*) &z_size ));
