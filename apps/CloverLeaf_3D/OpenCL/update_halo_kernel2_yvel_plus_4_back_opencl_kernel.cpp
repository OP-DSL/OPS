...
void buildOpenCLKernels_update_halo_kernel2_yvel_plus_4_back(int xdim0,
 int xdim1) {
  ...
  if(!isbuilt_update_halo_kernel2_yvel_plus_4_back) {
    ...
    printf("Compiling update_halo_kernel2_yvel_plus_4_back source -- start \n");
      ...
      if (pPath!=NULL)
        sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_update_halo_kernel2_yvel_plus_4_back=%d -Dxdim1_update_halo_kernel2_yvel_plus_4_back=%d", pPath, 32,xdim0,xdim1);
      else {
