...
void buildOpenCLKernels_advec_mom_kernel1_z_nonvector(int xdim0,
 int xdim1,
 int xdim2,
 int xdim3,
 int xdim4) {
  ...
  if(!isbuilt_advec_mom_kernel1_z_nonvector) {
    ...
    printf("Compiling advec_mom_kernel1_z_nonvector source -- start \n");
      ...
      if (pPath!=NULL)
        sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_advec_mom_kernel1_z_nonvector=%d -Dxdim1_advec_mom_kernel1_z_nonvector=%d -Dxdim2_advec_mom_kernel1_z_nonvector=%d -Dxdim3_advec_mom_kernel1_z_nonvector=%d -Dxdim4_advec_mom_kernel1_z_nonvector=%d", pPath, 32,xdim0,xdim1,xdim2,xdim3,xdim4);
      else {
    ...
    OPS_opencl_core.kernel[27] = clCreateKernel(OPS_opencl_core.program, "ops_advec_mom_kernel1_z_nonvector", &ret);
    clSafeCall( ret );
...
void ops_par_loop_advec_mom_kernel1_z_nonvector(char const *name, ops_block Block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[27], 7, sizeof(cl_int), (void*) &base2 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[27], 8, sizeof(cl_int), (void*) &base3 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[27], 9, sizeof(cl_int), (void*) &base4 ));
