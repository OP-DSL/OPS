 ...
 const int size2 ){
   ...
   if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
     accelerate_kernel(&arg0[base0 + idx_x * 1 + idx_y * 1 * xdim0_accelerate_kernel],
                       ...
                       &arg11[base11 + idx_x * 1 + idx_y * 1 * xdim11_accelerate_kernel],
                       &arg12[base12 + idx_x * 1 + idx_y * 1 * xdim12_accelerate_kernel],
                       &arg13[base13 + idx_x * 1 + idx_y * 1 * xdim13_accelerate_kernel],
                       *dt);
   }
