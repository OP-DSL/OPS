...
void buildOpenCLKernels_advec_mom_kernel1_y_nonvector(int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3, int xdim4, int ydim4) {
  ...
  if(!isbuilt_advec_mom_kernel1_y_nonvector) {
    ...
    OPS_opencl_core.kernel[31] = clCreateKernel(OPS_opencl_core.program, "ops_advec_mom_kernel1_y_nonvector", &ret);
    clSafeCall( ret );
...
void ops_par_loop_advec_mom_kernel1_y_nonvector(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[31], 7, sizeof(cl_int), (void*) &base2 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[31], 8, sizeof(cl_int), (void*) &base3 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[31], 9, sizeof(cl_int), (void*) &base4 ));
