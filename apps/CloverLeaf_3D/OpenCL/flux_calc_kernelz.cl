...
const __global double * restrict zvel1, 
 ...
 const int size2 ){
   ...
   if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
     flux_calc_kernelz(&arg0[base0 + idx_x * 1 + idx_y * 1 * xdim0_flux_calc_kernelz + idx_z * 1 * xdim0_flux_calc_kernelz * ydim0_flux_calc_kernelz],
                      &arg1[base1 + idx_x * 1 + idx_y * 1 * xdim1_flux_calc_kernelz + idx_z * 1 * xdim1_flux_calc_kernelz * ydim1_flux_calc_kernelz],
                      &arg2[base2 + idx_x * 1 + idx_y * 1 * xdim2_flux_calc_kernelz + idx_z * 1 * xdim2_flux_calc_kernelz * ydim2_flux_calc_kernelz],
                      &arg3[base3 + idx_x * 1 + idx_y * 1 * xdim3_flux_calc_kernelz + idx_z * 1 * xdim3_flux_calc_kernelz * ydim3_flux_calc_kernelz],
                      dt);
   }
