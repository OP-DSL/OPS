...
//user function
inline void update_halo_kernel4_plus_4_front(__global double * restrict vol_flux_y, __global double * restrict mass_flux_y)
 ...
 const int size2 ){
   ...
   if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
     update_halo_kernel4_plus_4_front(&arg0[base0 + idx_x * 1 + idx_y * 1 * xdim0_update_halo_kernel4_plus_4_front + idx_z * 1 * xdim0_update_halo_kernel4_plus_4_front * ydim0_update_halo_kernel4_plus_4_front],
                        &arg1[base1 + idx_x * 1 + idx_y * 1 * xdim1_update_halo_kernel4_plus_4_front + idx_z * 1 * xdim1_update_halo_kernel4_plus_4_front * ydim1_update_halo_kernel4_plus_4_front],
                        arg2);
   }
