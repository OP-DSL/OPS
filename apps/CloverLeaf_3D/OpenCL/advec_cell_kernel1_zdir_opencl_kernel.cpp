...
void buildOpenCLKernels_advec_cell_kernel1_zdir(int xdim0,
 int xdim1,
 int xdim2,
 int xdim3,
 int xdim4,
 int xdim5) {
  ...
  if(!isbuilt_advec_cell_kernel1_zdir) {
    ...
    printf("Compiling advec_cell_kernel1_zdir source -- start \n");
      ...
      if (pPath!=NULL)
        sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_advec_cell_kernel1_zdir=%d -Dxdim1_advec_cell_kernel1_zdir=%d -Dxdim2_advec_cell_kernel1_zdir=%d -Dxdim3_advec_cell_kernel1_zdir=%d -Dxdim4_advec_cell_kernel1_zdir=%d -Dxdim5_advec_cell_kernel1_zdir=%d", pPath, 32,xdim0,xdim1,xdim2,xdim3,xdim4,xdim5);
      else {
