...
void buildOpenCLKernels_update_halo_kernel2_xvel_plus_4_top(int xdim0,
 int xdim1) {
  ...
  if(!isbuilt_update_halo_kernel2_xvel_plus_4_top) {
    ...
    printf("Compiling update_halo_kernel2_xvel_plus_4_top source -- start \n");
      ...
      if (pPath!=NULL)
        sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_update_halo_kernel2_xvel_plus_4_top=%d -Dxdim1_update_halo_kernel2_xvel_plus_4_top=%d", pPath, 32,xdim0,xdim1);
      else {
