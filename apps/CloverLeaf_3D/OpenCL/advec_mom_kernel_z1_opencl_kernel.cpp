...
void buildOpenCLKernels_advec_mom_kernel_z1(int xdim0,
 int xdim1,
 int xdim2,
 int xdim3,
 int xdim4,
 int xdim5) {
  ...
  if(!isbuilt_advec_mom_kernel_z1) {
    ...
    printf("Compiling advec_mom_kernel_z1 source -- start \n");
      ...
      if (pPath!=NULL)
        sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_advec_mom_kernel_z1=%d -Dxdim1_advec_mom_kernel_z1=%d -Dxdim2_advec_mom_kernel_z1=%d -Dxdim3_advec_mom_kernel_z1=%d -Dxdim4_advec_mom_kernel_z1=%d -Dxdim5_advec_mom_kernel_z1=%d", pPath, 32,xdim0,xdim1,xdim2,xdim3,xdim4,xdim5);
      else {
