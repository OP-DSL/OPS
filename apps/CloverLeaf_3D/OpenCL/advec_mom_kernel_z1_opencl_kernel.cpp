...
void buildOpenCLKernels_advec_mom_kernel_z1(int xdim0, int ydim0,
 int xdim1, int ydim1,
 int xdim2, int ydim2,
 int xdim3, int ydim3,
 int xdim4, int ydim4,
 int xdim5, int ydim5) {
  ...
  if(!isbuilt_advec_mom_kernel_z1) {
    ...
    printf("Compiling advec_mom_kernel_z1 source -- start \n");
    ...
    OPS_opencl_core.kernel[12] = clCreateKernel(OPS_opencl_core.program, "ops_advec_mom_kernel_z1", &ret);
    clSafeCall( ret );
...
void ops_par_loop_advec_mom_kernel_z1(char const *name, ops_block Block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5) {
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 6, sizeof(cl_int), (void*) &base0 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 7, sizeof(cl_int), (void*) &base1 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 8, sizeof(cl_int), (void*) &base2 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 9, sizeof(cl_int), (void*) &base3 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 10, sizeof(cl_int), (void*) &base4 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 11, sizeof(cl_int), (void*) &base5 ));
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 14, sizeof(cl_int), (void*) &z_size ));
