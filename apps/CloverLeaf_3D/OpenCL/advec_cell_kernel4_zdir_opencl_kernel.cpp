...
void buildOpenCLKernels_advec_cell_kernel4_zdir(int xdim0,
 int xdim1,
 int xdim2,
 int xdim3,
 int xdim4,
 ...
 int xdim10) {
  ...
  if(!isbuilt_advec_cell_kernel4_zdir) {
    ...
    printf("Compiling advec_cell_kernel4_zdir source -- start \n");
      ...
      if (pPath!=NULL)
        sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_advec_cell_kernel4_zdir=%d -Dxdim1_advec_cell_kernel4_zdir=%d -Dxdim2_advec_cell_kernel4_zdir=%d -Dxdim3_advec_cell_kernel4_zdir=%d -Dxdim4_advec_cell_kernel4_zdir=%d -Dxdim5_advec_cell_kernel4_zdir=%d -Dxdim6_advec_cell_kernel4_zdir=%d -Dxdim7_advec_cell_kernel4_zdir=%d -Dxdim8_advec_cell_kernel4_zdir=%d -Dxdim9_advec_cell_kernel4_zdir=%d -Dxdim10_advec_cell_kernel4_zdir=%d", pPath, 32,xdim0,xdim1,xdim2,xdim3,xdim4,xdim5,xdim6,xdim7,xdim8,xdim9,xdim10);
      else {
