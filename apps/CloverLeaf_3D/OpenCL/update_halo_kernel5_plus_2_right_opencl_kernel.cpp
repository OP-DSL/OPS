...
void buildOpenCLKernels_update_halo_kernel5_plus_2_right(int xdim0,
 int xdim1) {
  ...
  if(!isbuilt_update_halo_kernel5_plus_2_right) {
    ...
    printf("Compiling update_halo_kernel5_plus_2_right source -- start \n");
      ...
      if (pPath!=NULL)
        sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_update_halo_kernel5_plus_2_right=%d -Dxdim1_update_halo_kernel5_plus_2_right=%d", pPath, 32,xdim0,xdim1);
      else {
