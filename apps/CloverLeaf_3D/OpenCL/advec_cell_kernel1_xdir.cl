...
const int size2 ){
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    advec_cell_kernel1_xdir(&arg0[base0 + idx_x * 1*1 + idx_y * 1*1 * xdim0_advec_cell_kernel1_xdir + idx_z * 1*1 * xdim0_advec_cell_kernel1_xdir * ydim0_advec_cell_kernel1_xdir],
                      &arg1[base1 + idx_x * 1*1 + idx_y * 1*1 * xdim1_advec_cell_kernel1_xdir + idx_z * 1*1 * xdim1_advec_cell_kernel1_xdir * ydim1_advec_cell_kernel1_xdir],
                      &arg2[base2 + idx_x * 1*1 + idx_y * 1*1 * xdim2_advec_cell_kernel1_xdir + idx_z * 1*1 * xdim2_advec_cell_kernel1_xdir * ydim2_advec_cell_kernel1_xdir],
                      &arg3[base3 + idx_x * 1*1 + idx_y * 1*1 * xdim3_advec_cell_kernel1_xdir + idx_z * 1*1 * xdim3_advec_cell_kernel1_xdir * ydim3_advec_cell_kernel1_xdir],
                      &arg4[base4 + idx_x * 1*1 + idx_y * 1*1 * xdim4_advec_cell_kernel1_xdir + idx_z * 1*1 * xdim4_advec_cell_kernel1_xdir * ydim4_advec_cell_kernel1_xdir],
                      &arg5[base5 + idx_x * 1*1 + idx_y * 1*1 * xdim5_advec_cell_kernel1_xdir + idx_z * 1*1 * xdim5_advec_cell_kernel1_xdir * ydim5_advec_cell_kernel1_xdir]);
  }
