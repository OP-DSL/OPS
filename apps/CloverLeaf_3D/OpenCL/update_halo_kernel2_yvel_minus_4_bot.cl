 ...
 
{
 ...
 const int size2 ){
   ...
   if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
     update_halo_kernel2_yvel_minus_4_bot(&arg0[base0 + idx_x * 1 + idx_y * 1 * xdim0_update_halo_kernel2_yvel_minus_4_bot],
                        &arg1[base1 + idx_x * 1 + idx_y * 1 * xdim1_update_halo_kernel2_yvel_minus_4_bot],
                        arg2);
   }
