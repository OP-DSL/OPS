...
const __global int* restrict  fields)
 ...
 const int size2 ){
   ...
   if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
     update_halo_kernel1_ba1(&arg0[base0 + idx_x * 1 + idx_y * 1 * xdim0_update_halo_kernel1_ba1 + idx_z * 1 * xdim0_update_halo_kernel1_ba1 * ydim0_update_halo_kernel1_ba1],
                        &arg1[base1 + idx_x * 1 + idx_y * 1 * xdim1_update_halo_kernel1_ba1 + idx_z * 1 * xdim1_update_halo_kernel1_ba1 * ydim1_update_halo_kernel1_ba1],
                        &arg2[base2 + idx_x * 1 + idx_y * 1 * xdim2_update_halo_kernel1_ba1 + idx_z * 1 * xdim2_update_halo_kernel1_ba1 * ydim2_update_halo_kernel1_ba1],
                        &arg3[base3 + idx_x * 1 + idx_y * 1 * xdim3_update_halo_kernel1_ba1 + idx_z * 1 * xdim3_update_halo_kernel1_ba1 * ydim3_update_halo_kernel1_ba1],
                        &arg4[base4 + idx_x * 1 + idx_y * 1 * xdim4_update_halo_kernel1_ba1 + idx_z * 1 * xdim4_update_halo_kernel1_ba1 * ydim4_update_halo_kernel1_ba1],
                        &arg5[base5 + idx_x * 1 + idx_y * 1 * xdim5_update_halo_kernel1_ba1 + idx_z * 1 * xdim5_update_halo_kernel1_ba1 * ydim5_update_halo_kernel1_ba1],
                        &arg6[base6 + idx_x * 1 + idx_y * 1 * xdim6_update_halo_kernel1_ba1 + idx_z * 1 * xdim6_update_halo_kernel1_ba1 * ydim6_update_halo_kernel1_ba1],
                        arg7);
   }
