 ...
 int xdim4) {
  ...
  if(!isbuilt_calc_dt_kernel_get) {
    ...
    printf("Compiling calc_dt_kernel_get source -- start \n");
      ...
      if (pPath!=NULL)
        sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_calc_dt_kernel_get=%d -Dxdim1_calc_dt_kernel_get=%d -Dxdim4_calc_dt_kernel_get=%d", pPath, 32,xdim0,xdim1,xdim4);
      else {
