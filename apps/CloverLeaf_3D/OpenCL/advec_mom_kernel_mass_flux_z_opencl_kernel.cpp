...
void buildOpenCLKernels_advec_mom_kernel_mass_flux_z(int xdim0, int ydim0,
 int xdim1, int ydim1) {
  ...
  if(!isbuilt_advec_mom_kernel_mass_flux_z) {
    ...
    printf("Compiling advec_mom_kernel_mass_flux_z %d source -- start \n",OCL_FMA);
      ...
      if (pPath!=NULL)
        if(OCL_FMA)
          sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA=1 -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_advec_mom_kernel_mass_flux_z=%d -Dydim0_advec_mom_kernel_mass_flux_z=%d -Dxdim1_advec_mom_kernel_mass_flux_z=%d -Dydim1_advec_mom_kernel_mass_flux_z=%d", pPath, 32,xdim0, ydim0,xdim1, ydim1);
        else
          sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA=0 -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_advec_mom_kernel_mass_flux_z=%d -Dydim0_advec_mom_kernel_mass_flux_z=%d -Dxdim1_advec_mom_kernel_mass_flux_z=%d -Dydim1_advec_mom_kernel_mass_flux_z=%d", pPath, 32,xdim0, ydim0,xdim1, ydim1);
      else {
