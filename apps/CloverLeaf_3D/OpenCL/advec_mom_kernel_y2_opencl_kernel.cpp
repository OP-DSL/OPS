 ...
 int xdim4) {
  ...
  if(!isbuilt_advec_mom_kernel_y2) {
    ...
    printf("Compiling advec_mom_kernel_y2 source -- start \n");
      ...
      if (pPath!=NULL)
        sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_advec_mom_kernel_y2=%d -Dxdim1_advec_mom_kernel_y2=%d -Dxdim2_advec_mom_kernel_y2=%d -Dxdim3_advec_mom_kernel_y2=%d -Dxdim4_advec_mom_kernel_y2=%d", pPath, 32,xdim0,xdim1,xdim2,xdim3,xdim4);
      else {
