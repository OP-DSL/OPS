...
inline void advec_mom_kernel_mass_flux_z( __global double * restrict node_flux, const __global double * restrict mass_flux_z)
 ...
 const int size2 ){
   ...
   if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
     advec_mom_kernel_mass_flux_z(&arg0[base0 + idx_x * 1 + idx_y * 1 * xdim0_advec_mom_kernel_mass_flux_z],
                      &arg1[base1 + idx_x * 1 + idx_y * 1 * xdim1_advec_mom_kernel_mass_flux_z]);
   }
