 ...
 int xdim1, int ydim1) {
  ...
  if(!isbuilt_update_halo_kernel2_yvel_plus_4_right) {
    ...
    printf("Compiling update_halo_kernel2_yvel_plus_4_right %d source -- start \n",OCL_FMA);
      ...
      if (pPath!=NULL)
        if(OCL_FMA)
          sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA=1 -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_update_halo_kernel2_yvel_plus_4_right=%d -Dydim0_update_halo_kernel2_yvel_plus_4_right=%d -Dxdim1_update_halo_kernel2_yvel_plus_4_right=%d -Dydim1_update_halo_kernel2_yvel_plus_4_right=%d", pPath, 32,xdim0, ydim0,xdim1, ydim1);
        else
          sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA=0 -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_update_halo_kernel2_yvel_plus_4_right=%d -Dydim0_update_halo_kernel2_yvel_plus_4_right=%d -Dxdim1_update_halo_kernel2_yvel_plus_4_right=%d -Dydim1_update_halo_kernel2_yvel_plus_4_right=%d", pPath, 32,xdim0, ydim0,xdim1, ydim1);
      else {
    ...
    OPS_opencl_core.kernel[71] = clCreateKernel(OPS_opencl_core.program, "ops_update_halo_kernel2_yvel_plus_4_right", &ret);
    clSafeCall( ret );
