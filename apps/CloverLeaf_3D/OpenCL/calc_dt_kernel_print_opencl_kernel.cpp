 ...
 int xdim6) {
  ...
  if(!isbuilt_calc_dt_kernel_print) {
    ...
    printf("Compiling calc_dt_kernel_print source -- start \n");
      ...
      if (pPath!=NULL)
        sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_calc_dt_kernel_print=%d -Dxdim1_calc_dt_kernel_print=%d -Dxdim2_calc_dt_kernel_print=%d -Dxdim3_calc_dt_kernel_print=%d -Dxdim4_calc_dt_kernel_print=%d -Dxdim5_calc_dt_kernel_print=%d -Dxdim6_calc_dt_kernel_print=%d", pPath, 32,xdim0,xdim1,xdim2,xdim3,xdim4,xdim5,xdim6);
      else {
