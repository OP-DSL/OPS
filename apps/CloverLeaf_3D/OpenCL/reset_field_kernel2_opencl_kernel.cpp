 ...
 int xdim5) {
  ...
  if(!isbuilt_reset_field_kernel2) {
    ...
    printf("Compiling reset_field_kernel2 source -- start \n");
      ...
      if (pPath!=NULL)
        sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_reset_field_kernel2=%d -Dxdim1_reset_field_kernel2=%d -Dxdim2_reset_field_kernel2=%d -Dxdim3_reset_field_kernel2=%d -Dxdim4_reset_field_kernel2=%d -Dxdim5_reset_field_kernel2=%d", pPath, 32,xdim0,xdim1,xdim2,xdim3,xdim4,xdim5);
      else {
