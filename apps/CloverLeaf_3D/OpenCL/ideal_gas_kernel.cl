...
__global double * restrict soundspeed)
 ...
 const int size2 ){
   ...
   if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
     ideal_gas_kernel(&arg0[base0 + idx_x * 1 + idx_y * 1 * xdim0_ideal_gas_kernel + idx_z * 1 * xdim0_ideal_gas_kernel * ydim0_ideal_gas_kernel],
                      &arg1[base1 + idx_x * 1 + idx_y * 1 * xdim1_ideal_gas_kernel + idx_z * 1 * xdim1_ideal_gas_kernel * ydim1_ideal_gas_kernel],
                      &arg2[base2 + idx_x * 1 + idx_y * 1 * xdim2_ideal_gas_kernel + idx_z * 1 * xdim2_ideal_gas_kernel * ydim2_ideal_gas_kernel],
                      &arg3[base3 + idx_x * 1 + idx_y * 1 * xdim3_ideal_gas_kernel + idx_z * 1 * xdim3_ideal_gas_kernel * ydim3_ideal_gas_kernel]);
   }
