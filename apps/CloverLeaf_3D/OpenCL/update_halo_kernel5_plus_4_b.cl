...
inline void update_halo_kernel5_plus_4_b(__global double * restrict vol_flux_z, __global double * restrict mass_flux_z, const __global int* restrict  fields)
 ...
 const int size2 ){
   ...
   if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
     update_halo_kernel5_plus_4_b(&arg0[base0 + idx_x * 1 + idx_y * 1 * xdim0_update_halo_kernel5_plus_4_b],
                        &arg1[base1 + idx_x * 1 + idx_y * 1 * xdim1_update_halo_kernel5_plus_4_b],
                        arg2);
   }
