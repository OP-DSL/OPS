...
const int size2 ){
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    advec_cell_kernel2_xdir(&arg0[base0 + idx_x * 1*1 + idx_y * 1*1 * xdim0_advec_cell_kernel2_xdir + idx_z * 1*1 * xdim0_advec_cell_kernel2_xdir * ydim0_advec_cell_kernel2_xdir],
                      &arg1[base1 + idx_x * 1*1 + idx_y * 1*1 * xdim1_advec_cell_kernel2_xdir + idx_z * 1*1 * xdim1_advec_cell_kernel2_xdir * ydim1_advec_cell_kernel2_xdir],
                      &arg2[base2 + idx_x * 1*1 + idx_y * 1*1 * xdim2_advec_cell_kernel2_xdir + idx_z * 1*1 * xdim2_advec_cell_kernel2_xdir * ydim2_advec_cell_kernel2_xdir],
                      &arg3[base3 + idx_x * 1*1 + idx_y * 1*1 * xdim3_advec_cell_kernel2_xdir + idx_z * 1*1 * xdim3_advec_cell_kernel2_xdir * ydim3_advec_cell_kernel2_xdir]);
  }
