...
void buildOpenCLKernels_advec_cell_kernel1_ydir(int xdim0, int ydim0,
 int xdim1, int ydim1,
 int xdim2, int ydim2,
 int xdim3, int ydim3,
 int xdim4, int ydim4) {
  ...
  if(!isbuilt_advec_cell_kernel1_ydir) {
    ...
    OPS_opencl_core.kernel[33] = clCreateKernel(OPS_opencl_core.program, "ops_advec_cell_kernel1_ydir", &ret);
    clSafeCall( ret );
...
void ops_par_loop_advec_cell_kernel1_ydir(char const *name, ops_block Block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[33], 9, sizeof(cl_int), (void*) &base4 ));
