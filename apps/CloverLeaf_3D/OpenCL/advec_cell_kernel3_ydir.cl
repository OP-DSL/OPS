 ...
 const int size2 ){
   ...
   if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
     advec_cell_kernel3_ydir(&arg0[base0 + idx_x * 1 + idx_y * 1 * xdim0_advec_cell_kernel3_ydir+ idx_z * 1 * xdim0_advec_cell_kernel3_ydir * ydim0_advec_cell_kernel3_ydir],
                       ...
                       &arg2[base2 + idx_x * 1 + idx_y * 1 * xdim2_advec_cell_kernel3_ydir+ idx_z * 0 * xdim2_advec_cell_kernel3_ydir * ydim2_advec_cell_kernel3_ydir],
                       ...
                       &arg4[base4 + idx_x * 0 + idx_y * 0 * xdim4_advec_cell_kernel3_ydir+ idx_z * 1 * xdim4_advec_cell_kernel3_ydir * ydim4_advec_cell_kernel3_ydir],
                       &arg5[base5 + idx_x * 1 + idx_y * 0 * xdim5_advec_cell_kernel3_ydir+ idx_z * 1 * xdim5_advec_cell_kernel3_ydir * ydim5_advec_cell_kernel3_ydir],
