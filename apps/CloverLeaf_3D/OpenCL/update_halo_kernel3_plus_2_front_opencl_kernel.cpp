...
void buildOpenCLKernels_update_halo_kernel3_plus_2_front(int xdim0,
 int xdim1) {
  ...
  if(!isbuilt_update_halo_kernel3_plus_2_front) {
    ...
    printf("Compiling update_halo_kernel3_plus_2_front source -- start \n");
      ...
      if (pPath!=NULL)
        sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_update_halo_kernel3_plus_2_front=%d -Dxdim1_update_halo_kernel3_plus_2_front=%d", pPath, 32,xdim0,xdim1);
      else {
