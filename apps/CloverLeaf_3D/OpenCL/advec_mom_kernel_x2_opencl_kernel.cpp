...
void buildOpenCLKernels_advec_mom_kernel_x2(int xdim0, int ydim0,
 int xdim1, int ydim1,
 int xdim2, int ydim2,
 int xdim3, int ydim3,
 int xdim4, int ydim4) {
  ...
  if(!isbuilt_advec_mom_kernel_x2) {
    ...
    OPS_opencl_core.kernel[13] = clCreateKernel(OPS_opencl_core.program, "ops_advec_mom_kernel_x2", &ret);
    clSafeCall( ret );
