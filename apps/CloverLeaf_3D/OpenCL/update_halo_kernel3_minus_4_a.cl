...
//user function
inline void update_halo_kernel3_minus_4_a(__global double * restrict vol_flux_x, __global double * restrict mass_flux_x)
 ...
 const int size2 ){
   ...
   if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
     update_halo_kernel3_minus_4_a(&arg0[base0 + idx_x * 1 + idx_y * 1 * xdim0_update_halo_kernel3_minus_4_a + idx_z * 1 * xdim0_update_halo_kernel3_minus_4_a * ydim0_update_halo_kernel3_minus_4_a],
                        &arg1[base1 + idx_x * 1 + idx_y * 1 * xdim1_update_halo_kernel3_minus_4_a + idx_z * 1 * xdim1_update_halo_kernel3_minus_4_a * ydim1_update_halo_kernel3_minus_4_a],
                        arg2);
   }
