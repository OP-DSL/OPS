...
void buildOpenCLKernels_update_halo_kernel2_yvel_plus_2_left(int xdim0,
 int xdim1) {
  ...
  if(!isbuilt_update_halo_kernel2_yvel_plus_2_left) {
    ...
    printf("Compiling update_halo_kernel2_yvel_plus_2_left source -- start \n");
      ...
      if (pPath!=NULL)
        sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_update_halo_kernel2_yvel_plus_2_left=%d -Dxdim1_update_halo_kernel2_yvel_plus_2_left=%d", pPath, 32,xdim0,xdim1);
      else {
