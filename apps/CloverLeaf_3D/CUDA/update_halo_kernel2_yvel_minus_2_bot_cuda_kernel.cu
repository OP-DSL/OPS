...
int size2 ){
  ...
  arg0 += idx_x * 1 + idx_y * 1 * xdim0_update_halo_kernel2_yvel_minus_2_bot + idx_z * 1 * xdim0_update_halo_kernel2_yvel_minus_2_bot * ydim0_update_halo_kernel2_yvel_minus_2_bot;
  arg1 += idx_x * 1 + idx_y * 1 * xdim1_update_halo_kernel2_yvel_minus_2_bot + idx_z * 1 * xdim1_update_halo_kernel2_yvel_minus_2_bot * ydim1_update_halo_kernel2_yvel_minus_2_bot;

  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    update_halo_kernel2_yvel_minus_2_bot(arg0, arg1, arg2);
  }
...
void ops_par_loop_update_halo_kernel2_yvel_minus_2_bot(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  //Timing
  double t1,t2,c1,c2;
  ops_timing_realloc(79,"update_halo_kernel2_yvel_minus_2_bot");
  ...
  ops_update_halo_kernel2_yvel_minus_2_bot<<<grid, block >>> (  (double *)p_a[0], (double *)p_a[1],
