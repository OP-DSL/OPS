...
int size2 ){
  ...
  arg0 += idx_x * 1 + idx_y * 1 * xdim0_update_halo_kernel5_plus_4_left + idx_z * 1 * xdim0_update_halo_kernel5_plus_4_left * ydim0_update_halo_kernel5_plus_4_left;
  arg1 += idx_x * 1 + idx_y * 1 * xdim1_update_halo_kernel5_plus_4_left + idx_z * 1 * xdim1_update_halo_kernel5_plus_4_left * ydim1_update_halo_kernel5_plus_4_left;
...
void ops_par_loop_update_halo_kernel5_plus_4_left(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  ops_update_halo_kernel5_plus_4_left<<<grid, block >>> (  (double *)p_a[0], (double *)p_a[1],
