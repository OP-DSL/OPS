...
int size2 ){
  ...
  arg0 += idx_x * 1 + idx_y * 1 * xdim0_update_halo_kernel4_plus_4_b + idx_z * 1 * xdim0_update_halo_kernel4_plus_4_b * ydim0_update_halo_kernel4_plus_4_b;
  arg1 += idx_x * 1 + idx_y * 1 * xdim1_update_halo_kernel4_plus_4_b + idx_z * 1 * xdim1_update_halo_kernel4_plus_4_b * ydim1_update_halo_kernel4_plus_4_b;
