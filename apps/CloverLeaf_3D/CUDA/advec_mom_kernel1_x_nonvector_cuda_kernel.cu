...
int size2 ){
  ...
  arg0 += idx_x * 1 + idx_y * 1 * xdim0_advec_mom_kernel1_x_nonvector + idx_z * 1 * xdim0_advec_mom_kernel1_x_nonvector * ydim0_advec_mom_kernel1_x_nonvector;
  arg1 += idx_x * 1 + idx_y * 1 * xdim1_advec_mom_kernel1_x_nonvector + idx_z * 1 * xdim1_advec_mom_kernel1_x_nonvector * ydim1_advec_mom_kernel1_x_nonvector;
  arg2 += idx_x * 1 + idx_y * 1 * xdim2_advec_mom_kernel1_x_nonvector + idx_z * 1 * xdim2_advec_mom_kernel1_x_nonvector * ydim2_advec_mom_kernel1_x_nonvector;
  arg3 += idx_x * 1 + idx_y * 0 * xdim3_advec_mom_kernel1_x_nonvector + idx_z * 0 * xdim3_advec_mom_kernel1_x_nonvector * ydim3_advec_mom_kernel1_x_nonvector;
  arg4 += idx_x * 1 + idx_y * 1 * xdim4_advec_mom_kernel1_x_nonvector + idx_z * 1 * xdim4_advec_mom_kernel1_x_nonvector * ydim4_advec_mom_kernel1_x_nonvector;
