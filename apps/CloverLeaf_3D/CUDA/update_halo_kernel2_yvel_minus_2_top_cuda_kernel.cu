...
int size2 ){
  ...
  arg0 += idx_x * 1 + idx_y * 1 * xdim0_update_halo_kernel2_yvel_minus_2_top + idx_z * 1 * xdim0_update_halo_kernel2_yvel_minus_2_top * ydim0_update_halo_kernel2_yvel_minus_2_top;
  arg1 += idx_x * 1 + idx_y * 1 * xdim1_update_halo_kernel2_yvel_minus_2_top + idx_z * 1 * xdim1_update_halo_kernel2_yvel_minus_2_top * ydim1_update_halo_kernel2_yvel_minus_2_top;
...
void ops_par_loop_update_halo_kernel2_yvel_minus_2_top(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  //Timing
  double t1,t2,c1,c2;
  ops_timing_realloc(81,"update_halo_kernel2_yvel_minus_2_top");
  ...
  ops_update_halo_kernel2_yvel_minus_2_top<<<grid, block >>> (  (double *)p_a[0], (double *)p_a[1],
