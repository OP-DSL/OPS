...
int size2 ){
  ...
  arg0 += idx_x * 1 + idx_y * 1 * xdim0_update_halo_kernel5_plus_2_right + idx_z * 1 * xdim0_update_halo_kernel5_plus_2_right * ydim0_update_halo_kernel5_plus_2_right;
  arg1 += idx_x * 1 + idx_y * 1 * xdim1_update_halo_kernel5_plus_2_right + idx_z * 1 * xdim1_update_halo_kernel5_plus_2_right * ydim1_update_halo_kernel5_plus_2_right;

  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    update_halo_kernel5_plus_2_right(arg0, arg1, arg2);
  }
...
void ops_par_loop_update_halo_kernel5_plus_2_right(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  ops_update_halo_kernel5_plus_2_right<<<grid, block >>> (  (double *)p_a[0], (double *)p_a[1],
