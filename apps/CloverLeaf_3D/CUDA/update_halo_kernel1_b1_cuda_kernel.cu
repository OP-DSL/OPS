...
int size2 ){
  ...
  arg0 += idx_x * 1 + idx_y * 1 * xdim0_update_halo_kernel1_b1 + idx_z * 1 * xdim0_update_halo_kernel1_b1 * ydim0_update_halo_kernel1_b1;
  arg1 += idx_x * 1 + idx_y * 1 * xdim1_update_halo_kernel1_b1 + idx_z * 1 * xdim1_update_halo_kernel1_b1 * ydim1_update_halo_kernel1_b1;
  arg2 += idx_x * 1 + idx_y * 1 * xdim2_update_halo_kernel1_b1 + idx_z * 1 * xdim2_update_halo_kernel1_b1 * ydim2_update_halo_kernel1_b1;
  arg3 += idx_x * 1 + idx_y * 1 * xdim3_update_halo_kernel1_b1 + idx_z * 1 * xdim3_update_halo_kernel1_b1 * ydim3_update_halo_kernel1_b1;
  arg4 += idx_x * 1 + idx_y * 1 * xdim4_update_halo_kernel1_b1 + idx_z * 1 * xdim4_update_halo_kernel1_b1 * ydim4_update_halo_kernel1_b1;
  arg5 += idx_x * 1 + idx_y * 1 * xdim5_update_halo_kernel1_b1 + idx_z * 1 * xdim5_update_halo_kernel1_b1 * ydim5_update_halo_kernel1_b1;
  arg6 += idx_x * 1 + idx_y * 1 * xdim6_update_halo_kernel1_b1 + idx_z * 1 * xdim6_update_halo_kernel1_b1 * ydim6_update_halo_kernel1_b1;
