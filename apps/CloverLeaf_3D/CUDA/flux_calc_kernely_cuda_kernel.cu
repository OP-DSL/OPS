...
int size2 ){
  ...
  arg0 += idx_x * 1 + idx_y * 1 * xdim0_flux_calc_kernely + idx_z * 1 * xdim0_flux_calc_kernely * ydim0_flux_calc_kernely;
  arg1 += idx_x * 1 + idx_y * 1 * xdim1_flux_calc_kernely + idx_z * 1 * xdim1_flux_calc_kernely * ydim1_flux_calc_kernely;
  arg2 += idx_x * 1 + idx_y * 1 * xdim2_flux_calc_kernely + idx_z * 1 * xdim2_flux_calc_kernely * ydim2_flux_calc_kernely;
  arg3 += idx_x * 1 + idx_y * 1 * xdim3_flux_calc_kernely + idx_z * 1 * xdim3_flux_calc_kernely * ydim3_flux_calc_kernely;
