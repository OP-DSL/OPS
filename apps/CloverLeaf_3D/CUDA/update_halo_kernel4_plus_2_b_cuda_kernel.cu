...
int size2 ){
  ...
  arg0 += idx_x * 1 + idx_y * 1 * xdim0_update_halo_kernel4_plus_2_b + idx_z * 1 * xdim0_update_halo_kernel4_plus_2_b * ydim0_update_halo_kernel4_plus_2_b;
  arg1 += idx_x * 1 + idx_y * 1 * xdim1_update_halo_kernel4_plus_2_b + idx_z * 1 * xdim1_update_halo_kernel4_plus_2_b * ydim1_update_halo_kernel4_plus_2_b;
...
void ops_par_loop_update_halo_kernel4_plus_2_b(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  //Timing
  double t1,t2,c1,c2;
  ops_timing_realloc(121,"update_halo_kernel4_plus_2_b");
