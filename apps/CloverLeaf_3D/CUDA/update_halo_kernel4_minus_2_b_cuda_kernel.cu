...
int size2 ){
  ...
  arg0 += idx_x * 1 + idx_y * 1 * xdim0_update_halo_kernel4_minus_2_b + idx_z * 1 * xdim0_update_halo_kernel4_minus_2_b * ydim0_update_halo_kernel4_minus_2_b;
  arg1 += idx_x * 1 + idx_y * 1 * xdim1_update_halo_kernel4_minus_2_b + idx_z * 1 * xdim1_update_halo_kernel4_minus_2_b * ydim1_update_halo_kernel4_minus_2_b;
