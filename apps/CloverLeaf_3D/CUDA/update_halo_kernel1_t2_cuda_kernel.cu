...
int size2 ){
  ...
  arg0 += idx_x * 1 + idx_y * 1 * xdim0_update_halo_kernel1_t2 + idx_z * 1 * xdim0_update_halo_kernel1_t2 * ydim0_update_halo_kernel1_t2;
  arg1 += idx_x * 1 + idx_y * 1 * xdim1_update_halo_kernel1_t2 + idx_z * 1 * xdim1_update_halo_kernel1_t2 * ydim1_update_halo_kernel1_t2;
  arg2 += idx_x * 1 + idx_y * 1 * xdim2_update_halo_kernel1_t2 + idx_z * 1 * xdim2_update_halo_kernel1_t2 * ydim2_update_halo_kernel1_t2;
  arg3 += idx_x * 1 + idx_y * 1 * xdim3_update_halo_kernel1_t2 + idx_z * 1 * xdim3_update_halo_kernel1_t2 * ydim3_update_halo_kernel1_t2;
  arg4 += idx_x * 1 + idx_y * 1 * xdim4_update_halo_kernel1_t2 + idx_z * 1 * xdim4_update_halo_kernel1_t2 * ydim4_update_halo_kernel1_t2;
  arg5 += idx_x * 1 + idx_y * 1 * xdim5_update_halo_kernel1_t2 + idx_z * 1 * xdim5_update_halo_kernel1_t2 * ydim5_update_halo_kernel1_t2;
  arg6 += idx_x * 1 + idx_y * 1 * xdim6_update_halo_kernel1_t2 + idx_z * 1 * xdim6_update_halo_kernel1_t2 * ydim6_update_halo_kernel1_t2;
...
void ops_par_loop_update_halo_kernel1_t2(char const *name, ops_block Block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6, ops_arg arg7) {
  ...
  //Timing
  double t1,t2,c1,c2;
  ops_timing_realloc(56,"update_halo_kernel1_t2");
