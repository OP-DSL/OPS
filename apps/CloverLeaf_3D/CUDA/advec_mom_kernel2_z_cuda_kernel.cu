...
int size2 ){
  ...
  arg0 += idx_x * 1 + idx_y * 1 * xdim0_advec_mom_kernel2_z + idx_z * 1 * xdim0_advec_mom_kernel2_z * ydim0_advec_mom_kernel2_z;
  arg1 += idx_x * 1 + idx_y * 1 * xdim1_advec_mom_kernel2_z + idx_z * 1 * xdim1_advec_mom_kernel2_z * ydim1_advec_mom_kernel2_z;
  arg2 += idx_x * 1 + idx_y * 1 * xdim2_advec_mom_kernel2_z + idx_z * 1 * xdim2_advec_mom_kernel2_z * ydim2_advec_mom_kernel2_z;
  arg3 += idx_x * 1 + idx_y * 1 * xdim3_advec_mom_kernel2_z + idx_z * 1 * xdim3_advec_mom_kernel2_z * ydim3_advec_mom_kernel2_z;
...
void ops_par_loop_advec_mom_kernel2_z(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3) {
  ...
  ops_advec_mom_kernel2_z<<<grid, block >>> (  (double *)p_a[0], (double *)p_a[1],
