...
int size2 ){
  ...
  arg0 += idx_x * 1 + idx_y * 1 * xdim0_revert_kernel + idx_z * 1 * xdim0_revert_kernel * ydim0_revert_kernel;
  arg1 += idx_x * 1 + idx_y * 1 * xdim1_revert_kernel + idx_z * 1 * xdim1_revert_kernel * ydim1_revert_kernel;
  arg2 += idx_x * 1 + idx_y * 1 * xdim2_revert_kernel + idx_z * 1 * xdim2_revert_kernel * ydim2_revert_kernel;
  arg3 += idx_x * 1 + idx_y * 1 * xdim3_revert_kernel + idx_z * 1 * xdim3_revert_kernel * ydim3_revert_kernel;
