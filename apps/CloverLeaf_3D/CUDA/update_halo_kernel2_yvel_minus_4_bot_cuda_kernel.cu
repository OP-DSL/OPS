...
int size2 ){
  ...
  arg0 += idx_x * 1 + idx_y * 1 * xdim0_update_halo_kernel2_yvel_minus_4_bot + idx_z * 1 * xdim0_update_halo_kernel2_yvel_minus_4_bot * ydim0_update_halo_kernel2_yvel_minus_4_bot;
  arg1 += idx_x * 1 + idx_y * 1 * xdim1_update_halo_kernel2_yvel_minus_4_bot + idx_z * 1 * xdim1_update_halo_kernel2_yvel_minus_4_bot * ydim1_update_halo_kernel2_yvel_minus_4_bot;
