...
int size2 ){
  ...
  arg0 += idx_x * 1 + idx_y * 1 * xdim0_update_halo_kernel2_zvel_plus_2_top + idx_z * 1 * xdim0_update_halo_kernel2_zvel_plus_2_top * ydim0_update_halo_kernel2_zvel_plus_2_top;
  arg1 += idx_x * 1 + idx_y * 1 * xdim1_update_halo_kernel2_zvel_plus_2_top + idx_z * 1 * xdim1_update_halo_kernel2_zvel_plus_2_top * ydim1_update_halo_kernel2_zvel_plus_2_top;

  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    update_halo_kernel2_zvel_plus_2_top(arg0, arg1, arg2);
  }
...
void ops_par_loop_update_halo_kernel2_zvel_plus_2_top(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  //Timing
  double t1,t2,c1,c2;
  ops_timing_realloc(93,"update_halo_kernel2_zvel_plus_2_top");
  ops_timers_core(&c2,&t2);

  if (OPS_kernels[93].count == 0) {
  ...
  ops_update_halo_kernel2_zvel_plus_2_top<<<grid, block >>> (  (double *)p_a[0], (double *)p_a[1],
