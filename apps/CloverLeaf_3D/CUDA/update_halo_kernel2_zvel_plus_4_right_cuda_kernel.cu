...
int size2 ){
  ...
  arg0 += idx_x * 1 + idx_y * 1 * xdim0_update_halo_kernel2_zvel_plus_4_right + idx_z * 1 * xdim0_update_halo_kernel2_zvel_plus_4_right * ydim0_update_halo_kernel2_zvel_plus_4_right;
  arg1 += idx_x * 1 + idx_y * 1 * xdim1_update_halo_kernel2_zvel_plus_4_right + idx_z * 1 * xdim1_update_halo_kernel2_zvel_plus_4_right * ydim1_update_halo_kernel2_zvel_plus_4_right;
...
void ops_par_loop_update_halo_kernel2_zvel_plus_4_right(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  //Timing
  double t1,t2,c1,c2;
  ops_timing_realloc(96,"update_halo_kernel2_zvel_plus_4_right");
  ops_timers_core(&c2,&t2);

  if (OPS_kernels[96].count == 0) {
  ...
  ops_update_halo_kernel2_zvel_plus_4_right<<<grid, block >>> (  (double *)p_a[0], (double *)p_a[1],
