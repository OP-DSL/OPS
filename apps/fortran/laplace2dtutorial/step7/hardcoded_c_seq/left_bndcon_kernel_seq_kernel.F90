! Auto-generated at 2024-12-18 11:34:46.000137 by ops-translator
...
SUBROUTINE left_bndcon_kernel_host_c(name, args, nargs, index, dim, range, block) BIND(C,name='left_bndcon_kernel_host_c')
    USE, INTRINSIC :: ISO_C_BINDING
...
SUBROUTINE left_bndcon_kernel_host( userSubroutine, block, dim, range, &
    ...
    CALL left_bndcon_kernel_host_c(namelit//c_null_char, c_loc(opsArgArray), &
                                    2, 2, dim, c_loc(range_tmp), &
                                    block%blockCptr)
