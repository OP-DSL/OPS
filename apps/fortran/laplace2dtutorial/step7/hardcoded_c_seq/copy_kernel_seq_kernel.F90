! Auto-generated at 2024-12-18 11:34:46.368174 by ops-translator
...
SUBROUTINE copy_kernel_host_c(name, args, nargs, index, dim, range, block) BIND(C,name='copy_kernel_host_c')
    USE, INTRINSIC :: ISO_C_BINDING
