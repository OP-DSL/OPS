...
private :: poisson_update, poisson_update_kernel_wrap
...
!host subroutine
subroutine poisson_update_kernel_run( userSubroutine, blockPtr, blockid, dim, range, nargs, opsArgArray)
  IMPLICIT NONE
  ...
  call setKernelTime(3,userSubroutine,0.0_8,0.0_8,0.0_4,0)
