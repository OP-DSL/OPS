...
__constant__ int xdim0_update_halo_kernel_t2;
__constant__ int xdim1_update_halo_kernel_t2;
__constant__ int xdim2_update_halo_kernel_t2;
__constant__ int xdim3_update_halo_kernel_t2;
__constant__ int xdim4_update_halo_kernel_t2;
__constant__ int xdim5_update_halo_kernel_t2;
__constant__ int xdim6_update_halo_kernel_t2;

#define OPS_ACC0(x,y) (x+xdim0_update_halo_kernel_t2*(y))
#define OPS_ACC1(x,y) (x+xdim1_update_halo_kernel_t2*(y))
#define OPS_ACC2(x,y) (x+xdim2_update_halo_kernel_t2*(y))
#define OPS_ACC3(x,y) (x+xdim3_update_halo_kernel_t2*(y))
#define OPS_ACC4(x,y) (x+xdim4_update_halo_kernel_t2*(y))
#define OPS_ACC5(x,y) (x+xdim5_update_halo_kernel_t2*(y))
#define OPS_ACC6(x,y) (x+xdim6_update_halo_kernel_t2*(y))
...
__global__ void ops_update_halo_kernel_t2(
...
int size1 ){
  ...
  arg0 += idx_x * 1 + idx_y * 1 * xdim0_update_halo_kernel_t2;
  arg1 += idx_x * 1 + idx_y * 1 * xdim1_update_halo_kernel_t2;
  arg2 += idx_x * 1 + idx_y * 1 * xdim2_update_halo_kernel_t2;
  arg3 += idx_x * 1 + idx_y * 1 * xdim3_update_halo_kernel_t2;
  arg4 += idx_x * 1 + idx_y * 1 * xdim4_update_halo_kernel_t2;
  arg5 += idx_x * 1 + idx_y * 1 * xdim5_update_halo_kernel_t2;
  arg6 += idx_x * 1 + idx_y * 1 * xdim6_update_halo_kernel_t2;

  if (idx_x < size0 && idx_y < size1) {
    update_halo_kernel_t2(arg0, arg1, arg2, arg3,
                   arg4, arg5, arg6, arg7);
  }
...
// host stub function
void ops_par_loop_update_halo_kernel_t2(char const *name, ops_block Block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6, ops_arg arg7) {
  ...
  //Timing
  double t1,t2,c1,c2;
  ops_timing_realloc(38,"update_halo_kernel_t2");
  ops_timers_core(&c1,&t1);

  if (OPS_kernels[38].count == 0) {
    cudaMemcpyToSymbol( xdim0_update_halo_kernel_t2, &xdim0, sizeof(int) );
    cudaMemcpyToSymbol( xdim1_update_halo_kernel_t2, &xdim1, sizeof(int) );
    cudaMemcpyToSymbol( xdim2_update_halo_kernel_t2, &xdim2, sizeof(int) );
    cudaMemcpyToSymbol( xdim3_update_halo_kernel_t2, &xdim3, sizeof(int) );
    cudaMemcpyToSymbol( xdim4_update_halo_kernel_t2, &xdim4, sizeof(int) );
    cudaMemcpyToSymbol( xdim5_update_halo_kernel_t2, &xdim5, sizeof(int) );
    cudaMemcpyToSymbol( xdim6_update_halo_kernel_t2, &xdim6, sizeof(int) );
  }
  ...
  ops_update_halo_kernel_t2<<<grid, block >>> (  (double *)p_a[0], (double *)p_a[1],
