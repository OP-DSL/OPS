...
void ops_par_loop_initialise_chunk_kernel_cellx(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  //Timing
  double t1,t2,c1,c2;
  ops_timing_realloc(73,"initialise_chunk_kernel_cellx");
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[73], 5, sizeof(cl_int), (void*) &xdim0 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[73], 6, sizeof(cl_int), (void*) &xdim1 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[73], 7, sizeof(cl_int), (void*) &xdim2 ));
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[73], 10, sizeof(cl_int), (void*) &base2 ));
