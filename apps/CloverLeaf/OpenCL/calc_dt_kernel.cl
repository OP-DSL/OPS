...
const __global double * restrict volume, const __global double * restrict yvel0, const __global double * restrict yarea, __global double * restrict dt_min, 
  ...
  const int xdim0_calc_dt_kernel,
const int xdim1_calc_dt_kernel,
const int xdim2_calc_dt_kernel,
const int xdim3_calc_dt_kernel,
const int xdim4_calc_dt_kernel,
const int xdim5_calc_dt_kernel,
const int xdim6_calc_dt_kernel,
const int xdim7_calc_dt_kernel,
const int xdim8_calc_dt_kernel,
const int xdim9_calc_dt_kernel,
const int xdim10_calc_dt_kernel)
