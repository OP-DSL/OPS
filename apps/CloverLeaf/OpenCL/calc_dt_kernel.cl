...
void calc_dt_kernel( __global double *celldx,  __global double *celldy,  __global double *soundspeed,
                     __global double *viscosity,  __global double *density0,  __global double *xvel0,
                     __global double *xarea,  __global double *volume,  __global double *yvel0,
                     __global double *yarea, __global double *dt_min ,
  double g_small,
  double g_big,
  double dtc_safe,
  double dtu_safe,
