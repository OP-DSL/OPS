...
void ops_par_loop_calc_dt_kernel(char const *name, ops_block Block, int dim, int* range,
 ...
 ops_arg arg9, ops_arg arg10) {
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[71], 11, sizeof(cl_mem), (void*) &OPS_opencl_core.constant[0]) );
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[71], 12, sizeof(cl_mem), (void*) &OPS_opencl_core.constant[1]) );
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[71], 13, sizeof(cl_mem), (void*) &OPS_opencl_core.constant[2]) );
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[71], 14, sizeof(cl_mem), (void*) &OPS_opencl_core.constant[3]) );
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[71], 15, sizeof(cl_mem), (void*) &OPS_opencl_core.constant[4]) );
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[71], 16, sizeof(cl_mem), (void*) &OPS_opencl_core.constant[5]) );
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[71], 17, sizeof(cl_int), (void*) &xdim0 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[71], 18, sizeof(cl_int), (void*) &xdim1 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[71], 19, sizeof(cl_int), (void*) &xdim2 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[71], 20, sizeof(cl_int), (void*) &xdim3 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[71], 21, sizeof(cl_int), (void*) &xdim4 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[71], 22, sizeof(cl_int), (void*) &xdim5 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[71], 23, sizeof(cl_int), (void*) &xdim6 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[71], 24, sizeof(cl_int), (void*) &xdim7 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[71], 25, sizeof(cl_int), (void*) &xdim8 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[71], 26, sizeof(cl_int), (void*) &xdim9 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[71], 27, sizeof(cl_int), (void*) &xdim10 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[71], 28, sizeof(cl_int), (void*) &base0 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[71], 29, sizeof(cl_int), (void*) &base1 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[71], 30, sizeof(cl_int), (void*) &base2 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[71], 31, sizeof(cl_int), (void*) &base3 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[71], 32, sizeof(cl_int), (void*) &base4 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[71], 33, sizeof(cl_int), (void*) &base5 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[71], 34, sizeof(cl_int), (void*) &base6 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[71], 35, sizeof(cl_int), (void*) &base7 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[71], 36, sizeof(cl_int), (void*) &base8 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[71], 37, sizeof(cl_int), (void*) &base9 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[71], 38, sizeof(cl_int), (void*) &base10 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[71], 39, sizeof(cl_int), (void*) &x_size ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[71], 40, sizeof(cl_int), (void*) &y_size ));
