//
// auto-generated by op2.py on 2014-05-13 14:12
//
...
extern double dt;
  ...
  #define MAX_SOURCE_SIZE (3*0x1000000)
  ...
  void buildOpenCLKernels() {
    ...
    if(!isbuilt) {
      ...
      printf(" compiling sources \n");
        ...
        OPS_opencl_core.program = clCreateProgramWithSource(OPS_opencl_core.context, 3, (const char **) &source_str, (const size_t *) &source_size, &ret);
        clSafeCall( ret );
