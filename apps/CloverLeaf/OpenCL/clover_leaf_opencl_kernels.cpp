//
// auto-generated by op2.py on 2014-06-09 11:20
//
...
extern double dt;
  ...
  #define MAX_SOURCE_SIZE (80*0x1000000)
  ...
  void buildOpenCLKernels() {
    ...
    if(!isbuilt) {
      ...
      OPS_opencl_core.n_kernels = 80;
      OPS_opencl_core.kernel = (cl_kernel*) malloc(80*sizeof(cl_kernel));  
      ...
      char* source_filename[80] = {
          ...
          "./OpenCL/initialise_chunk_kernel_x.cl",
          "./OpenCL/initialise_chunk_kernel_y.cl",
          "./OpenCL/initialise_chunk_kernel_cellx.cl",
          "./OpenCL/initialise_chunk_kernel_celly.cl",
          "./OpenCL/initialise_chunk_kernel_volume.cl",
      ...
      printf(" compiling sources \n");
        ...
        OPS_opencl_core.program = clCreateProgramWithSource(OPS_opencl_core.context, 80, (const char **) &source_str, (const size_t *) &source_size, &ret);
        clSafeCall( ret );
      ...
      clSafeCall( ret );
      OPS_opencl_core.kernel[72] = clCreateKernel(OPS_opencl_core.program, "ops_initialise_chunk_kernel_x", &ret);
      clSafeCall( ret );
      OPS_opencl_core.kernel[73] = clCreateKernel(OPS_opencl_core.program, "ops_initialise_chunk_kernel_y", &ret);
      clSafeCall( ret );
      OPS_opencl_core.kernel[74] = clCreateKernel(OPS_opencl_core.program, "ops_initialise_chunk_kernel_cellx", &ret);
      clSafeCall( ret );
      OPS_opencl_core.kernel[75] = clCreateKernel(OPS_opencl_core.program, "ops_initialise_chunk_kernel_celly", &ret);
      clSafeCall( ret );
      OPS_opencl_core.kernel[76] = clCreateKernel(OPS_opencl_core.program, "ops_initialise_chunk_kernel_volume", &ret);
      clSafeCall( ret );
      OPS_opencl_core.kernel[77] = clCreateKernel(OPS_opencl_core.program, "ops_calc_dt_kernel", &ret);
      clSafeCall( ret );
      OPS_opencl_core.kernel[78] = clCreateKernel(OPS_opencl_core.program, "ops_calc_dt_kernel_min", &ret);
      clSafeCall( ret );
      OPS_opencl_core.kernel[79] = clCreateKernel(OPS_opencl_core.program, "ops_calc_dt_kernel_get", &ret);
      clSafeCall( ret );
      //OPS_opencl_core.kernel[80] = clCreateKernel(OPS_opencl_core.program, "ops_calc_dt_kernel_print", &ret);
      //clSafeCall( ret );
...
#include "initialise_chunk_kernel_x_opencl_kernel.cpp"
#include "initialise_chunk_kernel_y_opencl_kernel.cpp"
#include "initialise_chunk_kernel_cellx_opencl_kernel.cpp"
#include "initialise_chunk_kernel_celly_opencl_kernel.cpp"
#include "initialise_chunk_kernel_volume_opencl_kernel.cpp"
