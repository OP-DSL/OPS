//
// auto-generated by op2.py on 2014-05-13 14:45
//
...
extern double dt;
  ...
  #define MAX_SOURCE_SIZE (10*0x1000000)
  ...
  void buildOpenCLKernels() {
    ...
    if(!isbuilt) {
      ...
      OPS_opencl_core.n_kernels = 10;
      OPS_opencl_core.kernel = (cl_kernel*) malloc(10*sizeof(cl_kernel));  
      ...
      printf(" compiling sources \n");
        ...
        OPS_opencl_core.program = clCreateProgramWithSource(OPS_opencl_core.context, 10, (const char **) &source_str, (const size_t *) &source_size, &ret);
        clSafeCall( ret );
