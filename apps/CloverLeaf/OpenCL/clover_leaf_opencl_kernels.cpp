//
// auto-generated by op2.py on 2014-06-05 13:01
//
...
extern double dt;
  ...
  void buildOpenCLKernels() {
    ...
    if(!isbuilt) {
      ...
      clSafeCall( ret );
      OPS_opencl_core.kernel[70] = clCreateKernel(OPS_opencl_core.program, "ops_calc_dt_kernel", &ret);
      clSafeCall( ret );
      OPS_opencl_core.kernel[71] = clCreateKernel(OPS_opencl_core.program, "ops_calc_dt_kernel_min", &ret);
      clSafeCall( ret );
