//
// auto-generated by op2.py on 2014-05-13 15:30
//
...
extern double dt;
  ...
  #define MAX_SOURCE_SIZE (22*0x1000000)
  ...
  void buildOpenCLKernels() {
    ...
    if(!isbuilt) {
      ...
      OPS_opencl_core.n_kernels = 22;
      OPS_opencl_core.kernel = (cl_kernel*) malloc(22*sizeof(cl_kernel));  
      
      cl_int ret;
      char* source_filename[22] = {
      ...
      printf(" compiling sources \n");
        ...
        OPS_opencl_core.program = clCreateProgramWithSource(OPS_opencl_core.context, 22, (const char **) &source_str, (const size_t *) &source_size, &ret);
        clSafeCall( ret );
