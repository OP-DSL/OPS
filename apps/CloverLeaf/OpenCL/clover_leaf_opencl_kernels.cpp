//
// auto-generated by op2.py on 2014-05-13 14:40
//
...
extern double dt;
  ...
  #define MAX_SOURCE_SIZE (7*0x1000000)
  ...
  void buildOpenCLKernels() {
    ...
    if(!isbuilt) {
      ...
      OPS_opencl_core.n_kernels = 7;
      OPS_opencl_core.kernel = (cl_kernel*) malloc(7*sizeof(cl_kernel));  
      
      cl_int ret;
      char* source_filename[7] = {
      ...
      printf(" compiling sources \n");
        ...
        OPS_opencl_core.program = clCreateProgramWithSource(OPS_opencl_core.context, 7, (const char **) &source_str, (const size_t *) &source_size, &ret);
        clSafeCall( ret );
