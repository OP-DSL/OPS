//
// auto-generated by op2.py on 2014-06-03 14:49
//
...
extern double dt;
  ...
  void buildOpenCLKernels() {
    ...
    if(!isbuilt) {
      ...
      clSafeCall( ret );
      OPS_opencl_core.kernel[70] = clCreateKernel(OPS_opencl_core.program, "ops_generate_chunk_kernel", &ret);
      clSafeCall( ret );
      ...
      clSafeCall( ret );
      //OPS_opencl_core.kernel[74] = clCreateKernel(OPS_opencl_core.program, "ops_calc_dt_kernel_print", &ret);
      //clSafeCall( ret );
