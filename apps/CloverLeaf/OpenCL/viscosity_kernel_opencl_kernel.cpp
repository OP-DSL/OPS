...
void ops_par_loop_viscosity_kernel(char const *name, ops_block Block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6) {
  ...
  size_t globalWorkSize[3] = {(x_size-1)/OPS_block_size_x+ 1, (y_size-1)/OPS_block_size_y + 1, 1};
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[0], 0, sizeof(cl_mem), (void*) p_a[0] ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[0], 1, sizeof(cl_mem), (void*) p_a[1] )); 
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[0], 2, sizeof(cl_mem), (void*) p_a[2] ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[0], 3, sizeof(cl_mem), (void*) p_a[3] ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[0], 4, sizeof(cl_mem), (void*) p_a[4] ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[0], 5, sizeof(cl_mem), (void*) p_a[5] ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[0], 6, sizeof(cl_mem), (void*) p_a[6] ));
