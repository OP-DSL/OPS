...
void ops_par_loop_calc_dt_kernel_min(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[31], 2, nthread*sizeof(double), NULL));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[31], 3, sizeof(cl_int), (void*) &r_bytes1 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[31], 3, sizeof(cl_int), (void*) &xdim0 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[31], 4, sizeof(cl_int), (void*) &base0 ));
