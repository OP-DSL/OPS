...
void ops_par_loop_PdV_kernel_nopredict(char const *name, ops_block Block, int dim, int* range,
 ...
 ops_arg arg9, ops_arg arg10, ops_arg arg11, ops_arg arg12, ops_arg arg13) {
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 14, sizeof(cl_mem), (void*) &OPS_opencl_core.constant[13]) );
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 15, sizeof(cl_int), (void*) &xdim0 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 16, sizeof(cl_int), (void*) &xdim1 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 17, sizeof(cl_int), (void*) &xdim2 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 18, sizeof(cl_int), (void*) &xdim3 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 19, sizeof(cl_int), (void*) &xdim4 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 20, sizeof(cl_int), (void*) &xdim5 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 21, sizeof(cl_int), (void*) &xdim6 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 22, sizeof(cl_int), (void*) &xdim7 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 23, sizeof(cl_int), (void*) &xdim8 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 24, sizeof(cl_int), (void*) &xdim9 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 25, sizeof(cl_int), (void*) &xdim10 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 26, sizeof(cl_int), (void*) &xdim11 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 27, sizeof(cl_int), (void*) &xdim12 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 28, sizeof(cl_int), (void*) &xdim13 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 29, sizeof(cl_int), (void*) &base0 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 30, sizeof(cl_int), (void*) &base1 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 31, sizeof(cl_int), (void*) &base2 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 32, sizeof(cl_int), (void*) &base3 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 33, sizeof(cl_int), (void*) &base4 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 34, sizeof(cl_int), (void*) &base5 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 35, sizeof(cl_int), (void*) &base6 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 36, sizeof(cl_int), (void*) &base7 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 37, sizeof(cl_int), (void*) &base8 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 38, sizeof(cl_int), (void*) &base9 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 39, sizeof(cl_int), (void*) &base10 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 40, sizeof(cl_int), (void*) &base11 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 41, sizeof(cl_int), (void*) &base12 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 42, sizeof(cl_int), (void*) &base13 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 43, sizeof(cl_int), (void*) &x_size ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 44, sizeof(cl_int), (void*) &y_size ));
