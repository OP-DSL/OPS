...
const __global int* restrict  fields, 
  const int xdim0_update_halo_kernel1_l1,
const int xdim1_update_halo_kernel1_l1,
const int xdim2_update_halo_kernel1_l1,
const int xdim3_update_halo_kernel1_l1,
const int xdim4_update_halo_kernel1_l1,
const int xdim5_update_halo_kernel1_l1,
const int xdim6_update_halo_kernel1_l1)
