...
const __global double * restrict vol_flux_x, const __global double * restrict vol_flux_y, 
  const int xdim0_advec_cell_kernel1_xdir,
const int xdim1_advec_cell_kernel1_xdir,
const int xdim2_advec_cell_kernel1_xdir,
const int xdim3_advec_cell_kernel1_xdir,
const int xdim4_advec_cell_kernel1_xdir)
