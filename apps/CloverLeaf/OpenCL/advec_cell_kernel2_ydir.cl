...
const __global double * restrict vol_flux_y, 
  const int xdim0_advec_cell_kernel2_ydir,
const int xdim1_advec_cell_kernel2_ydir,
const int xdim2_advec_cell_kernel2_ydir,
const int xdim3_advec_cell_kernel2_ydir)
