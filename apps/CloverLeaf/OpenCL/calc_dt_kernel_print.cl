...
const __global double * restrict energy0, const __global double * restrict pressure, const __global double * restrict soundspeed, 
  const int xdim0_calc_dt_kernel_print,
const int xdim1_calc_dt_kernel_print,
const int xdim2_calc_dt_kernel_print,
const int xdim3_calc_dt_kernel_print,
const int xdim4_calc_dt_kernel_print,
const int xdim5_calc_dt_kernel_print)
