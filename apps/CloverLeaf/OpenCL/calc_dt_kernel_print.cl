...
//user function
void calc_dt_kernel_pr__global int( __global double *xvel0, __global double *yvel0, __global double *density0, __global double *energy0, __global double *pressure, __global double *soundspeed, 
