...
void ops_par_loop_update_halo_kernel2_xvel_minus_4_a(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[42], 3, sizeof(cl_int), (void*) &xdim0 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[42], 4, sizeof(cl_int), (void*) &xdim1 ));
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[42], 7, sizeof(cl_int), (void*) &x_size ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[42], 8, sizeof(cl_int), (void*) &y_size ));
