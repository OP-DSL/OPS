...
void ops_par_loop_update_halo_kernel2_xvel_plus_4_b(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[40], 3, sizeof(cl_int), (void*) &xdim0 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[40], 4, sizeof(cl_int), (void*) &xdim1 ));
