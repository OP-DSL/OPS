...
//user function
inline void advec_mom_kernel1_x_nonvector(  __global double *node_flux, __global double *node_mass_pre, __global double *mom_flux, __global double *celldx, __global double *vel1, 
