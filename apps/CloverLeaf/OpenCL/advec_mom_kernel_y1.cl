...
//user function
inline void advec_mom_kernel_y1( __global double *pre_vol, __global double *post_vol, __global double *volume, __global double *vol_flux_x, __global double *vol_flux_y, 
