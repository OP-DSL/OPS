...
const __global double * restrict vol_flux_x, 
  const int xdim0_advec_cell_kernel2_xdir,
const int xdim1_advec_cell_kernel2_xdir,
const int xdim2_advec_cell_kernel2_xdir,
const int xdim3_advec_cell_kernel2_xdir)
