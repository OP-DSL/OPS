...
//user function
void PdV_kernel_predict( __global double *xarea, __global double *xvel0, __global double *yarea, __global double *yvel0, __global double *volume_change, __global double *volume, __global double *pressure, __global double *density0, __global double *density1, __global double *viscosity, __global double *energy0, __global double *energy1, 
  double dt,
