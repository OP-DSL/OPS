...
__global double * restrict energy1, 
  const double dt,
  const int xdim0_PdV_kernel_predict,
const int xdim1_PdV_kernel_predict,
const int xdim2_PdV_kernel_predict,
const int xdim3_PdV_kernel_predict,
const int xdim4_PdV_kernel_predict,
const int xdim5_PdV_kernel_predict,
const int xdim6_PdV_kernel_predict,
const int xdim7_PdV_kernel_predict,
const int xdim8_PdV_kernel_predict,
const int xdim9_PdV_kernel_predict,
const int xdim10_PdV_kernel_predict,
const int xdim11_PdV_kernel_predict)
