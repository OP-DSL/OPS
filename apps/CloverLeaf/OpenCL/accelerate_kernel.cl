...
void accelerate_kernel( const __global double *density0, const __global double *volume,
                __global double *stepbymass, const __global double *xvel0, __global double *xvel1,
                const __global double *xarea, const __global double *pressure,
                const __global double *yvel0, __global double *yvel1,
                const __global double *yarea, const __global double *viscosity,
  double dt,
