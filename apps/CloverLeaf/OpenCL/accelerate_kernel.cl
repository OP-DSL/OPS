...
const __global double * restrict yvel0, __global double * restrict yvel1, const __global double * restrict yarea, const __global double * restrict viscosity, 
  ...
  const double dt,
  const int xdim0_accelerate_kernel,
const int xdim1_accelerate_kernel,
const int xdim2_accelerate_kernel,
const int xdim3_accelerate_kernel,
const int xdim4_accelerate_kernel,
const int xdim5_accelerate_kernel,
const int xdim6_accelerate_kernel,
const int xdim7_accelerate_kernel,
const int xdim8_accelerate_kernel,
const int xdim9_accelerate_kernel,
const int xdim10_accelerate_kernel)
