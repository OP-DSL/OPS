...
const __global double * restrict celldy, const __global double * restrict vel1, 
  const int xdim0_advec_mom_kernel1_y_nonvector,
const int xdim1_advec_mom_kernel1_y_nonvector,
const int xdim2_advec_mom_kernel1_y_nonvector,
const int xdim3_advec_mom_kernel1_y_nonvector,
const int xdim4_advec_mom_kernel1_y_nonvector)
