...
__global double * restrict post_mass, __global double * restrict advec_vol, __global double * restrict post_ener, const __global double * restrict ener_flux, 
  ...
  const int xdim0_advec_cell_kernel4_ydir,
const int xdim1_advec_cell_kernel4_ydir,
const int xdim2_advec_cell_kernel4_ydir,
const int xdim3_advec_cell_kernel4_ydir,
const int xdim4_advec_cell_kernel4_ydir,
const int xdim5_advec_cell_kernel4_ydir,
const int xdim6_advec_cell_kernel4_ydir,
const int xdim7_advec_cell_kernel4_ydir,
const int xdim8_advec_cell_kernel4_ydir,
const int xdim9_advec_cell_kernel4_ydir,
const int xdim10_advec_cell_kernel4_ydir)
