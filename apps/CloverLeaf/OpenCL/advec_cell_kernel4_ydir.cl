...
//user function
inline void advec_cell_kernel4_ydir( __global double *density1, __global double *energy1, __global double *mass_flux_y, __global double *vol_flux_y, __global double *pre_vol, __global double *post_vol, __global double *pre_mass, __global double *post_mass, __global double *advec_vol, __global double *post_ener, __global double *ener_flux, 
