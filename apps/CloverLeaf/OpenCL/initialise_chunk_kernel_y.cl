...
//user function
void initialise_chunk_kernel_y(__global double *vertexy, __global int *yy, __global double *vertexdy, 
...
int xdim2_initialise_chunk_kernel_y)
 ...
 int size1 ){
   ...
   if (idx_x < size0 && idx_y < size1) {
     initialise_chunk_kernel_y(&arg0[base0 + idx_x * 0 + idx_y * 1 * xdim0_initialise_chunk_kernel_y],
