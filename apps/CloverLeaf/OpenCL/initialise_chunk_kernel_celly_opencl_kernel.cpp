...
void ops_par_loop_initialise_chunk_kernel_celly(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[75], 5, sizeof(cl_int), (void*) &xdim0 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[75], 6, sizeof(cl_int), (void*) &xdim1 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[75], 7, sizeof(cl_int), (void*) &xdim2 ));
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[75], 10, sizeof(cl_int), (void*) &base2 ));
