...
//user function
inline void update_halo_kernel1_b2(__global double *density0, __global double *density1, __global double *energy0, __global double *energy1, __global double *pressure, __global double *viscosity, __global double *soundspeed, __global int* fields, 
