...
void ops_par_loop_advec_cell_kernel4_ydir(char const *name, ops_block Block, int dim, int* range,
 ...
 ops_arg arg9, ops_arg arg10) {
  ...
  //Timing
  double t1,t2,c1,c2;
  ops_timing_realloc(12,"advec_cell_kernel4_ydir");
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 11, sizeof(cl_int), (void*) &xdim0 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 12, sizeof(cl_int), (void*) &xdim1 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 13, sizeof(cl_int), (void*) &xdim2 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 14, sizeof(cl_int), (void*) &xdim3 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 15, sizeof(cl_int), (void*) &xdim4 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 16, sizeof(cl_int), (void*) &xdim5 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 17, sizeof(cl_int), (void*) &xdim6 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 18, sizeof(cl_int), (void*) &xdim7 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 19, sizeof(cl_int), (void*) &xdim8 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 20, sizeof(cl_int), (void*) &xdim9 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 21, sizeof(cl_int), (void*) &xdim10 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 22, sizeof(cl_int), (void*) &base0 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 23, sizeof(cl_int), (void*) &base1 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 24, sizeof(cl_int), (void*) &base2 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 25, sizeof(cl_int), (void*) &base3 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 26, sizeof(cl_int), (void*) &base4 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 27, sizeof(cl_int), (void*) &base5 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 28, sizeof(cl_int), (void*) &base6 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 29, sizeof(cl_int), (void*) &base7 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 30, sizeof(cl_int), (void*) &base8 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 31, sizeof(cl_int), (void*) &base9 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 32, sizeof(cl_int), (void*) &base10 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 33, sizeof(cl_int), (void*) &x_size ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 34, sizeof(cl_int), (void*) &y_size ));
  ...
  OPS_kernels[12].transfer += ops_compute_transfer(dim, range, &arg6);
  OPS_kernels[12].transfer += ops_compute_transfer(dim, range, &arg7);
  OPS_kernels[12].transfer += ops_compute_transfer(dim, range, &arg8);
  OPS_kernels[12].transfer += ops_compute_transfer(dim, range, &arg9);
  OPS_kernels[12].transfer += ops_compute_transfer(dim, range, &arg10);
}
