...
//user function
inline void advec_mom_kernel_post_pre_advec_y( __global double *node_mass_post, __global double *post_vol, __global double *density1, __global double *node_mass_pre, __global double *node_flux, 
