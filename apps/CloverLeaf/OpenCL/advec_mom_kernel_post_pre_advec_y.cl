...
__global double * restrict node_mass_pre, const __global double * restrict node_flux, 
  const int xdim0_advec_mom_kernel_post_pre_advec_y,
const int xdim1_advec_mom_kernel_post_pre_advec_y,
const int xdim2_advec_mom_kernel_post_pre_advec_y,
const int xdim3_advec_mom_kernel_post_pre_advec_y,
const int xdim4_advec_mom_kernel_post_pre_advec_y)
