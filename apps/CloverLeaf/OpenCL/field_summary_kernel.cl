...
//user function
void field_summary_kernel(  __global double *volume, __global double *density0, __global double *energy0, 
__global double *pressure, __global double *xvel0, __global double *yvel0,  double *vol,
