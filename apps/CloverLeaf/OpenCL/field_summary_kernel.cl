...
const __global double * restrict pressure, const __global double * restrict xvel0, const __global double * restrict yvel0,  double * restrict vol,
 double * restrict mass, double * restrict ie, double * restrict ke, double * restrict press,
  ...
  const int xdim0_field_summary_kernel,
const int xdim1_field_summary_kernel,
const int xdim2_field_summary_kernel,
const int xdim3_field_summary_kernel,
const int xdim4_field_summary_kernel,
const int xdim5_field_summary_kernel)
