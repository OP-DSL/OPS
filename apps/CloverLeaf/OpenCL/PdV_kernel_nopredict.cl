...
const __global double * restrict viscosity, const __global double * restrict energy0, __global double * restrict energy1, 
  const double dt,
  const int xdim0_PdV_kernel_nopredict,
const int xdim1_PdV_kernel_nopredict,
const int xdim2_PdV_kernel_nopredict,
const int xdim3_PdV_kernel_nopredict,
const int xdim4_PdV_kernel_nopredict,
const int xdim5_PdV_kernel_nopredict,
const int xdim6_PdV_kernel_nopredict,
const int xdim7_PdV_kernel_nopredict,
const int xdim8_PdV_kernel_nopredict,
const int xdim9_PdV_kernel_nopredict,
const int xdim10_PdV_kernel_nopredict,
const int xdim11_PdV_kernel_nopredict,
const int xdim12_PdV_kernel_nopredict,
const int xdim13_PdV_kernel_nopredict)
