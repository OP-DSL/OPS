...
void ops_par_loop_initialise_chunk_kernel_x(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  //Timing
  double t1,t2,c1,c2;
  ops_timing_realloc(71,"initialise_chunk_kernel_x");
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[71], 3, sizeof(cl_mem), (void*) &OPS_opencl_core.constant[6]) );
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[71], 4, sizeof(cl_mem), (void*) &OPS_opencl_core.constant[7]) );
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[71], 5, sizeof(cl_int), (void*) &xdim0 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[71], 6, sizeof(cl_int), (void*) &xdim1 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[71], 7, sizeof(cl_int), (void*) &xdim2 ));
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[71], 10, sizeof(cl_int), (void*) &base2 ));
