...
//user function
void initialise_chunk_kernel_x(__global double * restrict vertexx, const __global int * restrict xx, __global double * restrict vertexdx, 
...
const grid_type grid)
 ...
 __global const int* restrict arg1,
