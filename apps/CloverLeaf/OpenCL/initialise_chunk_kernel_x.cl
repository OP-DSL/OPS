...
//user function
void initialise_chunk_kernel_x(__global double *vertexx, __global int *xx, __global double *vertexdx, 
...
int xdim2_initialise_chunk_kernel_x)
 ...
 int size1 ){
   ...
   if (idx_x < size0 && idx_y < size1) {
     initialise_chunk_kernel_x(&arg0[base0 + idx_x * 1 + idx_y * 0 * xdim0_initialise_chunk_kernel_x],
