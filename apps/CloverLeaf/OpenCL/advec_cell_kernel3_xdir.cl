...
//user function
inline void advec_cell_kernel3_xdir(  __global double *vol_flux_x, __global double *pre_vol, __global int *xx, __global double *vertexdx, __global double *density1, __global double *energy1, __global double *mass_flux_x, __global double *ener_flux, 
  field_type field,
