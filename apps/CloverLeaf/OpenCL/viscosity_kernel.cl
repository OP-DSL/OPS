...
//user function
void viscosity_kernel(  __global double *xvel0, __global double *yvel0, __global double *celldx, __global double *celldy, __global double *pressure, __global double *density0, __global double *viscosity, 
