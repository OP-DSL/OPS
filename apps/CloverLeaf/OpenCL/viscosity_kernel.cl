...
const __global double * restrict celldy, const __global double * restrict pressure, const __global double * restrict density0, __global double * restrict viscosity, 
  ...
  const int xdim0_viscosity_kernel,
const int xdim1_viscosity_kernel,
const int xdim2_viscosity_kernel,
const int xdim3_viscosity_kernel,
const int xdim4_viscosity_kernel,
const int xdim5_viscosity_kernel,
const int xdim6_viscosity_kernel)
