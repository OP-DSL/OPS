...
void viscosity_kernel( const __global double *xvel0, const __global double *yvel0,
                       const __global double *celldx, const __global double *celldy,
                       const __global double *pressure, const __global double *density0,
