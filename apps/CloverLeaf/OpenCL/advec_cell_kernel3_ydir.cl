...
__global double * restrict ener_flux, 
  ...
  const int xdim0_advec_cell_kernel3_ydir,
const int xdim1_advec_cell_kernel3_ydir,
const int xdim2_advec_cell_kernel3_ydir,
const int xdim3_advec_cell_kernel3_ydir,
const int xdim4_advec_cell_kernel3_ydir,
const int xdim5_advec_cell_kernel3_ydir,
const int xdim6_advec_cell_kernel3_ydir,
const int xdim7_advec_cell_kernel3_ydir)
