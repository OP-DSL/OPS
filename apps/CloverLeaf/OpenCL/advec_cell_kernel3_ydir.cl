...
//user function
inline void advec_cell_kernel3_ydir(  __global double *vol_flux_y, __global double *pre_vol, __global int *yy, __global double *vertexdy, __global double *density1, __global double *energy1, __global double *mass_flux_y, __global double *ener_flux, 
  field_type field,
