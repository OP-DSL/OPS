...
void PdV(int predict)
{
  ...
  if(predict == TRUE) {
  ops_par_loop_mpi(PdV_kernel_predict, "PdV_kernel_predict", clover_grid, 2, rangexy_inner,
  ...
  ops_par_loop_mpi(PdV_kernel_nopredict, "PdV_kernel_nopredict", clover_grid, 2, rangexy_inner,
    ops_arg_dat(xarea, S2D_00_P10_0P1_P1P1, "double", OPS_READ),
    ops_arg_dat(xvel0, S2D_00_P10_0P1_P1P1, "double", OPS_READ),
