...
void accelerate()
{
  ...
  ops_par_loop_mpi(accelerate_kernel_stepbymass, "accelerate_kernel_stepbymass", clover_grid, 2, rangexy_inner_plus1,
  ...
  ops_par_loop_mpi(accelerate_kernelx1, "accelerate_kernelx1", clover_grid, 2, rangexy_inner_plus1,
  ...
  ops_par_loop_mpi(accelerate_kernely1, "accelerate_kernely1", clover_grid, 2, rangexy_inner_plus1,
  ...
  ops_par_loop_mpi(accelerate_kernelx2, "accelerate_kernelx2", clover_grid, 2, rangexy_inner_plus1,
    ops_arg_dat(xvel1, S2D_00, "double", OPS_INC),
    ops_arg_dat(work_array1, S2D_00, "double", OPS_READ),
    ops_arg_dat(xarea, S2D_00_0M1, "double", OPS_READ),
    ops_arg_dat(viscosity, S2D_00_M10_0M1_M1M1, "double", OPS_READ));

  ops_par_loop_mpi(accelerate_kernely2, "accelerate_kernely2", clover_grid, 2, rangexy_inner_plus1,
