...
void update_halo(int* fields, int depth)
{
  ...
  if(depth ==2)
  ops_par_loop(update_halo_kernel1_b2, "update_halo_kernel1", 2, rangexy_b2a,
  ...
  ops_par_loop(update_halo_kernel_b1, "update_halo_kernel1", 2, rangexy_b1a,
  ...
  if(depth ==2)
  ops_par_loop(update_halo_kernel_t2, "update_halo_kernel1", 2, rangexy_t2a,
  ...
  ops_par_loop(update_halo_kernel_t1, "update_halo_kernel1", 2, rangexy_t1a,
  ...
  if(depth ==2)
  ops_par_loop(update_halo_kernel1_l2, "update_halo_kernel", 2, rangexy_l2a,
  ...
  ops_par_loop(update_halo_kernel1_l1, "update_halo_kernel", 2, rangexy_l1a,
  ...
  if(depth ==2)
  ops_par_loop(update_halo_kernel1_r2, "update_halo_kernel", 2, rangexy_r2a,
  ...
  ops_par_loop(update_halo_kernel1_r1, "update_halo_kernel", 2, rangexy_r1a,
