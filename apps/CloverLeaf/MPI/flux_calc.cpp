...
void flux_calc()
{
  ...
  ops_par_loop_mpi(flux_calc_kernelx, "flux_calc_kernelx", clover_grid, 2, rangexy_inner_plus1x,
  ...
  ops_par_loop_mpi(flux_calc_kernely, "flux_calc_kernely", clover_grid, 2, rangexy_inner_plus1y,
