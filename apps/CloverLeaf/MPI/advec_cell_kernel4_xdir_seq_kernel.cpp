...
void ops_par_loop_advec_cell_kernel4_xdir(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8, ops_arg arg9, ops_arg arg10) {
  ...
  //Timing
  double t1,t2,c1,c2;
  ops_timing_realloc(50,"advec_cell_kernel4_xdir");
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    OPS_kernels[50].transfer += ops_compute_transfer(dim, range, &arg7);
    OPS_kernels[50].transfer += ops_compute_transfer(dim, range, &arg8);
    OPS_kernels[50].transfer += ops_compute_transfer(dim, range, &arg9);
    OPS_kernels[50].transfer += ops_compute_transfer(dim, range, &arg10);
  }
