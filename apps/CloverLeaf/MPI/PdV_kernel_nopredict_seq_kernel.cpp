...
void ops_par_loop_PdV_kernel_nopredict(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12, ops_arg arg13) {
  ...
  //Timing
  double t1,t2,c1,c2;
  ops_timing_realloc(45,"PdV_kernel_nopredict");
  ...
  ops_exchange_halo3(&args[8],max8,min8,range);
  ...
  ops_exchange_halo3(&args[11],max11,min11,range);
  ...
  ops_exchange_halo3(&args[12],max12,min12,range);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    OPS_kernels[45].transfer += ops_compute_transfer(dim, range, &arg12);
    OPS_kernels[45].transfer += ops_compute_transfer(dim, range, &arg13);
  }
