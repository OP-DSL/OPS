...
void ops_par_loop_PdV_kernel_nopredict(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12, ops_arg arg13) {
  ...
  for ( int p=0; p<args[0].stencil->points; p++ ){
    for ( int n=0; n<ndim; n++ ){
      max0[n] = MAX(max0[n],args[0].stencil->stencil[ndim*p + n]);
      min0[n] = MIN(min0[n],args[0].stencil->stencil[ndim*p + n]);
    }
  }
  ...
  for ( int p=0; p<args[1].stencil->points; p++ ){
    for ( int n=0; n<ndim; n++ ){
      max1[n] = MAX(max1[n],args[1].stencil->stencil[ndim*p + n]);
      min1[n] = MIN(min1[n],args[1].stencil->stencil[ndim*p + n]);
    }
  }
  //set up initial pointers and exchange halos if nessasary
  int base1 = dat1 * 1 * 
  ...
  for ( int p=0; p<args[2].stencil->points; p++ ){
    for ( int n=0; n<ndim; n++ ){
      max2[n] = MAX(max2[n],args[2].stencil->stencil[ndim*p + n]);
      min2[n] = MIN(min2[n],args[2].stencil->stencil[ndim*p + n]);
    }
  }
  //set up initial pointers and exchange halos if nessasary
  int base2 = dat2 * 1 * 
  ...
  for ( int p=0; p<args[3].stencil->points; p++ ){
    for ( int n=0; n<ndim; n++ ){
      max3[n] = MAX(max3[n],args[3].stencil->stencil[ndim*p + n]);
      min3[n] = MIN(min3[n],args[3].stencil->stencil[ndim*p + n]);
    }
  }
  //set up initial pointers and exchange halos if nessasary
  int base3 = dat3 * 1 * 
  ...
  for ( int p=0; p<args[4].stencil->points; p++ ){
    for ( int n=0; n<ndim; n++ ){
      max4[n] = MAX(max4[n],args[4].stencil->stencil[ndim*p + n]);
      min4[n] = MIN(min4[n],args[4].stencil->stencil[ndim*p + n]);
    }
  }
  //set up initial pointers and exchange halos if nessasary
  int base4 = dat4 * 1 * 
  ...
  for ( int p=0; p<args[5].stencil->points; p++ ){
    for ( int n=0; n<ndim; n++ ){
      max5[n] = MAX(max5[n],args[5].stencil->stencil[ndim*p + n]);
      min5[n] = MIN(min5[n],args[5].stencil->stencil[ndim*p + n]);
    }
  }
  //set up initial pointers and exchange halos if nessasary
  int base5 = dat5 * 1 * 
  ...
  for ( int p=0; p<args[6].stencil->points; p++ ){
    for ( int n=0; n<ndim; n++ ){
      max6[n] = MAX(max6[n],args[6].stencil->stencil[ndim*p + n]);
      min6[n] = MIN(min6[n],args[6].stencil->stencil[ndim*p + n]);
    }
  }
  //set up initial pointers and exchange halos if nessasary
  int base6 = dat6 * 1 * 
  ...
  for ( int p=0; p<args[7].stencil->points; p++ ){
    for ( int n=0; n<ndim; n++ ){
      max7[n] = MAX(max7[n],args[7].stencil->stencil[ndim*p + n]);
      min7[n] = MIN(min7[n],args[7].stencil->stencil[ndim*p + n]);
    }
  }
  //set up initial pointers and exchange halos if nessasary
  int base7 = dat7 * 1 * 
  ...
  for ( int p=0; p<args[8].stencil->points; p++ ){
    for ( int n=0; n<ndim; n++ ){
      max8[n] = MAX(max8[n],args[8].stencil->stencil[ndim*p + n]);
      min8[n] = MIN(min8[n],args[8].stencil->stencil[ndim*p + n]);
    }
  }
  //set up initial pointers and exchange halos if nessasary
  int base8 = dat8 * 1 * 
  ...
  for ( int p=0; p<args[9].stencil->points; p++ ){
    for ( int n=0; n<ndim; n++ ){
      max9[n] = MAX(max9[n],args[9].stencil->stencil[ndim*p + n]);
      min9[n] = MIN(min9[n],args[9].stencil->stencil[ndim*p + n]);
    }
  }
  //set up initial pointers and exchange halos if nessasary
  int base9 = dat9 * 1 * 
  ...
  for ( int p=0; p<args[10].stencil->points; p++ ){
    for ( int n=0; n<ndim; n++ ){
      max10[n] = MAX(max10[n],args[10].stencil->stencil[ndim*p + n]);
      min10[n] = MIN(min10[n],args[10].stencil->stencil[ndim*p + n]);
    }
  }
  //set up initial pointers and exchange halos if nessasary
  int base10 = dat10 * 1 * 
  ...
  for ( int p=0; p<args[11].stencil->points; p++ ){
    for ( int n=0; n<ndim; n++ ){
      max11[n] = MAX(max11[n],args[11].stencil->stencil[ndim*p + n]);
      min11[n] = MIN(min11[n],args[11].stencil->stencil[ndim*p + n]);
    }
  }
  //set up initial pointers and exchange halos if nessasary
  int base11 = dat11 * 1 * 
  ...
  for ( int p=0; p<args[12].stencil->points; p++ ){
    for ( int n=0; n<ndim; n++ ){
      max12[n] = MAX(max12[n],args[12].stencil->stencil[ndim*p + n]);
      min12[n] = MIN(min12[n],args[12].stencil->stencil[ndim*p + n]);
    }
  }
  //set up initial pointers and exchange halos if nessasary
  int base12 = dat12 * 1 * 
  ...
  for ( int p=0; p<args[13].stencil->points; p++ ){
    for ( int n=0; n<ndim; n++ ){
      max13[n] = MAX(max13[n],args[13].stencil->stencil[ndim*p + n]);
      min13[n] = MIN(min13[n],args[13].stencil->stencil[ndim*p + n]);
    }
  }
  //set up initial pointers and exchange halos if nessasary
  int base13 = dat13 * 1 * 
