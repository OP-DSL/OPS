...
void ops_par_loop_PdV_kernel_predict(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8, ops_arg arg9, ops_arg arg10, ops_arg arg11) {
  ...
  //Timing
  double t1,t2,c1,c2;
  ops_timing_realloc(44,"PdV_kernel_predict");
  ...
  ops_exchange_halo3(&args[6],max6,min6,range);
  ...
  ops_exchange_halo3(&args[7],max7,min7,range);
  ...
  ops_exchange_halo3(&args[9],max9,min9,range);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    OPS_kernels[44].transfer += ops_compute_transfer(dim, range, &arg7);
    OPS_kernels[44].transfer += ops_compute_transfer(dim, range, &arg8);
    OPS_kernels[44].transfer += ops_compute_transfer(dim, range, &arg9);
    OPS_kernels[44].transfer += ops_compute_transfer(dim, range, &arg10);
    OPS_kernels[44].transfer += ops_compute_transfer(dim, range, &arg11);
  }
