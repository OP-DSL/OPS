...
void reset_field()
{
  ...
  ops_par_loop_macro(reset_field_kernel1_macro, "reset_field_kernel1_macro", 2, rangexy_inner,
  ...
  ops_par_loop_macro(reset_field_kernel2_macro, "reset_field_kernel2_macro", 2, rangexy_inner_plus1xy,
