 ...
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3, ops_arg arg4) {
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    ...
    for ( int n_x=0; n_x<x_size; n_x++ ){
      initialise_chunk_kernel_volume(  p_a0+ n_x*1+n_y*xdim0_initialise_chunk_kernel_volume*1, p_a1+ n_x*0+n_y*xdim1_initialise_chunk_kernel_volume*1,
           p_a2+ n_x*1+n_y*xdim2_initialise_chunk_kernel_volume*1, p_a3+ n_x*1+n_y*xdim3_initialise_chunk_kernel_volume*0,
           p_a4+ n_x*1+n_y*xdim4_initialise_chunk_kernel_volume*1 );
