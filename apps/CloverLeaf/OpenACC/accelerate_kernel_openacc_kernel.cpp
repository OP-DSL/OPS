 ...
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3, ops_arg arg4, ops_arg arg5, ops_arg arg6, ops_arg arg7, ops_arg arg8, ops_arg arg9, ops_arg arg10) {
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    ...
    for ( int n_x=0; n_x<x_size; n_x++ ){
      accelerate_kernel(  p_a0+ n_x*1+n_y*xdim0_accelerate_kernel*1, p_a1+ n_x*1+n_y*xdim1_accelerate_kernel*1,
           p_a2+ n_x*1+n_y*xdim2_accelerate_kernel*1, p_a3+ n_x*1+n_y*xdim3_accelerate_kernel*1,
           p_a4+ n_x*1+n_y*xdim4_accelerate_kernel*1, p_a5+ n_x*1+n_y*xdim5_accelerate_kernel*1,
           p_a6+ n_x*1+n_y*xdim6_accelerate_kernel*1, p_a7+ n_x*1+n_y*xdim7_accelerate_kernel*1,
           p_a8+ n_x*1+n_y*xdim8_accelerate_kernel*1, p_a9+ n_x*1+n_y*xdim9_accelerate_kernel*1,
           p_a10+ n_x*1+n_y*xdim10_accelerate_kernel*1 );
