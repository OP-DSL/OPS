...
void field_summary_kernel_c_wrapper(
  ...
  double p_a6_l[1];
  for (int d = 0; d < 1; d++) p_a6_l[d] = p_a6[d];
  double p_a7_l[1];
  for (int d = 0; d < 1; d++) p_a7_l[d] = p_a7[d];
  double p_a8_l[1];
  for (int d = 0; d < 1; d++) p_a8_l[d] = p_a8[d];
  double p_a9_l[1];
  for (int d = 0; d < 1; d++) p_a9_l[d] = p_a9[d];
  double p_a10_l[1];
  for (int d = 0; d < 1; d++) p_a10_l[d] = p_a10[d];
  #ifdef OPS_GPU
  ...
  for (int d = 0; d < 1; d++) p_a6[d] = p_a6_l[d];
  for (int d = 0; d < 1; d++) p_a7[d] = p_a7_l[d];
  for (int d = 0; d < 1; d++) p_a8[d] = p_a8_l[d];
  for (int d = 0; d < 1; d++) p_a9[d] = p_a9_l[d];
  for (int d = 0; d < 1; d++) p_a10[d] = p_a10_l[d];
}
