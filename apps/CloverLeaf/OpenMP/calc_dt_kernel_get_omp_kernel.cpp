...
void ops_par_loop_calc_dt_kernel_get(char const *name, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3) {
  ...
  double *arg_gbl2 = (double *) malloc(nthreads * 64 * sizeof(double *));
  double *arg_gbl3 = (double *) malloc(nthreads * 64 * sizeof(double *));
  for ( int thr=0; thr<nthreads; thr++ ){
    arg_gbl2[64*thr] = *arg2h;
    arg_gbl3[64*thr] = *arg3h;
  }
