//
// auto-generated by ops.py on 2013-10-21 16:51
//
...
void ops_par_loop_field_summary_kernel(char const *name, int dim, int* range,
 ...
 ops_arg arg8, ops_arg arg9, ops_arg arg10) {
  ...
  for ( int thr=0; thr<nthreads; thr++ ){
    *((double*)(args[6].data)) += *arg_gbl6[thr];
    *((double*)(args[7].data)) += *arg_gbl7[thr];
    *((double*)(args[8].data)) += *arg_gbl8[thr];
    *((double*)(args[9].data)) += *arg_gbl9[thr];
    *((double*)(args[10].data)) += *arg_gbl10[thr];
  }
  for ( int thr=0; thr<nthreads; thr++ ){
    free(arg_gbl6[thr]);
    free(arg_gbl7[thr]);
