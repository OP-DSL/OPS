...
void ops_par_loop_field_summary_kernel(char const *name, int dim, int* range,
 ...
 ops_arg arg8, ops_arg arg9, ops_arg arg10) {
  ...
  double arg_gbl6[nthreads * 64];
  double arg_gbl7[nthreads * 64];
  double arg_gbl8[nthreads * 64];
  double arg_gbl9[nthreads * 64];
  double arg_gbl10[nthreads * 64];
