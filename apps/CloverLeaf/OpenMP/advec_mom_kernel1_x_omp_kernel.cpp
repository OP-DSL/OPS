//
// auto-generated by ops.py on 2013-11-26 12:14
//
...
void ops_par_loop_advec_mom_kernel1_x(char const *name, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5) {
  ...
  //Timing
  double t1,t2,c1,c2;
  ops_timing_realloc(20,"advec_mom_kernel1_x");
  ...
  for ( int thr=0; thr<nthreads; thr++ ){
    ...
    p_a[4] = &args[4].data[
    + args[4].dat->size * args[4].dat->block_size[0] * ( start * 0 - args[4].dat->offset[1] )
    ...
    for ( int n_y=start; n_y<finish; n_y++ ){
      for ( int n_x=range[0]; n_x<range[0]+(range[1]-range[0])/4; n_x++ ){
        ...
        #pragma simd
        for ( int i=0; i<4; i++ ){
          advec_mom_kernel1_x(  (double *)p_a[0]+ i*1, (double *)p_a[1]+ i*1,
      ...
      for ( int n_x=range[0]+((range[1]-range[0])/4)*4; n_x<range[1]; n_x++ ){
        ...
        advec_mom_kernel1_x(  (double *)p_a[0], (double *)p_a[1],
