...
int size1 ){
  ...
  arg0 += idx_x * 1 + idx_y * 1 * xdim0_initialise_chunk_kernel_celly;
  arg1 += idx_x * 1 + idx_y * 1 * xdim1_initialise_chunk_kernel_celly;
  arg2 += idx_x * 1 + idx_y * 1 * xdim2_initialise_chunk_kernel_celly;
