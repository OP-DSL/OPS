//
// auto-generated by ops.py on 2013-11-14 12:00
//
...
int size1 ){
  ...
  double arg9_l[1];
  double arg10_l[1];
  for (int d=0; d<1; d++) arg6_l[1] = ZERO_double;
  for (int d=0; d<1; d++) arg7_l[1] = ZERO_double;
  for (int d=0; d<1; d++) arg8_l[1] = ZERO_double;
  for (int d=0; d<1; d++) arg9_l[1] = ZERO_double;
  for (int d=0; d<1; d++) arg10_l[1] = ZERO_double;
