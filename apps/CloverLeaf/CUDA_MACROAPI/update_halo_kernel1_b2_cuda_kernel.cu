...
// host stub function
void ops_par_loop_update_halo_kernel1_b2(char const *name, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6, ops_arg arg7) {
  ...
  for (int d=0; d<NUM_FIELDS; d++) ((double *)arg7.data)[d] = arg7h[d];
  ...
  ops_update_halo_kernel1_b2<<<grid, block >>> (  (double *)p_a[0], (double *)p_a[1],
           ...
           (double *)p_a[6], (int *) arg4.data_d, x_size, y_size);
