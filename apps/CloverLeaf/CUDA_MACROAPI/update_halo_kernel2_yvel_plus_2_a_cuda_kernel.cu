...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    update_halo_kernel2_yvel_plus_2_a(arg0 ,arg1 , fields_device);
  }
}
...
void ops_par_loop_update_halo_kernel2_yvel_plus_2_a(char const *name, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  ops_update_halo_kernel2_yvel_plus_2_a<<<grid, block >>> (  (double *)p_a[0], (double *)p_a[1],fields_device, x_size, y_size);
