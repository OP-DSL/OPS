...
void ops_par_loop_update_halo_kernel_b1(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6) {
  ...
  #ifdef OPS_DEBUG
  ops_register_args(args, "update_halo_kernel_b1");
  #endif
    ...
    for ( int n_y=start; n_y<finish; n_y++ ){
      for ( int n_x=s[0]; n_x<s[0]+(e[0]-s[0])/SIMD_VEC; n_x++ ){
          ...
          for ( int i=0; i<SIMD_VEC; i++ ){
            update_halo_kernel_b1(  (double *)p_a[0]+ i*1, (double *)p_a[1]+ i*1, (double *)p_a[2]+ i*1,
        ...
        for ( int n_x=s[0]+((e[0]-s[0])/SIMD_VEC)*SIMD_VEC; n_x<e[0]; n_x++ ){
            ...
            update_halo_kernel_b1(  (double *)p_a[0], (double *)p_a[1], (double *)p_a[2],
