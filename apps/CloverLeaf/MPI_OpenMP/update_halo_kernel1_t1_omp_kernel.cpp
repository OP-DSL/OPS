...
void ops_par_loop_update_halo_kernel1_t1(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6, ops_arg arg7) {
  ...
  //assumes a max of 256 threads with a cacche line size of 64 bytes
  int arg_gbl7[MAX(NUM_FIELDS , 64) * 256];
    ...
    for ( int n_y=start_i; n_y<finish_i; n_y++ ){
      for ( int n_x=start[0]; n_x<start[0]+(end[0]-start[0])/SIMD_VEC; n_x++ ){
        ...
        for ( int i=0; i<SIMD_VEC; i++ ){
          update_halo_kernel1_t1(  (double * restrict)p_a[0]+ i*1, (double * restrict)p_a[1]+ i*1, (double * restrict)p_a[2]+ i*1,
      ...
      for ( int n_x=start[0]+((end[0]-start[0])/SIMD_VEC)*SIMD_VEC; n_x<end[0]; n_x++ ){
        ...
        update_halo_kernel1_t1(  (double * restrict)p_a[0], (double * restrict)p_a[1], (double * restrict)p_a[2],
