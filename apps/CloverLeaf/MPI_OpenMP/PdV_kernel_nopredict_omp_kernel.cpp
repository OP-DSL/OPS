...
void ops_par_loop_PdV_kernel_nopredict(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12, ops_arg arg13) {
  ...
  offs[11][1] = off2D(1, &start_add[11*2],
  &end_add[11*2],args[11].dat->block_size, args[11].stencil->stride);

  offs[12][0] = args[12].stencil->stride[0]*1;  //unit step in x dimension
  offs[12][1] = off2D(1, &start_add[12*2],
  &end_add[12*2],args[12].dat->block_size, args[12].stencil->stride);

  offs[13][0] = args[13].stencil->stride[0]*1;  //unit step in x dimension
  offs[13][1] = off2D(1, &start_add[13*2],
  &end_add[13*2],args[13].dat->block_size, args[13].stencil->stride);
  ...
  for ( int thr=0; thr<nthreads; thr++ ){
    ...
    //set up initial pointers 
    int base11 = dat11 * 1 * 
    (start_thread_add[64*ndim*thr+0] * args[11].stencil->stride[0] - args[11].dat->offset[0]);
    base11 = base11  + dat11 * args[11].dat->block_size[0] * 
    (start_thread_add[64*ndim*thr+1] * args[11].stencil->stride[1] - args[11].dat->offset[1]);
    p_a[11] = (char *)args[11].data + base11;

    //set up initial pointers 
    int base12 = dat12 * 1 * 
    (start_thread_add[64*ndim*thr+0] * args[12].stencil->stride[0] - args[12].dat->offset[0]);
    base12 = base12  + dat12 * args[12].dat->block_size[0] * 
    (start_thread_add[64*ndim*thr+1] * args[12].stencil->stride[1] - args[12].dat->offset[1]);
    p_a[12] = (char *)args[12].data + base12;

    //set up initial pointers 
    int base13 = dat13 * 1 * 
    (start_thread_add[64*ndim*thr+0] * args[13].stencil->stride[0] - args[13].dat->offset[0]);
    base13 = base13  + dat13 * args[13].dat->block_size[0] * 
    (start_thread_add[64*ndim*thr+1] * args[13].stencil->stride[1] - args[13].dat->offset[1]);
