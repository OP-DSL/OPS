...
void ops_par_loop_advec_mom_kernel1_y(char const *name, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5) {
  ...
  //Timing
  double t1,t2,c1,c2;
  ops_timing_realloc(25,"advec_mom_kernel1_y");
  ...
  for ( int n_y=range[2]; n_y<range[3]; n_y++ ){
    for ( int n_x=range[0]; n_x<range[0]+(range[1]-range[0])/4; n_x++ ){
      ...
      #pragma simd
      for ( int i=0; i<4; i++ ){
        advec_mom_kernel1_y(  (double *)p_a[0]+ i*1, (double *)p_a[1]+ i*1, (double *)p_a[2]+ i*1,
           (double *)p_a[3]+ i*1, (double *)p_a[4]+ i*0, (double *)p_a[5]+ i*1 );
