  ...
  if (dir == 1) {
    ...
    if(vector) {
      ...
      ops_par_loop_opt(advec_mom_kernel1_x, "advec_mom_kernel1_x", 2, range_plus1xy_minus1x,
        ...
        ops_arg_dat(work_array4/*advec_vel*/, S2D_00, "double", OPS_READ),
        ops_arg_dat(work_array5/*mom_flux*/, S2D_00, "double", OPS_READ),
    ...
    ops_par_loop_opt(advec_mom_kernel2_x, "advec_mom_kernel2_x", 2, range_partx_party_2,
        ops_arg_dat(vel1, S2D_00, "double", OPS_READ),
        ops_arg_dat(work_array2/*node_mass_post*/, S2D_00, "double", OPS_READ),
        ops_arg_dat(work_array3/*node_mass_pre*/, S2D_00, "double", OPS_READ),
