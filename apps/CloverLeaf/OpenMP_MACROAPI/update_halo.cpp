...
void update_halo(int* fields, int depth)
{
  ...
  if(depth ==2)
  ops_par_loop_opt(update_halo_kernel1_b2, "update_halo_kernel1_b2", 2, rangexy_b2a,
  ...
  ops_par_loop_opt(update_halo_kernel1_b1, "update_halo_kernel1_b1", 2, rangexy_b1a,
  ...
  if(depth ==2)
  ops_par_loop_opt(update_halo_kernel1_t2, "update_halo_kernel1_t2", 2, rangexy_t2a,
  ...
  ops_par_loop_opt(update_halo_kernel1_t1, "update_halo_kernel1_t1", 2, rangexy_t1a,
  ...
  if(depth ==2)
  ops_par_loop_opt(update_halo_kernel1_l2, "update_halo_kernel1_l2", 2, rangexy_l2a,
  ...
  ops_par_loop_opt(update_halo_kernel1_l1, "update_halo_kernel1_l1", 2, rangexy_l1a,
  ...
  if(depth ==2)
  ops_par_loop_opt(update_halo_kernel1_r2, "update_halo_kernel1_r2", 2, rangexy_r2a,
  ...
  ops_par_loop_opt(update_halo_kernel1_r1, "update_halo_kernel1_r1", 2, rangexy_r1a,
  ...
  if(depth == 2)
  ops_par_loop_opt(update_halo_kernel2_xvel_plus_4_a, "update_halo_kernel2_xvel_plus_4_a", 2, rangexy_b2b,
  ...
  ops_par_loop_opt(update_halo_kernel2_xvel_plus_2_a, "update_halo_kernel2_xvel_plus_2_a", 2, rangexy_b1b,
  ...
  if(depth == 2)
  ops_par_loop_opt(update_halo_kernel2_xvel_plus_4_b, "update_halo_kernel2_xvel_plus_4_b", 2, rangexy_t2b,
  ...
  ops_par_loop_opt(update_halo_kernel2_xvel_plus_2_b, "update_halo_kernel2_xvel_plus_2_b", 2, rangexy_t1b,
  ...
  if(depth ==2)
  ops_par_loop_opt(update_halo_kernel2_xvel_minus_4_a, "update_halo_kernel2_xvel_minus_4_a", 2, rangexy_l2b,
  ...
  ops_par_loop_opt(update_halo_kernel2_xvel_minus_2_a, "update_halo_kernel2_xvel_minus_2_a", 2, rangexy_l1b,
  ...
  if(depth ==2)
  ops_par_loop_opt(update_halo_kernel2_xvel_minus_4_b, "update_halo_kernel2_xvel_minus_4_b", 2, rangexy_r2b,
  ...
  ops_par_loop_opt(update_halo_kernel2_xvel_minus_2_b, "update_halo_kernel2_xvel_minus_2_b", 2, rangexy_r1b,
  ...
  if(depth == 2)
  ops_par_loop_opt(update_halo_kernel2_yvel_minus_4_a, "update_halo_kernel2_yvel_minus_4_a", 2, rangexy_b2b,
              ops_arg_dat(yvel0, S2D_00_0P4, "double", OPS_RW),
              ops_arg_dat(yvel1, S2D_00_0P4, "double", OPS_RW),
              );

  ops_par_loop_opt(update_halo_kernel2_yvel_minus_2_a, "update_halo_kernel2_yvel_minus_2_a", 2, rangexy_b1b,
              ops_arg_dat(yvel0, S2D_00_0P2, "double", OPS_RW),
              ops_arg_dat(yvel1, S2D_00_0P2, "double", OPS_RW),
              );

  if(depth == 2)
  ops_par_loop_opt(update_halo_kernel2_yvel_minus_4_b, "update_halo_kernel2_yvel_minus_4_b", 2, rangexy_t2b,
              ops_arg_dat(yvel0, S2D_00_0M4, "double", OPS_RW),
              ops_arg_dat(yvel1, S2D_00_0M4, "double", OPS_RW),
              );

  ops_par_loop_opt(update_halo_kernel2_yvel_minus_2_b, "update_halo_kernel2_yvel_minus_2_b", 2, rangexy_t1b,
              ops_arg_dat(yvel0, S2D_00_0M2, "double", OPS_RW),
              ops_arg_dat(yvel1, S2D_00_0M2, "double", OPS_RW),
              );

  if(depth ==2)
  ops_par_loop_opt(update_halo_kernel2_yvel_plus_4_a, "update_halo_kernel2_yvel_plus_4_a", 2, rangexy_l2b,
              ops_arg_dat(yvel0, S2D_00_P40, "double", OPS_RW),
              ops_arg_dat(yvel1, S2D_00_P40, "double", OPS_RW),
              );

  ops_par_loop_opt(update_halo_kernel2_yvel_plus_2_a, "update_halo_kernel2_yvel_plus_2_a", 2, rangexy_l1b,
              ops_arg_dat(yvel0, S2D_00_P20, "double", OPS_RW),
              ops_arg_dat(yvel1, S2D_00_P20, "double", OPS_RW),
              );

  if(depth ==2)
  ops_par_loop_opt(update_halo_kernel2_yvel_plus_4_b, "update_halo_kernel2_yvel_plus_4_b", 2, rangexy_r2b,
              ops_arg_dat(yvel0, S2D_00_M40, "double", OPS_RW),
              ops_arg_dat(yvel1, S2D_00_M40, "double", OPS_RW),
              );

  ops_par_loop_opt(update_halo_kernel2_yvel_plus_2_b, "update_halo_kernel2_yvel_plus_2_b", 2, rangexy_r1b,
  ...
  if(depth ==2)
  ops_par_loop_opt(update_halo_kernel3_plus_4_a, "update_halo_kernel3_plus_4_a", 2, rangexy_b2c,
  ...
  ops_par_loop_opt(update_halo_kernel3_plus_2_a, "update_halo_kernel3_plus_2_a", 2, rangexy_b1c,
  ...
  if(depth ==2)
  ops_par_loop_opt(update_halo_kernel3_plus_4_b, "update_halo_kernel3_plus_4_b", 2, rangexy_t2c,
  ...
  ops_par_loop_opt(update_halo_kernel3_plus_2_b, "update_halo_kernel3_plus_2_b", 2, rangexy_t1c,
  ...
  if(depth ==2)
  ops_par_loop_opt(update_halo_kernel3_minus_4_a, "update_halo_kernel3_minus_4_a", 2, rangexy_l2c,
  ...
  ops_par_loop_opt(update_halo_kernel3_minus_2_a, "update_halo_kernel3_minus_2_a", 2, rangexy_l1c,
  ...
  if(depth ==2)
  ops_par_loop_opt(update_halo_kernel3_minus_4_b, "update_halo_kernel3_minus_4_b", 2, rangexy_r2c,
  ...
  ops_par_loop_opt(update_halo_kernel3_minus_2_b, "update_halo_kernel3_minus_2_b", 2, rangexy_r1c,
  ...
  if(depth ==2)
  ops_par_loop_opt(update_halo_kernel4_minus_4_a, "update_halo_kernel4_minus_4_a", 2, rangexy_b2d,
  ...
  ops_par_loop_opt(update_halo_kernel4_minus_2_a, "update_halo_kernel4_minus_2_a", 2, rangexy_b1d,
  ...
  if(depth ==2)
  ops_par_loop_opt(update_halo_kernel4_minus_4_b, "update_halo_kernel4_minus_4_b", 2, rangexy_t2d,
  ...
  ops_par_loop_opt(update_halo_kernel4_minus_2_b, "update_halo_kernel4_minus_2_b", 2, rangexy_t1d,
  ...
  if(depth ==2)
  ops_par_loop_opt(update_halo_kernel4_plus_4_a, "update_halo_kernel4_plus_4_a", 2, rangexy_l2d,
  ...
  ops_par_loop_opt(update_halo_kernel4_plus_2_a, "update_halo_kernel4_plus_2_a", 2, rangexy_l1d,
  ...
  if(depth ==2)
  ops_par_loop_opt(update_halo_kernel4_plus_4_b, "update_halo_kernel4_plus_4_b", 2, rangexy_r2d,
  ...
  ops_par_loop_opt(update_halo_kernel4_plus_2_b, "update_halo_kernel4_plus_2_b", 2, rangexy_r1d,
