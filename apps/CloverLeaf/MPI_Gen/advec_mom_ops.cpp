...
void ops_par_loop_advec_mom_kernel_post_advec_x(char const *, ops_block, int , int*,
  ops_arg,
  ops_arg,
  ops_arg );

void ops_par_loop_advec_mom_kernel_pre_advec_x(char const *, ops_block, int , int*,
  ops_arg,
  ops_arg,
  ops_arg );
...
void ops_par_loop_advec_mom_kernel_post_advec_y(char const *, ops_block, int , int*,
  ops_arg,
  ops_arg,
  ops_arg );

void ops_par_loop_advec_mom_kernel_pre_advec_y(char const *, ops_block, int , int*,
  ops_arg,
  ops_arg,
  ops_arg );
...
void advec_mom(int which_vel, int sweep_number, int dir)
{
  ...
  if (dir == 1) {
    ...
    ops_par_loop_advec_mom_kernel_post_advec_x("advec_mom_kernel_post_advec_x", clover_grid, 2, range_partx_party_1,
    ...
    ops_par_loop_advec_mom_kernel_pre_advec_x("advec_mom_kernel_pre_advec_x", clover_grid, 2, range_partx_party_1,
    ...
    ops_par_loop_advec_mom_kernel_post_advec_y("advec_mom_kernel_post_advec_y", clover_grid, 2, range_partx_party_2,
                 ops_arg_dat(work_array2, S2D_00, "double", OPS_WRITE),
                 ops_arg_dat(work_array7, S2D_00_M10_0M1_M1M1, "double", OPS_READ),
                 ops_arg_dat(density1, S2D_00_M10_0M1_M1M1, "double", OPS_READ));

    ops_par_loop_advec_mom_kernel_pre_advec_y("advec_mom_kernel_pre_advec_y", clover_grid, 2, range_partx_party_2,
                 ops_arg_dat(work_array3, S2D_00, "double", OPS_WRITE),
                 ops_arg_dat(work_array2, S2D_00, "double", OPS_READ),
