...
// host stub function
void ops_par_loop_accelerate_kernelx1(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  #ifdef OPS_DEBUG
  ops_register_args(args, "accelerate_kernelx1");
  #endif
  ...
  //Timing
  double t1,t2,c1,c2;
  ops_timing_realloc(48,"accelerate_kernelx1");
  ...
  for ( int n_y=s[1]; n_y<e[1]; n_y++ ){
    for ( int n_x=s[0]; n_x<s[0]+(e[0]-s[0])/SIMD_VEC; n_x++ ){
        ...
        for ( int i=0; i<SIMD_VEC; i++ ){
          accelerate_kernelx1(  (double *)p_a[0]+ i*1, (double *)p_a[1]+ i*1, (double *)p_a[2]+ i*1,
