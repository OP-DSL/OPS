//
// auto-generated by ops.py on 2014-02-19 11:58
//
...
void ops_par_loop_calc_dt_kernel_getx(char const *, ops_block, int , int*,
  ops_arg,
  ops_arg );

void ops_par_loop_calc_dt_kernel_gety(char const *, ops_block, int , int*,
  ops_arg,
  ops_arg );
             ...
             double* xl_pos, double* yl_pos, int* jldt, int* kldt)
{
  ...
  *kldt = 1 + (jk_control/(x_max-2));
  ...
  ops_par_loop_calc_dt_kernel_getx("calc_dt_kernel_getx", clover_grid, 2, rangexy_getpointx,
               ops_arg_dat(cellx, S2D_00_STRID2D_X, "double", OPS_READ),
               ops_arg_gbl(xl_pos, 1, "double", OPS_WRITE));

  ops_par_loop_calc_dt_kernel_gety("calc_dt_kernel_gety", clover_grid, 2, rangexy_getpointy,
