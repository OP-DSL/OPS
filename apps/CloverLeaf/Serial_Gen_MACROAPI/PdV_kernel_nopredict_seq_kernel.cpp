...
void ops_par_loop_PdV_kernel_nopredict(char const *name, int dim, int* range,
 ...
 ops_arg arg12, ops_arg arg13) {
  ...
  + args[11].dat->size * args[11].dat->block_size[0] * ( range[2] * args[11].stencil->stride[1] - args[11].dat->offset[1] )
  + args[11].dat->size * ( range[0] * args[11].stencil->stride[0] - args[11].dat->offset[0] );

  p_a[12] = (char *)args[12].data
  + args[12].dat->size * args[12].dat->block_size[0] * ( range[2] * args[12].stencil->stride[1] - args[12].dat->offset[1] )
  + args[12].dat->size * ( range[0] * args[12].stencil->stride[0] - args[12].dat->offset[0] );

  p_a[13] = (char *)args[13].data
  + args[13].dat->size * args[13].dat->block_size[0] * ( range[2] * args[13].stencil->stride[1] - args[13].dat->offset[1] )
  + args[13].dat->size * ( range[0] * args[13].stencil->stride[0] - args[13].dat->offset[0] );
  ...
  for ( int n_y=range[2]; n_y<range[3]; n_y++ ){
    for ( int n_x=range[0]; n_x<range[1]; n_x++ ){
      ...
      p_a[8]= p_a[8] + (args[8].dat->size * offs[8][0]);
      p_a[9]= p_a[9] + (args[9].dat->size * offs[9][0]);
      p_a[10]= p_a[10] + (args[10].dat->size * offs[10][0]);
      p_a[11]= p_a[11] + (args[11].dat->size * offs[11][0]);
      p_a[12]= p_a[12] + (args[12].dat->size * offs[12][0]);
      p_a[13]= p_a[13] + (args[13].dat->size * offs[13][0]);
    }
    ...
    p_a[5]= p_a[5] + (args[5].dat->size * offs[5][1]);
    p_a[6]= p_a[6] + (args[6].dat->size * offs[6][1]);
    p_a[7]= p_a[7] + (args[7].dat->size * offs[7][1]);
    p_a[8]= p_a[8] + (args[8].dat->size * offs[8][1]);
    p_a[9]= p_a[9] + (args[9].dat->size * offs[9][1]);
    p_a[10]= p_a[10] + (args[10].dat->size * offs[10][1]);
    p_a[11]= p_a[11] + (args[11].dat->size * offs[11][1]);
    p_a[12]= p_a[12] + (args[12].dat->size * offs[12][1]);
    p_a[13]= p_a[13] + (args[13].dat->size * offs[13][1]);
  }
}
