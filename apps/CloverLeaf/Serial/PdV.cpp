...
void PdV(int predict)
{
  ...
  ops_par_loop_opt(PdV_kernel_predict, "PdV_kernel_predict", 2, rangexy_inner,
    ops_arg_dat(xarea, S2D_00_P10_0P1_P1P1, OPS_READ),
    ops_arg_dat(xvel0, S2D_00_P10_0P1_P1P1, OPS_READ),
    ops_arg_dat(yarea, S2D_00_P10_0P1_P1P1, OPS_READ),
  ...
  ops_par_loop_opt(PdV_kernel_nopredict, "PdV_kernel_nopredict", 2, rangexy_inner,
    ops_arg_dat(xarea, S2D_00_P10_0P1_P1P1, OPS_READ),
    ops_arg_dat(xvel0, S2D_00_P10_0P1_P1P1, OPS_READ),
    ops_arg_dat(xvel1, S2D_00_P10_0P1_P1P1, OPS_READ),
    ops_arg_dat(yarea, S2D_00_P10_0P1_P1P1, OPS_READ),
    ops_arg_dat(yvel0, S2D_00_P10_0P1_P1P1, OPS_READ),
    ops_arg_dat(yvel1, S2D_00_P10_0P1_P1P1, OPS_READ),
    ops_arg_dat(work_array1, S2D_00, OPS_WRITE),
    ops_arg_dat(volume, S2D_00, OPS_READ),
    ops_arg_dat(pressure, S2D_00, OPS_READ),
    ops_arg_dat(density0, S2D_00, OPS_READ),
