...
__constant__ int xdim5_advec_mom_kernel1_y_nonvector;
...
#define OPS_ACC5(x,y) (x+xdim5_advec_mom_kernel1_y_nonvector*(y))
...
int size1 ){
  ...
  arg3 += idx_x * 1 + idx_y * 1 * xdim3_advec_mom_kernel1_y_nonvector;
  arg4 += idx_x * 0 + idx_y * 1 * xdim4_advec_mom_kernel1_y_nonvector;
  arg5 += idx_x * 1 + idx_y * 1 * xdim5_advec_mom_kernel1_y_nonvector;
...
void ops_par_loop_advec_mom_kernel1_y_nonvector(char const *name, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5) {
  ...
  if (OPS_kernels[25].count == 0) {
    ...
    cudaMemcpyToSymbol( xdim5_advec_mom_kernel1_y_nonvector, &xdim5, sizeof(int) );
  }
