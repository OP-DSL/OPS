...
//
//user function
#include "poisson_update_kernel.h"

// host stub function
void ops_par_loop_poisson_update_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  #endif //OPS_MPI
  #ifdef OPS_DEBUG
  ops_register_args(args, "poisson_update_kernel");
  #endif
  ...
  //Timing
  double t1,t2,c1,c2;
  ops_timing_realloc(3,"poisson_update_kernel");
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for( n_x=start[0]; n_x<start[0]+((end[0]-start[0])/SIMD_VEC)*SIMD_VEC; n_x+=SIMD_VEC ) {
      ...
      for ( int i=0; i<SIMD_VEC; i++ ){
        poisson_update_kernel(  (double *)p_a[0]+ i*1, (double *)p_a[1]+ i*1 );
    ...
    for ( int n_x=start[0]+((end[0]-start[0])/SIMD_VEC)*SIMD_VEC; n_x<end[0]; n_x++ ){
        ...
        poisson_update_kernel(  (double *)p_a[0], (double *)p_a[1] );
    ...
    #ifdef OPS_DEBUG
    ops_dump3(arg1.dat,"poisson_update_kernel");
    #endif
