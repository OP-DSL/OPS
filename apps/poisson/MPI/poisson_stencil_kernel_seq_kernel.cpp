...
//
//user function
#include "poisson_stencil_kernel.h"

// host stub function
void ops_par_loop_poisson_stencil_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  #endif //OPS_MPI
  #ifdef OPS_DEBUG
  ops_register_args(args, "poisson_stencil_kernel");
  #endif
  ...
  //Timing
  double t1,t2,c1,c2;
  ops_timing_realloc(2,"poisson_stencil_kernel");
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for( n_x=start[0]; n_x<start[0]+((end[0]-start[0])/SIMD_VEC)*SIMD_VEC; n_x+=SIMD_VEC ) {
      ...
      for ( int i=0; i<SIMD_VEC; i++ ){
        poisson_stencil_kernel(  (double *)p_a[0]+ i*1, (double *)p_a[1]+ i*1, (double *)p_a[2]+ i*1 );
    ...
    for ( int n_x=start[0]+((end[0]-start[0])/SIMD_VEC)*SIMD_VEC; n_x<end[0]; n_x++ ){
        ...
        poisson_stencil_kernel(  (double *)p_a[0], (double *)p_a[1], (double *)p_a[2] );
    ...
    #ifdef OPS_DEBUG
    ops_dump3(arg2.dat,"poisson_stencil_kernel");
    #endif
