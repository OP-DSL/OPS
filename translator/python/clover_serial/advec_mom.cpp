...
void advec_mom(int which_vel, int sweep_number, int dir)
{
  ...
  if(mom_sweep == 1) { // x 1
    ...
    ops_par_loop_opt(advec_mom_kernel_y1, "advec_mom_kernel_y1", 2, rangexy,
        ops_arg_dat(work_array6, S2D_00, OPS_WRITE),
        ops_arg_dat(work_array7, S2D_00, OPS_RW),
        ops_arg_dat(volume, S2D_00, OPS_READ),
        ops_arg_dat(vol_flux_x, S2D_00_P10, OPS_READ),
    ...
    ops_par_loop_opt(advec_mom_kernel_x2, "advec_mom_kernel_x2", 2, rangexy,
        ops_arg_dat(work_array6, S2D_00, OPS_WRITE),
        ops_arg_dat(work_array7, S2D_00, OPS_RW),
        ops_arg_dat(volume, S2D_00, OPS_READ),
        ops_arg_dat(vol_flux_y, S2D_00_0P1, OPS_READ));
    ...
    ops_par_loop_opt(advec_mom_kernel_y2, "advec_mom_kernel_y2", 2, rangexy,
        ops_arg_dat(work_array6, S2D_00, OPS_WRITE),
        ops_arg_dat(work_array7, S2D_00, OPS_RW),
        ops_arg_dat(volume, S2D_00, OPS_READ),
        ops_arg_dat(vol_flux_x, S2D_00_P10, OPS_READ));
  ...
  if (dir == 1) {
    ...
    ops_par_loop_opt(advec_mom_kernel_mass_flux_x, "advec_mom_kernel_mass_flux_x", 2, range_fullx_party_1,
        ops_arg_dat(work_array1, S2D_00, OPS_WRITE),
        ops_arg_dat(mass_flux_x, S2D_00_P10_0M1_P1M1, OPS_READ));

    //Staggered cell mass post advection
    ops_par_loop_opt(advec_mom_kernel_post_advec_x, "advec_mom_kernel_post_advec_x", 2, range_partx_party_1,
        ops_arg_dat(work_array2, S2D_00, OPS_WRITE),
        ops_arg_dat(work_array7, S2D_00_M10_0M1_M1M1, OPS_READ),
        ops_arg_dat(density1, S2D_00_M10_0M1_M1M1, OPS_READ));

    //Stagered cell mass pre advection
    ops_par_loop_opt(advec_mom_kernel_pre_advec_x, "advec_mom_kernel_pre_advec_x", 2, range_partx_party_1,
    ...
    //Find staggered mesh mass fluxes, nodal masses and volumes.
    ops_par_loop_opt(advec_mom_kernel_mass_flux_y, "advec_mom_kernel_mass_flux_y", 2, range_fully_party_1,
        ops_arg_dat(work_array1, S2D_00, OPS_WRITE),
        ops_arg_dat(mass_flux_y, S2D_00_0P1_M10_M1P1, OPS_READ));

    //Staggered cell mass post advection
    ops_par_loop_opt(advec_mom_kernel_post_advec_y, "advec_mom_kernel_post_advec_y", 2, range_partx_party_2,
        ops_arg_dat(work_array2, S2D_00, OPS_WRITE),
        ops_arg_dat(work_array7, S2D_00_M10_0M1_M1M1, OPS_READ),
        ops_arg_dat(density1, S2D_00_M10_0M1_M1M1, OPS_READ));

    //Stagered cell mass pre advection
    ops_par_loop_opt(advec_mom_kernel_pre_advec_y, "advec_mom_kernel_pre_advec_y", 2, range_partx_party_2,
        ops_arg_dat(work_array3/*node_mass_pre*/, S2D_00, OPS_WRITE),
        ops_arg_dat(work_array2/*node_mass_post*/, S2D_00, OPS_READ),
    ...
    if(vector) {
        ...
        ops_arg_dat(work_array4/*advec_vel*/, S2D_00, OPS_RW),
        ops_arg_dat(work_array5/*mom_flux*/, S2D_00, OPS_WRITE),
        ops_arg_dat(celldy, S2D_00_0P1_0M1_0M2_STRID2D_Y, OPS_READ),
        ops_arg_dat(vel1, S2D_00_0P1_0P2_0M1, OPS_READ));
    }
    else {
      //currently ignor this section
    }
