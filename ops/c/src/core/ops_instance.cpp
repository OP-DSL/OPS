...
char *ops_dat_core::derivative_get_raw_pointer(ops_stencil_core *stencil,
                                               ops_memspace *memspace) {
  return ops_dat_derivative_get_raw_pointer(this, stencil, memspace);
}
void ops_dat_core::release_raw_derivative(ops_access acc,
                                          ops_memspace memspace) {
  ops_dat_release_raw_derivative(this, acc, memspace);
}
void ops_dat_core::fetch_derivative(char *data, ops_memspace memspace) {
  ops_dat_fetch_derivative(this, data, memspace);
}
void ops_dat_core::store_derivative(char *data, ops_memspace memspace) {
  ops_dat_store_derivative(this, data, memspace);
}
void ops_dat_core::set_derivative(char *data, ops_memspace memspace) {
  ops_dat_set_derivative(this, data, memspace);
}
ops_dat_core *ops_dat_core::get_derivative_as_ops_dat() {
  return ops_get_derivative_as_ops_dat(this);
}
