...
void ops_dat_core::free() {_ops_free_dat(this);}
...
void ops_dat_core::fetch_data(int part, char *data) { ops_dat_fetch_data(this, part, data); }
void ops_dat_core::set_data(int part, char *data) { ops_dat_set_data(this, part, data); }
