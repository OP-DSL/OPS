...
/**
 * TODO: [[deprecated]] Remove this and replate with ops_hls_stencil_core_v2.hpp
*/
...
DEPRECATED class INDEX_STENCIL : public ops::hls::StencilCore<T, 1, VEC_FACTOR, ops::hls::CoefTypes::CONST_COEF, 
        0, DIM>
{
public:
