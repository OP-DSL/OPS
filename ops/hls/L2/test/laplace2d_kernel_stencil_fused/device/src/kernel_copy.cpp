...
static void kernel_copy_dataflow_region(ops::hls::GridPropertyCore& gridProp,
	    ...
	    kernel_copy_stencil::widen_stream_dt& arg1_input_stream,
	    kernel_copy_stencil::widen_stream_dt& arg0_output_stream)
{
#pragma HLS DATAFLOW
    ops::hls::axis2stream<axis_data_width, axis_data_width>(arg0_axis_in, arg0_output_stream, total_bytes);
    kernel_copy_PE(gridProp, arg0_output_stream, arg1_input_stream);
        ...
        hls::stream <ap_axiu<axis_data_width,0,0,0>>& arg1_axis_out)
{
    ...
    static kernel_copy_stencil::widen_stream_dt arg1_input_stream;
    static kernel_copy_stencil::widen_stream_dt arg0_output_stream;
    ...
    kernel_copy_dataflow_region(gridProp, total_bytes, arg0_axis_in, arg1_axis_out, arg1_input_stream, arg0_output_stream);
}
