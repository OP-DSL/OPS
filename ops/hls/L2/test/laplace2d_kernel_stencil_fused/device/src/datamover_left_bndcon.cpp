...
#include "../include/datamover_left_bndcon.hpp"

static void datamover_left_bndcon_dataflow_region(ops::hls::AccessRange& range,
...
)
{
    ...
    datamover_left_bndcon_dataflow_region(range, gridSize, arg0_out, arg0_stream_in);
}
