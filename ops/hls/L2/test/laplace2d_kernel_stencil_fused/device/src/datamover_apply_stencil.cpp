...
//    ops::hls::memWriteGrid<mem_data_width, axis_data_width, data_width>(arg1_out, arg1_stream_in, arg1_gridSize, read_range);
...
)
{
...
#ifdef DEBUG_LOG
            printf("[KERNEL_DEBUG]|%s| starting datamover TOP read_range:(%d,%d,%d) ---> (%d,%d,%d), read_range: (%d,%d,%d) ---> (%d,%d,%d)\n", __func__,
    ...
    datamover_apply_stencil_dataflow_region(read_range, arg0_gridSize, arg1_gridSize, arg0_in, arg1_out, arg0_stream_out, arg1_stream_in);
