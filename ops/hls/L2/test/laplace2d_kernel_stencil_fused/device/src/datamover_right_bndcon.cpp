...
#include "../include/datamover_right_bndcon.hpp"

static void datamover_right_bndcon_dataflow_region(ops::hls::AccessRange& range,
...
extern "C" void datamover_right_bndcon(
...
)
{
    ...
    datamover_right_bndcon_dataflow_region(range, gridSize, arg0_out, arg0_stream_in);
