...
#pragma HLS DATAFLOW
//#ifdef DEBUG_LOG
	printf("[KERNEL_DEBUG]|%s| Top dataflow region start \n", __func__);
//#endif
    ops::hls::axis2stream<axis_data_width, axis_data_width>(arg0_axis_in, arg0_output_stream, total_bytes);
//#ifdef DEBUG_LOG
	printf("[KERNEL_DEBUG]|%s| Top dataflow region calling PE \n", __func__);
//#endif
    kernel_copy_PE(stencilConfig, arg0_output_stream, arg1_input_stream);
    ops::hls::stream2axis<axis_data_width, axis_data_width>(arg1_axis_out, arg1_input_stream, total_bytes);
//#ifdef DEBUG_LOG
	printf("[KERNEL_DEBUG]|%s| Top dataflow region end \n", __func__);
//#endif
}
...
//#ifdef DEBUG_LOG
	printf("[KERNEL_DEBUG]|%s| Top start \n", __func__);
//#endif
...
//#ifdef DEBUG_LOG
	printf("[KERNEL_DEBUG]|%s| Top: Calling dataflow region \n", __func__);
//#endif
    kernel_copy_dataflow_region(stencilConfig, total_bytes, arg0_axis_in, arg1_axis_out, arg1_input_stream, arg0_output_stream);

//#ifdef DEBUG_LOG
	printf("[KERNEL_DEBUG]|%s| Top end \n", __func__);
//#endif
}
