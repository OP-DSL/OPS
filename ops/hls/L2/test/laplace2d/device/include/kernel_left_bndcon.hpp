...
void kernel_left_bndcon_core(const unsigned int num_itr,
...
void kernel_left_bndcon_PE(ops::hls::GridPropertyCore& gridProp,
...
#pragma HLS DATAFLOW
    ...
    kernel_left_bndcon_core(kernel_iterations, arg0_output_bus_0, idx_bus, const_pi, const_jmax);
