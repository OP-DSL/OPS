...
#include "../include/kernel_left_bndcon.hpp"

static void kernel_left_bndcon_dataflow_region(ops::hls::GridPropertyCore& gridProp,
    ...
    hls::stream <ap_axiu<axis_data_width,0,0,0>>& arg0_axis_out)
{
    ...
    kernel_left_bndcon_dataflow_region(gridProp, total_bytes, const_pi, const_jmax, arg0_axis_out, arg0_input_stream, arg0_inmask_stream);
