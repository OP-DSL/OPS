...
class s2d_1pt : public ops::hls::StencilCore<stencil_type, 1, vector_factor, ops::hls::CoefTypes::CONST_COEF, 
        stencil_size[0], stencil_size[1]>
{
    public:
        ...
        void stencilRead(stream_dt& rd_buffer, ::hls::stream<stencil_type> output_bus[vector_factor])
        {
        ...
        void stencilWrite(stream_dt& wr_buffer, ::hls::stream<stencil_type> input_bus[vector_factor],
