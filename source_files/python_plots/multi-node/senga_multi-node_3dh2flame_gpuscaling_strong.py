...
weight_counts_cuda = {
    "Compute_cuda"       : np.array([  1873.65, 960.45, 508.21, 322.65, 181.95, 118.09 ]),
    "Communication_cuda" : np.array([  88.13, 110.48, 102.28, 73.89, 71.04, 59.25 ]),
}

weight_counts_hip = {
    "Compute_hip"       	 : np.array([  1493.53, 773.20, 444.50, 247.69, 157.48, 104.63 ]),
    "Communication_hip" 	 : np.array([  164.01, 131.31, 90.38, 81.52, 69.90, 60.17 ]),
}
...
plt.savefig("senga_multi-node_3dh2flame_gpuscaling_strong.pdf", format="pdf", bbox_inches="tight")
# plt.show()
