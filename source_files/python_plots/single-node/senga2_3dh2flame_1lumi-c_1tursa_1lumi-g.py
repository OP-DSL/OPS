...
# senga2_3dh2flame_1lumi-c_1tursa_1lumi-g.py
weight_counts = {
    "Compute"       : np.array([ 36231.87, 32321.4, 2248.81, 1873.65, 1493.53 ]),
    "Communication" : np.array([ 622.03,   1402.45,  142.38,  88.13,   164.01  ]),
}
...
plt.savefig("senga2_3dh2flame_1lumi-c_1tursa_1lumi-g.pdf", format="pdf", bbox_inches="tight")
# plt.show()
