...
senga_opp_x = [0.12	       , 5.8	    , 0.09	    , 0.95	    , 3.7        ]     # AI - these are from BEDE
senga_opp_y = [128         , 3500       , 110       , 440       , 2600        ]
...
ax0.annotate(str(max_gflops_dp) + ' GFLOPS/s DP Max', (0.012, max_gflops_dp - 8000), fontsize=20, zorder=0, color='darkblue')
dram_diag_x = 0.0025
diag_x = 0.0025
ax0.annotate('L1 - ' + str(l1_bandwidth) + ' GB/s', (0.012, 130), fontsize=20, rotation=36.5, zorder=0, color='darkblue')
ax0.annotate('L2 - ' + str(l2_bandwidth) + ' GB/s', (0.012, 70), fontsize=20, rotation=36.5, zorder=0, color='darkblue')
ax0.annotate('DRAM - ' + str(dram_bandwidth) + ' GB/s', (0.012, 20), fontsize=20, rotation=36.5, zorder=0, color='darkblue')
...
plt.savefig("senga_roofline_lumi.pdf", format="pdf", bbox_inches="tight")
