...
\item[options] a combinations of flags, listed in \texttt{ops\_checkpointing.h}: \\OPS\_CHECKPOINT\_INITPHASE, \\
OPS\_CHECKPOINT\_MANUAL\_DATLIST, \\OPS\_CHECKPOINT\_FASTFW, \\OPS\_CHECKPOINT\_MANUAL.
\end{routine}
...
% (in this case accessing a 1D array with 2D indexing related to the stencil specified) to access the relevant element.
