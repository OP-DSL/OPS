...
\noindent \texttt{diags\_level} $>$ 4 : print intra-block halo buffer allocation feedback\\
\noindent \texttt{diags\_level} $>$ 5 : check if intra-block halo MPI sends depth match MPI receives depth\\
