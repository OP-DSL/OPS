...
\noindent To manually specify the tile sizes (in MB), use the T1, T2, and T3 
environment variables:\\
\texttt{export T1=600; export T2=200; \\
export OMP\_NUM\_THREADS=xx; \\
numactl -physnodebind=0 ./cloverleaf\_tiled OPS\_TILING
}
...
\noindent NVIDIA GPU-direct is enabled with \texttt{-gpudirect} runtime flag. \\
